...
public final class ViewPropertyAnimatorCompat
{
  ...
  static final int LISTENER_TAG_ID = NUM;
    ...
    implements ViewPropertyAnimatorCompat.ViewPropertyAnimatorCompatImpl
  {
    ...
    {
      paramView.setTag(NUM, paramViewPropertyAnimatorListener);
    }
    ...
    {
      Object localObject = paramView.getTag(NUM);
      ...
      implements ViewPropertyAnimatorListener
    {
      ...
      public void onAnimationEnd(View paramView)
      {
        ...
        if ((Build.VERSION.SDK_INT >= 16) || (!this.mAnimEndCalled))
        {
          ...
          Object localObject2 = paramView.getTag(NUM);
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/android/support/v4/view/ViewPropertyAnimatorCompat.class
