...
class CircleImageView
  extends ImageView
{
  private static final int FILL_SHADOW_COLOR = NUM;
    ...
    extends OvalShape
  {
    ...
    private void updateRadialGradient(int paramInt)
    {
      ...
      this.mRadialGradient = new RadialGradient(f1, f2, f3, new int[] { NUM, 0 }, null, localTileMode);
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/android/support/v4/widget/CircleImageView.class
