  ...
  extends ViewGroup
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      {
        paramInt1 = View.MeasureSpec.makeMeasureSpec(i3 - paramInt1, NUM);
        break label429;
      }
      paramInt1 = View.MeasureSpec.makeMeasureSpec(localLayoutParams.width, NUM);
      break label429;
      if (localLayoutParams.height == -1)
      {
        j = View.MeasureSpec.makeMeasureSpec(paramInt2, NUM);
        break label448;
      }
      j = View.MeasureSpec.makeMeasureSpec(localLayoutParams.height, NUM);
      break label448;
    }
    label653:
    if ((bool1) || (f1 > 0.0F))
      ...
      if (j < i4)
      {
        ...
        for (;;)
        {
          ...
          if (localView.getVisibility() != 8)
          {
            ...
            for (;;)
            {
              localView.measure(View.MeasureSpec.makeMeasureSpec(i1, NUM), paramInt1);
              break;
              paramInt1 = 0;
              break label750;
              label840:
              ...
              {
                paramInt1 = View.MeasureSpec.makeMeasureSpec(localLayoutParams.height, NUM);
                continue;
                label885:
                paramInt1 = View.MeasureSpec.makeMeasureSpec(localView.getMeasuredHeight(), NUM);
              }
            }
            label900:
            if (localLayoutParams.weight > 0.0F)
            {
              ...
              for (;;)
              {
                ...
                int i5 = View.MeasureSpec.makeMeasureSpec(i2, NUM);
                if (n == i2) {
                  break;
                }
              ...
              label1035:
              i2 = Math.max(0, m);
              localView.measure(View.MeasureSpec.makeMeasureSpec(n + (int)(localLayoutParams.weight * i2 / f1), NUM), paramInt1);
            }
          }
        }
      }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/android/support/v4/widget/SlidingPaneLayout.class
