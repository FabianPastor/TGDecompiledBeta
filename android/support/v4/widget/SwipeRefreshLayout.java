  ...
  implements NestedScrollingParent, NestedScrollingChild
{
  ...
  public void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      return;
      this.mTarget.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth() - getPaddingLeft() - getPaddingRight(), NUM), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() - getPaddingTop() - getPaddingBottom(), NUM));
      this.mCircleView.measure(View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, NUM), View.MeasureSpec.makeMeasureSpec(this.mCircleDiameter, NUM));
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/android/support/v4/widget/SwipeRefreshLayout.class
