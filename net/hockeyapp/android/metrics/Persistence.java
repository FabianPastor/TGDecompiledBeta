...
class Persistence
{
  ...
  protected Boolean isFreeSpaceAvailable()
  {
    ...
    synchronized (LOCK)
    {
      ...
      if (((Context)localObject2).getFilesDir() != null)
      {
        ...
        {
          if (new File((String)localObject2).listFiles().length < MAX_FILE_COUNT.intValue()) {
            bool = true;
          }
  ...
  protected void persist(String[] paramArrayOfString)
  {
    ...
    } while (!Boolean.valueOf(writeToDisk(localStringBuilder.toString())).booleanValue());
    getSender().triggerSending();
  }
  ...
  {
    // Byte code:
    //   0: invokestatic 246	java/util/UUID:randomUUID	()Ljava/util/UUID;
    //   3: invokevirtual 247	java/util/UUID:toString	()Ljava/lang/String;
    //   6: astore 9
    //   8: iconst_0
    //   9: invokestatic 164	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   12: astore 4
    //   14: aconst_null
    //   15: astore 6
    //   17: aconst_null
    ...
    //   61: invokevirtual 250	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   64: ldc -4
    ...
    //   89: aload 6
    //   91: iconst_1
    //   92: invokespecial 257	java/io/FileOutputStream:<init>	(Ljava/io/File;Z)V
    //   95: astore_2
    //   96: aload_2
    //   97: aload_1
    //   98: invokevirtual 263	java/lang/String:getBytes	()[B
    //   101: invokevirtual 267	java/io/FileOutputStream:write	([B)V
    //   104: ldc 15
    ...
    //   135: monitorexit
    //   136: iconst_1
    //   137: invokestatic 164	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   140: astore_1
    //   141: aload_2
    //   142: ifnull +122 -> 264
    //   145: aload_2
    //   146: invokevirtual 270	java/io/FileOutputStream:close	()V
    //   149: aload_1
    //   150: invokevirtual 226	java/lang/Boolean:booleanValue	()Z
    //   153: ireturn
    //   154: astore_1
    //   155: aload_3
    //   156: astore_2
    ...
    //   184: aload_1
    //   185: invokevirtual 273	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   201: ifnull -52 -> 149
    //   204: aload_3
    //   205: invokevirtual 270	java/io/FileOutputStream:close	()V
    //   208: aload 4
    //   210: astore_1
    //   211: goto -62 -> 149
    //   214: astore_1
    //   215: aload_1
    //   216: invokevirtual 276	java/io/IOException:printStackTrace	()V
    //   219: aload 4
    //   221: astore_1
    //   222: goto -73 -> 149
    //   225: astore_2
    //   226: aload_2
    //   227: invokevirtual 276	java/io/IOException:printStackTrace	()V
    //   230: goto -81 -> 149
    //   233: astore_1
    //   234: aload_2
    //   235: ifnull +7 -> 242
    //   238: aload_2
    //   239: invokevirtual 270	java/io/FileOutputStream:close	()V
    //   242: aload_1
    //   243: athrow
    //   244: astore_2
    //   245: aload_2
    //   246: invokevirtual 276	java/io/IOException:printStackTrace	()V
    //   249: goto -7 -> 242
    //   252: astore_1
    //   253: goto -19 -> 234
    //   256: astore_1
