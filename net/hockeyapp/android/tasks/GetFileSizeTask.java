  ...
  extends DownloadFileTask
{
  ...
  protected Long doInBackground(Void... paramVarArgs)
  {
    try
    {
      ...
      paramVarArgs.<init>(getURLString());
      long l = createConnection(paramVarArgs, 6).getContentLength();
      paramVarArgs = Long.valueOf(l);
    }
    catch (IOException paramVarArgs)
    {
      for (;;)
      {
        HockeyLog.error("Failed to get size " + this.mUrlString, paramVarArgs);
