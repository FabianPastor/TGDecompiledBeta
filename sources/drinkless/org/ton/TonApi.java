...
public class TonApi {
    ...
    public static class InputKeyRegular extends InputKey {
        ...
        public InputKeyRegular(Key key2, byte[] bArr) {
            this.key = key2;
    ...
    public static class Options extends Object {
        ...
        public Options(Config config2, KeyStoreType keyStoreType) {
            this.config = config2;
    ...
    public static class UpdateSyncState extends Update {
        ...
        public UpdateSyncState(SyncState syncState2) {
    ...
    public static class ChangeLocalPassword extends Function {
        ...
        public ChangeLocalPassword(InputKey inputKey2, byte[] bArr) {
            this.inputKey = inputKey2;
    ...
    public static class ExportEncryptedKey extends Function {
        ...
        public ExportEncryptedKey(InputKey inputKey2, byte[] bArr) {
            this.inputKey = inputKey2;
    ...
    public static class ExportKey extends Function {
        ...
        public ExportKey(InputKey inputKey2) {
            this.inputKey = inputKey2;
        }
    }
    ...
    public static class ExportPemKey extends Function {
        ...
        public ExportPemKey(InputKey inputKey2, byte[] bArr) {
            this.inputKey = inputKey2;
            this.keyPassword = bArr;
        }
    }
    ...
    public static class GenericGetAccountState extends Function {
        ...
        public GenericGetAccountState(AccountAddress accountAddress2) {
    ...
    public static class ImportEncryptedKey extends Function {
        ...
        public ImportEncryptedKey(byte[] bArr, byte[] bArr2, ExportedEncryptedKey exportedEncryptedKey2) {
            this.localPassword = bArr;
            this.keyPassword = bArr2;
            this.exportedEncryptedKey = exportedEncryptedKey2;
        }
    }
    ...
    public static class ImportKey extends Function {
        ...
        public ImportKey(byte[] bArr, byte[] bArr2, ExportedKey exportedKey2) {
            this.localPassword = bArr;
            this.mnemonicPassword = bArr2;
            this.exportedKey = exportedKey2;
        }
    }
    ...
    public static class OnLiteServerQueryError extends Function {
        ...
        public OnLiteServerQueryError(long j, Error error2) {
            this.id = j;
            this.error = error2;
        }
    }
    ...
    public static class OptionsSetConfig extends Function {
        ...
        public OptionsSetConfig(Config config2) {
            this.config = config2;
        }
    }
    ...
    public static class OptionsValidateConfig extends Function {
        ...
        public OptionsValidateConfig(Config config2) {
            this.config = config2;
        }
    }
    ...
    public static class RawGetAccountState extends Function {
        ...
        public RawGetAccountState(AccountAddress accountAddress2) {
            this.accountAddress = accountAddress2;
        }
    }
    ...
    public static class RawGetTransactions extends Function {
        ...
        public RawGetTransactions(AccountAddress accountAddress2, InternalTransactionId internalTransactionId) {
            this.accountAddress = accountAddress2;
    ...
    public static class SetLogStream extends Function {
        ...
        public SetLogStream(LogStream logStream2) {
            this.logStream = logStream2;
        }
    }
    ...
    public static class SmcLoad extends Function {
        ...
        public SmcLoad(AccountAddress accountAddress2) {
            this.accountAddress = accountAddress2;
        }
    }
    ...
    public static class TestWalletGetAccountState extends Function {
        ...
        public TestWalletGetAccountState(AccountAddress accountAddress2) {
            this.accountAddress = accountAddress2;
        }
    }
    ...
    public static class WalletGetAccountState extends Function {
        ...
        public WalletGetAccountState(AccountAddress accountAddress2) {
            this.accountAddress = accountAddress2;
        }
    }
