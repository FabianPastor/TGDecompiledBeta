...
public final class DateTimeFormatterBuilder {
    ...
    static final class ReducedPrinterParser extends NumberPrinterParser {
        ...
        public /* synthetic */ void m510xdf3a601e(DateTimeParseContext context, long initialValue, int errorPos, int successPos, Chronology _unused) {
    ...
    static final class LocalizedOffsetIdPrinterParser implements DateTimePrinterParser {
        ...
        public int parse(DateTimeParseContext context, CharSequence text, int position) {
            ...
            if (this.style == TextStyle.FULL) {
                ...
                if (h1 >= 0 && h2 >= 0) {
                    ...
                    if (charSequence.charAt(pos7) != 58) {
                        ...
                        int pos9 = h4 + 1;
                        int pos10 = getDigit(charSequence, h4);
                        if (m12 < 0 || pos10 < 0) {
                            return position ^ -1;
                        }
                        int m2 = (m12 * 10) + pos10;
            ...
            int pos11 = pos5 + 1;
            int h5 = getDigit(charSequence, pos5);
            if (h5 < 0) {
                return position ^ -1;
            }
            if (pos11 < end) {
                int h22 = getDigit(charSequence, pos11);
                if (h22 >= 0) {
                    pos11++;
                    h5 = (h5 * 10) + h22;
                }
                if (pos11 + 2 < end && charSequence.charAt(pos11) == ':' && pos11 + 2 < end && charSequence.charAt(pos11) == ':') {
                    int m13 = getDigit(charSequence, pos11 + 1);
                    int m22 = getDigit(charSequence, pos11 + 2);
                    if (m13 >= 0 && m22 >= 0) {
                        m = (m13 * 10) + m22;
                        pos11 += 3;
                        if (pos11 + 2 < end && charSequence.charAt(pos11) == ':') {
                            int s12 = getDigit(charSequence, pos11 + 1);
                            int s22 = getDigit(charSequence, pos11 + 2);
                            if (s12 >= 0 && s22 >= 0) {
                                m1 = (s12 * 10) + s22;
                                pos = pos11 + 3;
                                pos2 = h5;
