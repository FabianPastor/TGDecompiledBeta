...
public final /* synthetic */ class y0 implements LongStream {
    final /* synthetic */ W2 a;

    private /* synthetic */ y0(W2 w2) {
        this.a = w2;
    }
    ...
    public /* synthetic */ boolean allMatch(LongPredicate longPredicate) {
        return this.a.i0(f0.b(longPredicate));
    }

    public /* synthetic */ boolean anyMatch(LongPredicate longPredicate) {
        return this.a.e0(f0.b(longPredicate));
    }
    ...
    public /* synthetic */ Object collect(Supplier supplier, ObjLongConsumer objLongConsumer, BiConsumer biConsumer) {
        return this.a.g0(q0.a(supplier), n0.b(objLongConsumer), CLASSNAMEy.b(biConsumer));
    }
    ...
    public /* synthetic */ LongStream filter(LongPredicate longPredicate) {
        return c(this.a.j0(f0.b(longPredicate)));
    }
    ...
    public /* synthetic */ LongStream flatMap(LongFunction longFunction) {
        return c(this.a.t(e0.b(longFunction)));
    }

    public /* synthetic */ void forEach(LongConsumer longConsumer) {
        this.a.i(c0.a(longConsumer));
    }

    public /* synthetic */ void forEachOrdered(LongConsumer longConsumer) {
        this.a.b0(c0.a(longConsumer));
    }
    ...
    public /* synthetic */ boolean noneMatch(LongPredicate longPredicate) {
        return this.a.f(f0.b(longPredicate));
    }
    ...
    public /* synthetic */ LongStream peek(LongConsumer longConsumer) {
        return c(this.a.s(c0.a(longConsumer)));
    }

    public /* synthetic */ long reduce(long j, LongBinaryOperator longBinaryOperator) {
        return this.a.B(j, b0.b(longBinaryOperator));
    }

    public /* synthetic */ OptionalLong reduce(LongBinaryOperator longBinaryOperator) {
        return A.d(this.a.l(b0.b(longBinaryOperator)));
    }
