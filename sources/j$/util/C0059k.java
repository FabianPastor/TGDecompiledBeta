...
public final /* synthetic */ class CLASSNAMEk {
    ...
    public static /* synthetic */ Spliterator c(java.util.Collection collection) {
        return collection instanceof Collection ? ((Collection) collection).spliterator() : collection instanceof LinkedHashSet ? CLASSNAMEp.a((LinkedHashSet) collection) : collection instanceof SortedSet ? L.a((SortedSet) collection) : collection instanceof Set ? Set.CC.$default$spliterator((java.util.Set) collection) : collection instanceof List ? List.CC.$default$spliterator((java.util.List) collection) : Collection.CC.$default$spliterator(collection);
    }
