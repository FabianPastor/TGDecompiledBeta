        ...
        switch (this.b) {
            ...
            case 1:
                ...
                if (interfaceCLASSNAMEe1 != null) {
                    try {
                        interfaceCLASSNAMEe1.moNUMsequential().d((j$.util.function.q) this.c);
                    } finally {
                        try {
            ...
            case 2:
                ...
                if (intStream != null) {
                    try {
                        intStream.moNUMsequential().U((j$.util.function.l) this.c);
                    } finally {
                        try {
                            intStream.close();
            ...
            default:
                ...
                if (u != null) {
                    try {
                        u.moNUMsequential().j((j$.util.function.f) this.c);
                    } finally {
                        try {
                            u.close();
