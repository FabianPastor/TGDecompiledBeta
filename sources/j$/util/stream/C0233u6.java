...
enum CLASSNAMEu6 {
    ...
    static {
        k = c(CLASSNAMEt6.SPLITERATOR);
        l = c(CLASSNAMEt6.STREAM);
        m = c(CLASSNAMEt6.OP);
        c(CLASSNAMEt6.TERMINAL_OP);
        c(CLASSNAMEt6.UPSTREAM_TERMINAL_OP);
        n = b();
        int i = l;
        o = i;
        int i2 = i << 1;
    ...
    private static CLASSNAMEs6 h(CLASSNAMEt6 t2) {
    ...
    public boolean f(int flags) {
        return (this.e & flags) == this.c;
    }

    /* access modifiers changed from: package-private */
    public boolean g(int flags) {
        int i = this.e;
        return (flags & i) == i;
    }

    private static int c(CLASSNAMEt6 t2) {
        int mask = 0;
    ...
    private static int e(int flags) {
        if (flags == 0) {
            return n;
        }
    ...
    static int a(int newStreamOrOpFlags, int prevCombOpFlags) {
        return (e(newStreamOrOpFlags) & prevCombOpFlags) | newStreamOrOpFlags;
    }

    static int j(int combOpFlags) {
        return ((combOpFlags ^ -1) >> 1) & o & combOpFlags;
    }

    static int i(int streamFlags) {
        return k & streamFlags;
    }

    static int d(Spliterator spliterator) {
