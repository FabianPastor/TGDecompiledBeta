...
public final /* synthetic */ class Q1 {
    ...
    public static R1.b k(R1.b bVar, long j, long j2, x xVar) {
        ...
        j4.m(j3);
        for (int i = 0; ((long) i) < j && aVar.n(CLASSNAMEg0.a); i++) {
        }
        for (int i2 = 0; ((long) i2) < j3 && aVar.n(j4); i2++) {
        }
        j4.l();
        return j4.a();
    }
    ...
    public static R1.c l(R1.c cVar, long j, long j2, x xVar) {
        ...
        R1.a.b p = S1.p(j3);
        p.m(j3);
        for (int i = 0; ((long) i) < j && bVar.g(CLASSNAMEh0.a); i++) {
        }
        for (int i2 = 0; ((long) i2) < j3 && bVar.g(p); i2++) {
        }
        p.l();
        return p.a();
    }
    ...
    public static R1.d m(R1.d dVar, long j, long j2, x xVar) {
        ...
        R1.a.c q = S1.q(j3);
        q.m(j3);
        for (int i = 0; ((long) i) < j && cVar.i(CLASSNAMEi0.a); i++) {
        }
        for (int i2 = 0; ((long) i2) < j3 && cVar.i(q); i2++) {
        }
        q.l();
        return q.a();
    }
    ...
    public static R1 n(R1 r1, long j, long j2, x xVar) {
        ...
        R1.a d = S1.d(j3, xVar);
        d.m(j3);
        for (int i = 0; ((long) i) < j && spliterator.b(CLASSNAMEf0.a); i++) {
        }
