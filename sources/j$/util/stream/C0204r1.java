...
class CLASSNAMEr1 extends CLASSNAMEs5 {
    ...
    public CLASSNAMEt3 G0(CLASSNAMEq4 helper, Spliterator spliterator, C c) {
        if (CLASSNAMEu6.DISTINCT.f(helper.r0())) {
    ...
    public G5 J0(int flags, G5 sink) {
        sink.getClass();
        if (CLASSNAMEu6.DISTINCT.f(flags)) {
            return sink;
        }
        return CLASSNAMEu6.SORTED.f(flags) ? new CLASSNAMEp1(this, sink) : new CLASSNAMEq1(this, sink);
    }
}
