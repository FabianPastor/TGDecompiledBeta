...
abstract class CLASSNAMEh1 extends CLASSNAMEq4 implements CLASSNAMEl1 {
    ...
    CLASSNAMEh1(CLASSNAMEh1 previousStage, int opFlags) {
        if (!previousStage.i) {
            ...
            this.f = CLASSNAMEu6.a(opFlags, previousStage.f);
    ...
    private j$.util.Spliterator K0(int r9) {
        ...
        L_0x0064:
            ...
            r1.e = r2
            int r2 = r3.f
            int r2 = j$.util.stream.CLASSNAMEu6.a(r5, r2)
            r1.f = r2
            r3 = r1
            j$.util.stream.h1 r1 = r1.d
            r2 = r6
        ...
        L_0x0075:
            ...
            int r1 = r8.f
            int r1 = j$.util.stream.CLASSNAMEu6.a(r9, r1)
            r8.f = r1
        L_0x007f:
            return r0
        L_0x0080:
    ...
    public final void c(G5 wrappedSink, Spliterator spliterator) {
        ...
        if (!CLASSNAMEu6.SHORT_CIRCUIT.f(r0())) {
    ...
    public final boolean B0() {
        return CLASSNAMEu6.ORDERED.f(this.f);
    }
