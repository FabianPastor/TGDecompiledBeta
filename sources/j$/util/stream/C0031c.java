...
abstract class CLASSNAMEc extends CLASSNAMEz2 implements CLASSNAMEg {
    ...
    /* access modifiers changed from: package-private */
    public final B1 p0(y yVar, boolean z, l lVar) {
        if (this.a.k) {
            return z0(this, yVar, z, lVar);
        }
        CLASSNAMEt1 t0 = t0(q0(yVar), lVar);
        t0.getClass();
        n0(v0(t0), yVar);
        return t0.a();
    }
    ...
    public final B1 y0(l lVar) {
        if (!this.h) {
            ...
            return E0(cVar, cVar.I0(0), lVar);
        }
        throw new IllegalStateException("stream has already been operated upon or closed");
    }

    /* access modifiers changed from: package-private */
    public abstract B1 z0(CLASSNAMEz2 z2Var, y yVar, boolean z, l lVar);
}
