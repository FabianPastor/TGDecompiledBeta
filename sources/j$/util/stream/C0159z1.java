...
abstract class CLASSNAMEz1<E_IN> extends CLASSNAMEh1<E_IN, Integer, C1> implements C1 {
    ...
    class d extends k<Integer> {
        ...
        class a extends A2.b<Integer> {
            ...
            public void accept(int i) {
                this.a.accept(((CLASSNAMEe0) d.this.l).a(i));
            }
        }
    ...
    public final C1 distinct() {
        return ((CLASSNAMEy2) ((CLASSNAMEy2) F(CLASSNAMEd.a)).distinct()).m(J.a);
    }

    public final q findAny() {
        return (q) w0(new CLASSNAMEt1(false, U2.INT_VALUE, q.a(), R0.a, Y.a));
    }

    public final q findFirst() {
        return (q) w0(new CLASSNAMEt1(true, U2.INT_VALUE, q.a(), R0.a, Y.a));
    }
    ...
    public final int sum() {
        return ((Integer) w0(new CLASSNAMEk2(U2.INT_VALUE, L.a, 0))).intValue();
    }

    public final n summaryStatistics() {
        return (n) j0(CLASSNAMEd1.a, CLASSNAMEh.a, CLASSNAMEa1.a);
    }
