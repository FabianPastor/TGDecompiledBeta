...
abstract class CLASSNAMEy2 {
    ...
    static CLASSNAMEt1 d(long j, l lVar) {
        return (j < 0 || j >= NUM) ? new CLASSNAMEu2() : new CLASSNAMEc2(j, lVar);
    }

    public static B1 e(CLASSNAMEz2 z2Var, y yVar, boolean z, l lVar) {
        long q0 = z2Var.q0(yVar);
        if (q0 < 0 || !yVar.hasCharacteristics(16384)) {
            B1 b1 = (B1) new I1(z2Var, lVar, yVar).invoke();
            return z ? l(b1, lVar) : b1;
        } else if (q0 < NUM) {
            Object[] objArr = (Object[]) lVar.apply((int) q0);
    ...
    public static B1 l(B1 b1, l lVar) {
        if (b1.p() <= 0) {
            return b1;
        }
        long count = b1.count();
