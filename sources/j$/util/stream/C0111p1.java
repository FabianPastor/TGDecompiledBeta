...
public abstract /* synthetic */ class CLASSNAMEp1 {
    ...
    public static Object[] g(A1 a1, l lVar) {
        if (R4.a) {
            R4.a(a1.getClass(), "{0} calling Node.OfPrimitive.asArray");
            throw null;
        } else if (a1.count() < NUM) {
            Object[] objArr = (Object[]) lVar.apply((int) a1.count());
            a1.i(objArr, 0);
            return objArr;
        } else {
    ...
    public static CLASSNAMEv1 n(CLASSNAMEv1 v1Var, long j, long j2, l lVar) {
    ...
    public static CLASSNAMEx1 o(CLASSNAMEx1 x1Var, long j, long j2, l lVar) {
    ...
    public static CLASSNAMEz1 p(CLASSNAMEz1 z1Var, long j, long j2, l lVar) {
    ...
    public static B1 q(B1 b1, long j, long j2, l lVar) {
        if (j == 0 && j2 == b1.count()) {
            return b1;
        }
        y spliterator = b1.spliterator();
        long j3 = j2 - j;
        CLASSNAMEt1 d = CLASSNAMEy2.d(j3, lVar);
        d.n(j3);
    ...
    public static O4 x(x xVar, CLASSNAMEl1 l1Var) {
        xVar.getClass();
        l1Var.getClass();
        return new CLASSNAMEm1(CLASSNAMEf4.REFERENCE, l1Var, new CLASSNAMEo(l1Var, xVar));
    }
