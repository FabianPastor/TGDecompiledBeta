...
abstract class CLASSNAMEh1<E_IN, E_OUT, S extends CLASSNAMEl1<E_OUT, S>> extends T1<E_OUT> implements CLASSNAMEl1<E_OUT, S> {
    ...
    private final CLASSNAMEh1 var_a;
    ...
    CLASSNAMEh1(CLASSNAMEh1 h1Var, int i2) {
        if (!h1Var.h) {
            ...
            CLASSNAMEh1 h1Var2 = h1Var.var_a;
            this.var_a = h1Var2;
            if (F0()) {
                h1Var2.i = true;
            }
    ...
    public Spliterator E0(T1 t1, Spliterator spliterator) {
        return D0(t1, spliterator, CLASSNAMEj.var_a).spliterator();
    }
    ...
    public final Spliterator v0(Spliterator spliterator) {
        ...
        return J0(this, new CLASSNAMEl(spliterator), this.var_a.k);
    }
    ...
    public final Object w0(g3 g3Var) {
        if (!this.h) {
            this.h = true;
            return this.var_a.k ? g3Var.c(this, H0(g3Var.b())) : g3Var.d(this, H0(g3Var.b()));
        }
        throw new IllegalStateException("stream has already been operated upon or closed");
    }
    ...
    public final R1 x0(x xVar) {
        if (!this.h) {
            this.h = true;
            if (!this.var_a.k || this.b == null || !F0()) {
