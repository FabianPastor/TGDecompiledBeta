...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ void m4114lambda$new$0$orgwebrtcSurfaceTextureHelper(SurfaceTexture st) {
    ...
    public /* synthetic */ void m4118lambda$stopListening$1$orgwebrtcSurfaceTextureHelper() {
        this.listener = null;
    ...
    public /* synthetic */ void m4117lambda$setTextureSize$2$orgwebrtcSurfaceTextureHelper(int textureWidth2, int textureHeight2) {
    ...
    public /* synthetic */ void m4113lambda$forceFrame$3$orgwebrtcSurfaceTextureHelper() {
        this.hasPendingTexture = true;
        tryDeliverTextureFrame();
    }

    /* renamed from: lambda$setFrameRotation$4$org-webrtc-SurfaceTextureHelper  reason: not valid java name */
    public /* synthetic */ void m4116lambda$setFrameRotation$4$orgwebrtcSurfaceTextureHelper(int rotation) {
    ...
    public /* synthetic */ void m4115lambda$returnTextureFrame$5$orgwebrtcSurfaceTextureHelper() {
    ...
    public /* synthetic */ void m4112lambda$dispose$6$orgwebrtcSurfaceTextureHelper() {
