...
public class EglRenderer implements VideoSink {
    ...
    public /* synthetic */ void m4103lambda$init$0$orgwebrtcEglRenderer(EglBase.Context sharedContext, int[] configAttributes) {
    ...
    public /* synthetic */ void m4104lambda$release$1$orgwebrtcEglRenderer(CountDownLatch eglCleanupBarrier) {
    ...
    public /* synthetic */ void m4105lambda$release$2$orgwebrtcEglRenderer(Looper renderLooper) {
    ...
    public /* synthetic */ void m4100lambda$addFrameListener$3$orgwebrtcEglRenderer(RendererCommon.GlDrawer drawerParam, FrameListener listener, float scale, boolean applyFpsReduction) {
    ...
    public /* synthetic */ void m4107lambda$removeFrameListener$4$orgwebrtcEglRenderer(CountDownLatch latch, FrameListener listener) {
        latch.countDown();
    ...
    public /* synthetic */ void m4106lambda$releaseEglSurface$5$orgwebrtcEglRenderer(boolean background, Runnable completionCallback) {
    ...
    public void m4101lambda$clearImage$6$orgwebrtcEglRenderer(float r, float g, float b, float a) {
        EglBase eglBase2 = this.eglBase;
    ...
    public /* synthetic */ void m4102lambda$getTexture$7$orgwebrtcEglRenderer(GlGenericDrawer.TextureCallback callback) {
