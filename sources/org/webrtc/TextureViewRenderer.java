...
public class TextureViewRenderer extends TextureView implements TextureView.SurfaceTextureListener, VideoSink, RendererCommon.RendererEvents {
    ...
    public static class TextureEglRenderer extends EglRenderer implements TextureView.SurfaceTextureListener {
        ...
        public /* synthetic */ void m4124xd9a95a80() {
    ...
    public /* synthetic */ void m4122lambda$onFrameResolutionChanged$0$orgwebrtcTextureViewRenderer(int videoWidth2, int videoHeight2, int rotatedWidth, int rotatedHeight) {
    ...
    public /* synthetic */ void m4123lambda$updateVideoSizes$1$orgwebrtcTextureViewRenderer(int rotatedWidth, int rotatedHeight) {
        this.updateScreenRunnable = null;
        this.rotatedFrameWidth = rotatedWidth;
        this.rotatedFrameHeight = rotatedHeight;
        updateSurfaceSize();
    ...
    public void setRotateTextureWitchScreen(boolean rotateTextureWitchScreen2) {
        if (this.rotateTextureWitchScreen != rotateTextureWitchScreen2) {
            this.rotateTextureWitchScreen = rotateTextureWitchScreen2;
            requestLayout();
        }
    }
