...
public class BrightnessControlCell extends FrameLayout {
    ...
    class C10992 implements SeekBarViewDelegate {
        C10992() {
        }
    ...
    public BrightnessControlCell(Context context) {
        ...
        this.leftImageView.setImageResource(C0500R.drawable.brightness_low);
        ...
        this.seekBarView.setDelegate(new C10992());
        ...
        this.rightImageView.setImageResource(C0500R.drawable.brightness_high);
