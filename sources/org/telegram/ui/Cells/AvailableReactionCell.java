...
public class AvailableReactionCell extends FrameLayout {
    ...
    public void bind(TLRPC.TL_availableReaction react2, boolean checked) {
        ...
        this.imageView.setImage(ImageLocation.getForDocument(react2.center_icon), "40_40_lastframe", "webp", (Drawable) DocumentObject.getSvgThumb(react2.static_icon, "windowBackgroundGray", 1.0f), (Object) react2);
