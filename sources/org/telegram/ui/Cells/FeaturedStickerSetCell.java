...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C09254 extends AnimatorListenerAdapter {
        C09254() {
        }
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C09243());
                ...
                this.currentAnimation.addListener(new C09254());
                this.currentAnimation.start();
                return;
            } else {
                return;
