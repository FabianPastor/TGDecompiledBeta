...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C09203 extends AnimatorListenerAdapter {
        C09203() {
        }
    ...
    class C09214 extends AnimatorListenerAdapter {
        C09214() {
        }
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C09203());
                ...
                this.currentAnimation.addListener(new C09214());
                this.currentAnimation.start();
                return;
            } else {
                return;
