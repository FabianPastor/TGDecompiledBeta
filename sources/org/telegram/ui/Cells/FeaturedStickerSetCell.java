...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C11083 extends AnimatorListenerAdapter {
        C11083() {
        }
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C11083());
                ...
                this.currentAnimation.addListener(new C11094());
                this.currentAnimation.start();
                return;
            } else {
                return;
