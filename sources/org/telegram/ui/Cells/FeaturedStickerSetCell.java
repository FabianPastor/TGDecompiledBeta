...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C05803 extends AnimatorListenerAdapter {
        C05803() {
        }
    ...
    class C05814 extends AnimatorListenerAdapter {
        C05814() {
        }
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C05803());
                ...
                this.currentAnimation.addListener(new C05814());
                this.currentAnimation.start();
                return;
            } else {
                return;
