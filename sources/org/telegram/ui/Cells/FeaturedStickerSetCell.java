...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    public FeaturedStickerSetCell(Context context) {
        ...
        addView(textView, LayoutHelper.createFrame(-2, -2.0f, i, LocaleController.isRTL ? 22.0f : 71.0f, 10.0f, LocaleController.isRTL ? 71.0f : 22.0f, 0.0f));
        ...
        addView(textView, LayoutHelper.createFrame(-2, -2.0f, i, LocaleController.isRTL ? 100.0f : 71.0f, 35.0f, LocaleController.isRTL ? 71.0f : 100.0f, 0.0f));
        ...
        addView(backupImageView, LayoutHelper.createFrame(48, 48.0f, i, f, 8.0f, f2, 0.0f));
        ...
        addView(textView, LayoutHelper.createFrame(-2, 28.0f, i3 | 48, LocaleController.isRTL ? 14.0f : 0.0f, 18.0f, LocaleController.isRTL ? 0.0f : 14.0f, 0.0f));
    ...
    public void setStickersSet(StickerSetCovered set, boolean divider, boolean unread) {
        ...
        TLObject thumb = set.cover != null ? FileLoader.getClosestPhotoSizeWithSize(set.cover.thumbs, 90) : null;
        if (thumb == null || thumb.location == null) {
            thumb = !set.covers.isEmpty() ? FileLoader.getClosestPhotoSizeWithSize(((Document) set.covers.get(0)).thumbs, 90) : null;
            if (thumb != null) {
        ...
        if (sameSet) {
            ...
            isStickerPackInstalled = DataQuery.getInstance(this.currentAccount).isStickerPackInstalled(set.set.id);
