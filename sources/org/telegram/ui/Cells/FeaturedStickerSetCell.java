...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C11084 extends AnimatorListenerAdapter {
        C11084() {
        }
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C11073());
                ...
                this.currentAnimation.addListener(new C11084());
                this.currentAnimation.start();
                return;
            } else {
                return;
