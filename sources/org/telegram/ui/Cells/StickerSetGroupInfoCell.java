...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        infoTextView.setText(LocaleController.getString("GroupStickersInfo", C0500R.string.GroupStickersInfo));
        ...
        this.addButton.setText(LocaleController.getString("ChooseStickerSet", C0500R.string.ChooseStickerSet).toUpperCase());
