...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        infoTextView.setText(LocaleController.getString("GroupStickersInfo", C0488R.string.GroupStickersInfo));
        ...
        this.addButton.setText(LocaleController.getString("ChooseStickerSet", C0488R.string.ChooseStickerSet).toUpperCase());
