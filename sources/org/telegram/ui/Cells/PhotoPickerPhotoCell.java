...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    class C07511 extends AnimatorListenerAdapter {
        C07511() {
        }
    ...
    public PhotoPickerPhotoCell(Context context, boolean zoom) {
        ...
        this.checkBox = new CheckBox(context, C0431R.drawable.checkbig);
    ...
    public void showCheck(boolean show) {
        ...
        this.animatorSet.addListener(new C07511());
    ...
    public void setImage(SearchImage searchImage) {
        Drawable thumb = getResources().getDrawable(C0431R.drawable.nophotos);
