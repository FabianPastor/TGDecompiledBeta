...
public class PhotoPickerPhotoCell extends FrameLayout {
    ...
    class C11271 extends AnimatorListenerAdapter {
        C11271() {
        }
    ...
    public PhotoPickerPhotoCell(Context context, boolean zoom) {
        ...
        this.checkBox = new CheckBox(context, C0505R.drawable.checkbig);
    ...
    public void showCheck(boolean show) {
        ...
        this.animatorSet.addListener(new C11271());
    ...
    public void setImage(SearchImage searchImage) {
        Drawable thumb = getResources().getDrawable(C0505R.drawable.nophotos);
