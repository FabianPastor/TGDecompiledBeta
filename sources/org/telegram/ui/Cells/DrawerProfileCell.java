...
public class DrawerProfileCell extends FrameLayout {
    ...
    public DrawerProfileCell(Context context) {
        ...
        this.shadowView.setImageResource(C0493R.drawable.bottom_shadow);
    ...
    public void setAccountsShowed(boolean value) {
        if (this.accountsShowed != value) {
            ...
            this.arrowView.setImageResource(this.accountsShowed ? C0493R.drawable.collapse_up : C0493R.drawable.collapse_down);
        }
    }
    ...
    public void setOnArrowClickListener(final OnClickListener onClickListener) {
        this.arrowView.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                DrawerProfileCell.this.arrowView.setImageResource(DrawerProfileCell.this.accountsShowed ? C0493R.drawable.collapse_up : C0493R.drawable.collapse_down);
