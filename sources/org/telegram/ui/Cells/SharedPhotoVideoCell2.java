    ...
    public void setMessageObject(MessageObject messageObject, int parentColumnsCount) {
        ...
        if (messageObject3 != null || messageObject2 != null) {
            if (messageObject3 == null || messageObject2 == null || messageObject3.getId() != messageObject.getId() || oldParentColumsCount != i) {
                ...
                int width = (int) (((float) (AndroidUtilities.displaySize.x / i)) / AndroidUtilities.density);
                ...
                if (!TextUtils.isEmpty(restrictionReason)) {
                    ...
                    if (messageObject2.mediaThumb == null) {
                        ...
                        if (thumb == null) {
                            ...
                            ImageLocation forDocument = ImageLocation.getForDocument(qualityThumb, document);
                    ...
                    if (!(messageObject2.messageOwner.media instanceof TLRPC.TL_messageMediaPhoto) || messageObject2.messageOwner.media.photo == null || messageObject2.photoThumbs.isEmpty()) {
                        ...
                        if (messageObject2.mediaThumb == null) {
                            ...
                            int stride4 = stride3;
                            TLRPC.PhotoSize currentPhotoObject = FileLoader.getClosestPhotoSizeWithSize(messageObject2.photoThumbs, stride4, false, currentPhotoObjectThumb2, false);
                            ...
                            if (messageObject2.strippedThumb != null) {
                                TLRPC.PhotoSize photoSize4 = currentPhotoObjectThumb;
                                TLRPC.PhotoSize photoSize5 = currentPhotoObject;
                                int i12 = stride4;
                                this.imageReceiver.setImage(ImageLocation.getForObject(currentPhotoObject, messageObject2.photoThumbsObject), imageFilter5, (ImageLocation) null, (String) null, messageObject2.strippedThumb, currentPhotoObject != null ? (long) currentPhotoObject.size : 0, (String) null, messageObject, messageObject.shouldEncryptPhotoOrVideo() ? 2 : 1);
                                String str5 = imageFilter5;
                            } else {
                                int i13 = stride4;
                                ...
                                sb2.append(imageFilter6);
                                sb2.append("_b");
                                String str6 = imageFilter6;
                                TLRPC.PhotoSize photoSize6 = currentPhotoObjectThumb3;
                                imageReceiver3.setImage(forObject, imageFilter6, forObject2, sb2.toString(), currentPhotoObject2 != null ? (long) currentPhotoObject2.size : 0, (String) null, messageObject, messageObject.shouldEncryptPhotoOrVideo() ? 2 : 1);
                            }
                        } else if (messageObject2.strippedThumb != null) {
                            ...
                            String imageFilter7 = imageFilter5;
                            sb3.append(imageFilter7);
                            sb3.append("_b");
                            imageReceiver4.setImage(imageLocation, imageFilter7, imageLocation2, sb3.toString(), (Drawable) null, 0, (String) null, messageObject, 0);
                        ...
                        TLRPC.PhotoSize photoSize7 = currentPhotoObjectThumb4;
