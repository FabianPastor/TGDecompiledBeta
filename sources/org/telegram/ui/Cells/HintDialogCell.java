...
public class HintDialogCell extends FrameLayout {
    ...
    public /* synthetic */ void m2805lambda$new$0$orgtelegramuiCellsHintDialogCell(float progress) {
    ...
    public void setColors(String textColorKey, String backgroundColorKey2) {
        this.nameTextView.setTextColor(Theme.getColor(textColorKey));
        this.backgroundColorKey = backgroundColorKey2;
        this.checkBox.setColor("dialogRoundCheckBox", backgroundColorKey2, "dialogRoundCheckBoxCheck");
    }
