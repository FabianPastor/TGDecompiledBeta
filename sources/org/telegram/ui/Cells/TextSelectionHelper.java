...
public abstract class TextSelectionHelper<Cell extends SelectableView> {
            ...
            if (TextSelectionHelper.this.scrolling && TextSelectionHelper.this.parentRecyclerView != null) {
                ...
                if (!TextSelectionHelper.this.multiselect) {
                    if (TextSelectionHelper.this.scrollDown) {
                        if (TextSelectionHelper.this.selectedView.getBottom() - dy < TextSelectionHelper.this.parentView.getMeasuredHeight()) {
                            dy = TextSelectionHelper.this.selectedView.getBottom() - TextSelectionHelper.this.parentView.getMeasuredHeight();
                        }
    ...
    public /* synthetic */ void m1558xb705f8cf(ValueAnimator animation) {
    ...
    public /* synthetic */ boolean m1556lambda$showActions$1$orgtelegramuiCellsTextSelectionHelper(View v, MotionEvent event) {
    ...
    public /* synthetic */ void m1557lambda$showActions$2$orgtelegramuiCellsTextSelectionHelper(View v) {
        copyText();
    }
    ...
    public class TextSelectionOverlay extends View {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:233:0x059d  */
        /* JADX WARNING: Removed duplicated region for block: B:238:0x05aa  */
        /* JADX WARNING: Removed duplicated region for block: B:243:0x05c2  */
        /* JADX WARNING: Removed duplicated region for block: B:244:0x05c5  */
        /* JADX WARNING: Removed duplicated region for block: B:268:0x061d  */
        /* JADX WARNING: Removed duplicated region for block: B:269:0x0633  */
        /* JADX WARNING: Removed duplicated region for block: B:272:0x063b  */
        ...
        public boolean onTouchEvent(android.view.MotionEvent r33) {
            ...
            L_0x034a:
                ...
                r30 = r10
                r10 = 10
                if (r11 >= r8) goto L_0x0356
                if (r3 < r6) goto L_0x0378
            L_0x0356:
                org.telegram.ui.Cells.TextSelectionHelper r8 = org.telegram.ui.Cells.TextSelectionHelper.this
                int r8 = r8.selectionStart
                if (r11 <= r8) goto L_0x035e
            ...
            L_0x0513:
                ...
                if (r14 != r13) goto L_0x0689
                org.telegram.ui.Cells.TextSelectionHelper r8 = org.telegram.ui.Cells.TextSelectionHelper.this
                int r8 = r8.selectionEnd
                int r8 = r13.getLineForOffset(r8)
                if (r10 == r8) goto L_0x053d
                if (r10 != r12) goto L_0x053d
                r29 = r1
                r30 = r3
                r27 = r10
                r28 = r11
            ...
            L_0x05c7:
                ...
                if (r5 <= r11) goto L_0x05d1
                if (r9 <= r4) goto L_0x05ea
            L_0x05d1:
                org.telegram.ui.Cells.TextSelectionHelper r11 = org.telegram.ui.Cells.TextSelectionHelper.this
                int r11 = r11.selectionEnd
                if (r5 >= r11) goto L_0x05d9
    ...
    public void copyText() {
        CharSequence str;
        if (isSelectionMode() && (str = getTextForCopy()) != null) {
    ...
    public void drawSelection(Canvas canvas, StaticLayout layout, int selectionStart2, int selectionEnd2) {
        ...
        int endLine = staticLayout.getLineForOffset(selectionEnd2);
        if (startLine == endLine) {
            drawLine(canvas, layout, startLine, selectionStart2, selectionEnd2);
            return;
        }
        int end = staticLayout.getLineEnd(startLine);
        if (staticLayout.getParagraphDirection(startLine) != -1 && end > 0) {
            end--;
            CharSequence text = layout.getText();
            int s = (int) staticLayout.getPrimaryHorizontal(end);
            if (staticLayout.isRtlCharAt(end)) {
                int endIndex2 = end;
                while (staticLayout.isRtlCharAt(endIndex2) && endIndex2 != 0) {
                    endIndex2--;
                }
                endIndex = (int) (staticLayout.getLineForOffset(endIndex2) == staticLayout.getLineForOffset(end) ? staticLayout.getPrimaryHorizontal(endIndex2 + 1) : staticLayout.getLineLeft(startLine));
            } else {
            ...
            if (end > 0 && end < text.length() && !Character.isWhitespace(text.charAt(end - 1))) {
                canvas.drawRect((float) l, (float) staticLayout.getLineTop(startLine), (float) r, (float) staticLayout.getLineBottom(startLine), this.selectionPaint);
            }
        }
        int end2 = end;
        Canvas canvas2 = canvas;
        StaticLayout staticLayout2 = layout;
        drawLine(canvas2, staticLayout2, startLine, selectionStart2, end2);
        drawLine(canvas2, staticLayout2, endLine, staticLayout.getLineStart(endLine), selectionEnd2);
        for (int i = startLine + 1; i < endLine; i++) {
            int s2 = (int) staticLayout.getLineLeft(i);
            int e = (int) staticLayout.getLineRight(i);
            canvas.drawRect((float) Math.min(s2, e), (float) staticLayout.getLineTop(i), (float) Math.max(s2, e), (float) staticLayout.getLineBottom(i), this.selectionPaint);
        }
    }
    ...
    private void drawLine(Canvas canvas, StaticLayout layout, int line, int start, int end) {
        ...
        if (this.path.lastBottom < ((float) layout.getLineBottom(line))) {
            int lineBottom = layout.getLineBottom(line);
            int lineTop = layout.getLineTop(line);
            canvas.save();
            canvas.scale(1.0f, ((float) (lineBottom - lineTop)) / (this.path.lastBottom - ((float) lineTop)), 0.0f, (float) lineTop);
    ...
    public static class ChatListTextSelectionHelper extends TextSelectionHelper<ChatMessageCell> {
        ...
        public /* synthetic */ void m1559x6ff5dada(boolean idChanged, ValueAnimator animation) {
