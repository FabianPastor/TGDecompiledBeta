...
public class PollEditTextCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.textView.measure(View.MeasureSpec.makeMeasureSpec(((size - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.dp(i3), NUM), View.MeasureSpec.makeMeasureSpec(0, 0));
