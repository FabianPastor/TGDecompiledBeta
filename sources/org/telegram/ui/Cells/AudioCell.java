...
public class AudioCell extends FrameLayout {
    ...
    public AudioCell(Context context) {
        ...
        this.playButton.setOnClickListener(new C10961());
    ...
    private void setPlayDrawable(boolean play) {
        ...
        Drawable drawable = getResources().getDrawable(play ? C0500R.drawable.audiosend_pause : C0500R.drawable.audiosend_play);
