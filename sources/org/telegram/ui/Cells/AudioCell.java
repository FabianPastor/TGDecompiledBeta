...
public class AudioCell extends FrameLayout {
    ...
    class C10971 implements OnClickListener {
        C10971() {
        }
    ...
    public AudioCell(Context context) {
        ...
        this.playButton.setOnClickListener(new C10971());
    ...
    private void setPlayDrawable(boolean play) {
        ...
        Drawable drawable = getResources().getDrawable(play ? C0501R.drawable.audiosend_pause : C0501R.drawable.audiosend_play);
