...
public class StickerSetCell extends FrameLayout {
    ...
    public /* synthetic */ void m1523lambda$setReorderable$0$orgtelegramuiCellsStickerSetCell(boolean reorderable) {
        if (!reorderable) {
            this.reorderButton.setVisibility(8);
        }
    }
    ...
    public /* synthetic */ void m1524lambda$setReorderable$1$orgtelegramuiCellsStickerSetCell(boolean reorderable) {
        if (reorderable) {
