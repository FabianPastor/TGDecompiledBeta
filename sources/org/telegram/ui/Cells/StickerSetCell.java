...
public class StickerSetCell extends FrameLayout {
    ...
    public /* synthetic */ void m1554lambda$setReorderable$0$orgtelegramuiCellsStickerSetCell(boolean reorderable) {
        if (!reorderable) {
            this.reorderButton.setVisibility(8);
        }
    }
    ...
    public /* synthetic */ void m1555lambda$setReorderable$1$orgtelegramuiCellsStickerSetCell(boolean reorderable) {
        if (reorderable) {
