    ...
    public void update(int mask) {
        if (this.currentUser != null) {
            ...
            if (this.currentStatus != null) {
                ...
                this.statusTextView.setTag(Theme.key_groupcreate_offlineText);
                this.statusTextView.setTextColor(Theme.getColor(Theme.key_groupcreate_offlineText));
                this.statusTextView.setText(LocaleController.getString("Bot", C0493R.string.Bot));
                ...
                this.statusTextView.setText(LocaleController.getString("Online", C0493R.string.Online));
            } else {
                this.statusTextView.setTag(Theme.key_groupcreate_offlineText);
                this.statusTextView.setTextColor(Theme.getColor(Theme.key_groupcreate_offlineText));
