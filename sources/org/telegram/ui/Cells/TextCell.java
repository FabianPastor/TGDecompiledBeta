...
public class TextCell extends FrameLayout {
    ...
    public TextCell(Context context, int left, boolean dialog) {
        this(context, left, dialog, (Theme.ResourcesProvider) null);
    }

    public TextCell(Context context, int left, boolean dialog, Theme.ResourcesProvider resourcesProvider2) {
        super(context);
        ...
        simpleTextView.setTextColor(Theme.getColor(dialog ? "dialogTextBlack" : "windowBackgroundWhiteBlackText", resourcesProvider2));
        ...
        simpleTextView2.setTextColor(Theme.getColor(dialog ? "dialogTextBlue2" : "windowBackgroundWhiteValueText", resourcesProvider2));
        ...
        rLottieImageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(dialog ? "dialogIcon" : "windowBackgroundWhiteGrayIcon", resourcesProvider2), PorterDuff.Mode.MULTIPLY));
    ...
    public void setPrioritizeTitleOverValue(boolean prioritizeTitleOverValue2) {
        this.prioritizeTitleOverValue = prioritizeTitleOverValue2;
        requestLayout();
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.prioritizeTitleOverValue) {
            this.textView.measure(View.MeasureSpec.makeMeasureSpec(width - AndroidUtilities.dp((float) (this.leftPadding + 71)), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), NUM));
            this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec((width - AndroidUtilities.dp((float) (this.leftPadding + 103))) - this.textView.getTextWidth(), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0f), NUM));
        } else {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.prioritizeTitleOverValue && !LocaleController.isRTL) {
            viewLeft2 = (width - this.valueTextView.getMeasuredWidth()) - AndroidUtilities.dp((float) this.leftPadding);
        }
