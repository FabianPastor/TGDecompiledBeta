...
public class TextCell extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int viewLeft = LocaleController.isRTL ? AndroidUtilities.dp(23.0f) : 0;
        ...
        if (this.imageView.getVisibility() == 0) {
            ...
            viewLeft = !LocaleController.isRTL ? AndroidUtilities.dp(21.0f) : (width - this.imageView.getMeasuredWidth()) - AndroidUtilities.dp(21.0f);
        ...
        if (this.valueImageView.getVisibility() == 0) {
            ...
            viewLeft = LocaleController.isRTL ? AndroidUtilities.dp(23.0f) : (width - this.valueImageView.getMeasuredWidth()) - AndroidUtilities.dp(23.0f);
    ...
    public void setColors(String icon, String text) {
        ...
        if (icon != null) {
            this.imageView.setColorFilter(new PorterDuffColorFilter(Theme.getColor(icon), Mode.MULTIPLY));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needDivider) {
            ...
            if (LocaleController.isRTL) {
                ...
                f2 = (float) AndroidUtilities.dp(this.imageView.getVisibility() == 0 ? 68.0f : 20.0f);
            }
