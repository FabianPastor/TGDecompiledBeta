    ...
    public void setSession(TLObject object, boolean divider) {
        ...
        if (object instanceof TL_authorization) {
            ...
            if ((session.flags & 1) != 0) {
                ...
                this.onlineTextView.setText(LocaleController.getString("Online", C0431R.string.Online));
            ...
            if ((session.flags & 2) == 0) {
                ...
                stringBuilder.append(LocaleController.getString("UnofficialApp", C0431R.string.UnofficialApp));
