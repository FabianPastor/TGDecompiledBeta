...
public class DialogsEmptyCell extends LinearLayout {
    ...
    public void setType(int r6) {
        ...
        L_0x0024:
            ...
            r6 = 2131626144(0x7f0e08a0, float:1.8879516E38)
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (i3 == 0) {
            i3 = (AndroidUtilities.displaySize.y - ActionBar.getCurrentActionBarHeight()) - (i4 >= 21 ? AndroidUtilities.statusBarHeight : 0);
        }
