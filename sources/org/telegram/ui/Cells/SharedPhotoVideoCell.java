...
public class SharedPhotoVideoCell extends FrameLayout {
    ...
    class C11281 implements OnClickListener {
        C11281() {
        }
    ...
    class C11292 implements OnLongClickListener {
        C11292() {
        }
    ...
    private class PhotoVideoView extends FrameLayout {
        ...
        public PhotoVideoView(Context context) {
            ...
            this.checkBox = new CheckBox(context, C0500R.drawable.round_check2);
    ...
    public SharedPhotoVideoCell(Context context) {
        ...
        for (int a = 0; a < 6; a++) {
            ...
            this.photoVideoViews[a].setOnClickListener(new C11281());
            this.photoVideoViews[a].setOnLongClickListener(new C11292());
        }
    }
        ...
        if (messageObject != null) {
            ...
            if (messageObject.isVideo()) {
                ...
                if (messageObject.getDocument().thumb != null) {
                    photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(C0500R.drawable.photo_placeholder_in), null, messageObject.getDocument().thumb.location, "b", null, 0);
                    return;
                } else {
                    photoVideoView.imageView.setImageResource(C0500R.drawable.photo_placeholder_in);
                    return;
                }
                ...
                photoVideoView.videoInfoContainer.setVisibility(4);
                photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(C0500R.drawable.photo_placeholder_in), null, FileLoader.getClosestPhotoSizeWithSize(messageObject.photoThumbs, 80).location, "b", null, 0);
                return;
            }
        }
        this.photoVideoViews[a].clearAnimation();
