...
public class SharedPhotoVideoCell extends FrameLayout {
    ...
    class C10902 implements OnLongClickListener {
        C10902() {
        }
    ...
    public SharedPhotoVideoCell(Context context) {
        ...
        for (int a = 0; a < 6; a++) {
            ...
            this.photoVideoViews[a].setOnClickListener(new C10891());
            this.photoVideoViews[a].setOnLongClickListener(new C10902());
        }
    }
        ...
        if (messageObject != null) {
            ...
            if (messageObject.isVideo()) {
                ...
                if (messageObject.getDocument().thumb != null) {
                    photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(C0493R.drawable.photo_placeholder_in), null, messageObject.getDocument().thumb.location, "b", null, 0);
                    return;
                } else {
                    photoVideoView.imageView.setImageResource(C0493R.drawable.photo_placeholder_in);
                    return;
                }
                ...
                photoVideoView.videoInfoContainer.setVisibility(4);
                photoVideoView.imageView.setImage(null, null, null, ApplicationLoader.applicationContext.getResources().getDrawable(C0493R.drawable.photo_placeholder_in), null, FileLoader.getClosestPhotoSizeWithSize(messageObject.photoThumbs, 80).location, "b", null, 0);
                return;
            }
        }
        this.photoVideoViews[a].clearAnimation();
