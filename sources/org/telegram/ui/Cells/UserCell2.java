...
public class UserCell2 extends FrameLayout {
    ...
    L_0x0175:
        ...
        r1.setTextColor(r2);
        r1 = r12.statusTextView;
        r2 = NUM; // 0x7f0d06df float:1.8745682E38 double:1.0531306466E-314;
        r3 = "Online";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r1.setText(r2);
    L_0x018a:
    ...
    L_0x020b:
        r0 = r12.statusTextView;
        r1 = NUM; // 0x7f0d05c3 float:1.8745106E38 double:1.0531305063E-314;
        r2 = "MegaPrivate";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setText(r1);
        goto L_0x0228;
    L_0x021a:
        r0 = r12.statusTextView;
        r1 = NUM; // 0x7f0d05c6 float:1.8745112E38 double:1.053130508E-314;
        r2 = "MegaPublic";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setText(r1);
    L_0x0228:
