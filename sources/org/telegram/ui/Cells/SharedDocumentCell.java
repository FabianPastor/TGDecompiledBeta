...
public class SharedDocumentCell extends FrameLayout implements FileDownloadProgressListener {
    ...
    private int[] icons = new int[]{C0501R.drawable.media_doc_blue, C0501R.drawable.media_doc_green, C0501R.drawable.media_doc_red, C0501R.drawable.media_doc_yellow};
    ...
    class C11271 implements ImageReceiverDelegate {
        C11271() {
        }
    ...
    public SharedDocumentCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(40, 40.0f, i, f, 8.0f, f2, 0.0f));
        this.thumbImageView.getImageReceiver().setDelegate(new C11271());
    ...
    public void setDocument(MessageObject messageObject, boolean divider) {
        ...
        if (messageObject == null || messageObject.getDocument() == null) {
            ...
            objArr[1] = LocaleController.formatString("formatDateAtTime", C0501R.string.formatDateAtTime, LocaleController.getInstance().formatterYear.format(new Date(date)), LocaleController.getInstance().formatterDay.format(new Date(date)));
    ...
    public void updateFileExistIcon() {
        ...
        this.statusImageView.setImageResource(this.loading ? C0501R.drawable.media_doc_pause : C0501R.drawable.media_doc_load);
