...
public class WallpaperCell extends FrameLayout {
    ...
    public /* synthetic */ void m1539lambda$new$0$orgtelegramuiCellsWallpaperCell(WallpaperView wallpaperView, int num, View v) {
    ...
    public /* synthetic */ boolean m1540lambda$new$1$orgtelegramuiCellsWallpaperCell(WallpaperView wallpaperView, int num, View v) {
