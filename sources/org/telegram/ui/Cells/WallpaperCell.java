...
public class WallpaperCell extends FrameLayout {
    ...
    private class WallpaperView extends FrameLayout {
        ...
        public void setWallpaper(Object object, Object selectedWallpaper, Drawable themedWallpaper, boolean themed) {
            ...
            String imageFilter = 180 + "_" + 180;
            String thumbFilter = 100 + "_" + 100 + "_b";
            if (obj instanceof TLRPC.TL_wallPaper) {
                TLRPC.TL_wallPaper wallPaper = (TLRPC.TL_wallPaper) obj;
                TLRPC.PhotoSize thumb = FileLoader.getClosestPhotoSizeWithSize(wallPaper.document.thumbs, AndroidUtilities.dp((float) 100));
                TLRPC.PhotoSize image2 = FileLoader.getClosestPhotoSizeWithSize(wallPaper.document.thumbs, AndroidUtilities.dp((float) 180));
                if (image2 == thumb) {
                    image2 = null;
                }
                long size2 = image2 != null ? (long) image2.size : wallPaper.document.size;
                if (wallPaper.pattern) {
                    ...
                    if (image2 != null) {
                        this.imageView.setImage(ImageLocation.getForDocument(image2, wallPaper.document), imageFilter, ImageLocation.getForDocument(thumb, wallPaper.document), (String) null, "jpg", size2, 1, wallPaper);
                    } else {
                        this.imageView.setImage(ImageLocation.getForDocument(thumb, wallPaper.document), imageFilter, (ImageLocation) null, (String) null, "jpg", size2, 1, wallPaper);
                    }
                ...
                if (wallPaper2.path == null && wallPaper2.pattern == null && !"d".equals(wallPaper2.slug)) {
                    ...
                    if ("d".equals(wallPaper2.slug)) {
                        ...
                        WallpapersListActivity.ColorWallpaper colorWallpaper = wallPaper2;
                    } else if (wallPaper2.path != null) {
                        this.imageView.setImage(wallPaper2.path.getAbsolutePath(), imageFilter, (Drawable) null);
                        WallpapersListActivity.ColorWallpaper colorWallpaper2 = wallPaper2;
                    } else {
                        TLRPC.PhotoSize thumb2 = FileLoader.getClosestPhotoSizeWithSize(wallPaper2.pattern.document.thumbs, 100);
                        WallpapersListActivity.ColorWallpaper wallPaper3 = wallPaper2;
                        this.imageView.setImage(ImageLocation.getForDocument(thumb2, wallPaper2.pattern.document), imageFilter, (ImageLocation) null, (String) null, "jpg", thumb2 != null ? (long) thumb2.size : wallPaper2.pattern.document.size, 1, wallPaper2.pattern);
                        this.imageView.getImageReceiver().setAlpha(Math.abs(wallPaper3.intensity));
                        if (Build.VERSION.SDK_INT < 29 || wallPaper3.gradientColor2 == 0) {
                ...
                WallpapersListActivity.FileWallpaper wallPaper4 = (WallpapersListActivity.FileWallpaper) obj;
                if (wallPaper4.originalPath != null) {
                    this.imageView.setImage(wallPaper4.originalPath.getAbsolutePath(), imageFilter, (Drawable) null);
                } else if (wallPaper4.path != null) {
                    this.imageView.setImage(wallPaper4.path.getAbsolutePath(), imageFilter, (Drawable) null);
                } else if ("t".equals(wallPaper4.slug)) {
                    BackupImageView backupImageView = this.imageView;
                    backupImageView.setImageDrawable(Theme.getThemedWallpaper(true, backupImageView));
                } else {
                    this.imageView.setImageResource(wallPaper4.thumbResId);
                }
            } else if (obj instanceof MediaController.SearchImage) {
                MediaController.SearchImage wallPaper5 = (MediaController.SearchImage) obj;
                if (wallPaper5.photo != null) {
                    TLRPC.PhotoSize thumb3 = FileLoader.getClosestPhotoSizeWithSize(wallPaper5.photo.sizes, AndroidUtilities.dp((float) 100));
                    TLRPC.PhotoSize image3 = FileLoader.getClosestPhotoSizeWithSize(wallPaper5.photo.sizes, AndroidUtilities.dp((float) 180));
                    if (image3 == thumb3) {
                        image = null;
                    } else {
                        image = image3;
                    ...
                    TLRPC.PhotoSize photoSize = thumb3;
                    TLRPC.PhotoSize photoSize2 = image;
                    this.imageView.setImage(ImageLocation.getForPhoto(image, wallPaper5.photo), imageFilter, ImageLocation.getForPhoto(thumb3, wallPaper5.photo), thumbFilter, "jpg", (long) size, 1, wallPaper5);
                    return;
                }
                this.imageView.setImage(wallPaper5.thumbUrl, imageFilter, (Drawable) null);
            } else {
    ...
    public /* synthetic */ void m2837lambda$new$0$orgtelegramuiCellsWallpaperCell(WallpaperView wallpaperView, int num, View v) {
    ...
    public /* synthetic */ boolean m2838lambda$new$1$orgtelegramuiCellsWallpaperCell(WallpaperView wallpaperView, int num, View v) {
