...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    class C10811 implements OnClickListener {
        C10811() {
        }
    ...
    public PhotoPickerAlbumsCell(Context context) {
        ...
        for (int a = 0; a < 4; a++) {
            ...
            this.albumViews[a].setOnClickListener(new C10811());
        }
    }
    ...
    public void setAlbum(int a, AlbumEntry albumEntry) {
        ...
        if (albumEntry != null) {
            ...
            if (albumEntry.coverPhoto == null || albumEntry.coverPhoto.path == null) {
                albumView.imageView.setImageResource(C0493R.drawable.nophotos);
            } else {
                albumView.imageView.setOrientation(albumEntry.coverPhoto.orientation, true);
                if (albumEntry.coverPhoto.isVideo) {
                    albumView.imageView.setImage("vthumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(C0493R.drawable.nophotos));
                } else {
                    albumView.imageView.setImage("thumb://" + albumEntry.coverPhoto.imageId + ":" + albumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(C0493R.drawable.nophotos));
                }
            }
