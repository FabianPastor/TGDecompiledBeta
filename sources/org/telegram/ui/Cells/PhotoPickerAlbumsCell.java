...
public class PhotoPickerAlbumsCell extends FrameLayout {
    ...
    private class AlbumView extends FrameLayout {
        ...
        public AlbumView(org.telegram.ui.Cells.PhotoPickerAlbumsCell r18, android.content.Context r19) {
            /*
                ...
                r6 = 2131165262(0x7var_e, float:1.7944736E38)
                ...
                r6.<init>(r1)
                r0.selector = r6
                android.graphics.drawable.Drawable r5 = org.telegram.ui.ActionBar.Theme.getSelectorDrawable(r5)
                r6.setBackgroundDrawable(r5)
                android.view.View r5 = r0.selector
                android.widget.FrameLayout$LayoutParams r3 = org.telegram.ui.Components.LayoutHelper.createFrame(r3, r4)
                r0.addView(r5, r3)
                return
            */
    ...
    public PhotoPickerAlbumsCell(Context context) {
        ...
        for (int a = 0; a < 4; a++) {
            ...
            this.albumViews[a].setOnClickListener(new PhotoPickerAlbumsCell$$ExternalSyntheticLambda0(this));
        }
    }

    /* renamed from: lambda$new$0$org-telegram-ui-Cells-PhotoPickerAlbumsCell  reason: not valid java name */
    public /* synthetic */ void m1547lambda$new$0$orgtelegramuiCellsPhotoPickerAlbumsCell(View v) {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(4.0f) + itemWidth, NUM));
    }
}
