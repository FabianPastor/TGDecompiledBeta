...
public class ProfileSearchCell extends BaseCell implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void buildLayout() {
        ...
        int statusWidth4 = statusWidth - (getPaddingLeft() + getPaddingRight());
        if (this.drawCount) {
        ...
        CharSequence nameStringFinal2 = TextUtils.ellipsize(nameString, currentNamePaint, (float) (this.nameWidth - AndroidUtilities.dp(12.0f)), TextUtils.TruncateAt.END);
        if (nameStringFinal2 != null) {
            nameStringFinal = Emoji.replaceEmoji(nameStringFinal2, currentNamePaint.getFontMetricsInt(), AndroidUtilities.dp(20.0f), false);
        } else {
            nameStringFinal = nameStringFinal2;
        }
        StaticLayout staticLayout = r6;
        int statusWidth5 = statusWidth2;
        StaticLayout staticLayout2 = new StaticLayout(nameStringFinal, currentNamePaint, this.nameWidth, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        if (LocaleController.isRTL) {
            if (this.nameLayout.getLineCount() <= 0) {
                ...
                if (widthpx < ((double) i)) {
                    ...
                    CharSequence charSequence = nameString;
                    double d2 = (double) i;
                    Double.isNaN(d2);
                    Double.isNaN(d);
    ...
    public void update(int mask) {
        ...
        if (user3 != null) {
            ...
            if (UserObject.isReplyUser(this.user)) {
                ...
                this.avatarImage.setImage(ImageLocation.getForUserOrChat(this.user, 1), "50_50", ImageLocation.getForUserOrChat(this.user, 2), "50_50", thumb2, (Object) this.user, 0);
            }
        } else {
            TLRPC.Chat chat2 = this.chat;
            if (chat2 != null) {
                ...
                this.avatarImage.setImage(ImageLocation.getForUserOrChat(this.chat, 1), "50_50", ImageLocation.getForUserOrChat(this.chat, 2), "50_50", thumb, (Object) this.chat, 0);
            } else {
            ...
            if (this.nameLayout != null) {
                ...
                if (z || this.drawPremium) {
                    ...
                    if (!LocaleController.isRTL) {
                        ...
                        x = (this.nameLeft - AndroidUtilities.dp(6.0f)) - drawable.getIntrinsicWidth();
                    } else {
                    ...
                    if (this.drawCheck) {
                        ...
                        setDrawableBounds(drawable, x, this.nameTop + AndroidUtilities.dp(1.5f));
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (this.drawCheck) {
            builder.append(", ");
            builder.append(LocaleController.getString("AccDescrVerified", NUM));
            builder.append("\n");
        }
        if (this.statusLayout != null) {
            if (builder.length() > 0) {
