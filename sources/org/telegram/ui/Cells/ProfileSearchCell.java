...
public class ProfileSearchCell extends BaseCell {
    ...
    public void setException(NotificationException exception, CharSequence name) {
        String text;
    ...
    public void buildLayout() {
        ...
        if (LocaleController.isRTL) {
            avatarLeft = (getMeasuredWidth() - AndroidUtilities.dp(AndroidUtilities.isTablet() ? 65.0f : 61.0f)) - getPaddingRight();
        } else {
            avatarLeft = AndroidUtilities.dp(AndroidUtilities.isTablet() ? 13.0f : 9.0f) + getPaddingLeft();
        }
        ...
        this.onlineLeft += getPaddingLeft();
