...
public class AboutLinkCell extends FrameLayout {
    ...
    public AboutLinkCell(Context context, BaseFragment fragment) {
        this(context, fragment, (Theme.ResourcesProvider) null);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AboutLinkCell(Context context, BaseFragment fragment, Theme.ResourcesProvider resourcesProvider2) {
        super(context);
        ...
        this.SPACE = (float) AndroidUtilities.dp(3.0f);
        this.longPressedRunnable = new Runnable() {
            public void run() {
                String url;
            ...
            public /* synthetic */ void m2778lambda$run$0$orgtelegramuiCellsAboutLinkCell$3(ClickableSpan pressedLinkFinal, String url, DialogInterface dialog, int which) {
                if (which == 0) {
            ...
            public /* synthetic */ void m2779lambda$run$1$orgtelegramuiCellsAboutLinkCell$3(DialogInterface di) {
        ...
        AnonymousClass1 r8 = new FrameLayout(context2) {
        ...
        shadowDrawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor("windowBackgroundWhite", resourcesProvider3), PorterDuff.Mode.SRC_ATOP));
        ...
        AnonymousClass2 r6 = new TextView(context2) {
        ...
        mutate.setColorFilter(new PorterDuffColorFilter(Theme.getColor("windowBackgroundWhite", resourcesProvider3), PorterDuff.Mode.MULTIPLY));
    ...
    public /* synthetic */ void m2776lambda$new$0$orgtelegramuiCellsAboutLinkCell(View e) {
    ...
    public /* synthetic */ void m2777lambda$updateCollapse$1$orgtelegramuiCellsAboutLinkCell(AtomicReference lastValue, float fromValue, float toValue, SpringInterpolator spring, ValueAnimator a) {
