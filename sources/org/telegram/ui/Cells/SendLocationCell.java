...
public class SendLocationCell extends FrameLayout {
    ...
    public SendLocationCell(Context context, boolean live2, Theme.ResourcesProvider resourcesProvider2) {
        super(context);
        ...
        Drawable circle = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.dp(42.0f), getThemedColor(z ? str : "location_sendLocationBackground"), getThemedColor(!z ? "location_sendLocationBackground" : str));
        if (z) {
            this.rect = new RectF();
