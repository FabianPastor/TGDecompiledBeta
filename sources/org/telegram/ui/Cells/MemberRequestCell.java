...
public class MemberRequestCell extends FrameLayout {
    ...
    public MemberRequestCell(Context context, OnClickListener clickListener, boolean isChannel) {
        ...
        int i3 = 0;
        addButton.setBackground(Theme.AdaptiveRipple.filledRect("featuredStickers_addButton", 4.0f));
    ...
    public /* synthetic */ void m2808lambda$new$0$orgtelegramuiCellsMemberRequestCell(OnClickListener clickListener, View v) {
    ...
    public /* synthetic */ void m2809lambda$new$1$orgtelegramuiCellsMemberRequestCell(OnClickListener clickListener, View v) {
        TLRPC.TL_chatInviteImporter tL_chatInviteImporter;
        if (clickListener != null && (tL_chatInviteImporter = this.importer) != null) {
