    ...
    public void setStickerSet(StickerSetCovered stickerSet, boolean unread, int index, int searchLength) {
        ...
        if (this.hasOnClick) {
            ...
            if (isStickerPackInstalled) {
                ...
                this.addButton.setText(LocaleController.getString("StickersRemove", C0431R.string.StickersRemove).toUpperCase());
            } else {
