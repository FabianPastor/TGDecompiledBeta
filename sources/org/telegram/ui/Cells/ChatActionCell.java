                ...
                if (this.currentMessageObject.messageOwner.action instanceof TLRPC.TL_messageActionUserUpdatedPhoto) {
                    ...
                    if (photoSize2 != null) {
                        ...
                        if (!photo.video_sizes.isEmpty() && SharedConfig.autoplayGifs) {
                            ...
                            if (!messageObject2.mediaExists && !DownloadController.getInstance(this.currentAccount).canDownloadMedia(4, (long) videoSize.size)) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (!TextUtils.isEmpty(this.customText) || this.currentMessageObject != null) {
            if (this.accessibilityText == null) {
                SpannableStringBuilder sb = new SpannableStringBuilder(!TextUtils.isEmpty(this.customText) ? this.customText : this.currentMessageObject.messageText);
                for (final CharacterStyle link : (CharacterStyle[]) sb.getSpans(0, sb.length(), ClickableSpan.class)) {
