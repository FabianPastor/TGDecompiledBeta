...
public class PaymentInfoCell extends FrameLayout {
    ...
    public void setInvoice(TL_messageMediaInvoice invoice, String botname) {
        ...
        this.imageView.getImageReceiver().setImage(WebFile.createWithWebDocument(invoice.photo), String.format(Locale.US, "%d_%d", new Object[]{Integer.valueOf(width), Integer.valueOf(height)}), null, null, null, -1, null, invoice, 1);
    }
}
