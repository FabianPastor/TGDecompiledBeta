...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int avatarPadding, int nPadding, boolean needOption) {
        this(context, avatarPadding, nPadding, needOption, (Theme.ResourcesProvider) null);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ManageChatUserCell(Context context, int avatarPadding, int nPadding, boolean needOption, Theme.ResourcesProvider resourcesProvider2) {
        super(context);
    ...
    public /* synthetic */ void m2807lambda$new$0$orgtelegramuiCellsManageChatUserCell(View v) {
