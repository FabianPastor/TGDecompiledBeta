...
public class MaxFileSizeCell extends FrameLayout {
    ...
    class C19442 implements SeekBarViewDelegate {
        ...
        public void onSeekBarDrag(float progress) {
            ...
            MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C0446R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize((long) size)));
    ...
    public void setSize(long size, long max) {
        ...
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C0446R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(size)));
    }
}
