...
public class MaxFileSizeCell extends FrameLayout {
    ...
    class C10742 implements SeekBarViewDelegate {
        C10742() {
        }
        ...
        public void onSeekBarDrag(float progress) {
            ...
            MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C0493R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize((long) size)));
    ...
    public MaxFileSizeCell(Context context) {
        ...
        this.textView.setText(LocaleController.getString("AutodownloadSizeLimit", C0493R.string.AutodownloadSizeLimit));
        ...
        this.seekBarView.setDelegate(new C10742());
    ...
    public void setSize(long size, long max) {
        ...
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C0493R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(size)));
    }
}
