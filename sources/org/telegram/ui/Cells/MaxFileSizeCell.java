...
public class MaxFileSizeCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.seekBarView.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth() - AndroidUtilities.dp(8.0f), NUM), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(30.0f), NUM));
    }
