...
public class ChannelAdminLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2865lambda$loadMessages$1$orgtelegramuiChannelAdminLogActivity(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m2864lambda$loadMessages$0$orgtelegramuiChannelAdminLogActivity(TLRPC.TL_channels_adminLogResults res) {
        int i = 0;
    ...
    public View createView(Context context) {
        ...
        AnonymousClass6 r12 = new ChatListItemAnimator((ChatActivity) null, this.chatListView, (Theme.ResourcesProvider) null) {
            ...
            public /* synthetic */ void m2867xa4fb96a1() {
                if (this.scrollAnimationIndex != -1) {
    ...
    public /* synthetic */ void m2856lambda$createView$3$orgtelegramuiChannelAdminLogActivity(View view, int position) {
        createMenu(view);
    }

    /* renamed from: lambda$createView$5$org-telegram-ui-ChannelAdminLogActivity  reason: not valid java name */
    public /* synthetic */ void m2858lambda$createView$5$orgtelegramuiChannelAdminLogActivity(View view) {
    ...
    public /* synthetic */ void m2857lambda$createView$4$orgtelegramuiChannelAdminLogActivity(TLRPC.TL_channelAdminLogEventsFilter filter, LongSparseArray admins2) {
    ...
    public /* synthetic */ void m2859lambda$createView$6$orgtelegramuiChannelAdminLogActivity(View v) {
    ...
    public /* synthetic */ void m2861lambda$createView$8$orgtelegramuiChannelAdminLogActivity(View view) {
        if (getParentActivity() != null) {
    ...
    public /* synthetic */ void m2860lambda$createView$7$orgtelegramuiChannelAdminLogActivity(int param) {
        loadMessages(true);
    }
    ...
    public /* synthetic */ void m2855lambda$createMenu$9$orgtelegramuiChannelAdminLogActivity(ArrayList options, DialogInterface dialogInterface, int i) {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    if (path2 == null || path2.length() == 0) {
                        path2 = getFileLoader().getPathToMessage(this.selectedObject.messageOwner).toString();
                    }
    ...
    private int getMessageType(MessageObject messageObject) {
        ...
        if (messageObject.type == 10 || messageObject.type == 11 || messageObject.type == 16) {
            ...
            if (messageObject.isSticker() || messageObject.isAnimatedSticker()) {
                ...
                if (!canSave && getFileLoader().getPathToMessage(messageObject.messageOwner).exists()) {
                    canSave = true;
                }
                if (canSave) {
    ...
    public /* synthetic */ void m2863lambda$loadAdmins$11$orgtelegramuiChannelAdminLogActivity(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2862lambda$loadAdmins$10$orgtelegramuiChannelAdminLogActivity(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public /* synthetic */ void m2866xd8caeae1(String url, DialogInterface dialogInterface, int i) {
        Browser.openUrl((Context) getParentActivity(), url, true);
    }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                chatMessageCell.setDelegate(new ChatMessageCell.ChatMessageCellDelegate() {
                    ...
                    public /* synthetic */ void m2868xd0592d13(ChatMessageCell cell, TLRPC.User user, AvatarPreviewer.MenuItem item) {
                    ...
                    public /* synthetic */ void m2869x8aea75b9(String urlFinal, DialogInterface dialog, int which) {
                        if (which == 0) {
                            Browser.openUrl((Context) ChannelAdminLogActivity.this.getParentActivity(), urlFinal, true);
                        } else if (which == 1) {
                ...
                ((ChatActionCell) view).setDelegate(new ChatActionCell.ChatActionCellDelegate() {
                    ...
                    public /* synthetic */ void m2870xaf0CLASSNAMEcc(boolean[] canceled, DialogInterface dialogInterface) {
                    ...
                    public /* synthetic */ void m2872x962b4a4e(TLRPC.TL_chatInviteExported invite, boolean[] canceled, AlertDialog progressDialog, TLObject response, TLRPC.TL_error error) {
                    ...
                    public /* synthetic */ void m2871xa29bCLASSNAMEd(TLRPC.TL_chatInviteExported invite, TLRPC.TL_messages_exportedChatInvite finalInvite, boolean[] canceled, AlertDialog progressDialog) {
                        boolean unused = ChannelAdminLogActivity.this.linviteLoading = false;
