...
public final /* synthetic */ class LoginActivity$LoginActivityNewPasswordView$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ LoginActivity$LoginActivityNewPasswordView$$ExternalSyntheticLambda4(LoginActivity.LoginActivityNewPasswordView loginActivityNewPasswordView, String str, String str2, TLRPC.TL_auth_recoverPassword tL_auth_recoverPassword) {
    ...
    public final void run() {
        this.f$0.m3196x5b23dvar_(this.f$1, this.f$2, this.f$3);
    }
}
