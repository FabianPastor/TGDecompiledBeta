...
public final /* synthetic */ class ContentPreviewViewer$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ ContentPreviewViewer$$ExternalSyntheticLambda4(ContentPreviewViewer contentPreviewViewer, RecyclerListView recyclerListView, int i, int i2) {
    ...
    public final void run() {
        this.f$0.lambda$onInterceptTouchEvent$1(this.f$1, this.f$2, this.f$3);
    }
}
