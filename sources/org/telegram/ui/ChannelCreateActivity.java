...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, AvatarUpdaterDelegate {
    ...
    class C19752 extends ActionBarMenuOnItemClick {
        ...
        class C09651 implements OnClickListener {
            C09651() {
            }
            ...
            if (id == -1) {
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed) {
                        ...
                        ChannelCreateActivity.this.progressDialog.setCanceledOnTouchOutside(false);
                        ChannelCreateActivity.this.progressDialog.setCancelable(false);
                        ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0446R.string.Cancel), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.nameTextView.length() == 0) {
                            ...
                            builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C0446R.string.ChannelPublicEmptyUsername));
                            builder.setPositiveButton(LocaleController.getString("Close", C0446R.string.Close), null);
    ...
    class C09683 implements View.OnClickListener {

        /* renamed from: org.telegram.ui.ChannelCreateActivity$3$1 */
        class C09671 implements OnClickListener {
            C09671() {
            }
    ...
    class C09727 implements View.OnClickListener {
        C09727() {
        }
    ...
    class C09738 implements View.OnClickListener {
        C09738() {
        }
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (this.currentStep == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C19741());
            return;
        }
    ...
    public View createView(Context context) {
        ...
        if (this.currentStep == 0) {
            float f;
            float f2;
            this.actionBar.setTitle(LocaleController.getString("NewChannel", C0446R.string.NewChannel));
            ...
            this.avatarImage.setOnClickListener(new C09683());
            ...
            this.nameTextView.addTextChangedListener(new C09694());
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C0446R.string.DescriptionPlaceholder));
            ...
            this.descriptionTextView.setOnEditorActionListener(new C09705());
            this.descriptionTextView.addTextChangedListener(new C09716());
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C0446R.string.DescriptionInfo));
            ...
            this.actionBar.setTitle(LocaleController.getString("ChannelSettings", C0446R.string.ChannelSettings));
            ...
            this.radioButtonCell1.setOnClickListener(new C09727());
            ...
            this.radioButtonCell2.setOnClickListener(new C09738());
            ...
            this.nameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C0446R.string.ChannelUsernamePlaceholder));
            this.nameTextView.setCursorColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.nameTextView.setCursorSize(AndroidUtilities.dp(20.0f));
            this.nameTextView.setCursorWidth(1.5f);
            this.publicContainer.addView(this.nameTextView, LayoutHelper.createLinear(-1, 36));
            this.nameTextView.addTextChangedListener(new C09749());
            ...
            this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0446R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_channels_getAdminedPublicChannels(), new RequestDelegate() {
                public void run(final TLObject response, TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C09621 implements View.OnClickListener {
                            C09621() {
                            }
                            ...
                            public void onClick(View view) {
                                ...
                                if (channel.megagroup) {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C0446R.string.RevokeLinkAlert, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                } else {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C0446R.string.RevokeLinkAlertChannel, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                }
                                ...
                                builder.setPositiveButton(LocaleController.getString("RevokeButton", C0446R.string.RevokeButton), new OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C19721(), 64);
                                    }
                                });
                                ChannelCreateActivity.this.showDialog(builder.create());
                            }
                        ...
                        public void run() {
                            ...
                            if (response != null && ChannelCreateActivity.this.getParentActivity() != null) {
                                ...
                                while (a < res.chats.size()) {
                                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new C09621());
        ...
        if (name == null || name.length() < 5) {
            ...
            this.checkRunnable = new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (ChannelCreateActivity.this.lastCheckName != null && ChannelCreateActivity.this.lastCheckName.equals(name)) {
                                    if (error == null && (response instanceof TL_boolTrue)) {
                                        ChannelCreateActivity.this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C0446R.string.LinkAvailable, name));
                ...
                public void run() {
                    ...
                    ChannelCreateActivity.this.checkReqId = ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C19731(), 2);
                }
            };
