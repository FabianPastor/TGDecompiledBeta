...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (i == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new ChannelCreateActivity$$ExternalSyntheticLambda15(this));
            return;
        }
        if (i == 1) {
    ...
    public /* synthetic */ void m2893lambda$new$0$orgtelegramuiChannelCreateActivity(TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2894lambda$new$1$orgtelegramuiChannelCreateActivity(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda9(this, error));
    }
    ...
    public void showDoneCancelDialog() {
        if (this.cancelDialog == null) {
            ...
            builder.setNegativeButton(LocaleController.getString("Stop", NUM), new ChannelCreateActivity$$ExternalSyntheticLambda11(this));
            this.cancelDialog = builder.show();
        }
    }

    /* renamed from: lambda$showDoneCancelDialog$2$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2895x1cvar_(DialogInterface dialogInterface, int i) {
    ...
    /* renamed from: lambda$updateDoneProgress$3$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2897xa4259f8(ValueAnimator a) {
    ...
    public View createView(Context context) {
        ...
        CrossfadeDrawable crossfadeDrawable = new CrossfadeDrawable(checkmark, new CircularProgressDrawable(Theme.getColor("actionBarDefaultIcon")));
        this.doneButtonDrawable = crossfadeDrawable;
        this.doneButton = menu.addItemWithWidth(1, (Drawable) crossfadeDrawable, AndroidUtilities.dp(56.0f), (CharSequence) LocaleController.getString("Done", NUM));
        ...
        if (i == 0) {
            ...
            AnonymousClass3 r5 = new BackupImageView(context2) {
            ...
            this.avatarImage = r5;
            r5.setRoundRadius(AndroidUtilities.dp(32.0f));
            ...
            r13.setContentDescription(LocaleController.getString("ChatSetPhotoOrVideo", NUM));
            ...
            this.avatarOverlay.setOnClickListener(new ChannelCreateActivity$$ExternalSyntheticLambda22(this));
            this.cameraDrawable = new RLottieDrawable(NUM, "NUM", AndroidUtilities.dp(60.0f), AndroidUtilities.dp(60.0f), false, (int[]) null);
            AnonymousClass5 r7 = new RLottieImageView(context2) {
                public void invalidate(int l, int t, int r, int b) {
                    super.invalidate(l, t, r, b);
                    ChannelCreateActivity.this.avatarOverlay.invalidate();
                }
            ...
            this.nameTextView.getEditText().setOnEditorActionListener(new ChannelCreateActivity$$ExternalSyntheticLambda25(this));
            ...
            this.descriptionTextView.setOnEditorActionListener(new ChannelCreateActivity$$ExternalSyntheticLambda1(this));
            ...
            this.radioButtonCell1.setOnClickListener(new ChannelCreateActivity$$ExternalSyntheticLambda20(this));
            ...
            this.radioButtonCell2.setOnClickListener(new ChannelCreateActivity$$ExternalSyntheticLambda21(this));
    ...
    public /* synthetic */ void m2880lambda$createView$7$orgtelegramuiChannelCreateActivity(View view) {
        this.imageUpdater.openMenu(this.avatar != null, new ChannelCreateActivity$$ExternalSyntheticLambda2(this), new ChannelCreateActivity$$ExternalSyntheticLambda19(this));
    ...
    public /* synthetic */ void m2878lambda$createView$5$orgtelegramuiChannelCreateActivity() {
        this.avatar = null;
        this.avatarBig = null;
    ...
    public /* synthetic */ void m2879lambda$createView$6$orgtelegramuiChannelCreateActivity(DialogInterface dialog) {
    ...
    public /* synthetic */ boolean m2881lambda$createView$8$orgtelegramuiChannelCreateActivity(TextView textView, int i, KeyEvent keyEvent) {
    ...
    public /* synthetic */ boolean m2882lambda$createView$9$orgtelegramuiChannelCreateActivity(TextView textView, int i, KeyEvent keyEvent) {
        View view;
    ...
    /* renamed from: lambda$createView$10$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2876lambda$createView$10$orgtelegramuiChannelCreateActivity(View v) {
    ...
    /* renamed from: lambda$createView$11$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2877lambda$createView$11$orgtelegramuiChannelCreateActivity(View v) {
        if (!this.isPrivate) {
            this.isPrivate = true;
            updatePrivatePublic();
        }
    ...
    /* renamed from: lambda$generateLink$13$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2885lambda$generateLink$13$orgtelegramuiChannelCreateActivity(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda10(this, error, response));
    }

    /* renamed from: lambda$generateLink$12$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2884lambda$generateLink$12$orgtelegramuiChannelCreateActivity(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public void didUploadPhoto(TLRPC.InputFile photo, TLRPC.InputFile video, double videoStartTimestamp, String videoPath, TLRPC.PhotoSize bigSize, TLRPC.PhotoSize smallSize) {
        AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda8(this, photo, video, videoPath, videoStartTimestamp, smallSize, bigSize));
    }

    /* renamed from: lambda$didUploadPhoto$14$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2883lambda$didUploadPhoto$14$orgtelegramuiChannelCreateActivity(TLRPC.InputFile photo, TLRPC.InputFile video, String videoPath, double videoStartTimestamp, TLRPC.PhotoSize smallSize, TLRPC.PhotoSize bigSize) {
    ...
    private void loadAdminedChannels() {
        if (!this.loadingAdminedChannels) {
            ...
            updatePrivatePublic();
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TLRPC.TL_channels_getAdminedPublicChannels(), new ChannelCreateActivity$$ExternalSyntheticLambda14(this));
        }
    }

    /* renamed from: lambda$loadAdminedChannels$20$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2892x3a0330bb(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda7(this, response));
    }

    /* renamed from: lambda$loadAdminedChannels$19$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2891xf3edvar_(TLObject response) {
        ...
        if (response != null && getParentActivity() != null) {
            ...
            for (int a2 = 0; a2 < res.chats.size(); a2++) {
                AdminedChannelCell adminedChannelCell = new AdminedChannelCell(getParentActivity(), new ChannelCreateActivity$$ExternalSyntheticLambda23(this), false, 0);
    ...
    public /* synthetic */ void m2890x2aecf9e4(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", NUM), new ChannelCreateActivity$$ExternalSyntheticLambda18(this, channel));
        showDialog(builder.create());
    }

    /* renamed from: lambda$loadAdminedChannels$17$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2889x61eCLASSNAMEa3(TLRPC.Chat channel, DialogInterface dialogInterface, int i) {
        ...
        req1.username = "";
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req1, new ChannelCreateActivity$$ExternalSyntheticLambda13(this), 64);
    }

    /* renamed from: lambda$loadAdminedChannels$16$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2888x98eb0b62(TLObject response1, TLRPC.TL_error error1) {
        if (response1 instanceof TLRPC.TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda3(this));
        }
    }

    /* renamed from: lambda$loadAdminedChannels$15$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2887xcfea1421() {
    ...
    public boolean checkUserName(String name) {
        ...
        if (name == null || name.length() < 5) {
            ...
            ChannelCreateActivity$$ExternalSyntheticLambda5 channelCreateActivity$$ExternalSyntheticLambda5 = new ChannelCreateActivity$$ExternalSyntheticLambda5(this, name);
            this.checkRunnable = channelCreateActivity$$ExternalSyntheticLambda5;
            AndroidUtilities.runOnUIThread(channelCreateActivity$$ExternalSyntheticLambda5, 300);
            return true;
        }
    }

    /* renamed from: lambda$checkUserName$23$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2875lambda$checkUserName$23$orgtelegramuiChannelCreateActivity(String name) {
        TLRPC.TL_channels_checkUsername req = new TLRPC.TL_channels_checkUsername();
        req.username = name;
        req.channel = MessagesController.getInstance(this.currentAccount).getInputChannel(this.chatId);
        this.checkReqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new ChannelCreateActivity$$ExternalSyntheticLambda16(this, name), 2);
    }

    /* renamed from: lambda$checkUserName$22$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2874lambda$checkUserName$22$orgtelegramuiChannelCreateActivity(String name, TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new ChannelCreateActivity$$ExternalSyntheticLambda6(this, name, error, response));
    }

    /* renamed from: lambda$checkUserName$21$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2873lambda$checkUserName$21$orgtelegramuiChannelCreateActivity(String name, TLRPC.TL_error error, TLObject response) {
        this.checkReqId = 0;
    ...
    private void showPremiumIncreaseLimitDialog() {
        if (getParentActivity() != null) {
            ...
            limitReachedBottomSheet.onSuccessRunnable = new ChannelCreateActivity$$ExternalSyntheticLambda4(this);
            showDialog(limitReachedBottomSheet);
        }
    }

    /* renamed from: lambda$showPremiumIncreaseLimitDialog$24$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2896x98bb9116() {
        this.canCreatePublic = true;
        updatePrivatePublic();
    }
    ...
    public ArrayList<ThemeDescription> getThemeDescriptions() {
        ...
        ThemeDescription.ThemeDescriptionDelegate cellDelegate = new ChannelCreateActivity$$ExternalSyntheticLambda17(this);
    ...
    /* renamed from: lambda$getThemeDescriptions$25$org-telegram-ui-ChannelCreateActivity  reason: not valid java name */
    public /* synthetic */ void m2886xd508ee14() {
