...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C12322 extends ActionBarMenuOnItemClick {
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed) {
                        ...
                        if (ChannelCreateActivity.this.imageUpdater.uploadingImage != null) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", C0500R.string.Loading));
                            ...
                            ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0500R.string.Cancel), new C12301());
                        ...
                        ChannelCreateActivity.this.progressDialog.setCanceledOnTouchOutside(false);
                        ChannelCreateActivity.this.progressDialog.setCancelable(false);
                        ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0500R.string.Cancel), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.nameTextView.length() == 0) {
                            ...
                            builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C0500R.string.ChannelPublicEmptyUsername));
                            builder.setPositiveButton(LocaleController.getString("Close", C0500R.string.Close), null);
    ...
    class C12343 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (ChannelCreateActivity.this.getParentActivity() != null) {
                Builder builder = new Builder(ChannelCreateActivity.this.getParentActivity());
                builder.setItems(ChannelCreateActivity.this.avatar != null ? new CharSequence[]{LocaleController.getString("FromCamera", C0500R.string.FromCamera), LocaleController.getString("FromGalley", C0500R.string.FromGalley), LocaleController.getString("DeletePhoto", C0500R.string.DeletePhoto)} : new CharSequence[]{LocaleController.getString("FromCamera", C0500R.string.FromCamera), LocaleController.getString("FromGalley", C0500R.string.FromGalley)}, new C12331());
                ChannelCreateActivity.this.showDialog(builder.create());
            }
        }
    }
    ...
    class C12354 implements TextWatcher {
        C12354() {
        }
    ...
    class C12365 implements OnEditorActionListener {
        C12365() {
        }
    ...
    class C12376 implements TextWatcher {
        C12376() {
        }
    ...
    class C12387 implements View.OnClickListener {
        C12387() {
        }
    ...
    class C12398 implements View.OnClickListener {
        C12398() {
        }
    ...
    class C12409 implements TextWatcher {
        C12409() {
        }
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (this.currentStep == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C12291());
            return;
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C12322());
        ...
        if (this.currentStep == 0) {
            float f;
            float f2;
            this.actionBar.setTitle(LocaleController.getString("NewChannel", C0500R.string.NewChannel));
            ...
            this.avatarImage.setOnClickListener(new C12343());
            ...
            this.nameTextView.addTextChangedListener(new C12354());
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C0500R.string.DescriptionPlaceholder));
            ...
            this.descriptionTextView.setOnEditorActionListener(new C12365());
            this.descriptionTextView.addTextChangedListener(new C12376());
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C0500R.string.DescriptionInfo));
            ...
            this.actionBar.setTitle(LocaleController.getString("ChannelSettings", C0500R.string.ChannelSettings));
            ...
            this.radioButtonCell1.setOnClickListener(new C12387());
            ...
            this.radioButtonCell2.setOnClickListener(new C12398());
            ...
            this.nameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C0500R.string.ChannelUsernamePlaceholder));
            this.nameTextView.setCursorColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.nameTextView.setCursorSize(AndroidUtilities.dp(20.0f));
            this.nameTextView.setCursorWidth(1.5f);
            this.publicContainer.addView(this.nameTextView, LayoutHelper.createLinear(-1, 36));
            this.nameTextView.addTextChangedListener(new C12409());
                ...
                public void onClick(View v) {
                    if (ChannelCreateActivity.this.invite != null) {
                        try {
                            ...
                            Toast.makeText(ChannelCreateActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C0500R.string.LinkCopied), 0).show();
                        } catch (Throwable e) {
                            FileLog.m3e(e);
                        }
                    }
            ...
            this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0500R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                public void run(final TLObject response, final TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
                            ...
                            ChannelCreateActivity.this.privateContainer.setText(ChannelCreateActivity.this.invite != null ? ChannelCreateActivity.this.invite.link : LocaleController.getString("Loading", C0500R.string.Loading), false);
                        }
                    });
                }
            });
                        ...
                        class C12251 implements View.OnClickListener {
                            ...
                            public void onClick(View view) {
                                ...
                                if (channel.megagroup) {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C0500R.string.RevokeLinkAlert, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                } else {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C0500R.string.RevokeLinkAlertChannel, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                }
                                ...
                                builder.setPositiveButton(LocaleController.getString("RevokeButton", C0500R.string.RevokeButton), new OnClickListener() {
                                    ...
                                    class C12231 implements RequestDelegate {
                                        ...
                                        public void run(TLObject response, TL_error error) {
                                            if (response instanceof TL_boolTrue) {
                                                AndroidUtilities.runOnUIThread(new C12221());
                                            }
                                        }
                                    }
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C12231(), 64);
                                    }
                                });
                                ChannelCreateActivity.this.showDialog(builder.create());
                            }
                        ...
                        public void run() {
                            ...
                            if (response != null && ChannelCreateActivity.this.getParentActivity() != null) {
                                ...
                                while (a < res.chats.size()) {
                                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new C12251());
    ...
    private boolean checkUserName(final String name) {
        ...
        if (name == null || name.length() < 5) {
            ...
            this.checkRunnable = new Runnable() {
                ...
                class C12281 implements RequestDelegate {
                    C12281() {
                    }
                            ...
                            public void run() {
                                ...
                                if (ChannelCreateActivity.this.lastCheckName != null && ChannelCreateActivity.this.lastCheckName.equals(name)) {
                                    if (error == null && (response instanceof TL_boolTrue)) {
                                        ChannelCreateActivity.this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C0500R.string.LinkAvailable, name));
                                    ...
                                    if (error == null || !error.text.equals("CHANNELS_ADMIN_PUBLIC_TOO_MUCH")) {
                                        ChannelCreateActivity.this.checkTextView.setText(LocaleController.getString("LinkInUse", C0500R.string.LinkInUse));
                                    } else {
                ...
                public void run() {
                    ...
                    ChannelCreateActivity.this.checkReqId = ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C12281(), 2);
                }
            };
    ...
    private void showErrorAlert(String error) {
        if (getParentActivity() != null) {
            ...
            switch (obj) {
                case null:
                    builder.setMessage(LocaleController.getString("LinkInvalid", C0500R.string.LinkInvalid));
                    break;
                case 1:
                    builder.setMessage(LocaleController.getString("LinkInUse", C0500R.string.LinkInUse));
                    break;
                default:
