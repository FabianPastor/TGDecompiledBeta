...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, AvatarUpdaterDelegate {
    ...
    class C11932 extends ActionBarMenuOnItemClick {
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed) {
                        ...
                        if (ChannelCreateActivity.this.avatarUpdater.uploadingAvatar != null) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", C0493R.string.Loading));
                            ...
                            ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0493R.string.Cancel), new C11911());
                        ...
                        ChannelCreateActivity.this.progressDialog.setCanceledOnTouchOutside(false);
                        ChannelCreateActivity.this.progressDialog.setCancelable(false);
                        ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0493R.string.Cancel), new OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.nameTextView.length() == 0) {
                            ...
                            builder.setMessage(LocaleController.getString("ChannelPublicEmptyUsername", C0493R.string.ChannelPublicEmptyUsername));
                            builder.setPositiveButton(LocaleController.getString("Close", C0493R.string.Close), null);
    ...
    class C11953 implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (ChannelCreateActivity.this.getParentActivity() != null) {
                Builder builder = new Builder(ChannelCreateActivity.this.getParentActivity());
                builder.setItems(ChannelCreateActivity.this.avatar != null ? new CharSequence[]{LocaleController.getString("FromCamera", C0493R.string.FromCamera), LocaleController.getString("FromGalley", C0493R.string.FromGalley), LocaleController.getString("DeletePhoto", C0493R.string.DeletePhoto)} : new CharSequence[]{LocaleController.getString("FromCamera", C0493R.string.FromCamera), LocaleController.getString("FromGalley", C0493R.string.FromGalley)}, new C11941());
                ChannelCreateActivity.this.showDialog(builder.create());
            }
        }
    }
    ...
    class C11964 implements TextWatcher {
        C11964() {
        }
    ...
    class C11975 implements OnEditorActionListener {
        C11975() {
        }
    ...
    class C11986 implements TextWatcher {
        C11986() {
        }
    ...
    class C11997 implements View.OnClickListener {
        C11997() {
        }
    ...
    class C12008 implements View.OnClickListener {
        C12008() {
        }
    ...
    class C12019 implements TextWatcher {
        C12019() {
        }
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (this.currentStep == 0) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C11901());
            return;
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C11932());
        ...
        if (this.currentStep == 0) {
            float f;
            float f2;
            this.actionBar.setTitle(LocaleController.getString("NewChannel", C0493R.string.NewChannel));
            ...
            this.avatarImage.setOnClickListener(new C11953());
            ...
            this.nameTextView.addTextChangedListener(new C11964());
            ...
            this.descriptionTextView.setHint(LocaleController.getString("DescriptionPlaceholder", C0493R.string.DescriptionPlaceholder));
            ...
            this.descriptionTextView.setOnEditorActionListener(new C11975());
            this.descriptionTextView.addTextChangedListener(new C11986());
            ...
            this.helpTextView.setText(LocaleController.getString("DescriptionInfo", C0493R.string.DescriptionInfo));
            ...
            this.actionBar.setTitle(LocaleController.getString("ChannelSettings", C0493R.string.ChannelSettings));
            ...
            this.radioButtonCell1.setOnClickListener(new C11997());
            ...
            this.radioButtonCell2.setOnClickListener(new C12008());
            ...
            this.nameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C0493R.string.ChannelUsernamePlaceholder));
            this.nameTextView.setCursorColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.nameTextView.setCursorSize(AndroidUtilities.dp(20.0f));
            this.nameTextView.setCursorWidth(1.5f);
            this.publicContainer.addView(this.nameTextView, LayoutHelper.createLinear(-1, 36));
            this.nameTextView.addTextChangedListener(new C12019());
                ...
                public void onClick(View v) {
                    if (ChannelCreateActivity.this.invite != null) {
                        try {
                            ...
                            Toast.makeText(ChannelCreateActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C0493R.string.LinkCopied), 0).show();
                        } catch (Throwable e) {
                            FileLog.m3e(e);
                        }
                    }
            ...
            this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0493R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                public void run(final TLObject response, final TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
                            ...
                            ChannelCreateActivity.this.privateContainer.setText(ChannelCreateActivity.this.invite != null ? ChannelCreateActivity.this.invite.link : LocaleController.getString("Loading", C0493R.string.Loading), false);
                        }
                    });
                }
            });
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_channels_getAdminedPublicChannels(), new RequestDelegate() {
                public void run(final TLObject response, TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C11861 implements View.OnClickListener {
                            C11861() {
                            }
                            ...
                            public void onClick(View view) {
                                ...
                                if (channel.megagroup) {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C0493R.string.RevokeLinkAlert, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                } else {
                                    builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C0493R.string.RevokeLinkAlertChannel, MessagesController.getInstance(ChannelCreateActivity.this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
                                }
                                ...
                                builder.setPositiveButton(LocaleController.getString("RevokeButton", C0493R.string.RevokeButton), new OnClickListener() {
                                    ...
                                    class C11841 implements RequestDelegate {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C11841(), 64);
                                    }
                                });
                                ChannelCreateActivity.this.showDialog(builder.create());
                            }
                        ...
                        public void run() {
                            ...
                            if (response != null && ChannelCreateActivity.this.getParentActivity() != null) {
                                ...
                                while (a < res.chats.size()) {
                                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new C11861());
    ...
    private boolean checkUserName(final String name) {
        ...
        if (name == null || name.length() < 5) {
            ...
            this.checkRunnable = new Runnable() {
                ...
                class C11891 implements RequestDelegate {
                    C11891() {
                    }
                            ...
                            public void run() {
                                ...
                                if (ChannelCreateActivity.this.lastCheckName != null && ChannelCreateActivity.this.lastCheckName.equals(name)) {
                                    if (error == null && (response instanceof TL_boolTrue)) {
                                        ChannelCreateActivity.this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C0493R.string.LinkAvailable, name));
                                    ...
                                    if (error == null || !error.text.equals("CHANNELS_ADMIN_PUBLIC_TOO_MUCH")) {
                                        ChannelCreateActivity.this.checkTextView.setText(LocaleController.getString("LinkInUse", C0493R.string.LinkInUse));
                                    } else {
                ...
                public void run() {
                    ...
                    ChannelCreateActivity.this.checkReqId = ConnectionsManager.getInstance(ChannelCreateActivity.this.currentAccount).sendRequest(req, new C11891(), 2);
                }
            };
    ...
    private void showErrorAlert(String error) {
        if (getParentActivity() != null) {
            ...
            switch (obj) {
                case null:
                    builder.setMessage(LocaleController.getString("LinkInvalid", C0493R.string.LinkInvalid));
                    break;
                case 1:
                    builder.setMessage(LocaleController.getString("LinkInUse", C0493R.string.LinkInUse));
                    break;
                default:
