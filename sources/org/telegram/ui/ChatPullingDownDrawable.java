...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m1937xaa989d1b(View parent, ValueAnimator animation) {
    ...
    public /* synthetic */ void m1938x3738CLASSNAMEc(View parent, ValueAnimator animation) {
    ...
    public /* synthetic */ void m1939xc3d8var_d(View parent, ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        parent.invalidate();
    }

    /* renamed from: lambda$showReleaseState$3$org-telegram-ui-ChatPullingDownDrawable  reason: not valid java name */
    public /* synthetic */ void m1940x50791e1e(View parent, ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        parent.invalidate();
    }

    /* renamed from: lambda$showReleaseState$4$org-telegram-ui-ChatPullingDownDrawable  reason: not valid java name */
    public /* synthetic */ void m1941xdd19491f(View parent, ValueAnimator animation) {
        this.swipeToReleaseProgress = ((Float) animation.getAnimatedValue()).floatValue();
        this.fragmentView.invalidate();
        parent.invalidate();
    }
    ...
    public static TLRPC.Dialog getNextUnreadDialog(long currentDialogId, int folderId2, int filterId2, boolean searchNext, int[] params2) {
        ...
        if (i2 != 0) {
            dialogs = messagesController.dialogFiltersById.get(i2).dialogs;
        } else {
    ...
    public /* synthetic */ void m1935x9CLASSNAMEc7c6(ValueAnimator animation) {
        this.swipeToReleaseProgress = ((Float) animation.getAnimatedValue()).floatValue();
        this.fragmentView.invalidate();
        View view = this.parentView;
        if (view != null) {
    ...
    public /* synthetic */ void m1936x2913f2c7(ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        View view = this.parentView;
        if (view != null) {
            view.invalidate();
