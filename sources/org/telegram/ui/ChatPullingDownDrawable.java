...
public class ChatPullingDownDrawable implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m3265xaa989d1b(View parent, ValueAnimator animation) {
    ...
    public /* synthetic */ void m3266x3738CLASSNAMEc(View parent, ValueAnimator animation) {
    ...
    public /* synthetic */ void m3267xc3d8var_d(View parent, ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        parent.invalidate();
    }

    /* renamed from: lambda$showReleaseState$3$org-telegram-ui-ChatPullingDownDrawable  reason: not valid java name */
    public /* synthetic */ void m3268x50791e1e(View parent, ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        parent.invalidate();
    }

    /* renamed from: lambda$showReleaseState$4$org-telegram-ui-ChatPullingDownDrawable  reason: not valid java name */
    public /* synthetic */ void m3269xdd19491f(View parent, ValueAnimator animation) {
        this.swipeToReleaseProgress = ((Float) animation.getAnimatedValue()).floatValue();
        this.fragmentView.invalidate();
        parent.invalidate();
    }
    ...
    public void drawBottomPanel(android.graphics.Canvas r12, int r13, int r14, int r15) {
        /*
            ...
            float r4 = r11.progressToBottomPanel
            int r5 = (r4 > r3 ? 1 : (r4 == r3 ? 0 : -1))
            if (r5 == 0) goto L_0x0020
            float r4 = r4 + r1
            r11.progressToBottomPanel = r4
            int r0 = (r4 > r3 ? 1 : (r4 == r3 ? 0 : -1))
            if (r0 <= 0) goto L_0x001a
            r11.progressToBottomPanel = r3
            goto L_0x0037
        L_0x001a:
        ...
        L_0x0020:
            ...
            float r0 = r11.progressToBottomPanel
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 == 0) goto L_0x0037
            float r0 = r0 - r1
            r11.progressToBottomPanel = r0
            int r0 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r0 >= 0) goto L_0x0032
            r11.progressToBottomPanel = r2
            goto L_0x0037
        L_0x0032:
            android.view.View r0 = r11.fragmentView
            r0.invalidate()
        L_0x0037:
            android.text.TextPaint r0 = r11.textPaint2
            ...
            int r10 = r4.getAlpha()
            float r4 = (float) r1
            float r5 = r11.progressToBottomPanel
            float r4 = r4 * r5
            int r4 = (int) r4
            r0.setAlpha(r4)
            r5 = 0
            ...
            android.text.TextPaint r7 = r11.textPaint2
            float r8 = (float) r10
            float r4 = r3 - r4
            float r8 = r8 * r4
            float r4 = r11.progressToBottomPanel
            ...
            float r7 = (float) r7
            float r8 = r11.swipeToReleaseProgress
            float r7 = r7 * r8
            float r4 = r4 - r7
            r12.save()
            int r7 = r11.lastWidth
            int r8 = r11.layout1Width
            int r7 = r7 - r8
            float r7 = (float) r7
            float r7 = r7 / r6
            r12.translate(r7, r4)
            android.text.StaticLayout r7 = r11.layout1
            r7.draw(r12)
            r12.restore()
        L_0x00ad:
            ...
            float r2 = (float) r13
            int r4 = r14 - r13
            android.text.StaticLayout r7 = r11.layout2
            int r7 = r7.getHeight()
            int r4 = r4 - r7
            float r4 = (float) r4
            float r4 = r4 / r6
            ...
            float r4 = (float) r4
            float r5 = r11.swipeToReleaseProgress
            float r3 = r3 - r5
            float r4 = r4 * r3
            float r2 = r2 + r4
            r12.save()
    ...
    public /* synthetic */ void m3263x9CLASSNAMEc7c6(ValueAnimator animation) {
        this.swipeToReleaseProgress = ((Float) animation.getAnimatedValue()).floatValue();
        this.fragmentView.invalidate();
        View view = this.parentView;
        if (view != null) {
    ...
    public /* synthetic */ void m3264x2913f2c7(ValueAnimator animation) {
        this.bounceProgress = ((Float) animation.getAnimatedValue()).floatValue();
        View view = this.parentView;
        if (view != null) {
            view.invalidate();
