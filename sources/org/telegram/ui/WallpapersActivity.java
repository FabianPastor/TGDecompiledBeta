...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C17991 implements WallpaperUpdaterDelegate {
        C17991() {
        }
    ...
    class C18002 extends ActionBarMenuOnItemClick {
        C18002() {
        }
    ...
    class C18013 implements OnTouchListener {
        C18013() {
        }
    ...
    class C18024 implements OnItemClickListener {
        C18024() {
        }
    ...
    class C18045 implements RequestDelegate {
        C18045() {
        }
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), new C17991());
        this.actionBar.setBackButtonImage(C0431R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setTitle(LocaleController.getString("ChatBackground", C0431R.string.ChatBackground));
        this.actionBar.setActionBarMenuOnItemClick(new C18002());
        ...
        this.backgroundImage.setOnTouchListener(new C18013());
        ...
        this.progressViewBackground.setBackgroundResource(C0431R.drawable.system_loader);
        ...
        this.listView.setOnItemClickListener(new C18024());
        ...
        if (!Theme.hasWallpaperFromTheme() || this.overrideThemeWallpaper) {
            ...
            if (this.selectedBackground == -1 || this.selectedBackground == 1000001 || wallPaper == null || !(wallPaper instanceof TL_wallPaper)) {
                ...
                if (this.selectedBackground == 1000001) {
                    this.backgroundImage.setImageResource(C0431R.drawable.background_hd);
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getWallPapers(), new C18045()), this.classGuid);
    }
