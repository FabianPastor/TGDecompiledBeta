...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C25861 implements WallpaperUpdaterDelegate {
        C25861() {
        }
    ...
    class C25872 extends ActionBarMenuOnItemClick {
        C25872() {
        }
    ...
    class C25883 implements OnTouchListener {
        C25883() {
        }
    ...
    class C25894 implements OnItemClickListener {
        C25894() {
        }
    ...
    class C25915 implements RequestDelegate {
        C25915() {
        }
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), new C25861());
        this.actionBar.setBackButtonImage(C0505R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setTitle(LocaleController.getString("ChatBackground", C0505R.string.ChatBackground));
        this.actionBar.setActionBarMenuOnItemClick(new C25872());
        ...
        this.backgroundImage.setOnTouchListener(new C25883());
        ...
        this.progressViewBackground.setBackgroundResource(C0505R.drawable.system_loader);
        ...
        this.listView.setOnItemClickListener(new C25894());
        ...
        if (!Theme.hasWallpaperFromTheme() || this.overrideThemeWallpaper) {
            ...
            if (this.selectedBackground == -1 || this.selectedBackground == 1000001 || wallPaper == null || !(wallPaper instanceof TL_wallPaper)) {
                ...
                if (this.selectedBackground == 1000001) {
                    this.backgroundImage.setImageResource(C0505R.drawable.background_hd);
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getWallPapers(), new C25915()), this.classGuid);
    }
