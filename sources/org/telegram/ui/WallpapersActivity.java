...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C25601 implements WallpaperUpdaterDelegate {
        C25601() {
        }
    ...
    class C25612 extends ActionBarMenuOnItemClick {
        C25612() {
        }
    ...
    class C25623 implements OnTouchListener {
        C25623() {
        }
    ...
    class C25634 implements OnItemClickListener {
        C25634() {
        }
    ...
    class C25655 implements RequestDelegate {
        C25655() {
        }
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), new C25601());
        this.actionBar.setBackButtonImage(C0501R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setTitle(LocaleController.getString("ChatBackground", C0501R.string.ChatBackground));
        this.actionBar.setActionBarMenuOnItemClick(new C25612());
        ...
        this.backgroundImage.setOnTouchListener(new C25623());
        ...
        this.progressViewBackground.setBackgroundResource(C0501R.drawable.system_loader);
        ...
        this.listView.setOnItemClickListener(new C25634());
        ...
        if (!Theme.hasWallpaperFromTheme() || this.overrideThemeWallpaper) {
            ...
            if (this.selectedBackground == -1 || this.selectedBackground == 1000001 || wallPaper == null || !(wallPaper instanceof TL_wallPaper)) {
                ...
                if (this.selectedBackground == 1000001) {
                    this.backgroundImage.setImageResource(C0501R.drawable.background_hd);
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getWallPapers(), new C25655()), this.classGuid);
    }
