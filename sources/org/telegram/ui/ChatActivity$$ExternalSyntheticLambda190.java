...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda190 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda190(ChatActivity chatActivity, TLRPC$TL_messages_sendScheduledMessages tLRPC$TL_messages_sendScheduledMessages) {
        this.f$0 = chatActivity;
        this.f$1 = tLRPC$TL_messages_sendScheduledMessages;
    }

    public final void run() {
        this.f$0.lambda$processSelectedOption$211(this.f$1);
    }
}
