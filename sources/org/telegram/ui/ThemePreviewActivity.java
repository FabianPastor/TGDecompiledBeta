...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C24971 extends ActionBarMenuItemSearchListener {
        C24971() {
        }
    ...
    class C24993 extends ViewOutlineProvider {
        C24993() {
        }
    ...
    class C25015 implements OnPageChangeListener {
        C25015() {
        }
    ...
    class C25026 extends PagerAdapter {
        C25026() {
        }
    ...
    class C25048 implements OnClickListener {
        C25048() {
        }
    ...
    class C25059 implements OnClickListener {
        C25059() {
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C25061 implements ChatMessageCellDelegate {
            C25061() {
            }
        ...
        class C25072 implements ChatActionCellDelegate {
            C25072() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            if (viewType == 0) {
                ...
                ((ChatMessageCell) view).setDelegate(new C25061());
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C25072());
            }
            view.setLayoutParams(new LayoutParams(-1, -2));
            return new Holder(view);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) C0500R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C24971()).getSearchField().setHint(LocaleController.getString("Search", C0500R.string.Search));
        this.actionBar.setBackButtonDrawable(new MenuDrawable());
        this.actionBar.setAddToContainer(false);
        this.actionBar.setTitle(LocaleController.getString("ThemePreview", C0500R.string.ThemePreview));
        this.page1 = new FrameLayout(context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C24993());
        }
        ...
        viewPager.addOnPageChangeListener(new C25015());
        viewPager.setAdapter(new C25026());
        ...
        viewPager.setBackgroundResource(C0500R.drawable.header_shadow_reverse);
        ...
        cancelButton.setText(LocaleController.getString("Cancel", C0500R.string.Cancel).toUpperCase());
        cancelButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        bottomLayout.addView(cancelButton, LayoutHelper.createFrame(-2, -1, 51));
        cancelButton.setOnClickListener(new C25048());
        ...
        doneButton.setText(LocaleController.getString("ApplyTheme", C0500R.string.ApplyTheme).toUpperCase());
        ...
        doneButton.setOnClickListener(new C25059());
