...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C17373 extends ViewOutlineProvider {
        C17373() {
        }
    ...
    class C17398 implements OnClickListener {
        C17398() {
        }
    ...
    class C17409 implements OnClickListener {
        C17409() {
        }
    ...
    class C23141 extends ActionBarMenuItemSearchListener {
        C23141() {
        }
    ...
    class C23165 implements OnPageChangeListener {
        C23165() {
        }
    ...
    class C23176 extends PagerAdapter {
        C23176() {
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C23181 implements ChatMessageCellDelegate {
            C23181() {
            }
        ...
        class C23192 implements ChatActionCellDelegate {
            C23192() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            if (viewType == 0) {
                ...
                ((ChatMessageCell) view).setDelegate(new C23181());
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C23192());
            }
            view.setLayoutParams(new LayoutParams(-1, -2));
            return new Holder(view);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C23141()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C17373());
        }
        ...
        viewPager.addOnPageChangeListener(new C23165());
        viewPager.setAdapter(new C23176());
        ...
        cancelButton.setOnClickListener(new C17398());
        ...
        doneButton.setOnClickListener(new C17409());
