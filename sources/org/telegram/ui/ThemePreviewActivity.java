...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C17601 extends ActionBarMenuItemSearchListener {
        C17601() {
        }
    ...
    class C17623 extends ViewOutlineProvider {
        C17623() {
        }
    ...
    class C17645 implements OnPageChangeListener {
        C17645() {
        }
    ...
    class C17656 extends PagerAdapter {
        C17656() {
        }
    ...
    class C17678 implements OnClickListener {
        C17678() {
        }
    ...
    class C17689 implements OnClickListener {
        C17689() {
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C17691 implements ChatMessageCellDelegate {
            C17691() {
            }
        ...
        class C17702 implements ChatActionCellDelegate {
            C17702() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            if (viewType == 0) {
                ...
                ((ChatMessageCell) view).setDelegate(new C17691());
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C17702());
            }
            view.setLayoutParams(new LayoutParams(-1, -2));
            return new Holder(view);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) C0431R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C17601()).getSearchField().setHint(LocaleController.getString("Search", C0431R.string.Search));
        this.actionBar.setBackButtonDrawable(new MenuDrawable());
        this.actionBar.setAddToContainer(false);
        this.actionBar.setTitle(LocaleController.getString("ThemePreview", C0431R.string.ThemePreview));
        this.page1 = new FrameLayout(context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C17623());
        }
        ...
        viewPager.addOnPageChangeListener(new C17645());
        viewPager.setAdapter(new C17656());
        ...
        viewPager.setBackgroundResource(C0431R.drawable.header_shadow_reverse);
        ...
        cancelButton.setText(LocaleController.getString("Cancel", C0431R.string.Cancel).toUpperCase());
        cancelButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        bottomLayout.addView(cancelButton, LayoutHelper.createFrame(-2, -1, 51));
        cancelButton.setOnClickListener(new C17678());
        ...
        doneButton.setText(LocaleController.getString("ApplyTheme", C0431R.string.ApplyTheme).toUpperCase());
        ...
        doneButton.setOnClickListener(new C17689());
