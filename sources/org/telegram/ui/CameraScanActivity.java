...
public class CameraScanActivity extends BaseFragment {
    ...
    private Runnable requestShot = new Runnable() {
        ...
        public /* synthetic */ void m1481lambda$run$0$orgtelegramuiCameraScanActivity$7() {
    ...
    public static ActionBarLayout[] showAsSheet(BaseFragment parentFragment, boolean gallery, int type, CameraScanActivityDelegate cameraDelegate) {
        ...
        AnonymousClass1 r3 = new BottomSheet(parentFragment.getParentActivity(), false, actionBarLayout, type, gallery, cameraDelegate) {
...

            {
                ...
                this.fragment = r1;
                boolean unused = r1.needGalleryButton = r8;
            ...
            public /* synthetic */ void m1480lambda$new$0$orgtelegramuiCameraScanActivity$1(DialogInterface dialog) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            r3.getWindow().setNavigationBarColor(-16777216);
        }
    ...
    public /* synthetic */ void m1470lambda$new$0$orgtelegramuiCameraScanActivity() {
    ...
    public View createView(Context context) {
        ...
        if (i == 1 || i == 2) {
            this.fragmentView.postDelayed(new CameraScanActivity$$ExternalSyntheticLambda6(this), 350);
        } else {
            initCameraView();
        }
    ...
    public /* synthetic */ void m1464lambda$createView$2$orgtelegramuiCameraScanActivity(View currentImage) {
        if (getParentActivity() != null) {
    ...
    public /* synthetic */ void m1466lambda$createView$4$orgtelegramuiCameraScanActivity(View currentImage) {
    ...
    public /* synthetic */ void m1465lambda$createView$3$orgtelegramuiCameraScanActivity(ValueAnimator animation) {
    ...
    public /* synthetic */ void m1478lambda$updateRecognized$5$orgtelegramuiCameraScanActivity(ValueAnimator a) {
    ...
    public /* synthetic */ void m1479lambda$updateRecognized$6$orgtelegramuiCameraScanActivity(DynamicAnimation animation, float value, float velocity) {
    ...
    public /* synthetic */ void m1469lambda$initCameraView$9$orgtelegramuiCameraScanActivity() {
        startRecognizing();
        if (isQr()) {
    ...
    public /* synthetic */ void m1467lambda$initCameraView$7$orgtelegramuiCameraScanActivity(DynamicAnimation animation, float value, float velocity) {
    ...
    public /* synthetic */ void m1468lambda$initCameraView$8$orgtelegramuiCameraScanActivity(DynamicAnimation animation, boolean canceled, float value, float velocity) {
        SpringAnimation springAnimation = this.qrAppearing;
        if (springAnimation != null) {
            springAnimation.cancel();
            this.qrAppearing = null;
    ...
    public /* synthetic */ void m1471lambda$onNoQrFound$10$orgtelegramuiCameraScanActivity() {
    ...
    public /* synthetic */ void m1472lambda$processShot$11$orgtelegramuiCameraScanActivity(MrzRecognizer.Result res) {
    ...
    public /* synthetic */ void m1474lambda$processShot$13$orgtelegramuiCameraScanActivity() {
        CameraView cameraView2 = this.cameraView;
    ...
    public /* synthetic */ void m1473lambda$processShot$12$orgtelegramuiCameraScanActivity() {
        CameraScanActivityDelegate cameraScanActivityDelegate = this.delegate;
        if (cameraScanActivityDelegate != null) {
    ...
    public /* synthetic */ void m1475lambda$processShot$14$orgtelegramuiCameraScanActivity(QrResult res) {
    ...
    public /* synthetic */ void m1476lambda$processShot$15$orgtelegramuiCameraScanActivity() {
        CameraScanActivityDelegate cameraScanActivityDelegate = this.delegate;
        if (cameraScanActivityDelegate != null) {
            cameraScanActivityDelegate.didFindQr(this.recognizedText);
        }
    ...
    public /* synthetic */ void m1477lambda$processShot$16$orgtelegramuiCameraScanActivity() {
        CameraView cameraView2 = this.cameraView;
        if (cameraView2 != null) {
