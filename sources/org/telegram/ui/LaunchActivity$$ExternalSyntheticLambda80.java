...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda80 implements ChatAttachAlertContactsLayout.PhonebookShareAlertDelegate {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda80(LaunchActivity launchActivity, ChatActivity chatActivity, ArrayList arrayList, int i, CharSequence charSequence, boolean z) {
    ...
    public final void didSelectContact(TLRPC$User tLRPC$User, boolean z, int i) {
        this.f$0.lambda$didSelectDialogs$65(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, tLRPC$User, z, i);
    }
}
