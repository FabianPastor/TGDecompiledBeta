...
public abstract class BaseChartView<T extends ChartData, L extends LineViewData> extends View implements ChartPickerDelegate.Listener {
    ...
    public /* synthetic */ void m2898lambda$new$0$orgtelegramuiChartsBaseChartView(ValueAnimator animation) {
    ...
    public /* synthetic */ void m2899lambda$new$1$orgtelegramuiChartsBaseChartView(ValueAnimator animation) {
    ...
    public /* synthetic */ void m2902lambda$setMaxMinValue$2$orgtelegramuiChartsBaseChartView(ChartHorizontalLinesData newData, ValueAnimator animation) {
    ...
    public /* synthetic */ void m2903lambda$updateDates$3$orgtelegramuiChartsBaseChartView(ChartBottomSignatureData data, ValueAnimator animation) {
    ...
    public /* synthetic */ void m2900lambda$onCheckChanged$4$orgtelegramuiChartsBaseChartView(LineViewData lineViewData, ValueAnimator animation) {
    ...
    public /* synthetic */ void m2901lambda$onCheckChanged$5$orgtelegramuiChartsBaseChartView(LineViewData lineViewData, ValueAnimator animation) {
        lineViewData.alpha = ((Float) animation.getAnimatedValue()).floatValue();
        this.invalidatePickerChart = true;
        invalidate();
    }
