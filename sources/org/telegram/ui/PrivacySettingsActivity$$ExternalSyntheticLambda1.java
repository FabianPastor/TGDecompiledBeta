...
public final /* synthetic */ class PrivacySettingsActivity$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ PrivacySettingsActivity$$ExternalSyntheticLambda1(PrivacySettingsActivity privacySettingsActivity, TextCheckCell textCheckCell) {
        this.f$0 = privacySettingsActivity;
        this.f$1 = textCheckCell;
    }

    public final void run() {
        this.f$0.m3024lambda$createView$7$orgtelegramuiPrivacySettingsActivity(this.f$1);
    }
}
