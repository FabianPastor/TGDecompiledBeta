...
public class DialogsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    L_0x0164:
        r3 = NUM; // 0x7f0d035b float:1.8743857E38 double:1.053130202E-314;
    ...
    L_0x019c:
        r3 = NUM; // 0x7f0d02d1 float:1.8743577E38 double:1.053130134E-314;
        r4 = new java.lang.Object[r9];
    ...
    L_0x01d0:
        ...
        r1 = org.telegram.messenger.LocaleController.getString(r3, r1);
        r0.setMessage(r1);
        r1 = NUM; // 0x7f0d02d4 float:1.8743583E38 double:1.0531301352E-314;
        r3 = "ClearHistory";
        r1 = org.telegram.messenger.LocaleController.getString(r3, r1);
