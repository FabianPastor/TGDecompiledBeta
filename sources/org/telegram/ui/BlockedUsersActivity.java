...
public class BlockedUsersActivity extends BaseFragment implements NotificationCenterDelegate, ContactsActivityDelegate {
    ...
    class C06861 extends ActionBarMenuOnItemClick {
        C06861() {
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                default:
                    ...
                    ((TextInfoCell) view).setText(LocaleController.getString("UnblockText", C0431R.string.UnblockText));
                    break;
            }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (holder.getItemViewType() == 0) {
                ...
                if (user != null) {
                    String number;
                    if (user.bot) {
                        number = LocaleController.getString("Bot", C0431R.string.Bot).substring(0, 1).toUpperCase() + LocaleController.getString("Bot", C0431R.string.Bot).substring(1);
                    } else if (user.phone == null || user.phone.length() == 0) {
                        number = LocaleController.getString("NumberUnknown", C0431R.string.NumberUnknown);
                    } else {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("BlockedUsers", C0431R.string.BlockedUsers));
        this.actionBar.setActionBarMenuOnItemClick(new C06861());
        this.actionBar.createMenu().addItem(1, (int) C0431R.drawable.plus);
        this.fragmentView = new FrameLayout(context);
        FrameLayout frameLayout = this.fragmentView;
        this.emptyView = new EmptyTextProgressView(context);
        this.emptyView.setText(LocaleController.getString("NoBlocked", C0431R.string.NoBlocked));
    ...
    final /* synthetic */ boolean lambda$createView$2$BlockedUsersActivity(View view, int position) {
        if (position < MessagesController.getInstance(this.currentAccount).blockedUsers.size() && getParentActivity() != null) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Unblock", C0431R.string.Unblock)}, new BlockedUsersActivity$$Lambda$3(this));
