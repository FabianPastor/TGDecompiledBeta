...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda72 implements RequestDelegate {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda72(LaunchActivity launchActivity, String str, String str2, String str3, int i, String str4, String str5, Integer num, Integer num2, Integer num3, int[] iArr, AlertDialog alertDialog, String str6, String str7, String str8, int i2) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        ...
        launchActivity2.lambda$runLinkRequest$39(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12, this.f$13, this.f$14, this.f$15, tLObject, tLRPC$TL_error);
    }
}
