...
public class MessageSeenView extends FrameLayout {
    ...
    public /* synthetic */ void m3299lambda$new$5$orgtelegramuiMessageSeenView(long finalFromId, int currentAccount2, TLRPC.Chat chat, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3298lambda$new$4$orgtelegramuiMessageSeenView(TLRPC.TL_error error, TLObject response, long finalFromId, int currentAccount2, TLRPC.Chat chat) {
    ...
    public /* synthetic */ void m3295lambda$new$1$orgtelegramuiMessageSeenView(int currentAccount2, HashMap usersLocal, ArrayList allPeers, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m3294lambda$new$0$orgtelegramuiMessageSeenView(TLObject response1, int currentAccount2, HashMap usersLocal, ArrayList allPeers) {
        if (response1 != null) {
    ...
    public /* synthetic */ void m3297lambda$new$3$orgtelegramuiMessageSeenView(int currentAccount2, HashMap usersLocal, ArrayList allPeers, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m3296lambda$new$2$orgtelegramuiMessageSeenView(TLObject response1, int currentAccount2, HashMap usersLocal, ArrayList allPeers) {
        if (response1 != null) {
