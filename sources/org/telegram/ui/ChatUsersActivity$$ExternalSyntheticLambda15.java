...
public final /* synthetic */ class ChatUsersActivity$$ExternalSyntheticLambda15 implements Runnable {
    ...
    public /* synthetic */ ChatUsersActivity$$ExternalSyntheticLambda15(TLRPC.TL_error tL_error, TLObject tLObject, ArrayList arrayList, int i, AtomicInteger atomicInteger, ArrayList arrayList2, Runnable runnable) {
        this.f$0 = tL_error;
        this.f$1 = tLObject;
        this.f$2 = arrayList;
        this.f$3 = i;
