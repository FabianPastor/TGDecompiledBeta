...
public final /* synthetic */ class PassportActivity$$ExternalSyntheticLambda63 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m3412lambda$deleteValueInternal$60$orgtelegramuiPassportActivity(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, tLObject, tL_error);
    }
}
