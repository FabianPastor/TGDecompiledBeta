...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    static /* synthetic */ void lambda$null$14(TLObject tLObject, TLRPC.TL_error tL_error) {
    }

    static /* synthetic */ void lambda$onFragmentDestroy$0(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    public /* synthetic */ void lambda$createView$17$PrivacySettingsActivity(View view, int i) {
        ...
        if (view.isEnabled()) {
            ...
            if (i2 == this.sessionsRow) {
            ...
            } else if (i2 == this.clearDraftsRow) {
                    ...
                    while (i4 < strArr.length) {
                        ...
                        radioColorCell.setOnClickListener(new View.OnClickListener(builder2) {
                            ...
                            public final void onClick(View view) {
                                PrivacySettingsActivity.this.lambda$null$6$PrivacySettingsActivity(this.f$1, view);
                            }
                        });
                        i4++;
                    }
                ...
                if (getParentActivity() != null) {
                    ...
                    builder3.setTitle(LocaleController.getString("SyncContactsDeleteTitle", NUM));
                    builder3.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("SyncContactsDeleteText", NUM)));
                ...
                this.newSuggest = !z2;
                textCheckCell2.setChecked(this.newSuggest);
                ...
                builder5.setTitle(LocaleController.getString("PrivacyPaymentsClearAlertTitle", NUM));
                builder5.setMessage(LocaleController.getString("PrivacyPaymentsClearAlertText", NUM));
                ...
                while (i5 < 2) {
                    if (i5 == 0) {
                        ...
                        str = i5 == 1 ? LocaleController.getString("PrivacyClearPayment", NUM) : null;
                    }
                    this.clear[i5] = true;
                ...
                builder5.setPositiveButton(LocaleController.getString("ClearButton", NUM), new DialogInterface.OnClickListener() {
                    public final void onClick(DialogInterface dialogInterface, int i) {
                        PrivacySettingsActivity.this.lambda$null$16$PrivacySettingsActivity(dialogInterface, i);
                    }
                });
                builder5.setNegativeButton(LocaleController.getString("Cancel", NUM), (DialogInterface.OnClickListener) null);
                showDialog(builder5.create());
                AlertDialog create4 = builder5.create();
                showDialog(create4);
                TextView textView4 = (TextView) create4.getButton(-1);
                if (textView4 != null) {
                    textView4.setTextColor(Theme.getColor("dialogTextRed2"));
                }
    ...
    public /* synthetic */ void lambda$null$2$PrivacySettingsActivity(TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$null$6$PrivacySettingsActivity(AlertDialog.Builder builder, View view) {
        int i;
        ...
        alertDialog.show();
        TLRPC.TL_account_setAccountTTL tL_account_setAccountTTL = new TLRPC.TL_account_setAccountTTL();
        tL_account_setAccountTTL.ttl = new TLRPC.TL_accountDaysTTL();
        tL_account_setAccountTTL.ttl.days = i;
        getConnectionsManager().sendRequest(tL_account_setAccountTTL, new RequestDelegate(alertDialog, tL_account_setAccountTTL) {
    ...
    public /* synthetic */ void lambda$null$5$PrivacySettingsActivity(AlertDialog alertDialog, TLRPC.TL_account_setAccountTTL tL_account_setAccountTTL, TLObject tLObject, TLRPC.TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new Runnable(alertDialog, tLObject, tL_account_setAccountTTL) {
            private final /* synthetic */ AlertDialog f$1;
    ...
    public /* synthetic */ void lambda$null$4$PrivacySettingsActivity(AlertDialog alertDialog, TLObject tLObject, TLRPC.TL_account_setAccountTTL tL_account_setAccountTTL) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
    ...
    public /* synthetic */ void lambda$null$8$PrivacySettingsActivity(DialogInterface dialogInterface, int i) {
        this.progressDialog = new AlertDialog.Builder(getParentActivity(), 3).show();
    ...
    public /* synthetic */ void lambda$null$11$PrivacySettingsActivity(TextCheckCell textCheckCell, DialogInterface dialogInterface, int i) {
        ...
        getUserConfig().saveConfig(false);
        getConnectionsManager().sendRequest(tL_payments_clearSavedInfo, new RequestDelegate(textCheckCell) {
            private final /* synthetic */ TextCheckCell f$1;
    ...
    public /* synthetic */ void lambda$null$10$PrivacySettingsActivity(TextCheckCell textCheckCell, TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public /* synthetic */ void lambda$loadPasswordSettings$19$PrivacySettingsActivity(TLObject tLObject, TLRPC.TL_error tL_error) {
            ...
            for (int i5 = 0; i5 < privacyRules.size(); i5++) {
                ...
                if (privacyRule instanceof TLRPC.TL_privacyValueAllowChatParticipants) {
                    ...
                    for (int i7 = 0; i7 < size; i7++) {
                        TLRPC.Chat chat = accountInstance.getMessagesController().getChat(tL_privacyValueAllowChatParticipants.chats.get(i7));
                        if (chat != null) {
                    ...
                    for (int i8 = 0; i8 < size2; i8++) {
                        TLRPC.Chat chat2 = accountInstance.getMessagesController().getChat(tL_privacyValueDisallowChatParticipants.chats.get(i8));
                        if (chat2 != null) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == PrivacySettingsActivity.this.blockedRow) {
                    ...
                    if (i2 == 0) {
                        ...
                        textSettingsCell.setTextAndValue(LocaleController.getString("BlockedUsers", NUM), String.format("%d", new Object[]{Integer.valueOf(i2)}), true);
                    } else {
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(6)) {
                        str8 = LocaleController.getString("Loading", NUM);
                    } else {
                        str8 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 6);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyPhone", NUM), str8, true);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(0)) {
                        str7 = LocaleController.getString("Loading", NUM);
                    } else {
                        str7 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 0);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyLastSeen", NUM), str7, true);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(1)) {
                        str6 = LocaleController.getString("Loading", NUM);
                    } else {
                        str6 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 1);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("GroupsAndChannels", NUM), str6, false);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(2)) {
                        str5 = LocaleController.getString("Loading", NUM);
                    } else {
                        str5 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 2);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("Calls", NUM), str5, true);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(4)) {
                        str4 = LocaleController.getString("Loading", NUM);
                    } else {
                        str4 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 4);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyProfilePhoto", NUM), str4, true);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingPrivicyInfo(5)) {
                        str3 = LocaleController.getString("Loading", NUM);
                    } else {
                        str3 = PrivacySettingsActivity.formatRulesString(PrivacySettingsActivity.this.getAccountInstance(), 5);
                    }
                    textSettingsCell.setTextAndValue(LocaleController.getString("PrivacyForwards", NUM), str3, true);
                    ...
                    if (PrivacySettingsActivity.this.getContactsController().getLoadingDeleteInfo()) {
                        str2 = LocaleController.getString("Loading", NUM);
                    } else {
                    ...
                    textSettingsCell.setTextAndValue(LocaleController.getString("DeleteAccountIfAwayFor2", NUM), str2, false);
