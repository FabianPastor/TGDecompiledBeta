...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m3668lambda$createView$15$orgtelegramuiPrivacySettingsActivity(View view, int position) {
        String name;
        int type;
        int selected;
        View view2 = view;
            ...
            if (i == this.sessionsRow) {
                ...
                if (i == this.deleteAccountRow) {
                    if (getParentActivity() != null) {
                        ...
                        String[] items = {LocaleController.formatPluralString("Months", 1), LocaleController.formatPluralString("Months", 3), LocaleController.formatPluralString("Months", 6), LocaleController.formatPluralString("Years", 1)};
    ...
    public /* synthetic */ void m3671lambda$createView$4$orgtelegramuiPrivacySettingsActivity(AlertDialog.Builder builder, View v) {
        ...
        progressDialog2.setCanCacnel(false);
    ...
    public /* synthetic */ void m3670lambda$createView$3$orgtelegramuiPrivacySettingsActivity(AlertDialog progressDialog2, TLRPC.TL_account_setAccountTTL req, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3669lambda$createView$2$orgtelegramuiPrivacySettingsActivity(AlertDialog progressDialog2, TLObject response, TLRPC.TL_account_setAccountTTL req) {
        try {
    ...
    public /* synthetic */ void m3673lambda$createView$6$orgtelegramuiPrivacySettingsActivity(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m3672lambda$createView$5$orgtelegramuiPrivacySettingsActivity() {
        this.progressDialog.dismiss();
    }

    /* renamed from: lambda$createView$9$org-telegram-ui-PrivacySettingsActivity  reason: not valid java name */
    public /* synthetic */ void m3676lambda$createView$9$orgtelegramuiPrivacySettingsActivity(TextCheckCell cell, DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m3675lambda$createView$8$orgtelegramuiPrivacySettingsActivity(TextCheckCell cell, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3674lambda$createView$7$orgtelegramuiPrivacySettingsActivity(TextCheckCell cell) {
    ...
    public /* synthetic */ void m3664lambda$createView$10$orgtelegramuiPrivacySettingsActivity() {
        this.listAdapter.notifyDataSetChanged();
    }

    /* renamed from: lambda$createView$11$org-telegram-ui-PrivacySettingsActivity  reason: not valid java name */
    public /* synthetic */ void m3665lambda$createView$11$orgtelegramuiPrivacySettingsActivity(View v) {
    ...
    public /* synthetic */ void m3667lambda$createView$14$orgtelegramuiPrivacySettingsActivity(DialogInterface dialogInterface, int i) {
        try {
    ...
    public /* synthetic */ void m3666lambda$createView$13$orgtelegramuiPrivacySettingsActivity(DialogInterface dialogInterface2, int i2) {
        String text;
        TLRPC.TL_payments_clearSavedInfo req = new TLRPC.TL_payments_clearSavedInfo();
        req.credentials = this.clear[1];
        req.info = this.clear[0];
    ...
    public /* synthetic */ void m3678xbd2153e9(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m3677x308128e8(TLRPC.TL_account_password password) {
