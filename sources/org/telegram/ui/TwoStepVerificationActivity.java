...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C12622 implements Callback {
        C12622() {
        }
    ...
    class C17351 extends ActionBarMenuOnItemClick {
        C17351() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C17351());
        ...
        this.passwordEditText.setCustomSelectionActionModeCallback(new C12622());
    ...
    public static void initPasswordNewAlgo(TL_account_password password) {
        if (password.new_algo instanceof C1757xb6caa888) {
            C1757xb6caa888 algo = password.new_algo;
    ...
    final /* synthetic */ void lambda$setNewPassword$20$TwoStepVerificationActivity(TL_account_updatePasswordSettings req, boolean clear, String password) {
        ...
        if (this.currentPassword.new_algo instanceof C1757xb6caa888) {
            if (password != null) {
                C1757xb6caa888 algo = (C1757xb6caa888) this.currentPassword.new_algo;
    ...
    final /* synthetic */ void lambda$processDone$28$TwoStepVerificationActivity(byte[] oldPasswordBytes) {
        ...
        if (this.currentPassword.current_algo instanceof C1757xb6caa888) {
            req.password = SRPHelper.startCheck(x_bytes, this.currentPassword.srp_id, this.currentPassword.srp_B, (C1757xb6caa888) this.currentPassword.current_algo);
            if (req.password == null) {
                TL_error error = new TL_error();
                error.text = "ALGO_INVALID";
