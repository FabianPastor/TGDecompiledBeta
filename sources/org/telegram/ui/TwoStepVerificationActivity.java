...
public class TwoStepVerificationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m4736lambda$new$0$orgtelegramuiTwoStepVerificationActivity() {
    ...
    public /* synthetic */ void m4727lambda$createView$1$orgtelegramuiTwoStepVerificationActivity(View v, boolean hasFocus) {
    ...
    public /* synthetic */ boolean m4728lambda$createView$2$orgtelegramuiTwoStepVerificationActivity(TextView textView, int i, KeyEvent keyEvent) {
        if (i != 5 && i != 6) {
            return false;
        }
        processDone();
    ...
    public /* synthetic */ void m4729lambda$createView$3$orgtelegramuiTwoStepVerificationActivity(View v) {
        onPasswordForgot();
    }

    /* renamed from: lambda$createView$4$org-telegram-ui-TwoStepVerificationActivity  reason: not valid java name */
    public /* synthetic */ void m4730lambda$createView$4$orgtelegramuiTwoStepVerificationActivity(View v) {
        cancelPasswordReset();
    }

    /* renamed from: lambda$createView$5$org-telegram-ui-TwoStepVerificationActivity  reason: not valid java name */
    public /* synthetic */ void m4731lambda$createView$5$orgtelegramuiTwoStepVerificationActivity(View view) {
        processDone();
    }

    /* renamed from: lambda$createView$7$org-telegram-ui-TwoStepVerificationActivity  reason: not valid java name */
    public /* synthetic */ void m4733lambda$createView$7$orgtelegramuiTwoStepVerificationActivity(View view, int position) {
    ...
    public /* synthetic */ void m4732lambda$createView$6$orgtelegramuiTwoStepVerificationActivity(DialogInterface dialogInterface, int i) {
        clearPassword();
    }
    ...
    public /* synthetic */ void m4717xec9f1fee(DialogInterface dialog, int which) {
    ...
    public /* synthetic */ void m4719x90dee49a(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4718xvar_e2219(TLObject response) {
    ...
    public /* synthetic */ void m4751x681CLASSNAME(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4750x6be0fec0(TLObject response) {
        String timeString;
        needHideProgress();
    ...
    public /* synthetic */ void m4749xd1403c3f(DialogInterface dialog) {
    ...
    public /* synthetic */ void m4739xda2170f6(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4738x3var_ae75(TLRPC.TL_error error, TLObject response) {
        String timeString;
        needHideProgress();
        if (error == null) {
    ...
    public /* synthetic */ void m4740x74CLASSNAME(DialogInterface dialog, int which) {
        resetPassword();
    }

    /* renamed from: lambda$onPasswordForgot$17$org-telegram-ui-TwoStepVerificationActivity  reason: not valid java name */
    public /* synthetic */ void m4741xvar_f5f8(DialogInterface dialog, int which) {
        resetPassword();
    }
    ...
    public /* synthetic */ void m4735x983e2028(boolean silent, boolean first, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4734xfd9d5da7(TLRPC.TL_error error, TLObject response, boolean silent, boolean first) {
        if (error == null) {
            this.loading = false;
    ...
    public /* synthetic */ void m4753lambda$updateRows$20$orgtelegramuiTwoStepVerificationActivity() {
    ...
    public /* synthetic */ void m4726xvar_fa26(TLRPC.TL_account_updatePasswordSettings req) {
    ...
    public /* synthetic */ void m4721xvar_da1(TLObject response2, TLRPC.TL_error error2) {
    ...
    public /* synthetic */ void m4720x57CLASSNAMEb20(TLRPC.TL_error error2, TLObject response2) {
        if (error2 == null) {
    ...
    public /* synthetic */ void m4725x5ce737a5(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4724xCLASSNAME(TLRPC.TL_error error, TLObject response) {
        String timeString;
    ...
    public /* synthetic */ void m4723x27a5b2a3(TLObject response2, TLRPC.TL_error error2) {
    ...
    public /* synthetic */ void m4722x8d04var_(TLRPC.TL_error error2, TLObject response2) {
        if (error2 == null) {
            TLRPC.TL_account_password tL_account_password = (TLRPC.TL_account_password) response2;
            this.currentPassword = tL_account_password;
            initPasswordNewAlgo(tL_account_password);
    ...
    public /* synthetic */ void m4748x8a83005a(byte[] oldPasswordBytes) {
        byte[] x_bytes;
    ...
    public /* synthetic */ void m4747xefe23dd9(byte[] oldPasswordBytes, byte[] x_bytes, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m4743x855var_d5(byte[] oldPasswordBytes, TLObject response, byte[] x_bytes) {
    ...
    public /* synthetic */ void m4742x3b8e7cbf(boolean secretOk, byte[] x_bytes) {
    ...
    public /* synthetic */ void m4746x55417b58(TLRPC.TL_error error) {
        String timeString;
    ...
    public /* synthetic */ void m4745xbaa0b8d7(TLObject response2, TLRPC.TL_error error2) {
    ...
    public /* synthetic */ void m4744x1fffvar_(TLRPC.TL_error error2, TLObject response2) {
        if (error2 == null) {
            TLRPC.TL_account_password tL_account_password = (TLRPC.TL_account_password) response2;
            this.currentPassword = tL_account_password;
            initPasswordNewAlgo(tL_account_password);
    ...
    public /* synthetic */ void m4737x551b7b25() {
    ...
    public /* synthetic */ void m4752xa71edCLASSNAME(DialogInterface a1, int a2) {
        finishFragment();
    }
