...
public class IdenticonActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C14852 implements OnTouchListener {
        C14852() {
        }
    ...
    class C14874 extends AnimatorListenerAdapter {
        C14874() {
        }
    ...
    class C14885 implements OnPreDrawListener {
        C14885() {
        }
    ...
    public View createView(Context context) {
        ...
        this.fragmentView.setOnTouchListener(new C14852());
    ...
    private void updateEmojiButton(boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new C14874());
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C14885());
    }
