...
public class IdenticonActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C14822 implements OnTouchListener {
        C14822() {
        }
    ...
    class C14844 extends AnimatorListenerAdapter {
        C14844() {
        }
    ...
    class C14855 implements OnPreDrawListener {
        C14855() {
        }
    ...
    class C23041 extends ActionBarMenuOnItemClick {
        C23041() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C23041());
        this.fragmentView = new FrameLayout(context);
        FrameLayout parentFrameLayout = this.fragmentView;
        this.fragmentView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        this.fragmentView.setOnTouchListener(new C14822());
    ...
    private void updateEmojiButton(boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new C14844());
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C14855());
    }
