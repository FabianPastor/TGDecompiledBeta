...
public class PinchToZoomHelper {
    ...
    private void setFullImage(MessageObject messageObject2) {
        ...
        if (messageObject3 != null && messageObject2.isPhoto()) {
            ...
            if (imageLocation != null) {
                this.fullImage.setImage(imageLocation, (String) null, (ImageLocation) null, (String) null, (Drawable) null, size[0], (String) null, messageObject2, messageObject3 != null && messageObject2.isWebpage() ? 1 : 0);
    ...
    public /* synthetic */ void m2991lambda$finishZoom$0$orgtelegramuiPinchToZoomHelper(ValueAnimator valueAnimator) {
