        ...
        if (this.adapter.items != null) {
            ...
            while (true) {
                ...
                if (tlTheme != null) {
                    ...
                    if (Theme.getCurrentTheme().name.equals(themeInfo.getKey()) && this.adapter.items.get(i).chatTheme.getAccentId(this.themeIndex) == Theme.getCurrentTheme().currentAccentId) {
                        this.selectedPosition = i;
                        break;
                    }
                } else {
