...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda37 implements Runnable {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda37(LaunchActivity launchActivity, AlertDialog alertDialog, TLObject tLObject, int i, TLRPC.TL_account_authorizationForm tL_account_authorizationForm, TLRPC.TL_account_getAuthorizationForm tL_account_getAuthorizationForm, String str, String str2, String str3) {
    ...
    public final void run() {
        this.f$0.m3101lambda$runLinkRequest$35$orgtelegramuiLaunchActivity(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
