...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    L_0x001f:
        r0 = r8.actionBar;
        r1 = NUM; // 0x7f0e0a02 float:1.8880234E38 double:1.0531634224E-314;
        r2 = "SelectContact";
    ...
    L_0x0032:
        r0 = r8.actionBar;
        r1 = NUM; // 0x7f0e069c float:1.887847E38 double:1.0531629926E-314;
        r2 = "NewSecretChat";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setTitle(r1);
        goto L_0x005e;
    ...
    L_0x0153:
        ...
        r1 = r8.emptyView;
        r2 = NUM; // 0x7f0e06b1 float:1.8878512E38 double:1.053163003E-314;
        r3 = "NoContacts";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r1.setText(r2);
        r1 = r8.emptyView;
