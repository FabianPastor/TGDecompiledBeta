...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    L_0x0050:
        r0 = r8.actionBar;
        r1 = NUM; // 0x7f0d02fe float:1.8743668E38 double:1.053130156E-314;
        r2 = "Contacts";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setTitle(r1);
    L_0x005e:
    ...
    L_0x014f:
        ...
        r1 = r8.emptyView;
        r2 = NUM; // 0x7f0d061c float:1.8745287E38 double:1.0531305503E-314;
        r3 = "NoContacts";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r1.setText(r2);
        r1 = r8.emptyView;
    ...
    L_0x028f:
        ...
        r0 = r8.floatingButtonContainer;
        r1 = NUM; // 0x7f0d0313 float:1.874371E38 double:1.0531301664E-314;
        r2 = "CreateNewContact";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setContentDescription(r1);
