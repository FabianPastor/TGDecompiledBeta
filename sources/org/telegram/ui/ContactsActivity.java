...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C13051 extends ActionBarMenuOnItemClick {
        C13051() {
        }
    ...
    class C13062 extends ActionBarMenuItemSearchListener {
        C13062() {
        }
        ...
        public void onSearchCollapse() {
            ...
            ContactsActivity.this.emptyView.setText(LocaleController.getString("NoContacts", C0431R.string.NoContacts));
        }
            ...
            if (ContactsActivity.this.searchListViewAdapter != null) {
                ...
                if (text.length() != 0) {
                    ...
                    if (ContactsActivity.this.emptyView != null) {
                        ...
                        ContactsActivity.this.emptyView.setText(LocaleController.getString("NoResult", C0431R.string.NoResult));
                    }
                }
    ...
    class C13095 implements OnItemClickListener {
        C13095() {
        }
                ...
                if ((ContactsActivity.this.onlyUsers && ContactsActivity.this.chat_id == 0) || section != 0) {
                    ...
                    if (item instanceof User) {
                        ...
                        if (usePhone != null && ContactsActivity.this.getParentActivity() != null) {
                            ...
                            builder.setMessage(LocaleController.getString("InviteUser", C0431R.string.InviteUser));
                            builder.setTitle(LocaleController.getString("AppName", C0431R.string.AppName));
                            builder.setPositiveButton(LocaleController.getString("OK", C0431R.string.OK), new ContactsActivity$5$$Lambda$0(this, usePhone));
    ...
    class C13106 extends OnScrollListener {
        C13106() {
        }
    ...
    class C13139 implements IntCallback {
        C13139() {
        }
    ...
    public View createView(Context context) {
        ...
        if (!this.destroyAfterSelect) {
            this.actionBar.setTitle(LocaleController.getString("Contacts", C0431R.string.Contacts));
        } else if (this.returnAsResult) {
            this.actionBar.setTitle(LocaleController.getString("SelectContact", C0431R.string.SelectContact));
        } else if (this.createSecretChat) {
            this.actionBar.setTitle(LocaleController.getString("NewSecretChat", C0431R.string.NewSecretChat));
        } else {
            this.actionBar.setTitle(LocaleController.getString("NewMessageTitle", C0431R.string.NewMessageTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C13051());
        ActionBarMenu menu = this.actionBar.createMenu();
        menu.addItem(0, (int) C0431R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C13062()).getSearchField().setHint(LocaleController.getString("Search", C0431R.string.Search));
        if (!(this.createSecretChat || this.returnAsResult)) {
            this.addItem = menu.addItem(1, (int) C0431R.drawable.add);
        }
        ...
        this.listView.setOnItemClickListener(new C13095());
        this.listView.setOnScrollListener(new C13106());
    ...
    private void didSelectResult(final User user, boolean useAlert, String param) {
        if (!useAlert || this.selectAlertString == null) {
            ...
            if (user.bot && user.bot_nochats && !this.addingToChannel) {
                try {
                    Toast.makeText(getParentActivity(), LocaleController.getString("BotCantJoinGroups", C0431R.string.BotCantJoinGroups), 0).show();
                    return;
                } catch (Throwable e) {
                    FileLog.m8e(e);
                    return;
            ...
            if (!user.bot && this.needForwardCount) {
                message = String.format("%s\n\n%s", new Object[]{message, LocaleController.getString("AddToTheGroupForwardCount", C0431R.string.AddToTheGroupForwardCount)});
        ...
        if (this.checkPermission && VERSION.SDK_INT >= 23) {
            ...
            if (activity != null) {
                ...
                if (activity.shouldShowRequestPermissionRationale("android.permission.READ_CONTACTS")) {
                    Dialog create = AlertsCreator.createContactsPermissionDialog(activity, new C13139()).create();
