...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    L_0x001f:
        r0 = r8.actionBar;
        r1 = NUM; // 0x7f0d0933 float:1.8746891E38 double:1.053130941E-314;
        r2 = "SelectContact";
    ...
    L_0x005e:
        ...
        r2 = NUM; // 0x7f0d090b float:1.874681E38 double:1.0531309213E-314;
        r3 = "Search";
    ...
    L_0x014f:
        ...
        r1 = r8.emptyView;
        r2 = NUM; // 0x7f0d0626 float:1.8745307E38 double:1.053130555E-314;
        r3 = "NoContacts";
        r2 = org.telegram.messenger.LocaleController.getString(r3, r2);
        r1.setText(r2);
        r1 = r8.emptyView;
