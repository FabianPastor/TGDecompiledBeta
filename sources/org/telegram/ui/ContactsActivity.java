...
public class ContactsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    ...
    public /* synthetic */ void lambda$createView$1(int i, View view, int i2) {
        ...
        Object mo1806getItem = this.listViewAdapter.mo1806getItem(sectionForPosition, positionInSectionForPosition);
        if (mo1806getItem instanceof TLRPC$User) {
            TLRPC$User tLRPC$User2 = (TLRPC$User) mo1806getItem;
            if (this.returnAsResult) {
        ...
        } else if (!(mo1806getItem instanceof ContactsController.Contact)) {
        } else {
            ContactsController.Contact contact = (ContactsController.Contact) mo1806getItem;
