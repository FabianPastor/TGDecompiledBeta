...
public final /* synthetic */ class ProfileActivity$$ExternalSyntheticLambda25 implements Runnable {
    ...
    public /* synthetic */ ProfileActivity$$ExternalSyntheticLambda25(ProfileActivity profileActivity, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, double d, String str, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    public final void run() {
        this.f$0.lambda$didUploadPhoto$39(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
