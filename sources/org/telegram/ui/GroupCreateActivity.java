...
public class GroupCreateActivity extends BaseFragment implements NotificationCenterDelegate, OnClickListener {
    ...
    public class GroupCreateAdapter extends FastScrollAdapter {
        ...
        L_0x000f:
            ...
            r2 = NUM; // 0x7var_ float:1.7945852E38 double:1.0529358133E-314;
            if (r0 != r12) goto L_0x0028;
        L_0x001a:
            r12 = NUM; // 0x7f0e0256 float:1.887625E38 double:1.053162452E-314;
            r0 = "ChannelInviteViaLink";
            r12 = org.telegram.messenger.LocaleController.getString(r0, r12);
            r11.setTextAndIcon(r12, r2, r1);
            goto L_0x018f;
        L_0x0028:
            r12 = NUM; // 0x7f0e0590 float:1.8877926E38 double:1.05316286E-314;
        ...
        L_0x017b:
            ...
            if (r12 == 0) goto L_0x018f;
        L_0x0183:
            r12 = NUM; // 0x7f0e0527 float:1.8877713E38 double:1.0531628083E-314;
            r0 = "GlobalSearch";
            r12 = org.telegram.messenger.LocaleController.getString(r0, r12);
            r11.setText(r12);
        L_0x018f:
