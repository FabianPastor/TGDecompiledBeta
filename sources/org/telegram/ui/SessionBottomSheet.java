...
public class SessionBottomSheet extends BottomSheet {
    ...
    public SessionBottomSheet(BaseFragment fragment, TLRPC.TL_authorization session2, boolean isCurrentSession, Callback callback) {
        ...
        if ((tL_authorization.flags & 1) != 0) {
            ...
            timeText = LocaleController.stringForMessageListDate((long) tL_authorization.date_active);
        }
        ...
        if (!isCurrentSession) {
            ...
            buttonTextView.setOnClickListener(new View.OnClickListener() {
                ...
                public /* synthetic */ void m3848lambda$onClick$0$orgtelegramuiSessionBottomSheet$8(Callback callback, TLRPC.TL_authorization session, DialogInterface dialogInterface, int option) {
    ...
    public /* synthetic */ void m3847lambda$copyText$1$orgtelegramuiSessionBottomSheet(String text, DialogInterface dialogInterface, int i) {
