...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda35 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda35(ChatActivity chatActivity, String str, CharacterStyle characterStyle, MessageObject messageObject, ChatMessageCell chatMessageCell, int i) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        this.f$0.lambda$openClickableLink$233(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dialogInterface, i);
    }
}
