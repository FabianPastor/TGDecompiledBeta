...
public class DataSettingsActivity extends BaseFragment {
    ...
    class C13763 extends AnimatorListenerAdapter {
        C13763() {
        }
    ...
    class C21241 extends ActionBarMenuOnItemClick {
        C21241() {
        }
    ...
    class C21252 implements OnItemClickListener {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C21241());
        ...
        this.listView.setOnItemClickListener(new C21252());
    ...
    private void updateAutodownloadRows(boolean check) {
        ...
        if (!animators.isEmpty()) {
            ...
            this.animatorSet.addListener(new C13763());
