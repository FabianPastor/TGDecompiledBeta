...
public class DataSettingsActivity extends BaseFragment {
    ...
    public /* synthetic */ void m2062lambda$createView$6$orgtelegramuiDataSettingsActivity(Context context, View view, int position, float x, float y) {
        int num;
        String key2;
        String key;
    ...
    public /* synthetic */ void m2056lambda$createView$0$orgtelegramuiDataSettingsActivity(DialogInterface dialogInterface, int i) {
        String key;
        DownloadController.Preset defaultPreset;
        DownloadController.Preset preset;
        SharedPreferences.Editor editor = MessagesController.getMainSettings(this.currentAccount).edit();
    ...
    public /* synthetic */ void m2057lambda$createView$1$orgtelegramuiDataSettingsActivity(SharedPreferences preferences, int position, DialogInterface dialog, int which) {
        int val = -1;
        switch (which) {
            case 0:
                val = 0;
    ...
    public /* synthetic */ void m2058lambda$createView$2$orgtelegramuiDataSettingsActivity(String storageDir, AlertDialog.Builder builder, View v) {
    ...
    public /* synthetic */ void m2061lambda$createView$5$orgtelegramuiDataSettingsActivity(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m2059lambda$createView$3$orgtelegramuiDataSettingsActivity() {
    ...
    public /* synthetic */ void m2060lambda$createView$4$orgtelegramuiDataSettingsActivity(TLObject response, TLRPC.TL_error error) {
