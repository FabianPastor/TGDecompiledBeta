...
public class ChatEditActivity extends BaseFragment implements ImageUpdaterDelegate, NotificationCenterDelegate {
    ...
    L_0x0066:
        ...
        r0.<init>(r1);
        r1 = NUM; // 0x7f0e0bac float:1.8881098E38 double:1.053163633E-314;
    ...
    L_0x007f:
        r1 = NUM; // 0x7f0e028e float:1.8876364E38 double:1.0531624797E-314;
        r2 = "ChannelSettingsChangedAlert";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setMessage(r1);
        goto L_0x0098;
    L_0x008c:
        r1 = NUM; // 0x7f0e0548 float:1.887778E38 double:1.0531628246E-314;
        r2 = "GroupSettingsChangedAlert";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
        r0.setMessage(r1);
    L_0x0098:
        r1 = NUM; // 0x7f0e0104 float:1.8875565E38 double:1.053162285E-314;
        r2 = "ApplyTheme";
        r1 = org.telegram.messenger.LocaleController.getString(r2, r1);
