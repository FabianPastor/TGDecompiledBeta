...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda143 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda143(ChatActivity chatActivity, TLRPC$TL_messages_sendScheduledMessages tLRPC$TL_messages_sendScheduledMessages) {
        this.f$0 = chatActivity;
        this.f$1 = tLRPC$TL_messages_sendScheduledMessages;
    }

    public final void run() {
        this.f$0.lambda$processSelectedOption$160(this.f$1);
    }
}
