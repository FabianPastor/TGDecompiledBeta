...
public class LoginActivity extends BaseFragment {
    ...
    class C19971 extends ActionBarMenuOnItemClick {
        C19971() {
        }
    ...
    public class LoginActivityPasswordView extends SlideView {
        ...
        class C20124 implements RequestDelegate {
            C20124() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.formatString("FloodWaitTime", C0501R.string.FloodWaitTime, timeString));
                        } else {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), error.text);
                        }
                    }
                });
            }
        ...
        class C20135 implements Runnable {
            C20135() {
            }
        ...
        public LoginActivityPasswordView(Context context) {
            ...
            this.confirmTextView.setText(LocaleController.getString("LoginPasswordText", C0501R.string.LoginPasswordText));
            ...
            this.codeField.setHint(LocaleController.getString("LoginPassword", C0501R.string.LoginPassword));
            ...
            this.cancelButton.setText(LocaleController.getString("ForgotPassword", C0501R.string.ForgotPassword));
            ...
            this.cancelButton.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                public void onClick(View view) {
                    if (LoginActivityPasswordView.this.has_recovery) {
                        ...
                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(new TL_auth_requestPasswordRecovery(), new C20051(), 10);
                        return;
                    }
                    ...
                    LoginActivity.this.needShowAlert(LocaleController.getString("RestorePasswordNoEitle", C0501R.string.RestorePasswordNoEmailTitle), LocaleController.getString("RestorePasswordNoEmailText", C0501R.string.RestorePasswordNoEmailText));
                }
            });
            ...
            this.resetAccountButton.setText(LocaleController.getString("ResetMyAccount", C0501R.string.ResetMyAccount));
            ...
            this.resetAccountButton.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C20091 implements DialogInterface.OnClickListener {

                    /* renamed from: org.telegram.ui.LoginActivity$LoginActivityPasswordView$3$1$1 */
                    class C20081 implements RequestDelegate {
                        C20081() {
                        }
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("ResetAccountCancelledAlert", C0501R.string.ResetAccountCancelledAlert));
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C20081(), 10);
                    }
                }

                public void onClick(View view) {
                    Builder builder = new Builder(LoginActivity.this.getParentActivity());
                    builder.setMessage(LocaleController.getString("ResetMyAccountWarningText", C0501R.string.ResetMyAccountWarningText));
                    builder.setTitle(LocaleController.getString("ResetMyAccountWarning", C0501R.string.ResetMyAccountWarning));
                    builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", C0501R.string.ResetMyAccountWarningReset), new C20091());
            ...
            this.resetAccountText.setText(LocaleController.getString("ResetMyAccountText", C0501R.string.ResetMyAccountText));
        ...
        public String getHeaderName() {
            return LocaleController.getString("LoginPassword", C0501R.string.LoginPassword);
        }
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                try {
                    oldPasswordBytes = oldPassword.getBytes(C0616C.UTF8_NAME);
                } catch (Throwable e) {
                    FileLog.m3e(e);
                }
                LoginActivity.this.needShowProgress(0);
                ...
                ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C20124(), 10);
            }
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C20135(), 100);
        }
    ...
    public class LoginActivityRecoverView extends SlideView {
        ...
        class C20183 implements RequestDelegate {
            C20183() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivityRecoverView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.formatString("FloodWaitTime", C0501R.string.FloodWaitTime, timeString));
                        } else {
                            LoginActivityRecoverView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), error.text);
                        }
                    }
                });
            }
        ...
        public LoginActivityRecoverView(final LoginActivity this$0, Context context) {
            ...
            this.confirmTextView.setGravity(LocaleController.isRTL ? 5 : 3);
            this.confirmTextView.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            this.confirmTextView.setText(LocaleController.getString("RestoreEmailSentInfo", C0501R.string.RestoreEmailSentInfo));
            ...
            this.codeField.setHintTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteHintText));
            this.codeField.setBackgroundDrawable(Theme.createEditTextDrawable(context, false));
            this.codeField.setHint(LocaleController.getString("PasswordCode", C0501R.string.PasswordCode));
            this.codeField.setImeOptions(268435461);
            this.codeField.setTextSize(1, 18.0f);
            this.codeField.setMaxLines(1);
            this.codeField.setPadding(0, 0, 0, 0);
            ...
            this.cancelButton.setOnClickListener(new OnClickListener() {
                ...
                class C20151 implements DialogInterface.OnClickListener {
                    C20151() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    builder.setMessage(LocaleController.getString("RestoreEmailTroubleText", C0501R.string.RestoreEmailTroubleText));
                    builder.setTitle(LocaleController.getString("RestorePasswordNoEmailTitle", C0501R.string.RestorePasswordNoEmailTitle));
                    builder.setPositiveButton(LocaleController.getString("OK", C0501R.string.OK), new C20151());
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                this.currentParams = params;
                this.email_unconfirmed_pattern = this.currentParams.getString("email_unconfirmed_pattern");
                this.cancelButton.setText(LocaleController.formatString("RestoreEmailTrouble", C0501R.string.RestoreEmailTrouble, this.email_unconfirmed_pattern));
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                req.code = code;
                ConnectionsManager.getInstance(this.this$0.currentAccount).sendRequest(req, new C20183(), 10);
            }
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C20194(), 100);
        }
    ...
    public class LoginActivityRegisterView extends SlideView {
        ...
        class C20201 implements DialogInterface.OnClickListener {
            C20201() {
            }
        ...
        class C20232 implements DialogInterface.OnClickListener {

            /* renamed from: org.telegram.ui.LoginActivity$LoginActivityRegisterView$2$1 */
            class C20211 implements DialogInterface.OnClickListener {
                C20211() {
                }
            ...
            class C20222 implements DialogInterface.OnClickListener {
                C20222() {
                }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setMessage(LocaleController.getString("TosDecline", C0501R.string.TosDecline));
                builder.setPositiveButton(LocaleController.getString("SignUp", C0501R.string.SignUp), new C20211());
                builder.setNegativeButton(LocaleController.getString("Decline", C0501R.string.Decline), new C20222());
                LoginActivity.this.showDialog(builder.create());
            }
        }

        /* renamed from: org.telegram.ui.LoginActivity$LoginActivityRegisterView$6 */
        class C20286 implements Runnable {
            C20286() {
            }
        ...
        class C20307 implements RequestDelegate {
            C20307() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("InvalidPhoneNumber", C0501R.string.InvalidPhoneNumber));
                        } else if (error.text.contains("PHONE_CODE_EMPTY") || error.text.contains("PHONE_CODE_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("InvalidCode", C0501R.string.InvalidCode));
                        } else if (error.text.contains("PHONE_CODE_EXPIRED")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("CodeExpired", C0501R.string.CodeExpired));
                        } else if (error.text.contains("FIRSTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("InvalidFirstName", C0501R.string.InvalidFirstName));
                        } else if (error.text.contains("LASTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("InvalidLastName", C0501R.string.InvalidLastName));
                        } else {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), error.text);
                        }
                    }
        ...
        private void showTermsOfService(boolean needAccept) {
            if (LoginActivity.this.currentTermsOfService != null) {
                ...
                builder.setTitle(LocaleController.getString("TermsOfService", C0501R.string.TermsOfService));
                if (needAccept) {
                    builder.setPositiveButton(LocaleController.getString("Accept", C0501R.string.Accept), new C20201());
                    builder.setNegativeButton(LocaleController.getString("Decline", C0501R.string.Decline), new C20232());
                } else {
        ...
        public LoginActivityRegisterView(Context context) {
            ...
            this.textView.setText(LocaleController.getString("RegisterText", C0501R.string.RegisterText));
            ...
            this.wrongNumber.setText(LocaleController.getString("CancelRegistration", C0501R.string.CancelRegistration));
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C20261 implements DialogInterface.OnClickListener {
                    C20261() {
                    }
                ...
                public void onClick(View view) {
                    Builder builder = new Builder(LoginActivity.this.getParentActivity());
                    builder.setTitle(LocaleController.getString("AppName", C0501R.string.AppName));
                    builder.setMessage(LocaleController.getString("AreYouSureRegistration", C0501R.string.AreYouSureRegistration));
                    builder.setPositiveButton(LocaleController.getString("OK", C0501R.string.OK), new C20261());
                    builder.setNegativeButton(LocaleController.getString("Cancel", C0501R.string.Cancel), null);
                    LoginActivity.this.showDialog(builder.create());
                }
            });
            ...
            String str = LocaleController.getString("TermsOfServiceLogin", C0501R.string.TermsOfServiceLogin);
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourName", C0501R.string.YourName);
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C20286(), 100);
        }
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                if (LoginActivity.this.currentTermsOfService == null || !LoginActivity.this.currentTermsOfService.popup) {
                    ...
                    LoginActivity.this.needShowProgress(0);
                    ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C20307(), 10);
                    return;
                }
    ...
    public class LoginActivityResetWaitView extends SlideView {
        ...
        class C20352 implements Runnable {
            C20352() {
            }
        ...
        public LoginActivityResetWaitView(final LoginActivity this$0, Context context) {
            ...
            this.resetAccountText.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText6));
            this.resetAccountText.setText(LocaleController.getString("ResetAccountStatus", C0501R.string.ResetAccountStatus));
            this.resetAccountText.setTextSize(1, 14.0f);
            this.resetAccountText.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            ...
            textView.setGravity(i | 48);
            this.resetAccountButton.setText(LocaleController.getString("ResetAccountButton", C0501R.string.ResetAccountButton));
            this.resetAccountButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
            this.resetAccountButton.setTextSize(1, 14.0f);
            this.resetAccountButton.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            this.resetAccountButton.setPadding(0, AndroidUtilities.dp(14.0f), 0, 0);
            ...
            this.resetAccountButton.setOnClickListener(new OnClickListener() {
                ...
                class C20331 implements DialogInterface.OnClickListener {
                    ...
                    class C20321 implements RequestDelegate {
                        C20321() {
                        }
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("ResetAccountCancelledAlert", C0501R.string.ResetAccountCancelledAlert));
                                    } else {
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), error.text);
                                    }
                                }
                            });
                        }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        TL_account_deleteAccount req = new TL_account_deleteAccount();
                        req.reason = "Forgot password";
                        ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).sendRequest(req, new C20321(), 10);
                    }
                }
                ...
                public void onClick(View view) {
                    if (Math.abs(ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).getCurrentTime() - LoginActivityResetWaitView.this.startTime) >= LoginActivityResetWaitView.this.waitTime) {
                        ...
                        builder.setMessage(LocaleController.getString("ResetMyAccountWarningText", C0501R.string.ResetMyAccountWarningText));
                        builder.setTitle(LocaleController.getString("ResetMyAccountWarning", C0501R.string.ResetMyAccountWarning));
                        builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", C0501R.string.ResetMyAccountWarningReset), new C20331());
                        builder.setNegativeButton(LocaleController.getString("Cancel", C0501R.string.Cancel), null);
        ...
        public String getHeaderName() {
            return LocaleController.getString("ResetAccount", C0501R.string.ResetAccount);
        }
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", C0501R.string.ResetAccountInfo, LocaleController.addNbsp(PhoneFormat.getInstance().format("+" + this.requestPhone)))));
                updateTimeText();
                this.timeRunnable = new C20352();
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C20446 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C20431());
            }
        }

        /* renamed from: org.telegram.ui.LoginActivity$LoginActivitySmsView$7 */
        class C20487 extends TimerTask {
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C20461(), 10);
        ...
        class C20539 implements Runnable {
            C20539() {
            }
        ...
        public LoginActivitySmsView(Context context, int type) {
                    ...
                    if (!LoginActivitySmsView.this.nextPressed) {
                        if (LoginActivitySmsView.this.nextType == 0 || LoginActivitySmsView.this.nextType == 4) {
                            try {
                                ...
                                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("NoMailInstalled", C0501R.string.NoMailInstalled));
                                return;
                            }
                        }
                        LoginActivitySmsView.this.resendCode();
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C20391 implements RequestDelegate {
                    C20391() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C20391(), 10);
                        ...
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                    ...
                                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("FloodWait", C0501R.string.FloodWait));
                                } else if (error.code != -1000) {
                                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("ErrorOccurred", C0501R.string.ErrorOccurred) + "\n" + error.text);
                                }
                            }
                            LoginActivity.this.needHideProgress();
                        }
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C20446(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C20487(), 0, 1000);
            }
        }
                            ...
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    if (error.text.contains("PHONE_NUMBER_UNOCCUPIED")) {
                                        ...
                                        ok = true;
                                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(new TL_account_getPassword(), new C20501(), 10);
                                        LoginActivitySmsView.this.destroyTimer();
                                        LoginActivitySmsView.this.destroyCodeTimer();
                                    } else {
                                        LoginActivity.this.needHideProgress();
        ...
        public void onShow() {
            super.onShow();
            if (this.currentType != 3) {
                AndroidUtilities.runOnUIThread(new C20539(), 100);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C20551 implements CountrySelectActivityDelegate {
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C20541(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C20551());
            ...
            this.textView2.setText(LocaleController.getString("StartText", C0501R.string.StartText));
            ...
            if (LoginActivity.this.newAccount) {
                ...
                this.checkBoxCell.setText(LocaleController.getString("SyncContacts", C0501R.string.SyncContacts), TtmlNode.ANONYMOUS_REGION_ID, LoginActivity.this.syncContacts, false);
                    ...
                    public void onClick(View v) {
                        if (LoginActivity.this.getParentActivity() != null) {
                            ...
                            if (LoginActivity.this.syncContacts) {
                                this.visibleToast = Toast.makeText(LoginActivity.this.getParentActivity(), LocaleController.getString("SyncContactsOn", C0501R.string.SyncContactsOn), 0);
                                this.visibleToast.show();
                                return;
                            }
                            this.visibleToast = Toast.makeText(LoginActivity.this.getParentActivity(), LocaleController.getString("SyncContactsOff", C0501R.string.SyncContactsOff), 0);
                            this.visibleToast.show();
                        }
                    }
                });
        ...
        public void onNextPressed() {
            if (LoginActivity.this.getParentActivity() != null && !this.nextPressed) {
                ...
                if (this.countryState == 1) {
                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("ChooseCountry", C0501R.string.ChooseCountry));
                        ...
                        for (int a = 0; a < 3; a++) {
                            ...
                            if (userConfig.isClientActivated()) {
                                ...
                                if (userPhone.contains(phone) || phone.contains(userPhone)) {
                                    ...
                                    builder = new Builder(LoginActivity.this.getParentActivity());
                                    builder.setTitle(LocaleController.getString("AppName", C0501R.string.AppName));
                                    builder.setMessage(LocaleController.getString("AccountAlreadyLoggedIn", C0501R.string.AccountAlreadyLoggedIn));
                                    builder.setPositiveButton(LocaleController.getString("AccountSwitch", C0501R.string.AccountSwitch), new DialogInterface.OnClickListener() {
                                        public void onClick(DialogInterface dialog, int which) {
                                ...
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                            ...
                                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0501R.string.AppName), LocaleController.getString("PhoneNumberFlood", C0501R.string.PhoneNumberFlood));
                        ...
                        if (!(!LoginActivity.this.checkShowPermissions || allowCall || allowSms)) {
                            ...
                            if (!LoginActivity.this.permissionsShowItems.isEmpty()) {
                                ...
                                if (preferences.getBoolean("firstloginshow", true) || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.RECEIVE_SMS")) {
                                    ...
                                    builder.setTitle(LocaleController.getString("AppName", C0501R.string.AppName));
                                    builder.setPositiveButton(LocaleController.getString("OK", C0501R.string.OK), null);
                                    builder.setMessage(LocaleController.getString("AllowFillNumber", C0501R.string.AllowFillNumber));
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourPhone", C0501R.string.YourPhone);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19971());
        ActionBarMenu menu = this.actionBar.createMenu();
        this.actionBar.setAllowOverlayTitle(true);
        this.doneButton = menu.addItemWithWidth(1, C0501R.drawable.ic_done, AndroidUtilities.dp(56.0f));
        ...
        while (a < this.views.length) {
            ...
            if (this.currentViewNum == a) {
                ...
                int i = (this.views[a].needBackButton() || this.newAccount) ? C0501R.drawable.ic_ab_back : 0;
    ...
    private void needShowInvalidAlert(final String phoneNumber, final boolean banned) {
        if (getParentActivity() != null) {
            ...
            builder.setTitle(LocaleController.getString("AppName", C0501R.string.AppName));
            if (banned) {
                builder.setMessage(LocaleController.getString("BannedPhoneNumber", C0501R.string.BannedPhoneNumber));
            } else {
                builder.setMessage(LocaleController.getString("InvalidPhoneNumber", C0501R.string.InvalidPhoneNumber));
            }
            builder.setNeutralButton(LocaleController.getString("BotHelp", C0501R.string.BotHelp), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        PackageInfo pInfo = ApplicationLoader.applicationContext.getPackageManager().getPackageInfo(ApplicationLoader.applicationContext.getPackageName(), 0);
                        String version = String.format(Locale.US, "%s (%d)", new Object[]{pInfo.versionName, Integer.valueOf(pInfo.versionCode)});
    ...
    private void needShowProgress(final int reqiestId) {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.progressDialog == null) {
            ...
            if (reqiestId != 0) {
                builder.setPositiveButton(LocaleController.getString("Cancel", C0501R.string.Cancel), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void setPage(int page, boolean animated, Bundle params, boolean back) {
        int i = C0501R.drawable.ic_ab_back;
        if (page == 3 || page == 8) {
            this.doneButton.setVisibility(8);
        } else {
            if (page == 0) {
