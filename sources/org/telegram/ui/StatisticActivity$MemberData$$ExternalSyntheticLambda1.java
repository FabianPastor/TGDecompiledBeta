...
public final /* synthetic */ class StatisticActivity$MemberData$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ StatisticActivity$MemberData$$ExternalSyntheticLambda1(StatisticActivity.MemberData memberData, StatisticActivity statisticActivity, AlertDialog[] alertDialogArr, TLRPC.TL_error tL_error, TLObject tLObject, TLRPC.ChatFull chatFull) {
        this.f$0 = memberData;
    ...
    public final void run() {
        this.f$0.m3271x3fb722a7(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
