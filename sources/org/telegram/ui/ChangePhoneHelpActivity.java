...
public class ChangePhoneHelpActivity extends BaseFragment {
    ...
    class C11841 extends ActionBarMenuOnItemClick {
        C11841() {
        }
    ...
    class C11852 implements OnTouchListener {
        C11852() {
        }
    ...
    class C11873 implements OnClickListener {

        /* renamed from: org.telegram.ui.ChangePhoneHelpActivity$3$1 */
        class C11861 implements DialogInterface.OnClickListener {
            C11861() {
            }
        ...
        public void onClick(View v) {
            if (ChangePhoneHelpActivity.this.getParentActivity() != null) {
                ...
                builder.setMessage(LocaleController.getString("PhoneNumberAlert", C0500R.string.PhoneNumberAlert));
                builder.setPositiveButton(LocaleController.getString("OK", C0500R.string.OK), new C11861());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C11841());
        this.fragmentView = new RelativeLayout(context);
        this.fragmentView.setOnTouchListener(new C11852());
        ...
        this.imageView.setImageResource(C0500R.drawable.phone_change);
        ...
        try {
            this.textView1.setText(AndroidUtilities.replaceTags(LocaleController.getString("PhoneNumberHelp", C0500R.string.PhoneNumberHelp)));
        } catch (Throwable e) {
            FileLog.m3e(e);
            this.textView1.setText(LocaleController.getString("PhoneNumberHelp", C0500R.string.PhoneNumberHelp));
        }
        ...
        this.textView2.setText(LocaleController.getString("PhoneNumberChange", C0500R.string.PhoneNumberChange));
        ...
        this.textView2.setOnClickListener(new C11873());
