...
public class StickerPreviewViewer {
    ...
    public void open(Document sticker, boolean isRecent) {
        if (this.parentActivity != null && sticker != null) {
            ...
            this.centerImage.setImage((TLObject) sticker, null, sticker != null ? FileLoader.getClosestPhotoSizeWithSize(sticker.thumbs, 90) : null, null, "webp", this.currentSet, 1);
