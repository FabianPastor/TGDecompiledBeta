...
public class FiltersSetupActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class HintInnerCell extends FrameLayout {
        ...
        public /* synthetic */ void m3490lambda$new$0$orgtelegramuiFiltersSetupActivity$HintInnerCell(View v) {
    ...
    public static class FilterCell extends FrameLayout {
        ...
        public void setFilter(MessagesController.DialogFilter filter, boolean divider) {
            ...
            if (filter.isDefault()) {
                name = LocaleController.getString("FilterAllChats", NUM);
            }
            if (!animated) {
    ...
    public View createView(Context context) {
        ...
        AnonymousClass2 r2 = new RecyclerListView(context) {
            ...
            /* renamed from: lambda$onTouchEvent$0$org-telegram-ui-FiltersSetupActivity$2  reason: not valid java name */
            public /* synthetic */ void m3489lambda$onTouchEvent$0$orgtelegramuiFiltersSetupActivity$2() {
    ...
    public /* synthetic */ void m3488lambda$createView$1$orgtelegramuiFiltersSetupActivity(Context context, View view, int position, float x, float y) {
        ...
        if (position >= i && position < this.filtersEndRow) {
            ...
            if (!getMessagesController().dialogFilters.get(filterPosition).isDefault()) {
                if (getMessagesController().dialogFilters.get(filterPosition).locked) {
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        if (id == NotificationCenter.dialogFiltersUpdated) {
            if (!this.ignoreUpdates) {
                int rowCount2 = this.rowCount;
                updateRows(false);
                if (rowCount2 != this.rowCount) {
                    this.adapter.notifyDataSetChanged();
                } else {
                    this.adapter.notifyItemRangeChanged(0, rowCount2);
                }
            }
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ boolean m3491x834c8a63(FilterCell filterCell, View v, MotionEvent event) {
        ...
        public /* synthetic */ void m3496x3b9cc8fe(View v) {
        ...
        public /* synthetic */ void m3495x49var_df(MessagesController.DialogFilter filter, DialogInterface dialog, int which) {
            if (which == 0) {
                if (filter.locked) {
        ...
        public /* synthetic */ void m3494x58497cc0(MessagesController.DialogFilter filter, DialogInterface dialog2, int which2) {
        ...
        public /* synthetic */ void m3493x669fd6a1(AlertDialog progressDialogFinal, MessagesController.DialogFilter filter, TLObject response, TLRPC.TL_error error) {
        ...
        public /* synthetic */ void m3492x74var_(AlertDialog progressDialogFinal, MessagesController.DialogFilter filter) {
        ...
        public /* synthetic */ void m3498x1evar_c(SuggestedFilterCell suggestedFilterCell, View v) {
            long lowerId;
        ...
        public /* synthetic */ void m3497x2d466f1d(TLRPC.TL_dialogFilterSuggested suggested) {
