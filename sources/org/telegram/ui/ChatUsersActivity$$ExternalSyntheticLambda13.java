...
public final /* synthetic */ class ChatUsersActivity$$ExternalSyntheticLambda13 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ ChatUsersActivity$$ExternalSyntheticLambda13(ChatUsersActivity chatUsersActivity, CharSequence[] charSequenceArr, long j, TLRPC.TL_chatAdminRights tL_chatAdminRights, String str, TLObject tLObject, TLRPC.TL_chatBannedRights tL_chatBannedRights) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        this.f$0.m1964x78b746bc(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, dialogInterface, i);
    }
}
