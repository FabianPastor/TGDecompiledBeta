...
public final /* synthetic */ class VoIPFragment$$ExternalSyntheticLambda2 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public /* synthetic */ VoIPFragment$$ExternalSyntheticLambda2(VoIPFragment voIPFragment, boolean z, float f, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float var_, float var_, float var_, float var_, float var_, float var_, float var_) {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        voIPFragment2.lambda$createPiPTransition$14(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12, this.f$13, this.f$14, this.f$15, this.f$16, this.f$17, valueAnimator2);
    }
}
