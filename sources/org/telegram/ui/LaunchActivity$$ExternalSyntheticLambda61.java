...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda61 implements RequestDelegate {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda61(LaunchActivity launchActivity, int i, Integer num, TLRPC$Chat tLRPC$Chat, TLRPC$TL_messages_getDiscussionMessage tLRPC$TL_messages_getDiscussionMessage, Integer num2, Integer num3, AlertDialog alertDialog) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$runCommentRequest$24(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, tLObject, tLRPC$TL_error);
    }
}
