...
public final /* synthetic */ class CalendarActivity$MonthView$$ExternalSyntheticLambda0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        this.f$0.m1442lambda$animateRow$1$orgtelegramuiCalendarActivity$MonthView(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, valueAnimator);
    }
}
