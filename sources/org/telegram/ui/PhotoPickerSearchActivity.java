...
public class PhotoPickerSearchActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        SizeNotifierFrameLayout r5 = new SizeNotifierFrameLayout(context2) {
            ...
            public void dispatchDraw(Canvas canvas) {
                ...
                float y = (float) (PhotoPickerSearchActivity.this.actionBar.getMeasuredHeight() + ((int) PhotoPickerSearchActivity.this.actionBar.getTranslationY()));
                canvas.drawLine(0.0f, y, (float) getWidth(), y, Theme.dividerPaint);
            }
        ...
        SizeNotifierFrameLayout sizeNotifierFrameLayout = r5;
        ...
        while (true) {
            ...
            if (a2 < viewPageArr.length) {
                ...
                int statusBarBackground = Theme.getColor("dialogBackground");
