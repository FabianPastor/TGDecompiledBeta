...
public final /* synthetic */ class LoginActivity$PhoneView$$ExternalSyntheticLambda19 implements RequestDelegate {
    ...
    public /* synthetic */ LoginActivity$PhoneView$$ExternalSyntheticLambda19(LoginActivity.PhoneView phoneView, Bundle bundle, String str, TLRPC$TL_auth_sendCode tLRPC$TL_auth_sendCode) {
        this.f$0 = phoneView;
        this.f$1 = bundle;
        this.f$2 = str;
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$onNextPressed$20(this.f$1, this.f$2, this.f$3, tLObject, tLRPC$TL_error);
    }
}
