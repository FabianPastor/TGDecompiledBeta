...
public class ChatActivity extends BaseFragment implements NotificationCenterDelegate, DialogsActivityDelegate, LocationActivityDelegate {
    ...
    class C10386 implements Runnable {
        ...
        C10386(MessagesStorage messagesStorage, int i, CountDownLatch countDownLatch) {
    ...
    class C10447 implements Runnable {
        ...
        C10447(MessagesStorage messagesStorage, int i, CountDownLatch countDownLatch) {
            this.val$messagesStorage = messagesStorage;
            this.val$encId = i;
            this.val$countDownLatch = countDownLatch;
        }
    ...
    class C10488 implements Runnable {
        final /* synthetic */ CountDownLatch val$countDownLatch;
        final /* synthetic */ MessagesStorage val$messagesStorage;

        C10488(MessagesStorage messagesStorage, CountDownLatch countDownLatch) {
            this.val$messagesStorage = messagesStorage;
            this.val$countDownLatch = countDownLatch;
        }
...
*/
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C20119());
        ...
        if (id == NotificationCenter.messagesDidLoaded) {
                    ...
                    for (a = 0; a < arr.size(); a++) {
                        ...
                        if (obj.type >= 0 && this.messagesDict[0].indexOfKey(obj.getId()) < 0) {
                            ...
                            if (obj.messageOwner.action instanceof TL_messageActionChatMigrateTo) {
                                ...
                                bundle2 = bundle;
                                i2 = obj.messageOwner.action.channel_id;
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    ...
                                    class C10461 implements Runnable {
                                        ...
                                        public void run() {
                                            MessagesController.getInstance(ChatActivity.this.currentAccount).loadFullChat(i2, 0, true);
                                        }
                                    }
            ...
            if (this.dialog_id == ((Long) args[0]).longValue()) {
                ...
                if (((Boolean) args[1]).booleanValue()) {
                    ...
                    r17 = this.lastLoadIndex;
                    this.lastLoadIndex = r17 + 1;
                    r5.loadMessages(r6, i3, 0, 0, true, 0, r13, 2, 0, r16, r17);
                } else if (this.progressView != null) {
                    this.progressView.setVisibility(4);
                    this.chatListView.setEmptyView(this.emptyViewContainer);
                }
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            public void run() {
                                if (alertDialogArr[0] != null) {
                                    ...
                                    alertDialogArr[0].setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C10511());
