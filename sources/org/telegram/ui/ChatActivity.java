...
public class ChatActivity extends BaseFragment implements NotificationCenterDelegate, DialogsActivityDelegate, LocationActivityDelegate {
    ...
    private PhotoViewerProvider botContextProvider = new C17652();
    ...
    OnItemClickListenerExtended onItemClickListener = new C14804();
    OnItemLongClickListenerExtended onItemLongClickListener = new C14793();
    ...
    private PhotoViewerProvider photoViewerProvider = new C17641();
    ...
    class C14793 implements OnItemLongClickListenerExtended {
        C14793() {
        }
    ...
    class C14804 implements OnItemClickListenerExtended {
        C14804() {
        }
    ...
    class C14815 extends ActionBarMenuOnItemClick {
        C14815() {
        }
    ...
    class C14826 extends ActionBarMenuItemSearchListener {
        boolean searchWas;
    ...
    public class ChatActivityAdapter extends Adapter {
        ...
        class C14841 implements ChatMessageCellDelegate {
            C14841() {
            }
        ...
        class C14852 implements ChatActionCellDelegate {
            C14852() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                chatMessageCell.setDelegate(new C14841());
                if (ChatActivity.this.currentEncryptedChat == null) {
                    chatMessageCell.setAllowAssistant(true);
                }
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C14852());
            } else if (viewType == 2) {
                            ...
                            if (index != -1) {
                                ...
                                messageCell.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                                    public boolean onPreDraw() {
                                        ...
                                        r8[3] = ObjectAnimator.ofFloat(cameraContainer, "translationX", new float[]{((float) position[0]) - rect.f29x});
                                        r8[4] = ObjectAnimator.ofFloat(cameraContainer, "translationY", new float[]{((float) position[1]) - rect.f30y});
                                        ...
                                        animatorSet.addListener(new AnimatorListenerAdapter() {
                                            ...
                                            class C07011 extends AnimatorListenerAdapter {
                                                C07011() {
                                                }
                                            ...
                                            public void onAnimationEnd(Animator animation) {
                                                ...
                                                animatorSet.setInterpolator(new DecelerateInterpolator());
                                                animatorSet.addListener(new C07011());
                                                animatorSet.start();
                                            }
                                        });
                                        animatorSet.start();
    ...
    class C17641 extends EmptyPhotoViewerProvider {
        C17641() {
        }
    ...
    class C17652 extends EmptyPhotoViewerProvider {
        C17652() {
        }
...
*/
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C14815());
        ...
        if (this.currentEncryptedChat == null && !this.isBroadcast) {
            this.searchItem = menu.addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C14826());
        ...
        this.chatListView.setOnScrollListener(new OnScrollListener() {
            ...
            class C06941 extends AnimatorListenerAdapter {
                C06941() {
                }
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!(dy == 0 || !ChatActivity.this.scrollingFloatingDate || ChatActivity.this.currentFloatingTopIsNotMessage)) {
                    ...
                    if (ChatActivity.this.floatingDateView.getTag() == null) {
                        ...
                        ChatActivity.this.floatingDateAnimation.addListener(new C06941());
        ...
        if (!this.isBroadcast) {
                    ...
                    if (object instanceof BotInlineResult) {
                        ...
                        if (inlineResult.document != null) {
                            ...
                            if (inlineResult.document.thumb != null) {
                                f2 = (float) inlineResult.document.thumb.f48w;
                            } else {
                                f2 = 100.0f;
                            }
                            size.width = f2;
                            ...
                            if (inlineResult.document.thumb != null) {
                                f = (float) inlineResult.document.thumb.f47h;
                            }
                            size2.height = f;
                            for (b = 0; b < inlineResult.document.attributes.size(); b++) {
                                ...
                                if ((attribute instanceof TL_documentAttributeImageSize) || (attribute instanceof TL_documentAttributeVideo)) {
                                    this.size.width = (float) attribute.f41w;
                                    this.size.height = (float) attribute.f40h;
                                    break;
                                }
                            }
                            ...
                            if (photoSize != null) {
                                this.size.width = (float) photoSize.f48w;
                                this.size.height = (float) photoSize.f47h;
                            }
                        }
                    }
                    return this.size;
            ...
            chatActivityAdapter = new MentionsAdapter(context, false, this.dialog_id, new MentionsAdapterDelegate() {
                ...
                class C06951 extends AnimatorListenerAdapter {
                    C06951() {
                    }
                ...
                class C06962 extends AnimatorListenerAdapter {
                    C06962() {
                    }
                ...
                public void needChangePanelVisibility(boolean show) {
                    ...
                    if (show) {
                        ...
                        if (ChatActivity.this.allowStickersPanel && (!ChatActivity.this.mentionsAdapter.isBotContext() || ChatActivity.this.allowContextBotPanel || ChatActivity.this.allowContextBotPanelSecond)) {
                            ...
                            ChatActivity.this.mentionListAnimation.addListener(new C06951());
                    ...
                    if (ChatActivity.this.allowStickersPanel) {
                        ...
                        ChatActivity.this.mentionListAnimation.addListener(new C06962());
                        ChatActivity.this.mentionListAnimation.setDuration(200);
                        ChatActivity.this.mentionListAnimation.start();
                        return;
                    }
            ...
            if (this.mediaBanTooltip == null || this.mediaBanTooltip.getVisibility() != 0) {
                ...
                if (index != -1) {
                    ...
                    AnimatorSet.addListener(new AnimatorListenerAdapter() {
                        ...
                        class C06981 extends AnimatorListenerAdapter {
                            C06981() {
                            }
                        ...
                        final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$36() {
                            if (ChatActivity.this.mediaBanTooltip != null) {
                                ...
                                AnimatorSet.playTogether(animatorArr);
                                AnimatorSet.addListener(new C06981());
                ...
                if (this.allowContextBotPanelSecond) {
                    ...
                    if (index != -1) {
                        ...
                        AnimatorSet.addListener(new AnimatorListenerAdapter() {
                            ...
                            class C06991 extends AnimatorListenerAdapter {
                                C06991() {
                                }
                            ...
                            final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$37() {
                                if (ChatActivity.this.gifHintTextView != null) {
                                    ...
                                    AnimatorSet.playTogether(animatorArr);
                                    AnimatorSet.addListener(new C06991());
                                    AnimatorSet.setDuration(300);
                                    AnimatorSet.start();
                                }
                            }
        ...
        if (uri != null) {
            ...
            if (extractUriFrom.contains("com.google.android.apps.photos.contentprovider")) {
                try {
                    ...
                    if (index != -1) {
                        uri = Uri.parse(URLDecoder.decode(firstExtraction.substring(0, index), C0012C.UTF8_NAME));
                    }
                } catch (Throwable e) {
                    FileLog.m8e(e);
                }
    ...
    public void showAlert(String name, String message) {
        if (this.alertView != null && name != null && message != null) {
            ...
            Runnable anonymousClass48 = new Runnable() {
                ...
                class C07001 extends AnimatorListenerAdapter {
                    C07001() {
                    }
                ...
                public void run() {
                    if (ChatActivity.this.hideAlertViewRunnable == this && ChatActivity.this.alertView.getTag() == null) {
                        ...
                        ChatActivity.this.alertViewAnimator.addListener(new C07001());
