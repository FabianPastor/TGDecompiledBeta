...
public class LinkEditActivity extends BaseFragment {
    ...
    public /* synthetic */ void m3132lambda$createView$0$orgtelegramuiLinkEditActivity(View view) {
    ...
    public /* synthetic */ void m3133lambda$createView$1$orgtelegramuiLinkEditActivity(boolean notify, int scheduleDate) {
        chooseDate(scheduleDate);
    }

    /* renamed from: lambda$createView$2$org-telegram-ui-LinkEditActivity  reason: not valid java name */
    public /* synthetic */ void m3134lambda$createView$2$orgtelegramuiLinkEditActivity(Context context, View view) {
    ...
    public /* synthetic */ void m3135lambda$createView$3$orgtelegramuiLinkEditActivity(int index) {
    ...
    public /* synthetic */ void m3136lambda$createView$4$orgtelegramuiLinkEditActivity(int index) {
    ...
    public /* synthetic */ void m3138lambda$createView$6$orgtelegramuiLinkEditActivity(View view) {
    ...
    public /* synthetic */ void m3137lambda$createView$5$orgtelegramuiLinkEditActivity(DialogInterface dialogInterface2, int i2) {
    ...
    public /* synthetic */ void m3142lambda$onCreateClicked$8$orgtelegramuiLinkEditActivity(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3141lambda$onCreateClicked$7$orgtelegramuiLinkEditActivity(TLRPC.TL_error error, TLObject response) {
        this.loading = false;
        AlertDialog alertDialog = this.progressDialog;
        if (alertDialog != null) {
            alertDialog.dismiss();
    ...
    public /* synthetic */ void m3140lambda$onCreateClicked$10$orgtelegramuiLinkEditActivity(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3143lambda$onCreateClicked$9$orgtelegramuiLinkEditActivity(TLRPC.TL_error error, TLObject response) {
        this.loading = false;
        AlertDialog alertDialog = this.progressDialog;
        if (alertDialog != null) {
            alertDialog.dismiss();
    ...
    private void chooseDate(int selectedDate) {
        ...
        for (int i2 = 0; i2 < options.length; i2++) {
            if (i2 == options.length - 1) {
                ...
                options[i2] = LocaleController.formatPluralString("Hours", 1);
            } else if (this.dispalyedDates.get(i2).intValue() == this.defaultDates[1]) {
                options[i2] = LocaleController.formatPluralString("Days", 1);
            } else if (this.dispalyedDates.get(i2).intValue() == this.defaultDates[2]) {
                options[i2] = LocaleController.formatPluralString("Weeks", 1);
    ...
    private void resetDates() {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                String[] options = {LocaleController.formatPluralString("Hours", 1), LocaleController.formatPluralString("Days", 1), LocaleController.formatPluralString("Weeks", 1), LocaleController.getString("NoLimit", NUM)};
    ...
    public /* synthetic */ void m3139lambda$getThemeDescriptions$11$orgtelegramuiLinkEditActivity() {
        TextInfoPrivacyCell textInfoPrivacyCell = this.dividerUses;
