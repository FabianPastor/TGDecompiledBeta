...
public class PhonebookSelectActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C16522 extends ActionBarMenuItemSearchListener {
        C16522() {
        }
    ...
    class C16546 implements OnItemClickListener {

        /* renamed from: org.telegram.ui.PhonebookSelectActivity$6$1 */
        class C16531 implements PhonebookSelectActivityDelegate {
            C16531() {
            }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (object != null) {
                ...
                activity.setDelegate(new C16531());
    ...
    class C16557 extends OnScrollListener {
        C16557() {
        }
    ...
    class C16568 implements ThemeDescriptionDelegate {
        C16568() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C16522()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        this.listView.setOnItemClickListener(new C16546());
        this.listView.setOnScrollListener(new C16557());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C16568();
