...
public class NotificationsSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m3996x4800CLASSNAME() {
        /*
            r26 = this;
            r9 = r26
        ...
        L_0x0361:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.NotificationsSettingsActivity.m3996x4800CLASSNAME():void");
    }

    /* renamed from: lambda$loadExceptions$0$org-telegram-ui-NotificationsSettingsActivity  reason: not valid java name */
    public /* synthetic */ void m3995xd286a153(ArrayList users, ArrayList chats, ArrayList encryptedChats, ArrayList usersResult, ArrayList chatsResult, ArrayList channelsResult) {
    ...
    public /* synthetic */ void m3994xbde8ae12(View view, int position, float x, float y) {
        ...
        if (getParentActivity() != null) {
            ...
            if (i == i2 || i == this.groupRow || i == this.channelsRow) {
                ...
                builder2.setItems(new CharSequence[]{LocaleController.getString("RepeatDisabled", NUM), LocaleController.formatPluralString("Minutes", 5, new Object[0]), LocaleController.formatPluralString("Minutes", 10, new Object[0]), LocaleController.formatPluralString("Minutes", 30, new Object[0]), LocaleController.formatPluralString("Hours", 1, new Object[0]), LocaleController.formatPluralString("Hours", 2, new Object[0]), LocaleController.formatPluralString("Hours", 4, new Object[0])}, new NotificationsSettingsActivity$$ExternalSyntheticLambda1(this, i));
    ...
    public /* synthetic */ void m3991xe800150e(DialogInterface dialogInterface, int i) {
        if (!this.reseting) {
            this.reseting = true;
    ...
    public /* synthetic */ void m3990x7285eecd(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3989xfd0bCLASSNAMEc() {
    ...
    public /* synthetic */ void m3992xd2var_(int position) {
        this.adapter.notifyItemChanged(position);
    }

    /* renamed from: lambda$createView$7$org-telegram-ui-NotificationsSettingsActivity  reason: not valid java name */
    public /* synthetic */ void m3993x486e87d1(int position, DialogInterface dialog, int which) {
        int minutes = 0;
        if (which == 1) {
            minutes = 5;
        } else if (which == 2) {
    ...
    public /* synthetic */ void m3997xe3755a33(ArrayList exceptions, DialogInterface dialogInterface, int i) {
