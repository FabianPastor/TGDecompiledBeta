...
public class NotificationsSettingsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
                ...
                switch (itemViewType) {
                    ...
                    case 3:
                        ...
                        while (true) {
                            a2 = a;
                            if (a2 < 9) {
                                if (TextColorCell.colorsToSave[a2] == color) {
                                    color = TextColorCell.colors[a2];
                                } else {
                                    a = a2 + 1;
                                }
                            }
                ...
                if (position != NotificationsSettingsActivity.this.callsRingtoneRow) {
                    ...
                    if (!(position == NotificationsSettingsActivity.this.messageVibrateRow || position == NotificationsSettingsActivity.this.groupVibrateRow)) {
                        if (position != NotificationsSettingsActivity.this.callsVibrateRow) {
                            String value;
                            if (position == NotificationsSettingsActivity.this.repeatRow) {
                                minutes = preferences2.getInt("repeat_messages", 60);
                                if (minutes == 0) {
                            ...
                            if (position != NotificationsSettingsActivity.this.messagePriorityRow) {
                                if (position != NotificationsSettingsActivity.this.groupPriorityRow) {
                                    if (position == NotificationsSettingsActivity.this.messagePopupNotificationRow || position == NotificationsSettingsActivity.this.groupPopupNotificationRow) {
                                        minutes = 0;
                                        if (position == NotificationsSettingsActivity.this.messagePopupNotificationRow) {
                                            minutes = preferences2.getInt("popupAll", 0);
                                        } else if (position == NotificationsSettingsActivity.this.groupPopupNotificationRow) {
                                            minutes = preferences2.getInt("popupGroup", 0);
                                        }
                                        if (minutes == 0) {
                            ...
                            a2 = 0;
                            if (position == NotificationsSettingsActivity.this.messagePriorityRow) {
                                a2 = preferences2.getInt("priority_messages", 1);
                            } else if (position == NotificationsSettingsActivity.this.groupPriorityRow) {
                                a2 = preferences2.getInt("priority_group", 1);
                            }
                            if (a2 == 0) {
                    ...
                    minutes = 0;
                    if (position == NotificationsSettingsActivity.this.messageVibrateRow) {
                        minutes = preferences2.getInt("vibrate_messages", 0);
                    } else if (position == NotificationsSettingsActivity.this.groupVibrateRow) {
                        minutes = preferences2.getInt("vibrate_group", 0);
                    } else if (position == NotificationsSettingsActivity.this.callsVibrateRow) {
                        minutes = preferences2.getInt("vibrate_calls", 0);
                    }
                    if (minutes == 0) {
            ...
            String value2 = null;
            if (position == NotificationsSettingsActivity.this.messageSoundRow) {
                value2 = preferences2.getString("GlobalSound", LocaleController.getString("SoundDefault", R.string.SoundDefault));
            } else if (position == NotificationsSettingsActivity.this.groupSoundRow) {
                value2 = preferences2.getString("GroupSound", LocaleController.getString("SoundDefault", R.string.SoundDefault));
            } else if (position == NotificationsSettingsActivity.this.callsRingtoneRow) {
                value2 = preferences2.getString("CallsRingtone", LocaleController.getString("DefaultRingtone", R.string.DefaultRingtone));
            }
            if (value2.equals("NoSound")) {
                value2 = LocaleController.getString("NoSound", R.string.NoSound);
            }
            if (position == NotificationsSettingsActivity.this.callsRingtoneRow) {
                textCell.setTextAndValue(LocaleController.getString("VoipSettingsRingtone", R.string.VoipSettingsRingtone), value2, true);
            } else {
