...
public final /* synthetic */ class MemberRequestsDelegate$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ MemberRequestsDelegate$$ExternalSyntheticLambda6(MemberRequestsDelegate memberRequestsDelegate, boolean z, Runnable runnable, String str, TLRPC.TL_error tL_error, TLObject tLObject, boolean z2) {
    ...
    public final void run() {
        this.f$0.m4598xd869a6d7(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
