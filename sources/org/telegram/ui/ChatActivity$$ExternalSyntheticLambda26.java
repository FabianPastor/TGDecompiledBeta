...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda26 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda26(ChatActivity chatActivity, String str, CharacterStyle characterStyle, MessageObject messageObject, ChatMessageCell chatMessageCell, int i) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        this.f$0.lambda$didPressMessageUrl$161(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dialogInterface, i);
    }
}
