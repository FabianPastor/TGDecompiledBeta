...
public class ChannelRightsEditActivity extends BaseFragment {
    ...
    class C19951 extends ActionBarMenuOnItemClick {
        C19951() {
        }
    ...
    class C19963 implements OnItemClickListener {
        ...
        class C10051 implements OnDateSetListener {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                try {
                    ...
                    dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C10042());
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == 0) {
                ...
                if (ChannelRightsEditActivity.this.getParentActivity() != null) {
                    Calendar calendar = Calendar.getInstance();
                    try {
                        DatePickerDialog dialog = new DatePickerDialog(ChannelRightsEditActivity.this.getParentActivity(), new C10051(), calendar.get(1), calendar.get(2), calendar.get(5));
                        ...
                        dialog.setButton(-1, LocaleController.getString("Set", R.string.Set), dialog);
                        dialog.setButton(-3, LocaleController.getString("UserRestrictionsUntilForever", R.string.UserRestrictionsUntilForever), new C10062());
                        dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C10073());
    ...
    class C19974 implements ThemeDescriptionDelegate {
        C19974() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19951());
        if (this.canEdit) {
        ...
        this.listView.setOnItemClickListener(new C19963());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C19974();
