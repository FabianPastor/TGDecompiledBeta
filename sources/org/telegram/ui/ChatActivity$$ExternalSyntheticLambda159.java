...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda159 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda159(ChatActivity chatActivity, MessagesController messagesController, CharSequence charSequence, boolean z) {
    ...
    public final void run() {
        this.f$0.lambda$searchLinks$93(this.f$1, this.f$2, this.f$3);
    }
}
