...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, PopupSwipeBackLayout popupSwipeBackLayout, Callback callback) {
        ...
        ActionBarMenuSubItem addItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, NUM, LocaleController.getString("SpeedVerySlow", NUM), false, (Theme.ResourcesProvider) null);
        ...
        ActionBarMenuSubItem addItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, NUM, LocaleController.getString("SpeedVerySlow", NUM), false, (Theme.ResourcesProvider) null);
        ...
        ActionBarMenuSubItem addItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, NUM, LocaleController.getString("SpeedVerySlow", NUM), false, (Theme.ResourcesProvider) null);
        ...
        ActionBarMenuSubItem addItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, NUM, LocaleController.getString("SpeedVerySlow", NUM), false, (Theme.ResourcesProvider) null);
