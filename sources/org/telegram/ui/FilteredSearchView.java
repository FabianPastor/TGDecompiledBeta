...
public class FilteredSearchView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2929lambda$new$0$orgtelegramuiFilteredSearchView() {
    ...
    public FilteredSearchView(BaseFragment fragment) {
        ...
        AnonymousClass3 r3 = new RecyclerListView(parentActivity2) {
            ...
            public boolean onItemClick(View view, int position, float x, float y) {
                if (view instanceof SharedDocumentCell) {
                    ...
                    if (FilteredSearchView.this.uiCallback.actionModeShowing() || !((DialogCell) view).isPointInsideAvatar(x, y)) {
                        ...
                        FilteredSearchView.this.chatPreviewDelegate.startChatPreview((DialogCell) view);
                        return true;
                    }
                }
                return true;
        ...
        this.recyclerListView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                } else if (FilteredSearchView.this.adapter == null) {
    ...
    public /* synthetic */ void m2930lambda$new$1$orgtelegramuiFilteredSearchView(View view, int position) {
        if (view instanceof SharedDocumentCell) {
    ...
    public static java.lang.CharSequence createFromInfoString(org.telegram.messenger.MessageObject r10) {
        /*
            ...
            r3 = 2131166046(0x7var_e, float:1.7946326E38)
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ void m2933lambda$search$4$orgtelegramuiFilteredSearchView(long r19, java.lang.String r21, org.telegram.ui.Adapters.FiltersView.MediaFilterData r22, int r23, long r24, long r26, boolean r28, boolean r29, java.lang.String r30, int r31) {
        /*
            r18 = this;
            r13 = r18
            r14 = r19
        ...
        L_0x0119:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.FilteredSearchView.m2933lambda$search$4$orgtelegramuiFilteredSearchView(long, java.lang.String, org.telegram.ui.Adapters.FiltersView$MediaFilterData, int, long, long, boolean, boolean, java.lang.String, int):void");
    }

    /* renamed from: lambda$search$3$org-telegram-ui-FilteredSearchView  reason: not valid java name */
    public /* synthetic */ void m2932lambda$search$3$orgtelegramuiFilteredSearchView(int currentAccount, String query, int requestId, boolean filterAndQueryIsSame, FiltersView.MediaFilterData currentSearchFilter2, long dialogId, long minDate, ArrayList finalResultArray, ArrayList dateData, TLObject response, TLRPC.TL_error error) {
            ...
            if (view2 instanceof DialogCell) {
                ...
                if (view2 instanceof SharedDocumentCell) {
                    ...
                    if (cell.isLoaded()) {
                        ...
                        AccountInstance.getInstance(UserConfig.selectedAccount).getFileLoader().loadFile(document, cell.getMessage(), 0, 0);
    ...
    private class SharedLinksAdapter extends RecyclerListView.SectionsAdapter {
        ...
        private final SharedLinkCell.SharedLinkCellDelegate sharedLinkCellDelegate = new SharedLinkCell.SharedLinkCellDelegate() {
            ...
            public /* synthetic */ void m2934xd2f1fe27(String urlFinal, DialogInterface dialog, int which) {
                if (which == 0) {
                    FilteredSearchView.this.openUrl(urlFinal);
                } else if (which == 1) {
                    String url = urlFinal;
