...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenterDelegate {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == ProfileNotificationsActivity.this.generalRow) {
                        headerCell.setText(LocaleController.getString("General", C0431R.string.General));
                        return;
                    } else if (position == ProfileNotificationsActivity.this.popupRow) {
                        headerCell.setText(LocaleController.getString("ProfilePopupNotification", C0431R.string.ProfilePopupNotification));
                        return;
                    } else if (position == ProfileNotificationsActivity.this.ledRow) {
                        headerCell.setText(LocaleController.getString("NotificationsLed", C0431R.string.NotificationsLed));
                        return;
                ...
                case 1:
                    ...
                    if (position == ProfileNotificationsActivity.this.soundRow) {
                        value = preferences.getString("sound_" + ProfileNotificationsActivity.this.dialog_id, LocaleController.getString("SoundDefault", C0431R.string.SoundDefault));
                        ...
                        value = preferences.getString("ringtone_" + ProfileNotificationsActivity.this.dialog_id, LocaleController.getString("DefaultRingtone", C0431R.string.DefaultRingtone));
                        if (value.equals("NoSound")) {
                            value = LocaleController.getString("NoSound", C0431R.string.NoSound);
                        }
                        textCell.setTextAndValue(LocaleController.getString("VoipSettingsRingtone", C0431R.string.VoipSettingsRingtone), value, false);
                        return;
                        ...
                        String string2;
                        if (value == 0 || value == 4) {
                            string = LocaleController.getString("Vibrate", C0431R.string.Vibrate);
                            string2 = LocaleController.getString("VibrationDefault", C0431R.string.VibrationDefault);
                            ...
                            string = LocaleController.getString("Vibrate", C0431R.string.Vibrate);
                            string2 = LocaleController.getString("Short", C0431R.string.Short);
                            z = (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true;
                            textCell.setTextAndValue(string, string2, z);
                            return;
                        } else if (value == 2) {
                            string = LocaleController.getString("Vibrate", C0431R.string.Vibrate);
                            string2 = LocaleController.getString("VibrationDisabled", C0431R.string.VibrationDisabled);
                            z = (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true;
                            textCell.setTextAndValue(string, string2, z);
                            return;
                        } else if (value == 3) {
                            string = LocaleController.getString("Vibrate", C0431R.string.Vibrate);
                            string2 = LocaleController.getString("Long", C0431R.string.Long);
                            z = (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true;
                            textCell.setTextAndValue(string, string2, z);
                            return;
                        } else {
                        ...
                        if (value == 0) {
                            textCell.setTextAndValue(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance), LocaleController.getString("NotificationsPriorityHigh", C0431R.string.NotificationsPriorityHigh), false);
                            return;
                        } else if (value == 1 || value == 2) {
                            textCell.setTextAndValue(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance), LocaleController.getString("NotificationsPriorityUrgent", C0431R.string.NotificationsPriorityUrgent), false);
                            return;
                        } else if (value == 3) {
                            textCell.setTextAndValue(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance), LocaleController.getString("NotificationsPrioritySettings", C0431R.string.NotificationsPrioritySettings), false);
                            return;
                        } else if (value == 4) {
                            textCell.setTextAndValue(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance), LocaleController.getString("NotificationsPriorityLow", C0431R.string.NotificationsPriorityLow), false);
                            return;
                        } else if (value == 5) {
                            textCell.setTextAndValue(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance), LocaleController.getString("NotificationsPriorityMedium", C0431R.string.NotificationsPriorityMedium), false);
                            return;
                        } else {
                            return;
                        }
                        ...
                        if (notifyMaxCount == 0) {
                            textCell.setTextAndValue(LocaleController.getString("SmartNotifications", C0431R.string.SmartNotifications), LocaleController.getString("SmartNotificationsDisabled", C0431R.string.SmartNotificationsDisabled), ProfileNotificationsActivity.this.priorityRow != -1);
                            return;
                        }
                        String minutes = LocaleController.formatPluralString("Minutes", notifyDelay / 60);
                        textCell.setTextAndValue(LocaleController.getString("SmartNotifications", C0431R.string.SmartNotifications), LocaleController.formatString("SmartNotificationsInfo", C0431R.string.SmartNotificationsInfo, Integer.valueOf(notifyMaxCount), minutes), ProfileNotificationsActivity.this.priorityRow != -1);
                        return;
                ...
                case 2:
                    ...
                    if (position == ProfileNotificationsActivity.this.popupInfoRow) {
                        textCell2.setText(LocaleController.getString("ProfilePopupNotificationInfo", C0431R.string.ProfilePopupNotificationInfo));
                        textCell2.setBackgroundDrawable(Theme.getThemedDrawable(this.context, C0431R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                    } else if (position == ProfileNotificationsActivity.this.ledInfoRow) {
                        textCell2.setText(LocaleController.getString("NotificationsLedInfo", C0431R.string.NotificationsLedInfo));
                        textCell2.setBackgroundDrawable(Theme.getThemedDrawable(this.context, C0431R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        return;
                        ...
                        if (ProfileNotificationsActivity.this.priorityRow == -1) {
                            ...
                            textCell2.setText(LocaleController.getString("PriorityInfo", C0431R.string.PriorityInfo));
                        }
                        textCell2.setBackgroundDrawable(Theme.getThemedDrawable(this.context, C0431R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                        ...
                        textCell2.setText(LocaleController.getString("VoipRingtoneInfo", C0431R.string.VoipRingtoneInfo));
                        textCell2.setBackgroundDrawable(Theme.getThemedDrawable(this.context, C0431R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                    } else {
                        return;
                ...
                case 3:
                    ...
                    for (int a = 0; a < 9; a++) {
                        if (TextColorCell.colorsToSave[a] == color) {
                            ...
                            textCell3.setTextAndColor(LocaleController.getString("NotificationsLedColor", C0431R.string.NotificationsLedColor), color, false);
                            return;
                        }
                    }
                    textCell3.setTextAndColor(LocaleController.getString("NotificationsLedColor", C0431R.string.NotificationsLedColor), color, false);
                ...
                case 4:
                    ...
                    if (position == ProfileNotificationsActivity.this.popupEnabledRow) {
                        radioCell.setText(LocaleController.getString("PopupEnabled", C0431R.string.PopupEnabled), popup == 1, true);
                        radioCell.setTag(Integer.valueOf(1));
                        return;
                    } else if (position == ProfileNotificationsActivity.this.popupDisabledRow) {
                        radioCell.setText(LocaleController.getString("PopupDisabled", C0431R.string.PopupDisabled), popup == 2, false);
                ...
                case 5:
                    ...
                    preferences = MessagesController.getNotificationsSettings(ProfileNotificationsActivity.this.currentAccount);
                    string = LocaleController.getString("NotificationsEnableCustom", C0431R.string.NotificationsEnableCustom);
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("CustomNotifications", C0431R.string.CustomNotifications));
        ...
        this.listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            class C16591 extends AnimatorListenerAdapter {
                C16591() {
                }
            ...
            public void onItemClick(View view, int position) {
                ...
                if (position == ProfileNotificationsActivity.this.customRow && (view instanceof TextCheckBoxCell)) {
                    ...
                    if (!animators.isEmpty()) {
                        ...
                        ProfileNotificationsActivity.this.animatorSet.addListener(new C16591());
                        ...
                        if (ProfileNotificationsActivity.this.getParentActivity() != null) {
                            ...
                            recyclerListView.setAdapter(new SelectionAdapter() {
                                ...
                                public void onBindViewHolder(ViewHolder holder, int position) {
                                    ...
                                    textView.setText(LocaleController.formatString("SmartNotificationsDetail", C0431R.string.SmartNotificationsDetail, times, minutes));
                                }
                            });
                            ...
                            builder.setTitle(LocaleController.getString("SmartNotificationsAlert", C0431R.string.SmartNotificationsAlert));
                            builder.setView(recyclerListView);
                            builder.setPositiveButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
                            builder.setNegativeButton(LocaleController.getString("SmartNotificationsDisabled", C0431R.string.SmartNotificationsDisabled), new ProfileNotificationsActivity$3$$Lambda$4(this));
