...
public final /* synthetic */ class -$$Lambda$LaunchActivity$PKi-hEBJnpAzaZRsWAmEKFSWS9M implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$LaunchActivity$PKi-hEBJnpAzaZRsWAmEKFSWS9M(LaunchActivity launchActivity, AlertDialog alertDialog, TLObject tLObject, int i, TL_account_authorizationForm tL_account_authorizationForm, TL_account_getAuthorizationForm tL_account_getAuthorizationForm, String str, String str2, String str3) {
    ...
    public final void run() {
        this.f$0.lambda$null$21$LaunchActivity(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
