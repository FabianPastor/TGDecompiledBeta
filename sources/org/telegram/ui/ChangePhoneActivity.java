...
public class ChangePhoneActivity extends BaseFragment {
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C11736 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C11721());
            }
        }

        /* renamed from: org.telegram.ui.ChangePhoneActivity$LoginActivitySmsView$7 */
        class C11777 extends TimerTask {
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11751(), 2);
        ...
        public LoginActivitySmsView(Context context, int type) {
                    ...
                    if (!LoginActivitySmsView.this.nextPressed) {
                        if (LoginActivitySmsView.this.nextType == 0 || LoginActivitySmsView.this.nextType == 4) {
                            try {
                                ...
                                AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("NoMailInstalled", C0505R.string.NoMailInstalled));
                                return;
                            }
                        }
                        LoginActivitySmsView.this.resendCode();
            ...
            this.wrongNumber.setText(LocaleController.getString("WrongNumber", C0505R.string.WrongNumber));
            this.wrongNumber.setOnClickListener(new OnClickListener(ChangePhoneActivity.this) {
                ...
                class C11681 implements RequestDelegate {
                    C11681() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11681(), 2);
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourCode", C0505R.string.YourCode);
        }
            ...
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    if (this.currentType == 1) {
                        str = AndroidUtilities.replaceTags(LocaleController.getString("SentAppCode", C0505R.string.SentAppCode));
                    } else if (this.currentType == 2) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentSmsCode", C0505R.string.SentSmsCode, LocaleController.addNbsp(number)));
                    } else if (this.currentType == 3) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallCode", C0505R.string.SentCallCode, LocaleController.addNbsp(number)));
                    } else if (this.currentType == 4) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallOnly", C0505R.string.SentCallOnly, LocaleController.addNbsp(number)));
                    }
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C11736(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C11777(), 0, 1000);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setBackgroundResource(C0505R.drawable.spinner_states);
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C11811 implements CountrySelectActivityDelegate {
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C11801(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C11811());
            ...
            this.codeField.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable editable) {
                    if (!PhoneView.this.ignoreOnTextChange) {
                        ...
                        if (text.length() == 0) {
                            PhoneView.this.countryButton.setText(LocaleController.getString("ChooseCountry", C0505R.string.ChooseCountry));
                            ...
                            if (country != null) {
                                ...
                                if (index != -1) {
                                    ...
                                    PhoneView.this.countryButton.setText(LocaleController.getString("WrongCountry", C0505R.string.WrongCountry));
                                    PhoneView.this.phoneField.setHintText(null);
            ...
            this.textView2.setText(LocaleController.getString("ChangePhoneHelp", C0505R.string.ChangePhoneHelp));
            ...
            if (this.codeField.length() == 0) {
                this.countryButton.setText(LocaleController.getString("ChooseCountry", C0505R.string.ChooseCountry));
        ...
        public void onNextPressed() {
            if (ChangePhoneActivity.this.getParentActivity() != null && !this.nextPressed) {
                        ...
                        if (!ChangePhoneActivity.this.permissionsItems.isEmpty()) {
                            ...
                            if (preferences.getBoolean("firstlogin", true) || ChangePhoneActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") || ChangePhoneActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.RECEIVE_SMS")) {
                                ...
                                if (ChangePhoneActivity.this.permissionsItems.size() == 2) {
                                    builder.setMessage(LocaleController.getString("AllowReadCallAndSms", C0505R.string.AllowReadCallAndSms));
                                } else if (allowSms) {
                                    builder.setMessage(LocaleController.getString("AllowReadCall", C0505R.string.AllowReadCall));
                                } else {
                                    builder.setMessage(LocaleController.getString("AllowReadSms", C0505R.string.AllowReadSms));
                                }
                ...
                if (this.countryState == 1) {
                    AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("ChooseCountry", C0505R.string.ChooseCountry));
                } else if (this.codeField.length() == 0) {
                    AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("InvalidPhoneNumber", C0505R.string.InvalidPhoneNumber));
                } else {
        ...
        public String getHeaderName() {
            return LocaleController.getString("ChangePhoneNewNumber", C0505R.string.ChangePhoneNewNumber);
        }
    }
