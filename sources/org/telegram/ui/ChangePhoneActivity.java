...
public class ChangePhoneActivity extends BaseFragment {
    ...
    class C11581 extends ActionBarMenuOnItemClick {
        C11581() {
        }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C11686 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C11671());
            }
        }

        /* renamed from: org.telegram.ui.ChangePhoneActivity$LoginActivitySmsView$7 */
        class C11727 extends TimerTask {
            ...
            class C11711 implements Runnable {
                ...
                class C11701 implements RequestDelegate {
                    C11701() {
                    }
                ...
                public void run() {
                    if (LoginActivitySmsView.this.time >= 1000) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4 || LoginActivitySmsView.this.nextType == 3) {
                            LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("CallText", C0501R.string.CallText, Integer.valueOf(minutes), Integer.valueOf(seconds)));
                        } else if (LoginActivitySmsView.this.nextType == 2) {
                            LoginActivitySmsView.this.timeText.setText(LocaleController.formatString("SmsText", C0501R.string.SmsText, Integer.valueOf(minutes), Integer.valueOf(seconds)));
                        }
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            LoginActivitySmsView.this.timeText.setText(LocaleController.getString("Calling", C0501R.string.Calling));
                            ...
                            ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11701(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C11711());
                }
            }
        }
        ...
        public LoginActivitySmsView(Context context, int type) {
            ...
            if (this.currentType == 3) {
                ...
                imageView.setImageResource(C0501R.drawable.phone_activate);
            ...
            this.codeField.setHint(LocaleController.getString("Code", C0501R.string.Code));
            ...
            this.problemText.setText(LocaleController.getString("DidNotGetTheCode", C0501R.string.DidNotGetTheCode));
                    ...
                    if (!LoginActivitySmsView.this.nextPressed) {
                        if (LoginActivitySmsView.this.nextType == 0 || LoginActivitySmsView.this.nextType == 4) {
                            try {
                                ...
                                AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("NoMailInstalled", C0501R.string.NoMailInstalled));
                                return;
                            }
                        }
                        LoginActivitySmsView.this.resendCode();
            ...
            this.wrongNumber.setText(LocaleController.getString("WrongNumber", C0501R.string.WrongNumber));
            this.wrongNumber.setOnClickListener(new OnClickListener(ChangePhoneActivity.this) {
                ...
                class C11631 implements RequestDelegate {
                    C11631() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance(ChangePhoneActivity.this.currentAccount).sendRequest(req, new C11631(), 2);
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourCode", C0501R.string.YourCode);
        }
            ...
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    if (this.currentType == 1) {
                        str = AndroidUtilities.replaceTags(LocaleController.getString("SentAppCode", C0501R.string.SentAppCode));
                    } else if (this.currentType == 2) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentSmsCode", C0501R.string.SentSmsCode, LocaleController.addNbsp(number)));
                    } else if (this.currentType == 3) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallCode", C0501R.string.SentCallCode, LocaleController.addNbsp(number)));
                    } else if (this.currentType == 4) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallOnly", C0501R.string.SentCallOnly, LocaleController.addNbsp(number)));
                    }
                    ...
                    if (this.currentType == 1) {
                        ...
                        if (this.nextType == 4) {
                            this.timeText.setText(LocaleController.formatString("CallText", C0501R.string.CallText, Integer.valueOf(1), Integer.valueOf(0)));
                        } else if (this.nextType == 2) {
                            this.timeText.setText(LocaleController.formatString("SmsText", C0501R.string.SmsText, Integer.valueOf(1), Integer.valueOf(0)));
                        }
                        createTimer();
                    } else if (this.currentType == 2 && (this.nextType == 4 || this.nextType == 3)) {
                        this.timeText.setVisibility(0);
                        this.timeText.setText(LocaleController.formatString("CallText", C0501R.string.CallText, Integer.valueOf(2), Integer.valueOf(0)));
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C11686(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C11727(), 0, 1000);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setBackgroundResource(C0501R.drawable.spinner_states);
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C11761 implements CountrySelectActivityDelegate {
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C11751(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C11761());
            ...
            this.codeField.addTextChangedListener(new TextWatcher() {
                ...
                public void afterTextChanged(Editable editable) {
                    if (!PhoneView.this.ignoreOnTextChange) {
                        ...
                        if (text.length() == 0) {
                            PhoneView.this.countryButton.setText(LocaleController.getString("ChooseCountry", C0501R.string.ChooseCountry));
                            ...
                            if (country != null) {
                                ...
                                if (index != -1) {
                                    ...
                                    PhoneView.this.countryButton.setText(LocaleController.getString("WrongCountry", C0501R.string.WrongCountry));
                                    PhoneView.this.phoneField.setHintText(null);
            ...
            this.textView2.setText(LocaleController.getString("ChangePhoneHelp", C0501R.string.ChangePhoneHelp));
            ...
            if (this.codeField.length() == 0) {
                this.countryButton.setText(LocaleController.getString("ChooseCountry", C0501R.string.ChooseCountry));
        ...
        public void onNextPressed() {
            if (ChangePhoneActivity.this.getParentActivity() != null && !this.nextPressed) {
                        ...
                        if (!ChangePhoneActivity.this.permissionsItems.isEmpty()) {
                            ...
                            if (preferences.getBoolean("firstlogin", true) || ChangePhoneActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") || ChangePhoneActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.RECEIVE_SMS")) {
                                ...
                                if (ChangePhoneActivity.this.permissionsItems.size() == 2) {
                                    builder.setMessage(LocaleController.getString("AllowReadCallAndSms", C0501R.string.AllowReadCallAndSms));
                                } else if (allowSms) {
                                    builder.setMessage(LocaleController.getString("AllowReadCall", C0501R.string.AllowReadCall));
                                } else {
                                    builder.setMessage(LocaleController.getString("AllowReadSms", C0501R.string.AllowReadSms));
                                }
                ...
                if (this.countryState == 1) {
                    AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("ChooseCountry", C0501R.string.ChooseCountry));
                } else if (this.codeField.length() == 0) {
                    AlertsCreator.showSimpleAlert(ChangePhoneActivity.this, LocaleController.getString("InvalidPhoneNumber", C0501R.string.InvalidPhoneNumber));
                } else {
        ...
        public String getHeaderName() {
            return LocaleController.getString("ChangePhoneNewNumber", C0501R.string.ChangePhoneNewNumber);
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C11581());
    ...
    public void needShowProgress() {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.progressDialog == null) {
            ...
            this.progressDialog.setMessage(LocaleController.getString("Loading", C0501R.string.Loading));
