...
public final /* synthetic */ class ChatEditActivity$$ExternalSyntheticLambda24 implements Runnable {
    ...
    public /* synthetic */ ChatEditActivity$$ExternalSyntheticLambda24(ChatEditActivity chatEditActivity, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, double d, String str, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    public final void run() {
        this.f$0.lambda$didUploadPhoto$25(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
