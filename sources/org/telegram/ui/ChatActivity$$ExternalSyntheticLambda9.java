...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda9 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda9(ChatActivity chatActivity, int i, TLObject tLObject, int i2, MessageObject messageObject, Runnable runnable, TLRPC.TL_messages_getDiscussionMessage tL_messages_getDiscussionMessage, TLRPC.Chat chat, int i3, MessageObject messageObject2) {
    ...
    public final void run() {
        this.f$0.m1759x10ffb05(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9);
    }
}
