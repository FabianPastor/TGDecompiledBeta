...
public final /* synthetic */ class GroupCallActivity$$ExternalSyntheticLambda17 implements View.OnClickListener {
    ...
    public /* synthetic */ GroupCallActivity$$ExternalSyntheticLambda17(GroupCallActivity groupCallActivity, NumberPicker numberPicker, NumberPicker numberPicker2, NumberPicker numberPicker3, TLRPC.Chat chat, AccountInstance accountInstance, TLRPC.InputPeer inputPeer) {
    ...
    public final void onClick(View view) {
        this.f$0.m3531lambda$new$29$orgtelegramuiGroupCallActivity(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, view);
    }
}
