...
public class IntroActivity extends Activity implements NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollView.setSurfaceTextureListener(new C14261());
        ...
        scrollView.setText(LocaleController.getString("StartMessaging", C0446R.string.StartMessaging).toUpperCase());
        scrollView.setGravity(17);
        scrollView.setTextColor(-1);
        scrollView.setTextSize(1, 16.0f);
        scrollView.setBackgroundResource(C0446R.drawable.regbtn_states);
        ...
        scrollView.setOnClickListener(new C14273());
        if (BuildVars.DEBUG_VERSION) {
            scrollView.setOnLongClickListener(new C14284());
        }
        ...
        this.textView.setOnClickListener(new C14295());
        if (AndroidUtilities.isTablet()) {
            ...
            frameLayout4.setBackgroundResource(C0446R.drawable.btnshadow);
