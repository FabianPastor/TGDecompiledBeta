...
public class IntroActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        textureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public /* synthetic */ void m3607x770CLASSNAMEa() {
    ...
    public /* synthetic */ void m3602lambda$createView$0$orgtelegramuiIntroActivity(org.telegram.ui.Components.RLottieImageView r12, android.view.View r13) {
        /*
            r11 = this;
        ...
        L_0x0031:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.IntroActivity.m3602lambda$createView$0$orgtelegramuiIntroActivity(org.telegram.ui.Components.RLottieImageView, android.view.View):void");
    }

    /* renamed from: lambda$createView$1$org-telegram-ui-IntroActivity  reason: not valid java name */
    public /* synthetic */ void m3603lambda$createView$1$orgtelegramuiIntroActivity(View view) {
    ...
    public /* synthetic */ void m3604lambda$createView$2$orgtelegramuiIntroActivity(View v) {
        if (!this.startPressed && this.localeInfo != null) {
            ...
            NotificationCenter.getGlobalInstance().addObserver(new NotificationCenter.NotificationCenterDelegate() {
                ...
                public /* synthetic */ void m3608lambda$didReceivedNotification$0$orgtelegramuiIntroActivity$5() {
    ...
    public /* synthetic */ void m3601lambda$checkContinueText$4$orgtelegramuiIntroActivity(String finalSystemLang, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m3600lambda$checkContinueText$3$orgtelegramuiIntroActivity(TLRPC.LangPackString string, String finalSystemLang) {
        if (!this.destroyed) {
    ...
    public class EGLThread extends DispatchQueue {
        ...
        public /* synthetic */ void m3609lambda$shutdown$2$orgtelegramuiIntroActivity$EGLThread() {
            finish();
    ...
    public /* synthetic */ void m3605lambda$getThemeDescriptions$5$orgtelegramuiIntroActivity() {
        updateColors(true);
    }
    ...
    public /* synthetic */ void m3606lambda$updateColors$6$orgtelegramuiIntroActivity() {
