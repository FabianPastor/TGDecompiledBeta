...
public class QuickRepliesSettingsActivity extends BaseFragment {
    ...
    class C24851 extends ActionBarMenuOnItemClick {
        C24851() {
        }
    ...
    class C24862 implements OnItemClickListener {
        C24862() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C24851());
        ...
        this.listView.setOnItemClickListener(new C24862());
