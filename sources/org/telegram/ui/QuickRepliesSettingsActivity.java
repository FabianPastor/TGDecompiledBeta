...
public class QuickRepliesSettingsActivity extends BaseFragment {
    ...
    class C16981 extends ActionBarMenuOnItemClick {
        C16981() {
        }
    ...
    class C16992 implements OnItemClickListener {
        C16992() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C16981());
        ...
        this.listView.setOnItemClickListener(new C16992());
