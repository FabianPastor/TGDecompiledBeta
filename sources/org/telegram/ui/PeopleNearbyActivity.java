...
public class PeopleNearbyActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, LocationController.LocationFetchCallback {
    ...
    public /* synthetic */ void m3528lambda$createView$2$orgtelegramuiPeopleNearbyActivity(View view, int position) {
        long chatId;
    ...
    public /* synthetic */ void m3526lambda$createView$0$orgtelegramuiPeopleNearbyActivity(DialogInterface dialog) {
        this.loadingDialog = null;
    }

    /* renamed from: lambda$createView$1$org-telegram-ui-PeopleNearbyActivity  reason: not valid java name */
    public /* synthetic */ void m3527lambda$createView$1$orgtelegramuiPeopleNearbyActivity(UserConfig userConfig, DialogInterface dialog, int which) {
    ...
    public /* synthetic */ void m3524x84var_e9(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3523x23a6bb4a(TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3531lambda$sendRequest$5$orgtelegramuiPeopleNearbyActivity() {
        showLoadingProgress(true);
        this.showProgressRunnable = null;
    }

    /* renamed from: lambda$sendRequest$7$org-telegram-ui-PeopleNearbyActivity  reason: not valid java name */
    public /* synthetic */ void m3533lambda$sendRequest$7$orgtelegramuiPeopleNearbyActivity(int share, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m3532lambda$sendRequest$6$orgtelegramuiPeopleNearbyActivity(int share, TLRPC.TL_error error, TLObject response) {
        int i = share;
        this.reqId = 0;
    ...
    public /* synthetic */ void m3529xa0217175(TLRPC.Chat chat, long dialogId, boolean revoke) {
        if (chat == null) {
    ...
    public /* synthetic */ void m3525x726f6feb() {
        this.checkExpiredRunnable = null;
        checkForExpiredLocations(false);
    }
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position >= PeopleNearbyActivity.this.usersStartRow && position < PeopleNearbyActivity.this.usersEndRow) {
                        TLRPC.TL_peerLocated peerLocated = (TLRPC.TL_peerLocated) PeopleNearbyActivity.this.users.get(position - PeopleNearbyActivity.this.usersStartRow);
                ...
                case 1:
                    ...
                    if (position == PeopleNearbyActivity.this.usersSectionRow) {
                        ...
                        privacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, NUM, "windowBackgroundGrayShadow"));
                        return;
                    } else if (position == PeopleNearbyActivity.this.helpSectionRow) {
                        privacyCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, NUM, "windowBackgroundGrayShadow"));
                        return;
                    } else {
                        return;
                ...
                case 2:
                    ...
                    if (position == PeopleNearbyActivity.this.chatsCreateRow) {
                        ...
                        return;
                    } else if (position == PeopleNearbyActivity.this.showMeRow) {
                        ...
                        return;
                    } else if (position == PeopleNearbyActivity.this.showMoreRow) {
                        actionCell.setText(LocaleController.formatPluralString("ShowVotes", PeopleNearbyActivity.this.users.size() - 5), (String) null, NUM, false);
                        return;
                    } else {
                        return;
                    }
    ...
    public /* synthetic */ void m3530xb9b21fb() {
