...
public class GroupInviteActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C19022 implements OnItemClickListener {
                ...
                if (position == GroupInviteActivity.this.copyLinkRow || position == GroupInviteActivity.this.linkRow) {
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            Toast.makeText(GroupInviteActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C0501R.string.LinkCopied), 0).show();
                        } catch (Throwable e) {
                            FileLog.m3e(e);
                        }
                    }
                    ...
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            GroupInviteActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C0501R.string.InviteToGroupByLink)), 500);
                        } catch (Throwable e2) {
                            FileLog.m3e(e2);
                        }
                    }
                    ...
                    builder.setMessage(LocaleController.getString("RevokeAlert", C0501R.string.RevokeAlert));
                    builder.setTitle(LocaleController.getString("RevokeLink", C0501R.string.RevokeLink));
                    builder.setPositiveButton(LocaleController.getString("RevokeButton", C0501R.string.RevokeButton), new C19011());
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == GroupInviteActivity.this.copyLinkRow) {
                        textCell.setText(LocaleController.getString("CopyLink", C0501R.string.CopyLink), true);
                        return;
                    } else if (position == GroupInviteActivity.this.shareLinkRow) {
                        textCell.setText(LocaleController.getString("ShareLink", C0501R.string.ShareLink), false);
                        return;
                    } else if (position == GroupInviteActivity.this.revokeLinkRow) {
                        textCell.setText(LocaleController.getString("RevokeLink", C0501R.string.RevokeLink), true);
                        return;
                    } else {
                        return;
                    }
                case 1:
                    ...
                    if (position == GroupInviteActivity.this.shadowRow) {
                        ...
                        if (!ChatObject.isChannel(chat) || chat.megagroup) {
                            privacyCell.setText(LocaleController.getString("LinkInfo", C0501R.string.LinkInfo));
                        } else {
                            privacyCell.setText(LocaleController.getString("ChannelLinkInfo", C0501R.string.ChannelLinkInfo));
                        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("InviteLink", C0501R.string.InviteLink));
        ...
        this.listView.setOnItemClickListener(new C19022());
                    ...
                    public void run() {
                        if (error == null) {
                            ...
                            if (newRequest) {
                                if (GroupInviteActivity.this.getParentActivity() != null) {
                                    Builder builder = new Builder(GroupInviteActivity.this.getParentActivity());
                                    builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C0501R.string.RevokeAlertNewLink));
                                    builder.setTitle(LocaleController.getString("RevokeLink", C0501R.string.RevokeLink));
