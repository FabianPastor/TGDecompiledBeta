...
public class GroupInviteActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C13781 extends ActionBarMenuOnItemClick {
        C13781() {
        }
    ...
    class C13802 implements OnItemClickListener {
                ...
                if (position == GroupInviteActivity.this.copyLinkRow || position == GroupInviteActivity.this.linkRow) {
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            Toast.makeText(GroupInviteActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C0431R.string.LinkCopied), 0).show();
                        } catch (Throwable e) {
                            FileLog.m8e(e);
                        }
                    }
                    ...
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            GroupInviteActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C0431R.string.InviteToGroupByLink)), 500);
                        } catch (Throwable e2) {
                            FileLog.m8e(e2);
                        }
                    }
                    ...
                    builder.setMessage(LocaleController.getString("RevokeAlert", C0431R.string.RevokeAlert));
                    builder.setTitle(LocaleController.getString("RevokeLink", C0431R.string.RevokeLink));
                    builder.setPositiveButton(LocaleController.getString("RevokeButton", C0431R.string.RevokeButton), new C13791());
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == GroupInviteActivity.this.copyLinkRow) {
                        textCell.setText(LocaleController.getString("CopyLink", C0431R.string.CopyLink), true);
                        return;
                    } else if (position == GroupInviteActivity.this.shareLinkRow) {
                        textCell.setText(LocaleController.getString("ShareLink", C0431R.string.ShareLink), false);
                        return;
                    } else if (position == GroupInviteActivity.this.revokeLinkRow) {
                        textCell.setText(LocaleController.getString("RevokeLink", C0431R.string.RevokeLink), true);
                        return;
                    } else {
                        return;
                    }
                case 1:
                    ...
                    if (position == GroupInviteActivity.this.shadowRow) {
                        ...
                        if (!ChatObject.isChannel(chat) || chat.megagroup) {
                            privacyCell.setText(LocaleController.getString("LinkInfo", C0431R.string.LinkInfo));
                        } else {
                            privacyCell.setText(LocaleController.getString("ChannelLinkInfo", C0431R.string.ChannelLinkInfo));
                        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("InviteLink", C0431R.string.InviteLink));
        this.actionBar.setActionBarMenuOnItemClick(new C13781());
        ...
        this.listView.setOnItemClickListener(new C13802());
                    ...
                    public void run() {
                        if (error == null) {
                            ...
                            if (newRequest) {
                                if (GroupInviteActivity.this.getParentActivity() != null) {
                                    Builder builder = new Builder(GroupInviteActivity.this.getParentActivity());
                                    builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C0431R.string.RevokeAlertNewLink));
                                    builder.setTitle(LocaleController.getString("RevokeLink", C0431R.string.RevokeLink));
