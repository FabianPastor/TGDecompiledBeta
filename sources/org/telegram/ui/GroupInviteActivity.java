...
public class GroupInviteActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C19192 implements OnItemClickListener {
        ...
        class C19181 implements OnClickListener {
            C19181() {
            }
                ...
                if (position == GroupInviteActivity.this.copyLinkRow || position == GroupInviteActivity.this.linkRow) {
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            Toast.makeText(GroupInviteActivity.this.getParentActivity(), LocaleController.getString("LinkCopied", C0505R.string.LinkCopied), 0).show();
                        } catch (Throwable e) {
                            FileLog.m3e(e);
                        }
                    }
                    ...
                    if (GroupInviteActivity.this.invite != null) {
                        try {
                            ...
                            GroupInviteActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteToGroupByLink", C0505R.string.InviteToGroupByLink)), 500);
                        } catch (Throwable e2) {
                            FileLog.m3e(e2);
                        }
                    }
                    ...
                    builder.setMessage(LocaleController.getString("RevokeAlert", C0505R.string.RevokeAlert));
                    builder.setTitle(LocaleController.getString("RevokeLink", C0505R.string.RevokeLink));
                    builder.setPositiveButton(LocaleController.getString("RevokeButton", C0505R.string.RevokeButton), new C19181());
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == GroupInviteActivity.this.copyLinkRow) {
                        textCell.setText(LocaleController.getString("CopyLink", C0505R.string.CopyLink), true);
                        return;
                    } else if (position == GroupInviteActivity.this.shareLinkRow) {
                        textCell.setText(LocaleController.getString("ShareLink", C0505R.string.ShareLink), false);
                        return;
                    } else if (position == GroupInviteActivity.this.revokeLinkRow) {
                        textCell.setText(LocaleController.getString("RevokeLink", C0505R.string.RevokeLink), true);
                        return;
                    } else {
                        return;
                    }
                case 1:
                    ...
                    if (position == GroupInviteActivity.this.shadowRow) {
                        ...
                        if (!ChatObject.isChannel(chat) || chat.megagroup) {
                            privacyCell.setText(LocaleController.getString("LinkInfo", C0505R.string.LinkInfo));
                        } else {
                            privacyCell.setText(LocaleController.getString("ChannelLinkInfo", C0505R.string.ChannelLinkInfo));
                        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("InviteLink", C0505R.string.InviteLink));
                    ...
                    public void run() {
                        if (error == null) {
                            ...
                            if (newRequest) {
                                if (GroupInviteActivity.this.getParentActivity() != null) {
                                    Builder builder = new Builder(GroupInviteActivity.this.getParentActivity());
                                    builder.setMessage(LocaleController.getString("RevokeAlertNewLink", C0505R.string.RevokeAlertNewLink));
                                    builder.setTitle(LocaleController.getString("RevokeLink", C0505R.string.RevokeLink));
