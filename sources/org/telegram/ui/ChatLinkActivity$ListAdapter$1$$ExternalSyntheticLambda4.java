...
public final /* synthetic */ class ChatLinkActivity$ListAdapter$1$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ ChatLinkActivity$ListAdapter$1$$ExternalSyntheticLambda4(ChatLinkActivity.ListAdapter.AnonymousClass1 r1, Runnable runnable) {
        this.f$0 = r1;
        this.f$1 = runnable;
    }

    public final void run() {
        this.f$0.m3258x18321682(this.f$1);
    }
}
