...
public final /* synthetic */ class ChatActivity$ThemeDelegate$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$ThemeDelegate$$ExternalSyntheticLambda5(ChatActivity.ThemeDelegate themeDelegate, EmojiThemes emojiThemes, boolean z) {
    ...
    public final void run() {
        this.f$0.m1860x785var_ea(this.f$1, this.f$2);
    }
}
