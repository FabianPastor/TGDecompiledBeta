...
public class PhonebookShareActivity extends BaseFragment {
    ...
    class C11377 implements OnClickListener {

        /* renamed from: org.telegram.ui.PhonebookShareActivity$7$1 */
        class C11361 implements DialogInterface.OnClickListener {
            C11361() {
            }
        ...
        public void onClick(View v) {
            if (!PhonebookShareActivity.this.isImport) {
                ...
                builder2.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", R.string.AddToExistingContact)}, new C11361());
                builder2.show();
            }
        }
    }
    ...
    class C11388 implements OnPreDrawListener {
        C11388() {
        }
    ...
    class C16584 implements OnItemClickListener {
        C16584() {
        }
    ...
    class C16595 implements OnItemLongClickListener {
        C16595() {
        }
    ...
    class C16606 extends OnScrollListener {
        C16606() {
        }
    ...
    public View createView(Context context) {
        ...
        LayoutManager c17813 = new LinearLayoutManager(context, 1, false) {
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }
        };
        this.layoutManager = c17813;
        recyclerListView.setLayoutManager(c17813);
        ...
        this.listView.setOnItemClickListener(new C16584());
        this.listView.setOnItemLongClickListener(new C16595());
        ...
        needLayout();
        this.listView.setOnScrollListener(new C16606());
        ...
        this.bottomLayout.setOnClickListener(new C11377());
    ...
    private void fixLayout() {
        if (this.fragmentView != null) {
            this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C11388());
        }
    }
