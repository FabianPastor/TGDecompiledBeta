...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda199 implements RequestDelegate {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda199(ChatActivity chatActivity, TLRPC$TL_messages_sendScheduledMessages tLRPC$TL_messages_sendScheduledMessages) {
        this.f$0 = chatActivity;
        this.f$1 = tLRPC$TL_messages_sendScheduledMessages;
    }

    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$processSelectedOption$191(this.f$1, tLObject, tLRPC$TL_error);
    }
}
