...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda139 implements Runnable {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda139(ChatActivity chatActivity, TLRPC$TL_messages_sendScheduledMessages tLRPC$TL_messages_sendScheduledMessages) {
        this.f$0 = chatActivity;
        this.f$1 = tLRPC$TL_messages_sendScheduledMessages;
    }

    public final void run() {
        this.f$0.lambda$processSelectedOption$154(this.f$1);
    }
}
