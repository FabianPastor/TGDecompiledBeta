...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
        ...
        if (this.parentActivity != null) {
            ...
            if (this.videoPlayer == null) {
                ...
                this.videoPlayer.setDelegate(new VideoPlayer.VideoPlayerDelegate() {
                    ...
                    public /* synthetic */ void m4581lambda$onError$0$orgtelegramuiSecretMediaViewer$1(File file) {
    ...
    public /* synthetic */ WindowInsets m4580lambda$setParentActivity$0$orgtelegramuiSecretMediaViewer(View v, WindowInsets insets) {
            ...
            if (object2 != null) {
                ...
                if (document == null) {
                    ...
                    if (f5.exists()) {
                        ...
                        File file = FileLoader.getInstance(this.currentAccount).getPathToMessage(messageObject2.messageOwner);
    ...
    public /* synthetic */ void m4578lambda$openMedia$1$orgtelegramuiSecretMediaViewer(Runnable onOpen) {
    ...
    public /* synthetic */ void m4579lambda$openMedia$2$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
    ...
    public boolean closePhoto(boolean animated, boolean byDelete) {
        ...
        if (animated) {
            ...
            this.imageMoveAnimation.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m4582lambda$onAnimationEnd$0$orgtelegramuiSecretMediaViewer$7() {
                    if (SecretMediaViewer.this.photoAnimationEndRunnable != null) {
                        SecretMediaViewer.this.photoAnimationEndRunnable.run();
                        Runnable unused = SecretMediaViewer.this.photoAnimationEndRunnable = null;
                    }
    ...
    public /* synthetic */ void m4575lambda$closePhoto$3$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
        this.imageMoveAnimation = null;
        this.photoAnimationInProgress = 0;
        if (Build.VERSION.SDK_INT >= 18) {
            this.containerView.setLayerType(0, (Paint) null);
    ...
    public /* synthetic */ void m4576lambda$closePhoto$4$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
        if (this.containerView != null) {
            if (Build.VERSION.SDK_INT >= 18) {
                this.containerView.setLayerType(0, (Paint) null);
            }
    ...
    public /* synthetic */ void m4577lambda$onPhotoClosed$5$orgtelegramuiSecretMediaViewer() {
        ImageReceiver.BitmapHolder bitmapHolder = this.currentThumb;
        if (bitmapHolder != null) {
            bitmapHolder.release();
            this.currentThumb = null;
