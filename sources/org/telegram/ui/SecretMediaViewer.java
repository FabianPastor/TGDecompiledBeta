...
public class SecretMediaViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
        ...
        if (this.parentActivity != null) {
            ...
            if (this.videoPlayer == null) {
                ...
                this.videoPlayer.setDelegate(new VideoPlayer.VideoPlayerDelegate() {
                    ...
                    public /* synthetic */ void m3845lambda$onError$0$orgtelegramuiSecretMediaViewer$1(File file) {
    ...
    public /* synthetic */ WindowInsets m3844lambda$setParentActivity$0$orgtelegramuiSecretMediaViewer(View v, WindowInsets insets) {
    ...
    public /* synthetic */ void m3842lambda$openMedia$1$orgtelegramuiSecretMediaViewer(Runnable onOpen) {
    ...
    public /* synthetic */ void m3843lambda$openMedia$2$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
    ...
    /* access modifiers changed from: private */
    /* JADX WARNING: Removed duplicated region for block: B:85:0x02a7  */
    /* JADX WARNING: Removed duplicated region for block: B:86:0x02aa  */
    ...
    public void onDraw(android.graphics.Canvas r27) {
        ...
        L_0x0168:
            ...
            if (r5 != 0) goto L_0x01a5
            int r5 = r26.getContainerViewHeight()
            float r5 = (float) r5
            r15 = 1082130432(0x40800000, float:4.0)
            float r5 = r5 / r15
            org.telegram.ui.SecretMediaViewer$PhotoBackgroundDrawable r15 = r0.photoBackgroundDrawable
            ...
            goto L_0x01ac
        L_0x01a5:
            org.telegram.ui.SecretMediaViewer$PhotoBackgroundDrawable r4 = r0.photoBackgroundDrawable
        ...
        L_0x01dc:
            ...
            r27.save()
            float r6 = r9 - r7
            int r15 = r26.getContainerViewWidth()
            int r15 = r15 / 2
            float r15 = (float) r15
            float r15 = r15 + r3
            int r16 = r26.getContainerViewHeight()
            int r5 = r16 / 2
            float r5 = (float) r5
            float r5 = r5 + r10
            r1.translate(r15, r5)
            ...
            org.telegram.messenger.ImageReceiver r15 = r0.centerImage
            ...
            r21 = 1008981770(0x3CLASSNAMEd70a, float:0.01)
        ...
        L_0x024d:
            r5 = r20
        L_0x024f:
            int r2 = r26.getContainerViewHeight()
            float r2 = (float) r2
            float r3 = (float) r15
            float r2 = r2 / r3
            int r3 = r26.getContainerViewWidth()
            float r3 = (float) r3
            r20 = r7
            float r7 = (float) r5
            float r3 = r3 / r7
        ...
        L_0x02aa:
            ...
            r25 = r6
            float r6 = (float) r7
            r2.setImageCoords(r5, r9, r10, r6)
            org.telegram.messenger.ImageReceiver r2 = r0.centerImage
            r2.draw(r1)
        L_0x02c5:
            ...
            r0.videoCrossfadeAlphaLastTime = r5
        L_0x02db:
            int r2 = -r3
            int r2 = r2 / 2
            float r2 = (float) r2
            ...
            if (r2 >= 0) goto L_0x0323
            long r5 = java.lang.System.currentTimeMillis()
            long r9 = r0.videoCrossfadeAlphaLastTime
            long r9 = r5 - r9
            r0.videoCrossfadeAlphaLastTime = r5
            float r2 = r0.videoCrossfadeAlpha
            float r1 = (float) r9
            ...
            r1.invalidate()
            float r1 = r0.videoCrossfadeAlpha
    ...
    public boolean closePhoto(boolean animated, boolean byDelete) {
        ...
        if (animated) {
            ...
            this.imageMoveAnimation.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m3846lambda$onAnimationEnd$0$orgtelegramuiSecretMediaViewer$7() {
                    if (SecretMediaViewer.this.photoAnimationEndRunnable != null) {
                        SecretMediaViewer.this.photoAnimationEndRunnable.run();
                        Runnable unused = SecretMediaViewer.this.photoAnimationEndRunnable = null;
                    }
    ...
    public /* synthetic */ void m3839lambda$closePhoto$3$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
        this.imageMoveAnimation = null;
        this.photoAnimationInProgress = 0;
        if (Build.VERSION.SDK_INT >= 18) {
            this.containerView.setLayerType(0, (Paint) null);
    ...
    public /* synthetic */ void m3840lambda$closePhoto$4$orgtelegramuiSecretMediaViewer(PhotoViewer.PlaceProviderObject object) {
        if (this.containerView != null) {
            if (Build.VERSION.SDK_INT >= 18) {
                this.containerView.setLayerType(0, (Paint) null);
            }
    ...
    public /* synthetic */ void m3841lambda$onPhotoClosed$5$orgtelegramuiSecretMediaViewer() {
        ImageReceiver.BitmapHolder bitmapHolder = this.currentThumb;
        if (bitmapHolder != null) {
            bitmapHolder.release();
            this.currentThumb = null;
