...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ImageUpdater.ImageUpdaterDelegate {
    ...
    public /* synthetic */ void m3589xd3eevar_(ArrayList users, ArrayList usersToLoad, CountDownLatch countDownLatch) {
    ...
    public /* synthetic */ void m3583lambda$createView$4$orgtelegramuiGroupCreateFinalActivity(View view) {
    ...
    public /* synthetic */ void m3581lambda$createView$2$orgtelegramuiGroupCreateFinalActivity() {
        this.avatar = null;
        this.avatarBig = null;
    ...
    public /* synthetic */ void m3582lambda$createView$3$orgtelegramuiGroupCreateFinalActivity(DialogInterface dialog) {
    ...
    public /* synthetic */ void m3585lambda$createView$6$orgtelegramuiGroupCreateFinalActivity(View view, int position) {
    ...
    public /* synthetic */ void m3584lambda$createView$5$orgtelegramuiGroupCreateFinalActivity(TLRPC.MessageMedia location, int live, boolean notify, int scheduleDate) {
    ...
    public /* synthetic */ void m3586lambda$createView$7$orgtelegramuiGroupCreateFinalActivity(View view) {
        if (!this.donePressed) {
    ...
    public /* synthetic */ void m3587lambda$didUploadPhoto$8$orgtelegramuiGroupCreateFinalActivity(TLRPC.InputFile photo, TLRPC.InputFile video, String videoPath, double videoStartTimestamp, TLRPC.PhotoSize smallSize, TLRPC.PhotoSize bigSize) {
    ...
    public /* synthetic */ void m3588x91f4CLASSNAME() {
