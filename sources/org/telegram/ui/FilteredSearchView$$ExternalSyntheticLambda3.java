...
public final /* synthetic */ class FilteredSearchView$$ExternalSyntheticLambda3 implements RequestDelegate {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m3484lambda$search$3$orgtelegramuiFilteredSearchView(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, tLObject, tL_error);
    }
}
