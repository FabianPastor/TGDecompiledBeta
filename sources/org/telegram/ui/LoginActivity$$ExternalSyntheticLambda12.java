...
public final /* synthetic */ class LoginActivity$$ExternalSyntheticLambda12 implements Runnable {
    ...
    public /* synthetic */ LoginActivity$$ExternalSyntheticLambda12(OutlineTextContainerView outlineTextContainerView, View view, EditText editText, TextWatcher textWatcher) {
    ...
    public final void run() {
        LoginActivity.lambda$onFieldError$8(this.f$0, this.f$1, this.f$2, this.f$3);
    }
}
