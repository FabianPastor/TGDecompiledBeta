...
public class PassportActivity extends BaseFragment implements NotificationCenterDelegate {
                ...
                this.timeTimer.schedule(new TimerTask() {
                    public void run() {
                        if (PhoneConfirmationView.this.timeTimer != null) {
                            ...
                            AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$PhoneConfirmationView$5$Fz0wJt3qwaIJL6DdT1hAFPghb5Q(this));
                        }
                    }
                    ...
                    public /* synthetic */ void lambda$run$2$PassportActivity$PhoneConfirmationView$5() {
                        ...
                        if (PhoneConfirmationView.this.verificationType == 3) {
                            ...
                            if (PhoneConfirmationView.this.nextType == 4 || PhoneConfirmationView.this.nextType == 2) {
                                ...
                                ConnectionsManager.getInstance(PhoneConfirmationView.this.this$0.currentAccount).sendRequest(tL_auth_resendCode, new -$$Lambda$PassportActivity$PhoneConfirmationView$5$bGbxjTlg4kraZC8-TdkD8TS1heo(this), 2);
                    ...
                    public /* synthetic */ void lambda$null$1$PassportActivity$PhoneConfirmationView$5(TLObject tLObject, TL_error tL_error) {
                        if (tL_error != null && tL_error.text != null) {
                            AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$PhoneConfirmationView$5$e_KulAgqEVRy6OEqKxeM5XSuhwU(this, tL_error));
                        }
                    }

                    public /* synthetic */ void lambda$null$0$PassportActivity$PhoneConfirmationView$5(TL_error tL_error) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:49:0x013b A:{Catch:{ Exception -> 0x0239 }} */
    /* JADX WARNING: Removed duplicated region for block: B:48:0x0139 A:{Catch:{ Exception -> 0x0239 }} */
    ...
    L_0x0037:
        r0 = r11.errors;	 Catch:{ Exception -> 0x0239 }
        r1 = new org.telegram.ui.PassportActivity$2;	 Catch:{ Exception -> 0x0239 }
        r1.<init>();	 Catch:{ Exception -> 0x0239 }
        java.util.Collections.sort(r0, r1);	 Catch:{ Exception -> 0x0239 }
        r0 = r11.errors;	 Catch:{ Exception -> 0x0239 }
        r0 = r0.size();	 Catch:{ Exception -> 0x0239 }
        r2 = 0;
    L_0x0048:
        if (r2 >= r0) goto L_0x0239;
    L_0x004a:
        r3 = r11.errors;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.get(r2);	 Catch:{ Exception -> 0x0239 }
        r3 = (org.telegram.tgnet.TLRPC.SecureValueError) r3;	 Catch:{ Exception -> 0x0239 }
        r4 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorFrontSide;	 Catch:{ Exception -> 0x0239 }
        r5 = "data";
        r6 = 0;
        r7 = "error_all";
        r8 = "selfie";
    ...
    L_0x0065:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorFrontSide) r3;	 Catch:{ Exception -> 0x0239 }
        r4 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r4);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.file_hash;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        r13 = r6;
        r6 = r12;
        goto L_0x014b;
    L_0x0077:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorReverseSide;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x008d;
    L_0x007b:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorReverseSide) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.file_hash;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        r13 = r6;
        ...
        goto L_0x014b;
    L_0x008d:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorSelfie;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x00a3;
    L_0x0091:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorSelfie) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.file_hash;	 Catch:{ Exception -> 0x0239 }
        ...
        goto L_0x014b;
    L_0x00a3:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorTranslationFile;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x00b9;
    L_0x00a7:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorTranslationFile) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.file_hash;	 Catch:{ Exception -> 0x0239 }
    ...
    L_0x00b6:
        ...
        goto L_0x014b;
    L_0x00b9:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorTranslationFiles;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x00cc;
    L_0x00bd:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorTranslationFiles) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        ...
        goto L_0x00b6;
    L_0x00cc:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorFile;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x00e2;
    L_0x00d0:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorFile) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.file_hash;	 Catch:{ Exception -> 0x0239 }
    ...
    L_0x00df:
        ...
        goto L_0x014b;
    L_0x00e2:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorFiles;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x00f5;
    L_0x00e6:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorFiles) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        ...
        goto L_0x00df;
    L_0x00f5:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueError;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x010a;
    L_0x00f9:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueError) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = r3.type;	 Catch:{ Exception -> 0x0239 }
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.hash;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        r13 = r6;
        r6 = r7;
        goto L_0x014b;
    L_0x010a:
        r1 = r3 instanceof org.telegram.tgnet.TLRPC.TL_secureValueErrorData;	 Catch:{ Exception -> 0x0239 }
        if (r1 == 0) goto L_0x022f;
    L_0x010e:
        r3 = (org.telegram.tgnet.TLRPC.TL_secureValueErrorData) r3;	 Catch:{ Exception -> 0x0239 }
        r1 = 0;
    L_0x0111:
        r4 = r11.values;	 Catch:{ Exception -> 0x0239 }
        r4 = r4.size();	 Catch:{ Exception -> 0x0239 }
        if (r1 >= r4) goto L_0x0136;
    L_0x0119:
        r4 = r11.values;	 Catch:{ Exception -> 0x0239 }
        r4 = r4.get(r1);	 Catch:{ Exception -> 0x0239 }
        r4 = (org.telegram.tgnet.TLRPC.TL_secureValue) r4;	 Catch:{ Exception -> 0x0239 }
        r6 = r4.data;	 Catch:{ Exception -> 0x0239 }
        if (r6 == 0) goto L_0x0133;
    L_0x0125:
        r4 = r4.data;	 Catch:{ Exception -> 0x0239 }
        r4 = r4.data_hash;	 Catch:{ Exception -> 0x0239 }
        r6 = r3.data_hash;	 Catch:{ Exception -> 0x0239 }
        r4 = java.util.Arrays.equals(r4, r6);	 Catch:{ Exception -> 0x0239 }
    ...
    L_0x013b:
        ...
        r4 = r10.getNameForType(r1);	 Catch:{ Exception -> 0x0239 }
        r1 = r3.text;	 Catch:{ Exception -> 0x0239 }
        r6 = r3.field;	 Catch:{ Exception -> 0x0239 }
        r3 = r3.data_hash;	 Catch:{ Exception -> 0x0239 }
        r21 = r0;
        r13 = r6;
        r6 = r5;
    L_0x014b:
        r0 = r10.errorsMap;	 Catch:{ Exception -> 0x0239 }
        r0 = r0.get(r4);	 Catch:{ Exception -> 0x0239 }
        r0 = (java.util.HashMap) r0;	 Catch:{ Exception -> 0x0239 }
        if (r0 != 0) goto L_0x0164;
    L_0x0155:
        r0 = new java.util.HashMap;	 Catch:{ Exception -> 0x0239 }
        r0.<init>();	 Catch:{ Exception -> 0x0239 }
        r11 = r10.errorsMap;	 Catch:{ Exception -> 0x0239 }
        r11.put(r4, r0);	 Catch:{ Exception -> 0x0239 }
        r11 = r10.mainErrorsMap;	 Catch:{ Exception -> 0x0239 }
        r11.put(r4, r1);	 Catch:{ Exception -> 0x0239 }
    L_0x0164:
        r4 = 2;
        if (r3 == 0) goto L_0x016c;
    L_0x0167:
        r11 = android.util.Base64.encodeToString(r3, r4);	 Catch:{ Exception -> 0x0239 }
        goto L_0x016e;
    L_0x016c:
        r11 = "";
    L_0x016e:
        r16 = -1;
        r17 = r6.hashCode();	 Catch:{ Exception -> 0x0239 }
        switch(r17) {
            case -1840647503: goto L_0x01a7;
            case -906020504: goto L_0x01a0;
            case 3076010: goto L_0x0198;
            case 97434231: goto L_0x0190;
            case 97705513: goto L_0x0188;
            case 329856746: goto L_0x0180;
            case 1099846370: goto L_0x0178;
            default: goto L_0x0177;
        };	 Catch:{ Exception -> 0x0239 }
    L_0x0177:
        goto L_0x01af;
    L_0x0178:
        r4 = r6.equals(r9);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x017e:
        r4 = 5;
        goto L_0x01b0;
    L_0x0180:
        r4 = r6.equals(r7);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x0186:
        r4 = 6;
        goto L_0x01b0;
    L_0x0188:
        r4 = r6.equals(r12);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x018e:
        r4 = 4;
        goto L_0x01b0;
    L_0x0190:
        r4 = r6.equals(r14);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x0196:
        r4 = 1;
        goto L_0x01b0;
    L_0x0198:
        r4 = r6.equals(r5);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x019e:
        r4 = 0;
        goto L_0x01b0;
    L_0x01a0:
        r5 = r6.equals(r8);	 Catch:{ Exception -> 0x0239 }
        if (r5 == 0) goto L_0x01af;
    L_0x01a6:
        goto L_0x01b0;
    L_0x01a7:
        r4 = r6.equals(r15);	 Catch:{ Exception -> 0x0239 }
        if (r4 == 0) goto L_0x01af;
    L_0x01ad:
        r4 = 3;
        goto L_0x01b0;
    ...
    L_0x01b3:
        goto L_0x0231;
    L_0x01b5:
        r0.put(r7, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    L_0x01ba:
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0239 }
        r3.<init>();	 Catch:{ Exception -> 0x0239 }
        r3.append(r9);	 Catch:{ Exception -> 0x0239 }
        r3.append(r11);	 Catch:{ Exception -> 0x0239 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0239 }
        r0.put(r3, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    L_0x01cd:
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0239 }
        r3.<init>();	 Catch:{ Exception -> 0x0239 }
        r3.append(r12);	 Catch:{ Exception -> 0x0239 }
        r3.append(r11);	 Catch:{ Exception -> 0x0239 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0239 }
        r0.put(r3, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    ...
    L_0x01e2:
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0239 }
        r3.<init>();	 Catch:{ Exception -> 0x0239 }
        r3.append(r15);	 Catch:{ Exception -> 0x0239 }
        r3.append(r11);	 Catch:{ Exception -> 0x0239 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0239 }
        r0.put(r3, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    ...
    L_0x01fb:
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0239 }
        r3.<init>();	 Catch:{ Exception -> 0x0239 }
        r3.append(r8);	 Catch:{ Exception -> 0x0239 }
        r3.append(r11);	 Catch:{ Exception -> 0x0239 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0239 }
        r0.put(r3, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    ...
    L_0x0210:
        r3 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x0239 }
        r3.<init>();	 Catch:{ Exception -> 0x0239 }
        r3.append(r14);	 Catch:{ Exception -> 0x0239 }
        r3.append(r11);	 Catch:{ Exception -> 0x0239 }
        r3 = r3.toString();	 Catch:{ Exception -> 0x0239 }
        r0.put(r3, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    ...
    L_0x022b:
        r0.put(r13, r1);	 Catch:{ Exception -> 0x0239 }
        goto L_0x0231;
    L_0x022f:
        r21 = r0;
    L_0x0231:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBarMenuOnItemClick() {
            ...
            L_0x003e:
                ...
                r1 = r1.inputFields;
                r1 = r1[r12];
                r2 = NUM; // 0x7f0e086f float:1.8879417E38 double:1.0531632233E-314;
            ...
            L_0x00f6:
                ...
                r13.<init>(r0);
                r0 = NUM; // 0x7f0e0839 float:1.8879307E38 double:1.0531631966E-314;
                ...
                r13.setMessage(r0);
                r0 = NUM; // 0x7f0e0100 float:1.8875557E38 double:1.053162283E-314;
                r1 = "AppName";
                r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
                r13.setTitle(r0);
                r0 = NUM; // 0x7f0e03eb float:1.8877072E38 double:1.053162652E-314;
                r1 = "Done";
            ...
            L_0x003b:
                ...
                r1.<init>(r2);
                r2 = NUM; // 0x7f0e0801 float:1.8879193E38 double:1.053163169E-314;
                r7 = "PassportInfo2";
            ...
            L_0x0062:
                ...
                r8 = NUM; // 0x7f0e0803 float:1.8879197E38 double:1.05316317E-314;
                r10 = "PassportInfoUrl";
            ...
            L_0x0082:
                ...
                r2.<init>(r3);
                r2.setView(r1);
                r1 = NUM; // 0x7f0e0802 float:1.8879195E38 double:1.0531631695E-314;
                r3 = "PassportInfoTitle";
                r1 = org.telegram.messenger.LocaleController.getString(r3, r1);
                r2.setTitle(r1);
                r1 = NUM; // 0x7f0e030c float:1.887662E38 double:1.053162542E-314;
                r3 = "Close";
                r1 = org.telegram.messenger.LocaleController.getString(r3, r1);
    ...
    private void createManageInterface(android.content.Context r20) {
        ...
        r0 = r6.actionBar;
        r1 = "TelegramPassport";
        r2 = NUM; // 0x7f0e0af3 float:1.8880723E38 double:1.0531635415E-314;
        r1 = org.telegram.messenger.LocaleController.getString(r1, r2);
        r0.setTitle(r1);
        r0 = r6.actionBar;
        r0 = r0.createMenu();
        r8 = 1;
        r1 = NUM; // 0x7var_c float:1.7945868E38 double:1.0529358173E-314;
        r0.addItem(r8, r1);
        ...
        r2 = NUM; // 0x7f0e0851 float:1.8879356E38 double:1.0531632085E-314;
        r1 = org.telegram.messenger.LocaleController.getString(r1, r2);
        r0.setText(r1);
        r0 = r6.headerCell;
        ...
        r0.setBackgroundDrawable(r4);
        r0 = r6.addDocumentCell;
        r4 = NUM; // 0x7f0e0840 float:1.8879321E38 double:1.0531632E-314;
        ...
        r10 = NUM; // 0x7f0e0af6 float:1.8880729E38 double:1.053163543E-314;
    ...
    L_0x0152:
        ...
        r0.setTypeface(r9);
        r0 = r6.emptyTextView1;
        r9 = NUM; // 0x7f0e083f float:1.887932E38 double:1.0531631996E-314;
        ...
        r0 = r6.emptyTextView2;
        r1 = NUM; // 0x7f0e0841 float:1.8879323E38 double:1.0531632006E-314;
    ...
    public /* synthetic */ void lambda$createManageInterface$21$PassportActivity(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("Delete", NUM), new -$$Lambda$PassportActivity$TerssJhszDCLASSNAMEoVgt9PLJkXFg6k(this));
            ...
            if (i2 == 1) {
                ...
                this.inputFields[i2].addTextChangedListener(new TextWatcher() {
                    ...
                    L_0x0046:
                        ...
                        r12 = r12.inputFields;
                        r12 = r12[r7];
                        r0 = NUM; // 0x7f0e02ec float:1.8876555E38 double:1.053162526E-314;
                        r1 = "ChooseCountry";
                        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
                        r12.setText(r0);
                        goto L_0x018f;
                    ...
                    L_0x0145:
                        ...
                        r3 = r3.inputFields;
                        r3 = r3[r7];
                        r4 = NUM; // 0x7f0e0cce float:1.8881686E38 double:1.053163776E-314;
                        r5 = "WrongCountry";
    ...
    private void createIdentityInterface(Context context) {
        ...
        if (this.currentDocumentsType != null) {
            ...
            this.scanDocumentCell.setOnClickListener(new -$$Lambda$PassportActivity$CIH8TL09dyi-qIly_4D0tlrui2A(this));
            this.bottomCell = new TextInfoPrivacyCell(context2);
            this.bottomCell.setBackgroundDrawable(Theme.getThemedDrawable(context2, NUM, str));
        ...
        while (true) {
            ...
            if (i4 < i3) {
                ...
                AnonymousClass15 anonymousClass15 = new FrameLayout(context2) {
                    private StaticLayout errorLayout;
                ...
                anonymousClass15.setWillNotDraw(z);
                this.linearLayout2.addView(anonymousClass15, LayoutHelper.createLinear(i, 64));
                anonymousClass15.setBackgroundColor(Theme.getColor(str2));
                if (i4 == i3 - 1) {
                    this.extraBackgroundView = new View(context2);
                ...
                if (i4 == 5 || i4 == 6) {
                    this.inputFields[i4].setOnTouchListener(new -$$Lambda$PassportActivity$ow949Zv7R6W952Vqf3n-6Z8uJOY(this));
                    this.inputFields[i4].setInputType(0);
                } else if (i4 == 3 || i4 == 8) {
                    this.inputFields[i4].setOnTouchListener(new -$$Lambda$PassportActivity$WJJ2tEIkKv31bR3tm8G3xDQIOL0(this, context2));
                    this.inputFields[i4].setInputType(0);
                    this.inputFields[i4].setFocusable(false);
                } else if (i4 == 4) {
                    this.inputFields[i4].setOnTouchListener(new -$$Lambda$PassportActivity$4EIT_7VBkJ3Ft8SITyRBhPB6mTQ(this));
                    this.inputFields[i4].setInputType(0);
                    this.inputFields[i4].setFocusable(false);
                } else {
                ...
                anonymousClass15.addView(this.inputFields[i4], LayoutHelper.createFrame(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                this.inputFields[i4].setOnEditorActionListener(new -$$Lambda$PassportActivity$7gHP3rqtxrliQd6Hi-4RFh2SjSo(this));
                i4++;
                z = false;
                i = -1;
                i2 = 7;
                ...
                while (i5 < i3) {
                    ...
                    anonymousClass18.setBackgroundColor(Theme.getColor(str2));
                    if (i5 == 2) {
                    ...
                    anonymousClass18.addView(this.inputExtraFields[i5], LayoutHelper.createFrame(-1, -1.0f, 51, 21.0f, 0.0f, 21.0f, 0.0f));
                    this.inputExtraFields[i5].setOnEditorActionListener(new -$$Lambda$PassportActivity$IUKnReQZFqjMBZyTSuqCOeb27jI(this));
                    i5++;
                    i3 = 3;
                }
                ...
                if (((this.currentBotId == 0 && this.currentDocumentsType != null) || this.currentTypeValue == null || this.documentOnly) && this.currentDocumentsTypeValue == null) {
                    ...
                    this.linearLayout2.addView(textSettingsCell, LayoutHelper.createLinear(-1, -2));
                    textSettingsCell.setOnClickListener(new -$$Lambda$PassportActivity$WJlrsHWmbcLVOhaE2-okRbJs_gk(this));
                    this.nativeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context2, NUM, str));
                    this.sectionCell = new ShadowSectionCell(context2);
                    this.sectionCell.setBackgroundDrawable(Theme.getThemedDrawable(context2, NUM, str));
                    this.linearLayout2.addView(this.sectionCell, LayoutHelper.createLinear(-1, -2));
    ...
    public /* synthetic */ void lambda$createIdentityInterface$44$PassportActivity(View view) {
        if (VERSION.SDK_INT >= 23) {
            if (getParentActivity().checkSelfPermission("android.permission.CAMERA") != 0) {
                getParentActivity().requestPermissions(new String[]{r1}, 22);
                return;
            }
        }
        ...
        cameraScanActivity.setDelegate(new CameraScanActivityDelegate() {
            ...
            public void didFindMrzInfo(Result result) {
                ...
                if (!TextUtils.isEmpty(result.nationality)) {
                    ...
                    str = (String) PassportActivity.this.languageMap.get(PassportActivity.this.currentCitizeship);
                    if (str != null) {
                ...
                if (!TextUtils.isEmpty(result.issuingCountry)) {
                    ...
                    str = (String) PassportActivity.this.languageMap.get(PassportActivity.this.currentResidence);
                    if (str != null) {
                        PassportActivity.this.inputFields[6].setText(str);
                    }
                }
    ...
    public /* synthetic */ boolean lambda$createIdentityInterface$46$PassportActivity(View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1) {
            CountrySelectActivity countrySelectActivity = new CountrySelectActivity(false);
            countrySelectActivity.setCountrySelectActivityDelegate(new -$$Lambda$PassportActivity$Z-YlmJaxJ5njYIm4iUI084DrCAE(this, view));
            presentFragment(countrySelectActivity);
        }
        return true;
    }
    ...
    public /* synthetic */ boolean lambda$createIdentityInterface$49$PassportActivity(Context context, View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1) {
            ...
            try {
                ...
                Builder createDatePickerDialog = AlertsCreator.createDatePickerDialog(context, i, i2, i3, i4, i5, intValue, string, intValue2 == 8, new -$$Lambda$PassportActivity$P10T5kXtx9T7oOLbqDYgVm7EE8A(this, intValue2, editTextBoldCursor));
                if (intValue2 == 8) {
                    createDatePickerDialog.setNegativeButton(LocaleController.getString("PassportSelectNotExpire", NUM), new -$$Lambda$PassportActivity$HCa0var_lAYMpv3AScM17lwReamM(this, editTextBoldCursor));
                }
    ...
    public /* synthetic */ boolean lambda$createIdentityInterface$51$PassportActivity(View view, MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 1) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("PassportMale", NUM), LocaleController.getString("PassportFemale", NUM)}, new -$$Lambda$PassportActivity$Wuk7lBzGVppXHqk7cXUUmWpDK2Y(this));
    ...
    private void updateUploadText(int r9) {
        /*
        r8 = this;
        r0 = NUM; // 0x7f0e086b float:1.8879408E38 double:1.0531632213E-314;
        r1 = "PassportUploadAdditinalDocument";
        r2 = NUM; // 0x7f0e086c float:1.887941E38 double:1.053163222E-314;
    ...
    L_0x0094:
        r9 = r8.uploadFrontCell;
        r0 = NUM; // 0x7f0e07f8 float:1.8879175E38 double:1.0531631645E-314;
        r1 = "PassportFrontSide";
        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
        r1 = NUM; // 0x7f0e07f9 float:1.8879177E38 double:1.053163165E-314;
    ...
    L_0x00ac:
        r9 = r8.uploadFrontCell;
        r0 = NUM; // 0x7f0e0832 float:1.8879293E38 double:1.053163193E-314;
        r1 = "PassportMainPage";
        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
        r1 = NUM; // 0x7f0e0833 float:1.8879295E38 double:1.0531631937E-314;
    ...
    L_0x008a:
        ...
        r7[r5] = r4;
        r7[r4] = r4;
        r7 = NUM; // 0x7f0e0842 float:1.8879325E38 double:1.053163201E-314;
    ...
    L_0x00be:
        r6.currentGender = r7;
        r7 = NUM; // 0x7f0e07f7 float:1.8879173E38 double:1.053163164E-314;
        r0 = "PassportFemale";
        r7 = org.telegram.messenger.LocaleController.getString(r0, r7);
        r8.setText(r7);
        goto L_0x00f0;
            ...
            if (str2 != null) {
                ...
                if (hashMap != null) {
                    ...
                    if (charSequence != null) {
                        ...
                        secureDocumentCell.setOnClickListener(new -$$Lambda$PassportActivity$iFl4FvM0dO6VZeXLDYKUYIS1cfs(this, i));
                        secureDocumentCell.setOnLongClickListener(new -$$Lambda$PassportActivity$RiKhLWF7-bmBy1TPoBk73twqlHI(this, i, secureDocument, secureDocumentCell, str2));
                    }
                }
            }
    ...
    public /* synthetic */ boolean lambda$addDocumentView$57$PassportActivity(int i, SecureDocument secureDocument, SecureDocumentCell secureDocumentCell, String str, View view) {
        ...
        builder.setNegativeButton(LocaleController.getString("Cancel", NUM), null);
        builder.setTitle(LocaleController.getString("AppName", NUM));
        builder.setPositiveButton(LocaleController.getString("OK", NUM), new -$$Lambda$PassportActivity$1qgSM8U02l0fQnayGy0c0ZpUpCE(this, secureDocument, i, secureDocumentCell, str));
        showDialog(builder.create());
        return true;
    }
    ...
    L_0x00c6:
        ...
        r7.languageMap = r3;
    L_0x00cb:
        r5 = NUM; // 0x7f0e07f0 float:1.8879159E38 double:1.0531631606E-314;
    ...
    L_0x0340:
        r2 = "PassportMale";
        r4 = NUM; // 0x7f0e0834 float:1.8879297E38 double:1.053163194E-314;
    ...
    L_0x0355:
        r2 = "PassportFemale";
        r4 = NUM; // 0x7f0e07f7 float:1.8879173E38 double:1.053163164E-314;
        r2 = org.telegram.messenger.LocaleController.getString(r2, r4);	 Catch:{ Exception -> 0x037b }
        r12.append(r2);	 Catch:{ Exception -> 0x037b }
        goto L_0x0378;
    L_0x0362:
    ...
    L_0x042c:
        r0 = NUM; // 0x7f0e0846 float:1.8879333E38 double:1.053163203E-314;
    ...
    L_0x0440:
        r2 = r25;
        r1 = NUM; // 0x7f0e07f0 float:1.8879159E38 double:1.0531631606E-314;
    ...
    L_0x0455:
        r0 = NUM; // 0x7f0e0800 float:1.8879191E38 double:1.0531631685E-314;
    ...
    L_0x0463:
        r0 = NUM; // 0x7f0e07ff float:1.887919E38 double:1.053163168E-314;
    ...
    L_0x0471:
        r0 = NUM; // 0x7f0e07fd float:1.8879185E38 double:1.053163167E-314;
    ...
    L_0x047b:
        ...
        if (r1 == 0) goto L_0x0493;
    L_0x047f:
        r0 = NUM; // 0x7f0e07fe float:1.8879187E38 double:1.0531631675E-314;
        r1 = "PassportIdentityID";
        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
        goto L_0x0435;
    L_0x0489:
        r0 = NUM; // 0x7f0e07fc float:1.8879183E38 double:1.0531631665E-314;
    ...
    L_0x04a6:
        r0 = NUM; // 0x7f0e07d8 float:1.887911E38 double:1.0531631487E-314;
    ...
    L_0x04c8:
        r0 = NUM; // 0x7f0e07be float:1.8879058E38 double:1.053163136E-314;
    ...
    L_0x04d7:
        r0 = NUM; // 0x7f0e07c2 float:1.8879066E38 double:1.053163138E-314;
    ...
    L_0x04e5:
        r0 = NUM; // 0x7f0e07cc float:1.8879086E38 double:1.053163143E-314;
    ...
    L_0x04f3:
        r0 = NUM; // 0x7f0e07ce float:1.887909E38 double:1.053163144E-314;
    ...
    L_0x0501:
        r0 = NUM; // 0x7f0e07c0 float:1.8879062E38 double:1.053163137E-314;
        r1 = "PassportAddBankInfo";
        r0 = org.telegram.messenger.LocaleController.getString(r1, r0);
        goto L_0x053d;
    L_0x050b:
        r0 = NUM; // 0x7f0e07d7 float:1.8879108E38 double:1.053163148E-314;
    ...
    L_0x052e:
        ...
        if (r1 == 0) goto L_0x053d;
    L_0x0534:
        r0 = NUM; // 0x7f0e07f3 float:1.8879165E38 double:1.053163162E-314;
    ...
    private void checkNativeFields(boolean z) {
        if (this.inputExtraFields != null) {
            ...
            if (this.currentType.native_names && !TextUtils.isEmpty(this.currentResidence) && !"EN".equals(str2)) {
                ...
                if (z) {
                    AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$zqsTjYFcZZJYv3TC-jxWzaoeKKI(this));
                }
                            ...
                            if (!z2) {
                                ...
                                anonymousClass12 = new RequestDelegate(this) {
                                    ...
                                    private void onResult(TL_error tL_error, TL_secureValue tL_secureValue, TL_secureValue tL_secureValue2) {
                                        ...
                                        AnonymousClass20 anonymousClass20 = this.this$1;
                                        AnonymousClass20 anonymousClass202 = anonymousClass20;
                                        AnonymousClass20 anonymousClass203 = anonymousClass202;
                                        AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$20$1$Uic1dLmY_p3uaQ9tNTNsydinsac(this, tL_error, errorRunnable, str, tL_account_saveSecureValue, z2, tL_secureRequiredType4, tL_secureRequiredType3, tL_secureValue3, tL_secureValue4, arrayList3, secureDocument4, secureDocument5, secureDocument6, arrayList4, str5, str6, size, runnable2));
                                    }

                                    public /* synthetic */ void lambda$onResult$0$PassportActivity$20$1(TL_error tL_error, ErrorRunnable errorRunnable, String str, TL_account_saveSecureValue tL_account_saveSecureValue, boolean z, TL_secureRequiredType tL_secureRequiredType, TL_secureRequiredType tL_secureRequiredType2, TL_secureValue tL_secureValue, TL_secureValue tL_secureValue2, ArrayList arrayList, SecureDocument secureDocument, SecureDocument secureDocument2, SecureDocument secureDocument3, ArrayList arrayList2, String str2, String str3, int i, Runnable runnable) {
                                        TL_error tL_error2 = tL_error;
                                        ErrorRunnable errorRunnable2 = errorRunnable;
                                        String str4 = str;
                                        TL_secureRequiredType tL_secureRequiredType3 = tL_secureRequiredType;
                                    ...
                                    public void run(TLObject tLObject, TL_error tL_error) {
                                        if (tL_error != null) {
                                            if (tL_error.text.equals("EMAIL_VERIFICATION_NEEDED")) {
                                                ...
                                                ConnectionsManager.getInstance(PassportActivity.this.currentAccount).sendRequest(tL_account_sendVerifyEmailCode, new -$$Lambda$PassportActivity$20$1$xXbPSJhnMuKvf4CdbZ3dXntNgPc(this, str4, tL_secureRequiredType3, this, errorRunnable2));
                                                return;
                                            } else if (tL_error.text.equals("PHONE_VERIFICATION_NEEDED")) {
                                                AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$20$1$DA8klWTUN5YyRShFH-4ud5Y30Sg(errorRunnable2, tL_error, str4));
                                                return;
                                            }
                                        }
                                        if (tL_error != null || tL_inputSecureValue3 == null) {
                                            ...
                                            tL_account_saveSecureValue.secure_secret_id = PassportActivity.this.secureSecretId;
                                            ConnectionsManager.getInstance(PassportActivity.this.currentAccount).sendRequest(tL_account_saveSecureValue, new -$$Lambda$PassportActivity$20$1$RNBudqlw2hRjBnfew1me0QiF7Ho(this, tL_secureValue));
                                        }
                                    }

                                    public /* synthetic */ void lambda$run$2$PassportActivity$20$1(String str, TL_secureRequiredType tL_secureRequiredType, PassportActivityDelegate passportActivityDelegate, ErrorRunnable errorRunnable, TLObject tLObject, TL_error tL_error) {
                                        AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$20$1$RLCHh_-MgQ1hoS4C2TlelWtsOYg(this, tLObject, str, tL_secureRequiredType, passportActivityDelegate, tL_error, errorRunnable));
                                    }

                                    public /* synthetic */ void lambda$null$1$PassportActivity$20$1(TLObject tLObject, String str, TL_secureRequiredType tL_secureRequiredType, PassportActivityDelegate passportActivityDelegate, TL_error tL_error, ErrorRunnable errorRunnable) {
                                        String str2 = str;
                                        TL_error tL_error2 = tL_error;
                                        ErrorRunnable errorRunnable2 = errorRunnable;
                                        if (tLObject != null) {
                                    ...
                                    public /* synthetic */ void lambda$run$4$PassportActivity$20$1(TL_secureValue tL_secureValue, TLObject tLObject, TL_error tL_error) {
    ...
    private void deleteValueInternal(TL_secureRequiredType tL_secureRequiredType, TL_secureRequiredType tL_secureRequiredType2, ArrayList<TL_secureRequiredType> arrayList, boolean z, Runnable runnable, ErrorRunnable errorRunnable, boolean z2) {
        ...
        if (tL_secureRequiredType3 != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_deleteSecureValue, new -$$Lambda$PassportActivity$wh4XBcIYYsYXASYVxRv0U0OZ3bo(this, errorRunnable, z2, tL_secureRequiredType2, tL_secureRequiredType, z, arrayList, runnable));
        }
    }

    public /* synthetic */ void lambda$deleteValueInternal$60$PassportActivity(ErrorRunnable errorRunnable, boolean z, TL_secureRequiredType tL_secureRequiredType, TL_secureRequiredType tL_secureRequiredType2, boolean z2, ArrayList arrayList, Runnable runnable, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$mNUMe7wKm78vrkjVOFaRvh7of_ZE(this, tL_error, errorRunnable, z, tL_secureRequiredType, tL_secureRequiredType2, z2, arrayList, runnable));
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:35:0x00a2  */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00ab  */
    public /* synthetic */ void lambda$null$59$PassportActivity(org.telegram.tgnet.TLRPC.TL_error r12, org.telegram.ui.PassportActivity.ErrorRunnable r13, boolean r14, org.telegram.tgnet.TLRPC.TL_secureRequiredType r15, org.telegram.tgnet.TLRPC.TL_secureRequiredType r16, boolean r17, java.util.ArrayList r18, java.lang.Runnable r19) {
        /*
        r11 = this;
        r8 = r11;
        r0 = r12;
    ...
    L_0x00ff:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.PassportActivity.lambda$null$59$PassportActivity(org.telegram.tgnet.TLRPC$TL_error, org.telegram.ui.PassportActivity$ErrorRunnable, boolean, org.telegram.tgnet.TLRPC$TL_secureRequiredType, org.telegram.tgnet.TLRPC$TL_secureRequiredType, boolean, java.util.ArrayList, java.lang.Runnable):void");
    }
    ...
    L_0x0012:
        ...
        r10 = NUM; // 0x7f0e086a float:1.8879406E38 double:1.053163221E-314;
    ...
    L_0x0055:
        ...
        goto L_0x008b;
    L_0x0078:
        r4 = NUM; // 0x7f0e07fb float:1.8879181E38 double:1.053163166E-314;
        r5 = "PassportIdentityDocument";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        goto L_0x008b;
    L_0x0082:
        r4 = NUM; // 0x7f0e0845 float:1.8879331E38 double:1.0531632026E-314;
    ...
    L_0x00bc:
        ...
        goto L_0x00f2;
    L_0x00df:
        r4 = NUM; // 0x7f0e0857 float:1.8879368E38 double:1.0531632115E-314;
        r5 = "PassportResidentialAddress";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        goto L_0x00f2;
    L_0x00e9:
        r4 = NUM; // 0x7f0e07d5 float:1.8879104E38 double:1.053163147E-314;
        r5 = "PassportAddress";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
    L_0x00f2:
        r5 = r21 ^ 1;
    ...
    L_0x00fc:
        r4 = NUM; // 0x7f0e0848 float:1.8879337E38 double:1.053163204E-314;
        r5 = "PassportPhone";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = r21 ^ 1;
        r9.setTextAndValue(r4, r13, r5);
    ...
    L_0x010f:
        r4 = NUM; // 0x7f0e07f1 float:1.887916E38 double:1.053163161E-314;
        r5 = "PassportEmail";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = r21 ^ 1;
        r9.setTextAndValue(r4, r13, r5);
    ...
    L_0x0135:
        ...
        r4.addView(r9, r5);
    L_0x013e:
        r4 = new org.telegram.ui.-$$Lambda$PassportActivity$az74Dx11TJywMyS7RnmkdOtTd_Q;
        r4.<init>(r8, r0, r1, r6);
    ...
    public /* synthetic */ void lambda$addField$64$PassportActivity(ArrayList arrayList, TL_secureRequiredType tL_secureRequiredType, boolean z, View view) {
        int i;
        TL_secureRequiredType tL_secureRequiredType2;
        if (arrayList != null) {
            int size = arrayList.size();
        ...
        if (!(secureValueType instanceof TL_secureValueTypePersonalDetails) && !(secureValueType instanceof TL_secureValueTypeAddress)) {
            ...
            if ((z2 || (secureValueType instanceof TL_secureValueTypeEmail)) && getValueByType(tL_secureRequiredType, false) != null) {
                ...
                String str2;
                Builder builder = new Builder(getParentActivity());
                builder.setPositiveButton(LocaleController.getString("OK", NUM), new -$$Lambda$PassportActivity$kbdWZjEbWzdp771-jIbXtinEP_o(this, tL_secureRequiredType, z));
            ...
            builder2.setItems((CharSequence[]) arrayList2.toArray(new CharSequence[0]), new -$$Lambda$PassportActivity$XmDAwRSThNhHZUr1ANhGnZmNrB8(this, tL_secureRequiredType, arrayList, z));
    ...
    public /* synthetic */ void lambda$null$61$PassportActivity(TL_secureRequiredType tL_secureRequiredType, ArrayList arrayList, boolean z, DialogInterface dialogInterface, int i) {
        openTypeActivity(tL_secureRequiredType, (TL_secureRequiredType) arrayList.get(i), arrayList, z);
    }

    public /* synthetic */ void lambda$null$63$PassportActivity(TL_secureRequiredType tL_secureRequiredType, boolean z, DialogInterface dialogInterface, int i) {
        needShowProgress();
        deleteValueInternal(tL_secureRequiredType, null, null, true, new -$$Lambda$7J3LPgacD3LbZtGqatVXuN86YjY(this), new -$$Lambda$PassportActivity$eagO4V1pHcIZkkgas91xE4p9U18(this), z);
    }
    ...
    private void startPhoneVerification(boolean z, String str, Runnable runnable, ErrorRunnable errorRunnable, PassportActivityDelegate passportActivityDelegate) {
        TelephonyManager telephonyManager = (TelephonyManager) ApplicationLoader.applicationContext.getSystemService("phone");
        boolean z2 = true;
        Object obj = (telephonyManager.getSimState() == 1 || telephonyManager.getPhoneType() == 0) ? null : 1;
        Object obj2;
        if (getParentActivity() == null || VERSION.SDK_INT < 23 || obj == null) {
            obj2 = 1;
        } else {
            String str2 = "android.permission.READ_PHONE_STATE";
            obj2 = getParentActivity().checkSelfPermission(str2) == 0 ? 1 : null;
            if (z) {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_account_sendVerifyPhoneCode, new -$$Lambda$PassportActivity$G2baGoNcqgSkil2rxy0T_agogpM(this, str, passportActivityDelegate, tL_account_sendVerifyPhoneCode), 2);
    }

    public /* synthetic */ void lambda$startPhoneVerification$66$PassportActivity(String str, PassportActivityDelegate passportActivityDelegate, TL_account_sendVerifyPhoneCode tL_account_sendVerifyPhoneCode, TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$hLGy5GY7nr8K5LZQ5mUFeMfHUjQ(this, tL_error, str, passportActivityDelegate, tLObject, tL_account_sendVerifyPhoneCode));
    }

    public /* synthetic */ void lambda$null$65$PassportActivity(TL_error tL_error, String str, PassportActivityDelegate passportActivityDelegate, TLObject tLObject, TL_account_sendVerifyPhoneCode tL_account_sendVerifyPhoneCode) {
        String str2 = str;
        if (tL_error == null) {
            HashMap hashMap = new HashMap();
    ...
    private void showEditDoneProgress(boolean z, boolean z2) {
        ...
        if (z && this.doneItem != null) {
            ...
            if (z3) {
                ...
                animatorArr2[0] = ObjectAnimator.ofFloat(this.doneItem.getContentView(), View.SCALE_X, new float[]{0.1f});
                animatorArr2[1] = ObjectAnimator.ofFloat(this.doneItem.getContentView(), View.SCALE_Y, new float[]{0.1f});
                animatorArr2[2] = ObjectAnimator.ofFloat(this.doneItem.getContentView(), View.ALPHA, new float[]{0.0f});
    ...
    public void onTransitionAnimationEnd(boolean z, boolean z2) {
        if (this.presentAfterAnimation != null) {
            AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$OhvfFJsfn1Ho0zPpOd0uc_RHBys(this));
        }
        int i = this.currentActivityType;
        if (i == 5) {
            if (z) {
                ...
                if (i != 17 || chatAttachAlert == null) {
                    if (i == 21) {
                        if (!(getParentActivity() == null || iArr == null || iArr.length == 0 || iArr[0] == 0)) {
                            ...
                            builder.setNegativeButton(LocaleController.getString("PermissionOpenSettings", NUM), new -$$Lambda$PassportActivity$IKarRRXNpKlUS1FtA1cTLG17Uv8(this));
                            builder.setPositiveButton(LocaleController.getString("OK", NUM), null);
                            builder.show();
                        }
            ...
            try {
                ...
                if (generatePicturePath != null) {
                    ...
                    if (VERSION.SDK_INT >= 24) {
                        intent.putExtra(str, FileProvider.getUriForFile(getParentActivity(), "org.telegram.messenger.provider", generatePicturePath));
                        intent.addFlags(2);
                        intent.addFlags(1);
                    } else {
                ...
                if (VERSION.SDK_INT < 23 || getParentActivity().checkSelfPermission(str2) == 0) {
                    ...
                    documentSelectActivity.setDelegate(new DocumentSelectActivityDelegate() {
                        public /* synthetic */ void startMusicSelectActivity(BaseFragment baseFragment) {
                            DocumentSelectActivityDelegate.-CC.$default$startMusicSelectActivity(this, baseFragment);
                        }
    ...
    private boolean checkDiscard() {
        ...
        Builder builder = new Builder(getParentActivity());
        builder.setPositiveButton(LocaleController.getString("PassportDiscard", NUM), new -$$Lambda$PassportActivity$z_5h380GpBKbVqT4qgY94NjsWOs(this));
        builder.setNegativeButton(LocaleController.getString("Cancel", NUM), null);
    ...
    private void processSelectedFiles(ArrayList<SendingMediaInfo> arrayList) {
        if (!arrayList.isEmpty()) {
            ...
            Utilities.globalQueue.postRunnable(new -$$Lambda$PassportActivity$VFUF5NGaIcrb7nCRPLcEDBy1Ens(this, arrayList, this.uploadingFileType, z));
        }
    }
        ...
        for (int i4 = 0; i4 < min; i4++) {
            ...
            if (loadBitmap != null) {
                ...
                if (scaleAndSaveImage != null) {
                    ...
                    saveFile.type = i2;
                    AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$-YJXCeSkHUwUh2fvw2lHGINsRyg(this, saveFile, i2));
                    if (z && obj == null) {
                        try {
                            ...
                            if (recognize != null) {
                                try {
                                    AndroidUtilities.runOnUIThread(new -$$Lambda$PassportActivity$md8Jrv8oe-xPLzjO0J26yy5r9GY(this, recognize));
                                    obj = 1;
                                } catch (Throwable th2) {
                                    th = th2;
                                    obj = 1;
    ...
    public /* synthetic */ void lambda$null$71$PassportActivity(Result result) {
        String str;
        int i = result.type;
        int i2;
        TL_secureRequiredType tL_secureRequiredType;
