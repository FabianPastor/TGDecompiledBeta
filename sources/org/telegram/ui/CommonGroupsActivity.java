...
public class CommonGroupsActivity extends BaseFragment {
    ...
    class C09321 extends ActionBarMenuOnItemClick {
        C09321() {
        }
    ...
    class C09332 implements OnItemClickListener {
        C09332() {
        }
    ...
    class C09343 extends OnScrollListener {
        C09343() {
        }
    ...
    class C09375 implements ThemeDescriptionDelegate {
        C09375() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("GroupsInCommonTitle", C0431R.string.GroupsInCommonTitle));
        this.actionBar.setActionBarMenuOnItemClick(new C09321());
        this.fragmentView = new FrameLayout(context);
        this.fragmentView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        FrameLayout frameLayout = this.fragmentView;
        this.emptyView = new EmptyTextProgressView(context);
        this.emptyView.setText(LocaleController.getString("NoGroupsInCommon", C0431R.string.NoGroupsInCommon));
        ...
        this.listView.setOnItemClickListener(new C09332());
        this.listView.setOnScrollListener(new C09343());
        if (this.loading) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C09375();
