...
public class CommonGroupsActivity extends BaseFragment {
    ...
    class C14891 extends ActionBarMenuOnItemClick {
        C14891() {
        }
    ...
    class C14902 implements OnItemClickListener {
        C14902() {
        }
    ...
    class C14913 extends OnScrollListener {
        C14913() {
        }
    ...
    class C14935 implements ThemeDescriptionDelegate {
        C14935() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C14891());
        ...
        this.listView.setOnItemClickListener(new C14902());
        this.listView.setOnScrollListener(new C14913());
        if (this.loading) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C14935();
