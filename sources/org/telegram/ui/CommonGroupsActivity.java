...
public class CommonGroupsActivity extends BaseFragment {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        view = this.listView;
        Class[] clsArr = new Class[]{ProfileSearchCell.class};
        r5 = new Paint[3];
        TextPaint[] textPaintArr = Theme.dialogs_namePaint;
        r5[0] = textPaintArr[0];
        r5[1] = textPaintArr[1];
        r5[2] = Theme.dialogs_searchNamePaint;
        r10[14] = new ThemeDescription(view, 0, clsArr, null, r5, null, null, "chats_name");
        view = this.listView;
        clsArr = new Class[]{ProfileSearchCell.class};
        r2 = new Paint[3];
        TextPaint[] textPaintArr2 = Theme.dialogs_nameEncryptedPaint;
        r2[0] = textPaintArr2[0];
        r2[1] = textPaintArr2[1];
        r2[2] = Theme.dialogs_searchNameEncryptedPaint;
        r10[15] = new ThemeDescription(view, 0, clsArr, null, r2, null, null, "chats_secretName");
