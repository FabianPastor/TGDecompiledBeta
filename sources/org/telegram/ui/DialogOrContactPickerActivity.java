...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public /* synthetic */ void m2066lambda$new$1$orgtelegramuiDialogOrContactPickerActivity(DialogsActivity fragment, ArrayList dids, CharSequence message, boolean param) {
        if (!dids.isEmpty()) {
    ...
    public /* synthetic */ void m2067lambda$new$2$orgtelegramuiDialogOrContactPickerActivity(TLRPC.User user, String param, ContactsActivity activity) {
        showBlockAlert(user);
    }
    ...
    public /* synthetic */ void m2068x7CLASSNAMECLASSNAME(TLRPC.User user, DialogInterface dialogInterface, int i) {
