...
public class NewContactActivity extends BaseFragment implements OnItemSelectedListener {
    ...
    public android.view.View createView(android.content.Context r23) {
        ...
        r6 = NUM; // 0x7var_d float:1.7945124E38 double:1.052935636E-314;
        r2 = r2.addItemWithWidth(r3, r6, r4);
        r1.editDoneItem = r2;
        r2 = r1.editDoneItem;
        r4 = "Done";
        r6 = NUM; // 0x7f0e03d7 float:1.8877031E38 double:1.0531626423E-314;
        ...
        r4 = r1.firstNameField;
        r13 = "FirstName";
        r14 = NUM; // 0x7f0e04b2 float:1.8877475E38 double:1.0531627505E-314;
        ...
        r4 = r1.lastNameField;
        r5 = "LastName";
        r15 = NUM; // 0x7f0e05aa float:1.8877978E38 double:1.053162873E-314;
    ...
    L_0x04b1:
        r0 = r1.countryButton;
        r2 = NUM; // 0x7f0e02e0 float:1.887653E38 double:1.0531625203E-314;
        r5 = "ChooseCountry";
