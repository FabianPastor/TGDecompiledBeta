...
public class NewContactActivity extends BaseFragment implements OnItemSelectedListener {
    ...
    public android.view.View createView(android.content.Context r23) {
        ...
        r2 = r1.actionBar;
        r4 = "AddContactTitle";
        r5 = NUM; // 0x7f0e00b1 float:1.8875397E38 double:1.053162244E-314;
        ...
        r6 = NUM; // 0x7var_f float:1.7945128E38 double:1.052935637E-314;
        r2 = r2.addItemWithWidth(r3, r6, r4);
        r1.editDoneItem = r2;
        r2 = r1.editDoneItem;
        r4 = "Done";
        r6 = NUM; // 0x7f0e03e2 float:1.8877054E38 double:1.0531626477E-314;
        ...
        r4 = r1.firstNameField;
        r13 = "FirstName";
        r14 = NUM; // 0x7f0e04bf float:1.8877502E38 double:1.053162757E-314;
        ...
        r4 = r1.lastNameField;
        r5 = "LastName";
        r15 = NUM; // 0x7f0e05b9 float:1.8878009E38 double:1.0531628804E-314;
    ...
    L_0x04b1:
        r0 = r1.countryButton;
        r2 = NUM; // 0x7f0e02e3 float:1.8876536E38 double:1.0531625217E-314;
        r5 = "ChooseCountry";
