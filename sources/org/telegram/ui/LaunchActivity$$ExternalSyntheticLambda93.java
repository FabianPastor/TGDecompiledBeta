...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda93 implements AlertsCreator.AccountSelectDelegate {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda93(LaunchActivity launchActivity, int i, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, String str9, boolean z, Integer num, Long l, Integer num2, Integer num3, String str10, HashMap hashMap, String str11, String str12, String str13, String str14, TLRPC$TL_wallPaper tLRPC$TL_wallPaper, String str15, String str16, String str17, String str18, int i2, String str19, String str20, String str21) {
    ...
    public final void didSelectAccount(int i) {
        ...
        launchActivity2.lambda$runLinkRequest$30(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12, this.f$13, this.f$14, this.f$15, this.f$16, this.f$17, this.f$18, this.f$19, this.f$20, this.f$21, this.f$22, this.f$23, this.f$24, this.f$25, this.f$26, this.f$27, this.f$28, this.f$29, this.f$30, i2);
    }
}
