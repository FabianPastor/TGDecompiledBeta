...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, ContactsActivity.ContactsActivityDelegate {
    ...
    public /* synthetic */ void m3680lambda$createView$1$orgtelegramuiPrivacyUsersActivity(View view, int position) {
    ...
    public /* synthetic */ void m3679lambda$createView$0$orgtelegramuiPrivacyUsersActivity(ArrayList ids) {
    ...
    public /* synthetic */ boolean m3681lambda$createView$2$orgtelegramuiPrivacyUsersActivity(View view, int position) {
    ...
    public /* synthetic */ void m3683lambda$showUnblockAlert$3$orgtelegramuiPrivacyUsersActivity(Long uid, DialogInterface dialogInterface, int i) {
        if (i != 0) {
            return;
        }
        if (this.currentType == 1) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ boolean m3684xd7d3d381(ManageChatUserCell cell, boolean click) {
            if (!click) {
                return true;
            }
    ...
    public /* synthetic */ void m3682xCLASSNAME() {
        RecyclerListView recyclerListView = this.listView;
        if (recyclerListView != null) {
            int count = recyclerListView.getChildCount();
            for (int a = 0; a < count; a++) {
