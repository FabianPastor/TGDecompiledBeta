...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItemWithWidth(int id, Drawable drawable, int width, CharSequence title) {
        return addItem(id, 0, (CharSequence) null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, drawable, width, title);
    }
    ...
    public /* synthetic */ void m2535lambda$addItem$0$orgtelegramuiActionBarActionBarMenu(View view) {
