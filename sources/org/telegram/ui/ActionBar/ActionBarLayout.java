...
public class ActionBarLayout extends FrameLayout {
    ...
    public class LayoutContainer extends FrameLayout {
        ...
        public boolean dispatchTouchEvent(android.view.MotionEvent r6) {
            ...
            L_0x0030:
                ...
                org.telegram.ui.ActionBar.ActionBarLayout r3 = org.telegram.ui.ActionBar.ActionBarLayout.this     // Catch:{ all -> 0x0041 }
                org.telegram.ui.ActionBar.ActionBarLayout$LayoutContainer r3 = r3.containerView     // Catch:{ all -> 0x0041 }
                if (r5 == r3) goto L_0x003f
            L_0x0038:
                boolean r3 = super.dispatchTouchEvent(r6)     // Catch:{ all -> 0x0041 }
        ...
        public void processMenuButtonsTouch(MotionEvent event) {
            if (event.getAction() == 0) {
                ...
                if (!this.allowToPressByHover && Math.sqrt(Math.pow((double) (this.pressX - event.getX()), 2.0d) + Math.pow((double) (this.pressY - event.getY()), 2.0d)) > ((double) AndroidUtilities.dp(30.0f))) {
            ...
            if (event.getAction() == 1 || event.getAction() == 3) {
                if (ActionBarLayout.this.previewMenu != null && ActionBarLayout.this.highlightActionButtons) {
                    ...
                    ValueAnimator arrowAlphaUpdate = ValueAnimator.ofFloat(new float[]{(float) alpha, 0.0f});
                    arrowAlphaUpdate.addUpdateListener(new ActionBarLayout$LayoutContainer$$ExternalSyntheticLambda0(this));
                    arrowAlphaUpdate.setDuration(150);
                    arrowAlphaUpdate.setInterpolator(CubicBezierInterpolator.DEFAULT);
                    arrowAlphaUpdate.start();
                    ObjectAnimator containerTranslationUpdate = ObjectAnimator.ofFloat(ActionBarLayout.this.containerView, View.TRANSLATION_Y, new float[]{0.0f});
        ...
        /* renamed from: lambda$processMenuButtonsTouch$0$org-telegram-ui-ActionBar-ActionBarLayout$LayoutContainer  reason: not valid java name */
        public /* synthetic */ void m2534xb0129fab(ValueAnimator a) {
    ...
    public boolean presentFragmentAsPreview(BaseFragment fragment) {
        return presentFragment(fragment, false, false, true, true, (ActionBarPopupWindow.ActionBarPopupWindowLayout) null);
    }
    ...
    public boolean presentFragment(BaseFragment fragment) {
        return presentFragment(fragment, false, false, true, false, (ActionBarPopupWindow.ActionBarPopupWindowLayout) null);
    }

    public boolean presentFragment(BaseFragment fragment, boolean removeLast) {
        return presentFragment(fragment, removeLast, false, true, false, (ActionBarPopupWindow.ActionBarPopupWindowLayout) null);
    }
        ...
        AnonymousClass2 r0 = new Runnable() {
            public void run() {
                ...
                if (ActionBarLayout.this.animationRunnable == this) {
                    ...
                    ActionBarLayout.access$1216(ActionBarLayout.this, ((float) dt) / ((!preview || !open) ? 150.0f : 190.0f));
                    ...
                    if (!preview) {
                        ...
                        interpolated = ActionBarLayout.this.overshootInterpolator.getInterpolation(ActionBarLayout.this.animationProgress);
                    } else {
                        interpolated = CubicBezierInterpolator.EASE_OUT_QUINT.getInterpolation(ActionBarLayout.this.animationProgress);
                    }
                    if (open) {
                        ...
                        if (preview) {
                            ...
                            if (ActionBarLayout.this.previewMenu != null) {
                                ActionBarLayout.this.containerView.setTranslationY(((float) AndroidUtilities.dp(40.0f)) * (1.0f - interpolated));
                                ActionBarLayout.this.previewMenu.setTranslationY(((float) (-AndroidUtilities.dp(70.0f))) * (1.0f - interpolated));
    ...
    public boolean presentFragment(BaseFragment fragment, boolean removeLast, boolean forceWithoutAnimation, boolean check, boolean preview) {
        return presentFragment(fragment, removeLast, forceWithoutAnimation, check, preview, (ActionBarPopupWindow.ActionBarPopupWindowLayout) null);
    }

    public boolean presentFragment(BaseFragment fragment, boolean removeLast, boolean forceWithoutAnimation, boolean check, boolean preview, ActionBarPopupWindow.ActionBarPopupWindowLayout menu) {
        View fragmentView;
        int menuHeight;
        boolean z;
        ...
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = menu;
        if (baseFragment == null || checkTransitionAnimation()) {
            return false;
        }
        ActionBarLayoutDelegate actionBarLayoutDelegate = this.delegate;
        if ((actionBarLayoutDelegate != null && check && !actionBarLayoutDelegate.needPresentFragment(baseFragment, z4, z5, this)) || !fragment.onFragmentCreate()) {
            return false;
        }
        ...
        baseFragment.setInPreviewMode(z6);
        ...
        BaseFragment currentFragment = baseFragment2;
        baseFragment.setParentLayout(this);
        View fragmentView2 = baseFragment.fragmentView;
        if (fragmentView2 == null) {
            fragmentView = baseFragment.createView(this.parentActivity);
        } else {
        ...
        if (actionBarPopupWindowLayout != null) {
            ...
            actionBarPopupWindowLayout.setLayoutParams(menuParams);
        ...
        if (baseFragment.actionBar != null && baseFragment.actionBar.shouldAddToContainer()) {
            if (this.removeActionBarExtraHeight) {
                baseFragment.actionBar.setOccupyStatusBar(false);
            }
            ViewGroup parent2 = (ViewGroup) baseFragment.actionBar.getParent();
            if (parent2 != null) {
                parent2.removeView(baseFragment.actionBar);
            }
        ...
        if (needAnimation || z6) {
            LayoutContainer layoutContainer2 = temp;
            if (!this.useAlphaAnimations || this.fragmentsStack.size() != 1) {
                ...
                boolean z7 = !fragment.needDelayOpenAnimation();
                final boolean noDelay = z7;
                if (z7) {
                    ...
                    baseFragment.onTransitionAnimationStart(true, z);
                } else {
                    z = false;
                }
                ...
                if (!z6) {
                    animation = baseFragment.onCustomTransitionAnimation(true, new ActionBarLayout$$ExternalSyntheticLambda1(this));
                } else {
                    animation = null;
                }
                if (animation == null) {
                        ...
                        public void run() {
                            if (ActionBarLayout.this.waitingForKeyboardCloseRunnable == this) {
                                ...
                                if (noDelay) {
                                    ...
                                    ActionBarLayout.this.startLayoutAnimation(true, true, z8);
            ...
            this.transitionAnimationInProgress = true;
            this.layoutToIgnore = this.containerView;
            this.onOpenAnimationEndRunnable = new ActionBarLayout$$ExternalSyntheticLambda5(currentFragment, baseFragment);
            ...
            baseFragment.onTransitionAnimationStart(true, z2);
            AnimatorSet animatorSet = new AnimatorSet();
            ...
            View view5 = wrappedView;
            View view6 = fragmentView;
        ...
        baseFragment.onTransitionAnimationStart(true, z3);
        baseFragment.onTransitionAnimationEnd(true, z3);
        fragment.onBecomeFullyVisible();
        FrameLayout.LayoutParams layoutParams4 = layoutParams;
        View view8 = wrappedView;
        View view9 = fragmentView;
        LayoutContainer layoutContainer3 = temp;
    ...
    public /* synthetic */ void m2532xd7da5798(boolean preview, ActionBarPopupWindow.ActionBarPopupWindowLayout menu, boolean removeLast, BaseFragment currentFragment, BaseFragment fragment) {
        if (preview) {
    ...
    public /* synthetic */ void m2533xbd1bCLASSNAME() {
    ...
    public void closeLastFragment(boolean animated, boolean forceNoAnimation) {
        ...
        if ((actionBarLayoutDelegate == null || actionBarLayoutDelegate.needCloseLastFragment(this)) && !checkTransitionAnimation() && !this.fragmentsStack.isEmpty()) {
            ...
            if (previousFragment != null) {
                ...
                if (view2 != null) {
                    animators.add(ObjectAnimator.ofFloat(view2, View.ALPHA, new float[]{1.0f, 0.0f}));
                }
                AnimatorSet animatorSet = new AnimatorSet();
                this.currentAnimation = animatorSet;
                animatorSet.playTogether(animators);
    ...
    public /* synthetic */ void m2529x789344cd(BaseFragment currentFragment, BaseFragment previousFragmentFinal) {
        ViewGroup parent;
