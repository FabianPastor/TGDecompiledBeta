...
public class ActionBarLayout extends FrameLayout {
    ...
    class C05843 extends ViewOutlineProvider {
        C05843() {
        }
    ...
    class C05854 extends AnimatorListenerAdapter {
        C05854() {
        }
    ...
    class C05887 implements Runnable {
        C05887() {
        }
    ...
    class C05898 extends AnimatorListenerAdapter {
        C05898() {
        }
    ...
    class C05909 extends AnimatorListenerAdapter {
        C05909() {
        }
    ...
    public ActionBarLayout(Context context) {
        ...
        if (layerShadowDrawable == null) {
            layerShadowDrawable = getResources().getDrawable(C0431R.drawable.layer_shadow);
            headerShadowDrawable = getResources().getDrawable(C0431R.drawable.header_shadow).mutate();
    ...
    private void startLayoutAnimation(final boolean open, final boolean first, final boolean preview) {
        ...
        this.animationRunnable = c05832;
        AndroidUtilities.runOnUIThread(c05832);
    }
    ...
    public boolean presentFragment(BaseFragment fragment, boolean removeLast, boolean forceWithoutAnimation, boolean check, boolean preview) {
        ...
        if (preview) {
            if (VERSION.SDK_INT >= 21) {
                fragmentView.setOutlineProvider(new C05843());
        ...
        if (!needAnimation && !preview) {
            ...
            this.currentAnimation.addListener(new C05854());
            ...
            if (previousFragment != null) {
                ...
                if (needAnimation) {
                    ...
                    if (animation != null) {
                        ...
                        this.waitingForKeyboardCloseRunnable = new C05887();
                        AndroidUtilities.runOnUIThread(this.waitingForKeyboardCloseRunnable, 200);
                        return;
                    } else {
                ...
                this.currentAnimation.setInterpolator(this.accelerateDecelerateInterpolator);
                this.currentAnimation.setDuration(200);
                this.currentAnimation.addListener(new C05898());
                this.currentAnimation.start();
            } else {
    ...
    public void animateThemedValues(ThemeInfo theme) {
        ...
        if (startAnimation) {
            ...
            this.themeAnimatorSet.addListener(new C05909());
