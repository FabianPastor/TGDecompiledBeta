...
public final /* synthetic */ class Theme$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ Theme$$ExternalSyntheticLambda5(TLObject tLObject, Theme.ThemeAccent themeAccent, Theme.ThemeInfo themeInfo, TLRPC$TL_theme tLRPC$TL_theme) {
        this.f$0 = tLObject;
    ...
    public final void run() {
        Theme.lambda$checkCurrentRemoteTheme$6(this.f$0, this.f$1, this.f$2, this.f$3);
    }
}
