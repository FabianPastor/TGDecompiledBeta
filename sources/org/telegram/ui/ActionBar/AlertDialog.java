...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public /* synthetic */ void m1309lambda$new$0$orgtelegramuiActionBarAlertDialog() {
        if (!isShowing()) {
            try {
                show();
            } catch (Exception e) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            public /* synthetic */ void m1317lambda$onMeasure$0$orgtelegramuiActionBarAlertDialog$1() {
                int maxWidth;
            ...
            public /* synthetic */ void m1316lambda$onLayout$1$orgtelegramuiActionBarAlertDialog$1() {
        ...
        if (hasButtons) {
            if (!this.verticalButtons) {
                ...
                if (buttonsWidth > AndroidUtilities.dp(320.0f)) {
            ...
            if (this.positiveButtonText != null) {
                ...
                textView6.setOnClickListener(new AlertDialog$$ExternalSyntheticLambda3(this));
            }
            if (this.negativeButtonText != null) {
                ...
                textView7.setOnClickListener(new AlertDialog$$ExternalSyntheticLambda4(this));
            }
            if (this.neutralButtonText != null) {
                ...
                textView8.setOnClickListener(new AlertDialog$$ExternalSyntheticLambda5(this));
            }
            if (this.verticalButtons) {
    ...
    public /* synthetic */ void m1310lambda$onCreate$1$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m1311lambda$onCreate$2$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m1312lambda$onCreate$3$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m1313lambda$onCreate$4$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m1314lambda$showCancelAlert$5$orgtelegramuiActionBarAlertDialog(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m1315lambda$showCancelAlert$6$orgtelegramuiActionBarAlertDialog(DialogInterface dialog) {
