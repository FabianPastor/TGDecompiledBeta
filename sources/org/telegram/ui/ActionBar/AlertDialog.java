...
public class AlertDialog extends Dialog implements Callback {
    ...
    public AlertDialog(Context context, int progressStyle) {
        ...
        this.shadowDrawable = context.getResources().getDrawable(C0431R.drawable.popup_fixed_alert).mutate();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!(this.topResId == 0 && this.topDrawable == null)) {
            ...
            this.topImageView.setBackgroundDrawable(getContext().getResources().getDrawable(C0431R.drawable.popup_fixed_top));
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C0431R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C0431R.drawable.header_shadow_reverse).mutate();
