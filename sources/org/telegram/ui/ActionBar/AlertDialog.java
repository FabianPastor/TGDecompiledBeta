...
public class AlertDialog extends Dialog implements Drawable.Callback {
    ...
    public /* synthetic */ void m2552lambda$new$0$orgtelegramuiActionBarAlertDialog() {
        if (!isShowing()) {
            try {
                show();
            } catch (Exception e) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            public /* synthetic */ void m2560lambda$onMeasure$0$orgtelegramuiActionBarAlertDialog$1() {
                int maxWidth;
            ...
            public /* synthetic */ void m2559lambda$onLayout$1$orgtelegramuiActionBarAlertDialog$1() {
        ...
        if (hasButtons) {
                        ...
                        if (totalWidth > availableWidth) {
                            ...
                            if (negative != null && neutral != null) {
                                if (negative.getMeasuredWidth() < neutral.getMeasuredWidth()) {
                                    neutral.measure(View.MeasureSpec.makeMeasureSpec(neutral.getMeasuredWidth() - (totalWidth - availableWidth), NUM), View.MeasureSpec.makeMeasureSpec(neutral.getMeasuredHeight(), NUM));
                                } else {
            ...
            if (this.neutralButtonText != null) {
                ...
                textView7.setBackground(Theme.getRoundRectSelectorDrawable(getThemedColor(this.dialogButtonColorKey)));
    ...
    public /* synthetic */ void m2553lambda$onCreate$1$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m2554lambda$onCreate$2$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m2555lambda$onCreate$3$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m2556lambda$onCreate$4$orgtelegramuiActionBarAlertDialog(View v) {
    ...
    public /* synthetic */ void m2557lambda$showCancelAlert$5$orgtelegramuiActionBarAlertDialog(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m2558lambda$showCancelAlert$6$orgtelegramuiActionBarAlertDialog(DialogInterface dialog) {
