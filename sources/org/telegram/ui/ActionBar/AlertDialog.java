...
public class AlertDialog extends Dialog implements Callback {
    ...
    private Runnable dismissRunnable = new C09041();
    ...
    class C09094 implements View.OnClickListener {
        C09094() {
        }
    ...
    class C09127 implements View.OnClickListener {
        C09127() {
        }
    ...
    class C09149 implements View.OnClickListener {
        C09149() {
        }
    ...
    public AlertDialog(Context context, int progressStyle) {
        ...
        this.shadowDrawable = context.getResources().getDrawable(C0505R.drawable.popup_fixed_alert).mutate();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            class C09062 implements OnScrollChangedListener {
                C09062() {
                }
            ...
            protected void onLayout(boolean changed, int l, int t, int r, int b) {
                ...
                if (AlertDialog.this.contentScrollView != null) {
                    if (AlertDialog.this.onScrollChangedListener == null) {
                        AlertDialog.this.onScrollChangedListener = new C09062();
        ...
        if (!(this.topResId == 0 && this.topDrawable == null)) {
            ...
            this.topImageView.setBackgroundDrawable(getContext().getResources().getDrawable(C0505R.drawable.popup_fixed_top));
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C0505R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C0505R.drawable.header_shadow_reverse).mutate();
        ...
        if (this.items != null) {
            ...
            while (a < this.items.length) {
                if (this.items[a] != null) {
                    ...
                    cell.setOnClickListener(new C09094());
                }
                a++;
            }
        }
        ...
        if (hasButtons) {
            ...
            if (this.positiveButtonText != null) {
                ...
                radialProgressView.setOnClickListener(new C09127());
            }
            if (this.negativeButtonText != null) {
                ...
                radialProgressView.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
                this.buttonsLayout.addView(radialProgressView, LayoutHelper.createFrame(-2, 36, 53));
                radialProgressView.setOnClickListener(new C09149());
            }
