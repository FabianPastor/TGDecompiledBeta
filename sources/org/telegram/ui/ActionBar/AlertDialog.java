...
public class AlertDialog extends Dialog implements Callback {
    ...
    private Runnable dismissRunnable = new C08991();
    ...
    class C09044 implements View.OnClickListener {
        C09044() {
        }
    ...
    class C09077 implements View.OnClickListener {
        C09077() {
        }
    ...
    class C09099 implements View.OnClickListener {
        C09099() {
        }
    ...
    public AlertDialog(Context context, int progressStyle) {
        ...
        this.shadowDrawable = context.getResources().getDrawable(C0501R.drawable.popup_fixed_alert).mutate();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout containerView = new LinearLayout(getContext()) {
            ...
            class C09012 implements OnScrollChangedListener {
                C09012() {
                }
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (AlertDialog.this.lastScreenWidth != AndroidUtilities.displaySize.x) {
                    AndroidUtilities.runOnUIThread(new C09001());
                }
            }
            ...
            protected void onLayout(boolean changed, int l, int t, int r, int b) {
                ...
                if (AlertDialog.this.contentScrollView != null) {
                    if (AlertDialog.this.onScrollChangedListener == null) {
                        AlertDialog.this.onScrollChangedListener = new C09012();
        ...
        if (!(this.topResId == 0 && this.topDrawable == null)) {
            ...
            this.topImageView.setBackgroundDrawable(getContext().getResources().getDrawable(C0501R.drawable.popup_fixed_top));
        ...
        if (this.progressViewStyle == 0) {
            this.shadow[0] = (BitmapDrawable) getContext().getResources().getDrawable(C0501R.drawable.header_shadow).mutate();
            this.shadow[1] = (BitmapDrawable) getContext().getResources().getDrawable(C0501R.drawable.header_shadow_reverse).mutate();
        ...
        if (this.items != null) {
            ...
            while (a < this.items.length) {
                if (this.items[a] != null) {
                    ...
                    cell.setOnClickListener(new C09044());
                }
                a++;
            }
        }
        ...
        if (hasButtons) {
            ...
            if (this.positiveButtonText != null) {
                ...
                radialProgressView.setOnClickListener(new C09077());
            }
            if (this.negativeButtonText != null) {
                ...
                radialProgressView.setPadding(AndroidUtilities.dp(10.0f), 0, AndroidUtilities.dp(10.0f), 0);
                this.buttonsLayout.addView(radialProgressView, LayoutHelper.createFrame(-2, 36, 53));
                radialProgressView.setOnClickListener(new C09099());
            }
