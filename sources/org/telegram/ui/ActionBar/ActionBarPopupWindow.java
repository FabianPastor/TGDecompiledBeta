...
public class ActionBarPopupWindow extends PopupWindow {
    private static final OnScrollChangedListener NOP = new C07651();
    ...
    static class C07651 implements OnScrollChangedListener {
        C07651() {
        }
    ...
    class C07662 implements AnimatorListener {
        C07662() {
        }
    ...
    class C07673 implements AnimatorListener {
        C07673() {
        }
    ...
    public void startAnimation() {
        if (this.animationEnabled && this.windowAnimatorSet == null) {
            ...
            this.windowAnimatorSet.addListener(new C07662());
    ...
    public void dismiss(boolean animated) {
        ...
        if (this.animationEnabled && animated) {
            ...
            this.windowAnimatorSet.addListener(new C07673());
            this.windowAnimatorSet.start();
            return;
        }
        try {
