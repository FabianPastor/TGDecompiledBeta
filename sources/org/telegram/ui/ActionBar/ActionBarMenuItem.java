...
public class ActionBarMenuItem extends FrameLayout {
    ...
    class C04803 implements Callback {
        C04803() {
        }
    ...
    class C04814 implements TextWatcher {
        C04814() {
        }
        ...
        if (this.parentMenu != null) {
            if (value && this.searchContainer == null) {
                ...
                if (VERSION.SDK_INT < 23) {
                    this.searchField.setCustomSelectionActionModeCallback(new C04803());
                }
                this.searchField.setOnEditorActionListener(new ActionBarMenuItem$$Lambda$6(this));
                this.searchField.addTextChangedListener(new C04814());
