...
public class BottomSheet extends Dialog {
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        private void checkDismiss(float velX, float velY) {
            ...
            ValueAnimator invalidateContainer = ValueAnimator.ofFloat(new float[]{0.0f, 1.0f});
            invalidateContainer.addUpdateListener(new BottomSheet$ContainerView$$ExternalSyntheticLambda0(this));
            this.currentAnimation.playTogether(new Animator[]{ObjectAnimator.ofFloat(BottomSheet.this.containerView, "translationY", new float[]{0.0f}), invalidateContainer});
        ...
        /* renamed from: lambda$checkDismiss$0$org-telegram-ui-ActionBar-BottomSheet$ContainerView  reason: not valid java name */
        public /* synthetic */ void m2569x6CLASSNAMEdvar_(ValueAnimator a) {
        ...
        public void onMeasure(int r17, int r18) {
            /*
                ...
                r2 = r1
                android.view.View r7 = r16.getRootView()
            ...
            L_0x0183:
                org.telegram.ui.ActionBar.BottomSheet r0 = org.telegram.ui.ActionBar.BottomSheet.this
                boolean r2 = r0.isPortrait
                int r0 = r0.getBottomSheetWidth(r2, r11, r13)
                org.telegram.ui.ActionBar.BottomSheet r2 = org.telegram.ui.ActionBar.BottomSheet.this
                int r2 = r2.backgroundPaddingLeft
                int r2 = r2 * 2
                int r0 = r0 + r2
            ...
            L_0x01d3:
                org.telegram.ui.ActionBar.BottomSheet r0 = org.telegram.ui.ActionBar.BottomSheet.this
                boolean r0 = r0.onCustomMeasure(r15, r11, r13)
                if (r0 != 0) goto L_0x01eb
                int r2 = android.view.View.MeasureSpec.makeMeasureSpec(r11, r9)
                r3 = 0
                int r4 = android.view.View.MeasureSpec.makeMeasureSpec(r13, r9)
                r5 = 0
                r0 = r16
                r1 = r15
        ...
        public void onLayout(boolean changed, int left, int top, int right, int bottom) {
            ...
            if (BottomSheet.this.containerView != null) {
                ...
                if (BottomSheet.this.smoothKeyboardAnimationEnabled && BottomSheet.this.startAnimationRunnable == null && this.keyboardChanged && !BottomSheet.this.dismissed && BottomSheet.this.containerView.getTop() != t) {
                    ...
                    BottomSheet.this.keyboardContentAnimator.addUpdateListener(new BottomSheet$ContainerView$$ExternalSyntheticLambda1(this));
        ...
        /* renamed from: lambda$onLayout$1$org-telegram-ui-ActionBar-BottomSheet$ContainerView  reason: not valid java name */
        public /* synthetic */ void m2570x8219var_f(ValueAnimator valueAnimator) {
        ...
        public void drawNavigationBar(Canvas canvas, float alpha) {
            ...
            if ((BottomSheet.this.drawNavigationBar && BottomSheet.this.bottomInset != 0) || BottomSheet.this.currentPanTranslationY != 0.0f) {
                ...
                int navBarHeight = BottomSheet.this.drawNavigationBar ? BottomSheet.this.getBottomInset() : 0;
                if (BottomSheet.this.scrollNavBar || (Build.VERSION.SDK_INT >= 29 && BottomSheet.this.getAdditionalMandatoryOffsets() > 0)) {
                    translation = BottomSheet.this.drawDoubleNavigationBar ? Math.max(0.0f, Math.min(((float) navBarHeight) - BottomSheet.this.currentPanTranslationY, BottomSheet.this.containerView.getTranslationY())) : Math.max(0.0f, ((float) BottomSheet.this.getBottomInset()) - (((float) BottomSheet.this.containerView.getMeasuredHeight()) - BottomSheet.this.containerView.getTranslationY()));
                }
                int wasAlpha = this.backgroundPaint.getAlpha();
                if (alpha < 1.0f) {
                    this.backgroundPaint.setAlpha((int) (((float) wasAlpha) * alpha));
                }
                ...
                if (BottomSheet.this.overlayDrawNavBarColor != 0) {
                    ...
                    if (alpha < 1.0f) {
                        this.backgroundPaint.setAlpha((int) (((float) wasAlpha2) * alpha));
                        translation = 0.0f;
                    }
                    canvas.drawRect((float) (BottomSheet.this.containerView.getLeft() + BottomSheet.this.backgroundPaddingLeft), (((float) (getMeasuredHeight() - navBarHeight)) + translation) - BottomSheet.this.currentPanTranslationY, (float) (BottomSheet.this.containerView.getRight() - BottomSheet.this.backgroundPaddingLeft), ((float) getMeasuredHeight()) + translation, this.backgroundPaint);
    ...
    /* access modifiers changed from: protected */
    public int getBottomSheetWidth(boolean isPortrait2, int width, int height) {
        return isPortrait2 ? width : (int) Math.max(((float) width) * 0.8f, (float) Math.min(AndroidUtilities.dp(480.0f), width));
    }
    ...
    public void setHideSystemVerticalInsets(boolean hideSystemVerticalInsets) {
        ...
        animator.addUpdateListener(new BottomSheet$$ExternalSyntheticLambda1(this));
        animator.start();
    }

    /* renamed from: lambda$setHideSystemVerticalInsets$0$org-telegram-ui-ActionBar-BottomSheet  reason: not valid java name */
    public /* synthetic */ void m2565x3bf1CLASSNAME(ValueAnimator animation) {
    ...
    public /* synthetic */ WindowInsets m2563lambda$new$1$orgtelegramuiActionBarBottomSheet(View v, WindowInsets insets) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int topOffset = 0;
        if (this.title != null) {
            AnonymousClass4 r8 = new TextView(getContext()) {
                /* access modifiers changed from: protected */
                public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                    ...
                    if (BottomSheet.this.multipleLinesTitle) {
                        ...
                        if (BottomSheet.this.customView != null) {
                            ((ViewGroup.MarginLayoutParams) BottomSheet.this.customView.getLayoutParams()).topMargin = topOffset;
                            ...
                            for (int i = 1; i < BottomSheet.this.containerView.getChildCount(); i++) {
                                ...
                                if (child instanceof BottomSheetCell) {
                                    ...
                                    topOffset += AndroidUtilities.dp(48.0f);
                                }
                            }
                        }
                    }
        ...
        if (view != null) {
            ...
            if (!this.useBackgroundTopPadding) {
                ...
                this.containerView.addView(this.customView, LayoutHelper.createFrame(-1, -2.0f, 51, 0.0f, (float) ((-this.backgroundPaddingTop) + topOffset), 0.0f, 0.0f));
            } else {
            ...
            while (true) {
                ...
                if (charSequenceArr[a] != null) {
                    ...
                    cell.setOnClickListener(new BottomSheet$$ExternalSyntheticLambda4(this));
    ...
    public /* synthetic */ void m2564lambda$onCreate$3$orgtelegramuiActionBarBottomSheet(View v) {
    ...
    /* renamed from: lambda$startOpenAnimation$4$org-telegram-ui-ActionBar-BottomSheet  reason: not valid java name */
    public /* synthetic */ void m2566x1fb6af0f(ValueAnimator a) {
    ...
    public void dismissWithButtonClick(final int item) {
        if (!this.dismissed) {
            ...
            this.currentSheetAnimation.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m2567lambda$onAnimationEnd$0$orgtelegramuiActionBarBottomSheet$7() {
        ...
        if ((bottomSheetDelegateInterface == null || bottomSheetDelegateInterface.canDismiss()) && !this.dismissed) {
            ...
            if (!this.allowCustomAnimation || !onCustomCloseAnimation()) {
                ...
                this.currentSheetAnimation.addListener(new AnimatorListenerAdapter() {
                    ...
                    /* renamed from: lambda$onAnimationEnd$0$org-telegram-ui-ActionBar-BottomSheet$8  reason: not valid java name */
                    public /* synthetic */ void m2568lambda$onAnimationEnd$0$orgtelegramuiActionBarBottomSheet$8() {
                        try {
                            BottomSheet.this.dismissInternal();
                        } catch (Exception e) {
                            FileLog.e((Throwable) e);
    ...
    /* renamed from: lambda$dismiss$5$org-telegram-ui-ActionBar-BottomSheet  reason: not valid java name */
    public /* synthetic */ void m2562lambda$dismiss$5$orgtelegramuiActionBarBottomSheet(ValueAnimator a) {
        this.navigationBarAlpha = ((Float) a.getAnimatedValue()).floatValue();
        ContainerView containerView2 = this.container;
        if (containerView2 != null) {
            containerView2.invalidate();
    ...
    public static class Builder {
        ...
        public Builder(Context context, int bgColor) {
            this(context, false, (Theme.ResourcesProvider) null, bgColor);
        }
        ...
        public Builder(Context context, boolean needFocus, int bgColor) {
            this(context, needFocus, (Theme.ResourcesProvider) null, bgColor);
        }

        public Builder(Context context, boolean needFocus, Theme.ResourcesProvider resourcesProvider) {
            BottomSheet bottomSheet2 = new BottomSheet(context, needFocus, resourcesProvider);
        ...
        public Builder(Context context, boolean needFocus, Theme.ResourcesProvider resourcesProvider, int bgColor) {
            BottomSheet bottomSheet2 = new BottomSheet(context, needFocus, resourcesProvider);
            this.bottomSheet = bottomSheet2;
            bottomSheet2.setBackgroundColor(bgColor);
        ...
        public Builder setTitleMultipleLines(boolean allowMultipleLines) {
            boolean unused = this.bottomSheet.multipleLinesTitle = allowMultipleLines;
            return this;
        }
