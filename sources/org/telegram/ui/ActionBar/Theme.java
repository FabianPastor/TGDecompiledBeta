...
public class Theme {
    ...
    private static Runnable switchDayBrightnessRunnable = new C07521();
    private static boolean switchDayRunnableScheduled;
    private static Runnable switchNightBrightnessRunnable = new C07532();
    ...
    static class C07521 implements Runnable {
        C07521() {
        }
    ...
    static class C07532 implements Runnable {
        C07532() {
        }
    ...
    static class C07543 implements Runnable {
        C07543() {
        }
    ...
    static class C07554 extends StateListDrawable {
        C07554() {
        }
    ...
    static class C07565 extends StateListDrawable {
        C07565() {
        }
    ...
    static class C07576 extends StateListDrawable {
        C07576() {
        }
    ...
    static class C07587 extends Drawable {
        C07587() {
        }
    ...
    static class C07598 implements Comparator<ThemeInfo> {
        C07598() {
        }
    ...
    static {
        ...
        if (TextUtils.isEmpty(themesString)) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new C07543());
            }
        }
        sortThemes();
        themeInfo2 = null;
    ...
    public static Drawable createEmojiIconSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C07554();
    ...
    public static Drawable createEditTextDrawable(Context context, boolean alert) {
        ...
        StateListDrawable stateListDrawable = new C07565();
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C07576();
    ...
    private static void sortThemes() {
        Collections.sort(themes, new C07598());
    }
    ...
    public static void saveCurrentTheme(String name, boolean finalSave) {
        ...
        try {
            ...
            if (themedWallpaper instanceof BitmapDrawable) {
                ...
                if (bitmap != null) {
                    stream.write(new byte[]{(byte) 87, (byte) 80, (byte) 83, (byte) 10});
                    bitmap.compress(CompressFormat.JPEG, 87, stream);
                    stream.write(new byte[]{(byte) 10, (byte) 87, (byte) 80, (byte) 69, (byte) 10});
                }
                if (finalSave) {
            ...
            ThemeInfo themeInfo = (ThemeInfo) themesDict.get(name);
            ThemeInfo newTheme = themeInfo;
            if (themeInfo == null) {
    ...
    private static HashMap<String, Integer> getThemeFileValues(File file, String assetName) {
        ...
        try {
            ...
            if (assetName != null) {
                assetFile = getAssetFile(assetName);
            } else {
                assetFile = file;
            }
            try {
                stream2 = new FileInputStream(assetFile);
                ...
                while (true) {
                    ...
                    currentPosition = 0;
                    while (currentPosition < read2) {
                        if (bytes[currentPosition] == (byte) 10) {
                            int len = (currentPosition - start) + 1;
                            String line = new String(bytes, start, len - 1, C0539C.UTF8_NAME);
                            if (line.startsWith("WPS")) {
                                try {
                                    themedWallpaperFileOffset = currentPosition2 + len;
                                    finished = true;
                                    bytes2 = bytes;
                                    file2 = assetFile;
                                    break;
                                ...
                                if (indexOf != -1) {
                                    ...
                                    bytes = line.substring(idx + 1);
                                    if (bytes.length() > 0) {
                                        file2 = assetFile;
                                        try {
                                            if (bytes.charAt(0) == '#') {
                                                try {
                                                    value = Color.parseColor(bytes);
                                                } catch (Exception e2) {
                                                    Exception ignore = e2;
                                                    value = Utilities.parseInt(bytes).intValue();
                                                }
                    ...
                    stream2.getChannel().position((long) currentPosition2);
                    if (finished) {
                        break;
                    }
    ...
    public static void setEmojiDrawableColor(Drawable drawable, int color, boolean selected) {
        if (drawable instanceof StateListDrawable) {
            ...
            if (selected) {
                try {
                    state = getStateDrawable(drawable, null);
                        ...
                        if (!MessagesController.getGlobalMainSettings().getBoolean("overrideThemeWallpaper", false)) {
                            ...
                            if (backgroundColor != null) {
                                ...
                                try {
                                    ...
                                    stream.getChannel().position((long) Theme.themedWallpaperFileOffset);
                                        ...
                                        try {
                                            ...
                                            if (Theme.wallpaper == null) {
                                                ...
                                                if (Theme.wallpaper == null) {
                                                    ...
                                                    Theme.wallpaper = new ColorDrawable(selectedColor);
                                                }
                                            }
    ...
    public static Drawable getThemedWallpaper(boolean thumb) {
        ...
        if (themedWallpaperFileOffset > 0 && !(currentTheme.pathToFile == null && currentTheme.assetName == null)) {
            ...
            try {
                ...
                stream = new FileInputStream(file);
                stream.getChannel().position((long) themedWallpaperFileOffset);
                ...
                if (thumb) {
                    ...
                    int maxWidth = AndroidUtilities.dp(NUM);
                    while (true) {
