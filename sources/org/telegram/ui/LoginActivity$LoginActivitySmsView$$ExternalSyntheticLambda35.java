...
public final /* synthetic */ class LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda35 implements RequestDelegate {
    ...
    public /* synthetic */ LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda35(LoginActivity.LoginActivitySmsView loginActivitySmsView, TLRPC$TL_account_confirmPhone tLRPC$TL_account_confirmPhone) {
        this.f$0 = loginActivitySmsView;
        this.f$1 = tLRPC$TL_account_confirmPhone;
    }

    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$onNextPressed$24(this.f$1, tLObject, tLRPC$TL_error);
    }
}
