...
public final /* synthetic */ class -$$Lambda$AlertsCreator$rUZAG4rhe76ZIPr-YMmswXbF2Dk implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$AlertsCreator$rUZAG4rhe76ZIPr-YMmswXbF2Dk(AlertDialog[] alertDialogArr, TLObject tLObject, BaseFragment baseFragment, User user, Chat chat, EncryptedChat encryptedChat, ChatFull chatFull, long j, MessageObject messageObject, SparseArray[] sparseArrayArr, GroupedMessages groupedMessages, Runnable runnable) {
    ...
    public final void run() {
        AlertsCreator.lambda$null$43(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11);
    }
}
