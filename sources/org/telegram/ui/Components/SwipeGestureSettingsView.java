...
public class SwipeGestureSettingsView extends FrameLayout {
    ...
    public /* synthetic */ String m4450lambda$new$0$orgtelegramuiComponentsSwipeGestureSettingsView(int value) {
        return this.strings[value];
    }

    /* renamed from: lambda$new$1$org-telegram-ui-Components-SwipeGestureSettingsView  reason: not valid java name */
    public /* synthetic */ void m4451lambda$new$1$orgtelegramuiComponentsSwipeGestureSettingsView(NumberPicker picker2, int oldVal, int newVal) {
        swapIcons();
    ...
    public /* synthetic */ void m4452x6d65954c() {
