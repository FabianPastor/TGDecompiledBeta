...
public class PinnedLineView extends View {
    ...
    public /* synthetic */ void m4226xd2955f1c(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4227lambda$set$1$orgtelegramuiComponentsPinnedLineView(ValueAnimator valueAnimator) {
        this.animationProgress = ((Float) valueAnimator.getAnimatedValue()).floatValue();
        invalidate();
    }
