...
public class SenderSelectPopup extends ActionBarPopupWindow {
    ...
    public /* synthetic */ void m1336lambda$new$0$orgtelegramuiComponentsSenderSelectPopup(OnSelectCallback selectCallback, List peers, View view, int position) {
        if (!this.clicked) {
            this.clicked = true;
    ...
    public /* synthetic */ void m1342xdbb89fef(DynamicAnimation animation, float value, float velocity) {
    ...
    public /* synthetic */ void m1343x95302d8e(DynamicAnimation animation, float value, float velocity) {
    ...
    public /* synthetic */ void m1344x4ea7bb2d(SpringAnimation animation, DynamicAnimation animation1, boolean canceled, float value, float velocity) {
        if (!canceled) {
    ...
    public /* synthetic */ void m1337x4cc0e76f(DynamicAnimation animation, float value, float velocity) {
        this.recyclerContainer.setScaleX(1.0f / value);
    }

    /* renamed from: lambda$startDismissAnimation$5$org-telegram-ui-Components-SenderSelectPopup  reason: not valid java name */
    public /* synthetic */ void m1338x638750e(DynamicAnimation animation, float value, float velocity) {
        this.recyclerContainer.setScaleY(1.0f / value);
    }

    /* renamed from: lambda$startDismissAnimation$6$org-telegram-ui-Components-SenderSelectPopup  reason: not valid java name */
    public /* synthetic */ void m1339xbfb002ad(DynamicAnimation animation, boolean canceled, float value, float velocity) {
    ...
    public /* synthetic */ void m1340x7927904c(DynamicAnimation animation, boolean canceled, float value, float velocity) {
    ...
    public /* synthetic */ void m1341x329f1deb(SpringAnimation springAnimation, DynamicAnimation animation, boolean canceled, float value, float velocity) {
        if (!canceled) {
