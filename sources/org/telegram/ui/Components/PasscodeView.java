...
public class PasscodeView extends FrameLayout {
    ...
    public PasscodeView(Context context) {
        ...
        this.passwordEditText.setOnEditorActionListener(new C12181());
        this.passwordEditText.addTextChangedListener(new C12192());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C12203());
        ...
        this.checkImage.setOnClickListener(new C12214());
