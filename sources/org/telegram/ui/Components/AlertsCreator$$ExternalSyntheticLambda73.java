...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda73 implements Runnable {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda73(SharedPreferences sharedPreferences, TLRPC$TL_help_support tLRPC$TL_help_support, AlertDialog alertDialog, int i, BaseFragment baseFragment) {
    ...
    public final void run() {
        AlertsCreator.lambda$performAskAQuestion$13(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
