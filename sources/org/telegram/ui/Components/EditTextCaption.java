...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public void makeSelectedUrl() {
        ...
        builder.setTitle(LocaleController.getString("CreateLink", C0431R.string.CreateLink));
        ...
        editText.setHintText(LocaleController.getString("URL", C0431R.string.URL));
    ...
    private Callback overrideCallback(final Callback callback) {
        return new Callback() {
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                boolean z = true;
                if (item.getItemId() == C0431R.id.menu_regular) {
                    EditTextCaption.this.makeSelectedRegular();
                    mode.finish();
                } else if (item.getItemId() == C0431R.id.menu_bold) {
                    EditTextCaption.this.makeSelectedBold();
                    mode.finish();
                } else if (item.getItemId() == C0431R.id.menu_italic) {
                    EditTextCaption.this.makeSelectedItalic();
                    mode.finish();
                } else if (item.getItemId() == C0431R.id.menu_mono) {
                    EditTextCaption.this.makeSelectedMono();
                    mode.finish();
                } else if (item.getItemId() == C0431R.id.menu_link) {
