...
public class EditTextCaption extends EditTextBoldCursor {
    ...
    public /* synthetic */ void m3945x8e956f7d(int start, int end, EditTextBoldCursor editText, DialogInterface dialogInterface, int i) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        if (hasSelection() != 0) {
            infoCompat.addAction(new AccessibilityNodeInfoCompat.AccessibilityActionCompat(NUM, LocaleController.getString("Spoiler", NUM)));
