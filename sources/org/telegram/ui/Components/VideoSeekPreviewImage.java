...
public class VideoSeekPreviewImage extends View {
    ...
    public /* synthetic */ void m4523xe0CLASSNAMEa(float progress, long time) {
        int height;
        int width;
    ...
    public /* synthetic */ void m4522xevar_a4b(Bitmap bitmapFinal) {
        int viewHeight;
        int viewWidth;
        if (bitmapFinal != null) {
    ...
    public /* synthetic */ void m4521lambda$open$3$orgtelegramuiComponentsVideoSeekPreviewImage(Uri uri) {
        String path;
        Uri uri2 = uri;
    ...
    public /* synthetic */ void m4520lambda$open$2$orgtelegramuiComponentsVideoSeekPreviewImage() {
    ...
    public /* synthetic */ void m4519lambda$close$4$orgtelegramuiComponentsVideoSeekPreviewImage() {
        this.pendingProgress = 0.0f;
