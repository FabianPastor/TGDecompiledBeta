        ...
        public void draw(Canvas canvas) {
            switch (this.type) {
                case 0:
                    ...
                    canvas.drawPoint(this.f52x, this.f53y, FireworksEffect.this.particlePaint);
                    return;
                default:
                    return;
            }
    ...
    private void updateParticles(long dt) {
        ...
        while (a < count) {
            ...
            if (particle.currentTime >= particle.lifeTime) {
                ...
                particle.f52x += ((particle.vx * particle.velocity) * ((float) dt)) / 500.0f;
                particle.f53y += ((particle.vy * particle.velocity) * ((float) dt)) / 500.0f;
