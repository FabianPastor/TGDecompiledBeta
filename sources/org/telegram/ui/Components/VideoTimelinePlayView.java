...
public class VideoTimelinePlayView extends View {
    ...
    class C17031 extends AsyncTask<Integer, Integer, Bitmap> {
    ...
    public VideoTimelinePlayView(Context context) {
        ...
        this.drawableLeft = context.getResources().getDrawable(C0493R.drawable.video_cropleft);
        this.drawableLeft.setColorFilter(new PorterDuffColorFilter(Theme.ACTION_BAR_VIDEO_EDIT_COLOR, Mode.MULTIPLY));
        this.drawableRight = context.getResources().getDrawable(C0493R.drawable.video_cropright);
