...
public class JoinCallAlert extends BottomSheet {
    ...
    public static void checkFewUsers(Context context, int i, AccountInstance accountInstance, MessagesStorage.BooleanCallback booleanCallback) {
        if (lastCachedAccount != accountInstance.getCurrentAccount() || lastCacheDid != ((long) i) || cachedChats == null || SystemClock.elapsedRealtime() - lastCacheTime >= 240000) {
            ...
            alertDialog.setOnCancelListener(new JoinCallAlert$$ExternalSyntheticLambda1(accountInstance, accountInstance.getConnectionsManager().sendRequest(tLRPC$TL_phone_getGroupCallJoinAs, new JoinCallAlert$$ExternalSyntheticLambda6(alertDialog, i, accountInstance, booleanCallback))));
            try {
    ...
    /* access modifiers changed from: private */
    public static /* synthetic */ void lambda$checkFewUsers$0(AlertDialog alertDialog, TLObject tLObject, int i, AccountInstance accountInstance, MessagesStorage.BooleanCallback booleanCallback) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
    ...
    /* access modifiers changed from: private */
    public static /* synthetic */ void lambda$open$3(AlertDialog alertDialog, TLObject tLObject, AccountInstance accountInstance, JoinCallAlertDelegate joinCallAlertDelegate, int i, Context context, BaseFragment baseFragment, int i2, TLRPC$Peer tLRPC$Peer) {
        try {
            alertDialog.dismiss();
        } catch (Exception e) {
            FileLog.e((Throwable) e);
    ...
    private JoinCallAlert(android.content.Context r20, long r21, java.util.ArrayList<org.telegram.tgnet.TLRPC$Peer> r23, int r24, org.telegram.tgnet.TLRPC$Peer r25, org.telegram.ui.Components.JoinCallAlert.JoinCallAlertDelegate r26) {
        ...
        L_0x005d:
            ...
            int r5 = org.telegram.messenger.MessageObject.getPeerId(r25)
            long r7 = (long) r5
        ...
        L_0x0176:
            ...
            r9.<init>(r1)
            r9.setAutoRepeat(r7)
            r10 = 2131558512(0x7f0d0070, float:1.8742342E38)
        ...
        L_0x02be:
            ...
            if (r10 != 0) goto L_0x02f2
            r10 = 2131628263(0x7f0e10e7, float:1.8883814E38)
            java.lang.String r11 = "VoipChannelStart2"
            java.lang.String r10 = org.telegram.messenger.LocaleController.getString(r11, r10)
            r6.append(r10)
            goto L_0x02fe
        L_0x02f2:
            r10 = 2131628374(0x7f0e1156, float:1.8884039E38)
        ...
        L_0x0340:
            ...
            android.widget.TextView r6 = r0.messageTextView
            r10 = 2131628377(0x7f0e1159, float:1.8884045E38)
        ...
        L_0x0351:
            android.widget.TextView r6 = r0.messageTextView
            r10 = 2131628376(0x7f0e1158, float:1.8884043E38)
        ...
        L_0x03a2:
            ...
            goto L_0x03ef
        L_0x03e3:
            r1 = 2131628366(0x7f0e114e, float:1.8884023E38)
