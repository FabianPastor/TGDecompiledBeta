...
public class TableLayout extends View {
    ...
    final class Axis {
        ...
        /* synthetic */ Axis(TableLayout x0, boolean x1, AnonymousClass1 x2) {
            this(x1);
        }
        ...
        public void draw(Canvas canvas) {
            if (this.cell != null) {
                ...
                if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                    ...
                    if (hasCorners) {
                        TableLayout.this.rect.set((float) this.x, (float) this.y, (float) (this.x + this.measuredWidth), (float) (this.y + this.measuredHeight));
                        ...
                        canvas.drawRect((float) this.x, (float) this.y, (float) (this.x + this.measuredWidth), (float) (this.y + this.measuredHeight), TableLayout.this.delegate.getHeaderPaint());
                    } else {
                        canvas.drawRect((float) this.x, (float) this.y, (float) (this.x + this.measuredWidth), (float) (this.y + this.measuredHeight), TableLayout.this.delegate.getStripPaint());
                    }
                }
                if (this.textLayout != null) {
                    canvas.save();
                ...
                if (TableLayout.this.drawLines) {
                    ...
                    if (this.x == 0) {
                        start = (float) this.y;
                        end = (float) (this.y + this.measuredHeight);
                        if (this.y == 0) {
                            start += (float) rad;
                        }
                        ...
                        canvas.drawLine(((float) this.x) + strokeWidth, start, ((float) this.x) + strokeWidth, end, linePaint);
                    } else {
                        canvas.drawLine(((float) this.x) - halfStrokeWidth, (float) this.y, ((float) this.x) - halfStrokeWidth, (float) (this.y + this.measuredHeight), halfLinePaint);
                    }
                    if (this.y == 0) {
                        start = (float) this.x;
                        end = (float) (this.x + this.measuredWidth);
                        if (this.x == 0) {
                            start += (float) rad;
                        }
                        ...
                        canvas.drawLine(start, ((float) this.y) + strokeWidth, end, ((float) this.y) + strokeWidth, linePaint);
                    } else {
                        canvas.drawLine((float) this.x, ((float) this.y) - halfStrokeWidth, (float) (this.x + this.measuredWidth), ((float) this.y) - halfStrokeWidth, halfLinePaint);
                    }
                    if (isLastX && this.y == 0) {
                        start = (float) (this.y + rad);
                    } else {
                    ...
                    canvas.drawLine(((float) (this.x + this.measuredWidth)) - strokeWidth, start, ((float) (this.x + this.measuredWidth)) - strokeWidth, end, linePaint);
                    if (this.x == 0 && isLastY) {
                        start = (float) (this.x + rad);
                    } else {
                        start = ((float) this.x) - strokeWidth;
                    }
                    if (isLastX && isLastY) {
                        end = (float) ((this.x + this.measuredWidth) - rad);
                    } else {
                        end = ((float) (this.x + this.measuredWidth)) - strokeWidth;
                    }
                    canvas.drawLine(start, ((float) (this.y + this.measuredHeight)) - strokeWidth, end, ((float) (this.y + this.measuredHeight)) - strokeWidth, linePaint);
                    if (this.x == 0 && this.y == 0) {
                        TableLayout.this.rect.set(((float) this.x) + strokeWidth, ((float) this.y) + strokeWidth, (((float) this.x) + strokeWidth) + ((float) (rad * 2)), (((float) this.y) + strokeWidth) + ((float) (rad * 2)));
                        canvas.drawArc(TableLayout.this.rect, -180.0f, 90.0f, false, linePaint);
                    }
                    if (isLastX && this.y == 0) {
                        TableLayout.this.rect.set((((float) (this.x + this.measuredWidth)) - strokeWidth) - ((float) (rad * 2)), ((float) this.y) + strokeWidth, ((float) (this.x + this.measuredWidth)) - strokeWidth, (((float) this.y) + strokeWidth) + ((float) (rad * 2)));
                        canvas.drawArc(TableLayout.this.rect, 0.0f, -90.0f, false, linePaint);
                    }
                    if (this.x == 0 && isLastY) {
                        TableLayout.this.rect.set(((float) this.x) + strokeWidth, (((float) (this.y + this.measuredHeight)) - strokeWidth) - ((float) (rad * 2)), (((float) this.x) + strokeWidth) + ((float) (rad * 2)), ((float) (this.y + this.measuredHeight)) - strokeWidth);
                        canvas.drawArc(TableLayout.this.rect, 180.0f, -90.0f, false, linePaint);
                    }
                    if (isLastX && isLastY) {
                        TableLayout.this.rect.set((((float) (this.x + this.measuredWidth)) - strokeWidth) - ((float) (rad * 2)), (((float) (this.y + this.measuredHeight)) - strokeWidth) - ((float) (rad * 2)), ((float) (this.x + this.measuredWidth)) - strokeWidth, ((float) (this.y + this.measuredHeight)) - strokeWidth);
                        canvas.drawArc(TableLayout.this.rect, 0.0f, 90.0f, false, linePaint);
                    }
                }
            }
            ...
            if (c.cell != null) {
                ...
                if (!(c.fixedHeight == 0 || c.fixedHeight == height || c.layoutParams.rowSpec.span.max - c.layoutParams.rowSpec.span.min > 1)) {
                    ...
                    for (a = 0; a < size; a++) {
                        ...
                        if (p.x <= ((float) c.layoutParams.rowSpec.span.min) && p.y > ((float) c.layoutParams.rowSpec.span.min)) {
                            found = true;
                            break;
                        }
                    }
