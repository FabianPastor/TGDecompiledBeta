...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda48 implements View.OnClickListener {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda48(ActionBarMenuItem actionBarMenuItem, AlertsCreator.ScheduleDatePickerColors scheduleDatePickerColors) {
        this.f$0 = actionBarMenuItem;
        this.f$1 = scheduleDatePickerColors;
    }

    public final void onClick(View view) {
        AlertsCreator.lambda$createScheduleDatePickerDialog$45(this.f$0, this.f$1, view);
    }
}
