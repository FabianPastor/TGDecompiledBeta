...
public final /* synthetic */ class -$$Lambda$AlertsCreator$PfqFazdn9NQ97ARqEHrnjPsSobk implements RequestDelegate {
    ...
    public /* synthetic */ -$$Lambda$AlertsCreator$PfqFazdn9NQ97ARqEHrnjPsSobk(AlertDialog[] alertDialogArr, BaseFragment baseFragment, User user, Chat chat, EncryptedChat encryptedChat, ChatFull chatFull, long j, MessageObject messageObject, SparseArray[] sparseArrayArr, GroupedMessages groupedMessages, boolean z, Runnable runnable) {
    ...
    public final void run(TLObject tLObject, TL_error tL_error) {
        AndroidUtilities.runOnUIThread(new -$$Lambda$AlertsCreator$87SVNSIdTlutspPmkbzW8iBSgTM(this.f$0, tLObject, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11));
    }
}
