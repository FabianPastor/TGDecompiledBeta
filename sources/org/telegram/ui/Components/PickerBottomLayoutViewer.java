...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean darkTheme) {
        ...
        this.doneButton.setText(LocaleController.getString("Send", C0501R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C0501R.drawable.photobadge : C0501R.drawable.bluecounter);
