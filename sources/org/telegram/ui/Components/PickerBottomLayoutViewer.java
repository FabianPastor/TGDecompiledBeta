...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean darkTheme) {
        ...
        this.doneButton.setText(LocaleController.getString("Send", C0431R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C0431R.drawable.photobadge : C0431R.drawable.bluecounter);
