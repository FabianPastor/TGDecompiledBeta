...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean darkTheme) {
        ...
        this.doneButton.setText(LocaleController.getString("Send", C0505R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C0505R.drawable.photobadge : C0505R.drawable.bluecounter);
