...
public class BlurBehindDrawable {
    ...
    public /* synthetic */ void m2021lambda$draw$0$orgtelegramuiComponentsBlurBehindDrawable() {
        this.error = true;
        this.parentView.invalidate();
    }
    ...
    public /* synthetic */ void m2020lambda$clear$2$orgtelegramuiComponentsBlurBehindDrawable() {
    ...
    public /* synthetic */ void m2019lambda$clear$1$orgtelegramuiComponentsBlurBehindDrawable() {
        DispatchQueue dispatchQueue = this.queue;
        if (dispatchQueue != null) {
    ...
    public class BlurBackgroundTask implements Runnable {
        ...
        public /* synthetic */ void m2022xc3c2eb08() {
            if (!this.canceled) {
