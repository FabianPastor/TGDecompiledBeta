...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    /* access modifiers changed from: private */
    public float stickerTabWidth = ((float) AndroidUtilities.dp(38.0f));
    ...
    public void beginUpdate(boolean animated) {
        ...
        if (animated && Build.VERSION.SDK_INT >= 19) {
            ...
            transition.addTransition(new Transition() {
                ...
                public /* synthetic */ void m1319xddfcbcca(ValueAnimator a) {
                    ScrollSlidingTabStrip.this.invalidate();
                }
            });
    ...
    public /* synthetic */ void m1313x4b831afd(View v) {
    ...
    public /* synthetic */ void m1312xcb3eCLASSNAME(View v) {
        this.delegate.onPageSelected(((Integer) v.getTag(NUM)).intValue());
    }
    ...
    public /* synthetic */ void m1314x30882916(View v) {
        this.delegate.onPageSelected(((Integer) v.getTag(NUM)).intValue());
    }
    ...
    public /* synthetic */ void m1315x80889fdc(View v) {
        this.delegate.onPageSelected(((Integer) v.getTag(NUM)).intValue());
    }
    ...
    public /* synthetic */ void m1311xc5ead344(View v) {
        this.delegate.onPageSelected(((Integer) v.getTag(NUM)).intValue());
    }
    ...
    public /* synthetic */ void m1316x63dbec1a(View v) {
        this.delegate.onPageSelected(((Integer) v.getTag(NUM)).intValue());
    }
    ...
    public /* synthetic */ void m1318xe446e308(boolean expanded2, float x, ValueAnimator valueAnimator) {
        if (!expanded2) {
    ...
    public void setImages() {
        ...
        float tabSize = ((float) AndroidUtilities.dp(38.0f)) + (((float) AndroidUtilities.dp(48.0f)) * f);
        int start = (int) (((((float) getScrollX()) - (this.animateToExpanded ? this.expandOffset * (1.0f - f) : 0.0f)) - ((float) this.tabsContainer.getPaddingLeft())) / tabSize);
                        ...
                        if (!(object instanceof TLRPC.Document) || !MessageObject.isVideoSticker(sticker2)) {
                            if (!(object instanceof TLRPC.Document) || !MessageObject.isAnimatedStickerDocument(sticker2, true)) {
                                if (imageLocation.imageType == 1) {
                                    imageView.setImage(imageLocation, "40_40", "tgs", (Drawable) svgThumb, parentObject);
                                } else {
                                    imageView.setImage(imageLocation, (String) null, "webp", (Drawable) svgThumb, parentObject);
                                }
    ...
    public /* synthetic */ void m1317x18a44158(ValueAnimator valueAnimator) {
