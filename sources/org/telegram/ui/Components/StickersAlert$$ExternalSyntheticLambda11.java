...
public final /* synthetic */ class StickersAlert$$ExternalSyntheticLambda11 implements View.OnClickListener {
    ...
    public /* synthetic */ StickersAlert$$ExternalSyntheticLambda11(StickersAlert stickersAlert, int[] iArr, EditTextBoldCursor editTextBoldCursor, TextView textView, TextView textView2, AlertDialog.Builder builder) {
    ...
    public final void onClick(View view) {
        this.f$0.lambda$showNameEnterAlert$28(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, view);
    }
}
