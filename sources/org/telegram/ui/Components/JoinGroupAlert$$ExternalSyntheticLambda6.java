...
public final /* synthetic */ class JoinGroupAlert$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ JoinGroupAlert$$ExternalSyntheticLambda6(JoinGroupAlert joinGroupAlert, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, TLRPC$TL_messages_importChatInvite tLRPC$TL_messages_importChatInvite) {
    ...
    public final void run() {
        this.f$0.lambda$new$6(this.f$1, this.f$2, this.f$3);
    }
}
