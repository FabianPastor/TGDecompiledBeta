    ...
    public void draw(Canvas canvas) {
        ...
        if ((this.mediaActionDrawable.getCurrentIcon() != 4 || this.mediaActionDrawable.getTransitionProgress() < 1.0f) && !this.progressRect.isEmpty()) {
            ...
            if (this.overlayImageView.hasBitmapImage()) {
                ...
                this.overlayPaint.setAlpha((int) (100.0f * alpha2 * wholeAlpha * this.overrideAlpha));
                if (alpha2 >= 1.0f) {
                    drawCircle = false;
                    r = -1;
                    int i3 = prevIcon;
                    ...
                    int i10 = rD;
                    int i11 = gD;
                    r = Color.argb(a + ((int) (((float) (255 - a)) * alpha2)), c + rD, g + gD, b + ((int) (((float) (255 - b)) * alpha2)));
                    drawCircle = true;
                }
            ...
            if (!(canvas6 == null || this.circleCrossfadeColorKey == null || this.circleCheckProgress == 1.0f)) {
                ...
                float scale = 1.0f - ((1.0f - this.circleCheckProgress) * 0.1f);
                this.miniDrawCanvas.scale(scale, scale, (float) centerX, (float) centerY);
            }
            if (drawCircle && this.drawBackground) {
                if ((this.drawMiniIcon || this.circleCrossfadeColorKey != null) && (canvas4 = this.miniDrawCanvas) != null) {
                    ...
                    if (this.backgroundStroke != 0) {
                        ...
                        canvas5.drawCircle((float) centerX, (float) centerY, ((float) this.circleRadius) * wholeAlpha, this.circlePaint);
                    }
                }
            }
            if (this.overlayImageView.hasBitmapImage()) {
