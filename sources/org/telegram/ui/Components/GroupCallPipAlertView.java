...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2320lambda$new$0$orgtelegramuiComponentsGroupCallPipAlertView(View view) {
    ...
    public /* synthetic */ void m2321lambda$new$1$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
        if (VoIPService.getSharedInstance() != null) {
    ...
    public /* synthetic */ void m2322lambda$new$2$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
        if (VoIPService.getSharedInstance() == null) {
            return;
        }
    ...
    public /* synthetic */ void m2323lambda$new$4$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
    ...
    private void updateMembersCount() {
        ...
        if (service != null && service.groupCall != null) {
            ...
            if (service.isSwitchingStream() || !(currentCallState == 1 || currentCallState == 2 || currentCallState == 6 || currentCallState == 5)) {
                this.subtitleView.setText(LocaleController.formatPluralString("Participants", service.groupCall.call.participants_count));
            } else {
