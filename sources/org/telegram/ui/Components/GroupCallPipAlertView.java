...
public class GroupCallPipAlertView extends LinearLayout implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m4041lambda$new$0$orgtelegramuiComponentsGroupCallPipAlertView(View view) {
    ...
    public /* synthetic */ void m4042lambda$new$1$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
        if (VoIPService.getSharedInstance() != null) {
    ...
    public /* synthetic */ void m4043lambda$new$2$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
        if (VoIPService.getSharedInstance() == null) {
            return;
        }
    ...
    public /* synthetic */ void m4044lambda$new$4$orgtelegramuiComponentsGroupCallPipAlertView(Context context, View v) {
    ...
    private void updateMembersCount() {
        ...
        if (service != null && service.groupCall != null) {
            ...
            if (service.isSwitchingStream() || !(currentCallState == 1 || currentCallState == 2 || currentCallState == 6 || currentCallState == 5)) {
                this.subtitleView.setText(LocaleController.formatPluralString(service.groupCall.call.rtmp_stream ? "ViewersWatching" : "Participants", service.groupCall.call.participants_count));
            } else {
