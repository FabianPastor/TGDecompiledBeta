...
public class AlertsCreator {
    ...
    public static Dialog processError(int currentAccount, TL_error error, BaseFragment fragment, TLObject request, Object... args) {
        ...
        if (!(request instanceof TL_account_saveSecureValue) && !(request instanceof TL_account_getAuthorizationForm)) {
                ...
                if (!(request instanceof TL_messages_createChat)) {
                    if (!(request instanceof TL_channels_createChannel)) {
                        if (!(request instanceof TL_messages_editMessage)) {
                            if (!(request instanceof TL_messages_sendMessage) && !(request instanceof TL_messages_sendMedia) && !(request instanceof TL_messages_sendBroadcast) && !(request instanceof TL_messages_sendInlineBotResult) && !(request instanceof TL_messages_forwardMessages)) {
                                if (!(request instanceof TL_messages_importChatInvite)) {
                                    if (!(request instanceof TL_messages_getAttachedStickers)) {
                                        if (!(request instanceof TL_account_confirmPhone) && !(request instanceof TL_account_verifyPhone) && !(request instanceof TL_account_verifyEmail)) {
                                            if (!(request instanceof TL_auth_resendCode)) {
                                                if (!(request instanceof TL_account_sendConfirmPhoneCode)) {
                                                        ...
                                                        if (!(request instanceof TL_account_sendChangePhoneCode)) {
                                                            ...
                                                            if (!(request instanceof TL_updateUserName)) {
                                                                if (!(request instanceof TL_contacts_importContacts)) {
                                                                    if (!(request instanceof TL_account_getPassword) && !(request instanceof TL_account_getTmpPassword)) {
                                                                        if (!(request instanceof TL_payments_sendPaymentForm)) {
                                                                            if (request instanceof TL_payments_validateRequestedInfo) {
                                                                                ...
                                                                                switch (z2) {
                                                                                    case false:
                                                                                        showSimpleToast(fragment, LocaleController.getString("PaymentNoShippingMethod", C0431R.string.PaymentNoShippingMethod));
                                                                                        break;
                                                                                    default:
                                                                        ...
                                                                        switch (z) {
                                                                            case false:
                                                                                showSimpleToast(fragment, LocaleController.getString("PaymentPrecheckoutFailed", C0431R.string.PaymentPrecheckoutFailed));
                                                                                break;
                                                                            case true:
                                                                                showSimpleToast(fragment, LocaleController.getString("PaymentFailed", C0431R.string.PaymentFailed));
                                                                                break;
                                                                            default:
                                                                                showSimpleToast(fragment, error.text);
                                                                                break;
                                                                    ...
                                                                    showSimpleAlert(fragment, LocaleController.getString("FloodWait", C0431R.string.FloodWait));
                                                                } else {
                                                                    showSimpleAlert(fragment, LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred) + "\n" + error.text);
                                                                }
                                                            } else {
                                                                str = error.text;
                                                                switch (str.hashCode()) {
                                                                ...
                                                                switch (z) {
                                                                    case false:
                                                                        showSimpleAlert(fragment, LocaleController.getString("UsernameInvalid", C0431R.string.UsernameInvalid));
                                                                        break;
                                                                    case true:
                                                                        showSimpleAlert(fragment, LocaleController.getString("UsernameInUse", C0431R.string.UsernameInUse));
                                                                        break;
                                                                    default:
                                                                        showSimpleAlert(fragment, LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred));
                                                                        break;
                                                            ...
                                                            showSimpleAlert(fragment, LocaleController.getString("InvalidPhoneNumber", C0431R.string.InvalidPhoneNumber));
                                                        } else if (error.text.contains("PHONE_CODE_EMPTY") || error.text.contains("PHONE_CODE_INVALID")) {
                                                            showSimpleAlert(fragment, LocaleController.getString("InvalidCode", C0431R.string.InvalidCode));
                                                        } else if (error.text.contains("PHONE_CODE_EXPIRED")) {
                                                            showSimpleAlert(fragment, LocaleController.getString("CodeExpired", C0431R.string.CodeExpired));
                                                        } else if (error.text.startsWith("FLOOD_WAIT")) {
                                                            showSimpleAlert(fragment, LocaleController.getString("FloodWait", C0431R.string.FloodWait));
                                                        } else if (error.text.startsWith("PHONE_NUMBER_OCCUPIED")) {
                                                            showSimpleAlert(fragment, LocaleController.formatString("ChangePhoneNumberOccupied", C0431R.string.ChangePhoneNumberOccupied, (String) args[0]));
                                                        } else {
                                                            showSimpleAlert(fragment, LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred));
                                                        }
                                                    } else if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                                    ...
                                                    return showSimpleAlert(fragment, LocaleController.getString("CancelLinkExpired", C0431R.string.CancelLinkExpired));
                                                } else {
                                                    if (error.text != null) {
                                                        if (error.text.startsWith("FLOOD_WAIT")) {
                                                            return showSimpleAlert(fragment, LocaleController.getString("FloodWait", C0431R.string.FloodWait));
                                                        }
                                                        return showSimpleAlert(fragment, LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred));
                                                    }
                                                }
                                            } else if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                                return showSimpleAlert(fragment, LocaleController.getString("InvalidPhoneNumber", C0431R.string.InvalidPhoneNumber));
                                            } else {
                                                if (error.text.contains("PHONE_CODE_EMPTY") || error.text.contains("PHONE_CODE_INVALID")) {
                                                    return showSimpleAlert(fragment, LocaleController.getString("InvalidCode", C0431R.string.InvalidCode));
                                                }
                                                if (error.text.contains("PHONE_CODE_EXPIRED")) {
                                                    return showSimpleAlert(fragment, LocaleController.getString("CodeExpired", C0431R.string.CodeExpired));
                                                }
                                                if (error.text.startsWith("FLOOD_WAIT")) {
                                                    return showSimpleAlert(fragment, LocaleController.getString("FloodWait", C0431R.string.FloodWait));
                                                }
                                        ...
                                        Toast.makeText(fragment.getParentActivity(), LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred) + "\n" + error.text, 0).show();
                                    }
                                } else if (error.text.startsWith("FLOOD_WAIT")) {
                                    showSimpleAlert(fragment, LocaleController.getString("FloodWait", C0431R.string.FloodWait));
                                } else if (error.text.equals("USERS_TOO_MUCH")) {
                                    showSimpleAlert(fragment, LocaleController.getString("JoinToGroupErrorFull", C0431R.string.JoinToGroupErrorFull));
                                } else {
                                    showSimpleAlert(fragment, LocaleController.getString("JoinToGroupErrorNotExist", C0431R.string.JoinToGroupErrorNotExist));
                                }
                            ...
                            if (fragment != null) {
                                showSimpleAlert(fragment, LocaleController.getString("EditMessageError", C0431R.string.EditMessageError));
                            } else {
                                showSimpleToast(fragment, LocaleController.getString("EditMessageError", C0431R.string.EditMessageError));
                            }
                        }
                    } else if (error.text.startsWith("FLOOD_WAIT")) {
            ...
            showUpdateAppAlert(fragment.getParentActivity(), LocaleController.getString("UpdateAppAlert", C0431R.string.UpdateAppAlert), true);
        } else {
            showSimpleAlert(fragment, LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred) + "\n" + error.text);
        }
        return null;
    ...
    public static AlertDialog showUpdateAppAlert(Context context, String text, boolean updateApp) {
        ...
        if (updateApp) {
            builder.setNegativeButton(LocaleController.getString("UpdateApp", C0431R.string.UpdateApp), new AlertsCreator$$Lambda$0(context));
        }
        return builder.show();
    }
    ...
    public static void showCustomNotificationsDialog(BaseFragment parentFragment, long did, int currentAccount, IntCallback callback) {
        if (parentFragment != null && parentFragment.getParentActivity() != null) {
            ...
            descriptions[0] = defaultEnabled ? LocaleController.getString("NotificationsDefaultOn", C0431R.string.NotificationsDefaultOn) : LocaleController.getString("NotificationsDefaultOff", C0431R.string.NotificationsDefaultOff);
            descriptions[1] = LocaleController.getString("NotificationsTurnOn", C0431R.string.NotificationsTurnOn);
            descriptions[2] = LocaleController.formatString("MuteFor", C0431R.string.MuteFor, LocaleController.formatPluralString("Hours", 1));
            descriptions[3] = LocaleController.formatString("MuteFor", C0431R.string.MuteFor, LocaleController.formatPluralString("Days", 2));
            descriptions[4] = LocaleController.getString("NotificationsCustomize", C0431R.string.NotificationsCustomize);
            descriptions[5] = LocaleController.getString("NotificationsTurnOff", C0431R.string.NotificationsTurnOff);
            int[] icons = new int[6];
            icons[0] = defaultEnabled ? C0431R.drawable.notifications_s_on : C0431R.drawable.notifications_s_off;
            icons[1] = C0431R.drawable.notifications_s_on;
            icons[2] = C0431R.drawable.notifications_s_1h;
            icons[3] = C0431R.drawable.notifications_s_2d;
            icons[4] = C0431R.drawable.notifications_s_custom;
            icons[5] = C0431R.drawable.notifications_s_off;
            ...
            builder.setTitle(LocaleController.getString("Notifications", C0431R.string.Notifications));
    ...
    public static AlertDialog showSecretLocationAlert(Context context, int currentAccount, Runnable onSelectRunnable, boolean inChat) {
        ...
        if ((providers & 1) != 0) {
            arrayList.add(LocaleController.getString("MapPreviewProviderTelegram", C0431R.string.MapPreviewProviderTelegram));
        }
        if ((providers & 2) != 0) {
            arrayList.add(LocaleController.getString("MapPreviewProviderGoogle", C0431R.string.MapPreviewProviderGoogle));
        }
        if ((providers & 4) != 0) {
            arrayList.add(LocaleController.getString("MapPreviewProviderYandex", C0431R.string.MapPreviewProviderYandex));
        }
        arrayList.add(LocaleController.getString("MapPreviewProviderNobody", C0431R.string.MapPreviewProviderNobody));
        Builder builder = new Builder(context).setTitle(LocaleController.getString("ChooseMapPreviewProvider", C0431R.string.ChooseMapPreviewProvider)).setItems((CharSequence[]) arrayList.toArray(new String[arrayList.size()]), new AlertsCreator$$Lambda$2(onSelectRunnable));
        if (!inChat) {
    ...
    public static Builder createDatePickerDialog(Context context, int minYear, int maxYear, int currentYearDiff, int selectedDay, int selectedMonth, int selectedYear, String title, boolean checkMinDate, DatePickerDelegate datePickerDelegate) {
        ...
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Set", C0431R.string.Set), new AlertsCreator$$Lambda$9(checkMinDate, dayPicker, monthPicker, yearPicker, datePickerDelegate));
        builder.setNegativeButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
        return builder;
    }
    ...
    public static Dialog createMuteAlert(Context context, long dialog_id) {
        ...
        items[0] = LocaleController.formatString("MuteFor", C0431R.string.MuteFor, LocaleController.formatPluralString("Hours", 1));
        items[1] = LocaleController.formatString("MuteFor", C0431R.string.MuteFor, LocaleController.formatPluralString("Hours", 8));
        items[2] = LocaleController.formatString("MuteFor", C0431R.string.MuteFor, LocaleController.formatPluralString("Days", 2));
        items[3] = LocaleController.getString("MuteDisable", C0431R.string.MuteDisable);
    ...
    public static Dialog createReportAlert(Context context, long dialog_id, int messageId, BaseFragment parentFragment) {
        ...
        BottomSheet.Builder builder = new BottomSheet.Builder(context);
        builder.setTitle(LocaleController.getString("ReportChat", C0431R.string.ReportChat));
        builder.setItems(new CharSequence[]{LocaleController.getString("ReportChatSpam", C0431R.string.ReportChatSpam), LocaleController.getString("ReportChatViolence", C0431R.string.ReportChatViolence), LocaleController.getString("ReportChatPornography", C0431R.string.ReportChatPornography), LocaleController.getString("ReportChatOther", C0431R.string.ReportChatOther)}, new AlertsCreator$$Lambda$11(dialog_id, messageId, parentFragment, context));
        return builder.create();
    }
    ...
    static final /* synthetic */ void lambda$createReportAlert$12$AlertsCreator(long dialog_id, int messageId, BaseFragment parentFragment, Context context, DialogInterface dialogInterface, int i) {
        ...
        Toast.makeText(context, LocaleController.getString("ReportChatSent", C0431R.string.ReportChatSent), 0).show();
    }
    ...
    private static String getFloodWaitString(String error) {
        ...
        return LocaleController.formatString("FloodWaitTime", C0431R.string.FloodWaitTime, timeString);
    }
    ...
    public static void showFloodWaitAlert(String error, BaseFragment fragment) {
        if (error != null && error.startsWith("FLOOD_WAIT") && fragment != null && fragment.getParentActivity() != null) {
            ...
            builder.setTitle(LocaleController.getString("AppName", C0431R.string.AppName));
            builder.setMessage(LocaleController.formatString("FloodWaitTime", C0431R.string.FloodWaitTime, timeString));
            builder.setPositiveButton(LocaleController.getString("OK", C0431R.string.OK), null);
    ...
    public static void showSendMediaAlert(int result, BaseFragment fragment) {
        if (result != 0) {
            ...
            builder.setTitle(LocaleController.getString("AppName", C0431R.string.AppName));
            if (result == 1) {
                builder.setMessage(LocaleController.getString("ErrorSendRestrictedStickers", C0431R.string.ErrorSendRestrictedStickers));
            } else if (result == 2) {
                builder.setMessage(LocaleController.getString("ErrorSendRestrictedMedia", C0431R.string.ErrorSendRestrictedMedia));
            }
            builder.setPositiveButton(LocaleController.getString("OK", C0431R.string.OK), null);
            fragment.showDialog(builder.create(), true, null);
        }
    ...
    public static void showAddUserAlert(String error, BaseFragment fragment, boolean isChannel) {
        if (error != null && fragment != null && fragment.getParentActivity() != null) {
            ...
            switch (z) {
                case false:
                    builder.setMessage(LocaleController.getString("NobodyLikesSpam2", C0431R.string.NobodyLikesSpam2));
                    builder.setNegativeButton(LocaleController.getString("MoreInfo", C0431R.string.MoreInfo), new AlertsCreator$$Lambda$12(fragment));
                    break;
                case true:
                case true:
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("GroupUserCantAdd", C0431R.string.GroupUserCantAdd));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("ChannelUserCantAdd", C0431R.string.ChannelUserCantAdd));
                        break;
                    }
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("GroupUserAddLimit", C0431R.string.GroupUserAddLimit));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("ChannelUserAddLimit", C0431R.string.ChannelUserAddLimit));
                        break;
                    }
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("GroupUserLeftError", C0431R.string.GroupUserLeftError));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("ChannelUserLeftError", C0431R.string.ChannelUserLeftError));
                        break;
                    }
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("GroupUserCantAdmin", C0431R.string.GroupUserCantAdmin));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("ChannelUserCantAdmin", C0431R.string.ChannelUserCantAdmin));
                        break;
                    }
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("GroupUserCantBot", C0431R.string.GroupUserCantBot));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("ChannelUserCantBot", C0431R.string.ChannelUserCantBot));
                        break;
                    }
                case true:
                    if (!isChannel) {
                        builder.setMessage(LocaleController.getString("InviteToGroupError", C0431R.string.InviteToGroupError));
                        break;
                    } else {
                        builder.setMessage(LocaleController.getString("InviteToChannelError", C0431R.string.InviteToChannelError));
                        break;
                    }
                case true:
                    builder.setMessage(LocaleController.getString("CreateGroupError", C0431R.string.CreateGroupError));
                    break;
                case true:
                    builder.setMessage(LocaleController.getString("UserRestricted", C0431R.string.UserRestricted));
                    break;
                case true:
                    builder.setMessage(LocaleController.getString("YouBlockedUser", C0431R.string.YouBlockedUser));
                    break;
                case true:
                case true:
                    builder.setMessage(LocaleController.getString("AddAdminErrorBlacklisted", C0431R.string.AddAdminErrorBlacklisted));
                    break;
                case true:
                    builder.setMessage(LocaleController.getString("AddAdminErrorNotAMember", C0431R.string.AddAdminErrorNotAMember));
                    break;
                case true:
                    builder.setMessage(LocaleController.getString("AddBannedErrorAdmin", C0431R.string.AddBannedErrorAdmin));
                    break;
                default:
                    builder.setMessage(LocaleController.getString("ErrorOccurred", C0431R.string.ErrorOccurred) + "\n" + error);
                    break;
            }
            builder.setPositiveButton(LocaleController.getString("OK", C0431R.string.OK), null);
            fragment.showDialog(builder.create(), true, null);
    ...
    public static Dialog createColorSelectDialog(Activity parentActivity, long dialog_id, boolean globalGroup, boolean globalAll, Runnable onSelect) {
        ...
        linearLayout.setOrientation(1);
        String[] descriptions = new String[]{LocaleController.getString("ColorRed", C0431R.string.ColorRed), LocaleController.getString("ColorOrange", C0431R.string.ColorOrange), LocaleController.getString("ColorYellow", C0431R.string.ColorYellow), LocaleController.getString("ColorGreen", C0431R.string.ColorGreen), LocaleController.getString("ColorCyan", C0431R.string.ColorCyan), LocaleController.getString("ColorBlue", C0431R.string.ColorBlue), LocaleController.getString("ColorViolet", C0431R.string.ColorViolet), LocaleController.getString("ColorPink", C0431R.string.ColorPink), LocaleController.getString("ColorWhite", C0431R.string.ColorWhite)};
        ...
        builder.setTitle(LocaleController.getString("LedColor", C0431R.string.LedColor));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Set", C0431R.string.Set), new AlertsCreator$$Lambda$14(globalAll, selectedColor, globalGroup, dialog_id, onSelect));
        builder.setNeutralButton(LocaleController.getString("LedDisabled", C0431R.string.LedDisabled), new AlertsCreator$$Lambda$15(globalAll, globalGroup, dialog_id, onSelect));
        if (!(globalAll || globalGroup)) {
            builder.setNegativeButton(LocaleController.getString("Default", C0431R.string.Default), new AlertsCreator$$Lambda$16(dialog_id, onSelect));
        }
        return builder.create();
    }
    ...
    public static Dialog createVibrationSelectDialog(Activity parentActivity, BaseFragment parentFragment, long dialog_id, String prefKeyPrefix, Runnable onSelect) {
        ...
        if (dialog_id != 0) {
            ...
            descriptions = new String[]{LocaleController.getString("VibrationDefault", C0431R.string.VibrationDefault), LocaleController.getString("Short", C0431R.string.Short), LocaleController.getString("Long", C0431R.string.Long), LocaleController.getString("VibrationDisabled", C0431R.string.VibrationDisabled)};
        } else {
            ...
            descriptions = new String[]{LocaleController.getString("VibrationDisabled", C0431R.string.VibrationDisabled), LocaleController.getString("VibrationDefault", C0431R.string.VibrationDefault), LocaleController.getString("Short", C0431R.string.Short), LocaleController.getString("Long", C0431R.string.Long), LocaleController.getString("OnlyIfSilent", C0431R.string.OnlyIfSilent)};
        }
        ...
        Builder builder = new Builder((Context) parentActivity);
        builder.setTitle(LocaleController.getString("Vibrate", C0431R.string.Vibrate));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
        return builder.create();
    }
    ...
    public static Dialog createLocationUpdateDialog(Activity parentActivity, User user, IntCallback callback) {
        int[] selected = new int[1];
        String[] descriptions = new String[]{LocaleController.getString("SendLiveLocationFor15m", C0431R.string.SendLiveLocationFor15m), LocaleController.getString("SendLiveLocationFor1h", C0431R.string.SendLiveLocationFor1h), LocaleController.getString("SendLiveLocationFor8h", C0431R.string.SendLiveLocationFor8h)};
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        linearLayout.setOrientation(1);
        TextView titleTextView = new TextView(parentActivity);
        if (user != null) {
            titleTextView.setText(LocaleController.formatString("LiveLocationAlertPrivate", C0431R.string.LiveLocationAlertPrivate, UserObject.getFirstName(user)));
        } else {
            titleTextView.setText(LocaleController.getString("LiveLocationAlertGroup", C0431R.string.LiveLocationAlertGroup));
        }
        ...
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("ShareFile", C0431R.string.ShareFile), new AlertsCreator$$Lambda$19(selected, callback));
        builder.setNeutralButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
        return builder.create();
    }
    ...
    public static Builder createContactsPermissionDialog(Activity parentActivity, IntCallback callback) {
        Builder builder = new Builder((Context) parentActivity);
        builder.setTopImage((int) C0431R.drawable.permissions_contacts, Theme.getColor(Theme.key_dialogTopBackground));
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.getString("ContactsPermissionAlert", C0431R.string.ContactsPermissionAlert)));
        builder.setPositiveButton(LocaleController.getString("ContactsPermissionAlertContinue", C0431R.string.ContactsPermissionAlertContinue), new AlertsCreator$$Lambda$20(callback));
        builder.setNegativeButton(LocaleController.getString("ContactsPermissionAlertNotNow", C0431R.string.ContactsPermissionAlertNotNow), new AlertsCreator$$Lambda$21(callback));
        return builder;
    }
    ...
    public static Dialog createFreeSpaceDialog(LaunchActivity parentActivity) {
        ...
        String[] descriptions = new String[]{LocaleController.formatPluralString("Days", 3), LocaleController.formatPluralString("Weeks", 1), LocaleController.formatPluralString("Months", 1), LocaleController.getString("LowDiskSpaceNeverRemove", C0431R.string.LowDiskSpaceNeverRemove)};
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        linearLayout.setOrientation(1);
        View titleTextView = new TextView(parentActivity);
        titleTextView.setText(LocaleController.getString("LowDiskSpaceTitle2", C0431R.string.LowDiskSpaceTitle2));
        titleTextView.setTextColor(Theme.getColor(Theme.key_dialogTextBlack));
        titleTextView.setTextSize(1, 16.0f);
        ...
        Builder builder = new Builder((Context) parentActivity);
        builder.setTitle(LocaleController.getString("LowDiskSpaceTitle", C0431R.string.LowDiskSpaceTitle));
        builder.setMessage(LocaleController.getString("LowDiskSpaceMessage", C0431R.string.LowDiskSpaceMessage));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("OK", C0431R.string.OK), new AlertsCreator$$Lambda$23(selected));
        builder.setNeutralButton(LocaleController.getString("ClearMediaCache", C0431R.string.ClearMediaCache), new AlertsCreator$$Lambda$24(parentActivity));
        return builder.create();
    }
    ...
    public static Dialog createPrioritySelectDialog(Activity parentActivity, BaseFragment parentFragment, long dialog_id, boolean globalGroup, boolean globalAll, Runnable onSelect) {
        ...
        if (dialog_id != 0) {
            ...
            descriptions = new String[]{LocaleController.getString("NotificationsPrioritySettings", C0431R.string.NotificationsPrioritySettings), LocaleController.getString("NotificationsPriorityLow", C0431R.string.NotificationsPriorityLow), LocaleController.getString("NotificationsPriorityMedium", C0431R.string.NotificationsPriorityMedium), LocaleController.getString("NotificationsPriorityHigh", C0431R.string.NotificationsPriorityHigh), LocaleController.getString("NotificationsPriorityUrgent", C0431R.string.NotificationsPriorityUrgent)};
        } else {
            if (globalAll) {
            ...
            descriptions = new String[]{LocaleController.getString("NotificationsPriorityLow", C0431R.string.NotificationsPriorityLow), LocaleController.getString("NotificationsPriorityMedium", C0431R.string.NotificationsPriorityMedium), LocaleController.getString("NotificationsPriorityHigh", C0431R.string.NotificationsPriorityHigh), LocaleController.getString("NotificationsPriorityUrgent", C0431R.string.NotificationsPriorityUrgent)};
        }
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        linearLayout.setOrientation(1);
        int a = 0;
        ...
        Builder builder = new Builder((Context) parentActivity);
        builder.setTitle(LocaleController.getString("NotificationsImportance", C0431R.string.NotificationsImportance));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
        return builder.create();
    }
    ...
    public static Dialog createPopupSelectDialog(Activity parentActivity, BaseFragment parentFragment, boolean globalGroup, boolean globalAll, Runnable onSelect) {
        ...
        String[] descriptions = new String[]{LocaleController.getString("NoPopup", C0431R.string.NoPopup), LocaleController.getString("OnlyWhenScreenOn", C0431R.string.OnlyWhenScreenOn), LocaleController.getString("OnlyWhenScreenOff", C0431R.string.OnlyWhenScreenOff), LocaleController.getString("AlwaysShowPopup", C0431R.string.AlwaysShowPopup)};
        LinearLayout linearLayout = new LinearLayout(parentActivity);
        linearLayout.setOrientation(1);
        int a = 0;
        while (a < descriptions.length) {
        ...
        Builder builder = new Builder((Context) parentActivity);
        builder.setTitle(LocaleController.getString("PopupNotification", C0431R.string.PopupNotification));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
        return builder.create();
    }
    ...
    public static Builder createTTLAlert(Context context, EncryptedChat encryptedChat) {
        Builder builder = new Builder(context);
        builder.setTitle(LocaleController.getString("MessageLifetime", C0431R.string.MessageLifetime));
        ...
        builder.setNegativeButton(LocaleController.getString("Done", C0431R.string.Done), new AlertsCreator$$Lambda$29(encryptedChat, numberPicker));
        return builder;
    }

    static final /* synthetic */ String lambda$createTTLAlert$29$AlertsCreator(int value) {
        if (value == 0) {
            return LocaleController.getString("ShortMessageLifetimeForever", C0431R.string.ShortMessageLifetimeForever);
        }
        if (value >= 1 && value < 16) {
    ...
    public static AlertDialog createAccountSelectDialog(Activity parentActivity, AccountSelectDelegate delegate) {
        ...
        builder.setTitle(LocaleController.getString("SelectAccount", C0431R.string.SelectAccount));
        builder.setView(linearLayout);
        builder.setPositiveButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null);
