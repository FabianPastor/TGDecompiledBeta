...
public class StickerMasksView extends FrameLayout implements NotificationCenterDelegate {
    ...
    class C12232 extends SpanSizeLookup {
        C12232() {
        }
    ...
    class C12254 implements OnItemClickListener {
        C12254() {
        }
    ...
    class C12265 implements ScrollSlidingTabStripDelegate {
        C12265() {
        }
    ...
    class C12276 extends OnScrollListener {
        C12276() {
        }
    ...
    class C12287 implements Runnable {
        C12287() {
        }
    ...
    public StickerMasksView(Context context) {
        ...
        this.stickersLayoutManager.setSpanSizeLookup(new C12232());
        ...
        this.stickersGridView.setOnTouchListener(new C12243());
        this.stickersOnItemClickListener = new C12254();
        ...
        updateStickerTabs();
        this.scrollSlidingTabStrip.setDelegate(new C12265());
        this.stickersGridView.setOnScrollListener(new C12276());
    }
    ...
    private void updateStickerTabs() {
        if (this.scrollSlidingTabStrip != null) {
            ...
            if (this.currentType == 0) {
                drawable = getContext().getResources().getDrawable(C0431R.drawable.ic_masks_msk1);
                ...
                drawable = getContext().getResources().getDrawable(C0431R.drawable.ic_masks_sticker1);
                Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
                this.scrollSlidingTabStrip.addIconTab(drawable);
                this.stickersEmptyView.setText(LocaleController.getString("NoMasks", C0431R.string.NoMasks));
            }
            if (!this.recentStickers[this.currentType].isEmpty()) {
                this.recentTabBum = this.stickersTabOffset;
                this.stickersTabOffset++;
                this.scrollSlidingTabStrip.addIconTab(Theme.createEmojiIconSelectorDrawable(getContext(), C0431R.drawable.ic_masks_recent1, Theme.getColor(Theme.key_chat_emojiPanelMasksIcon), Theme.getColor(Theme.key_chat_emojiPanelMasksIconSelected)));
            }
    ...
    protected void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(new C12287());
    }
