...
public class BackgroundGradientDrawable extends GradientDrawable {
    ...
    public /* synthetic */ void m2011xc8CLASSNAMEd9(View ownerView, Disposable delegate) {
    ...
    public /* synthetic */ void m2013xfdd06cfb(IntSize size, Runnable[] runnables, int index, Listener[] listenerReference) {
    ...
    public /* synthetic */ void m2012xd47CLASSNAMEba(Runnable[] runnables, Bitmap bitmap, IntSize size, int index, Listener[] listenerReference) {
    ...
    public /* synthetic */ void m2014x2724CLASSNAMEc(Listener[] listenerReference, Runnable[] runnables, IntSize[] sizesArr) {
        listenerReference[0] = null;
        if (this.ditheringRunnables.contains(runnables)) {
