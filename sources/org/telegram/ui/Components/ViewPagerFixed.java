...
public class ViewPagerFixed extends FrameLayout {
    ...
    public static class TabsView extends FrameLayout {
        ...
        public Runnable animationRunnable = new Runnable() {
            public void run() {
                if (TabsView.this.animatingIndicator) {
                    ...
                    TabsView.access$2816(TabsView.this, ((float) dt) / 200.0f);
        ...
        static /* synthetic */ float access$2816(TabsView x0, float x1) {
        ...
        public /* synthetic */ void m2723lambda$new$0$orgtelegramuiComponentsViewPagerFixed$TabsView(View view, int position, float x, float y) {
