...
public class CropRotationWheel extends FrameLayout {
    ...
    public /* synthetic */ void m2218lambda$new$0$orgtelegramuiComponentsCropCropRotationWheel(View v) {
    ...
    public /* synthetic */ boolean m2219lambda$new$1$orgtelegramuiComponentsCropCropRotationWheel(View v) {
    ...
    public /* synthetic */ void m2220lambda$new$2$orgtelegramuiComponentsCropCropRotationWheel(View v) {
        RotationWheelListener rotationWheelListener = this.rotationListener;
        if (rotationWheelListener != null) {
    ...
    public /* synthetic */ void m2221lambda$new$3$orgtelegramuiComponentsCropCropRotationWheel(View v) {
        RotationWheelListener rotationWheelListener = this.rotationListener;
        if (rotationWheelListener != null) {
