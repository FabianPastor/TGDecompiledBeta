        ...
        if (i5 == 1) {
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                try {
                    ...
                    float f4 = spacingAdd;
                    TextUtils.TruncateAt truncateAt22 = ellipsize;
                    FileLog.e((Throwable) e);
                    return null;
                }
                try {
                    try {
                        ...
                        TextUtils.TruncateAt truncateAt222 = ellipsize;
                        FileLog.e((Throwable) e);
                        return null;
                    }
                } catch (Exception e5) {
                    ...
                    float var_ = spacingMult;
                    float var_ = spacingAdd;
                    TextUtils.TruncateAt truncateAt2222 = ellipsize;
                    FileLog.e((Throwable) e);
                    return null;
                }
                try {
                    try {
                        ...
                        return maxLines2.setBreakStrategy(i6).setHyphenationFrequency(0).build();
                    } catch (Exception e6) {
                        e = e6;
                        FileLog.e((Throwable) e);
                        return null;
                    ...
                    e = e7;
                    TextUtils.TruncateAt truncateAt22222 = ellipsize;
                    FileLog.e((Throwable) e);
                    return null;
                }
            } else {
