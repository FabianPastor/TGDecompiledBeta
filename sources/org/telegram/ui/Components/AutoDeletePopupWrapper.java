...
public class AutoDeletePopupWrapper {
    ...
    public AutoDeletePopupWrapper(Context context, PopupSwipeBackLayout swipeBackLayout, Callback callback2, boolean createBackground, Theme.ResourcesProvider resourcesProvider) {
        ...
        gap.setBackgroundColor(Theme.getColor("graySection"));
        gap.setTag(NUM, 1);
    ...
    public /* synthetic */ void m3615lambda$new$1$orgtelegramuiComponentsAutoDeletePopupWrapper(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3616lambda$new$2$orgtelegramuiComponentsAutoDeletePopupWrapper(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3617lambda$new$3$orgtelegramuiComponentsAutoDeletePopupWrapper(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3618lambda$new$5$orgtelegramuiComponentsAutoDeletePopupWrapper(Context context, Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3619lambda$new$6$orgtelegramuiComponentsAutoDeletePopupWrapper(Callback callback2, View view) {
        dismiss();
    ...
    public void m3620xf8eeadab(int ttl) {
