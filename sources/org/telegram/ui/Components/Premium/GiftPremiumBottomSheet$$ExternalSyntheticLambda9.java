...
public final /* synthetic */ class GiftPremiumBottomSheet$$ExternalSyntheticLambda9 implements RequestDelegate {
    ...
    public /* synthetic */ GiftPremiumBottomSheet$$ExternalSyntheticLambda9(GiftPremiumBottomSheet giftPremiumBottomSheet, TLRPC$TL_inputStorePaymentGiftPremium tLRPC$TL_inputStorePaymentGiftPremium, GiftPremiumBottomSheet.GiftTier giftTier, TLRPC$TL_payments_canPurchasePremium tLRPC$TL_payments_canPurchasePremium) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$onGiftPremium$10(this.f$1, this.f$2, this.f$3, tLObject, tLRPC$TL_error);
    }
}
