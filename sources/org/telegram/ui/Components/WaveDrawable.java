...
public class WaveDrawable {
    ...
    public /* synthetic */ void m4526lambda$new$0$orgtelegramuiComponentsWaveDrawable(ValueAnimator animation) {
    ...
    public /* synthetic */ void m4527lambda$setValue$1$orgtelegramuiComponentsWaveDrawable(float animateToBRotation, float bRotation, float animateToTRotation, float tRotation, float bWaveDif, float tWaveDif, ValueAnimator animation) {
