...
public class WaveDrawable {
    ...
    public /* synthetic */ void m1559lambda$new$0$orgtelegramuiComponentsWaveDrawable(ValueAnimator animation) {
    ...
    public /* synthetic */ void m1560lambda$setValue$1$orgtelegramuiComponentsWaveDrawable(float animateToBRotation, float bRotation, float animateToTRotation, float tRotation, float bWaveDif, float tWaveDif, ValueAnimator animation) {
