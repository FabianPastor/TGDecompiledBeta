...
public class InstantCameraView extends FrameLayout implements NotificationCenterDelegate {
     ...
     */
        ...
        public /* synthetic */ void lambda$handleStopRecording$3$InstantCameraView$VideoRecorder(int i) {
            ...
            if (i != 1) {
                ...
                animatorArr[0] = ObjectAnimator.ofFloat(InstantCameraView.this.switchCameraButton, View.ALPHA, new float[]{0.0f});
                animatorArr[1] = ObjectAnimator.ofInt(InstantCameraView.this.paint, "alpha", new int[]{0});
                animatorArr[2] = ObjectAnimator.ofFloat(InstantCameraView.this.muteImageView, View.ALPHA, new float[]{1.0f});
                ...
                if (dequeueOutputBuffer == -1) {
                    ...
                    if (dequeueOutputBuffer == -2) {
                        ...
                        if (this.videoTrackIndex == -5) {
                            ...
                            String str3 = "prepend-sps-pps-to-idr-frames";
                            if (outputFormat.containsKey(str3) && outputFormat.getInteger(str3) == 1) {
                                this.prependHeaderSize = outputFormat.getByteBuffer(str2).limit() + outputFormat.getByteBuffer(str).limit();
                            }
                        }
                        ...
                        if (byteBuffer != null) {
                            ...
                            if (i2 > 1) {
                                ...
                                if ((i3 & 2) == 0) {
                                    ...
                                    if (this.firstEncode) {
                                        bufferInfo = this.videoBufferInfo;
                                        if ((bufferInfo.flags & 1) != 0) {
                                            if (bufferInfo.size > 100) {
                                                ...
                                                while (i2 < bArr.length - 4) {
                                                    if (bArr[i2] == (byte) 0 && bArr[i2 + 1] == (byte) 0 && bArr[i2 + 2] == (byte) 0 && bArr[i2 + 3] == (byte) 1) {
                                                        i3++;
                                                        if (i3 > 1) {
                                                            bufferInfo = this.videoBufferInfo;
                                    ...
                                    while (i >= 0 && i > 3) {
                                        if (bArr2[i] == b && bArr2[i - 1] == (byte) 0 && bArr2[i - 2] == (byte) 0) {
                                            i2 = i - 3;
                                            if (bArr2[i2] == (byte) 0) {
                                                allocate = ByteBuffer.allocate(i2);
                                                byteBuffer = ByteBuffer.allocate(this.videoBufferInfo.size - i2);
                                                allocate.put(bArr2, 0, i2).position(0);
                                                byteBuffer.put(bArr2, i2, this.videoBufferInfo.size - i2).position(0);
                                                break;
                                            }
                                        }
                                        i--;
                                    ...
                                    if (!(allocate == null || byteBuffer == null)) {
                                        createVideoFormat.setByteBuffer(str2, allocate);
                                        createVideoFormat.setByteBuffer(str, byteBuffer);
                                    }
            ...
            while (true) {
                ...
                if (i == -1) {
                    ...
                    if (byteBuffer2 != null) {
                        ...
                        bufferInfo2 = this.audioBufferInfo;
                        if (bufferInfo2.size != 0) {
                            long writeSampleData2 = this.mediaMuxer.writeSampleData(this.audioTrackIndex, byteBuffer2, bufferInfo2, false);
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (chatActivity != null) {
                ...
                if (videoPlayer != null) {
                    ...
                    fArr2[0] = f;
                    animatorArr[2] = ObjectAnimator.ofFloat(imageView2, property2, fArr2);
                    animatorSet.playTogether(animatorArr);
    ...
    public void startAnimation(boolean z) {
        ...
        fArr3 = new float[1];
        fArr3[0] = z ? 1.0f : 0.1f;
        animatorArr[5] = ObjectAnimator.ofFloat(frameLayout, property3, fArr3);
        frameLayout = this.cameraContainer;
        property3 = View.SCALE_Y;
        fArr3 = new float[1];
        fArr3[0] = z ? 1.0f : 0.1f;
        animatorArr[6] = ObjectAnimator.ofFloat(frameLayout, property3, fArr3);
        frameLayout = this.cameraContainer;
        property3 = View.TRANSLATION_Y;
        fArr3 = new float[2];
        fArr3[0] = z ? (float) (getMeasuredHeight() / 2) : 0.0f;
        fArr3[1] = z ? 0.0f : (float) (getMeasuredHeight() / 2);
        animatorArr[7] = ObjectAnimator.ofFloat(frameLayout, property3, fArr3);
        BackupImageView backupImageView = this.textureOverlayView;
        property3 = View.ALPHA;
        fArr3 = new float[1];
        fArr3[0] = z ? 1.0f : 0.0f;
        animatorArr[8] = ObjectAnimator.ofFloat(backupImageView, property3, fArr3);
        backupImageView = this.textureOverlayView;
        property3 = View.SCALE_X;
        fArr3 = new float[1];
        fArr3[0] = z ? 1.0f : 0.1f;
        animatorArr[9] = ObjectAnimator.ofFloat(backupImageView, property3, fArr3);
        backupImageView = this.textureOverlayView;
        property3 = View.SCALE_Y;
        fArr3 = new float[1];
        if (!z) {
        ...
        fArr3[0] = f;
        animatorArr[10] = ObjectAnimator.ofFloat(backupImageView, property3, fArr3);
        ...
        fArr4[1] = f2;
        animatorArr[11] = ObjectAnimator.ofFloat(backupImageView2, property4, fArr4);
        animatorSet.playTogether(animatorArr);
        if (!z) {
