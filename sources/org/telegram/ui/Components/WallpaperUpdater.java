...
public class WallpaperUpdater {
    ...
    public void showAlert(boolean fromTheme) {
        ...
        builder.setItems(fromTheme ? new CharSequence[]{LocaleController.getString("FromCamera", C0431R.string.FromCamera), LocaleController.getString("FromGalley", C0431R.string.FromGalley), LocaleController.getString("SelectColor", C0431R.string.SelectColor), LocaleController.getString("Default", C0431R.string.Default), LocaleController.getString("Cancel", C0431R.string.Cancel)} : new CharSequence[]{LocaleController.getString("FromCamera", C0431R.string.FromCamera), LocaleController.getString("FromGalley", C0431R.string.FromGalley), LocaleController.getString("Cancel", C0431R.string.Cancel)}, new WallpaperUpdater$$Lambda$0(this, fromTheme));
        builder.show();
    }
            ...
            try {
                ...
                if (image != null) {
                    if (VERSION.SDK_INT >= 24) {
                        takePictureIntent.putExtra("output", FileProvider.getUriForFile(this.parentActivity, "org.telegram.messenger.provider", image));
