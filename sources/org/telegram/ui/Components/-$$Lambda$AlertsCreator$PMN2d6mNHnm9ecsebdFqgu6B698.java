...
public final /* synthetic */ class -$$Lambda$AlertsCreator$PMN2d6mNHnm9ecsebdFqgu6B698 implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$AlertsCreator$PMN2d6mNHnm9ecsebdFqgu6B698(AlertDialog[] alertDialogArr, TLObject tLObject, BaseFragment baseFragment, User user, Chat chat, EncryptedChat encryptedChat, ChatFull chatFull, long j, MessageObject messageObject, SparseArray[] sparseArrayArr, GroupedMessages groupedMessages, boolean z, Runnable runnable) {
    ...
    public final void run() {
        AlertsCreator.lambda$null$50(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12);
    }
}
