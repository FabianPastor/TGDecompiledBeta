...
public class RoundVideoPlayingDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            canvas.drawRect((float) (AndroidUtilities.dp(2.0f) + i), (float) (AndroidUtilities.dp((r0.progress1 * 7.0f) + 2.0f) + i2), (float) (AndroidUtilities.dp(4.0f) + i), (float) (AndroidUtilities.dp(10.0f) + i2), r0.paint);
            Canvas canvas2 = canvas;
            canvas2.drawRect((float) (AndroidUtilities.dp(5.0f) + i), (float) (AndroidUtilities.dp((r0.progress2 * 7.0f) + 2.0f) + i2), (float) (AndroidUtilities.dp(7.0f) + i), (float) (AndroidUtilities.dp(10.0f) + i2), r0.paint);
            canvas2.drawRect((float) (AndroidUtilities.dp(8.0f) + i), (float) (AndroidUtilities.dp(2.0f + (7.0f * r0.progress3)) + i2), (float) (AndroidUtilities.dp(10.0f) + i), (float) (AndroidUtilities.dp(10.0f) + i2), r0.paint);
        }
        if (r0.started) {
            update();
        }
