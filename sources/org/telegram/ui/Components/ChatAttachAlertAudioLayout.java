...
public class ChatAttachAlertAudioLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2117x64d1var_e(View view, int position) {
        onItemClick(view);
    }

    /* renamed from: lambda$new$2$org-telegram-ui-Components-ChatAttachAlertAudioLayout  reason: not valid java name */
    public /* synthetic */ boolean m2118x8e26456f(View view, int position) {
        onItemClick(view);
        return true;
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:30:0x0187 A[SYNTHETIC, Splitter:B:30:0x0187] */
    ...
    public /* synthetic */ void m2116x5var_a1() {
        /*
            r18 = this;
            r1 = r18
            r0 = 6
            ...
            r0.<init>()
            r14 = r0
            android.content.Context r0 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch:{ Exception -> 0x018f }
            android.content.ContentResolver r2 = r0.getContentResolver()     // Catch:{ Exception -> 0x018f }
            android.net.Uri r3 = android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI     // Catch:{ Exception -> 0x018f }
            java.lang.String r5 = "is_music != 0"
            r6 = 0
            java.lang.String r7 = "title"
            android.database.Cursor r0 = r2.query(r3, r4, r5, r6, r7)     // Catch:{ Exception -> 0x018f }
            r2 = r0
            r0 = -2000000000(0xfffffffvar_ca6CLASSNAME, float:-1.2182823E-33)
        L_0x003e:
            boolean r3 = r2.moveToNext()     // Catch:{ all -> 0x0182 }
            if (r3 == 0) goto L_0x017b
            org.telegram.messenger.MediaController$AudioEntry r3 = new org.telegram.messenger.MediaController$AudioEntry     // Catch:{ all -> 0x0182 }
            r3.<init>()     // Catch:{ all -> 0x0182 }
            int r5 = r2.getInt(r8)     // Catch:{ all -> 0x0182 }
            long r5 = (long) r5     // Catch:{ all -> 0x0182 }
            r3.id = r5     // Catch:{ all -> 0x0182 }
            java.lang.String r5 = r2.getString(r9)     // Catch:{ all -> 0x0182 }
            r3.author = r5     // Catch:{ all -> 0x0182 }
            java.lang.String r5 = r2.getString(r10)     // Catch:{ all -> 0x0182 }
            r3.title = r5     // Catch:{ all -> 0x0182 }
            java.lang.String r5 = r2.getString(r11)     // Catch:{ all -> 0x0182 }
            r3.path = r5     // Catch:{ all -> 0x0182 }
            long r5 = r2.getLong(r12)     // Catch:{ all -> 0x0182 }
            r15 = 1000(0x3e8, double:4.94E-321)
            long r5 = r5 / r15
            int r6 = (int) r5     // Catch:{ all -> 0x0182 }
            r3.duration = r6     // Catch:{ all -> 0x0182 }
            java.lang.String r5 = r2.getString(r13)     // Catch:{ all -> 0x0182 }
            r3.genre = r5     // Catch:{ all -> 0x0182 }
            java.io.File r5 = new java.io.File     // Catch:{ all -> 0x0182 }
            java.lang.String r6 = r3.path     // Catch:{ all -> 0x0182 }
            r5.<init>(r6)     // Catch:{ all -> 0x0182 }
            org.telegram.tgnet.TLRPC$TL_message r6 = new org.telegram.tgnet.TLRPC$TL_message     // Catch:{ all -> 0x0182 }
            r6.<init>()     // Catch:{ all -> 0x0182 }
            r6.out = r9     // Catch:{ all -> 0x0182 }
            r6.id = r0     // Catch:{ all -> 0x0182 }
            org.telegram.tgnet.TLRPC$TL_peerUser r7 = new org.telegram.tgnet.TLRPC$TL_peerUser     // Catch:{ all -> 0x0182 }
            r7.<init>()     // Catch:{ all -> 0x0182 }
            r6.peer_id = r7     // Catch:{ all -> 0x0182 }
            org.telegram.tgnet.TLRPC$TL_peerUser r7 = new org.telegram.tgnet.TLRPC$TL_peerUser     // Catch:{ all -> 0x0182 }
            r7.<init>()     // Catch:{ all -> 0x0182 }
            r6.from_id = r7     // Catch:{ all -> 0x0182 }
            org.telegram.tgnet.TLRPC$Peer r7 = r6.peer_id     // Catch:{ all -> 0x0182 }
            org.telegram.tgnet.TLRPC$Peer r10 = r6.from_id     // Catch:{ all -> 0x0182 }
            org.telegram.ui.Components.ChatAttachAlert r12 = r1.parentAlert     // Catch:{ all -> 0x0182 }
            int r12 = r12.currentAccount     // Catch:{ all -> 0x0182 }
            org.telegram.messenger.UserConfig r12 = org.telegram.messenger.UserConfig.getInstance(r12)     // Catch:{ all -> 0x0182 }
            r17 = r14
            long r13 = r12.getClientUserId()     // Catch:{ all -> 0x0176 }
            r10.user_id = r13     // Catch:{ all -> 0x0176 }
            r7.user_id = r13     // Catch:{ all -> 0x0176 }
            long r12 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0176 }
            long r12 = r12 / r15
            int r7 = (int) r12     // Catch:{ all -> 0x0176 }
            r6.date = r7     // Catch:{ all -> 0x0176 }
            java.lang.String r7 = ""
            r6.message = r7     // Catch:{ all -> 0x0176 }
            java.lang.String r7 = r3.path     // Catch:{ all -> 0x0176 }
            r6.attachPath = r7     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$TL_messageMediaDocument r7 = new org.telegram.tgnet.TLRPC$TL_messageMediaDocument     // Catch:{ all -> 0x0176 }
            r7.<init>()     // Catch:{ all -> 0x0176 }
            r6.media = r7     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r7 = r6.media     // Catch:{ all -> 0x0176 }
            int r10 = r7.flags     // Catch:{ all -> 0x0176 }
            r10 = r10 | r11
            r7.flags = r10     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r7 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$TL_document r10 = new org.telegram.tgnet.TLRPC$TL_document     // Catch:{ all -> 0x0176 }
            r10.<init>()     // Catch:{ all -> 0x0176 }
            r7.document = r10     // Catch:{ all -> 0x0176 }
            int r7 = r6.flags     // Catch:{ all -> 0x0176 }
            r7 = r7 | 768(0x300, float:1.076E-42)
            r6.flags = r7     // Catch:{ all -> 0x0176 }
            java.lang.String r7 = org.telegram.messenger.FileLoader.getFileExtension(r5)     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            r12 = 0
            r10.id = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            r10.access_hash = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            byte[] r12 = new byte[r8]     // Catch:{ all -> 0x0176 }
            r10.file_reference = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            int r12 = r6.date     // Catch:{ all -> 0x0176 }
            r10.date = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            java.lang.StringBuilder r12 = new java.lang.StringBuilder     // Catch:{ all -> 0x0176 }
            r12.<init>()     // Catch:{ all -> 0x0176 }
            java.lang.String r13 = "audio/"
            r12.append(r13)     // Catch:{ all -> 0x0176 }
            int r13 = r7.length()     // Catch:{ all -> 0x0176 }
        ...
        L_0x010d:
            r12.append(r13)     // Catch:{ all -> 0x0176 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x0176 }
            r10.mime_type = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            long r12 = r5.length()     // Catch:{ all -> 0x0176 }
            int r13 = (int) r12     // Catch:{ all -> 0x0176 }
            r10.size = r13     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r10 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r10 = r10.document     // Catch:{ all -> 0x0176 }
            r10.dc_id = r8     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$TL_documentAttributeAudio r10 = new org.telegram.tgnet.TLRPC$TL_documentAttributeAudio     // Catch:{ all -> 0x0176 }
            r10.<init>()     // Catch:{ all -> 0x0176 }
            int r12 = r3.duration     // Catch:{ all -> 0x0176 }
            r10.duration = r12     // Catch:{ all -> 0x0176 }
            java.lang.String r12 = r3.title     // Catch:{ all -> 0x0176 }
            r10.title = r12     // Catch:{ all -> 0x0176 }
            java.lang.String r12 = r3.author     // Catch:{ all -> 0x0176 }
            r10.performer = r12     // Catch:{ all -> 0x0176 }
            int r12 = r10.flags     // Catch:{ all -> 0x0176 }
            r12 = r12 | r11
            r10.flags = r12     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r12 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r12 = r12.document     // Catch:{ all -> 0x0176 }
            java.util.ArrayList<org.telegram.tgnet.TLRPC$DocumentAttribute> r12 = r12.attributes     // Catch:{ all -> 0x0176 }
            r12.add(r10)     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$TL_documentAttributeFilename r12 = new org.telegram.tgnet.TLRPC$TL_documentAttributeFilename     // Catch:{ all -> 0x0176 }
            r12.<init>()     // Catch:{ all -> 0x0176 }
            java.lang.String r13 = r5.getName()     // Catch:{ all -> 0x0176 }
            r12.file_name = r13     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$MessageMedia r13 = r6.media     // Catch:{ all -> 0x0176 }
            org.telegram.tgnet.TLRPC$Document r13 = r13.document     // Catch:{ all -> 0x0176 }
            java.util.ArrayList<org.telegram.tgnet.TLRPC$DocumentAttribute> r13 = r13.attributes     // Catch:{ all -> 0x0176 }
            r13.add(r12)     // Catch:{ all -> 0x0176 }
            org.telegram.messenger.MessageObject r13 = new org.telegram.messenger.MessageObject     // Catch:{ all -> 0x0176 }
            org.telegram.ui.Components.ChatAttachAlert r14 = r1.parentAlert     // Catch:{ all -> 0x0176 }
            int r14 = r14.currentAccount     // Catch:{ all -> 0x0176 }
            r13.<init>(r14, r6, r8, r9)     // Catch:{ all -> 0x0176 }
            r3.messageObject = r13     // Catch:{ all -> 0x0176 }
            r13 = r17
            r13.add(r3)     // Catch:{ all -> 0x0173 }
            int r0 = r0 + -1
            r14 = r13
            r10 = 2
            r12 = 4
        ...
        L_0x018b:
            r0 = move-exception
        L_0x018c:
            throw r3     // Catch:{ Exception -> 0x018d }
        L_0x018d:
            r0 = move-exception
            goto L_0x0191
        L_0x018f:
        ...
        L_0x0194:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlertAudioLayout.m2116x5var_a1():void");
    }

    /* renamed from: lambda$loadAudio$3$org-telegram-ui-Components-ChatAttachAlertAudioLayout  reason: not valid java name */
    public /* synthetic */ void m2115x361e2160(ArrayList newAudioEntries) {
    ...
    public class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void m2120xb4e282d3(String query, int searchId) {
        ...
        public /* synthetic */ void m2119xCLASSNAMEvar_(String query, ArrayList copy, int searchId) {
        ...
        public /* synthetic */ void m2121x2081177(int searchId, String query, ArrayList result) {
