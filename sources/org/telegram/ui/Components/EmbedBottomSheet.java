...
public class EmbedBottomSheet extends BottomSheet {
    ...
    private EmbedBottomSheet(Context context, String title, String description, String originalUrl, String url, int w, int h) {
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new C11282());
        ...
        this.containerLayout.setOnTouchListener(new C11304());
        ...
        this.webView.setWebChromeClient(new C11326());
        this.webView.setWebViewClient(new C11337());
        ...
        this.youtubeLogoImage.setOnClickListener(new C11348());
        this.videoView = new WebPlayerView(context, true, false, new C20459());
