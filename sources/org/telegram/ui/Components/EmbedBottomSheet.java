...
public class EmbedBottomSheet extends BottomSheet {
    ...
    class C10081 implements OnShowListener {

        /* renamed from: org.telegram.ui.Components.EmbedBottomSheet$1$1 */
        class C10041 implements OnPreDrawListener {
            C10041() {
            }
        ...
        public void onShow(DialogInterface dialog) {
            if (EmbedBottomSheet.this.pipVideoView != null && EmbedBottomSheet.this.videoView.isInline()) {
                EmbedBottomSheet.this.videoView.getViewTreeObserver().addOnPreDrawListener(new C10041());
            }
        }
    }

    /* renamed from: org.telegram.ui.Components.EmbedBottomSheet$2 */
    class C10092 implements OnTouchListener {
        C10092() {
        }
    ...
    class C10103 implements OnTouchListener {
        C10103() {
        }
    ...
    class C10147 extends WebChromeClient {
        C10147() {
        }
    ...
    class C10158 extends WebViewClient {
        C10158() {
        }
    ...
    class C10169 implements OnClickListener {
        C10169() {
        }
    ...
    private EmbedBottomSheet(Context context, String title, String description, String originalUrl, String url, int w, int h) {
        ...
        this.onShowListener = new C10081();
        this.fullWidth = true;
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new C10092());
        this.container.addView(this.fullscreenVideoContainer, LayoutHelper.createFrame(-1, -1.0f));
        this.fullscreenVideoContainer.setVisibility(4);
        this.fullscreenVideoContainer.setOnTouchListener(new C10103());
        ...
        this.containerLayout.setOnTouchListener(new C10125());
        ...
        this.webView.setWebChromeClient(new C10147());
        this.webView.setWebViewClient(new C10158());
        ...
        this.youtubeLogoImage.setOnClickListener(new C10169());
            ...
            public void prepareToSwitchInlineMode(boolean inline, Runnable switchInlineModeRunnable, float aspectRatio, boolean animated) {
                if (inline) {
                    ...
                    if (animated) {
                        ...
                        r9[2] = ObjectAnimator.ofFloat(textureImageView, "translationX", new float[]{rect.f70x});
                        r9[3] = ObjectAnimator.ofFloat(textureImageView, "translationY", new float[]{rect.f71y});
                        ...
                        r9[6] = ObjectAnimator.ofFloat(textureView, "translationX", new float[]{rect.f70x});
                        r9[7] = ObjectAnimator.ofFloat(textureView, "translationY", new float[]{rect.f71y});
                ...
                if (animated) {
                    ...
                    textureImageView.setTranslationX(rect.f70x);
                    textureImageView.setTranslationY(rect.f71y);
                    textureView.setScaleX(scale);
                    textureView.setScaleY(scale);
                    textureView.setTranslationX(rect.f70x);
                    textureView.setTranslationY(rect.f71y);
                } else {
        ...
        textView.setPadding(AndroidUtilities.dp(18.0f), 0, AndroidUtilities.dp(18.0f), 0);
        textView.setText(LocaleController.getString("Close", C0431R.string.Close).toUpperCase());
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.pipButton.setImageResource(C0431R.drawable.video_pip);
        ...
        this.pipButton.setOnClickListener(new OnClickListener() {
            ...
            class C10071 extends AnimatorListenerAdapter {
                C10071() {
                }
            ...
            public void onClick(View v) {
                if (EmbedBottomSheet.this.checkInlinePermissions() && EmbedBottomSheet.this.progressBar.getVisibility() != 0) {
                    ...
                    if (false) {
                        ...
                        animatorSet.setInterpolator(new DecelerateInterpolator());
                        animatorSet.setDuration(250);
                        animatorSet.addListener(new C10071());
                        animatorSet.start();
                    } else {
                        EmbedBottomSheet.this.containerView.setTranslationY(0.0f);
                    }
        ...
        OnClickListener copyClickListener = new OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(EmbedBottomSheet.this.getContext(), LocaleController.getString("LinkCopied", C0431R.string.LinkCopied), 0).show();
                EmbedBottomSheet.this.dismiss();
            }
        };
        ImageView copyButton = new ImageView(context);
        copyButton.setScaleType(ScaleType.CENTER);
        copyButton.setImageResource(C0431R.drawable.video_copy);
        ...
        this.copyTextButton.setText(LocaleController.getString("Copy", C0431R.string.Copy).toUpperCase());
        ...
        this.openInButton.setText(LocaleController.getString("OpenInBrowser", C0431R.string.OpenInBrowser).toUpperCase());
            ...
            public void onOpenAnimationEnd() {
                ...
                try {
                    if (EmbedBottomSheet.this.videoView.getYoutubeId() != null) {
                        ...
                        EmbedBottomSheet.this.youtubeLogoImage.setImageResource(C0431R.drawable.ytlogo);
                        ...
                        EmbedBottomSheet.this.webView.loadDataWithBaseURL("https://www.youtube.com", String.format(Locale.US, "<!DOCTYPE html><html><head><style>body { margin: 0; width:100%%; height:100%%;  background-color:#000; }html { width:100%%; height:100%%; background-color:#000; }.embed-container iframe,.embed-container object,   .embed-container embed {       position: absolute;       top: 0;       left: 0;       width: 100%% !important;       height: 100%% !important;   }   </style></head><body>   <div class=\"embed-container\">       <div id=\"player\"></div>   </div>   <script src=\"https://www.youtube.com/iframe_api\"></script>   <script>   var player;   var observer;   var videoEl;   var playing;   var posted = false;   YT.ready(function() {       player = new YT.Player(\"player\", {                              \"width\" : \"100%%\",                              \"events\" : {                              \"onReady\" : \"onReady\",                              \"onError\" : \"onError\",                              },                              \"videoId\" : \"%1$s\",                              \"height\" : \"100%%\",                              \"playerVars\" : {                              \"start\" : %2$d,                              \"rel\" : 0,                              \"showinfo\" : 0,                              \"modestbranding\" : 1,                              \"iv_load_policy\" : 3,                              \"autohide\" : 1,                              \"autoplay\" : 1,                              \"cc_load_policy\" : 1,                              \"playsinline\" : 1,                              \"controls\" : 1                              }                            });        player.setSize(window.innerWidth, window.innerHeight);    });    function hideControls() {        playing = !videoEl.paused;       videoEl.controls = 0;       observer.observe(videoEl, {attributes: true});    }    function showControls() {        playing = !videoEl.paused;       observer.disconnect();       videoEl.controls = 1;    }    function onError(event) {       if (!posted) {            if (window.YoutubeProxy !== undefined) {                   YoutubeProxy.postEvent(\"loaded\", null);             }            posted = true;       }    }    function onReady(event) {       player.playVideo();       videoEl = player.getIframe().contentDocument.getElementsByTagName('video')[0];\n       videoEl.addEventListener(\"canplay\", function() {            if (playing) {               videoEl.play();            }       }, true);       videoEl.addEventListener(\"timeupdate\", function() {            if (!posted && videoEl.currentTime > 0) {               if (window.YoutubeProxy !== undefined) {                   YoutubeProxy.postEvent(\"loaded\", null);                }               posted = true;           }       }, true);       observer = new MutationObserver(function() {\n          if (videoEl.controls) {\n               videoEl.controls = 0;\n          }       });\n    }    window.onresize = function() {        player.setSize(window.innerWidth, window.innerHeight);    }    </script></body></html>", new Object[]{currentYoutubeId, Integer.valueOf(seekToTime)}), "text/html", C0020C.UTF8_NAME, "http://youtube.com");
                        return;
                    }
                    EmbedBottomSheet.this.webView.loadUrl(EmbedBottomSheet.this.embedUrl, args);
                } catch (Throwable e2) {
