...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda41 implements View.OnClickListener {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda41(ActionBarMenuItem actionBarMenuItem, AlertsCreator.ScheduleDatePickerColors scheduleDatePickerColors) {
        this.f$0 = actionBarMenuItem;
        this.f$1 = scheduleDatePickerColors;
    }

    public final void onClick(View view) {
        AlertsCreator.lambda$createScheduleDatePickerDialog$38(this.f$0, this.f$1, view);
    }
}
