...
public class ForwardingPreviewView extends FrameLayout {
    ...
    public ForwardingPreviewView(Context context, ForwardingMessagesParams params, TLRPC.User user, TLRPC.Chat chat, int currentAccount2, ResourcesDelegate resourcesProvider2) {
        ...
        AnonymousClass5 r02 = new ChatListItemAnimator((ChatActivity) null, this.chatListView, resourcesProvider2) {
            ...
            public /* synthetic */ void m984xaa159a02(int currentAccount) {
                if (this.scrollAnimationIndex != -1) {
            ...
            public /* synthetic */ void m985xd7ee3461() {
            ...
            public /* synthetic */ void m983xCLASSNAMEa9(int currentAccount) {
                if (this.scrollAnimationIndex != -1) {
                    NotificationCenter.getInstance(currentAccount).onAnimationFinish(this.scrollAnimationIndex);
                    this.scrollAnimationIndex = -1;
                }
            ...
            public void onItemClick(View view, int position) {
                if (ForwardingPreviewView.this.forwardingMessagesParams.previewMessages.size() > 1) {
                    ...
                    if (ForwardingPreviewView.this.forwardingMessagesParams.selectedIds.size() != 1 || newSelected) {
                        ...
                        ForwardingPreviewView.this.actionBar.setTitle(LocaleController.formatPluralString("PreviewForwardMessagesCount", forwardingMessagesParams2.selectedIds.size(), new Object[0]));
                    }
                }
            }
        });
        ...
        AnonymousClass8 r03 = new GridLayoutManagerFixed(context, 1000, 1, true) {
            ...
            public /* synthetic */ void m986xcccee436() {
    ...
    public /* synthetic */ void m974lambda$new$0$orgtelegramuiComponentsForwardingPreviewView(ForwardingMessagesParams params, View view) {
    ...
    public /* synthetic */ void m975lambda$new$1$orgtelegramuiComponentsForwardingPreviewView(ForwardingMessagesParams params, View view) {
        if (!params.hideForwardSendersName) {
            this.returnSendersNames = false;
    ...
    public /* synthetic */ void m976lambda$new$2$orgtelegramuiComponentsForwardingPreviewView(ForwardingMessagesParams params, View view) {
    ...
    public /* synthetic */ void m977lambda$new$3$orgtelegramuiComponentsForwardingPreviewView(ForwardingMessagesParams params, View view) {
        if (!params.hideCaption) {
    ...
    public /* synthetic */ void m978lambda$new$4$orgtelegramuiComponentsForwardingPreviewView(View View) {
        didSendPressed();
    }

    /* renamed from: lambda$new$5$org-telegram-ui-Components-ForwardingPreviewView  reason: not valid java name */
    public /* synthetic */ void m979lambda$new$5$orgtelegramuiComponentsForwardingPreviewView(View view) {
        selectAnotherChat();
    }

    /* renamed from: lambda$new$6$org-telegram-ui-Components-ForwardingPreviewView  reason: not valid java name */
    public /* synthetic */ boolean m980lambda$new$6$orgtelegramuiComponentsForwardingPreviewView(View view, MotionEvent motionEvent) {
    ...
    public /* synthetic */ boolean m981lambda$new$7$orgtelegramuiComponentsForwardingPreviewView(View view, MotionEvent motionEvent) {
        if (motionEvent.getAction() == 1) {
            dismiss(true);
        }
        return true;
    ...
    public /* synthetic */ void m982x83256e3b(int lastTopOffset, float lastYOffset, ValueAnimator valueAnimator) {
