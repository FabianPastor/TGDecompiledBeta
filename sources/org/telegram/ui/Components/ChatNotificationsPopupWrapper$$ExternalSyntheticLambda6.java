...
public final /* synthetic */ class ChatNotificationsPopupWrapper$$ExternalSyntheticLambda6 implements View.OnClickListener {
    ...
    public /* synthetic */ ChatNotificationsPopupWrapper$$ExternalSyntheticLambda6(ChatNotificationsPopupWrapper chatNotificationsPopupWrapper, ChatNotificationsPopupWrapper.Callback callback) {
        this.f$0 = chatNotificationsPopupWrapper;
        this.f$1 = callback;
    }

    public final void onClick(View view) {
        this.f$0.m3909x6865fa02(this.f$1, view);
    }
}
