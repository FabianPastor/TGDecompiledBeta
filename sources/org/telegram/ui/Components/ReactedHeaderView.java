...
public class ReactedHeaderView extends FrameLayout {
    ...
    public /* synthetic */ void m4276xe1027737(long fromId, TLRPC.Chat chat, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4271x41acb31c(List usersRes) {
    ...
    public /* synthetic */ void m4273xb49bce5a(List usersToRequest, List usersRes, Runnable callback, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m4272xfb2440bb(TLObject response1, List usersToRequest, List usersRes, Runnable callback) {
        if (response1 != null) {
    ...
    public /* synthetic */ void m4275x278ae998(List usersToRequest, List usersRes, Runnable callback, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m4274x6e135bf9(TLObject response1, List usersToRequest, List usersRes, Runnable callback) {
        if (response1 != null) {
    ...
    public /* synthetic */ void m4270xd9ccebf9(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4269x20555e5a(int c, TLRPC.TL_messages_messageReactionsList list) {
        String str;
        String countStr;
        ...
        if (this.message.messageOwner.reactions != null && this.message.messageOwner.reactions.results.size() == 1 && !list.reactions.isEmpty()) {
            ...
            while (true) {
                ...
                if (r.reaction.equals(list.reactions.get(0).reaction)) {
                    this.reactView.setImage(ImageLocation.getForDocument(r.static_icon), "50_50", "webp", (Drawable) null, (Object) r);
