...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda37 implements View.OnClickListener {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda37(long j, int i, boolean z, MessagesStorage.IntCallback intCallback, int i2, BaseFragment baseFragment, ArrayList arrayList, MessagesStorage.IntCallback intCallback2, AlertDialog.Builder builder) {
        this.f$0 = j;
        this.f$1 = i;
        this.f$2 = z;
