...
public final /* synthetic */ class SlotsDrawable$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ SlotsDrawable$$ExternalSyntheticLambda0(TLRPC.Document document, int i, MessageObject messageObject, ChatMessageCell chatMessageCell, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.f$0 = document;
        this.f$1 = i;
