...
public class BiometricPromtHelper {
    ...
    static final String[] badBiometricModels = {"SM-G95", "SM-G96", "SM-G97", "SM-N95", "SM-N96", "SM-N97", "SM-A20"};
    static final String[] hideBiometricModels = {"SM-G97", "SM-N97"};
    ...
    /* access modifiers changed from: private */
    public void promtWithCipher(Cipher cipher, String str, CipherCallback cipherCallback, boolean z) {
        BaseFragment baseFragment;
        final Cipher cipher2 = cipher;
        final String str2 = str;
        final CipherCallback cipherCallback2 = cipherCallback;
        if (cipher2 != null && cipherCallback2 != null && (baseFragment = this.parentFragment) != null && baseFragment.getParentActivity() != null) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && !z) {
                ...
                builder.setNegativeButton(LocaleController.getString("Cancel", NUM), parentActivity.getMainExecutor(), $$Lambda$BiometricPromtHelper$8iJ3p94NRkmT4GGZwbEsySMo9Io.INSTANCE);
                builder.build().authenticate(new BiometricPrompt.CryptoObject(cipher2), this.cancellationSignal, parentActivity.getMainExecutor(), new BiometricPrompt.AuthenticationCallback() {
                ...
                textView.setText(LocaleController.getString("Wallet", NUM));
                ...
                this.errorTextView.setText(LocaleController.getString("Wallet", NUM));
                ...
                this.negativeButton.setTextColor(Theme.getColor("dialogButton"));
                this.negativeButton.setText(LocaleController.getString("Cancel", NUM));
                ...
                this.negativeButton.setBackgroundDrawable(Theme.getRoundRectSelectorDrawable(Theme.getColor("dialogButton")));
                ...
                baseFragment2.showDialog(create, new DialogInterface.OnDismissListener() {
    ...
    public static boolean hasBiometricEnrolled() {
        ...
        if (Build.VERSION.SDK_INT < 29 || shouldUseFingerprintForCrypto()) {
            if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull()) == null || !fingerprintManagerOrNull.isHardwareDetected() || !fingerprintManagerOrNull.hasEnrolledFingerprints()) {
                return false;
            }
            return true;
        } else if (((BiometricManager) ApplicationLoader.applicationContext.getSystemService(BiometricManager.class)).canAuthenticate() == 0) {
            return true;
        } else {
            return false;
        }
    ...
    public static boolean canAddBiometric() {
        ...
        return ((BiometricManager) ApplicationLoader.applicationContext.getSystemService(BiometricManager.class)).canAuthenticate() != 1;
    }

    public static boolean hasFingerprintHardware() {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull()) == null || !fingerprintManagerOrNull.isHardwareDetected()) {
            return false;
        }
        return true;
    }
    ...
    public static void askForBiometric(BaseFragment baseFragment, ContinueCallback continueCallback, String str) {
        if (baseFragment != null && baseFragment.getParentActivity() != null && continueCallback != null) {
            ...
            builder.setPositiveButton(LocaleController.getString("WalletSecurityAlertSetup", NUM), new DialogInterface.OnClickListener(z, baseFragment) {
