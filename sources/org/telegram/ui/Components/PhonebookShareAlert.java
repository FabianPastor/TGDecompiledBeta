...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public PhonebookShareAlert(org.telegram.ui.ActionBar.BaseFragment r27, org.telegram.messenger.ContactsController.Contact r28, org.telegram.tgnet.TLRPC.User r29, android.net.Uri r30, java.io.File r31, java.lang.String r32, java.lang.String r33, org.telegram.ui.ActionBar.Theme.ResourcesProvider r34) {
        ...
        L_0x0259:
            org.telegram.ui.ActionBar.ActionBar r1 = r0.actionBar
            r15 = 2131628273(0x7f0e10f1, float:1.8883834E38)
    ...
    public /* synthetic */ void m1158lambda$new$0$orgtelegramuiComponentsPhonebookShareAlert(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
    ...
    public /* synthetic */ void m1160lambda$new$2$orgtelegramuiComponentsPhonebookShareAlert(int position, View view, View v) {
    ...
    public /* synthetic */ void m1159lambda$new$1$orgtelegramuiComponentsPhonebookShareAlert(AndroidUtilities.VcardItem item, DialogInterface dialogInterface, int i) {
        if (i == 0) {
            try {
    ...
    public /* synthetic */ boolean m1161lambda$new$3$orgtelegramuiComponentsPhonebookShareAlert(int position, Theme.ResourcesProvider resourcesProvider, Context context, View v) {
        AndroidUtilities.VcardItem item;
        int i = this.phoneStartRow;
        if (position < i || position >= this.phoneEndRow) {
            int i2 = this.vcardStartRow;
    ...
    public /* synthetic */ void m1163lambda$new$5$orgtelegramuiComponentsPhonebookShareAlert(Theme.ResourcesProvider resourcesProvider, View v) {
    ...
    public /* synthetic */ void m1162lambda$new$4$orgtelegramuiComponentsPhonebookShareAlert(boolean notify, int scheduleDate) {
