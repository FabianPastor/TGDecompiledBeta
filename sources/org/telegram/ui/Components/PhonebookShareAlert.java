...
public class PhonebookShareAlert extends BottomSheet {
    ...
    public PhonebookShareAlert(org.telegram.ui.ActionBar.BaseFragment r27, org.telegram.messenger.ContactsController.Contact r28, org.telegram.tgnet.TLRPC.User r29, android.net.Uri r30, java.io.File r31, java.lang.String r32, java.lang.String r33, org.telegram.ui.ActionBar.Theme.ResourcesProvider r34) {
        ...
        L_0x01fd:
            ...
            r4 = 2131624222(0x7f0e011e, float:1.8875618E38)
    ...
    public /* synthetic */ void m4175lambda$new$0$orgtelegramuiComponentsPhonebookShareAlert(NestedScrollView v, int scrollX, int scrollY, int oldScrollX, int oldScrollY) {
    ...
    public /* synthetic */ void m4177lambda$new$2$orgtelegramuiComponentsPhonebookShareAlert(int position, View view, View v) {
    ...
    public /* synthetic */ void m4176lambda$new$1$orgtelegramuiComponentsPhonebookShareAlert(AndroidUtilities.VcardItem item, DialogInterface dialogInterface, int i) {
        if (i == 0) {
            try {
    ...
    public /* synthetic */ boolean m4178lambda$new$3$orgtelegramuiComponentsPhonebookShareAlert(int position, Theme.ResourcesProvider resourcesProvider, Context context, View v) {
        AndroidUtilities.VcardItem item;
        int i = this.phoneStartRow;
        if (position < i || position >= this.phoneEndRow) {
            int i2 = this.vcardStartRow;
    ...
    public /* synthetic */ void m4180lambda$new$5$orgtelegramuiComponentsPhonebookShareAlert(Theme.ResourcesProvider resourcesProvider, View v) {
    ...
    public /* synthetic */ void m4179lambda$new$4$orgtelegramuiComponentsPhonebookShareAlert(boolean notify, int scheduleDate) {
