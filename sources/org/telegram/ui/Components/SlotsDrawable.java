...
public class SlotsDrawable extends RLottieDrawable {
    ...
    public /* synthetic */ void m1415lambda$new$0$orgtelegramuiComponentsSlotsDrawable() {
        int i;
        int result;
        if (!this.isRecycled) {
    ...
    public /* synthetic */ void m1419lambda$setBaseDice$5$orgtelegramuiComponentsSlotsDrawable(TLRPC.TL_messages_stickerSet stickerSet, int account, MessageObject currentMessageObject, ChatMessageCell messageCell) {
        int num;
        ...
        while (true) {
            ...
            if (jArr[a] != 0) {
                ...
                String json = readRes(FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(document, true), 0);
    ...
    public /* synthetic */ void m1416lambda$setBaseDice$1$orgtelegramuiComponentsSlotsDrawable() {
    ...
    public /* synthetic */ void m1417lambda$setBaseDice$3$orgtelegramuiComponentsSlotsDrawable() {
        this.loadingInBackground = false;
    }

    /* renamed from: lambda$setBaseDice$4$org-telegram-ui-Components-SlotsDrawable  reason: not valid java name */
    public /* synthetic */ void m1418lambda$setBaseDice$4$orgtelegramuiComponentsSlotsDrawable(int account, ChatMessageCell messageCell) {
        this.loadingInBackground = false;
        if (this.secondLoadingInBackground || !this.destroyAfterLoading) {
    ...
    public /* synthetic */ void m1420lambda$setDiceNumber$10$orgtelegramuiComponentsSlotsDrawable(TLRPC.TL_messages_stickerSet stickerSet, int account, MessageObject currentMessageObject, ChatMessageCell messageCell, boolean instant) {
        int num;
        if (this.destroyAfterLoading) {
    ...
    public /* synthetic */ void m1421lambda$setDiceNumber$6$orgtelegramuiComponentsSlotsDrawable() {
    ...
    public /* synthetic */ void m1422lambda$setDiceNumber$8$orgtelegramuiComponentsSlotsDrawable() {
        this.secondLoadingInBackground = false;
    }

    /* renamed from: lambda$setDiceNumber$9$org-telegram-ui-Components-SlotsDrawable  reason: not valid java name */
    public /* synthetic */ void m1423lambda$setDiceNumber$9$orgtelegramuiComponentsSlotsDrawable(boolean instant, int account, ChatMessageCell messageCell) {
