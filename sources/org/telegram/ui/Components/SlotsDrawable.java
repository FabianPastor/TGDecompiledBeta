...
public class SlotsDrawable extends RLottieDrawable {
    ...
    public /* synthetic */ void m2611lambda$new$0$orgtelegramuiComponentsSlotsDrawable() {
        int i;
        int result;
        if (!this.isRecycled) {
    ...
    public /* synthetic */ void m2615lambda$setBaseDice$5$orgtelegramuiComponentsSlotsDrawable(TLRPC.TL_messages_stickerSet stickerSet, int account, MessageObject currentMessageObject, ChatMessageCell messageCell) {
        int num;
    ...
    public /* synthetic */ void m2612lambda$setBaseDice$1$orgtelegramuiComponentsSlotsDrawable() {
    ...
    public /* synthetic */ void m2613lambda$setBaseDice$3$orgtelegramuiComponentsSlotsDrawable() {
        this.loadingInBackground = false;
    }

    /* renamed from: lambda$setBaseDice$4$org-telegram-ui-Components-SlotsDrawable  reason: not valid java name */
    public /* synthetic */ void m2614lambda$setBaseDice$4$orgtelegramuiComponentsSlotsDrawable(int account, ChatMessageCell messageCell) {
        this.loadingInBackground = false;
        if (this.secondLoadingInBackground || !this.destroyAfterLoading) {
    ...
    public /* synthetic */ void m2616lambda$setDiceNumber$10$orgtelegramuiComponentsSlotsDrawable(TLRPC.TL_messages_stickerSet stickerSet, int account, MessageObject currentMessageObject, ChatMessageCell messageCell, boolean instant) {
        int num;
        if (this.destroyAfterLoading) {
    ...
    public /* synthetic */ void m2617lambda$setDiceNumber$6$orgtelegramuiComponentsSlotsDrawable() {
    ...
    public /* synthetic */ void m2618lambda$setDiceNumber$8$orgtelegramuiComponentsSlotsDrawable() {
        this.secondLoadingInBackground = false;
    }

    /* renamed from: lambda$setDiceNumber$9$org-telegram-ui-Components-SlotsDrawable  reason: not valid java name */
    public /* synthetic */ void m2619lambda$setDiceNumber$9$orgtelegramuiComponentsSlotsDrawable(boolean instant, int account, ChatMessageCell messageCell) {
