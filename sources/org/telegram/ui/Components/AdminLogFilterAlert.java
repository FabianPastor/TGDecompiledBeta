...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C09403 extends OnScrollListener {
        C09403() {
        }
    ...
    class C09414 implements OnItemClickListener {
        C09414() {
        }
    ...
    class C09425 implements OnClickListener {
        C09425() {
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    CheckBoxCell cell = holder.itemView;
                    if (position == 0) {
                        cell.setText(LocaleController.getString("EventLogFilterAll", C0431R.string.EventLogFilterAll), TtmlNode.ANONYMOUS_REGION_ID, AdminLogFilterAlert.this.currentFilter == null, true);
                        return;
                    } else if (position == AdminLogFilterAlert.this.restrictionsRow) {
                        r3 = LocaleController.getString("EventLogFilterNewRestrictions", C0431R.string.EventLogFilterNewRestrictions);
                        ...
                        r3 = LocaleController.getString("EventLogFilterNewAdmins", C0431R.string.EventLogFilterNewAdmins);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.promote && AdminLogFilterAlert.this.currentFilter.demote)) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterNewMembers", C0431R.string.EventLogFilterNewMembers);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.invite && AdminLogFilterAlert.this.currentFilter.join)) {
                            z = true;
                        }
                        ...
                        if (AdminLogFilterAlert.this.isMegagroup) {
                            r3 = LocaleController.getString("EventLogFilterGroupInfo", C0431R.string.EventLogFilterGroupInfo);
                            r6 = TtmlNode.ANONYMOUS_REGION_ID;
                            if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                                z = true;
                            }
                        ...
                        r3 = LocaleController.getString("EventLogFilterChannelInfo", C0431R.string.EventLogFilterChannelInfo);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterDeletedMessages", C0431R.string.EventLogFilterDeletedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.delete) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterEditedMessages", C0431R.string.EventLogFilterEditedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.edit) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterPinnedMessages", C0431R.string.EventLogFilterPinnedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.pinned) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterLeavingMembers", C0431R.string.EventLogFilterLeavingMembers);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (!(AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.leave)) {
                            z2 = false;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogAllAdmins", C0431R.string.EventLogAllAdmins);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.selectedAdmins == null) {
                            z = true;
                        }
    ...
    public AdminLogFilterAlert(Context context, TL_channelAdminLogEventsFilter filter, SparseArray<User> admins, boolean megagroup) {
        ...
        this.listView.setOnScrollListener(new C09403());
        this.listView.setOnItemClickListener(new C09414());
        ...
        this.saveButton.setTextAndIcon(LocaleController.getString("Save", C0431R.string.Save).toUpperCase(), 0);
        this.saveButton.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        this.saveButton.setOnClickListener(new C09425());
