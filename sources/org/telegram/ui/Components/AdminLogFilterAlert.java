...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C14003 extends OnScrollListener {
        C14003() {
        }
    ...
    class C14014 implements OnItemClickListener {
        C14014() {
        }
    ...
    class C14025 implements OnClickListener {
        C14025() {
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    CheckBoxCell cell = holder.itemView;
                    if (position == 0) {
                        cell.setText(LocaleController.getString("EventLogFilterAll", C0501R.string.EventLogFilterAll), TtmlNode.ANONYMOUS_REGION_ID, AdminLogFilterAlert.this.currentFilter == null, true);
                        return;
                    } else if (position == AdminLogFilterAlert.this.restrictionsRow) {
                        r3 = LocaleController.getString("EventLogFilterNewRestrictions", C0501R.string.EventLogFilterNewRestrictions);
                        ...
                        r3 = LocaleController.getString("EventLogFilterNewAdmins", C0501R.string.EventLogFilterNewAdmins);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.promote && AdminLogFilterAlert.this.currentFilter.demote)) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterNewMembers", C0501R.string.EventLogFilterNewMembers);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || (AdminLogFilterAlert.this.currentFilter.invite && AdminLogFilterAlert.this.currentFilter.join)) {
                            z = true;
                        }
                        ...
                        if (AdminLogFilterAlert.this.isMegagroup) {
                            r3 = LocaleController.getString("EventLogFilterGroupInfo", C0501R.string.EventLogFilterGroupInfo);
                            r6 = TtmlNode.ANONYMOUS_REGION_ID;
                            if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                                z = true;
                            }
                        ...
                        r3 = LocaleController.getString("EventLogFilterChannelInfo", C0501R.string.EventLogFilterChannelInfo);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.info) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterDeletedMessages", C0501R.string.EventLogFilterDeletedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.delete) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterEditedMessages", C0501R.string.EventLogFilterEditedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.edit) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterPinnedMessages", C0501R.string.EventLogFilterPinnedMessages);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.pinned) {
                            z = true;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogFilterLeavingMembers", C0501R.string.EventLogFilterLeavingMembers);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (!(AdminLogFilterAlert.this.currentFilter == null || AdminLogFilterAlert.this.currentFilter.leave)) {
                            z2 = false;
                        }
                        ...
                        r3 = LocaleController.getString("EventLogAllAdmins", C0501R.string.EventLogAllAdmins);
                        r6 = TtmlNode.ANONYMOUS_REGION_ID;
                        if (AdminLogFilterAlert.this.selectedAdmins == null) {
                            z = true;
                        }
    ...
    public AdminLogFilterAlert(Context context, TL_channelAdminLogEventsFilter filter, SparseArray<User> admins, boolean megagroup) {
        ...
        this.listView.setOnScrollListener(new C14003());
        this.listView.setOnItemClickListener(new C14014());
        ...
        this.saveButton.setTextAndIcon(LocaleController.getString("Save", C0501R.string.Save).toUpperCase(), 0);
        this.saveButton.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        this.saveButton.setOnClickListener(new C14025());
