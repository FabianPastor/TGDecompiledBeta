...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C21753 extends OnScrollListener {
        C21753() {
        }
    ...
    class C21764 implements OnItemClickListener {
        C21764() {
        }
    ...
    public AdminLogFilterAlert(Context context, TL_channelAdminLogEventsFilter filter, SparseArray<User> admins, boolean megagroup) {
        ...
        this.listView.setOnScrollListener(new C21753());
        this.listView.setOnItemClickListener(new C21764());
        ...
        this.saveButton.setOnClickListener(new C11135());
