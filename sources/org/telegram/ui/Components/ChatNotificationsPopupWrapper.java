...
public class ChatNotificationsPopupWrapper {
    ...
    public ChatNotificationsPopupWrapper(Context context, int currentAccount2, PopupSwipeBackLayout swipeBackLayout, boolean createBackground, boolean isProfile2, Callback callback2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (swipeBackLayout != null) {
            ...
            addItem.setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda7(swipeBackLayout));
        }
        ...
        addItem2.setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda2(this, callback2));
        ...
        addItem3.setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda3(this, callback2));
        ...
        addItem4.setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda4(this, callback2));
        ActionBarMenuItem.addItem(this.windowLayout, NUM, LocaleController.getString("MuteForPopup", NUM), false, resourcesProvider).setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda0(this, context, currentAccount2, callback2));
        ActionBarMenuItem.addItem(this.windowLayout, NUM, LocaleController.getString("NotificationsCustomize", NUM), false, resourcesProvider).setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda5(this, callback2));
        ...
        addItem5.setOnClickListener(new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda6(this, callback2));
    }

    /* renamed from: lambda$new$1$org-telegram-ui-Components-ChatNotificationsPopupWrapper  reason: not valid java name */
    public /* synthetic */ void m3904xfd410a(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3905x8dea5829(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3906x1ad76var_(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3907xCLASSNAMEeb4a5(Context context, int currentAccount2, Callback callback2, View view) {
        dismiss();
        AlertsCreator.createMuteForPickerDialog(context, new ChatNotificationsPopupWrapper$$ExternalSyntheticLambda1(currentAccount2, callback2));
    }
    ...
    public /* synthetic */ void m3908x4e8bcbc4(Callback callback2, View view) {
        dismiss();
    ...
    public /* synthetic */ void m3909x6865fa02(Callback callback2, View view) {
        dismiss();
    ...
    /* renamed from: update */
    public void m3910x80790d7d(long dialogId) {
        int color;
        int time1;
        int time12;
