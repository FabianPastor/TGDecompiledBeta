...
public class PollVotesAlert extends BottomSheet {
    ...
    public class SectionCell extends FrameLayout {
        ...
        public /* synthetic */ void m2511xe45e52c1(View v) {
            onCollapseClick();
        }
    ...
    public /* synthetic */ void m2507lambda$new$1$orgtelegramuiComponentsPollVotesAlert(Integer[] reqIds, int num, ChatActivity parentFragment, ArrayList loadedVoters, TLRPC.TL_pollAnswerVoters answerVoters, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2506lambda$new$0$orgtelegramuiComponentsPollVotesAlert(Integer[] reqIds, int num, TLObject response, ChatActivity parentFragment, ArrayList loadedVoters, TLRPC.TL_pollAnswerVoters answerVoters) {
    ...
    public /* synthetic */ void m2510lambda$new$4$orgtelegramuiComponentsPollVotesAlert(ChatActivity parentFragment, View view, int position) {
        if (parentFragment != null && parentFragment.getParentActivity() != null) {
    ...
    public /* synthetic */ void m2509lambda$new$3$orgtelegramuiComponentsPollVotesAlert(VotesList votesList, ChatActivity parentFragment, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2508lambda$new$2$orgtelegramuiComponentsPollVotesAlert(VotesList votesList, TLObject response, ChatActivity parentFragment) {
        if (isShowing()) {
