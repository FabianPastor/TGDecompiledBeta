...
public class StroageUsageView extends FrameLayout {
    ...
    public /* synthetic */ void m1465xb842a2b9(ValueAnimator animation) {
    ...
    public /* synthetic */ void m1466x52e3653a(ValueAnimator animation) {
    ...
    private class ProgressView extends View {
        ...
        public void onDraw(Canvas canvas) {
            ...
            if (StroageUsageView.this.calculating || StroageUsageView.this.calculatingProgress != 0.0f) {
                ...
                StroageUsageView.this.cellFlickerDrawable.draw(canvas, AndroidUtilities.rectTmp, (float) AndroidUtilities.dp(3.0f), (View) null);
            } else {
