...
public final /* synthetic */ class BotWebViewMenuContainer$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public /* synthetic */ BotWebViewMenuContainer$$ExternalSyntheticLambda5(BotWebViewMenuContainer botWebViewMenuContainer, TLObject tLObject) {
        this.f$0 = botWebViewMenuContainer;
        this.f$1 = tLObject;
    }

    public final void run() {
        this.f$0.lambda$loadWebView$8(this.f$1);
    }
}
