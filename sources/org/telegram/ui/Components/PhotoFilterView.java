...
public class PhotoFilterView extends FrameLayout {
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation, SavedFilterState state) {
        ...
        this.textureView.setSurfaceTextureListener(new C12351());
        ...
        this.blurControl.setDelegate(new C20622());
        this.curvesControl = new PhotoFilterCurvesControl(context, this.curvesToolValue);
        this.curvesControl.setDelegate(new C20633());
        ...
        this.tuneItem.setOnClickListener(new C12364());
        ...
        this.blurItem.setOnClickListener(new C12375());
        ...
        this.curveItem.setOnClickListener(new C12386());
        ...
        this.blurOffButton.setOnClickListener(new C12408());
        ...
        this.blurRadialButton.setOnClickListener(new C12419());
