...
public class PhotoFilterView extends FrameLayout {
    ...
    class C08671 implements SurfaceTextureListener {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (PhotoFilterView.this.eglThread != null) {
                PhotoFilterView.this.eglThread.setSurfaceTextureSize(width, height);
                PhotoFilterView.this.eglThread.requestRender(false, true);
                PhotoFilterView.this.eglThread.postRunnable(new C08661());
            }
        }
    ...
    class C08684 implements OnClickListener {
        C08684() {
        }
    ...
    class C08695 implements OnClickListener {
        C08695() {
        }
    ...
    class C08706 implements OnClickListener {
        C08706() {
        }
    ...
    class C08717 implements OnClickListener {
        C08717() {
        }
    ...
    class C08728 implements OnClickListener {
        C08728() {
        }
    ...
    class C08739 implements OnClickListener {
        C08739() {
        }
    ...
    class C15212 implements PhotoFilterLinearBlurControlDelegate {
        C15212() {
        }
    ...
    class C15223 implements PhotoFilterCurvesControlDelegate {
        C15223() {
        }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C08741();
        private EGL10 egl10;
        ...
        private boolean drawBlurPass() {
            ...
            if (PhotoFilterView.this.blurType == 1) {
                ...
                GLES20.glUniform2f(this.radialBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f27x, PhotoFilterView.this.blurExcludePoint.f28y);
                ...
                GLES20.glUniform2f(this.linearBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f27x, PhotoFilterView.this.blurExcludePoint.f28y);
    ...
    public class ToolsAdapter extends SelectionAdapter {
        ...
        class C15231 implements PhotoEditorSeekBarDelegate {
            C15231() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                view = cell;
                cell.setSeekBarDelegate(new C15231());
            } else {
                view = new PhotoEditRadioCell(this.mContext);
                view.setOnClickListener(new C08782());
            }
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation, SavedFilterState state) {
        ...
        this.textureView.setSurfaceTextureListener(new C08671());
        ...
        this.blurControl.setDelegate(new C15212());
        this.curvesControl = new PhotoFilterCurvesControl(context, this.curvesToolValue);
        this.curvesControl.setDelegate(new C15223());
        ...
        this.tuneItem.setOnClickListener(new C08684());
        ...
        this.blurItem.setOnClickListener(new C08695());
        ...
        this.curveItem.setOnClickListener(new C08706());
        ...
        while (a < 4) {
            ...
            frameLayout1.setOnClickListener(new C08717());
            a++;
        }
        ...
        this.blurOffButton.setOnClickListener(new C08728());
        ...
        this.blurRadialButton.setOnClickListener(new C08739());
