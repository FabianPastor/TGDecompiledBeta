...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2604lambda$new$0$orgtelegramuiComponentsSharingLocationsAlert(View view, int position) {
    ...
    public /* synthetic */ void m2605lambda$new$1$orgtelegramuiComponentsSharingLocationsAlert(View view) {
        for (int a = 0; a < 3; a++) {
    ...
    public /* synthetic */ void m2606lambda$new$2$orgtelegramuiComponentsSharingLocationsAlert(View view) {
        dismiss();
    }
