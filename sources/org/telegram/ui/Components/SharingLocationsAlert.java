...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenterDelegate {
    ...
    class C13495 implements OnClickListener {
        C13495() {
        }
    ...
    class C13506 implements OnClickListener {
        C13506() {
        }
    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate) {
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C13495());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C13506());
