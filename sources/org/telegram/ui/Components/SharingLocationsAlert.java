...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m1405lambda$new$0$orgtelegramuiComponentsSharingLocationsAlert(View view, int position) {
    ...
    public /* synthetic */ void m1406lambda$new$1$orgtelegramuiComponentsSharingLocationsAlert(View view) {
        for (int a = 0; a < 4; a++) {
    ...
    public /* synthetic */ void m1407lambda$new$2$orgtelegramuiComponentsSharingLocationsAlert(View view) {
        dismiss();
    }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    if (SharingLocationsAlert.this.textView != null) {
                        SharingLocationsAlert.this.textView.setText(LocaleController.formatString("SharingLiveLocationTitle", NUM, LocaleController.formatPluralString("Chats", LocationController.getLocationsCount(), new Object[0])));
                        return;
                    }
                    return;
                default:
