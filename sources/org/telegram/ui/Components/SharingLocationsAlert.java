...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenterDelegate {
    ...
    class C09285 implements OnClickListener {
        C09285() {
        }
    ...
    class C09296 implements OnClickListener {
        C09296() {
        }
    ...
    class C15373 extends OnScrollListener {
        C15373() {
        }
    ...
    class C15384 implements OnItemClickListener {
        C15384() {
        }
    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate) {
        ...
        this.listView.setOnScrollListener(new C15373());
        this.listView.setOnItemClickListener(new C15384());
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C09285());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C09296());
