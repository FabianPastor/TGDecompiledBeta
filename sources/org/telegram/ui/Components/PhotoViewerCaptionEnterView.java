...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenterDelegate, SizeNotifierFrameLayoutPhotoDelegate {
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, View window) {
        ...
        if (VERSION.SDK_INT >= 23 && this.windowView != null) {
            this.messageEditText.setCustomSelectionActionModeCallback(new C12563());
            this.messageEditText.setCustomInsertionActionModeCallback(new C12574());
        }
        ...
        this.messageEditText.setOnKeyListener(new C12585());
        this.messageEditText.setOnClickListener(new C12596());
        this.messageEditText.addTextChangedListener(new C12607());
