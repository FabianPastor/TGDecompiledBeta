...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, SizeNotifierFrameLayoutPhoto.SizeNotifierFrameLayoutPhotoDelegate {
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, View window, Theme.ResourcesProvider resourcesProvider2) {
        ...
        r10.setWindowView(this.windowView);
        ...
        this.messageEditText.addTextChangedListener(new TextWatcher() {
            ...
            public /* synthetic */ void m2499x66ab4dd8(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m2491x2fe3bd6f(View view) {
    ...
    public /* synthetic */ boolean m2492x311a104e(View view, int i, KeyEvent keyEvent) {
        if (i == 4) {
    ...
    public /* synthetic */ void m2493x3250632d(View view) {
        if (isPopupShowing()) {
    ...
    public /* synthetic */ void m2494x3386b60c(View view) {
    ...
    /* renamed from: lambda$onDraw$4$org-telegram-ui-Components-PhotoViewerCaptionEnterView  reason: not valid java name */
    public /* synthetic */ void m2495xc8eb378e(ValueAnimator animation) {
        this.messageEditText.setOffsetY(((Float) animation.getAnimatedValue()).floatValue());
    }

    /* renamed from: lambda$onDraw$5$org-telegram-ui-Components-PhotoViewerCaptionEnterView  reason: not valid java name */
    public /* synthetic */ void m2496xca218a6d(ValueAnimator valueAnimator) {
    ...
    /* renamed from: lambda$setFieldFocused$6$org-telegram-ui-Components-PhotoViewerCaptionEnterView  reason: not valid java name */
    public /* synthetic */ void m2497xe6dccb0a() {
        EditTextCaption editTextCaption = this.messageEditText;
        if (editTextCaption != null) {
            try {
    ...
    /* renamed from: lambda$showPopup$7$org-telegram-ui-Components-PhotoViewerCaptionEnterView  reason: not valid java name */
    public /* synthetic */ void m2498x40b9CLASSNAME(float animateFrom, ValueAnimator animation) {
