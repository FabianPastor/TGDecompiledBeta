...
public final /* synthetic */ class BotWebViewMenuContainer$1$$ExternalSyntheticLambda0 implements ValueAnimator.AnimatorUpdateListener {
    ...
    public /* synthetic */ BotWebViewMenuContainer$1$$ExternalSyntheticLambda0(BotWebViewMenuContainer.AnonymousClass1 r1, int i, int i2) {
        this.f$0 = r1;
        this.f$1 = i;
        this.f$2 = i2;
    }
    ...
    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
        this.f$0.m612x44var_d5(this.f$1, this.f$2, valueAnimator);
    }
}
