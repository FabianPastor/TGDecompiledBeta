...
public class TermsOfServiceView extends FrameLayout {
    ...
    class C17381 implements OnClickListener {
        ...
        class C17371 implements DialogInterface.OnClickListener {
            ...
            class C17361 implements DialogInterface.OnClickListener {
                C17361() {
                }
                        ...
                        public void run(final TLObject response, final TL_error error) {
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    String errorText = LocaleController.getString("ErrorOccurred", C0500R.string.ErrorOccurred);
                                    if (error != null) {
                                        errorText = errorText + "\n" + error.text;
                                    }
            ...
            public void onClick(DialogInterface dialog, int which) {
                Builder builder = new Builder(TermsOfServiceView.this.getContext());
                builder.setMessage(LocaleController.getString("TosDeclineDeleteAccount", C0500R.string.TosDeclineDeleteAccount));
                builder.setTitle(LocaleController.getString("AppName", C0500R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Deactivate", C0500R.string.Deactivate), new C17361());
        ...
        public void onClick(View view) {
            ...
            builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", C0500R.string.DeclineDeactivate), new C17371());
            builder.setNegativeButton(LocaleController.getString("Back", C0500R.string.Back), null);
            builder.setMessage(LocaleController.getString("TosUpdateDecline", C0500R.string.TosUpdateDecline));
            builder.show();
        }
    }

    /* renamed from: org.telegram.ui.Components.TermsOfServiceView$2 */
    class C17402 implements OnClickListener {
        ...
        public void onClick(View view) {
            if (TermsOfServiceView.this.currentTos.min_age_confirm != 0) {
                Builder builder = new Builder(view.getContext());
                builder.setTitle(LocaleController.getString("TosAgeTitle", C0500R.string.TosAgeTitle));
                builder.setPositiveButton(LocaleController.getString("Agree", C0500R.string.Agree), new C17391());
                builder.setNegativeButton(LocaleController.getString("Cancel", C0500R.string.Cancel), null);
                builder.setMessage(LocaleController.formatString("TosAgeText", C0500R.string.TosAgeText, LocaleController.formatPluralString("Years", TermsOfServiceView.this.currentTos.min_age_confirm)));
                builder.show();
                return;
            }
            TermsOfServiceView.this.accept();
    ...
    class C17413 implements RequestDelegate {
        C17413() {
        }
    ...
    public TermsOfServiceView(Context context) {
        ...
        imageView.setImageResource(C0500R.drawable.logo_middle);
        ...
        titleTextView.setText(LocaleController.getString("PrivacyPolicyAndTerms", C0500R.string.PrivacyPolicyAndTerms));
        ...
        declineTextView.setText(LocaleController.getString("Decline", C0500R.string.Decline).toUpperCase());
        ...
        declineTextView.setOnClickListener(new C17381());
        TextView acceptTextView = new TextView(context);
        acceptTextView.setText(LocaleController.getString("Accept", C0500R.string.Accept).toUpperCase());
        ...
        acceptTextView.setBackgroundResource(C0500R.drawable.regbtn_states);
        if (VERSION.SDK_INT >= 21) {
        ...
        acceptTextView.setOnClickListener(new C17402());
    }
    ...
    private void accept() {
        ...
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C17413());
    }
