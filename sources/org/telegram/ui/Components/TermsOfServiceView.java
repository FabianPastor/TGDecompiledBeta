...
public class TermsOfServiceView extends FrameLayout {
    ...
    public /* synthetic */ void m1475lambda$new$4$orgtelegramuiComponentsTermsOfServiceView(View view) {
    ...
    public /* synthetic */ void m1474lambda$new$3$orgtelegramuiComponentsTermsOfServiceView(DialogInterface dialog, int which) {
    ...
    public /* synthetic */ void m1473lambda$new$2$orgtelegramuiComponentsTermsOfServiceView(DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m1472lambda$new$1$orgtelegramuiComponentsTermsOfServiceView(AlertDialog progressDialog, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1471lambda$new$0$orgtelegramuiComponentsTermsOfServiceView(AlertDialog progressDialog, TLObject response, TLRPC.TL_error error) {
        try {
    ...
    public /* synthetic */ void m1477lambda$new$6$orgtelegramuiComponentsTermsOfServiceView(View view) {
    ...
    public /* synthetic */ void m1476lambda$new$5$orgtelegramuiComponentsTermsOfServiceView(DialogInterface dialog, int which) {
        accept();
    }
