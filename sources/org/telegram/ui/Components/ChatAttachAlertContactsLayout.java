...
public class ChatAttachAlertContactsLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class UserCell extends FrameLayout {
        ...
        public void update(int mask) {
            ...
            if (charSequence3 != null) {
                this.statusTextView.setText(charSequence3);
            } else {
                TLRPC.User user5 = this.currentUser;
                if (user5 != null) {
                    if (TextUtils.isEmpty(user5.phone)) {
                        ...
                        simpleTextView.setText(instance.format("+" + this.currentUser.phone));
                    }
                }
            }
            ...
            if (user6 != null) {
                this.avatarImageView.setForUserOrChat(user6, this.avatarDrawable);
            } else {
    ...
    public /* synthetic */ void m2124x9bcdCLASSNAMEf(Theme.ResourcesProvider resourcesProvider, View view, int position) {
        Object object;
        String firstName;
        String firstName2;
    ...
    public /* synthetic */ void m2123xee0adf0(TLRPC.User user, boolean notify, int scheduleDate) {
            ...
            if (holder.getItemViewType() == 0) {
                ...
                if (object instanceof ContactsController.Contact) {
                    ...
                    if (contact.user != null) {
                        ...
                        userCell.setData((TLRPC.User) null, ContactsController.formatName(contact.first_name, contact.last_name), contact.phones.isEmpty() ? "" : PhoneFormat.getInstance().format(contact.phones.get(0)), divider);
                    }
                } else {
                ...
                if (user != null) {
                    PhoneFormat instance = PhoneFormat.getInstance();
                    userCell.setData(user, (CharSequence) null, instance.format("+" + user.phone), divider);
                }
            }
        }
    ...
    public class ShareSearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void m2127x8377var_e(String query, int searchId) {
        ...
        public /* synthetic */ void m2126xcCLASSNAMEea95(String query, int searchId) {
        ...
        public /* synthetic */ void m2125xcb356CLASSNAME(java.lang.String r22, java.util.ArrayList r23, java.util.ArrayList r24, int r25, int r26) {
            /*
                r21 = this;
                r0 = r21
                r1 = r22
            ...
            L_0x02a3:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.ChatAttachAlertContactsLayout.ShareSearchAdapter.m2125xcb356CLASSNAME(java.lang.String, java.util.ArrayList, java.util.ArrayList, int, int):void");
        }
        ...
        public /* synthetic */ void m2128xcea3a044(int searchId, ArrayList users, ArrayList names) {
            ...
            if (holder.getItemViewType() == 0) {
                ...
                if (object instanceof ContactsController.Contact) {
                    ...
                    if (contact.user != null) {
                        ...
                        userCell.setCurrentId(contact.contact_id);
                        userCell.setData((TLRPC.User) null, this.searchResultNames.get(position - 1), contact.phones.isEmpty() ? "" : PhoneFormat.getInstance().format(contact.phones.get(0)), divider);
                    }
                } else {
                    user = (TLRPC.User) object;
                }
                if (user != null) {
                    PhoneFormat instance = PhoneFormat.getInstance();
                    userCell.setData(user, this.searchResultNames.get(position - 1), instance.format("+" + user.phone), divider);
                }
            }
        }
    ...
    public /* synthetic */ void m2122x637b688a() {
        RecyclerListView recyclerListView = this.listView;
