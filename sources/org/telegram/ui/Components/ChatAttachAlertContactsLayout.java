...
public class ChatAttachAlertContactsLayout extends ChatAttachAlert.AttachAlertLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$new$1(Theme.ResourcesProvider resourcesProvider, View view, int i) {
        ...
        if (adapter == shareSearchAdapter) {
            mo1791getItem = shareSearchAdapter.getItem(i);
        } else {
            ...
            mo1791getItem = this.listAdapter.mo1791getItem(sectionForPosition, positionInSectionForPosition);
        }
        if (mo1791getItem != null) {
            if (mo1791getItem instanceof ContactsController.Contact) {
                ContactsController.Contact contact2 = (ContactsController.Contact) mo1791getItem;
    ...
    public class ShareAdapter extends RecyclerListView.SectionsAdapter {
        ...
        public void onBindViewHolder(int i, int i2, RecyclerView.ViewHolder viewHolder) {
            ...
            if (viewHolder.getItemViewType() == 0) {
                ...
                Object mo1791getItem = mo1791getItem(i, i2);
                boolean z = true;
                if (i == getSectionCount() - 2 && i2 == getCountForSection(i) - 1) {
                    z = false;
                }
                if (mo1791getItem instanceof ContactsController.Contact) {
                    final ContactsController.Contact contact = (ContactsController.Contact) mo1791getItem;
                    ...
                    tLRPC$User = (TLRPC$User) mo1791getItem;
                }
                if (tLRPC$User == null) {
                    return;
                }
