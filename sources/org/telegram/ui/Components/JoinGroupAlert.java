...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(Context context, ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        textView.setBackgroundResource(C0431R.drawable.header_shadow_reverse);
        ...
        pickerBottomLayout.cancelButton.setText(LocaleController.getString("Cancel", C0431R.string.Cancel).toUpperCase());
        pickerBottomLayout.cancelButton.setOnClickListener(new C10801());
        ...
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString("JoinGroup", C0431R.string.JoinGroup));
        pickerBottomLayout.doneButton.setOnClickListener(new C10832());
    }
}
