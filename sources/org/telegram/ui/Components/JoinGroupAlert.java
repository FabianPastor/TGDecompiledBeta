...
public class JoinGroupAlert extends BottomSheet {
    ...
    class C12001 implements OnClickListener {
        C12001() {
        }
    ...
    public JoinGroupAlert(Context context, ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C12001());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C12022());
    }
}
