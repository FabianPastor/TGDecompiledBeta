...
public class JoinGroupAlert extends BottomSheet {
    ...
    public JoinGroupAlert(android.content.Context r37, org.telegram.tgnet.TLRPC.ChatInvite r38, java.lang.String r39, org.telegram.ui.ActionBar.BaseFragment r40) {
        /*
            ...
            r11 = 2131165522(0x7var_, float:1.7945263E38)
        ...
        L_0x0269:
            ...
            goto L_0x02cf
        L_0x02ca:
            r4 = 2131627519(0x7f0e0dff, float:1.8882305E38)
        ...
        L_0x034f:
            ...
            r1.setTextColor(r8)
            android.widget.TextView r1 = r7.cancelButton
            r8 = 2131624692(0x7f0e02f4, float:1.887657E38)
    ...
    public /* synthetic */ void m2387lambda$new$0$orgtelegramuiComponentsJoinGroupAlert(View view) {
        dismiss();
    }

    /* renamed from: lambda$new$5$org-telegram-ui-Components-JoinGroupAlert  reason: not valid java name */
    public /* synthetic */ void m2392lambda$new$5$orgtelegramuiComponentsJoinGroupAlert(Context context, boolean isChannel, View view) {
    ...
    public /* synthetic */ void m2388lambda$new$1$orgtelegramuiComponentsJoinGroupAlert() {
        if (!isDismissed()) {
    ...
    public /* synthetic */ void m2391lambda$new$4$orgtelegramuiComponentsJoinGroupAlert(Context context, boolean isChannel, TLRPC.TL_messages_importChatInvite request, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2390lambda$new$3$orgtelegramuiComponentsJoinGroupAlert(TLRPC.TL_error error, Context context, boolean isChannel, TLRPC.TL_messages_importChatInvite request) {
    ...
    public /* synthetic */ void m2389lambda$new$2$orgtelegramuiComponentsJoinGroupAlert(Context context, boolean isChannel, DialogInterface dialog) {
        String subTitle;
    ...
    public /* synthetic */ void m2393lambda$new$6$orgtelegramuiComponentsJoinGroupAlert(View view) {
        dismiss();
    }

    /* renamed from: lambda$new$9$org-telegram-ui-Components-JoinGroupAlert  reason: not valid java name */
    public /* synthetic */ void m2396lambda$new$9$orgtelegramuiComponentsJoinGroupAlert(View v) {
        dismiss();
    ...
    public /* synthetic */ void m2395lambda$new$8$orgtelegramuiComponentsJoinGroupAlert(TLRPC.TL_messages_importChatInvite req, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m2394lambda$new$7$orgtelegramuiComponentsJoinGroupAlert(TLRPC.TL_error error, TLObject response, TLRPC.TL_messages_importChatInvite req) {
        BaseFragment baseFragment = this.fragment;
        if (baseFragment != null && baseFragment.getParentActivity() != null) {
            if (error == null) {
