...
public class BlockingUpdateView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m2015lambda$new$0$orgtelegramuiComponentsBlockingUpdateView(View v) {
    ...
    public /* synthetic */ void m2016lambda$new$1$orgtelegramuiComponentsBlockingUpdateView(View view1) {
    ...
    public void show(int account, TLRPC.TL_help_appUpdate update, boolean check) {
        ...
        if (update.document instanceof TLRPC.TL_document) {
            ...
            textView2.setText(LocaleController.getString("Update", NUM) + String.format(Locale.US, " (%1$s)", new Object[]{AndroidUtilities.formatFileSize((long) update.document.size)}));
        } else {
        ...
        if (check) {
            ...
            ConnectionsManager.getInstance(this.accountNum).sendRequest(req, new BlockingUpdateView$$ExternalSyntheticLambda4(this));
        }
    }

    /* renamed from: lambda$show$4$org-telegram-ui-Components-BlockingUpdateView  reason: not valid java name */
    public /* synthetic */ void m2018lambda$show$4$orgtelegramuiComponentsBlockingUpdateView(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new BlockingUpdateView$$ExternalSyntheticLambda3(this, response));
    }

    /* renamed from: lambda$show$3$org-telegram-ui-Components-BlockingUpdateView  reason: not valid java name */
    public /* synthetic */ void m2017lambda$show$3$orgtelegramuiComponentsBlockingUpdateView(TLObject response) {
