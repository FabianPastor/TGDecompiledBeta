...
public class StickersArchiveAlert extends Builder {
    ...
    public StickersArchiveAlert(Context context, BaseFragment baseFragment, ArrayList<StickerSetCovered> sets) {
        ...
        if (set.set.masks) {
            this.currentType = 1;
            setTitle(LocaleController.getString("ArchivedMasksAlertTitle", C0500R.string.ArchivedMasksAlertTitle));
        } else {
            this.currentType = 0;
            setTitle(LocaleController.getString("ArchivedStickersAlertTitle", C0500R.string.ArchivedStickersAlertTitle));
        }
        ...
        if (set.set.masks) {
            textView.setText(LocaleController.getString("ArchivedMasksAlertInfo", C0500R.string.ArchivedMasksAlertInfo));
        } else {
            textView.setText(LocaleController.getString("ArchivedStickersAlertInfo", C0500R.string.ArchivedStickersAlertInfo));
        }
        ...
        setNegativeButton(LocaleController.getString("Close", C0500R.string.Close), new C17321());
        if (this.parentFragment != null) {
            setPositiveButton(LocaleController.getString("Settings", C0500R.string.Settings), new C17332());
        }
    }
}
