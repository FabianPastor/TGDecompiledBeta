...
public class StickersArchiveAlert extends Builder {
    ...
    class C09442 implements OnClickListener {
        C09442() {
        }
    ...
    public StickersArchiveAlert(Context context, BaseFragment baseFragment, ArrayList<StickerSetCovered> sets) {
        ...
        setNegativeButton(LocaleController.getString("Close", R.string.Close), new C09431());
        if (this.parentFragment != null) {
            setPositiveButton(LocaleController.getString("Settings", R.string.Settings), new C09442());
        }
    }
}
