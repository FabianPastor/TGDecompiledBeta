...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        this.cancelButton.setTextColor(this.isDarkTheme ? -1 : Theme.getColor("picker_enabledButton"));
        ...
        this.doneButton.setBackgroundDrawable(Theme.createSelectorDrawable(this.isDarkTheme ? -12763843 : NUM, 0));
        ...
        if (this.isDarkTheme) {
            ...
            drawable = Theme.createRoundRectDrawable(AndroidUtilities.dp(11.0f), Theme.getColor("picker_badge"));
        }
    ...
    public void updateSelectedCount(int count, boolean disable) {
        ...
        if (count == 0) {
            ...
            if (disable) {
                ...
                if (!this.isDarkTheme) {
                    obj = "picker_disabledButton";
                }
                textView2.setTag(obj);
                this.doneButtonTextView.setTextColor(this.isDarkTheme ? -6710887 : Theme.getColor("picker_disabledButton"));
                this.doneButton.setEnabled(false);
                return;
            }
            textView = this.doneButtonTextView;
            if (!this.isDarkTheme) {
                obj = "picker_enabledButton";
            }
            textView.setTag(obj);
            this.doneButtonTextView.setTextColor(this.isDarkTheme ? -1 : Theme.getColor("picker_enabledButton"));
            return;
        }
