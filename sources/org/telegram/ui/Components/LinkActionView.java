...
public class LinkActionView extends LinearLayout {
    ...
    public /* synthetic */ void m4120lambda$new$0$orgtelegramuiComponentsLinkActionView(BottomSheet bottomSheet, BaseFragment fragment2, View view) {
        try {
            if (this.link != null) {
    ...
    public /* synthetic */ void m4121lambda$new$1$orgtelegramuiComponentsLinkActionView(View view) {
    ...
    public /* synthetic */ void m4122lambda$new$2$orgtelegramuiComponentsLinkActionView(BaseFragment fragment2, View view) {
        try {
            if (this.link != null) {
    ...
    public /* synthetic */ void m4124lambda$new$4$orgtelegramuiComponentsLinkActionView(BaseFragment fragment2, View view) {
    ...
    public /* synthetic */ void m4123lambda$new$3$orgtelegramuiComponentsLinkActionView(DialogInterface dialogInterface2, int i2) {
    ...
    public /* synthetic */ void m4129lambda$new$9$orgtelegramuiComponentsLinkActionView(Context context, BottomSheet bottomSheet, BaseFragment fragment2, View view) {
    ...
    public /* synthetic */ void m4125lambda$new$5$orgtelegramuiComponentsLinkActionView(View view12) {
    ...
    public /* synthetic */ void m4126lambda$new$6$orgtelegramuiComponentsLinkActionView(View view12) {
        showQrCode();
    }

    /* renamed from: lambda$new$7$org-telegram-ui-Components-LinkActionView  reason: not valid java name */
    public /* synthetic */ void m4127lambda$new$7$orgtelegramuiComponentsLinkActionView(View view1) {
        ActionBarPopupWindow actionBarPopupWindow2 = this.actionBarPopupWindow;
        if (actionBarPopupWindow2 != null) {
            actionBarPopupWindow2.dismiss();
        }
    ...
    public /* synthetic */ void m4128lambda$new$8$orgtelegramuiComponentsLinkActionView(KeyEvent keyEvent) {
    ...
    public /* synthetic */ void m4130lambda$revokeLink$10$orgtelegramuiComponentsLinkActionView(DialogInterface dialogInterface, int i) {
        Delegate delegate2 = this.delegate;
        if (delegate2 != null) {
    ...
    public /* synthetic */ void m4119lambda$loadUsers$12$orgtelegramuiComponentsLinkActionView(TLRPC.TL_chatInviteExported invite, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m4118lambda$loadUsers$11$orgtelegramuiComponentsLinkActionView(TLRPC.TL_error error, TLObject response, TLRPC.TL_chatInviteExported invite) {
