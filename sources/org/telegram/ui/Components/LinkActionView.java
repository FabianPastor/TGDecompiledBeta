            ...
            if (frameLayout2 != null) {
                final AnonymousClass1 r5 = new View(context) {
                    ...
                    public void onDraw(Canvas canvas) {
                        ...
                        View access$300 = LinkActionView.this.frameLayout;
                        float f = 0.0f;
                        float f2 = 0.0f;
                        while (access$300 != frameLayout2) {
                            f2 += access$300.getY();
                            f += access$300.getX();
                            access$300 = (View) access$300.getParent();
                            if (!(access$300 instanceof ViewGroup)) {
                                return;
                            }
                        }
                        canvas.save();
                ...
                this.actionBarPopupWindow.showAtLocation(frameLayout2, 0, (frameLayout2.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.dp(16.0f), ((int) f) + this.frameLayout.getMeasuredHeight());
            }
        }
    }
