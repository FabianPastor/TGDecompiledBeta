...
public class LinkActionView extends LinearLayout {
    ...
    public /* synthetic */ void m2399lambda$new$0$orgtelegramuiComponentsLinkActionView(BottomSheet bottomSheet, BaseFragment fragment2, View view) {
        try {
            if (this.link != null) {
    ...
    public /* synthetic */ void m2400lambda$new$1$orgtelegramuiComponentsLinkActionView(View view) {
    ...
    public /* synthetic */ void m2401lambda$new$2$orgtelegramuiComponentsLinkActionView(BaseFragment fragment2, View view) {
        try {
            if (this.link != null) {
    ...
    public /* synthetic */ void m2403lambda$new$4$orgtelegramuiComponentsLinkActionView(BaseFragment fragment2, View view) {
    ...
    public /* synthetic */ void m2402lambda$new$3$orgtelegramuiComponentsLinkActionView(DialogInterface dialogInterface2, int i2) {
    ...
    public /* synthetic */ void m2408lambda$new$9$orgtelegramuiComponentsLinkActionView(Context context, BottomSheet bottomSheet, BaseFragment fragment2, View view) {
    ...
    public /* synthetic */ void m2404lambda$new$5$orgtelegramuiComponentsLinkActionView(View view12) {
    ...
    public /* synthetic */ void m2405lambda$new$6$orgtelegramuiComponentsLinkActionView(View view12) {
        showQrCode();
    }

    /* renamed from: lambda$new$7$org-telegram-ui-Components-LinkActionView  reason: not valid java name */
    public /* synthetic */ void m2406lambda$new$7$orgtelegramuiComponentsLinkActionView(View view1) {
        ActionBarPopupWindow actionBarPopupWindow2 = this.actionBarPopupWindow;
        if (actionBarPopupWindow2 != null) {
            actionBarPopupWindow2.dismiss();
        }
    ...
    public /* synthetic */ void m2407lambda$new$8$orgtelegramuiComponentsLinkActionView(KeyEvent keyEvent) {
    ...
    public /* synthetic */ void m2409lambda$revokeLink$10$orgtelegramuiComponentsLinkActionView(DialogInterface dialogInterface, int i) {
        Delegate delegate2 = this.delegate;
        if (delegate2 != null) {
    ...
    public void setUsers(int usersCount2, ArrayList<TLRPC.User> importers) {
        ...
        if (usersCount2 == 0) {
            ...
            this.avatarsContainer.countTextView.setText(LocaleController.formatPluralString("PeopleJoined", usersCount2));
    ...
    public /* synthetic */ void m2398lambda$loadUsers$12$orgtelegramuiComponentsLinkActionView(TLRPC.TL_chatInviteExported invite, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2397lambda$loadUsers$11$orgtelegramuiComponentsLinkActionView(TLRPC.TL_error error, TLObject response, TLRPC.TL_chatInviteExported invite) {
