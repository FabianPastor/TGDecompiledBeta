...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m3900lambda$new$0$orgtelegramuiComponentsChatAvatarContainer(View v) {
        openProfile(true);
    }

    /* renamed from: lambda$new$1$org-telegram-ui-Components-ChatAvatarContainer  reason: not valid java name */
    public /* synthetic */ void m3901lambda$new$1$orgtelegramuiComponentsChatAvatarContainer(Theme.ResourcesProvider resourcesProvider2, View v) {
        if (this.secretChatTimer) {
    ...
    public /* synthetic */ void m3902lambda$new$2$orgtelegramuiComponentsChatAvatarContainer(View v) {
        openProfile(false);
    }
    ...
    public boolean openSetTimer() {
        ...
        if (chat == null || ChatObject.canUserDoAdminAction(chat, 13)) {
            ...
            autoDeletePopupWrapper.m3620xf8eeadab(ttl);
