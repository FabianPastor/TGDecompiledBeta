            ...
            if (actionMasked == 1) {
                if (!this.hasMoved) {
                    ...
                    if (this.renderView.getCurrentBrush() instanceof Brush.Arrow) {
                        ...
                        double d = point2.x;
                        double d2 = d;
                        Point point3 = new Point(d, point2.y, 0.800000011920929d);
                        double d3 = (double) f2;
                        Double.isNaN(d3);
                        ...
                        double d4 = d2 + (cos * currentWeight);
                        double d5 = point2.y;
                        Double.isNaN(d3);
                        double sin = Math.sin(d3 - 2.5132741228718345d);
                        Double.isNaN(currentWeight);
                        Point point4 = new Point(d4, d5 + (sin * currentWeight), 1.0d);
                        point4.edge = true;
                        ...
                        Double.isNaN(currentWeight);
                        Point point5 = new Point(d6 + (cos2 * currentWeight), d7 + (sin2 * currentWeight), 1.0d);
                        point5.edge = true;
