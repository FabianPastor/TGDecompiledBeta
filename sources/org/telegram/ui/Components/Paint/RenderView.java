...
public class RenderView extends TextureView {
    ...
    class C15381 implements SurfaceTextureListener {
        ...
        class C15372 implements Runnable {
            C15372() {
            }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (RenderView.this.internal != null) {
                ...
                RenderView.this.updateTransform();
                RenderView.this.internal.requestRender();
                RenderView.this.internal.postRunnable(new C15361());
            }
        }

        public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
            if (!(RenderView.this.internal == null || RenderView.this.shuttingDown)) {
                RenderView.this.painting.onPause(new C15372());
            }
            return true;
        }
    ...
    class C15392 implements PaintingDelegate {
        C15392() {
        }
    ...
    class C15403 implements Runnable {
        C15403() {
        }
    ...
    private class CanvasInternal extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C15431();
        private EGL10 egl10;
        ...
        class C15431 implements Runnable {
            ...
            class C15421 implements Runnable {
                C15421() {
                }
            ...
            public void run() {
                if (CanvasInternal.this.initialized && !RenderView.this.shuttingDown) {
                    ...
                    if (!CanvasInternal.this.ready) {
                        RenderView.this.queue.postRunnable(new C15421(), 200);
                    }
                }
            }
        }
        ...
        class C15442 implements Runnable {
            C15442() {
            }
        ...
        class C15453 implements Runnable {
            C15453() {
            }
        ...
        class C15464 implements Runnable {
            C15464() {
            }
        ...
        public void scheduleRedraw() {
            ...
            this.scheduledRunnable = new C15453();
    ...
    public RenderView(Context context, Painting paint, Bitmap b, int rotation) {
        ...
        setSurfaceTextureListener(new C15381());
        this.painting.setDelegate(new C15392());
    }
