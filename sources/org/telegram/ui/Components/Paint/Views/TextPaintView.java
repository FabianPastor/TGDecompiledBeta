...
public class TextPaintView extends EntityView {
    ...
    class C08491 implements TextWatcher {
    ...
    public TextPaintView(Context context, Point position, int fontSize, String text, Swatch swatch, boolean stroke) {
        ...
        setStroke(stroke);
        updatePosition();
        this.editText.addTextChangedListener(new C08491());
    }
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f27x - (width / 2.0f)) * scale, (this.position.f28y - (height / 2.0f)) * scale, width * scale, height * scale);
    }
