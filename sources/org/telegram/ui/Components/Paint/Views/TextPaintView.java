...
public class TextPaintView extends EntityView {
    ...
    class C16131 implements TextWatcher {
    ...
    public TextPaintView(Context context, Point position, int fontSize, String text, Swatch swatch, boolean stroke) {
        ...
        setStroke(stroke);
        updatePosition();
        this.editText.addTextChangedListener(new C16131());
    }
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f58x - (width / 2.0f)) * scale, (this.position.f59y - (height / 2.0f)) * scale, width * scale, height * scale);
    }
