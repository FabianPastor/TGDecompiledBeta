...
public class TextPaintView extends EntityView {
    ...
    public TextPaintView(Context context, Point position, int fontSize, String text, Swatch swatch, boolean stroke) {
        ...
        setStroke(stroke);
        updatePosition();
        this.editText.addTextChangedListener(new C11131());
    }
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f68x - (width / 2.0f)) * scale, (this.position.f69y - (height / 2.0f)) * scale, width * scale, height * scale);
    }
