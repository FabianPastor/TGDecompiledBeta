...
public class StickerView extends EntityView {
    ...
    public /* synthetic */ void m4157lambda$new$0$orgtelegramuiComponentsPaintViewsStickerView(ImageReceiver imageReceiver, boolean set, boolean isThumb, boolean memCache) {
    ...
    public long getDuration() {
        ...
        if (animatedFileDrawable != null) {
            return (long) animatedFileDrawable.getDurationMs();
        }
        return 0;
    }
