...
public class ColorPicker extends FrameLayout {
    ...
    public ColorPicker(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(C0493R.drawable.knob_shadow);
        ...
        this.settingsButton.setImageResource(C0493R.drawable.photo_paint_brush);
        addView(this.settingsButton, LayoutHelper.createFrame(60, 52.0f));
        this.settingsButton.setOnClickListener(new C15491());
        this.undoButton = new ImageView(context);
        this.undoButton.setScaleType(ScaleType.CENTER);
        this.undoButton.setImageResource(C0493R.drawable.photo_undo);
        addView(this.undoButton, LayoutHelper.createFrame(60, 52.0f));
        this.undoButton.setOnClickListener(new C15502());
