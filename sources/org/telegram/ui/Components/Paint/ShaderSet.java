...
public class ShaderSet {
    ...
    private static Map<String, Map<String, Object>> createMap() {
        ...
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_BLIT_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "texture"});
        result.put("blit", Collections.unmodifiableMap(shader2));
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_BLITWITHMASKLIGHT_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        result.put("blitWithMaskLight", Collections.unmodifiableMap(shader2));
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_BLITWITHMASK_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        result.put("blitWithMask", Collections.unmodifiableMap(shader2));
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_COMPOSITEWITHMASK_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "mask", TtmlNode.ATTR_TTS_COLOR});
        result.put("compositeWithMask", Collections.unmodifiableMap(shader2));
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_COMPOSITEWITHMASKLIGHT_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "texture", "mask", TtmlNode.ATTR_TTS_COLOR});
        result.put("compositeWithMaskLight", Collections.unmodifiableMap(shader2));
        shader2 = new HashMap();
        shader2.put(VERTEX, PAINT_BLIT_VSH);
        shader2.put(FRAGMENT, PAINT_NONPREMULTIPLIEDBLIT_FSH);
        shader2.put(ATTRIBUTES, new String[]{"inPosition", "inTexcoord"});
        shader2.put(UNIFORMS, new String[]{"mvpMatrix", "texture"});
        result.put("nonPremultipliedBlit", Collections.unmodifiableMap(shader2));
