...
public class ChatAttachAlertPhotoLayoutPreview extends ChatAttachAlert.AttachAlertLayout {
    ...
    static /* synthetic */ float access$1516(ChatAttachAlertPhotoLayoutPreview x0, float x1) {
    ...
    public class PaddingBox extends View {
        ...
        public boolean setPadding(int height) {
            if (this.thisHeight == height || getMeasuredHeight() == height) {
                return false;
            }
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            super.onMeasure(widthMeasureSpec, View.MeasureSpec.makeMeasureSpec(Math.max(0, this.thisHeight), NUM));
        }
    }
    ...
    public /* synthetic */ void m3888x7a1626c9(ChatAttachAlert.AttachAlertLayout previousLayout) {
    ...
    public /* synthetic */ void m3889xe549668() {
        if (this.shown) {
    ...
    private class PreviewGroupsView extends ViewGroup {
            ...
            public void run() {
                if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null && !ChatAttachAlertPhotoLayoutPreview.this.draggingCellHiding) {
                    ...
                    if (Math.abs((int) dy) > 0 && ChatAttachAlertPhotoLayoutPreview.this.listView.canScrollVertically((int) dy) && (dy <= 0.0f || !atBottom)) {
                        ChatAttachAlertPhotoLayoutPreview.access$1516(ChatAttachAlertPhotoLayoutPreview.this, dy);
        ...
        public void fromPhotoLayout(ChatAttachAlertPhotoLayout photoLayout) {
            ...
            int photosOrderSize = photosOrder.size();
            int photosOrderLast = photosOrderSize - 1;
            for (int i = 0; i < photosOrderSize; i++) {
                photos.add((MediaController.PhotoEntry) photosMap.get(Integer.valueOf(((Integer) photosOrder.get(i)).intValue())));
        ...
        public void toPhotoLayout(ChatAttachAlertPhotoLayout photoLayout, boolean updateLayout) {
            ...
            HashMap<Object, Object> photosMap2 = photoLayout.getSelectedPhotos();
            List<Map.Entry<Object, Object>> photosMapKeys2 = new ArrayList<>(photosMap2.entrySet());
            HashMap<Object, Object> selectedPhotos = new HashMap<>();
            ArrayList<Object> photosOrder = new ArrayList<>();
            int groupCellsCount2 = this.groupCells.size();
            int i = 0;
            while (i < groupCellsCount2) {
                ...
                if (group.photos.size() != 0) {
                    ...
                    while (j < photosCount) {
                        ...
                        if (this.deletedPhotos.containsKey(photoEntry)) {
                            ...
                            photosMap = photosMap2;
                            photosMapKeys = photosMapKeys2;
                            groupCellsCount = groupCellsCount2;
                        } else {
                            boolean found = false;
                            int k = 0;
                            while (true) {
                                if (k >= photosMapKeys2.size()) {
                                    photosMap = photosMap2;
                                    groupCellsCount = groupCellsCount2;
                                    break;
                                }
                                Map.Entry<Object, Object> entry = photosMapKeys2.get(k);
                                photosMap = photosMap2;
                                ...
                                k++;
                                photosMap2 = photosMap;
                            }
                            if (!found) {
                                int k2 = 0;
                                while (true) {
                                    if (k2 >= photosMapKeys2.size()) {
                                        photosMapKeys = photosMapKeys2;
                                        break;
                                    }
                                    Map.Entry<Object, Object> entry2 = photosMapKeys2.get(k2);
                                    Object value2 = entry2.getValue();
                                    if (!(value2 instanceof MediaController.PhotoEntry) || ((MediaController.PhotoEntry) value2).path == null || photoEntry == null) {
                                        photosMapKeys = photosMapKeys2;
                                    } else {
                                        photosMapKeys = photosMapKeys2;
                                        if (((MediaController.PhotoEntry) value2).path.equals(photoEntry.path)) {
                                            Object key2 = entry2.getKey();
                                            selectedPhotos.put(key2, value2);
                                            photosOrder.add(key2);
                                            break;
                                        }
                                    }
                                    k2++;
                                    photosMapKeys2 = photosMapKeys;
                                }
                            } else {
                                photosMapKeys = photosMapKeys2;
                            }
                        ...
                        j++;
                        photosMap2 = photosMap;
                        groupCellsCount2 = groupCellsCount;
                        photosMapKeys2 = photosMapKeys;
                    }
                }
                i++;
                photosMap2 = photosMap2;
                groupCellsCount2 = groupCellsCount2;
                photosMapKeys2 = photosMapKeys2;
            }
            List<Map.Entry<Object, Object>> list = photosMapKeys2;
            int i2 = groupCellsCount2;
        ...
        public /* synthetic */ void m3894x76aa0fb1(ValueAnimator a) {
        ...
        public /* synthetic */ void m3893x4294d1ca(ValueAnimator a) {
            this.draggingT = ((Float) a.getAnimatedValue()).floatValue();
            invalidate();
        }
        ...
        public boolean onTouchEvent(MotionEvent event) {
            ...
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null) {
                ...
                if (draggingOverGroupCell3 != null) {
                    ...
                    while (i2 < mediaCount3) {
                        PreviewGroupCell.MediaCell mediaCell2 = draggingOverGroupCell3.media.get(i2);
                        if (mediaCell2 == null || mediaCell2 == ChatAttachAlertPhotoLayoutPreview.this.draggingCell) {
                            draggingOverGroupCell2 = draggingOverGroupCell3;
                            maxLength = maxLength2;
                            mediaCount = mediaCount3;
                        } else {
                            maxLength = maxLength2;
                            if (draggingOverGroupCell3.group.photos.contains(mediaCell2.photoEntry)) {
                                RectF mediaCellRect = mediaCell2.drawingRect();
                                if ((mediaCell2.positionFlags & 4) > 0) {
                                    f = 0.0f;
                                    mediaCellRect.top = 0.0f;
                                } else {
                                    f = 0.0f;
                                }
                                if ((mediaCell2.positionFlags & 1) > 0) {
                                    mediaCellRect.left = f;
                                }
                                if ((mediaCell2.positionFlags & 2) > 0) {
                                    mediaCellRect.right = (float) getWidth();
                                }
                                if ((mediaCell2.positionFlags & 8) > 0) {
                                ...
                                if (RectF.intersects(draggingCellXY, mediaCellRect)) {
                                    ...
                                    if (area > 0.15f && area > maxArea) {
                                        maxArea = area;
                                        draggingOverMediaCell3 = mediaCell2;
                                    }
                                } else {
                                    draggingOverGroupCell2 = draggingOverGroupCell3;
            ...
            if (action == 0 && ChatAttachAlertPhotoLayoutPreview.this.draggingCell == null && !ChatAttachAlertPhotoLayoutPreview.this.listView.scrollingByUser && ((ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator == null || !ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator.isRunning()) && touchGroupCell != null && touchMediaCell != null && touchGroupCell.group != null && touchGroupCell.group.photos.contains(touchMediaCell.photoEntry))) {
                ...
                if (action != 1 || ChatAttachAlertPhotoLayoutPreview.this.draggingCell != null || this.tapMediaCell == null || this.tapGroupCell == null) {
                    result2 = result;
                } else {
                    if (ChatAttachAlertPhotoLayoutPreview.this.getSelectedItemsCount() > 1) {
                        ...
                        if (index >= 0) {
                            ...
                            PreviewGroupCell previewGroupCell = groupCell3;
                    ...
                    if (tapIndex >= 0) {
                        ...
                        if (ChatAttachAlertPhotoLayoutPreview.this.draggingCell.groupCell != replaceGroupCell) {
                            ...
                            while (true) {
                                ...
                                PreviewGroupCell.MediaCell mediaCell3 = replaceGroupCell.media.get(i5);
                                int tapIndex2 = tapIndex;
                                float touchX2 = touchX;
                                if (mediaCell3.photoEntry == ChatAttachAlertPhotoLayoutPreview.this.draggingCell.photoEntry) {
                                    newDraggingCell = mediaCell3;
                                    break;
                                }
                                i5++;
                                tapIndex = tapIndex2;
        ...
        public /* synthetic */ void m3890x25db1826(long wasTapTime, PreviewGroupCell.MediaCell wasTapMediaCell) {
        ...
        public /* synthetic */ void m3891x3ce7e05(PreviewGroupCell groupCell, MediaController.PhotoEntry photo, int index) {
            if (ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator != null) {
                ChatAttachAlertPhotoLayoutPreview.this.draggingAnimator.cancel();
            }
            PreviewGroupCell.MediaCell unused = ChatAttachAlertPhotoLayoutPreview.this.draggingCell = null;
        ...
        public /* synthetic */ void m3892xe1c1e3e4(int currentUndoViewId) {
            ...
            private class MediaCell {
                ...
                public void setImage(MediaController.PhotoEntry photoEntry2) {
                    ...
                    if (photoEntry2 == null || !photoEntry2.isVideo) {
                        ...
                        this.videoDurationText = AndroidUtilities.formatShortDuration(photoEntry2.duration);
                    }
                    ...
                    if (photoEntry2.thumbPath != null) {
                        this.image.setImage(ImageLocation.getForPath(photoEntry2.thumbPath), (String) null, (ImageLocation) null, (String) null, Theme.chat_attachEmptyDrawable, 0, (String) null, (Object) null, 0);
                        ...
                        imageReceiver.setImage(ImageLocation.getForPath("vthumb://" + photoEntry2.imageId + ":" + photoEntry2.path), (String) null, (ImageLocation) null, (String) null, Theme.chat_attachEmptyDrawable, 0, (String) null, (Object) null, 0);
                        this.image.setAllowStartAnimation(true);
                    } else {
                        this.image.setOrientation(photoEntry2.orientation, true);
                        ImageReceiver imageReceiver2 = this.image;
                        imageReceiver2.setImage(ImageLocation.getForPath("thumb://" + photoEntry2.imageId + ":" + photoEntry2.path), (String) null, (ImageLocation) null, (String) null, Theme.chat_attachEmptyDrawable, 0, (String) null, (Object) null, 0);
                    }
                }
                ...
                private void drawPhotoIndex(Canvas canvas, float top, float right, String indexText, float scale2) {
                    float textSize;
                    String str;
                    ...
                    if (this.indexBitmap != null) {
                        ...
                        this.bitmapPaint.setAlpha((int) (255.0f * scale2));
                ...
                private void drawDuration(Canvas canvas, float left, float bottom, String durationText, float scale2) {
                    String str;
                    float f = left;
                    float f2 = bottom;
                ...
                public boolean draw(Canvas canvas, float t, boolean ignoreBounds) {
                    ...
                    float br = this.roundRadiuses.right;
                    float bl = this.roundRadiuses.bottom;
                    if (f < 1.0f && (rectF = this.fromRoundRadiuses) != null) {
                        ...
                        br = AndroidUtilities.lerp(this.fromRoundRadiuses.right, br, f);
                        bl = AndroidUtilities.lerp(this.fromRoundRadiuses.bottom, bl, f);
                    }
                    float tl2 = AndroidUtilities.lerp(tl, R, dragging);
                    float tr2 = AndroidUtilities.lerp(tr, R, dragging);
                    float br2 = AndroidUtilities.lerp(br, R, dragging);
                    float bl2 = AndroidUtilities.lerp(bl, R, dragging);
                    if (ignoreBounds) {
                        canvas.save();
                        canvas2.translate(-drawingRect.centerX(), -drawingRect.centerY());
                    }
                    this.image.setRoundRadius((int) tl2, (int) tr2, (int) br2, (int) bl2);
                    ...
                    float f2 = bl2;
                    float f3 = br2;
                    drawPhotoIndex(canvas, ((float) AndroidUtilities.dp(10.0f)) + drawingRect.top, drawingRect.right - ((float) AndroidUtilities.dp(10.0f)), indexText, scale2);
                    float f4 = tr2;
                    float f5 = tl2;
                    float f6 = R;
                    RectF rectF2 = drawingRect;
                    float f7 = scale2;
                    drawDuration(canvas, drawingRect.left + ((float) AndroidUtilities.dp(4.0f)), drawingRect.bottom - ((float) AndroidUtilities.dp(4.0f)), this.videoDurationText, scale2);
                    if (ignoreBounds) {
                        canvas.restore();
                    }
                    if (f < 1.0f) {
