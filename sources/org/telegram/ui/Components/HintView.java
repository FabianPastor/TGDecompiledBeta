    ...
    public boolean showForMessageCell(ChatMessageCell cell, Object object, int x, int y, boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m4057lambda$onAnimationEnd$0$orgtelegramuiComponentsHintView$1() {
                    HintView.this.hide();
                }
            });
    ...
    public boolean showForView(View view, boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m4058lambda$onAnimationEnd$0$orgtelegramuiComponentsHintView$2() {
                    HintView.this.hide();
                }
            });
            this.animatorSet.setDuration(300);
