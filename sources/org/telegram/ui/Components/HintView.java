...
public class HintView extends FrameLayout {
    ...
    public HintView(Context context, int type, boolean topArrow, Theme.ResourcesProvider resourcesProvider2) {
        ...
        if (this.currentType == 3) {
            ...
            textView2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.dp((i2 == 7 || i2 == 8 || i2 == 9) ? 6.0f : 3.0f), getThemedColor("chat_gifSaveHintBackground")));
    ...
    public boolean showForMessageCell(ChatMessageCell cell, Object object, int x, int y, boolean animated) {
        ...
        if (i3 == 0) {
            ...
            if (count.intValue() == -1) {
                ...
                if (count.intValue() == 0) {
                    ...
                    this.textView.setText(LocaleController.formatPluralString("Answer", count.intValue()));
                }
            } else if (count.intValue() == 0) {
                this.textView.setText(LocaleController.getString("NoVotes", NUM));
            } else {
                this.textView.setText(LocaleController.formatPluralString("Vote", count.intValue()));
            }
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m2336lambda$onAnimationEnd$0$orgtelegramuiComponentsHintView$1() {
                    HintView.this.hide();
                }
            });
    ...
    public boolean showForView(View view, boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public /* synthetic */ void m2337lambda$onAnimationEnd$0$orgtelegramuiComponentsHintView$2() {
                    HintView.this.hide();
                }
            });
            this.animatorSet.setDuration(300);
