...
public final /* synthetic */ class JoinGroupAlert$$ExternalSyntheticLambda3 implements RequestDelegate {
    ...
    public /* synthetic */ JoinGroupAlert$$ExternalSyntheticLambda3(JoinGroupAlert joinGroupAlert, TLRPC$TL_messages_importChatInvite tLRPC$TL_messages_importChatInvite) {
        this.f$0 = joinGroupAlert;
        this.f$1 = tLRPC$TL_messages_importChatInvite;
    }

    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$new$2(this.f$1, tLObject, tLRPC$TL_error);
    }
}
