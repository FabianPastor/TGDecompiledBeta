...
public final /* synthetic */ class SlotsDrawable$$ExternalSyntheticLambda8 implements Runnable {
    ...
    public /* synthetic */ SlotsDrawable$$ExternalSyntheticLambda8(SlotsDrawable slotsDrawable, int i, ChatMessageCell chatMessageCell) {
    ...
    public final void run() {
        this.f$0.m1418lambda$setBaseDice$4$orgtelegramuiComponentsSlotsDrawable(this.f$1, this.f$2);
    }
}
