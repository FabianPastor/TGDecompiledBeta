...
public final /* synthetic */ class -$$Lambda$AlertsCreator$Z4kCfZq2Csg4JqBOo8whPkThoNo implements OnClickListener {
    ...
    public /* synthetic */ -$$Lambda$AlertsCreator$Z4kCfZq2Csg4JqBOo8whPkThoNo(long j, int i, boolean z, IntCallback intCallback, int i2, BaseFragment baseFragment, ArrayList arrayList, IntCallback intCallback2, Builder builder) {
        this.f$0 = j;
        this.f$1 = i;
        this.f$2 = z;
