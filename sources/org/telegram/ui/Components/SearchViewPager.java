...
public class SearchViewPager extends ViewPagerFixed implements FilteredSearchView.UiCallback {
        ...
        if (this.isActionModeShowed != show) {
            if (!show || !this.parent.getActionBar().isActionModeShowed()) {
                if (show && !this.parent.getActionBar().actionModeIsExist("search_view_pager")) {
                    ...
                    this.deleteItem = actionMode.addItemWithWidth(202, NUM, AndroidUtilities.dp(54.0f), LocaleController.getString("Delete", NUM));
                }
    ...
    public /* synthetic */ void m4318x21ad9157(ArrayList messageObjects, DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m4319xe499fab6(DialogsActivity fragment1, ArrayList dids, CharSequence message, boolean param) {
