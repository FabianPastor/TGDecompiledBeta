...
public final /* synthetic */ class AlertsCreator$$ExternalSyntheticLambda50 implements View.OnClickListener {
    ...
    public /* synthetic */ AlertsCreator$$ExternalSyntheticLambda50(BaseFragment baseFragment, EditTextBoldCursor editTextBoldCursor, Theme.ThemeAccent themeAccent, Theme.ThemeInfo themeInfo, AlertDialog alertDialog) {
    ...
    public final void onClick(View view) {
        AlertsCreator.lambda$createThemeCreateDialog$109(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, view);
    }
}
