...
public class PhotoViewerWebView extends FrameLayout {
    ...
    private class YoutubeProxy {
        ...
        public /* synthetic */ void m2500x81e88var_() {
    ...
    public PipVideoView openInPip() {
        ...
        pipVideoView2.show((Activity) getContext(), PhotoViewer.getInstance(), (this.currentWebpage.embed_width == 0 || this.currentWebpage.embed_height == 0) ? 1.0f : ((float) this.currentWebpage.embed_width) / ((float) this.currentWebpage.embed_height), 0, this.webView);
