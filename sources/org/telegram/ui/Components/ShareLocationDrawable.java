...
public class ShareLocationDrawable extends Drawable {
    ...
    public ShareLocationDrawable(Context context, boolean small) {
        ...
        if (small) {
            ...
            this.drawableRight = context.getResources().getDrawable(C0446R.drawable.smallanimationpinright);
            return;
        }
        ...
        this.drawableRight = context.getResources().getDrawable(C0446R.drawable.animationpinright);
    }
