...
public class ShareLocationDrawable extends Drawable {
    ...
    public ShareLocationDrawable(Context context, boolean small) {
        this.isSmall = small;
        if (small) {
            this.drawable = context.getResources().getDrawable(C0431R.drawable.smallanimationpin);
            this.drawableLeft = context.getResources().getDrawable(C0431R.drawable.smallanimationpinleft);
            this.drawableRight = context.getResources().getDrawable(C0431R.drawable.smallanimationpinright);
            return;
        }
        this.drawable = context.getResources().getDrawable(C0431R.drawable.animationpin);
        this.drawableLeft = context.getResources().getDrawable(C0431R.drawable.animationpinleft);
        this.drawableRight = context.getResources().getDrawable(C0431R.drawable.animationpinright);
    }
