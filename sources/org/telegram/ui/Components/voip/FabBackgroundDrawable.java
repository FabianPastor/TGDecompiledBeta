...
public class FabBackgroundDrawable extends Drawable {
    ...
    protected void onBoundsChange(Rect rect) {
        rect = Math.min(rect.width(), rect.height());
        if (rect <= null) {
            this.shadowBitmap = null;
            return;
        }
        this.shadowBitmap = Bitmap.createBitmap(rect, rect, Config.ALPHA_8);
        ...
        rect /= 2;
        float f = (float) rect;
        canvas.drawCircle(f, f, (float) (rect - AndroidUtilities.dp(4.0f)), paint);
    }
