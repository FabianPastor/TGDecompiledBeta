...
public class GroupCallRenderersContainer extends FrameLayout {
    ...
    public /* synthetic */ void m4558x30f2e92f(GroupCallActivity groupCallActivity2, View v) {
        if (isRtmpStream()) {
    ...
    public /* synthetic */ void m4559xe34ac4fa(final GroupCallMiniTextureView removingMiniView, final GroupCallMiniTextureView finalNewSmallTextureView) {
        ValueAnimator valueAnimator = this.replaceFullscreenViewAnimator;
        if (valueAnimator != null) {
            valueAnimator.start();
        }
    ...
    public /* synthetic */ void m4560x9dCLASSNAMEb(final GroupCallMiniTextureView newSmallTextureView) {
    ...
    public /* synthetic */ void m4561x583605fc(GroupCallMiniTextureView newFullscreenTextureView, ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4562x12aba67d(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4554x200965e9(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4555x102cdcf5(float fromScale, float fromTranslateX, float fromTranslateY, ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4563x9var_CLASSNAME() {
