...
public class CallSwipeView extends View {
    ...
    class C13451 extends AnimatorListenerAdapter {
        private Runnable restarter = new C13441();
    ...
    private void init() {
        ...
        for (int i = 0; i < this.arrowAlphas.length; i++) {
            ...
            anim.setStartDelay((long) (Callback.DEFAULT_DRAG_ANIMATION_DURATION * i));
            anims.add(anim);
        }
        this.arrowAnim = new AnimatorSet();
        this.arrowAnim.playTogether(anims);
        this.arrowAnim.addListener(new C13451());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            float f = 16.0f;
            if (offsetX > ((float) AndroidUtilities.dp((float) (16 * i)))) {
