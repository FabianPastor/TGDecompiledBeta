...
public class VoIPPiPView implements VoIPService.StateListener, NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m4582lambda$new$0$orgtelegramuiComponentsvoipVoIPPiPView(ValueAnimator valueAnimator) {
    ...
    public /* synthetic */ void m4583lambda$new$2$orgtelegramuiComponentsvoipVoIPPiPView(Context context, View v) {
    ...
    private class FloatingView extends FrameLayout {
            ...
            if (VoIPPiPView.instance != null && !VoIPPiPView.this.expandedAnimationInProgress && VoIPPiPView.instance.expanded != expanded) {
                ...
                if (expanded) {
                    ...
                    valueAnimator.addListener(new AnimatorListenerAdapter() {
                        ...
                        public /* synthetic */ void m4585xbeabb793(boolean expanded) {
        ...
        public /* synthetic */ void m4584x8bCLASSNAMEf(float scale, VoIPPiPView pipViewExpanded) {
            if (VoIPPiPView.expandedInstance != null) {
