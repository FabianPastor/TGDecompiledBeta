...
public class ReactionsEffectOverlay {
    ...
    private ReactionsEffectOverlay(Context context, BaseFragment fragment2, ReactionsContainerLayout reactionsLayout, ChatMessageCell cell2, float x, float y, String reaction2, int currentAccount2, int animationType2) {
        ...
        if (i3 == 2) {
            size = AndroidUtilities.dp(34.0f);
        } else if (i3 == 1) {
            size = AndroidUtilities.dp(80.0f);
        } else {
            size = Math.round(((float) Math.min(AndroidUtilities.dp(350.0f), Math.min(AndroidUtilities.displaySize.x, AndroidUtilities.displaySize.y))) * 0.8f);
        }
        int sizeForFilter2 = (int) ((((float) size) * 2.0f) / AndroidUtilities.density);
        int emojiSize = size >> 1;
        this.animateInProgress = 0.0f;
        this.animateOutProgress = 0.0f;
        FrameLayout frameLayout = new FrameLayout(context);
        this.container = frameLayout;
        int emojiSizeForFilter = sizeForFilter2 >> 1;
        int emojiSize2 = emojiSize;
        int sizeForFilter3 = sizeForFilter2;
        ...
        this.windowView = new FrameLayout(context) {
            ...
            /* JADX WARNING: Removed duplicated region for block: B:202:0x0678  */
            ...
            public /* synthetic */ void m4282xd3d15369() {
            ...
            public /* synthetic */ void m4283xCLASSNAMEd7aa() {
                ReactionsEffectOverlay.this.removeCurrentView();
            }
        ...
        if (availableReaction != null) {
            ...
            if (i11 != 2) {
                ...
                sizeForFilter = sizeForFilter3;
                sb2.append(sizeForFilter);
                sb2.append("_");
                sb2.append(sizeForFilter);
                sb2.append("_pcache");
            ...
            int size3 = size2;
            int topOffset = (size3 - emojiSize3) >> 1;
            if (i == i2) {
                leftOffset = topOffset;
            } else {
                leftOffset = size3 - emojiSize3;
            }
            ...
            if (i != i2) {
                animationView3.getImageReceiver().setImage(ImageLocation.getForDocument(availableReaction.static_icon), "40_40", (Drawable) null, "webp", availableReaction, 1);
            }
            ...
            frameLayout3.getLayoutParams().width = size3;
            frameLayout3.getLayoutParams().height = size3;
            ...
            animationView.getLayoutParams().width = size3;
            animationView.getLayoutParams().height = size3;
            animationView.getLayoutParams().width = size3;
            animationView.getLayoutParams().height = size3;
