...
public class FragmentContextView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public FragmentContextView(android.content.Context r28, org.telegram.ui.ActionBar.BaseFragment r29, android.view.View r30, boolean r31, org.telegram.ui.ActionBar.Theme.ResourcesProvider r32) {
        ...
        L_0x0066:
            ...
            r1.<init>(r7)
            r0.shadow = r1
            r2 = 2131165275(0x7var_b, float:1.7944763E38)
        ...
        L_0x00ff:
            ...
            r1.<init>(r7)
            r0.joinButton = r1
            r2 = 2131629004(0x7f0e13cc, float:1.8885317E38)
            ...
            r4 = 2131628399(0x7f0e116f, float:1.888409E38)
            ...
            r4 = 2131628398(0x7f0e116e, float:1.8884088E38)
        ...
        L_0x02f3:
            ...
            r21 = 2131558577(0x7f0d00b1, float:1.8742474E38)
        ...
        L_0x0366:
            ...
            r1.<init>(r7)
            r0.closeButton = r1
            r2 = 2131165619(0x7var_b3, float:1.794546E38)
    ...
    public /* synthetic */ void m987lambda$new$0$orgtelegramuiComponentsFragmentContextView(View v) {
    ...
    public /* synthetic */ void m988lambda$new$1$orgtelegramuiComponentsFragmentContextView(View v) {
        callOnClick();
    }

    /* renamed from: lambda$new$2$org-telegram-ui-Components-FragmentContextView  reason: not valid java name */
    public /* synthetic */ void m990lambda$new$2$orgtelegramuiComponentsFragmentContextView(int id) {
    ...
    public /* synthetic */ void m991lambda$new$3$orgtelegramuiComponentsFragmentContextView(View v) {
        float newSpeed;
    ...
    public /* synthetic */ boolean m992lambda$new$4$orgtelegramuiComponentsFragmentContextView(View view) {
    ...
    public /* synthetic */ void m993lambda$new$5$orgtelegramuiComponentsFragmentContextView() {
        updateAvatars(true);
    }

    /* renamed from: lambda$new$6$org-telegram-ui-Components-FragmentContextView  reason: not valid java name */
    public /* synthetic */ void m994lambda$new$6$orgtelegramuiComponentsFragmentContextView(View v) {
    ...
    public /* synthetic */ void m996lambda$new$8$orgtelegramuiComponentsFragmentContextView(Theme.ResourcesProvider resourcesProvider2, View v) {
    ...
    public /* synthetic */ void m995lambda$new$7$orgtelegramuiComponentsFragmentContextView(DialogInterface dialogInterface, int i) {
        BaseFragment baseFragment = this.fragment;
        if (baseFragment instanceof DialogsActivity) {
            for (int a = 0; a < 4; a++) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ void m989lambda$new$10$orgtelegramuiComponentsFragmentContextView(org.telegram.ui.ActionBar.Theme.ResourcesProvider r17, org.telegram.ui.ActionBar.BaseFragment r18, android.view.View r19) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
        ...
        L_0x01d4:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.ui.Components.FragmentContextView.m989lambda$new$10$orgtelegramuiComponentsFragmentContextView(org.telegram.ui.ActionBar.Theme$ResourcesProvider, org.telegram.ui.ActionBar.BaseFragment, android.view.View):void");
    }

    /* renamed from: lambda$new$9$org-telegram-ui-Components-FragmentContextView  reason: not valid java name */
    public /* synthetic */ void m997lambda$new$9$orgtelegramuiComponentsFragmentContextView(DialogInterface dialog) {
        checkImport(false);
    }
    ...
    public void openSharingLocation(LocationController.SharingLocationInfo info) {
        if (info != null && (this.fragment.getParentActivity() instanceof LaunchActivity)) {
            ...
            launchActivity.m3690lambda$runLinkRequest$59$orgtelegramuiLaunchActivity(locationActivity);
        }
    }
                ...
                if (locationSharingCount == 0) {
                    ...
                    if (LocationController.getInstance(currentAccount).isSharingLocation(dialogId)) {
                        if (otherSharingCount == 0) {
                            ...
                            fullString = String.format("%1$s - %2$s %3$s", new Object[]{liveLocation, LocaleController.getString("ChatYourSelfName", NUM), LocaleController.formatPluralString("AndOther", otherSharingCount, new Object[0])});
                        } else {
                        ...
                        fullString = String.format("%1$s - %2$s %3$s", new Object[]{liveLocation, UserObject.getFirstName(notYouUser), LocaleController.formatPluralString("AndOther", otherSharingCount, new Object[0])});
                    } else {
    ...
    public /* synthetic */ void m998x92aab17d() {
