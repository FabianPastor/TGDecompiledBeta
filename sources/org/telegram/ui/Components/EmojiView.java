...
public class EmojiView extends FrameLayout implements NotificationCenterDelegate {
    private static final OnScrollChangedListener NOP = new C15082();
    ...
    private StickerPreviewViewerDelegate stickerPreviewViewerDelegate = new C15061();
    ...
    class C15061 implements StickerPreviewViewerDelegate {
        C15061() {
        }
    ...
    static class C15082 implements OnScrollChangedListener {
        C15082() {
        }
    ...
    class C15113 extends ViewOutlineProvider {
        C15113() {
        }
    ...
    class C15135 extends SpanSizeLookup {
        C15135() {
        }
    ...
    class C15146 implements OnTouchListener {
        C15146() {
        }
    ...
    class C15157 implements OnItemClickListener {
        C15157() {
        }
    ...
    class C15168 implements OnClickListener {
        C15168() {
        }
    ...
    private class EmojiColorPickerView extends View {
        private Drawable arrowDrawable = getResources().getDrawable(C0500R.drawable.stickers_back_arrow);
        private int arrowX;
        private Drawable backgroundDrawable = getResources().getDrawable(C0500R.drawable.stickers_back_all);
    ...
    private class StickersGridAdapter extends SelectionAdapter {
        ...
        class C15233 implements OnClickListener {
            C15233() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 2:
                    ...
                    ((StickerSetNameCell) view).setOnIconClickListener(new C15222());
                    break;
                case 3:
                    view = new StickerSetGroupInfoCell(this.context);
                    ((StickerSetGroupInfoCell) view).setAddOnClickListener(new C15233());
                ...
                case 2:
                    ...
                    if (position == EmojiView.this.groupStickerPackPosition) {
                        ...
                        if (EmojiView.this.groupStickersHidden && EmojiView.this.groupStickerSet == null) {
                            ...
                            icon = EmojiView.this.groupStickerSet != null ? C0500R.drawable.stickersclose : C0500R.drawable.stickerset_close;
                        }
                        ...
                        cell3.setText(LocaleController.formatString(str, C0500R.string.CurrentGroupStickers, objArr), icon);
                        return;
                    }
                    ...
                    if (object instanceof TL_messages_stickerSet) {
                        ...
                        cell3.setText(LocaleController.getString("RecentStickers", C0500R.string.RecentStickers), 0);
                        return;
                    } else if (object == EmojiView.this.favouriteStickers) {
                        cell3.setText(LocaleController.getString("FavoriteStickers", C0500R.string.FavoriteStickers), 0);
                        return;
                    } else {
                        return;
                    }
    ...
    private class StickersSearchGridAdapter extends SelectionAdapter {
        ...
        private Runnable searchRunnable = new C15281();
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 3:
                    ...
                    ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new C15303());
                    break;
                case 4:
                    view = new View(this.context);
                    view.setLayoutParams(new LayoutParams(-1, EmojiView.this.searchFieldHeight));
                ...
                case 5:
                    ...
                    imageView.setImageResource(C0500R.drawable.stickers_none);
                    ...
                    textView.setText(LocaleController.getString("NoStickersFound", C0500R.string.NoStickersFound));
    ...
    private class TrendingGridAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                ...
                case 2:
                    view = new FeaturedStickerSetInfoCell(this.context, 17);
                    ((FeaturedStickerSetInfoCell) view).setAddOnClickListener(new C15332());
                    break;
            }
            return new Holder(view);
        }
    ...
    public EmojiView(boolean needStickers, boolean needGif, Context context, ChatFull chatFull) {
        ...
        super(context);
        this.stickersDrawable = context.getResources().getDrawable(C0500R.drawable.ic_smiles2_stickers);
        Theme.setDrawableColorByKey(this.stickersDrawable, Theme.key_chat_emojiPanelIcon);
        Drawable[] drawableArr = new Drawable[7];
        drawableArr[0] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_recent, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        drawableArr[1] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_smile, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        drawableArr[2] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_nature, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        drawableArr[3] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_food, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        drawableArr[4] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_car, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        drawableArr[5] = Theme.createEmojiIconSelectorDrawable(context, C0500R.drawable.ic_smiles2_objects, Theme.getColor(Theme.key_chat_emojiPanelIcon), Theme.getColor(Theme.key_chat_emojiPanelIconSelected));
        ...
        if (VERSION.SDK_INT >= 21) {
            this.outlineProvider = new C15113();
        }
        ...
        if (needStickers) {
            ...
            this.stickersLayoutManager.setSpanSizeLookup(new C15135());
            ...
            this.stickersGridView.setOnTouchListener(new C15146());
            this.stickersOnItemClickListener = new C15157();
            ...
            this.searchIconImageView.setImageResource(C0500R.drawable.sticker_search);
                    ...
                    if (event.getAction() == 0) {
                        if (!EmojiView.this.listener.isSearchOpened()) {
                            ...
                            if (EmojiView.this.listener == null || !EmojiView.this.listener.isExpanded()) {
                                ...
                                EmojiView.this.searchAnimation.addListener(new C15171());
            ...
            this.searchEditText.setHint(LocaleController.getString("SearchStickersHint", C0500R.string.SearchStickersHint));
            ...
            if (needGif) {
                ...
                this.gifsGridView.setOnItemLongClickListener(new OnItemLongClickListener() {
                    public boolean onItemClick(View view, int position) {
                        ...
                        builder.setMessage(LocaleController.getString("DeleteGif", C0500R.string.DeleteGif));
                        builder.setPositiveButton(LocaleController.getString("OK", C0500R.string.OK).toUpperCase(), new DialogInterface.OnClickListener() {
            ...
            this.stickersEmptyView.setText(LocaleController.getString("NoStickers", C0500R.string.NoStickers));
        ...
        this.backspaceButton.setImageResource(C0500R.drawable.ic_smiles_backspace);
        ...
        this.noRecentTextView.setText(LocaleController.getString("NoRecent", C0500R.string.NoRecent));
    ...
    private void updateStickerTabs() {
        if (this.stickersTab != null) {
            ...
            Drawable drawable = getContext().getResources().getDrawable(C0500R.drawable.ic_smiles2_smile);
            ...
            if (this.showGifs && !this.recentGifs.isEmpty()) {
                drawable = getContext().getResources().getDrawable(C0500R.drawable.ic_smiles_gif);
                Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
                this.stickersTab.addIconTab(drawable);
            ...
            if (!(this.trendingGridAdapter == null || this.trendingGridAdapter.getItemCount() == 0 || unread.isEmpty())) {
                drawable = getContext().getResources().getDrawable(C0500R.drawable.ic_smiles_trend);
                Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
            ...
            if (!this.favouriteStickers.isEmpty()) {
                ...
                this.stickersTabOffset++;
                drawable = getContext().getResources().getDrawable(C0500R.drawable.staredstickerstab);
                Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
                this.stickersTab.addIconTab(drawable);
            }
            if (!this.recentStickers.isEmpty()) {
                ...
                this.stickersTabOffset++;
                drawable = getContext().getResources().getDrawable(C0500R.drawable.ic_smiles2_recent);
                Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
                this.stickersTab.addIconTab(drawable);
            }
            ...
            drawable = getContext().getResources().getDrawable(C0500R.drawable.ic_smiles_settings);
            Theme.setDrawableColorByKey(drawable, Theme.key_chat_emojiPanelIcon);
            this.stickersTab.addIconTab(drawable);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (AndroidUtilities.isInMultiwindow) {
            if (this.currentBackgroundType != 1) {
                ...
                setBackgroundResource(C0500R.drawable.smiles_popup);
                getBackground().setColorFilter(new PorterDuffColorFilter(Theme.getColor(Theme.key_chat_emojiPanelBackground), Mode.MULTIPLY));
        ...
        if (this.mediaBanTooltip.getVisibility() != 0) {
            ...
            if (chat != null && chat.banned_rights != null) {
                if (AndroidUtilities.isBannedForever(chat.banned_rights.until_date)) {
                    this.mediaBanTooltip.setText(LocaleController.getString("AttachStickersRestrictedForever", C0500R.string.AttachStickersRestrictedForever));
                } else {
                    this.mediaBanTooltip.setText(LocaleController.formatString("AttachStickersRestricted", C0500R.string.AttachStickersRestricted, LocaleController.formatDateForBan((long) chat.banned_rights.until_date)));
                }
                ...
                AnimatorSet.addListener(new AnimatorListenerAdapter() {
                    ...
                    class C15101 implements Runnable {
                        ...
                        class C15091 extends AnimatorListenerAdapter {
                            C15091() {
                            }
                        ...
                        public void run() {
                            if (EmojiView.this.mediaBanTooltip != null) {
                                ...
                                AnimatorSet.addListener(new C15091());
                    ...
                    public void onAnimationEnd(Animator animation) {
                        AndroidUtilities.runOnUIThread(new C15101(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                    }
                });
                AnimatorSet.setDuration(300);
                AnimatorSet.start();
