...
public final class BulletinFactory {
    ...
    public Bulletin createMembersNotifyInfo(boolean z) {
        if (z) {
            Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(getContext());
            lottieLayout.setAnimation(NUM, 36, 36, "NULL BODY", "BODY", "Waves R", "Waves L", "Bottom");
            lottieLayout.textView.setText(LocaleController.getString("ChannelNotifyMembersInfoOn", NUM));
            return create(lottieLayout, 1500);
        }
        Bulletin.LottieLayout lottieLayout2 = new Bulletin.LottieLayout(getContext());
        lottieLayout2.setAnimation(NUM, 36, 36, "NULL BODY", "BODY", "Pieces", "Line Cross", "Bottom");
        lottieLayout2.textView.setText(LocaleController.getString("ChannelNotifyMembersInfoOff", NUM));
        return create(lottieLayout2, 1500);
    }
    ...
    public static org.telegram.ui.Components.Bulletin createMuteBulletin(org.telegram.ui.ActionBar.BaseFragment r10, int r11) {
        ...
        L_0x002a:
            ...
            throw r10
        L_0x0030:
            r11 = 2131626359(0x7f0e0977, float:1.8879952E38)
    ...
    public static Bulletin createRemoveFromChatBulletin(BaseFragment baseFragment, String str, String str2) {
        Bulletin.LottieLayout lottieLayout = new Bulletin.LottieLayout(baseFragment.getParentActivity());
        lottieLayout.setAnimation(NUM, "Hand");
        lottieLayout.textView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("UserRemovedFromChatHint", NUM, str, str2)));
        return Bulletin.make(baseFragment, (Bulletin.Layout) lottieLayout, 1500);
    }
