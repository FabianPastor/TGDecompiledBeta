...
public final /* synthetic */ class StickersAlert$$ExternalSyntheticLambda20 implements RequestDelegate {
    ...
    public /* synthetic */ StickersAlert$$ExternalSyntheticLambda20(StickersAlert stickersAlert, Object obj, TLRPC.TL_messages_getAttachedStickers tL_messages_getAttachedStickers, RequestDelegate requestDelegate) {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m1447lambda$new$2$orgtelegramuiComponentsStickersAlert(this.f$1, this.f$2, this.f$3, tLObject, tL_error);
    }
}
