...
public class PhotoCropView extends FrameLayout {
    ...
    class C12463 implements Runnable {
        C12463() {
        }
    ...
    class C20791 implements CropViewListener {
        C20791() {
        }
    ...
    class C20802 implements RotationWheelListener {
        C20802() {
        }
    ...
    public void setBitmap(Bitmap bitmap, int rotation, boolean freeform) {
        ...
        if (this.cropView == null) {
            ...
            this.cropView.setListener(new C20791());
            ...
            this.wheelView.setListener(new C20802());
    ...
    public void startAnimationRunnable() {
        if (this.animationRunnable == null) {
            this.animationRunnable = new C12463();
