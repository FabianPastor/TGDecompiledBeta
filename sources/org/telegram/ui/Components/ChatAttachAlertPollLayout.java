...
public class ChatAttachAlertPollLayout extends ChatAttachAlert.AttachAlertLayout {
    ...
    public /* synthetic */ void m856x3180e5dc(View view, int position) {
        boolean checked;
    ...
    public /* synthetic */ void m857x54var_cc4(TLRPC.TL_messageMediaPoll poll, HashMap params, boolean notify, int scheduleDate) {
    ...
    public /* synthetic */ void m855x9CLASSNAMEa(DialogInterface dialogInterface, int i) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (position == ChatAttachAlertPollLayout.this.solutionInfoRow) {
                        ...
                        cell2.setText(LocaleController.formatString("AddAnOptionInfo", NUM, LocaleController.formatPluralString("Option", 10 - ChatAttachAlertPollLayout.this.answersCount, new Object[0])));
                        return;
                    }
                case 3:
                ...
                case 6:
                    ...
                    if (position != ChatAttachAlertPollLayout.this.anonymousRow) {
                        if (position != ChatAttachAlertPollLayout.this.multipleRow) {
                            ...
                            String string = LocaleController.getString("PollMultiple", NUM);
                            boolean access$1700 = ChatAttachAlertPollLayout.this.multipleChoise;
                            if (ChatAttachAlertPollLayout.this.quizRow != -1) {
                                z = true;
                            }
                            checkCell.setTextAndCheck(string, access$1700, z);
                            checkCell.setEnabled(true, (ArrayList<Animator>) null);
                            break;
                        }
                    } else {
                        String string2 = LocaleController.getString("PollAnonymous", NUM);
                        ...
                        checkCell.setTextAndCheck(string2, access$1400, z);
                        checkCell.setEnabled(true, (ArrayList<Animator>) null);
                        break;
                    }
                    break;
        ...
        public /* synthetic */ void m858xd77380a3(View v) {
            int position;
            if (v.getTag() == null) {
                v.setTag(1);
        ...
        public /* synthetic */ boolean m859x41a308c2(PollEditTextCell cell, TextView v, int actionId, KeyEvent event) {
            int position;
            if (actionId != 5) {
                return false;
            }
