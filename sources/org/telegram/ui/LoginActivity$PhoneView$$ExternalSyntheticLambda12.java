...
public final /* synthetic */ class LoginActivity$PhoneView$$ExternalSyntheticLambda12 implements RequestDelegate {
    ...
    public /* synthetic */ LoginActivity$PhoneView$$ExternalSyntheticLambda12(LoginActivity.PhoneView phoneView, Bundle bundle, TLRPC$TL_auth_sendCode tLRPC$TL_auth_sendCode) {
        this.f$0 = phoneView;
        this.f$1 = bundle;
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$onNextPressed$13(this.f$1, this.f$2, tLObject, tLRPC$TL_error);
    }
}
