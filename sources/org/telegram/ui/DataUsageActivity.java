...
public class DataUsageActivity extends BaseFragment {
    ...
    class C13291 extends ActionBarMenuOnItemClick {
        C13291() {
        }
    ...
    class C13312 implements OnItemClickListener {
        ...
        public void onItemClick(View view, int position) {
            if (DataUsageActivity.this.getParentActivity() != null && position == DataUsageActivity.this.resetRow) {
                ...
                builder.setMessage(LocaleController.getString("ResetStatisticsAlert", C0431R.string.ResetStatisticsAlert));
                builder.setPositiveButton(LocaleController.getString("Reset", C0431R.string.Reset), new C13301());
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    if (position == DataUsageActivity.this.resetSection2Row) {
                        holder.itemView.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C0431R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        return;
                    } else {
                        holder.itemView.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C0431R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                    }
                case 1:
                    ...
                    if (position == DataUsageActivity.this.resetRow) {
                        ...
                        textCell.setText(LocaleController.getString("ResetStatistics", C0431R.string.ResetStatistics), false);
                    ...
                    if (position == DataUsageActivity.this.callsSentRow) {
                        textCell.setTextAndValue(LocaleController.getString("OutgoingCalls", C0431R.string.OutgoingCalls), String.format("%d", new Object[]{Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentItemsCount(DataUsageActivity.this.currentType, type))}), true);
                        return;
                    } else if (position == DataUsageActivity.this.callsReceivedRow) {
                        textCell.setTextAndValue(LocaleController.getString("IncomingCalls", C0431R.string.IncomingCalls), String.format("%d", new Object[]{Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getRecivedItemsCount(DataUsageActivity.this.currentType, type))}), true);
                        return;
                        ...
                        textCell.setTextAndValue(LocaleController.getString("CallsTotalTime", C0431R.string.CallsTotalTime), time, false);
                        return;
                        ...
                        textCell.setTextAndValue(LocaleController.getString("CountSent", C0431R.string.CountSent), String.format("%d", new Object[]{Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentItemsCount(DataUsageActivity.this.currentType, type))}), true);
                        return;
                        ...
                        textCell.setTextAndValue(LocaleController.getString("CountReceived", C0431R.string.CountReceived), String.format("%d", new Object[]{Integer.valueOf(StatsController.getInstance(DataUsageActivity.this.currentAccount).getRecivedItemsCount(DataUsageActivity.this.currentType, type))}), true);
                        return;
                        ...
                        textCell.setTextAndValue(LocaleController.getString("BytesSent", C0431R.string.BytesSent), AndroidUtilities.formatFileSize(StatsController.getInstance(DataUsageActivity.this.currentAccount).getSentBytesCount(DataUsageActivity.this.currentType, type)), true);
                        return;
                ...
                case 2:
                    ...
                    if (position == DataUsageActivity.this.totalSectionRow) {
                        headerCell.setText(LocaleController.getString("TotalDataUsage", C0431R.string.TotalDataUsage));
                        return;
                    } else if (position == DataUsageActivity.this.callsSectionRow) {
                        headerCell.setText(LocaleController.getString("CallsDataUsage", C0431R.string.CallsDataUsage));
                        return;
                    } else if (position == DataUsageActivity.this.filesSectionRow) {
                        headerCell.setText(LocaleController.getString("FilesDataUsage", C0431R.string.FilesDataUsage));
                        return;
                    } else if (position == DataUsageActivity.this.audiosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalAudioCache", C0431R.string.LocalAudioCache));
                        return;
                    } else if (position == DataUsageActivity.this.videosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalVideoCache", C0431R.string.LocalVideoCache));
                        return;
                    } else if (position == DataUsageActivity.this.photosSectionRow) {
                        headerCell.setText(LocaleController.getString("LocalPhotoCache", C0431R.string.LocalPhotoCache));
                        return;
                    } else if (position == DataUsageActivity.this.messagesSectionRow) {
                        headerCell.setText(LocaleController.getString("MessagesDataUsage", C0431R.string.MessagesDataUsage));
                        return;
                    } else {
                        return;
                    }
                case 3:
                    ...
                    cell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C0431R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    cell.setText(LocaleController.formatString("NetworkUsageSince", C0431R.string.NetworkUsageSince, LocaleController.getInstance().formatterStats.format(StatsController.getInstance(DataUsageActivity.this.currentAccount).getResetStatsDate(DataUsageActivity.this.currentType))));
                    return;
                default:
                    return;
            }
    ...
    public View createView(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(LocaleController.getString("MobileUsage", C0431R.string.MobileUsage));
        } else if (this.currentType == 1) {
            this.actionBar.setTitle(LocaleController.getString("WiFiUsage", C0431R.string.WiFiUsage));
        } else if (this.currentType == 2) {
            this.actionBar.setTitle(LocaleController.getString("RoamingUsage", C0431R.string.RoamingUsage));
        }
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setActionBarMenuOnItemClick(new C13291());
        ...
        this.listView.setOnItemClickListener(new C13312());
