...
public class ChatUsersActivity extends BaseFragment implements NotificationCenterDelegate {
            ...
            switch (viewHolder.getItemViewType()) {
                case 0:
                    ...
                    if (i2 >= ChatUsersActivity.this.participantsStartRow && i2 < ChatUsersActivity.this.participantsEndRow) {
                        access$3100 = ChatUsersActivity.this.participantsEndRow;
                    } else if (i2 < ChatUsersActivity.this.contactsStartRow || i2 >= ChatUsersActivity.this.contactsEndRow) {
                        access$3100 = ChatUsersActivity.this.botEndRow;
                    } else {
                        access$3100 = ChatUsersActivity.this.contactsEndRow;
                    }
                    ...
                    if (ChatUsersActivity.this.type == 3) {
                        access$3600 = ChatUsersActivity.this.formatUserPermissions(tL_chatBannedRights);
                        if (i2 != access$3100 - 1) {
                            z = true;
                        }
                ...
                case 7:
                    ...
                    if (i2 == ChatUsersActivity.this.changeInfoRow) {
                        access$3600 = LocaleController.getString("UserRestrictionsChangeInfo", NUM);
                        z5 = !ChatUsersActivity.this.defaultBannedRights.change_info && TextUtils.isEmpty(ChatUsersActivity.this.currentChat.username);
                        textCheckCell2.setTextAndCheck(access$3600, z5, false);
                        ...
                        access$3600 = LocaleController.getString("UserRestrictionsPinMessages", NUM);
                        z5 = !ChatUsersActivity.this.defaultBannedRights.pin_messages && TextUtils.isEmpty(ChatUsersActivity.this.currentChat.username);
                        textCheckCell2.setTextAndCheck(access$3600, z5, true);
    ...
    private class SearchAdapter extends SelectionAdapter {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:56:0x0158 A:{LOOP_END, LOOP:1: B:32:0x00c8->B:56:0x0158} */
        /* JADX WARNING: Removed duplicated region for block: B:103:0x011d A:{SYNTHETIC} */
        /* JADX WARNING: Removed duplicated region for block: B:94:0x0255 A:{LOOP_END, LOOP:3: B:72:0x01c5->B:94:0x0255} */
        ...
        /* JADX WARNING: Missing block: B:41:0x0106, code skipped:
            if (r11.contains(r4.toString()) != false) goto L_0x011a;
     */
     ...
     */
        ...
        L_0x0072:
            r16 = r1.get(r15);
            r5 = r16;
            r5 = (org.telegram.tgnet.TLObject) r5;
            r11 = r5 instanceof org.telegram.tgnet.TLRPC.ChatParticipant;
            if (r11 == 0) goto L_0x0084;
        L_0x007e:
            r11 = r5;
            r11 = (org.telegram.tgnet.TLRPC.ChatParticipant) r11;
            r11 = r11.user_id;
            goto L_0x008d;
        L_0x0084:
            r11 = r5 instanceof org.telegram.tgnet.TLRPC.ChannelParticipant;
        ...
        L_0x00a9:
            goto L_0x0167;
        L_0x00ab:
            r7 = org.telegram.messenger.UserObject.getUserName(r6);
            r7 = r7.toLowerCase();
            r11 = org.telegram.messenger.LocaleController.getInstance();
            r11 = r11.getTranslitString(r7);
            r17 = r7.equals(r11);
        ...
        L_0x0120:
            r4 = r6.first_name;
            r6 = r6.last_name;
            r1 = org.telegram.messenger.AndroidUtilities.generateSearchName(r4, r6, r1);
            r9.add(r1);
            goto L_0x0154;
        L_0x012c:
            r4 = new java.lang.StringBuilder;
        ...
        L_0x0182:
            ...
            r5 = org.telegram.ui.ChatUsersActivity.this;
        ...
        L_0x01a6:
            ...
            goto L_0x025e;
        L_0x01ab:
            r5 = org.telegram.messenger.UserObject.getUserName(r4);
            r5 = r5.toLowerCase();
            r6 = org.telegram.messenger.LocaleController.getInstance();
            r6 = r6.getTranslitString(r5);
            r7 = r5.equals(r6);
        ...
        L_0x0214:
            r5 = r4.first_name;
            r6 = r4.last_name;
            r5 = org.telegram.messenger.AndroidUtilities.generateSearchName(r5, r6, r15);
            r9.add(r5);
            r15 = 0;
            goto L_0x0249;
        L_0x0221:
            ...
            r6 = r6.toString();
            r15 = 0;
            r5 = org.telegram.messenger.AndroidUtilities.generateSearchName(r5, r15, r6);
            r9.add(r5);
        L_0x0249:
            r3.add(r4);
            r5 = r4.id;
        ...
        public void removeUserId(int i) {
            ...
            Object obj = this.searchResultMap.get(i);
            if (obj != null) {
     ...
     */
        ...
        public /* synthetic */ boolean lambda$onCreateViewHolder$4$ChatUsersActivity$SearchAdapter(ManageChatUserCell manageChatUserCell, boolean z) {
            ...
            return ChatUsersActivity.this.createMenuForParticipant((ChannelParticipant) item, z ^ 1);
        }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:67:0x015d A:{Catch:{ Exception -> 0x0176 }} */
        /* JADX WARNING: Removed duplicated region for block: B:76:0x017f  */
        /* JADX WARNING: Removed duplicated region for block: B:63:0x0148  */
        /* JADX WARNING: Removed duplicated region for block: B:67:0x015d A:{Catch:{ Exception -> 0x0176 }} */
        /* JADX WARNING: Removed duplicated region for block: B:76:0x017f  */
        ...
        L_0x001b:
            r15 = NUM; // 0x7f0e0242 float:1.887621E38 double:1.053162442E-314;
        ...
        L_0x0032:
            r15 = NUM; // 0x7f0e0281 float:1.8876338E38 double:1.0531624733E-314;
        ...
        L_0x0048:
            r15 = NUM; // 0x7f0e0289 float:1.8876354E38 double:1.0531624773E-314;
            r0 = "ChannelSubscribers";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01ad;
        L_0x0056:
            r15 = NUM; // 0x7f0e025e float:1.8876267E38 double:1.053162456E-314;
            r0 = "ChannelMembers";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01ad;
        ...
        L_0x0068:
            r15 = NUM; // 0x7f0e0526 float:1.887771E38 double:1.053162808E-314;
            r0 = "GlobalSearch";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01ad;
        ...
        L_0x007a:
            r15 = NUM; // 0x7f0e032a float:1.887668E38 double:1.053162557E-314;
            r0 = "Contacts";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01ad;
        ...
        L_0x014c:
            r1 = new android.text.SpannableStringBuilder;	 Catch:{ Exception -> 0x0176 }
            r1.<init>();	 Catch:{ Exception -> 0x0176 }
            r1.append(r7);	 Catch:{ Exception -> 0x0176 }
            r1.append(r2);	 Catch:{ Exception -> 0x0176 }
            r5 = org.telegram.messenger.AndroidUtilities.indexOfIgnoreCase(r2, r15);	 Catch:{ Exception -> 0x0176 }
            if (r5 == r11) goto L_0x017d;
        L_0x015d:
            r15 = r15.length();	 Catch:{ Exception -> 0x0176 }
        ...
        L_0x0166:
            r5 = r5 + 1;
        L_0x0168:
            r7 = new android.text.style.ForegroundColorSpan;	 Catch:{ Exception -> 0x0176 }
            r12 = org.telegram.ui.ActionBar.Theme.getColor(r10);	 Catch:{ Exception -> 0x0176 }
    ...
    L_0x0017:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0275 float:1.8876313E38 double:1.0531624674E-314;
    ...
    L_0x0029:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0240 float:1.8876206E38 double:1.053162441E-314;
        r6 = "ChannelBlacklist";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a3;
    ...
    L_0x003a:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e023b float:1.8876196E38 double:1.0531624387E-314;
    ...
    L_0x0053:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0289 float:1.8876354E38 double:1.0531624773E-314;
    ...
    L_0x0062:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e025e float:1.8876267E38 double:1.053162456E-314;
        r6 = "ChannelMembers";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a3;
    ...
    L_0x0073:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0231 float:1.8876175E38 double:1.053162434E-314;
        r6 = "ChannelAddAdmin";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a3;
    ...
    L_0x0084:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0241 float:1.8876208E38 double:1.0531624417E-314;
        r6 = "ChannelBlockUser";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r1.setTitle(r5);
        goto L_0x00a3;
    ...
    L_0x0095:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0e0232 float:1.8876177E38 double:1.0531624343E-314;
    ...
    L_0x00b9:
        ...
        r1 = r9.actionBar;
        r1 = r1.createMenu();
        r5 = NUM; // 0x7var_fc float:1.794509E38 double:1.0529356275E-314;
        r5 = r1.addItem(r0, r5);
    ...
    L_0x00e0:
        r5 = r9.searchItem;
        r6 = NUM; // 0x7f0e0282 float:1.887634E38 double:1.053162474E-314;
    ...
    L_0x00ef:
        r5 = r9.searchItem;
        r6 = NUM; // 0x7f0e09b2 float:1.8880072E38 double:1.053163383E-314;
        r7 = "Search";
        r6 = org.telegram.messenger.LocaleController.getString(r7, r6);
        r5.setSearchFieldHint(r6);
    L_0x00fd:
    ...
    L_0x0101:
        r5 = NUM; // 0x7var_f float:1.7945128E38 double:1.052935637E-314;
        r6 = NUM; // 0x42600000 float:56.0 double:5.50185432E-315;
        r6 = org.telegram.messenger.AndroidUtilities.dp(r6);
        r7 = NUM; // 0x7f0e03e1 float:1.8877052E38 double:1.053162647E-314;
        r8 = "Done";
    ...
    L_0x013f:
        r4 = r9.emptyView;
        r5 = NUM; // 0x7f0e06bf float:1.887854E38 double:1.05316301E-314;
        r6 = "NoResult";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r4.setText(r5);
    L_0x014d:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:260:0x04c7 A:{RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:201:0x0398  */
    ...
    L_0x0120:
        ...
        r1 = NUM; // 0x7f0e0404 float:1.8877123E38 double:1.0531626645E-314;
    ...
    L_0x0135:
        r0 = r21.getParentActivity();
        r1 = NUM; // 0x7f0e0403 float:1.887712E38 double:1.053162664E-314;
    ...
    L_0x03b4:
        ...
        r11.setTitle(r0);
        r0 = NUM; // 0x7f0e00d1 float:1.8875461E38 double:1.05316226E-314;
        r1 = new java.lang.Object[r4];
        r4 = org.telegram.messenger.UserObject.getUserName(r2);
        r1[r3] = r4;
    ...
    private void removeParticipants(int i) {
        ...
        Adapter adapter = this.listView.getAdapter();
        Adapter adapter2 = this.searchListViewAdapter;
        if (adapter == adapter2) {
            adapter2.removeUserId(i);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:123:0x02b7 A:{RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:123:0x02b7 A:{RETURN} */
    /* JADX WARNING: Removed duplicated region for block: B:124:0x02b8  */
    /* JADX WARNING: Removed duplicated region for block: B:124:0x02b8  */
    /* JADX WARNING: Removed duplicated region for block: B:123:0x02b7 A:{RETURN} */
    ...
    L_0x00ab:
        r1 = org.telegram.messenger.UserObject.isDeleted(r3);
        r1 = r1 ^ r15;
        r2 = r2 & r1;
    L_0x00b1:
    ...
    L_0x00d3:
        r0 = NUM; // 0x7f0e03f7 float:1.8877096E38 double:1.053162658E-314;
        r0 = org.telegram.messenger.LocaleController.getString(r12, r0);
        goto L_0x00e4;
    L_0x00db:
        r0 = NUM; // 0x7f0e0a16 float:1.8880274E38 double:1.0531634323E-314;
        r2 = "SetAsAdmin";
        r0 = org.telegram.messenger.LocaleController.getString(r2, r0);
    L_0x00e4:
        r1.add(r0);
        r0 = NUM; // 0x7var_f float:1.7944706E38 double:1.052935534E-314;
        r0 = java.lang.Integer.valueOf(r0);
        r2 = r19;
        r2.add(r0);
        r0 = 0;
    ...
    L_0x011b:
        r12 = NUM; // 0x7f0e0228 float:1.8876157E38 double:1.0531624294E-314;
        ...
        r0.add(r15);
    L_0x0139:
        r12 = NUM; // 0x7f0e05a9 float:1.8877976E38 double:1.0531628725E-314;
        r15 = "KickFromGroup";
        r12 = org.telegram.messenger.LocaleController.getString(r15, r12);
        r1.add(r12);
        r12 = NUM; // 0x7var_ float:1.7944712E38 double:1.0529355356E-314;
        r12 = java.lang.Integer.valueOf(r12);
        r2.add(r12);
        r15 = 2;
    ...
    L_0x0158:
        r12 = NUM; // 0x7var_ float:1.7944712E38 double:1.0529355356E-314;
        r15 = NUM; // 0x7f0e027f float:1.8876334E38 double:1.0531624723E-314;
    ...
    L_0x01d8:
        ...
        r20 = r14;
        r0 = 3;
        r2 = NUM; // 0x7f0e024d float:1.8876232E38 double:1.0531624476E-314;
    ...
    L_0x01f0:
        ...
        r6 = NUM; // 0x7f0e0253 float:1.8876244E38 double:1.0531624506E-314;
    ...
    L_0x0269:
        r0 = r11.currentChat;
        r0 = r0.creator;
        r2 = NUM; // 0x7f0e0280 float:1.8876336E38 double:1.053162473E-314;
    ...
    L_0x0280:
        ...
        r1[r5] = r2;
        r2 = new int[r0];
        r3 = NUM; // 0x7var_ float:1.7944712E38 double:1.0529355356E-314;
        r2[r5] = r3;
        r12 = r1;
        r13 = r2;
        goto L_0x02b5;
    ...
    L_0x0297:
        ...
        r13 = NUM; // 0x7f0e03f7 float:1.8877096E38 double:1.053162658E-314;
        ...
        if (tL_error == null) {
            ...
            if (this.type == 2) {
                ...
                while (i3 < size) {
                    ...
                    Object obj = (this.contactsMap.get(channelParticipant2.user_id) == null && this.botsMap.get(channelParticipant2.user_id) == null && (this.selectType != 1 || !UserObject.isDeleted(getMessagesController().getUser(Integer.valueOf(channelParticipant2.user_id))))) ? null : 1;
                    if (obj != null) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ...
        themeDescriptionArr[32] = new ThemeDescription(this.undoView, ThemeDescription.FLAG_BACKGROUNDFILTER, null, null, null, null, "undo_background");
