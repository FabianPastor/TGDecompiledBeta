...
public class ChatUsersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    private boolean administratorsEndReached;
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public int getItemCount() {
            return (ChatUsersActivity.this.delayResults > 0 || (ChatUsersActivity.this.loadingUsers && !ChatUsersActivity.this.firstLoaded)) ? 0 : ChatUsersActivity.this.rowCount;
        }
     ...
     */
        ...
        L_0x0032:
            r15 = NUM; // 0x7f0d0247 float:1.8743297E38 double:1.0531300656E-314;
        ...
        L_0x0048:
            r15 = NUM; // 0x7f0d024f float:1.8743313E38 double:1.0531300695E-314;
        ...
        L_0x0068:
            r15 = NUM; // 0x7f0d047d float:1.8744445E38 double:1.053130345E-314;
            r0 = "GlobalSearch";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bd;
        ...
        L_0x007a:
            r15 = NUM; // 0x7f0d02db float:1.8743597E38 double:1.0531301387E-314;
            r0 = "Contacts";
            r15 = org.telegram.messenger.LocaleController.getString(r0, r15);
            r14.setText(r15);
            goto L_0x01bd;
    ...
    L_0x0019:
        r1 = r9.actionBar;
        r5 = NUM; // 0x7f0d023c float:1.8743275E38 double:1.05313006E-314;
    ...
    L_0x0141:
        r4 = r9.emptyView;
        r5 = NUM; // 0x7f0d05db float:1.8745155E38 double:1.053130518E-314;
        r6 = "NoResult";
        r5 = org.telegram.messenger.LocaleController.getString(r6, r5);
        r4.setText(r5);
    L_0x014f:
        ...
        r4.setEmptyView(r7);
        r4 = r9.listView;
        r7 = new org.telegram.messenger.support.widget.LinearLayoutManager;
        r7.<init>(r10, r2, r0);
    ...
    L_0x004e:
        r3 = r10.type;
        r5 = NUM; // 0x7f0d036c float:1.8743891E38 double:1.0531302103E-314;
        r11 = "EditAdminRights";
        r12 = "dialogRedIcon";
        r13 = "dialogTextRed2";
        r15 = 2;
    ...
    L_0x0144:
        r0 = NUM; // 0x7var_a float:1.794476E38 double:1.0529355475E-314;
        r2 = 2;
        r11 = NUM; // 0x7f0d0245 float:1.8743293E38 double:1.0531300646E-314;
    ...
    L_0x024b:
        r0 = r10.currentChat;
        r0 = r0.creator;
        r2 = NUM; // 0x7f0d0246 float:1.8743295E38 double:1.053130065E-314;
    ...
    private void loadChatParticipants(int i, int i2) {
        if (!this.loadingUsers) {
            ...
            this.administratorsEndReached = false;
        ...
        if (ChatObject.isChannel(this.currentChat)) {
            ...
            if (i4 == 0) {
                ...
                if (this.selectType == 1) {
                    ...
                    this.contactsEndReached = true;
                    loadChatParticipants(0, 200, false);
                } else if (!this.administratorsEndReached) {
                    tL_channels_getParticipants.filter = new TL_channelParticipantsAdmins();
                    this.administratorsEndReached = true;
                    loadChatParticipants(0, 200, false);
    ...
    public /* synthetic */ void lambda$null$21$ChatUsersActivity(TL_error tL_error, TLObject tLObject, TL_channels_getParticipants tL_channels_getParticipants) {
        ...
        if (tL_error == null) {
            ...
            if (this.type == 2) {
                ...
                while (i < size2) {
                    ChannelParticipant channelParticipant2 = (ChannelParticipant) this.participants.get(i);
