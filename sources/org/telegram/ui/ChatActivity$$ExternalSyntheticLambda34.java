...
public final /* synthetic */ class ChatActivity$$ExternalSyntheticLambda34 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ ChatActivity$$ExternalSyntheticLambda34(ChatActivity chatActivity, String str, CharacterStyle characterStyle, MessageObject messageObject, ChatMessageCell chatMessageCell, int i) {
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        this.f$0.lambda$didPressMessageUrl$212(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dialogInterface, i);
    }
}
