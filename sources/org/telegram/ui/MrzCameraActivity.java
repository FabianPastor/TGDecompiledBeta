...
public class MrzCameraActivity extends BaseFragment implements PreviewCallback {
    ...
    class C14801 extends ActionBarMenuOnItemClick {
        C14801() {
        }
    ...
    class C14823 implements OnTouchListener {
        C14823() {
        }
    ...
    class C14834 implements CameraViewDelegate {
        C14834() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C14801());
        ...
        viewGroup.setOnTouchListener(new C14823());
        this.cameraView = new CameraView(context, false);
        this.cameraView.setDelegate(new C14834());
        viewGroup.addView(this.cameraView, LayoutHelper.createFrame(-1, -1.0f));
        this.titleTextView = new TextView(context);
        this.titleTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
        this.titleTextView.setGravity(1);
        this.titleTextView.setTextSize(1, 24.0f);
        this.titleTextView.setText(LocaleController.getString("PassportScanPassport", C0431R.string.PassportScanPassport));
        ...
        this.descriptionText.setText(LocaleController.getString("PassportScanPassportInfo", C0431R.string.PassportScanPassportInfo));
