...
public class FeaturedStickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C13471 extends ActionBarMenuOnItemClick {
        C13471() {
        }
    ...
    class C13503 implements OnItemClickListener {
        C13503() {
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((FeaturedStickerSetCell) view).setAddOnClickListener(new C13511());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("FeaturedStickers", C0431R.string.FeaturedStickers));
        this.actionBar.setActionBarMenuOnItemClick(new C13471());
        ...
        this.listView.setOnItemClickListener(new C13503());
