...
public final /* synthetic */ class LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda32 implements RequestDelegate {
    ...
    public /* synthetic */ LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda32(LoginActivity.LoginActivitySmsView loginActivitySmsView, TLRPC.TL_auth_signIn tL_auth_signIn) {
        this.f$0 = loginActivitySmsView;
        this.f$1 = tL_auth_signIn;
    }

    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m3871xevar_db(this.f$1, tLObject, tL_error);
    }
}
