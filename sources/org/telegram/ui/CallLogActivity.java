...
public class CallLogActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private static class EmptyTextProgressView extends FrameLayout {
        ...
        public /* synthetic */ void m1500x52cvar_(View v) {
    ...
    private class CallCell extends FrameLayout {
        ...
        public /* synthetic */ void m1499lambda$new$0$orgtelegramuiCallLogActivity$CallCell(View v) {
    ...
    private class GroupCallCell extends FrameLayout {
        ...
        public /* synthetic */ void m1501lambda$new$0$orgtelegramuiCallLogActivity$GroupCallCell(View v) {
    ...
    public View createView(Context context) {
        ...
        this.listView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public /* synthetic */ void m1498lambda$onScrolled$0$orgtelegramuiCallLogActivity$2(CallLogRow row) {
    ...
    public /* synthetic */ void m1489lambda$createView$0$orgtelegramuiCallLogActivity(View view, int position) {
    ...
    public /* synthetic */ boolean m1490lambda$createView$1$orgtelegramuiCallLogActivity(View view, int position) {
        if (!(view instanceof CallCell)) {
            return false;
        }
    ...
    public /* synthetic */ void m1492lambda$createView$3$orgtelegramuiCallLogActivity(View v) {
        Bundle args = new Bundle();
    ...
    public /* synthetic */ void m1491lambda$createView$2$orgtelegramuiCallLogActivity(TLRPC.User user, String param, ContactsActivity activity) {
    ...
    public /* synthetic */ void m1497lambda$showDeleteAlert$5$orgtelegramuiCallLogActivity(boolean all, boolean[] checks, DialogInterface dialogInterface, int i) {
        if (all) {
    ...
    public /* synthetic */ void m1493lambda$deleteAllMessages$6$orgtelegramuiCallLogActivity(boolean revoke, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    private void createActionMode() {
        if (!this.actionBar.actionModeIsExist((String) null)) {
            ...
            this.actionModeViews.add(actionMode.addItemWithWidth(2, NUM, AndroidUtilities.dp(54.0f), LocaleController.getString("Delete", NUM)));
        }
    }
    ...
    public /* synthetic */ void m1495lambda$getCalls$9$orgtelegramuiCallLogActivity(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1494lambda$getCalls$8$orgtelegramuiCallLogActivity(TLRPC.TL_error error, TLObject response) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onViewAttachedToWindow(RecyclerView.ViewHolder holder) {
            if (holder.itemView instanceof CallCell) {
                ...
                ProgressButton unused = CallLogActivity.this.waitingForLoadButton = cell.button;
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    ProfileSearchCell access$2700 = cell.profileSearchCell;
                ...
                case 4:
                    ...
                    ProfileSearchCell access$2100 = cell3.profileSearchCell;
    ...
    public /* synthetic */ void m1496lambda$getThemeDescriptions$10$orgtelegramuiCallLogActivity() {
