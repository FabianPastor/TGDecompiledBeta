...
public class CallLogActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    private OnClickListener callBtnClickListener = new C06991();
    ...
    class C07002 extends ActionBarMenuOnItemClick {
        C07002() {
        }
    ...
    class C07013 implements OnItemClickListener {
        C07013() {
        }
    ...
    class C07034 implements OnItemLongClickListener {
        C07034() {
        }
        ...
        public boolean onItemClick(View view, int position) {
            ...
            new Builder(CallLogActivity.this.getParentActivity()).setTitle(LocaleController.getString("Calls", C0431R.string.Calls)).setItems((CharSequence[]) items.toArray(new String[items.size()]), new DialogInterface.OnClickListener() {
    ...
    class C07055 extends OnScrollListener {
        C07055() {
        }
    ...
    class C07066 extends ViewOutlineProvider {
        C07066() {
        }
    ...
    class C07087 implements OnClickListener {
        ...
        class C07071 implements ContactsActivityDelegate {
            C07071() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    imageView.setImageResource(C0431R.drawable.profile_phone);
    ...
    public View createView(Context context) {
        this.greenDrawable = getParentActivity().getResources().getDrawable(C0431R.drawable.ic_call_made_green_18dp).mutate();
        ...
        this.greenDrawable2 = getParentActivity().getResources().getDrawable(C0431R.drawable.ic_call_received_green_18dp).mutate();
        ...
        this.redDrawable = getParentActivity().getResources().getDrawable(C0431R.drawable.ic_call_received_green_18dp).mutate();
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C07002());
        this.fragmentView = new FrameLayout(context);
        this.fragmentView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        FrameLayout frameLayout = this.fragmentView;
        this.emptyView = new EmptyTextProgressView(context);
        this.emptyView.setText(LocaleController.getString("NoCallLog", C0431R.string.NoCallLog));
        ...
        this.listView.setOnItemClickListener(new C07013());
        this.listView.setOnItemLongClickListener(new C07034());
        this.listView.setOnScrollListener(new C07055());
        if (this.loading) {
        ...
        this.floatingButton.setImageResource(C0431R.drawable.ic_call_white_24dp);
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C07066());
        }
        ...
        this.floatingButton.setOnClickListener(new C07087());
    ...
    private void getCalls(int max_id, int count) {
        if (!this.loading) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C07108(), 2), this.classGuid);
        }
    }

    private void confirmAndDelete(final CallLogRow row) {
        if (getParentActivity() != null) {
            new Builder(getParentActivity()).setTitle(LocaleController.getString("AppName", C0431R.string.AppName)).setMessage(LocaleController.getString("ConfirmDeleteCallLog", C0431R.string.ConfirmDeleteCallLog)).setPositiveButton(LocaleController.getString("Delete", C0431R.string.Delete), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
            ...
            }).setNegativeButton(LocaleController.getString("Cancel", C0431R.string.Cancel), null).show().setCanceledOnTouchOutside(true);
        }
    }
