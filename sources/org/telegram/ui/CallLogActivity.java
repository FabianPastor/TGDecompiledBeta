...
public class CallLogActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    private OnClickListener callBtnClickListener = new C05531();
    ...
    class C05566 extends ViewOutlineProvider {
        C05566() {
        }
    ...
    class C05577 implements OnClickListener {

        /* renamed from: org.telegram.ui.CallLogActivity$7$1 */
        class C14231 implements ContactsActivityDelegate {
            C14231() {
            }
        ...
        public void onClick(View v) {
            ...
            contactsFragment.setDelegate(new C14231());
    ...
    class C14192 extends ActionBarMenuOnItemClick {
        C14192() {
        }
    ...
    class C14203 implements OnItemClickListener {
        C14203() {
        }
    ...
    class C14214 implements OnItemLongClickListener {
        C14214() {
        }
    ...
    class C14225 extends OnScrollListener {
        C14225() {
        }
    ...
    class C14248 implements RequestDelegate {
        C14248() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C14192());
        ...
        this.listView.setOnItemClickListener(new C14203());
        this.listView.setOnItemLongClickListener(new C14214());
        this.listView.setOnScrollListener(new C14225());
        if (this.loading) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C05566());
        }
        ...
        this.floatingButton.setOnClickListener(new C05577());
    ...
    private void getCalls(int max_id, int count) {
        if (!this.loading) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C14248(), 2), this.classGuid);
        }
    }
