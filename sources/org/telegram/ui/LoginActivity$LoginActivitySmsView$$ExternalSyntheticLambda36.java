...
public final /* synthetic */ class LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda36 implements RequestDelegate {
    ...
    public /* synthetic */ LoginActivity$LoginActivitySmsView$$ExternalSyntheticLambda36(LoginActivity.LoginActivitySmsView loginActivitySmsView, TLRPC$TL_auth_signIn tLRPC$TL_auth_signIn) {
        this.f$0 = loginActivitySmsView;
        this.f$1 = tLRPC$TL_auth_signIn;
    }

    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$onNextPressed$29(this.f$1, tLObject, tLRPC$TL_error);
    }
}
