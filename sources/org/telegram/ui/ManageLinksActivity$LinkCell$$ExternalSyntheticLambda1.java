...
public final /* synthetic */ class ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1 implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ ManageLinksActivity$LinkCell$$ExternalSyntheticLambda1(ManageLinksActivity.LinkCell linkCell, TLRPC.TL_chatInviteExported tL_chatInviteExported) {
        this.f$0 = linkCell;
        this.f$1 = tL_chatInviteExported;
    }

    public final void onClick(DialogInterface dialogInterface, int i) {
        this.f$0.m3938lambda$new$0$orgtelegramuiManageLinksActivity$LinkCell(this.f$1, dialogInterface, i);
    }
}
