...
public final /* synthetic */ class ChannelCreateActivity$$ExternalSyntheticLambda14 implements Runnable {
    ...
    public /* synthetic */ ChannelCreateActivity$$ExternalSyntheticLambda14(ChannelCreateActivity channelCreateActivity, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputFile tLRPC$InputFile2, String str, double d, TLRPC$PhotoSize tLRPC$PhotoSize, TLRPC$PhotoSize tLRPC$PhotoSize2) {
    ...
    public final void run() {
        this.f$0.lambda$didUploadPhoto$12(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
