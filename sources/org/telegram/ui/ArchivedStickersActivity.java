...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m1406lambda$createView$0$orgtelegramuiArchivedStickersActivity(final View view, int position) {
    ...
    public /* synthetic */ void m1408lambda$getStickers$2$orgtelegramuiArchivedStickersActivity(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1407lambda$getStickers$1$orgtelegramuiArchivedStickersActivity(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
            m1409x2ad8e55f((TLRPC.TL_messages_archivedStickers) response);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: processResponse */
    public void m1409x2ad8e55f(TLRPC.TL_messages_archivedStickers res) {
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public /* synthetic */ void m1410x7ffa3458(TLRPC.StickerSetCovered stickerSet, ArchivedStickerSetCell c, boolean isChecked) {
            if (isChecked) {
