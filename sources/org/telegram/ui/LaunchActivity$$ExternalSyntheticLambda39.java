...
public final /* synthetic */ class LaunchActivity$$ExternalSyntheticLambda39 implements Runnable {
    ...
    public /* synthetic */ LaunchActivity$$ExternalSyntheticLambda39(LaunchActivity launchActivity, TLObject tLObject, int i, Integer num, TLRPC$Chat tLRPC$Chat, TLRPC$TL_messages_getDiscussionMessage tLRPC$TL_messages_getDiscussionMessage, Integer num2, Integer num3, AlertDialog alertDialog) {
    ...
    public final void run() {
        this.f$0.lambda$runCommentRequest$22(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
