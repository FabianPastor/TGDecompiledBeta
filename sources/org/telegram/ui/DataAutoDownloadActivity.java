...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    class C15721 extends ActionBarMenuOnItemClick {
        C15721() {
        }
    ...
    class C15732 implements OnItemClickListener {
        C15732() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C15721());
        ...
        this.listView.setOnItemClickListener(new C15732());
