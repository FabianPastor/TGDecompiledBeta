...
public class VoIPActivity extends Activity implements NotificationCenterDelegate, StateListener {
    ...
    class C25331 implements ImageReceiverDelegate {
        C25331() {
        }
    ...
    class C25372 implements OnClickListener {
    ...
    class C25443 implements OnClickListener {
        ...
        class C25381 implements Runnable {
            C25381() {
            }
        ...
        public void onClick(View v) {
            ...
            if (VoIPActivity.this.retrying) {
                ...
                VoIPActivity.this.endBtn.postDelayed(new C25381(), 100);
            } else if (VoIPService.getSharedInstance() != null) {
    ...
    class C25454 implements OnClickListener {
        C25454() {
        }
    ...
    class C25465 implements OnClickListener {
        C25465() {
        }
    ...
    class C25476 implements OnClickListener {
        C25476() {
        }
    ...
    class C25507 implements Listener {

        /* renamed from: org.telegram.ui.VoIPActivity$7$1 */
        class C25481 extends AnimatorListenerAdapter {
            C25481() {
            }
        ...
        class C25492 extends AnimatorListenerAdapter {
            C25492() {
            }
    ...
    class C25538 implements Listener {

        /* renamed from: org.telegram.ui.VoIPActivity$8$1 */
        class C25511 extends AnimatorListenerAdapter {
            C25511() {
            }
        ...
        class C25522 extends AnimatorListenerAdapter {
            C25522() {
            }
    ...
    class C25549 implements OnClickListener {
        C25549() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.user.photo != null) {
            this.photoView.getImageReceiver().setDelegate(new C25331());
        ...
        this.nameText.setOnClickListener(new C25372());
        this.endBtn.setOnClickListener(new C25443());
        this.spkToggle.setOnClickListener(new C25454());
        this.micToggle.setOnClickListener(new C25465());
        this.chatBtn.setOnClickListener(new C25476());
        ...
        this.acceptSwipe.setListener(new C25507());
        this.declineSwipe.setListener(new C25538());
        this.cancelBtn.setOnClickListener(new C25549());
        getWindow().getDecorView().setKeepScreenOn(true);
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.emojiDidLoaded);
        NotificationCenter.getGlobalInstance().addObserver(this, NotificationCenter.closeInCallActivity);
        this.hintTextView.setText(LocaleController.formatString("CallEmojiKeyTooltip", C0500R.string.CallEmojiKeyTooltip, this.user.first_name));
        this.emojiExpandedText.setText(LocaleController.formatString("CallEmojiKeyTooltip", C0500R.string.CallEmojiKeyTooltip, this.user.first_name));
    }
    ...
    private View createContentView() {
        ...
        View anonymousClass11 = new BackupImageView(this) {
            private Drawable bottomGradient = getResources().getDrawable(C0500R.drawable.gradient_bottom);
            private Paint paint = new Paint();
            private Drawable topGradient = getResources().getDrawable(C0500R.drawable.gradient_top);
        ...
        branding.setText(LocaleController.getString("VoipInCallBranding", C0500R.string.VoipInCallBranding));
        Drawable logo = getResources().getDrawable(C0500R.drawable.notification).mutate();
        logo.setAlpha(204);
        ...
        anonymousClass11.setBackgroundResource(C0500R.drawable.bg_voip_icon_btn);
        Drawable micIcon = getResources().getDrawable(C0500R.drawable.ic_mic_off_white_24dp).mutate();
        ...
        Drawable chatIcon = getResources().getDrawable(C0500R.drawable.ic_chat_bubble_white_24dp).mutate();
        ...
        anonymousClass11 = new CheckableImageView(this);
        anonymousClass11.setBackgroundResource(C0500R.drawable.bg_voip_icon_btn);
        Drawable speakerIcon = getResources().getDrawable(C0500R.drawable.ic_volume_up_white_24dp).mutate();
        anonymousClass11.setAlpha(204);
        ...
        acceptBtn.setImageResource(C0500R.drawable.ic_call_end_white_36dp);
        ...
        anonymousClass11.setImageResource(C0500R.drawable.ic_call_end_white_36dp);
        anonymousClass11.setScaleType(ScaleType.CENTER);
        ...
        anonymousClass11.setForeground(getResources().getDrawable(C0500R.drawable.fab_highlight_dark));
        ...
        anonymousClass11.setImageResource(C0500R.drawable.edit_cancel);
        ...
        this.emojiWrap.setOnLongClickListener(new OnLongClickListener() {
            ...
            class C25311 implements Runnable {
                C25311() {
                }
            ...
            public boolean onLongClick(View v) {
                ...
                if (VoIPActivity.this.emojiTooltipVisible) {
                    VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C25311(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                }
                return true;
            }
        });
        ...
        this.ellAnimator.addListener(new AnimatorListenerAdapter() {
            private Runnable restarter = new C25321();

            /* renamed from: org.telegram.ui.VoIPActivity$14$1 */
            class C25321 implements Runnable {
                C25321() {
                }
    ...
    private void showDebugAlert() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            closeBtn.setText(LocaleController.getString("Close", C0500R.string.Close));
    ...
    public void onStateChanged(final int state) {
        ...
        runOnUiThread(new Runnable() {
            ...
            class C25341 implements Runnable {
                C25341() {
                }
            ...
            class C25352 implements Runnable {
                C25352() {
                }
            ...
            class C25363 implements Runnable {
                C25363() {
                }
            ...
            public void run() {
                ...
                if (VoIPActivity.this.firstStateChange) {
                    ...
                    if (VoIPActivity.this.isIncomingWaiting = state == 15) {
                        ...
                        if (UserConfig.getActivatedAccountsCount() > 1) {
                            ...
                            VoIPActivity.this.accountNameText.setText(LocaleController.formatString("VoipAnsweringAsAccount", C0500R.string.VoipAnsweringAsAccount, ContactsController.formatName(self.first_name, self.last_name)));
                        } else {
                            VoIPActivity.this.accountNameText.setVisibility(8);
                        }
                ...
                if (state == 15) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipIncoming", C0500R.string.VoipIncoming), false);
                    VoIPActivity.this.getWindow().addFlags(2097152);
                } else if (state == 1 || state == 2) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipConnecting", C0500R.string.VoipConnecting), true);
                } else if (state == 12) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipExchangingKeys", C0500R.string.VoipExchangingKeys), true);
                } else if (state == 13) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipWaiting", C0500R.string.VoipWaiting), true);
                } else if (state == 16) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipRinging", C0500R.string.VoipRinging), true);
                } else if (state == 14) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipRequesting", C0500R.string.VoipRequesting), true);
                } else if (state == 10) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipHangingUp", C0500R.string.VoipHangingUp), true);
                    VoIPActivity.this.endBtnIcon.setAlpha(0.5f);
                    VoIPActivity.this.endBtn.setEnabled(false);
                } else if (state == 11) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipCallEnded", C0500R.string.VoipCallEnded), false);
                    VoIPActivity.this.stateText.postDelayed(new C25341(), 200);
                } else if (state == 17) {
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipBusy", C0500R.string.VoipBusy), false);
                    ...
                    if (!wasFirstStateChange && state == 3) {
                        ...
                        if (count < 3) {
                            ...
                            VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C25352(), DefaultRenderersFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
                    ...
                    int lastError;
                    VoIPActivity.this.setStateTextAnimated(LocaleController.getString("VoipFailed", C0500R.string.VoipFailed), false);
                    if (VoIPService.getSharedInstance() != null) {
                    ...
                    if (lastError == 1) {
                        VoIPActivity.this.showErrorDialog(AndroidUtilities.replaceTags(LocaleController.formatString("VoipPeerIncompatible", C0500R.string.VoipPeerIncompatible, ContactsController.formatName(VoIPActivity.this.user.first_name, VoIPActivity.this.user.last_name))));
                    } else if (lastError == -1) {
                        VoIPActivity.this.showErrorDialog(AndroidUtilities.replaceTags(LocaleController.formatString("VoipPeerOutdated", C0500R.string.VoipPeerOutdated, ContactsController.formatName(VoIPActivity.this.user.first_name, VoIPActivity.this.user.last_name))));
                    } else if (lastError == -2) {
                        VoIPActivity.this.showErrorDialog(AndroidUtilities.replaceTags(LocaleController.formatString("CallNotAvailable", C0500R.string.CallNotAvailable, ContactsController.formatName(VoIPActivity.this.user.first_name, VoIPActivity.this.user.last_name))));
                    } else if (lastError == 3) {
                        VoIPActivity.this.showErrorDialog("Error initializing audio hardware");
                    } else if (lastError == -3) {
                        VoIPActivity.this.finish();
                    } else if (lastError == -5) {
                        VoIPActivity.this.showErrorDialog(LocaleController.getString("VoipErrorUnknown", C0500R.string.VoipErrorUnknown));
                    } else {
                        VoIPActivity.this.stateText.postDelayed(new C25363(), 1000);
                    }
                }
    ...
    private void showErrorDialog(CharSequence message) {
        AlertDialog dlg = new Builder(this).setTitle(LocaleController.getString("VoipFailed", C0500R.string.VoipFailed)).setMessage(message).setPositiveButton(LocaleController.getString("OK", C0500R.string.OK), null).show();
    ...
    public void onAudioSettingsChanged() {
        ...
        if (svc != null) {
            ...
            if (svc.hasEarpiece() || svc.isBluetoothHeadsetConnected()) {
                this.spkToggle.setVisibility(0);
                if (!svc.hasEarpiece()) {
                    this.spkToggle.setImageResource(C0500R.drawable.ic_bluetooth_white_24dp);
                    this.spkToggle.setChecked(svc.isSpeakerphoneOn());
                    return;
                } else if (svc.isBluetoothHeadsetConnected()) {
                    switch (svc.getCurrentAudioRoute()) {
                        case 0:
                            this.spkToggle.setImageResource(C0500R.drawable.ic_phone_in_talk_white_24dp);
                            break;
                        case 1:
                            this.spkToggle.setImageResource(C0500R.drawable.ic_volume_up_white_24dp);
                            break;
                        case 2:
                            this.spkToggle.setImageResource(C0500R.drawable.ic_bluetooth_white_24dp);
                            break;
    ...
    private void updateBlurredPhotos(final BitmapHolder src) {
        new Thread(new Runnable() {
            ...
            class C25391 implements Runnable {
                C25391() {
                }
            ...
            public void run() {
                ...
                VoIPActivity.this.runOnUiThread(new C25391());
            }
        }).start();
    }
    ...
    private void showMessagesSheet() {
        ...
        msgs = new String[4];
        msgs[0] = prefs.getString("quick_reply_msg1", LocaleController.getString("QuickReplyDefault1", C0500R.string.QuickReplyDefault1));
        msgs[1] = prefs.getString("quick_reply_msg2", LocaleController.getString("QuickReplyDefault2", C0500R.string.QuickReplyDefault2));
        msgs[2] = prefs.getString("quick_reply_msg3", LocaleController.getString("QuickReplyDefault3", C0500R.string.QuickReplyDefault3));
        msgs[3] = prefs.getString("quick_reply_msg4", LocaleController.getString("QuickReplyDefault4", C0500R.string.QuickReplyDefault4));
        ...
        cell = new BottomSheetCell(this, 0);
        cell.setTextAndIcon(LocaleController.getString("QuickReplyCustom", C0500R.string.QuickReplyCustom), 0);
        cell.setTextColor(-1);
        ...
        field.setHint(LocaleController.getString("QuickReplyCustom", C0500R.string.QuickReplyCustom));
        ...
        imageView.setImageDrawable(DarkTheme.getThemedDrawable(this, C0500R.drawable.ic_send, Theme.key_chat_messagePanelSend));
        if (LocaleController.isRTL) {
        ...
        imageView.setOnClickListener(new OnClickListener() {
            ...
            class C25411 implements Runnable {
                C25411() {
                }
            ...
            public void onClick(View v) {
                if (field.length() != 0) {
                    bottomSheet2.dismiss();
                    if (VoIPService.getSharedInstance() != null) {
                        VoIPService.getSharedInstance().declineIncomingCall(4, new C25411());
                    }
                }
            }
        });
        ...
        cancelBtn.setImageDrawable(DarkTheme.getThemedDrawable(this, C0500R.drawable.edit_cancel, Theme.key_chat_messagePanelIcons));
        ...
        field.addTextChangedListener(new TextWatcher() {
            ...
            class C25421 implements Runnable {
                C25421() {
                }
            ...
            class C25432 implements Runnable {
                C25432() {
                }
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (this.prevState != hasText) {
                    ...
                    if (hasText) {
                        ...
                        cancelBtn.animate().alpha(0.0f).scaleX(0.1f).scaleY(0.1f).setInterpolator(CubicBezierInterpolator.DEFAULT).setDuration(200).withEndAction(new C25421()).start();
                        return;
                    }
                    ...
                    view.animate().alpha(0.0f).scaleX(LocaleController.isRTL ? -0.1f : 0.1f).scaleY(0.1f).setInterpolator(CubicBezierInterpolator.DEFAULT).setDuration(200).withEndAction(new C25432()).start();
                }
            }
        });
        editor.setVisibility(8);
