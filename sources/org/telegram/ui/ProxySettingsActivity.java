            ...
            if (id == -1) {
                ...
                try {
                    ...
                    if (params.length() != 0) {
                        ...
                        Intent chooserIntent = Intent.createChooser(shareIntent, LocaleController.getString("ShareLink", C0446R.string.ShareLink));
    ...
    public View createView(Context context) {
        ...
        while (a < 4) {
            ...
            if (a == 0) {
                ...
                this.inputFields[a].addTextChangedListener(new C16583());
            } else if (a == 1) {
                this.inputFields[a].setInputType(2);
                this.inputFields[a].addTextChangedListener(new C16594());
            } else if (a == 3) {
            ...
            switch (a) {
                case 0:
                    this.inputFields[a].setHint(LocaleController.getString("UseProxyAddress", C0446R.string.UseProxyAddress));
                    this.inputFields[a].setText(preferences.getString("proxy_ip", TtmlNode.ANONYMOUS_REGION_ID));
                    break;
                case 1:
                    this.inputFields[a].setHint(LocaleController.getString("UseProxyPort", C0446R.string.UseProxyPort));
                    this.inputFields[a].setText(TtmlNode.ANONYMOUS_REGION_ID + preferences.getInt("proxy_port", 1080));
                    break;
                case 2:
                    this.inputFields[a].setHint(LocaleController.getString("UseProxyUsername", C0446R.string.UseProxyUsername));
                    this.inputFields[a].setText(preferences.getString("proxy_user", TtmlNode.ANONYMOUS_REGION_ID));
                    break;
                case 3:
                    this.inputFields[a].setHint(LocaleController.getString("UseProxyPassword", C0446R.string.UseProxyPassword));
            ...
            this.inputFields[a].setOnEditorActionListener(new C16605());
            a++;
        }
        this.bottomCell = new TextInfoPrivacyCell(context);
        this.bottomCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0446R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        this.bottomCell.setText(LocaleController.getString("UseProxyInfo", C0446R.string.UseProxyInfo));
        ...
        this.useForCallsCell.setTextAndCheck(LocaleController.getString("UseProxyForCalls", C0446R.string.UseProxyForCalls), this.useProxyForCalls, false);
        ...
        this.useForCallsCell.setOnClickListener(new C16616());
        TextInfoPrivacyCell useForCallsInfoCell = new TextInfoPrivacyCell(context);
        useForCallsInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0446R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        useForCallsInfoCell.setText(LocaleController.getString("UseProxyForCallsInfo", C0446R.string.UseProxyForCallsInfo));
