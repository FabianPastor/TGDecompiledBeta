...
public class ProxySettingsActivity extends BaseFragment {
    ...
    class C24231 extends ActionBarMenuOnItemClick {
        C24231() {
        }
    ...
    class C24253 implements TextWatcher {
        C24253() {
        }
    ...
    class C24264 implements TextWatcher {
        C24264() {
        }
    ...
    class C24275 implements OnEditorActionListener {
        C24275() {
        }
    ...
    class C24286 implements OnClickListener {
        C24286() {
        }
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(address)) {
                    params.append("server=").append(URLEncoder.encode(address, C0621C.UTF8_NAME));
                }
                if (!TextUtils.isEmpty(port)) {
                    if (params.length() != 0) {
                        params.append("&");
                    }
                    params.append("port=").append(URLEncoder.encode(port, C0621C.UTF8_NAME));
                }
                if (ProxySettingsActivity.this.currentType == 1) {
                    ...
                    params.append("secret=").append(URLEncoder.encode(secret, C0621C.UTF8_NAME));
                } else {
                    ...
                    if (!TextUtils.isEmpty(user)) {
                        ...
                        params.append("user=").append(URLEncoder.encode(user, C0621C.UTF8_NAME));
                    }
                    if (!TextUtils.isEmpty(password)) {
                        if (params.length() != 0) {
                            params.append("&");
                        }
                        params.append("pass=").append(URLEncoder.encode(password, C0621C.UTF8_NAME));
                    }
                }
                if (params.length() != 0) {
                    ...
                    Intent chooserIntent = Intent.createChooser(shareIntent, LocaleController.getString("ShareLink", C0505R.string.ShareLink));
    ...
    public View createView(Context context) {
        this.actionBar.setTitle(LocaleController.getString("ProxyDetails", C0505R.string.ProxyDetails));
        this.actionBar.setBackButtonImage(C0505R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(false);
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setActionBarMenuOnItemClick(new C24231());
        this.doneItem = this.actionBar.createMenu().addItemWithWidth(1, C0505R.drawable.ic_done, AndroidUtilities.dp(56.0f));
        ...
        while (a < 2) {
            ...
            if (a == 0) {
                this.typeCell[a].setValue(LocaleController.getString("UseProxySocks5", C0505R.string.UseProxySocks5), a == this.currentType, true);
            } else if (a == 1) {
                this.typeCell[a].setValue(LocaleController.getString("UseProxyTelegram", C0505R.string.UseProxyTelegram), a == this.currentType, false);
            }
            this.linearLayout2.addView(this.typeCell[a], LayoutHelper.createLinear(-1, 48));
            this.typeCell[a].setOnClickListener(new C24242());
            a++;
        }
        ...
        for (a = 0; a < 5; a++) {
            ...
            if (a == 0) {
                ...
                this.inputFields[a].addTextChangedListener(new C24253());
            } else if (a == 1) {
                this.inputFields[a].setInputType(2);
                this.inputFields[a].addTextChangedListener(new C24264());
            } else if (a == 3) {
            ...
            switch (a) {
                case 0:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyAddress", C0505R.string.UseProxyAddress));
                    this.inputFields[a].setText(this.currentProxyInfo.address);
                    break;
                case 1:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPort", C0505R.string.UseProxyPort));
                    this.inputFields[a].setText(TtmlNode.ANONYMOUS_REGION_ID + this.currentProxyInfo.port);
                    break;
                case 2:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyUsername", C0505R.string.UseProxyUsername));
                    this.inputFields[a].setText(this.currentProxyInfo.username);
                    break;
                case 3:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPassword", C0505R.string.UseProxyPassword));
                    this.inputFields[a].setText(this.currentProxyInfo.password);
                    break;
                case 4:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxySecret", C0505R.string.UseProxySecret));
            ...
            this.inputFields[a].setOnEditorActionListener(new C24275());
        }
        this.bottomCell = new TextInfoPrivacyCell(context);
        this.bottomCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0505R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        this.bottomCell.setText(LocaleController.getString("UseProxyInfo", C0505R.string.UseProxyInfo));
        ...
        this.shareCell.setText(LocaleController.getString("ShareFile", C0505R.string.ShareFile), false);
        ...
        this.shareCell.setOnClickListener(new C24286());
        this.sectionCell[1] = new ShadowSectionCell(context);
        this.sectionCell[1].setBackgroundDrawable(Theme.getThemedDrawable(context, C0505R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    private void updateUiForType() {
        ...
        if (this.currentType == 0) {
            ...
            this.bottomCell.setText(LocaleController.getString("UseProxyTelegramInfo", C0505R.string.UseProxyTelegramInfo) + "\n\n" + LocaleController.getString("UseProxyTelegramInfo2", C0505R.string.UseProxyTelegramInfo2));
