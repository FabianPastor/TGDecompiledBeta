...
public class ProxySettingsActivity extends BaseFragment {
    ...
    class C23971 extends ActionBarMenuOnItemClick {
        C23971() {
        }
    ...
    class C23982 implements OnClickListener {
        C23982() {
        }
    ...
    class C23993 implements TextWatcher {
        C23993() {
        }
    ...
    class C24004 implements TextWatcher {
        C24004() {
        }
    ...
    class C24015 implements OnEditorActionListener {
        C24015() {
        }
    ...
    class C24026 implements OnClickListener {
        C24026() {
        }
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(address)) {
                    params.append("server=").append(URLEncoder.encode(address, C0616C.UTF8_NAME));
                }
                if (!TextUtils.isEmpty(port)) {
                    if (params.length() != 0) {
                        params.append("&");
                    }
                    params.append("port=").append(URLEncoder.encode(port, C0616C.UTF8_NAME));
                }
                if (ProxySettingsActivity.this.currentType == 1) {
                    ...
                    params.append("secret=").append(URLEncoder.encode(secret, C0616C.UTF8_NAME));
                } else {
                    ...
                    if (!TextUtils.isEmpty(user)) {
                        ...
                        params.append("user=").append(URLEncoder.encode(user, C0616C.UTF8_NAME));
                    }
                    if (!TextUtils.isEmpty(password)) {
                        if (params.length() != 0) {
                            params.append("&");
                        }
                        params.append("pass=").append(URLEncoder.encode(password, C0616C.UTF8_NAME));
                    }
                }
                if (params.length() != 0) {
                    ...
                    Intent chooserIntent = Intent.createChooser(shareIntent, LocaleController.getString("ShareLink", C0501R.string.ShareLink));
    ...
    public class TypeCell extends FrameLayout {
        ...
        public TypeCell(ProxySettingsActivity this$0, Context context) {
            ...
            this.checkImage.setImageResource(C0501R.drawable.sticker_added);
    ...
    public View createView(Context context) {
        this.actionBar.setTitle(LocaleController.getString("ProxyDetails", C0501R.string.ProxyDetails));
        this.actionBar.setBackButtonImage(C0501R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(false);
        if (AndroidUtilities.isTablet()) {
            this.actionBar.setOccupyStatusBar(false);
        }
        this.actionBar.setActionBarMenuOnItemClick(new C23971());
        this.doneItem = this.actionBar.createMenu().addItemWithWidth(1, C0501R.drawable.ic_done, AndroidUtilities.dp(56.0f));
        ...
        while (a < 2) {
            ...
            if (a == 0) {
                this.typeCell[a].setValue(LocaleController.getString("UseProxySocks5", C0501R.string.UseProxySocks5), a == this.currentType, true);
            } else if (a == 1) {
                this.typeCell[a].setValue(LocaleController.getString("UseProxyTelegram", C0501R.string.UseProxyTelegram), a == this.currentType, false);
            }
            this.linearLayout2.addView(this.typeCell[a], LayoutHelper.createLinear(-1, 48));
            this.typeCell[a].setOnClickListener(new C23982());
            a++;
        }
        ...
        for (a = 0; a < 5; a++) {
            ...
            if (a == 0) {
                ...
                this.inputFields[a].addTextChangedListener(new C23993());
            } else if (a == 1) {
                this.inputFields[a].setInputType(2);
                this.inputFields[a].addTextChangedListener(new C24004());
            } else if (a == 3) {
            ...
            switch (a) {
                case 0:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyAddress", C0501R.string.UseProxyAddress));
                    this.inputFields[a].setText(this.currentProxyInfo.address);
                    break;
                case 1:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPort", C0501R.string.UseProxyPort));
                    this.inputFields[a].setText(TtmlNode.ANONYMOUS_REGION_ID + this.currentProxyInfo.port);
                    break;
                case 2:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyUsername", C0501R.string.UseProxyUsername));
                    this.inputFields[a].setText(this.currentProxyInfo.username);
                    break;
                case 3:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxyPassword", C0501R.string.UseProxyPassword));
                    this.inputFields[a].setText(this.currentProxyInfo.password);
                    break;
                case 4:
                    this.inputFields[a].setHintText(LocaleController.getString("UseProxySecret", C0501R.string.UseProxySecret));
            ...
            this.inputFields[a].setOnEditorActionListener(new C24015());
        }
        this.bottomCell = new TextInfoPrivacyCell(context);
        this.bottomCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0501R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        this.bottomCell.setText(LocaleController.getString("UseProxyInfo", C0501R.string.UseProxyInfo));
        ...
        this.shareCell.setText(LocaleController.getString("ShareFile", C0501R.string.ShareFile), false);
        ...
        this.shareCell.setOnClickListener(new C24026());
        this.sectionCell[1] = new ShadowSectionCell(context);
        this.sectionCell[1].setBackgroundDrawable(Theme.getThemedDrawable(context, C0501R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    private void updateUiForType() {
        ...
        if (this.currentType == 0) {
            ...
            this.bottomCell.setText(LocaleController.getString("UseProxyTelegramInfo", C0501R.string.UseProxyTelegramInfo) + "\n\n" + LocaleController.getString("UseProxyTelegramInfo2", C0501R.string.UseProxyTelegramInfo2));
