...
public final /* synthetic */ class PremiumPreviewFragment$$ExternalSyntheticLambda11 implements RequestDelegate {
    ...
    public /* synthetic */ PremiumPreviewFragment$$ExternalSyntheticLambda11(BaseFragment baseFragment, Runnable runnable, TLRPC$TL_payments_assignPlayMarketTransaction tLRPC$TL_payments_assignPlayMarketTransaction) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        PremiumPreviewFragment.lambda$buyPremium$5(this.f$0, this.f$1, this.f$2, tLObject, tLRPC$TL_error);
    }
}
