...
public class InviteContactsActivity extends BaseFragment implements OnClickListener, NotificationCenterDelegate {
    ...
    class C14305 implements Callback {
        C14305() {
        }
    ...
    class C14316 implements OnKeyListener {
    ...
    class C14327 implements TextWatcher {
        C14327() {
        }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        public void addSpan(GroupCreateSpan span) {
            ...
            this.currentAnimation.addListener(new C14371());
    ...
    class C21511 extends ActionBarMenuOnItemClick {
        C21511() {
        }
    ...
    class C21538 implements OnItemClickListener {
        C21538() {
        }
    ...
    class C21549 extends OnScrollListener {
        C21549() {
        }
        ...
        public void searchDialogs(final String query) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C14341 implements Runnable {
                    ...
                    public void run() {
                        Utilities.searchQueue.postRunnable(new C14331());
                    }
                }
                ...
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C14341());
                }
            }, 200, 300);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C21511());
        ...
        this.editText.setCustomSelectionActionModeCallback(new C14305());
        this.editText.setOnKeyListener(new C14316());
        this.editText.addTextChangedListener(new C14327());
        ...
        this.listView.setOnItemClickListener(new C21538());
        this.listView.setOnScrollListener(new C21549());
