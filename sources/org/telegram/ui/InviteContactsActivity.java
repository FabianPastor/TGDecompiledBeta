...
public class InviteContactsActivity extends BaseFragment implements OnClickListener, NotificationCenterDelegate {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 1:
                    ...
                    ((InviteTextCell) view).setTextAndIcon(LocaleController.getString("ShareTelegram", C0446R.string.ShareTelegram), C0446R.drawable.share);
                    break;
                default:
    ...
    public View createView(Context context) {
        ...
        this.editText.setHintText(LocaleController.getString("SearchFriends", C0446R.string.SearchFriends));
        this.editText.setCustomSelectionActionModeCallback(new C14365());
        this.editText.setOnKeyListener(new C14376());
        this.editText.addTextChangedListener(new C14387());
        ...
        this.listView.setOnItemClickListener(new C21598());
        this.listView.setOnScrollListener(new C21609());
        ...
        this.infoTextView.setText(LocaleController.getString("InviteFriendsHelp", C0446R.string.InviteFriendsHelp));
        ...
        this.textView.setText(LocaleController.getString("InviteToTelegram", C0446R.string.InviteToTelegram).toUpperCase());
