...
public abstract class BaseLocationAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public /* synthetic */ void m1348xdd58fbb0(String query, Location coordinate) {
    ...
    public /* synthetic */ void m1347x23e16e11(String query, Location coordinate) {
        this.searchRunnable = null;
    ...
    public /* synthetic */ void m1346x63b66c1e(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new BaseLocationAdapter$$ExternalSyntheticLambda3(this, response));
        }
    }

    /* renamed from: lambda$searchBotUser$2$org-telegram-ui-Adapters-BaseLocationAdapter  reason: not valid java name */
    public /* synthetic */ void m1345xaa3ede7f(TLObject response) {
            ...
            if (location == null || coordinate.distanceTo(location) >= 200.0f) {
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    if (!animated || Build.VERSION.SDK_INT < 19) {
                        ...
                        int placesCount = this.places.size() + 1;
    ...
    public /* synthetic */ void m1350xd7bd1b58(String query, TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new BaseLocationAdapter$$ExternalSyntheticLambda2(this, query, error, response));
    }

    /* renamed from: lambda$searchPlacesWithQuery$4$org-telegram-ui-Adapters-BaseLocationAdapter  reason: not valid java name */
    public /* synthetic */ void m1349x1e458db9(String query, TLRPC.TL_error error, TLObject response) {
        this.currentRequestNum = 0;
        this.searching = false;
        this.places.clear();
        this.iconUrls.clear();
