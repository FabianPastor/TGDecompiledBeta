...
public abstract class BaseLocationAdapter extends SelectionAdapter {
    ...
    class C09032 implements RequestDelegate {
        C09032() {
        }
    ...
    class C09053 implements RequestDelegate {
        C09053() {
        }
    ...
    private void searchBotUser() {
        if (!this.searchingUser) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C09032());
        }
    }
    ...
    public void searchPlacesWithQuery(String query, Location coordinate, boolean searchUser) {
        if (this.lastSearchLocation == null || coordinate.distanceTo(this.lastSearchLocation) >= 200.0f) {
            ...
            if (object instanceof User) {
                ...
                this.currentRequestNum = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C09053());
                notifyDataSetChanged();
            } else if (searchUser) {
                searchBotUser();
            }
