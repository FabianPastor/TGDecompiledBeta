...
public abstract class BaseLocationAdapter extends SelectionAdapter {
    ...
    class C09392 implements RequestDelegate {
        C09392() {
        }
    ...
    class C09413 implements RequestDelegate {
        C09413() {
        }
    ...
    public void searchDelayed(final String query, final Location coordinate) {
        ...
        this.searchTimer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C09361());
            }
        }, 200, 500);
    }
    ...
    private void searchBotUser() {
        if (!this.searchingUser) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C09392());
        }
    }
    ...
    public void searchPlacesWithQuery(String query, Location coordinate, boolean searchUser) {
        ...
        if (this.lastSearchLocation == null || coordinate.distanceTo(this.lastSearchLocation) >= 200.0f) {
            ...
            if (object instanceof User) {
                ...
                this.currentRequestNum = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C09413());
                notifyDataSetChanged();
            } else if (searchUser) {
                searchBotUser();
            }
