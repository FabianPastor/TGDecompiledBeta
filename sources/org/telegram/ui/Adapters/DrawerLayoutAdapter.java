...
public class DrawerLayoutAdapter extends SelectionAdapter {
    ...
    public final /* synthetic */ void lambda$onCreateViewHolder$0$DrawerLayoutAdapter(View v) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            case 0:
                ...
                holder.itemView.setBackgroundColor(Theme.getColor("avatar_backgroundActionBarBlue"));
                return;
            case 3:
                position -= 2;
                if (this.accountsShowed) {
