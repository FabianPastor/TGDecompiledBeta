...
public final /* synthetic */ class MentionsAdapter$7$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ MentionsAdapter$7$$ExternalSyntheticLambda0(MentionsAdapter.AnonymousClass7 r1, int i, ArrayList arrayList, LongSparseArray longSparseArray, TLRPC$TL_error tLRPC$TL_error, TLObject tLObject, MessagesController messagesController) {
        this.f$0 = r1;
        this.f$1 = i;
        this.f$2 = arrayList;
