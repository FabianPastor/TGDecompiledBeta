...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m1340x5b1741cc(String emoji, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1339x53b20cad(String emoji, TLObject response) {
        ArrayList<StickerResult> arrayList;
        int newCount = 0;
        this.lastReqId = 0;
    ...
    public /* synthetic */ void m1334xde31628e(boolean[] buttonClicked, TLRPC.User foundContextBotFinal, DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m1335xe59697ad(boolean[] buttonClicked, DialogInterface dialog, int which) {
        buttonClicked[0] = true;
        onLocationUnavailable();
    }

    /* renamed from: lambda$processFoundUser$4$org-telegram-ui-Adapters-MentionsAdapter  reason: not valid java name */
    public /* synthetic */ void m1336xecfbcccc(boolean[] buttonClicked, DialogInterface dialog) {
        if (!buttonClicked[0]) {
            onLocationUnavailable();
        }
    }
    ...
    private void searchForContextBot(String username, String query) {
        ...
        if (user == null || user.username == null || !this.foundContextBot.username.equals(username) || (str2 = this.searchingContextQuery) == null || !str2.equals(query)) {
            ...
            AnonymousClass4 r1 = new Runnable() {
                ...
                public /* synthetic */ void m1344lambda$run$1$orgtelegramuiAdaptersMentionsAdapter$4(String username, MessagesController messagesController, MessagesStorage messagesStorage, TLObject response, TLRPC.TL_error error) {
                ...
                public /* synthetic */ void m1343lambda$run$0$orgtelegramuiAdaptersMentionsAdapter$4(String username, TLRPC.TL_error error, TLObject response, MessagesController messagesController, MessagesStorage messagesStorage) {
    ...
    public /* synthetic */ void m1338xcd6fb36b(String query, boolean cache, TLRPC.User user, String offset, MessagesStorage messagesStorage, String key, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1337xCLASSNAMEa7e4c(String query, boolean cache, TLObject response, TLRPC.User user, String offset, MessagesStorage messagesStorage, String key) {
    ...
    public /* synthetic */ void m1341xea5050b6(ArrayList newResult, LongSparseArray newMap) {
        this.cancelDelayRunnable = null;
    ...
    public /* synthetic */ void m1342xf1b585d5(ArrayList param, String alias) {
    ...
    public /* synthetic */ void m1333xddefa6d9(ContextLinkCell cell) {
