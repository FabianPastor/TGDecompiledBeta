...
public class MentionsAdapter extends RecyclerListView.SelectionAdapter implements NotificationCenter.NotificationCenterDelegate {
    ...
    private boolean checkStickerFilesExistAndDownload() {
        ...
        for (int a = 0; a < size; a++) {
            ...
            if (((thumb instanceof TLRPC.TL_photoSize) || (thumb instanceof TLRPC.TL_photoSizeProgressive)) && !FileLoader.getPathToAttach(thumb, "webp", true).exists()) {
    ...
    public /* synthetic */ void m1380x5b1741cc(String emoji, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1379x53b20cad(String emoji, TLObject response) {
        ArrayList<StickerResult> arrayList;
        int newCount = 0;
        this.lastReqId = 0;
    ...
    public /* synthetic */ void m1374xde31628e(boolean[] buttonClicked, TLRPC.User foundContextBotFinal, DialogInterface dialogInterface, int i) {
    ...
    public /* synthetic */ void m1375xe59697ad(boolean[] buttonClicked, DialogInterface dialog, int which) {
        buttonClicked[0] = true;
        onLocationUnavailable();
    }

    /* renamed from: lambda$processFoundUser$4$org-telegram-ui-Adapters-MentionsAdapter  reason: not valid java name */
    public /* synthetic */ void m1376xecfbcccc(boolean[] buttonClicked, DialogInterface dialog) {
        if (!buttonClicked[0]) {
            onLocationUnavailable();
        }
    }
    ...
    private void searchForContextBot(String username, String query) {
        ...
        if (user == null || user.username == null || !this.foundContextBot.username.equals(username) || (str2 = this.searchingContextQuery) == null || !str2.equals(query)) {
            ...
            AnonymousClass4 r1 = new Runnable() {
                ...
                public /* synthetic */ void m1384lambda$run$1$orgtelegramuiAdaptersMentionsAdapter$4(String username, MessagesController messagesController, MessagesStorage messagesStorage, TLObject response, TLRPC.TL_error error) {
                ...
                public /* synthetic */ void m1383lambda$run$0$orgtelegramuiAdaptersMentionsAdapter$4(String username, TLRPC.TL_error error, TLObject response, MessagesController messagesController, MessagesStorage messagesStorage) {
    ...
    public /* synthetic */ void m1378xcd6fb36b(String query, boolean cache, TLRPC.User user, String offset, MessagesStorage messagesStorage, String key, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1377xCLASSNAMEa7e4c(String query, boolean cache, TLObject response, TLRPC.User user, String offset, MessagesStorage messagesStorage, String key) {
    ...
    public void searchUsernameOrHashtag(java.lang.String r34, int r35, java.util.ArrayList<org.telegram.messenger.MessageObject> r36, boolean r37, boolean r38) {
        ...
        L_0x03c5:
            ...
            r5.needChangePanelVisibility(r4)
            return
        L_0x03d2:
        ...
        L_0x057b:
            ...
            int r14 = r14.size()
            if (r7 >= r14) goto L_0x067f
            r14 = -1
            if (r7 != r14) goto L_0x05bb
            int r15 = r3.length()
    ...
    public /* synthetic */ void m1381xea5050b6(ArrayList newResult, LongSparseArray newMap) {
        this.cancelDelayRunnable = null;
    ...
    public /* synthetic */ void m1382xf1b585d5(ArrayList param, String alias) {
    ...
    public /* synthetic */ void m1373xddefa6d9(ContextLinkCell cell) {
