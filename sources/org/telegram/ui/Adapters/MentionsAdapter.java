...
public class MentionsAdapter extends SelectionAdapter {
    ...
    private LocationProvider locationProvider = new LocationProvider(new C13921()) {
        public void stop() {
            super.stop();
    ...
    class C13921 implements LocationProviderDelegate {
        C13921() {
        }
    ...
    class C13943 implements SearchAdapterHelperDelegate {
        C13943() {
        }
    ...
    public MentionsAdapter(Context context, boolean darkTheme, long did, MentionsAdapterDelegate mentionsAdapterDelegate) {
        ...
        this.searchAdapterHelper.setDelegate(new C13943());
    }
        ...
        if (this.foundContextBot == null) {
            ...
            if (foundType == -1) {
                ...
                if (chat != null && chat.megagroup && usernameString.length() > 0) {
                    ...
                    this.searchGlobalRunnable = c05105;
                    AndroidUtilities.runOnUIThread(c05105, 200);
                }
