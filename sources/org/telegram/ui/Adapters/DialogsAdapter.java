...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public /* synthetic */ void m2601x3c8bd2a9(View view1) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
        ...
        switch (holder.getItemViewType()) {
            ...
            case 14:
                ...
                switch (((DialogsActivity.DialogsHeader) getItem(i2)).headerType) {
                    case 0:
    ...
    public /* synthetic */ void m2599x3d1e216b() {
    ...
    public /* synthetic */ void m2600xc9be4c6c(Float progress) {
    ...
    public int getItemViewType(int i) {
        ...
        if (i == size) {
            ...
            if (this.dialogsType != 2 || !(getItem(i) instanceof DialogsActivity.DialogsHeader)) {
                return 0;
            }
            return 14;
        }
    ...
    public static class DialogsPreloader {
        ...
        public /* synthetic */ void m2602x8b23716d() {
        ...
        public void start() {
            if (preloadIsAvilable() && this.resumed && !this.preloadDialogsPool.isEmpty() && this.currentRequestCount < 4 && this.networkRequestCount <= 6) {
                ...
                MessagesController.getInstance(UserConfig.selectedAccount).ensureMessagesLoaded(dialog_id, 0, new MessagesController.MessagesLoadedCallback() {
                    ...
                    public /* synthetic */ void m2604xCLASSNAMEb96d0(boolean fromCache, long dialog_id) {
                        if (!fromCache) {
                    ...
                    public /* synthetic */ void m2603x11937a70(long dialog_id) {
                        if (DialogsPreloader.this.loadingDialogs.remove(Long.valueOf(dialog_id))) {
