    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2:
                ...
                headerCell.setText(LocaleController.getString("RecentlyViewed", C0500R.string.RecentlyViewed));
                TextView textView = new TextView(this.mContext);
                textView.setTextSize(1, 15.0f);
                textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
                textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader));
                textView.setText(LocaleController.getString("RecentlyViewedHide", C0500R.string.RecentlyViewedHide));
                ...
                textView.setOnClickListener(new C09411());
                view = headerCell;
                break;
            case 3:
                ...
                v.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, C0500R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            ...
            case 7:
                headerCell = new HeaderCell(this.mContext);
                headerCell.setText(LocaleController.getString("YourContacts", C0500R.string.YourContacts));
                view = headerCell;
                break;
            default:
                view = new ShadowSectionCell(this.mContext);
                CombinedDrawable combinedDrawable = new CombinedDrawable(new ColorDrawable(Theme.getColor(Theme.key_windowBackgroundGray)), Theme.getThemedDrawable(this.mContext, C0500R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
