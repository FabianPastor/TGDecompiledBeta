...
public class SearchAdapter extends SelectionAdapter {
    ...
    class C06321 implements SearchAdapterHelperDelegate {
        C06321() {
        }
    ...
    public SearchAdapter(Context context, SparseArray<User> arg1, boolean usernameSearch, boolean mutual, boolean chats, boolean bots, int searchChannelId) {
        ...
        this.searchAdapterHelper.setDelegate(new C06321());
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            default:
                ...
                ((GraySectionCell) view).setText(LocaleController.getString("GlobalSearch", C0431R.string.GlobalSearch));
                break;
        }
