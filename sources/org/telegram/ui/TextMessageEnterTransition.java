...
public class TextMessageEnterTransition implements MessageEnterTransitionContainer.Transition {
    ...
    public /* synthetic */ void m3907lambda$new$0$orgtelegramuiTextMessageEnterTransition(ChatActivityEnterView chatActivityEnterView, MessageEnterTransitionContainer container2, ValueAnimator valueAnimator) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.messageView.getMessageObject().stableId == this.messageId) {
            ...
            if (this.hasReply) {
                ...
                float replyMessageX = ((fromReplayX - f6) * (1.0f - progressX)) + ((toReplayX - f6) * progressX);
            ...
            float sendProgress = f7 > 0.4f ? 1.0f : f7 / 0.4f;
