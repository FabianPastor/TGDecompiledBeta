            ...
            switch (holder.getItemViewType()) {
                case 0:
                    ...
                    if (position == PrivacyControlActivity.this.alwaysShareRow) {
                        if (PrivacyControlActivity.this.currentPlus.size() != 0) {
                            ...
                            value = LocaleController.getString("EmpryUsersPlaceholder", C0446R.string.EmpryUsersPlaceholder);
                        }
                        String string;
                        if (PrivacyControlActivity.this.rulesType != 0) {
                        ...
                        if (PrivacyControlActivity.this.rulesType != 0) {
                            textCell.setTextAndValue(LocaleController.getString("NeverAllow", C0446R.string.NeverAllow), value, false);
                            return;
                        } else {
                            textCell.setTextAndValue(LocaleController.getString("NeverShareWith", C0446R.string.NeverShareWith), value, false);
                            return;
                        }
                    } else {
                        return;
                ...
                case 1:
                    ...
                    if (position == PrivacyControlActivity.this.detailRow) {
                        if (PrivacyControlActivity.this.rulesType == 2) {
                            privacyCell.setText(LocaleController.getString("WhoCanCallMeInfo", C0446R.string.WhoCanCallMeInfo));
                        } else if (PrivacyControlActivity.this.rulesType == 1) {
                            privacyCell.setText(LocaleController.getString("WhoCanAddMeInfo", C0446R.string.WhoCanAddMeInfo));
                        } else {
                            privacyCell.setText(LocaleController.getString("CustomHelp", C0446R.string.CustomHelp));
                        }
                        ...
                        if (PrivacyControlActivity.this.rulesType == 2) {
                            privacyCell.setText(LocaleController.getString("CustomCallInfo", C0446R.string.CustomCallInfo));
                        } else if (PrivacyControlActivity.this.rulesType == 1) {
                            privacyCell.setText(LocaleController.getString("CustomShareInfo", C0446R.string.CustomShareInfo));
                        } else {
                            privacyCell.setText(LocaleController.getString("CustomShareSettingsHelp", C0446R.string.CustomShareSettingsHelp));
                        }
                ...
                case 3:
                    ...
                    if (position == PrivacyControlActivity.this.everybodyRow) {
                        ...
                        String string2 = LocaleController.getString("LastSeenContacts", C0446R.string.LastSeenContacts);
                        ...
                        String string3 = LocaleController.getString("LastSeenNobody", C0446R.string.LastSeenNobody);
