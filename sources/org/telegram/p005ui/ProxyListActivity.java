...
public class ProxyListActivity extends BaseFragment implements NotificationCenterDelegate {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == ProxyListActivity.this.proxyAddRow) {
                        textCell.setText(LocaleController.getString("AddProxy", CLASSNAMER.string.AddProxy), false);
                        return;
                    }
                    return;
                case 2:
                    ...
                    if (position == ProxyListActivity.this.connectionsHeaderRow) {
                        headerCell.setText(LocaleController.getString("ProxyConnections", CLASSNAMER.string.ProxyConnections));
                        return;
                    }
                    return;
                case 3:
                    ...
                    if (position == ProxyListActivity.this.useProxyRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UseProxySettings", CLASSNAMER.string.UseProxySettings), ProxyListActivity.this.useProxySettings, false);
                        return;
                    } else if (position == ProxyListActivity.this.callsRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UseProxyForCalls", CLASSNAMER.string.UseProxyForCalls), ProxyListActivity.this.useProxyForCalls, false);
                        return;
                    } else {
                        return;
                    }
                case 4:
                    ...
                    if (position == ProxyListActivity.this.callsDetailRow) {
                        cell.setText(LocaleController.getString("UseProxyForCallsInfo", CLASSNAMER.string.UseProxyForCallsInfo));
    ...
    public class TextDetailProxyCell extends FrameLayout {
        ...
        public TextDetailProxyCell(ProxyListActivity this$0, Context context) {
            ...
            this.checkImageView.setImageResource(CLASSNAMER.drawable.profile_info);
            ...
            if (SharedConfig.currentProxy == this.currentInfo && this.this$0.useProxySettings) {
                if (this.this$0.currentConnectionState == 3 || this.this$0.currentConnectionState == 5) {
                    ...
                    if (this.currentInfo.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString("Connected", CLASSNAMER.string.Connected) + ", " + LocaleController.formatString("Ping", CLASSNAMER.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString("Connected", CLASSNAMER.string.Connected));
                    }
                    ...
                    this.valueTextView.setText(LocaleController.getString("Connecting", CLASSNAMER.string.Connecting));
                }
            } else if (this.currentInfo.checking) {
                this.valueTextView.setText(LocaleController.getString("Checking", CLASSNAMER.string.Checking));
                colorKey = Theme.key_windowBackgroundWhiteGrayText2;
            } else if (this.currentInfo.available) {
                if (this.currentInfo.ping != 0) {
                    this.valueTextView.setText(LocaleController.getString("Available", CLASSNAMER.string.Available) + ", " + LocaleController.formatString("Ping", CLASSNAMER.string.Ping, Long.valueOf(this.currentInfo.ping)));
                } else {
                    this.valueTextView.setText(LocaleController.getString("Available", CLASSNAMER.string.Available));
                }
                colorKey = Theme.key_windowBackgroundWhiteGreenText;
            } else {
                this.valueTextView.setText(LocaleController.getString("Unavailable", CLASSNAMER.string.Unavailable));
        ...
        public void setChecked(boolean checked) {
            if (checked) {
                if (this.checkDrawable == null) {
                    this.checkDrawable = getResources().getDrawable(CLASSNAMER.drawable.proxy_check).mutate();
                }
                if (this.checkDrawable != null) {
                    this.checkDrawable.setColorFilter(new PorterDuffColorFilter(this.color, Mode.MULTIPLY));
                }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("ProxySettings", CLASSNAMER.string.ProxySettings));
    ...
    final /* synthetic */ boolean lambda$createView$2$ProxyListActivity(View view, int position) {
        ...
        builder.setMessage(LocaleController.getString("DeleteProxy", CLASSNAMER.string.DeleteProxy));
        ...
        builder.setPositiveButton(LocaleController.getString("OK", CLASSNAMER.string.OK), new ProxyListActivity$$Lambda$4(this, info));
