...
public class ProxyListActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C21502 implements OnItemClickListener {
        C21502() {
        }
    ...
    class C21523 implements OnItemLongClickListener {
        C21523() {
        }
        ...
        public boolean onItemClick(View view, int position) {
            ...
            builder.setMessage(LocaleController.getString("DeleteProxy", C0541R.string.DeleteProxy));
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == ProxyListActivity.this.proxyAddRow) {
                        textCell.setText(LocaleController.getString("AddProxy", C0541R.string.AddProxy), false);
                        return;
                    }
                    return;
                case 2:
                    ...
                    if (position == ProxyListActivity.this.connectionsHeaderRow) {
                        headerCell.setText(LocaleController.getString("ProxyConnections", C0541R.string.ProxyConnections));
                        return;
                    }
                    return;
                case 3:
                    ...
                    if (position == ProxyListActivity.this.useProxyRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UseProxySettings", C0541R.string.UseProxySettings), ProxyListActivity.this.useProxySettings, false);
                        return;
                    } else if (position == ProxyListActivity.this.callsRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UseProxyForCalls", C0541R.string.UseProxyForCalls), ProxyListActivity.this.useProxyForCalls, false);
                        return;
                    } else {
                        return;
                    }
                case 4:
                    ...
                    if (position == ProxyListActivity.this.callsDetailRow) {
                        cell.setText(LocaleController.getString("UseProxyForCallsInfo", C0541R.string.UseProxyForCallsInfo));
    ...
    public class TextDetailProxyCell extends FrameLayout {
        ...
        public TextDetailProxyCell(final ProxyListActivity this$0, Context context) {
            ...
            this.checkImageView.setImageResource(C0541R.drawable.profile_info);
            ...
            if (SharedConfig.currentProxy == this.currentInfo && this.this$0.useProxySettings) {
                if (this.this$0.currentConnectionState == 3 || this.this$0.currentConnectionState == 5) {
                    ...
                    if (this.currentInfo.ping != 0) {
                        this.valueTextView.setText(LocaleController.getString("Connected", C0541R.string.Connected) + ", " + LocaleController.formatString("Ping", C0541R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                    } else {
                        this.valueTextView.setText(LocaleController.getString("Connected", C0541R.string.Connected));
                    }
                    ...
                    this.valueTextView.setText(LocaleController.getString("Connecting", C0541R.string.Connecting));
                }
            } else if (this.currentInfo.checking) {
                this.valueTextView.setText(LocaleController.getString("Checking", C0541R.string.Checking));
                colorKey = Theme.key_windowBackgroundWhiteGrayText2;
            } else if (this.currentInfo.available) {
                if (this.currentInfo.ping != 0) {
                    this.valueTextView.setText(LocaleController.getString("Available", C0541R.string.Available) + ", " + LocaleController.formatString("Ping", C0541R.string.Ping, Long.valueOf(this.currentInfo.ping)));
                } else {
                    this.valueTextView.setText(LocaleController.getString("Available", C0541R.string.Available));
                }
                colorKey = Theme.key_windowBackgroundWhiteGreenText;
            } else {
                this.valueTextView.setText(LocaleController.getString("Unavailable", C0541R.string.Unavailable));
        ...
        public void setChecked(boolean checked) {
            if (checked) {
                if (this.checkDrawable == null) {
                    this.checkDrawable = getResources().getDrawable(C0541R.drawable.proxy_check).mutate();
                }
                if (this.checkDrawable != null) {
                    this.checkDrawable.setColorFilter(new PorterDuffColorFilter(this.color, Mode.MULTIPLY));
                }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("ProxySettings", C0541R.string.ProxySettings));
        ...
        this.listView.setOnItemClickListener(new C21502());
        this.listView.setOnItemLongClickListener(new C21523());
