...
public class SecretMediaViewer implements OnDoubleTapListener, OnGestureListener, NotificationCenterDelegate {
    ...
    class C169713 extends AnimatorListenerAdapter {
        C169713() {
        }
    ...
    class C169814 implements Runnable {
        C169814() {
        }
    ...
    class C169915 extends AnimatorListenerAdapter {
        C169915() {
        }
    ...
    class C17014 implements OnApplyWindowInsetsListener {
        C17014() {
        }
    ...
    class C17026 implements Runnable {
        C17026() {
        }
    ...
    class C17037 extends AnimatorListenerAdapter {
        C17037() {
        }
    ...
    class C17059 extends AnimatorListenerAdapter {
        C17059() {
        }
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        private class Particle {
            ...
            /* synthetic */ Particle(SecretDeleteTimer x0, C22841 x1) {
                this();
            }
        }
        ...
        private void updateParticles(long dt) {
            ...
            while (a < count) {
                ...
                if (particle.currentTime >= particle.lifeTime) {
                    ...
                    particle.f239x += ((particle.f237vx * particle.velocity) * ((float) dt)) / 500.0f;
                    particle.f240y += ((particle.f238vy * particle.velocity) * ((float) dt)) / 500.0f;
        ...
        protected void onDraw(Canvas canvas) {
            if (SecretMediaViewer.this.currentMessageObject != null && SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0) {
                ...
                if (!this.useVideoProgress) {
                    ...
                    if (duration == C0016C.TIME_UNSET || position == C0016C.TIME_UNSET) {
                        progress = 1.0f;
                    } else {
                ...
                for (a = 0; a < count; a++) {
                    ...
                    canvas.drawPoint(particle.f239x, particle.f240y, this.particlePaint);
                }
                ...
                for (a = 0; a < 1; a++) {
                    ...
                    newParticle.f239x = cx;
                    newParticle.f240y = cy;
                    double angle = 0.017453292519943295d * ((double) (Utilities.random.nextInt(140) - 70));
                    if (angle < 0.0d) {
                        angle += 6.283185307179586d;
                    }
                    newParticle.f237vx = (float) ((Math.cos(angle) * vx) - (Math.sin(angle) * vy));
                    newParticle.f238vy = (float) ((Math.sin(angle) * vx) + (Math.cos(angle) * vy));
    ...
    class C22841 implements VideoPlayerDelegate {
        C22841() {
        }
    ...
    class C22865 extends ActionBarMenuOnItemClick {
        C22865() {
        }
    ...
    private void preparePlayer(File file) {
        if (this.parentActivity != null) {
            ...
            if (this.videoPlayer == null) {
                ...
                this.videoPlayer.setDelegate(new C22841());
            }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.containerView = new FrameLayoutDrawer(activity) {
                protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
                    ...
                    if (SecretMediaViewer.this.secretDeleteTimer != null) {
                        int y = ((C0646ActionBar.getCurrentActionBarHeight() - SecretMediaViewer.this.secretDeleteTimer.getMeasuredHeight()) / 2) + (VERSION.SDK_INT >= 21 ? AndroidUtilities.statusBarHeight : 0);
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.containerView.setOnApplyWindowInsetsListener(new C17014());
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C22865());
    ...
    public void openMedia(MessageObject messageObject, PhotoViewerProvider provider) {
        if (this.parentActivity != null && messageObject != null && messageObject.needDrawBluredPreview() && provider != null) {
            ...
            if (object != null) {
                ...
                this.photoAnimationEndRunnable = new C17026();
                this.imageMoveAnimation.setDuration(250);
                this.imageMoveAnimation.addListener(new C17037());
    ...
    private void toggleActionBar(boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            if (!show) {
                this.currentActionBarAnimation.addListener(new C17059());
            }
    ...
    public void closePhoto(boolean animated, boolean byDelete) {
        if (this.parentActivity != null && this.isPhotoVisible && !checkPhotoAnimation()) {
            ...
            if (animated) {
                ...
                this.imageMoveAnimation.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        AndroidUtilities.runOnUIThread(new C16941());
                    }
                });
                this.photoTransitionAnimationStartTime = System.currentTimeMillis();
                if (VERSION.SDK_INT >= 18) {
            ...
            animatorSet2.addListener(new C169713());
            this.photoTransitionAnimationStartTime = System.currentTimeMillis();
            if (VERSION.SDK_INT >= 18) {
                this.containerView.setLayerType(2, null);
            }
    ...
    private void onPhotoClosed(PlaceProviderObject object) {
        ...
        AndroidUtilities.runOnUIThread(new C169814(), 50);
    }
    ...
    private void animateTo(float newScale, float newTx, float newTy, boolean isZoom, int duration) {
        if (this.scale != newScale || this.translationX != newTx || this.translationY != newTy) {
            ...
            this.imageMoveAnimation.addListener(new C169915());
            this.imageMoveAnimation.start();
        }
    }
