        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (this.drawerLayout != child) {
                    ...
                    child.measure(DrawerLayoutContainer.getChildMeasureSpec(widthMeasureSpec, (this.minDrawerMargin + lp.leftMargin) + lp.rightMargin, lp.width), DrawerLayoutContainer.getChildMeasureSpec(heightMeasureSpec, lp.topMargin + lp.bottomMargin, lp.height));
                }
            }
        }
    }
