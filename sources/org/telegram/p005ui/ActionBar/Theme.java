...
public class Theme {
    ...
    public static void createChatResources(Context context, boolean fontsOnly) {
        ...
        if (!fontsOnly && chat_msgInDrawable == null) {
            ...
            chat_attachButtonDrawables[1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_gallery);
            chat_attachButtonDrawables[2] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_video);
            chat_attachButtonDrawables[3] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_audio);
            chat_attachButtonDrawables[4] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_file);
            chat_attachButtonDrawables[5] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_contact);
            chat_attachButtonDrawables[6] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_location);
            chat_attachButtonDrawables[7] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_close);
            chat_attachButtonDrawables[8] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_send);
            chat_attachButtonDrawables[9] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(54.0f), R.drawable.attach_polls);
            ...
            chat_ivStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_cancel_m, 2);
            chat_ivStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(40.0f), (int) R.drawable.msg_round_cancel_m, 2);
            chat_fileMiniStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[4][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[4][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[5][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.video_mini_cancel);
            chat_fileMiniStatesDrawable[5][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(22.0f), R.drawable.video_mini_cancel);
            chat_fileStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[4][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[4][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[5][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[5][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[6][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[6][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[7][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[7][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[8][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[8][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[9][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[9][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_play_m);
            chat_photoStatesDrawables[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_play_m);
            ...
            drawableArr2[1] = drawable;
            drawableArr[0] = drawable;
            chat_photoStatesDrawables[7][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[7][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[8][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[8][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            ...
            chat_photoStatesDrawables[10][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[10][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[11][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[11][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(48.0f), R.drawable.msg_round_cancel_m);
            ...
            chat_contactDrawable[0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_contact);
            chat_contactDrawable[1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m9dp(44.0f), R.drawable.msg_contact);
            chat_locationDrawable[0] = Theme.createRoundRectDrawableWithIcon(AndroidUtilities.m9dp(2.0f), R.drawable.msg_location);
            chat_locationDrawable[1] = Theme.createRoundRectDrawableWithIcon(AndroidUtilities.m9dp(2.0f), R.drawable.msg_location);
