...
public class Theme {
    ...
    private static SensorEventListener ambientSensorListener = new C06847();
    ...
    private static Runnable switchDayBrightnessRunnable = new C06781();
    private static boolean switchDayRunnableScheduled;
    private static Runnable switchNightBrightnessRunnable = new C06792();
    ...
    static class C06781 implements Runnable {
        C06781() {
        }
    ...
    static class C06792 implements Runnable {
        C06792() {
        }
    ...
    static class C06803 extends StateListDrawable {
        C06803() {
        }
    ...
    static class C06814 extends StateListDrawable {
        C06814() {
        }
    ...
    static class C06825 extends StateListDrawable {
        C06825() {
        }
    ...
    static class C06836 extends Drawable {
        C06836() {
        }

        public void draw(Canvas canvas) {
            Rect bounds = getBounds();
            canvas.drawCircle((float) bounds.centerX(), (float) bounds.centerY(), (float) AndroidUtilities.m10dp(18.0f), Theme.maskPaint);
        }
    ...
    static class C06847 implements SensorEventListener {
        C06847() {
        }
    ...
    private static class AttachCameraDrawable extends Drawable {
        ...
        public AttachCameraDrawable() {
            int size = AndroidUtilities.m10dp(54.0f);
            RectF rect = new RectF(0.0f, 0.0f, (float) size, (float) size);
            this.segment = new Path();
            this.segment.moveTo((float) AndroidUtilities.m10dp(23.0f), (float) AndroidUtilities.m10dp(20.0f));
            this.segment.lineTo((float) AndroidUtilities.m10dp(23.0f), 0.0f);
        ...
        public void draw(Canvas canvas) {
            canvas.save();
            int cx = AndroidUtilities.m10dp(27.0f);
        ...
        public int getIntrinsicWidth() {
            return AndroidUtilities.m10dp(54.0f);
        }
    ...
    public static Drawable createEmojiIconSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C06803();
    ...
    public static Drawable createEditTextDrawable(Context context, boolean alert) {
        ...
        StateListDrawable stateListDrawable = new C06814();
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C06825();
    ...
    public static Drawable getRoundRectSelectorDrawable() {
        if (VERSION.SDK_INT >= 21) {
            return new RippleDrawable(new ColorStateList(new int[][]{StateSet.WILD_CARD}, new int[]{Theme.getColor(key_dialogButtonSelector)}), null, Theme.createRoundRectDrawable(AndroidUtilities.m10dp(3.0f), -1));
        }
        Drawable stateListDrawable = new StateListDrawable();
        stateListDrawable.addState(new int[]{16842919}, Theme.createRoundRectDrawable(AndroidUtilities.m10dp(3.0f), Theme.getColor(key_dialogButtonSelector)));
        stateListDrawable.addState(new int[]{16842913}, Theme.createRoundRectDrawable(AndroidUtilities.m10dp(3.0f), Theme.getColor(key_dialogButtonSelector)));
        ...
        if (previousTheme == null) {
            ...
            if (selectedAutoNightType != 2) {
                ...
                if (lightSensorRegistered) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m11d("light sensor unregistered");
                    }
                }
            }
            int switchToTheme = 0;
            if (selectedAutoNightType == 1) {
                ...
                if (!(lightSensorRegistered || lightSensor == null)) {
                    ...
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m11d("light sensor registered");
                    }
                }
    ...
    public static void createCommonResources(Context context) {
        if (dividerPaint == null) {
            ...
            checkboxSquare_checkPaint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
    ...
    public static void applyCommonTheme() {
        if (dividerPaint != null) {
            ...
            Theme.setDrawableColorByKey(avatar_photoDrawable, key_avatar_text);
        }
    }
    ...
    public static void createDialogsResources(Context context) {
        ...
        dialogs_nameEncryptedPaint.setTextSize((float) AndroidUtilities.m10dp(17.0f));
        dialogs_messagePaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
        dialogs_messagePrintingPaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
        dialogs_timePaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
        dialogs_countTextPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
        dialogs_onlinePaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
        dialogs_offlinePaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
    }
    ...
    public static void createChatResources(Context context, boolean fontsOnly) {
        ...
        if (!fontsOnly && chat_msgInDrawable == null) {
            ...
            chat_attachButtonDrawables[1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_gallery);
            chat_attachButtonDrawables[2] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_video);
            chat_attachButtonDrawables[3] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_audio);
            chat_attachButtonDrawables[4] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_file);
            chat_attachButtonDrawables[5] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_contact);
            chat_attachButtonDrawables[6] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_location);
            chat_attachButtonDrawables[7] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_close);
            chat_attachButtonDrawables[8] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(54.0f), R.drawable.attach_send);
            ...
            chat_ivStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_cancel_m, 2);
            chat_ivStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(40.0f), (int) R.drawable.msg_round_cancel_m, 2);
            chat_fileMiniStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[4][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[4][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[5][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.video_mini_cancel);
            chat_fileMiniStatesDrawable[5][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(22.0f), R.drawable.video_mini_cancel);
            chat_fileStatesDrawable[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[4][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[4][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[5][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[5][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[6][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[6][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[7][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[7][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[8][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[8][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[9][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[9][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[0][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[0][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[1][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[1][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[2][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[2][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[3][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_play_m);
            chat_photoStatesDrawables[3][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_play_m);
            ...
            drawableArr2[1] = drawable;
            drawableArr[0] = drawable;
            chat_photoStatesDrawables[7][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[7][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[8][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[8][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            ...
            chat_photoStatesDrawables[10][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[10][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[11][0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[11][1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(48.0f), R.drawable.msg_round_cancel_m);
            ...
            chat_contactDrawable[0] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_contact);
            chat_contactDrawable[1] = Theme.createCircleDrawableWithIcon(AndroidUtilities.m10dp(44.0f), R.drawable.msg_contact);
            chat_locationDrawable[0] = Theme.createRoundRectDrawableWithIcon(AndroidUtilities.m10dp(2.0f), R.drawable.msg_location);
            chat_locationDrawable[1] = Theme.createRoundRectDrawableWithIcon(AndroidUtilities.m10dp(2.0f), R.drawable.msg_location);
            ...
            try {
                ...
                paint.setShadowLayer((float) AndroidUtilities.m10dp(4.0f), 0.0f, 0.0f, NUM);
                canvas.drawCircle((float) (bitmapSize / 2), (float) (bitmapSize / 2), (float) ((AndroidUtilities.roundMessageSize / 2) - AndroidUtilities.m10dp(1.0f)), paint);
                try {
        ...
        chat_msgTextPaintOneEmoji.setTextSize((float) AndroidUtilities.m10dp(28.0f));
        chat_msgTextPaintTwoEmoji.setTextSize((float) AndroidUtilities.m10dp(24.0f));
        chat_msgTextPaintThreeEmoji.setTextSize((float) AndroidUtilities.m10dp(20.0f));
        chat_msgTextPaint.setTextSize((float) AndroidUtilities.m10dp((float) SharedConfig.fontSize));
        chat_msgGameTextPaint.setTextSize((float) AndroidUtilities.m10dp(14.0f));
        chat_msgBotButtonPaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
        if (!fontsOnly && chat_botProgressPaint != null) {
            chat_botProgressPaint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
            chat_infoPaint.setTextSize((float) AndroidUtilities.m10dp(12.0f));
            chat_docNamePaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_locationTitlePaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_locationAddressPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_audioTimePaint.setTextSize((float) AndroidUtilities.m10dp(12.0f));
            chat_livePaint.setTextSize((float) AndroidUtilities.m10dp(12.0f));
            chat_audioTitlePaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
            chat_audioPerformerPaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_botButtonPaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_contactNamePaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_contactPhonePaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_durationPaint.setTextSize((float) AndroidUtilities.m10dp(12.0f));
            chat_timePaint.setTextSize((float) AndroidUtilities.m10dp(12.0f));
            chat_adminPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_namePaint.setTextSize((float) AndroidUtilities.m10dp(14.0f));
            chat_forwardNamePaint.setTextSize((float) AndroidUtilities.m10dp(14.0f));
            chat_replyNamePaint.setTextSize((float) AndroidUtilities.m10dp(14.0f));
            chat_replyTextPaint.setTextSize((float) AndroidUtilities.m10dp(14.0f));
            chat_gamePaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_shipmentPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_instantViewPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_instantViewRectPaint.setStrokeWidth((float) AndroidUtilities.m10dp(1.0f));
            chat_statusRecordPaint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
            chat_actionTextPaint.setTextSize((float) AndroidUtilities.m10dp((float) (Math.max(16, SharedConfig.fontSize) - 2)));
            chat_contextResult_titleTextPaint.setTextSize((float) AndroidUtilities.m10dp(15.0f));
            chat_contextResult_descriptionTextPaint.setTextSize((float) AndroidUtilities.m10dp(13.0f));
            chat_radialProgressPaint.setStrokeWidth((float) AndroidUtilities.m10dp(3.0f));
            chat_radialProgress2Paint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
        }
    }
    ...
    public static Drawable getThemedDrawable(Context context, int resId, String key) {
        ...
        drawable.setColorFilter(new PorterDuffColorFilter(Theme.getColor(key), Mode.MULTIPLY));
        return drawable;
    }
            ...
            try {
                ...
                try {
                    ...
                    if (thumb) {
                        ...
                        int maxWidth = AndroidUtilities.m10dp(100.0f);
                        while (true) {
