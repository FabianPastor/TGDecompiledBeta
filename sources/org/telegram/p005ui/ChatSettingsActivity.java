...
public class ChatSettingsActivity extends BaseFragment {
            ...
            switch (holder.getItemViewType()) {
                case 2:
                    ...
                    if (position == ChatSettingsActivity.this.textSizeRow) {
                        ...
                        textCell.setTextAndValue(LocaleController.getString("TextSize", CLASSNAMER.string.TextSize), String.format("%d", new Object[]{Integer.valueOf(size)}), false);
                        return;
                        ...
                        textCell.setText(LocaleController.getString("StickersAndMasks", CLASSNAMER.string.StickersAndMasks), false);
                        return;
                ...
                case 3:
                    ...
                    if (position == ChatSettingsActivity.this.enableAnimationsRow) {
                        textCell2.setTextAndCheck(LocaleController.getString("EnableAnimations", CLASSNAMER.string.EnableAnimations), preferences.getBoolean("view_animations", true), true);
                        return;
                ...
                case 4:
                    ...
                    if (position == ChatSettingsActivity.this.settingsRow) {
                        ...
                        headerCell.setText(LocaleController.getString("Appearance", CLASSNAMER.string.Appearance));
                        return;
                    } else {
                        return;
                    }
                case 5:
                    ...
                    if (position == ChatSettingsActivity.this.nightModeRow) {
                        ...
                        checkCell.setTextAndValueAndCheck(LocaleController.getString("AutoNightTheme", CLASSNAMER.string.AutoNightTheme), enabled ? Theme.getCurrentNightThemeName() : LocaleController.getString("NotificationsOff", CLASSNAMER.string.NotificationsOff), enabled, true);
                        return;
                    }
                    return;
                case 6:
                    ...
                    if (position == ChatSettingsActivity.this.themeRow) {
                        textCell3.setTextAndValue(LocaleController.getString("Theme", CLASSNAMER.string.Theme), LocaleController.getString("ThemeInfo", CLASSNAMER.string.ThemeInfo), true);
                        return;
                    }
                    return;
                default:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("ChatSettings", CLASSNAMER.string.ChatSettings));
        ...
        if (position != this.textSizeRow) {
            ...
            if (position != this.contactsReimportRow) {
                if (position != this.contactsSortRow) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.getString("Default", CLASSNAMER.string.Default), LocaleController.getString("SortFirstName", CLASSNAMER.string.SortFirstName), LocaleController.getString("SortLastName", CLASSNAMER.string.SortLastName)}, new ChatSettingsActivity$$Lambda$2(this, position));
            ...
            builder.setNegativeButton(LocaleController.getString("Done", CLASSNAMER.string.Done), new ChatSettingsActivity$$Lambda$1(this, numberPicker, position));
            showDialog(builder.create());
        }
    }
