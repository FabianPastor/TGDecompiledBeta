...
/* renamed from: org.telegram.ui.ChannelPermissionsActivity */
public class ChannelPermissionsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C09334 implements OnClickListener {
        C09334() {
        }
    ...
    class C19471 extends ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ChannelPermissionsActivity.this.lambda$checkDiscard$69$PassportActivity();
            } else if (id == 1) {
    ...
    /* renamed from: org.telegram.ui.ChannelPermissionsActivity$ListAdapter */
    private class ListAdapter extends SelectionAdapter {
        ...
        public int getItemViewType(int position) {
            ...
            if (position == ChannelPermissionsActivity.this.permissionsHeaderRow) {
            }
            return 0;
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.radioButtonCell3.setOnClickListener(new C09334());
        ...
        this.radioButtonCell4.setOnClickListener(new C09345());
