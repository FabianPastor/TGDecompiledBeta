...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C18731 extends ActionBarMenuOnItemClick {
        C18731() {
        }

        public void onItemClick(int id) {
            if (id == -1) {
                ArchivedStickersActivity.this.lambda$checkDiscard$69$PassportActivity();
            }
        }
    }

    /* renamed from: org.telegram.ui.ArchivedStickersActivity$2 */
    class C18752 implements OnItemClickListener {
        C18752() {
        }
    ...
    class C18763 extends OnScrollListener {
        C18763() {
        }
    ...
    class C18774 implements RequestDelegate {
        C18774() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C06941 implements OnCheckedChangeListener {
            C06941() {
            }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (getItemViewType(position) == 0) {
                ...
                cell.setChecked(DataQuery.getInstance(ArchivedStickersActivity.this.currentAccount).isStickerPackInstalled(stickerSet.set.f111id));
            }
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((ArchivedStickerSetCell) view).setOnCheckClick(new C06941());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C18731());
        ...
        this.listView.setOnItemClickListener(new C18752());
        this.listView.setOnScrollListener(new C18763());
    ...
    private void getStickers() {
        if (!this.loadingStickers && !this.endReached) {
            ...
            req.offset_id = this.sets.isEmpty() ? 0 : ((StickerSetCovered) this.sets.get(this.sets.size() - 1)).set.f111id;
            req.limit = 15;
            req.masks = this.currentType == 1;
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C18774()), this.classGuid);
        }
    }
