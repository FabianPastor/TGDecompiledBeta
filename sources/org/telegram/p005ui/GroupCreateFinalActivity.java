...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C14074 implements OnClickListener {
        ...
        class C14061 implements DialogInterface.OnClickListener {
            C14061() {
            }
    ...
    class C14085 implements TextWatcher {
        C14085() {
        }
    ...
    class C21242 extends ActionBarMenuOnItemClick {
        C21242() {
        }

        public void onItemClick(int id) {
            if (id == -1) {
                GroupCreateFinalActivity.this.lambda$checkDiscard$69$PassportActivity();
    ...
    class C21256 extends OnScrollListener {
        C21256() {
        }
    ...
    class C21269 implements ThemeDescriptionDelegate {
        C21269() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C21242());
        ...
        this.avatarImage.setOnClickListener(new C14074());
        ...
        this.editText.addTextChangedListener(new C14085());
        ...
        this.listView.setOnScrollListener(new C21256());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C21269();
