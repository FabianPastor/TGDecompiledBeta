...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C17212 extends ActionBarMenuOnItemClick {
        C17212() {
        }
    ...
    class C17244 implements OnClickListener {

        /* renamed from: org.telegram.ui.GroupCreateFinalActivity$4$1 */
        class C17231 implements DialogInterface.OnClickListener {
            C17231() {
            }
    ...
    class C17255 implements TextWatcher {
        C17255() {
        }
    ...
    class C17266 extends OnScrollListener {
        C17266() {
        }
    ...
    class C17299 implements ThemeDescriptionDelegate {
        C17299() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString("NewGroup", C0541R.string.NewGroup));
        this.actionBar.setActionBarMenuOnItemClick(new C17212());
        ...
        this.avatarImage.setOnClickListener(new C17244());
        this.editText = new EditTextBoldCursor(context);
        this.editText.setHint(this.chatType == 0 ? LocaleController.getString("EnterGroupNamePlaceholder", C0541R.string.EnterGroupNamePlaceholder) : LocaleController.getString("EnterListName", C0541R.string.EnterListName));
        ...
        this.editText.setPadding(0, 0, 0, AndroidUtilities.m10dp(8.0f));
        ...
        this.editText.setCursorSize(AndroidUtilities.m10dp(20.0f));
        ...
        this.editText.addTextChangedListener(new C17255());
        ...
        this.listView.setOnScrollListener(new C17266());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new C17299();
