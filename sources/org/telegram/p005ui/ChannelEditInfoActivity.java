...
public class ChannelEditInfoActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    class C10701 extends ActionBarMenuOnItemClick {
        C10701() {
        }
            ...
            if (id == -1) {
                ...
                if (ChannelEditInfoActivity.this.nameTextView.length() == 0) {
                    ...
                    if (ChannelEditInfoActivity.this.imageUpdater.uploadingImage != null) {
                        ...
                        ChannelEditInfoActivity.this.progressDialog.setMessage(LocaleController.getString("Loading", C0541R.string.Loading));
                        ...
                        ChannelEditInfoActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", C0541R.string.Cancel), new ChannelEditInfoActivity$1$$Lambda$0(this));
    ...
    class C10712 implements TextWatcher {
        C10712() {
        }
    ...
    class C10723 implements TextWatcher {
        C10723() {
        }
    ...
    class C10734 implements TextWatcher {
        C10734() {
        }
    ...
    public void onResume() {
        ...
        if (this.textCell2 != null && this.info != null) {
            if (this.info.stickerset != null) {
                this.textCell2.setTextAndValue(LocaleController.getString("GroupStickers", C0541R.string.GroupStickers), this.info.stickerset.title, false);
            } else {
                this.textCell2.setText(LocaleController.getString("GroupStickers", C0541R.string.GroupStickers), false);
            }
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C10701());
        ...
        this.nameTextView.addTextChangedListener(new C10712());
        ...
        this.descriptionTextView.setHint(LocaleController.getString("DescriptionOptionalPlaceholder", C0541R.string.DescriptionOptionalPlaceholder));
        ...
        this.descriptionTextView.addTextChangedListener(new C10723());
        ...
        if (this.currentChat.creator && (this.info == null || this.info.can_set_username)) {
            ...
            if (this.currentChat.megagroup) {
                this.radioButtonCell1.setTextAndValue(LocaleController.getString("MegaPublic", C0541R.string.MegaPublic), LocaleController.getString("MegaPublicInfo", C0541R.string.MegaPublicInfo), !this.isPrivate);
            } else {
            ...
            if (this.currentChat.megagroup) {
                this.radioButtonCell2.setTextAndValue(LocaleController.getString("MegaPrivate", C0541R.string.MegaPrivate), LocaleController.getString("MegaPrivateInfo", C0541R.string.MegaPrivateInfo), this.isPrivate);
            } else {
            ...
            this.usernameTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", C0541R.string.ChannelUsernamePlaceholder));
            ...
            this.usernameTextView.addTextChangedListener(new C10734());
        ...
        if ((this.currentChat.creator || (this.currentChat.admin_rights != null && this.currentChat.admin_rights.change_info)) && this.currentChat.megagroup) {
            ...
            this.radioButtonCell3.setTextAndValue(LocaleController.getString("ChatHistoryVisible", C0541R.string.ChatHistoryVisible), LocaleController.getString("ChatHistoryVisibleInfo", C0541R.string.ChatHistoryVisibleInfo), !this.historyHidden);
        ...
        if (!this.currentChat.megagroup) {
            ...
            this.textCheckCell.setTextAndCheck(LocaleController.getString("ChannelSignMessages", C0541R.string.ChannelSignMessages), this.signMessages, false);
            ...
            this.infoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0541R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            this.infoCell.setText(LocaleController.getString("ChannelSignMessagesInfo", C0541R.string.ChannelSignMessagesInfo));
            ...
            this.infoCell3.setText(LocaleController.getString("GroupStickersInfo", C0541R.string.GroupStickersInfo));
        ...
        if (this.currentChat.creator) {
            ...
            if (this.currentChat.megagroup) {
                this.textCell.setText(LocaleController.getString("DeleteMega", C0541R.string.DeleteMega), false);
            } else {
                this.textCell.setText(LocaleController.getString("ChannelDelete", C0541R.string.ChannelDelete), false);
            }
            ...
            this.infoCell2.setBackgroundDrawable(Theme.getThemedDrawable(context, C0541R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            if (this.currentChat.megagroup) {
                this.infoCell2.setText(LocaleController.getString("MegaDeleteInfo", C0541R.string.MegaDeleteInfo));
            } else {
                this.infoCell2.setText(LocaleController.getString("ChannelDeleteInfo", C0541R.string.ChannelDeleteInfo));
            }
            this.linearLayout.addView(this.infoCell2, LayoutHelper.createLinear(-1, -2));
        } else {
            if (!this.currentChat.megagroup) {
                this.infoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, C0541R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
        ...
        if (this.infoCell3 != null) {
            if (this.infoCell2 == null) {
                this.infoCell3.setBackgroundDrawable(Theme.getThemedDrawable(context, C0541R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            } else {
                this.infoCell3.setBackgroundDrawable(Theme.getThemedDrawable(context, C0541R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            }
        }
    ...
    final /* synthetic */ void lambda$createView$8$ChannelEditInfoActivity(View v) {
        if (this.invite != null) {
            try {
                ...
                Toast.makeText(getParentActivity(), LocaleController.getString("LinkCopied", C0541R.string.LinkCopied), 0).show();
            } catch (Throwable e) {
                FileLog.m14e(e);
            }
        }
    ...
    final /* synthetic */ void lambda$createView$12$ChannelEditInfoActivity(View v) {
        GroupStickersActivity groupStickersActivity = new GroupStickersActivity(this.currentChat.f113id);
    ...
    final /* synthetic */ void lambda$createView$14$ChannelEditInfoActivity(View v) {
        Builder builder = new Builder(getParentActivity());
        if (this.currentChat.megagroup) {
            builder.setMessage(LocaleController.getString("MegaDeleteAlert", C0541R.string.MegaDeleteAlert));
        } else {
            builder.setMessage(LocaleController.getString("ChannelDeleteAlert", C0541R.string.ChannelDeleteAlert));
        }
        builder.setTitle(LocaleController.getString("AppName", C0541R.string.AppName));
        builder.setPositiveButton(LocaleController.getString("OK", C0541R.string.OK), new ChannelEditInfoActivity$$Lambda$25(this));
    ...
    final /* synthetic */ void lambda$null$19$ChannelEditInfoActivity(View view) {
        ...
        if (channel.megagroup) {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlert", C0541R.string.RevokeLinkAlert, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
        } else {
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("RevokeLinkAlertChannel", C0541R.string.RevokeLinkAlertChannel, MessagesController.getInstance(this.currentAccount).linkPrefix + "/" + channel.username, channel.title)));
        }
        builder.setNegativeButton(LocaleController.getString("Cancel", C0541R.string.Cancel), null);
        builder.setPositiveButton(LocaleController.getString("RevokeButton", C0541R.string.RevokeButton), new ChannelEditInfoActivity$$Lambda$22(this, channel));
        showDialog(builder.create());
    }
    ...
    private void updatePrivatePublic() {
        ...
        if (this.sectionCell2 != null) {
            if (this.isPrivate || this.canCreatePublic) {
                ...
                if (this.currentChat.megagroup) {
                    this.typeInfoCell.setText(this.isPrivate ? LocaleController.getString("MegaPrivateLinkHelp", C0541R.string.MegaPrivateLinkHelp) : LocaleController.getString("MegaUsernameHelp", C0541R.string.MegaUsernameHelp));
                ...
                if (this.loadingAdminedChannels) {
                    ...
                    this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(this.adminedInfoCell.getContext(), C0541R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    this.typeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(this.typeInfoCell.getContext(), C0541R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    this.loadingAdminedCell.setVisibility(8);
    ...
    private boolean checkUserName(String name) {
        ...
        if (name != null) {
            ...
            while (a < name.length()) {
                ...
                if (a != 0 || ch < '0' || ch > '9') {
                    ...
                    this.checkTextView.setText(LocaleController.getString("LinkInvalidStartNumberMega", C0541R.string.LinkInvalidStartNumberMega));
                    this.checkTextView.setTag(Theme.key_windowBackgroundWhiteRedText4);
                    this.checkTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteRedText4));
                    return false;
                } else {
        ...
        if (name == null || name.length() < 5) {
            if (this.currentChat.megagroup) {
                this.checkTextView.setText(LocaleController.getString("LinkInvalidShortMega", C0541R.string.LinkInvalidShortMega));
                this.checkTextView.setTag(Theme.key_windowBackgroundWhiteRedText4);
                this.checkTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteRedText4));
                return false;
            }
    ...
    final /* synthetic */ void lambda$null$22$ChannelEditInfoActivity(String name, TL_error error, TLObject response) {
        ...
        if (this.lastCheckName != null && this.lastCheckName.equals(name)) {
            if (error == null && (response instanceof TL_boolTrue)) {
                this.checkTextView.setText(LocaleController.formatString("LinkAvailable", C0541R.string.LinkAvailable, name));
            ...
            if (error == null || !error.text.equals("CHANNELS_ADMIN_PUBLIC_TOO_MUCH")) {
                this.checkTextView.setText(LocaleController.getString("LinkInUse", C0541R.string.LinkInUse));
            } else {
