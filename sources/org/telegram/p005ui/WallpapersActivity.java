...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C18083 implements OnTouchListener {
        C18083() {
        }
    ...
    class C23212 extends ActionBarMenuOnItemClick {
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                if (wallPaper != null && wallPaper.f182id != 1000001 && (wallPaper instanceof TL_wallPaper)) {
    ...
    class C23224 implements OnItemClickListener {
        C23224() {
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            WallpapersActivity.this.selectedBackground = ((WallPaper) WallpapersActivity.this.wallPapers.get(position)).f182id;
            WallpapersActivity.this.overrideThemeWallpaper = true;
            WallpapersActivity.this.listAdapter.notifyDataSetChanged();
            WallpapersActivity.this.processSelectedBackground();
        }
    ...
    class C23235 implements RequestDelegate {
        C23235() {
        }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            WallpapersActivity.this.wallpappersByIds.put(((WallPaper) obj).f182id, (WallPaper) obj);
                        }
    ...
    public View createView(Context context) {
        ...
        this.backgroundImage.setOnTouchListener(new C18083());
        ...
        this.listView.setOnItemClickListener(new C23224());
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        ...
        if (id == NotificationCenter.FileDidFailedLoad) {
            ...
            while (it.hasNext()) {
                ...
                this.wallpappersByIds.put(wallPaper.f182id, wallPaper);
            }
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getWallPapers(), new C23235()), this.classGuid);
    }
