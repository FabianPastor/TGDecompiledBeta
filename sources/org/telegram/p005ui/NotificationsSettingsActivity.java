                                                                        ...
                                                                        if (position == this.notificationsServiceRow) {
                                                                            ...
                                                                            if (position != this.callsVibrateRow) {
                                                                                if (position == this.repeatRow) {
                                                                                    ...
                                                                                    builder.setItems(new CharSequence[]{LocaleController.getString("RepeatDisabled", CLASSNAMER.string.RepeatDisabled), LocaleController.formatPluralString("Minutes", 5), LocaleController.formatPluralString("Minutes", 10), LocaleController.formatPluralString("Minutes", 30), LocaleController.formatPluralString("Hours", 1), LocaleController.formatPluralString("Hours", 2), LocaleController.formatPluralString("Hours", 4)}, new NotificationsSettingsActivity$$Lambda$6(this, position));
                                                                                    builder.setNegativeButton(LocaleController.getString("Cancel", CLASSNAMER.string.Cancel), null);
                                                                                    showDialog(builder.create());
                                                                                }
