            ...
            if (showEmoji) {
                ...
                for (int a = 0; a < document.attributes.size(); a++) {
                    ...
                    if (attribute instanceof TL_documentAttributeSticker) {
                        ...
                        if (!set) {
                            this.emojiTextView.setText(Emoji.replaceEmoji(DataQuery.getInstance(this.currentAccount).getEmojiForSticker(this.sticker.f84id), this.emojiTextView.getPaint().getFontMetricsInt(), AndroidUtilities.m10dp(16.0f), false));
                        }
