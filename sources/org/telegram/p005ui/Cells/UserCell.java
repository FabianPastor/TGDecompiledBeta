...
public class UserCell extends FrameLayout {
    ...
    public void setIsAdmin(int value) {
        if (this.adminTextView != null) {
            ...
            if (value == 1) {
                this.adminTextView.setText(LocaleController.getString("ChannelCreator", CLASSNAMER.string.ChannelCreator));
                this.adminTextView.setTextColor(Theme.getColor(Theme.key_profile_creatorIcon));
                setTag(Theme.key_profile_creatorIcon);
            } else if (value == 2) {
                this.adminTextView.setText(LocaleController.getString("ChannelAdmin", CLASSNAMER.string.ChannelAdmin));
