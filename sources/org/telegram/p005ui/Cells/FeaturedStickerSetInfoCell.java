...
public class FeaturedStickerSetInfoCell extends FrameLayout {
    ...
    private Drawable addDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m10dp(4.0f), Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed));
    private int angle;
    ...
    class C08061 extends Drawable {
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawCircle((float) AndroidUtilities.m10dp(8.0f), 0.0f, (float) AndroidUtilities.m10dp(4.0f), this.paint);
        }
    ...
    public FeaturedStickerSetInfoCell(Context context, int left) {
        ...
        this.botProgressPaint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
        ...
        this.addButton = new TextView(context) {
            protected void onDraw(Canvas canvas) {
                ...
                if (FeaturedStickerSetInfoCell.this.drawProgress || !(FeaturedStickerSetInfoCell.this.drawProgress || FeaturedStickerSetInfoCell.this.progressAlpha == 0.0f)) {
                    ...
                    FeaturedStickerSetInfoCell.this.rect.set((float) x, (float) AndroidUtilities.m10dp(3.0f), (float) (AndroidUtilities.m10dp(8.0f) + x), (float) AndroidUtilities.m10dp(11.0f));
                    ...
                    invalidate(((int) FeaturedStickerSetInfoCell.this.rect.left) - AndroidUtilities.m10dp(2.0f), ((int) FeaturedStickerSetInfoCell.this.rect.top) - AndroidUtilities.m10dp(2.0f), ((int) FeaturedStickerSetInfoCell.this.rect.right) + AndroidUtilities.m10dp(2.0f), ((int) FeaturedStickerSetInfoCell.this.rect.bottom) + AndroidUtilities.m10dp(2.0f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), NUM), MeasureSpec.makeMeasureSpec(AndroidUtilities.m10dp(60.0f), NUM));
    }
    ...
    public void setStickerSet(StickerSetCovered stickerSet, boolean unread, int index, int searchLength) {
        ...
        if (this.hasOnClick) {
            ...
            boolean isStickerPackInstalled = DataQuery.getInstance(this.currentAccount).isStickerPackInstalled(stickerSet.set.f111id);
