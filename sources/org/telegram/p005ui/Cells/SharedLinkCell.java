...
public class SharedLinkCell extends FrameLayout {
    ...
    private int description2Y = AndroidUtilities.m10dp(27.0f);
    private StaticLayout descriptionLayout;
    private StaticLayout descriptionLayout2;
    private TextPaint descriptionTextPaint;
    private int descriptionY = AndroidUtilities.m10dp(27.0f);
    ...
    private int titleY = AndroidUtilities.m10dp(7.0f);
    ...
    public SharedLinkCell(Context context) {
        ...
        this.titleTextPaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
        this.descriptionTextPaint.setTextSize((float) AndroidUtilities.m10dp(16.0f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.links.clear();
        int maxWidth = (MeasureSpec.getSize(widthMeasureSpec) - AndroidUtilities.m10dp((float) AndroidUtilities.leftBaseline)) - AndroidUtilities.m10dp(8.0f);
        String title = null;
        ...
        if (title != null) {
            try {
                this.titleLayout = new StaticLayout(TextUtils.ellipsize(title.replace(10, ' '), this.titleTextPaint, (float) Math.min((int) Math.ceil((double) this.titleTextPaint.measureText(title)), maxWidth), TruncateAt.END), this.titleTextPaint, maxWidth, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            } catch (Throwable e2) {
                FileLog.m14e(e2);
            }
        ...
        if (description != null) {
            try {
                ...
                if (this.descriptionLayout.getLineCount() > 0) {
                    this.description2Y = (this.descriptionY + this.descriptionLayout.getLineBottom(this.descriptionLayout.getLineCount() - 1)) + AndroidUtilities.m10dp(1.0f);
                }
            } catch (Throwable e22) {
                FileLog.m14e(e22);
            }
        ...
        if (description2 != null) {
            try {
                ...
                if (this.descriptionLayout != null) {
                    this.description2Y += AndroidUtilities.m10dp(10.0f);
                }
            ...
            for (a = 0; a < this.links.size(); a++) {
                try {
                    ...
                    if (!(this.descriptionLayout2 == null || this.descriptionLayout2.getLineCount() == 0)) {
                        this.linkY += this.descriptionLayout2.getLineBottom(this.descriptionLayout2.getLineCount() - 1) + AndroidUtilities.m10dp(1.0f);
                    }
        ...
        int maxPhotoWidth = AndroidUtilities.m10dp(52.0f);
        if (LocaleController.isRTL) {
            x = (MeasureSpec.getSize(widthMeasureSpec) - AndroidUtilities.m10dp(10.0f)) - maxPhotoWidth;
        } else {
            x = AndroidUtilities.m10dp(10.0f);
        }
        this.letterDrawable.setBounds(x, AndroidUtilities.m10dp(10.0f), x + maxPhotoWidth, AndroidUtilities.m10dp(62.0f));
        if (hasPhoto) {
            ...
            this.linkImageView.setImageCoords(x, AndroidUtilities.m10dp(10.0f), maxPhotoWidth, maxPhotoWidth);
        ...
        if (!(this.descriptionLayout2 == null || this.descriptionLayout2.getLineCount() == 0)) {
            height += this.descriptionLayout2.getLineBottom(this.descriptionLayout2.getLineCount() - 1);
            if (this.descriptionLayout != null) {
                height += AndroidUtilities.m10dp(10.0f);
            }
        }
        ...
        if (hasPhoto) {
            height = Math.max(AndroidUtilities.m10dp(48.0f), height);
        }
        this.checkBox.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.m10dp(22.0f), NUM), MeasureSpec.makeMeasureSpec(AndroidUtilities.m10dp(22.0f), NUM));
        setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec), (this.needDivider ? 1 : 0) + Math.max(AndroidUtilities.m10dp(72.0f), AndroidUtilities.m10dp(16.0f) + height));
    }
        ...
        if (this.message == null || this.linkLayout.isEmpty() || this.delegate == null || !this.delegate.canPerformActions()) {
            ...
            for (int a = 0; a < this.linkLayout.size(); a++) {
                ...
                if (layout.getLineCount() > 0) {
                    ...
                    int linkPosX = AndroidUtilities.m10dp(f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.descriptionLayout != null) {
            ...
            canvas.save();
            canvas.translate((float) AndroidUtilities.m10dp(LocaleController.isRTL ? 8.0f : (float) AndroidUtilities.leftBaseline), (float) this.descriptionY);
        ...
        if (this.descriptionLayout2 != null) {
            ...
            canvas.translate((float) AndroidUtilities.m10dp(f), (float) this.description2Y);
        ...
        if (!this.linkLayout.isEmpty()) {
            ...
            for (int a = 0; a < this.linkLayout.size(); a++) {
                ...
                if (layout.getLineCount() > 0) {
                    ...
                    canvas.translate((float) AndroidUtilities.m10dp(f), (float) (this.linkY + offset));
