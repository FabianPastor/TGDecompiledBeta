...
public class NotificationsCheckCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawLine) {
            int x = LocaleController.isRTL ? AndroidUtilities.m9dp(76.0f) : (getMeasuredWidth() - AndroidUtilities.m9dp(76.0f)) - 1;
            canvas.drawLine((float) x, (float) AndroidUtilities.m9dp(24.0f), (float) x, (float) AndroidUtilities.m9dp(46.0f), Theme.dividerPaint);
        }
    }
}
