...
public class ChatMessageCell extends BaseCell implements FileDownloadProgressListener, ImageReceiverDelegate, SeekBarDelegate {
    ...
    private Runnable invalidateRunnable = new C07981();
    ...
    private class BotButton {
        ...
        /* synthetic */ BotButton(ChatMessageCell x0, C07981 x1) {
            this();
        }
    }
    ...
    private boolean checkBotButtonMotionEvent(MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            ...
            while (a < this.botButtons.size()) {
                BotButton button = (BotButton) this.botButtons.get(a);
                int y2 = (button.f206y + this.layoutHeight) - AndroidUtilities.m10dp(2.0f);
                if (x < button.f205x + addX || x > (button.f205x + addX) + button.width || y < y2 || y > button.height + y2) {
                    a++;
                } else {
    ...
    private void checkLocationExpired() {
        if (this.currentMessageObject != null) {
            ...
            if (newExpired != this.locationExpired) {
                ...
                this.docTitleLayout = new StaticLayout(LocaleController.getString("AttachLiveLocation", R.string.AttachLiveLocation), Theme.chat_locationTitlePaint, this.backgroundWidth - AndroidUtilities.m10dp(91.0f), Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            }
        }
    }
            ...
            if (messageObject.type == 0) {
                ...
                if (this.hasLinkPreview || this.hasGamePreview || this.hasInvoicePreview) {
                    ...
                    if (document == null) {
                        ...
                        if (MessageObject.isRoundVideoDocument(document)) {
                            ...
                            this.currentPhotoObject = document.thumb;
                            if (this.currentPhotoObject != null && (this.currentPhotoObject.f110w == 0 || this.currentPhotoObject.f109h == 0)) {
                                for (a = 0; a < document.attributes.size(); a++) {
                                    attribute = (DocumentAttribute) document.attributes.get(a);
                                    if ((attribute instanceof TL_documentAttributeImageSize) || (attribute instanceof TL_documentAttributeVideo)) {
                                        this.currentPhotoObject.f110w = attribute.f87w;
                                        this.currentPhotoObject.f109h = attribute.f86h;
                                        break;
                                    }
                                }
                                if (this.currentPhotoObject.f110w == 0 || this.currentPhotoObject.f109h == 0) {
                                    photoSize = this.currentPhotoObject;
                                    photoSize2 = this.currentPhotoObject;
                                    dp3 = AndroidUtilities.m10dp(150.0f);
                                    photoSize2.f109h = dp3;
                                    photoSize.f110w = dp3;
                                }
                            }
                            this.documentAttach = document;
                        ...
                        if (this.currentPhotoObject == null || webDocument2 != null) {
                            if (type != null) {
                                ...
                                if (smallImage || this.documentAttachType == 7) {
                                    ...
                                    width = this.currentPhotoObject.f110w;
                                    scale = ((float) width) / ((float) (maxPhotoWidth - AndroidUtilities.m10dp(2.0f)));
                                    width = (int) (((float) width) / scale);
                                    height = (int) (((float) this.currentPhotoObject.f109h) / scale);
                ...
                if (TextUtils.isEmpty(messageObject.vCardData)) {
                    ...
                    if (TextUtils.isEmpty(phone2)) {
                        ...
                        phone = C0195PhoneFormat.getInstance().format(phone2);
                    }
                } else {
                ...
                if (messageObject.type == 9) {
                    ...
                    } else if (messageObject.messageOwner.media.document.f84id != 0) {
                    ...
                    if (this.currentPhotoObject != null) {
                        scale = ((float) this.currentPhotoObject.f110w) / ((float) photoWidth);
                        w = (int) (((float) this.currentPhotoObject.f110w) / scale);
                        h = (int) (((float) this.currentPhotoObject.f109h) / scale);
                        if (w == 0) {
                        ...
                        if (h > photoHeight) {
                            ...
                            hScale = ((float) this.currentPhotoObject.f109h) / ((float) h);
                            if (((float) this.currentPhotoObject.f110w) / hScale < ((float) photoWidth)) {
                                w = (int) (((float) this.currentPhotoObject.f110w) / hScale);
                            }
                        }
                    }
                    if (messageObject.type == 5) {
                    ...
                    if ((w == 0 || h == 0) && messageObject.type == 8) {
                        ...
                        while (a < messageObject.messageOwner.media.document.attributes.size()) {
                            attribute = (DocumentAttribute) messageObject.messageOwner.media.document.attributes.get(a);
                            if ((attribute instanceof TL_documentAttributeImageSize) || (attribute instanceof TL_documentAttributeVideo)) {
                                scale = ((float) attribute.f87w) / ((float) photoWidth);
                                w = (int) (((float) attribute.f87w) / scale);
                                h = (int) (((float) attribute.f86h) / scale);
                                if (h > photoHeight) {
                                    h = photoHeight;
                                    w = (int) (((float) w) / (((float) h) / ((float) h)));
                                } else if (h < AndroidUtilities.m10dp(120.0f)) {
                                    h = AndroidUtilities.m10dp(120.0f);
                                    hScale = ((float) attribute.f86h) / ((float) h);
                                    if (((float) attribute.f87w) / hScale < ((float) photoWidth)) {
                                        w = (int) (((float) attribute.f87w) / hScale);
                                    }
                                }
                            } else {
                                a++;
                    ...
                    if (this.currentMessagesGroup != null) {
                        ...
                        for (a = 0; a < this.currentMessagesGroup.posArray.size(); a++) {
                            ...
                            firstLineWidth = (int) (((double) firstLineWidth) + Math.ceil((double) ((((float) (position.f55pw + position.leftSpanOffset)) / 1000.0f) * ((float) dWidth))));
                        }
                    ...
                    if (this.currentMessagesGroup != null) {
                        ...
                        dWidth = getGroupPhotosWidth();
                        w = (int) Math.ceil((double) ((((float) this.currentPosition.f55pw) / 1000.0f) * ((float) dWidth)));
                        if (this.currentPosition.minY != (byte) 0 && ((messageObject.isOutOwner() && (this.currentPosition.flags & 1) != 0) || !(messageObject.isOutOwner() || (this.currentPosition.flags & 2) == 0))) {
                            ...
                            for (a = 0; a < this.currentMessagesGroup.posArray.size(); a++) {
                                position = (GroupedMessagePosition) this.currentMessagesGroup.posArray.get(a);
                                if (position.minY == (byte) 0) {
                                    firstLineWidth = (int) (((position.leftSpanOffset != 0 ? Math.ceil((double) ((((float) position.leftSpanOffset) / 1000.0f) * ((float) dWidth))) : 0.0d) + Math.ceil((double) ((((float) position.f55pw) / 1000.0f) * ((float) dWidth)))) + ((double) firstLineWidth));
                                } else if (position.minY == this.currentPosition.minY) {
                                    currentLineWidth = (int) (((position.leftSpanOffset != 0 ? Math.ceil((double) ((((float) position.leftSpanOffset) / 1000.0f) * ((float) dWidth))) : 0.0d) + Math.ceil((double) ((((float) position.f55pw) / 1000.0f) * ((float) dWidth)))) + ((double) currentLineWidth));
                                } else if (position.minY > this.currentPosition.minY) {
                                    break;
                                }
                            }
                        ...
                        if (this.currentPosition.siblingHeights != null) {
                            ...
                            h = (int) Math.ceil((double) (this.currentPosition.f54ph * maxHeight));
                        }
                        ...
                        if ((this.currentPosition.flags & 8) != 0 || (this.currentMessagesGroup.hasSibling && (this.currentPosition.flags & 4) == 0)) {
                            ...
                            for (int i3 = 0; i3 < count; i3++) {
                                ...
                                if (!(rowPosition == this.currentPosition || (rowPosition.flags & 8) == 0)) {
                                    w = (int) Math.ceil((double) ((((float) rowPosition.f55pw) / 1000.0f) * ((float) dWidth)));
                ...
                for (a = 0; a < rows; a++) {
                    ...
                    if (buttonsCount != 0) {
                        ...
                        for (int b = 0; b < row.buttons.size(); b++) {
                            ...
                            botButton.f205x = (AndroidUtilities.m10dp(5.0f) + buttonWidth) * b;
                            botButton.f206y = (AndroidUtilities.m10dp(48.0f) * a) + AndroidUtilities.m10dp(5.0f);
                            ...
                            if (b == row.buttons.size() - 1) {
                                maxButtonsWidth = Math.max(maxButtonsWidth, botButton.f205x + botButton.width);
                            }
                        }
                    }
                }
    ...
    private void drawContent(Canvas canvas) {
        ...
        if (!this.botButtons.isEmpty()) {
            ...
            while (a < this.botButtons.size()) {
                BotButton button = (BotButton) this.botButtons.get(a);
                y = (button.f206y + this.layoutHeight) - AndroidUtilities.m10dp(2.0f);
                Theme.chat_systemDrawable.setColorFilter(a == this.pressedBotButton ? Theme.colorPressedFilter : Theme.colorFilter);
                Theme.chat_systemDrawable.setBounds(button.f205x + addX, y, (button.f205x + addX) + button.width, button.height + y);
                Theme.chat_systemDrawable.draw(canvas);
                canvas.save();
                canvas.translate((float) ((button.f205x + addX) + AndroidUtilities.m10dp(5.0f)), (float) (((AndroidUtilities.m10dp(44.0f) - button.title.getLineBottom(button.title.getLineCount() - 1)) / 2) + y));
                button.title.draw(canvas);
                canvas.restore();
                if (button.button instanceof TL_keyboardButtonUrl) {
                    BaseCell.setDrawableBounds(Theme.chat_botLinkDrawalbe, (((button.f205x + button.width) - AndroidUtilities.m10dp(3.0f)) - Theme.chat_botLinkDrawalbe.getIntrinsicWidth()) + addX, AndroidUtilities.m10dp(3.0f) + y);
                    Theme.chat_botLinkDrawalbe.draw(canvas);
                } else if (button.button instanceof TL_keyboardButtonSwitchInline) {
                    BaseCell.setDrawableBounds(Theme.chat_botInlineDrawable, (((button.f205x + button.width) - AndroidUtilities.m10dp(3.0f)) - Theme.chat_botInlineDrawable.getIntrinsicWidth()) + addX, AndroidUtilities.m10dp(3.0f) + y);
                    ...
                    if (drawProgress || !(drawProgress || button.progressAlpha == 0.0f)) {
                        ...
                        x = ((button.f205x + button.width) - AndroidUtilities.m10dp(12.0f)) + addX;
    ...
    private void setMessageObjectInternal(MessageObject messageObject) {
        ...
        if (authorName || viaBot) {
            ...
            if (this.currentUser == null || this.currentMessageObject.isOutOwner() || this.currentMessageObject.type == 13 || this.currentMessageObject.type == 5 || !this.delegate.isChatAdminCell(this.currentUser.f177id)) {
                adminString = null;
                adminWidth = 0;
            } else {
        ...
        if (this.drawForwardedName && messageObject.needDrawForwarded() && (this.currentPosition == null || this.currentPosition.minY == (byte) 0)) {
            ...
            if (!(this.currentForwardUser == null && this.currentForwardChannel == null)) {
                ...
                try {
                    ...
                    this.forwardedNameLayout[0] = new StaticLayout(TextUtils.ellipsize(AndroidUtilities.replaceTags(LocaleController.getString("ForwardedMessage", R.string.ForwardedMessage)), Theme.chat_forwardNamePaint, (float) this.forwardedNameWidth, TruncateAt.END), Theme.chat_forwardNamePaint, this.forwardedNameWidth + AndroidUtilities.m10dp(2.0f), Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public void drawNamesLayout(Canvas canvas) {
        ...
        if (this.drawNameLayout && this.nameLayout != null) {
            ...
            if (this.currentMessageObject.type == 13 || this.currentMessageObject.type == 5) {
                ...
                if (this.currentUser != null) {
                    Theme.chat_namePaint.setColor(AvatarDrawable.getNameColorForId(this.currentUser.f177id));
                } else if (this.currentChat == null) {
                    ...
                    Theme.chat_namePaint.setColor(AvatarDrawable.getNameColorForId(this.currentChat.f78id));
                } else {
