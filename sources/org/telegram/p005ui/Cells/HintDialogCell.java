...
public class HintDialogCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), NUM), MeasureSpec.makeMeasureSpec(AndroidUtilities.m10dp(100.0f), NUM));
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (child == this.imageView && this.countLayout != null) {
            ...
            int left = AndroidUtilities.m10dp(54.0f);
            int x = left - AndroidUtilities.m10dp(5.5f);
            this.rect.set((float) x, (float) top, (float) ((this.countWidth + x) + AndroidUtilities.m10dp(11.0f)), (float) (AndroidUtilities.m10dp(23.0f) + top));
            ...
            canvas.save();
            canvas.translate((float) left, (float) (AndroidUtilities.m10dp(4.0f) + top));
