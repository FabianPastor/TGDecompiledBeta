...
public class CancelAccountDeletionActivity extends BaseFragment {
    ...
    class C19051 extends ActionBarMenuOnItemClick {
        C19051() {
        }
        ...
        public void onItemClick(int id) {
            if (id == 1) {
                ...
                CancelAccountDeletionActivity.this.lambda$checkDiscard$69$PassportActivity();
            }
        }
    }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C07885 extends TimerTask {
        ...
        class C07926 extends TimerTask {
            ...
            class C07901 implements Runnable {
                ...
                class C07911 implements RequestDelegate {
                    C07911() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(CancelAccountDeletionActivity.this.currentAccount).sendRequest(req, new C07911(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C07901());
                }
            }
        }
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("CancelAccountResetInfo", R.string.CancelAccountResetInfo, C0195PhoneFormat.getInstance().format("+" + number))));
                    if (this.currentType != 3) {
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C07885(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C07926(), 0, 1000);
            }
        }
                    ...
                    public void run(TLObject response, final TL_error error) {
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            public void run() {
                                ...
                                LoginActivitySmsView.this.nextPressed = false;
                                if (error == null) {
                                    CancelAccountDeletionActivity.this.errorDialog = AlertsCreator.showSimpleAlert(CancelAccountDeletionActivity.this, LocaleController.formatString("CancelLinkSuccess", R.string.CancelLinkSuccess, C0195PhoneFormat.getInstance().format("+" + LoginActivitySmsView.this.phone)));
                                    return;
                                }
                                LoginActivitySmsView.this.lastError = error.text;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19051());
