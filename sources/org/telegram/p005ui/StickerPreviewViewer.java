...
public class StickerPreviewViewer {
    ...
    private int keyboardHeight = AndroidUtilities.m10dp(200.0f);
    private long lastUpdateTime;
    private Runnable openStickerPreviewRunnable;
    private Activity parentActivity;
    private float showProgress;
    private Runnable showSheetRunnable = new C22251();
    private int startX;
    private int startY;
    ...
    class C22251 implements Runnable {
        ...
        class C22242 implements OnDismissListener {
            C22242() {
            }
            ...
            if (StickerPreviewViewer.this.parentActivity != null && StickerPreviewViewer.this.currentSet != null) {
                ...
                if (StickerPreviewViewer.this.delegate != null) {
                    if (StickerPreviewViewer.this.delegate.needSend()) {
                        items.add(LocaleController.getString("SendStickerPreview", C0541R.string.SendStickerPreview));
                        icons.add(Integer.valueOf(C0541R.drawable.stickers_send));
                        actions.add(Integer.valueOf(0));
                    }
                    items.add(LocaleController.formatString("ViewPackPreview", C0541R.string.ViewPackPreview, new Object[0]));
                    icons.add(Integer.valueOf(C0541R.drawable.stickers_pack));
                ...
                if (!MessageObject.isMaskDocument(StickerPreviewViewer.this.currentSticker) && (inFavs || DataQuery.getInstance(StickerPreviewViewer.this.currentAccount).canAddStickerToFavorites())) {
                    items.add(inFavs ? LocaleController.getString("DeleteFromFavorites", C0541R.string.DeleteFromFavorites) : LocaleController.getString("AddToFavorites", C0541R.string.AddToFavorites));
                    icons.add(Integer.valueOf(inFavs ? C0541R.drawable.stickers_unfavorite : C0541R.drawable.stickers_favorite));
                ...
                if (!items.isEmpty()) {
                    ...
                    StickerPreviewViewer.this.visibleDialog.setOnDismissListener(new C22242());
    ...
    class C22284 implements OnTouchListener {
        C22284() {
        }
    ...
    class C22295 implements Runnable {
        C22295() {
        }
            ...
            if (event.getAction() == 1 || event.getAction() == 3 || event.getAction() == 6) {
                ...
                if (isVisible()) {
                    ...
                    if (event.getAction() != 2) {
                        AndroidUtilities.cancelRunOnUIThread(this.openStickerPreviewRunnable);
                        this.openStickerPreviewRunnable = null;
                    } else if (Math.hypot((double) (((float) this.startX) - event.getX()), (double) (((float) this.startY) - event.getY())) > ((double) AndroidUtilities.m10dp(10.0f))) {
                        AndroidUtilities.cancelRunOnUIThread(this.openStickerPreviewRunnable);
                        this.openStickerPreviewRunnable = null;
                    }
                }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C22284());
    ...
    public void open(Document sticker, boolean isRecent) {
        if (this.parentActivity != null && sticker != null) {
            ...
            if (textPaint == null) {
                ...
                textPaint.setTextSize((float) AndroidUtilities.m10dp(24.0f));
            }
            ...
            for (a = 0; a < sticker.attributes.size(); a++) {
                ...
                if ((attribute instanceof TL_documentAttributeSticker) && !TextUtils.isEmpty(attribute.alt)) {
                    this.stickerEmojiLayout = new StaticLayout(Emoji.replaceEmoji(attribute.alt, textPaint.getFontMetricsInt(), AndroidUtilities.m10dp(24.0f), false), textPaint, AndroidUtilities.m10dp(100.0f), Alignment.ALIGN_CENTER, 1.0f, 0.0f, false);
                    break;
                }
            }
    ...
    private void onDraw(Canvas canvas) {
        if (this.containerView != null && this.backgroundDrawable != null) {
            ...
            canvas.translate((float) (this.containerView.getWidth() / 2), (float) Math.max((this.stickerEmojiLayout != null ? AndroidUtilities.m10dp(40.0f) : 0) + (AndroidUtilities.statusBarHeight + (size / 2)), (this.containerView.getHeight() - this.keyboardHeight) / 2));
            ...
            if (this.stickerEmojiLayout != null) {
                canvas.translate((float) (-AndroidUtilities.m10dp(50.0f)), (float) (((-this.centerImage.getImageHeight()) / 2) - AndroidUtilities.m10dp(30.0f)));
            ...
            if (this.isVisible) {
                ...
                if (this.showProgress == 0.0f) {
                    ...
                    AndroidUtilities.runOnUIThread(new C22295());
                    try {
                        if (this.windowView.getParent() != null) {
                            ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                        }
