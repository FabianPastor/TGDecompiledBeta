...
public class StickerPreviewViewer {
    ...
    private Runnable showSheetRunnable = new C17311();
    private int startX;
    private int startY;
    ...
    class C17311 implements Runnable {
        ...
        class C17302 implements OnDismissListener {
            C17302() {
            }
        ...
        public void run() {
            if (StickerPreviewViewer.this.parentActivity != null && StickerPreviewViewer.this.currentSet != null) {
                ...
                if (!items.isEmpty()) {
                    ...
                    StickerPreviewViewer.this.visibleDialog.setOnDismissListener(new C17302());
    ...
    class C17344 implements OnTouchListener {
        C17344() {
        }
    ...
    class C17355 implements Runnable {
        C17355() {
        }
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C17344());
        ...
        if (this.containerView != null && this.backgroundDrawable != null) {
            ...
            if (this.isVisible) {
                ...
                if (this.showProgress == 0.0f) {
                    ...
                    AndroidUtilities.runOnUIThread(new C17355());
                    try {
                        if (this.windowView.getParent() != null) {
                            ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                        }
