...
public class ChatActivity extends BaseFragment implements NotificationCenterDelegate, DialogsActivityDelegate, LocationActivityDelegate {
    ...
    private PhotoViewerProvider botContextProvider = new C19792();
    ...
    OnItemClickListenerExtended onItemClickListener = new C19714();
    OnItemLongClickListenerExtended onItemLongClickListener = new C19683();
    ...
    private PhotoViewerProvider photoViewerProvider = new C19781();
    ...
    class C094413 implements OnClickListener {
        C094413() {
        }
        ...
        final /* synthetic */ void lambda$null$1$ChatActivity$13(TLObject response, TL_error error, MessagesStorage messagesStorage) {
            ...
            int id = ((Message) res.messages.get(0)).f104id;
            long mid = (long) id;
            if (ChatObject.isChannel(ChatActivity.this.currentChat)) {
                mid |= ((long) ChatActivity.this.currentChat.f78id) << 32;
            }
    ...
    class C095430 extends ViewOutlineProvider {
        C095430() {
        }
    ...
    class C095734 extends AnimatorListenerAdapter {
        C095734() {
        }
    ...
    class C095835 extends AnimatorListenerAdapter {
        C095835() {
        }
    ...
    class C096036 extends AnimatorListenerAdapter {

        /* renamed from: org.telegram.ui.ChatActivity$36$1 */
        class C09591 extends AnimatorListenerAdapter {
            C09591() {
            }
        ...
        final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$36() {
            if (ChatActivity.this.mediaBanTooltip != null) {
                ...
                AnimatorSet.addListener(new C09591());
    ...
    class C096237 extends AnimatorListenerAdapter {

        /* renamed from: org.telegram.ui.ChatActivity$37$1 */
        class C09611 extends AnimatorListenerAdapter {
            C09611() {
            }
        ...
        final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$37() {
            if (ChatActivity.this.gifHintTextView != null) {
                ...
                AnimatorSet.playTogether(animatorArr);
                AnimatorSet.addListener(new C09611());
                AnimatorSet.setDuration(300);
                AnimatorSet.start();
            }
        }
    ...
    class C096338 extends AnimatorListenerAdapter {
        C096338() {
        }
    ...
    class C096439 extends AnimatorListenerAdapter {
        C096439() {
        }
    ...
    class C096540 extends AnimatorListenerAdapter {
        C096540() {
        }
    ...
    class C096643 extends AnimatorListenerAdapter {
        C096643() {
        }
    ...
    class C096744 extends AnimatorListenerAdapter {
        C096744() {
        }
    ...
    class C096947 extends AnimatorListenerAdapter {
        C096947() {
        }
    ...
    class C097148 implements Runnable {

        /* renamed from: org.telegram.ui.ChatActivity$48$1 */
        class C09701 extends AnimatorListenerAdapter {
            C09701() {
            }
        ...
        public void run() {
            if (ChatActivity.this.hideAlertViewRunnable == this && ChatActivity.this.alertView.getTag() == null) {
                ...
                ChatActivity.this.alertViewAnimator.addListener(new C09701());
    ...
    class C097249 extends AnimatorListenerAdapter {
        C097249() {
        }
    ...
    class C097350 extends AnimatorListenerAdapter {
        C097350() {
        }
    ...
    class C097451 extends AnimatorListenerAdapter {
        C097451() {
        }
    ...
    class C097552 extends AnimatorListenerAdapter {
        C097552() {
        }
    ...
    class C097653 implements OnPreDrawListener {
        C097653() {
        }
    ...
    class C195810 extends SpanSizeLookup {
        C195810() {
        }
    ...
    class C195911 extends ItemDecoration {
        C195911() {
        }
                    ...
                    if (position != null && position.siblingHeights != null) {
                        ...
                        for (a = 0; a < count; a++) {
                            ...
                            if (pos.minY == position.minY && ((pos.minX != position.minX || pos.maxX != position.maxX || pos.minY != position.minY || pos.maxY != position.maxY) && pos.minY == position.minY)) {
                                h -= ((int) Math.ceil((double) (pos.f54ph * maxHeight))) - AndroidUtilities.m10dp(4.0f);
                                break;
                            }
                        }
                        outRect.bottom = -h;
    ...
    class C196012 extends OnScrollListener {
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (!(dy == 0 || !ChatActivity.this.scrollingFloatingDate || ChatActivity.this.currentFloatingTopIsNotMessage)) {
                ...
                if (ChatActivity.this.floatingDateView.getTag() == null) {
                    ...
                    ChatActivity.this.floatingDateAnimation.addListener(new C09431());
    ...
    class C196118 extends SpanSizeLookup {
        C196118() {
        }
    ...
    class C196219 extends ItemDecoration {
        C196219() {
        }
    ...
    class C196320 implements MentionsAdapterDelegate {
        ...
        class C09472 extends AnimatorListenerAdapter {
            C09472() {
            }
        ...
        public void needChangePanelVisibility(boolean show) {
            ...
            if (show) {
                ...
                if (ChatActivity.this.allowStickersPanel && (!ChatActivity.this.mentionsAdapter.isBotContext() || ChatActivity.this.allowContextBotPanel || ChatActivity.this.allowContextBotPanelSecond)) {
                    ...
                    ChatActivity.this.mentionListAnimation.addListener(new C09461());
            ...
            if (ChatActivity.this.allowStickersPanel) {
                ...
                ChatActivity.this.mentionListAnimation.addListener(new C09472());
                ChatActivity.this.mentionListAnimation.setDuration(200);
                ChatActivity.this.mentionListAnimation.start();
                return;
            }
    ...
    class C196421 extends OnScrollListener {
        C196421() {
        }
    ...
    class C196522 implements ChatActivityEnterViewDelegate {
        C196522() {
        }
        ...
        public void onWindowSizeChanged(int size) {
            boolean z = true;
            if (size < AndroidUtilities.m10dp(72.0f) + C0646ActionBar.getCurrentActionBarHeight()) {
    ...
    class C196624 implements StickerPreviewViewerDelegate {
        C196624() {
        }
        ...
        public void openSet(InputStickerSet set) {
            if (set != null && ChatActivity.this.getParentActivity() != null) {
                ...
                inputStickerSet.f103id = set.f103id;
    ...
    class C196732 implements ChatAttachViewDelegate {
        C196732() {
        }
    ...
    class C19683 implements OnItemLongClickListenerExtended {
        C19683() {
        }
    ...
    class C196941 implements PhotoAlbumPickerActivityDelegate {
        C196941() {
        }
    ...
    class C197042 implements DocumentSelectActivityDelegate {
        C197042() {
        }
    ...
    class C19714 implements OnItemClickListenerExtended {
        C19714() {
        }
    ...
    class C19725 extends ActionBarMenuOnItemClick {
        C19725() {
        }
        ...
        public void onItemClick(int id) {
            ...
            if (id == -1) {
                ...
                ChatActivity.this.lambda$checkDiscard$69$PassportActivity();
            } else if (id == 10) {
                ...
                if (ChatActivity.this.currentUser != null && ChatActivity.this.getParentActivity() != null) {
                    ...
                    args = new Bundle();
                    args.putInt("user_id", ChatActivity.this.currentUser.f177id);
                ...
                try {
                    DataQuery.getInstance(ChatActivity.this.currentAccount).installShortcut((long) ChatActivity.this.currentUser.f177id);
                } catch (Throwable e) {
                    FileLog.m14e(e);
                }
            } else if (id == 21) {
                ...
                if (messageObject != null && (messageObject.messageOwner.f104id > 0 || (messageObject.messageOwner.f104id < 0 && ChatActivity.this.currentEncryptedChat != null))) {
                ...
                if (ChatActivity.this.currentUser != null && ChatActivity.this.getParentActivity() != null) {
                    VoIPHelper.startCall(ChatActivity.this.currentUser, ChatActivity.this.getParentActivity(), MessagesController.getInstance(ChatActivity.this.currentAccount).getUserFull(ChatActivity.this.currentUser.f177id));
                }
            } else if (id == 50) {
                if (ChatActivity.this.chatActivityEnterView != null) {
    ...
    class C19736 extends ActionBarMenuItemSearchListener {
        boolean searchWas;
    ...
    public class ChatActivityAdapter extends Adapter {
        ...
        class C19751 implements ChatMessageCellDelegate {
            C19751() {
            }
            ...
            public void didPressedUserAvatar(ChatMessageCell cell, User user) {
                ...
                if (ChatActivity.this.actionBar.isActionModeShowed()) {
                    ChatActivity.this.processRowSelect(cell, true);
                } else if (user != null && user.f177id != UserConfig.getInstance(ChatActivity.this.currentAccount).getClientUserId()) {
                    Bundle args = new Bundle();
                    args.putInt("user_id", user.f177id);
                    ProfileActivity fragment = new ProfileActivity(args);
                    if (ChatActivity.this.currentUser == null || ChatActivity.this.currentUser.f177id != user.f177id) {
                        z = false;
                    }
            ...
            public boolean isChatAdminCell(int uid) {
                if (ChatObject.isChannel(ChatActivity.this.currentChat) && ChatActivity.this.currentChat.megagroup) {
                    return MessagesController.getInstance(ChatActivity.this.currentAccount).isChannelAdmin(ChatActivity.this.currentChat.f78id, uid);
                }
                return false;
            }
        }
        ...
        class C19762 implements ChatActionCellDelegate {
            C19762() {
            }
            ...
            public void needOpenUserProfile(int uid) {
                ...
                if (uid < 0) {
                    ...
                    if (ChatActivity.this.currentEncryptedChat != null && uid == ChatActivity.this.currentUser.f177id) {
                        args.putLong("dialog_id", ChatActivity.this.dialog_id);
                    }
                    ProfileActivity fragment = new ProfileActivity(args);
                    if (ChatActivity.this.currentUser == null || ChatActivity.this.currentUser.f177id != uid) {
                        z = false;
                    }
                    fragment.setPlayProfileAnimation(z);
                    ChatActivity.this.presentFragment(fragment);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                chatMessageCell.setDelegate(new C19751());
                if (ChatActivity.this.currentEncryptedChat == null) {
                    chatMessageCell.setAllowAssistant(true);
                }
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C19762());
            } else if (viewType == 2) {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (position == this.botInfoRow) {
                ...
                if (ChatActivity.this.botInfo.size() != 0) {
                    str = ((BotInfo) ChatActivity.this.botInfo.get(ChatActivity.this.currentUser.f177id)).description;
                } else {
                    str = null;
                }
            ...
            if (position >= this.messagesStartRow && position < this.messagesEndRow) {
                            ...
                            if (index != -1) {
                                ...
                                messageCell.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                                    public boolean onPreDraw() {
                                        ...
                                        r8[3] = ObjectAnimator.ofFloat(cameraContainer, "translationX", new float[]{((float) position[0]) - rect.f230x});
                                        r8[4] = ObjectAnimator.ofFloat(cameraContainer, "translationY", new float[]{((float) position[1]) - rect.f231y});
                                        ...
                                        animatorSet.addListener(new AnimatorListenerAdapter() {
                                            ...
                                            class C09771 extends AnimatorListenerAdapter {
                                                C09771() {
                                                }
                                            ...
                                            public void onAnimationEnd(Animator animation) {
                                                ...
                                                animatorSet.setInterpolator(new DecelerateInterpolator());
                                                animatorSet.addListener(new C09771());
                                                animatorSet.start();
                                            }
                                        });
                                        animatorSet.start();
                ...
                if (message != null && message.messageOwner != null && message.messageOwner.media_unread && message.messageOwner.mentioned) {
                    if (!(ChatActivity.this.inPreviewMode || message.isVoice() || message.isRoundVideo())) {
                        ...
                        MessagesController.getInstance(ChatActivity.this.currentAccount).markMentionMessageAsRead(message.getId(), ChatObject.isChannel(ChatActivity.this.currentChat) ? ChatActivity.this.currentChat.f78id : 0, ChatActivity.this.dialog_id);
    ...
    class C19781 extends EmptyPhotoViewerProvider {
        C19781() {
        }
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (imageReceiver != null) {
                    ...
                    if ((view instanceof ChatActionCell) && ChatActivity.this.currentChat != null) {
                        object.dialogId = -ChatActivity.this.currentChat.f78id;
                    }
    ...
    class C19792 extends EmptyPhotoViewerProvider {
        C19792() {
        }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.currentChat != null) {
            ...
            MessagesController.getInstance(this.currentAccount).loadChatInfo(this.currentChat.f78id, countDownLatch2, ChatObject.isChannel(this.currentChat));
        ...
        if (userId != 0 && this.currentUser.bot) {
            ...
            for (int a = 0; a < this.info.participants.participants.size(); a++) {
                ...
                if (user != null && user.bot) {
                    DataQuery.getInstance(this.currentAccount).loadBotInfo(user.f177id, true, this.classGuid);
                }
            }
        }
        if (this.currentUser != null) {
            this.userBlocked = MessagesController.getInstance(this.currentAccount).blockedUsers.indexOfKey(this.currentUser.f177id) >= 0;
        }
    ...
    public void onFragmentDestroy() {
        ...
        if (this.currentUser != null) {
            MessagesController.getInstance(this.currentAccount).cancelLoadFullUser(this.currentUser.f177id);
        }
        ...
        if (ChatObject.isChannel(this.currentChat)) {
            MessagesController.getInstance(this.currentAccount).startShortPoll(this.currentChat.f78id, true);
        }
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C19725());
        ...
        if (this.currentEncryptedChat == null && !this.isBroadcast) {
            this.searchItem = menu.addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C19736());
        ...
        if (this.currentUser != null) {
            ...
            TL_userFull userFull = MessagesController.getInstance(this.currentAccount).getUserFull(this.currentUser.f177id);
        ...
        if (this.currentEncryptedChat == null) {
            this.actionModeViews.add(actionMode.addItemWithWidth(23, R.drawable.group_edit, AndroidUtilities.m10dp(54.0f)));
            if (!this.isBroadcast) {
                this.actionModeViews.add(actionMode.addItemWithWidth(19, R.drawable.ic_ab_reply, AndroidUtilities.m10dp(54.0f)));
            }
            this.actionModeViews.add(actionMode.addItemWithWidth(22, R.drawable.ic_ab_fave, AndroidUtilities.m10dp(54.0f)));
            this.actionModeViews.add(actionMode.addItemWithWidth(10, R.drawable.ic_ab_copy, AndroidUtilities.m10dp(54.0f)));
            this.actionModeViews.add(actionMode.addItemWithWidth(11, R.drawable.ic_ab_forward, AndroidUtilities.m10dp(54.0f)));
            this.actionModeViews.add(actionMode.addItemWithWidth(12, R.drawable.ic_ab_delete, AndroidUtilities.m10dp(54.0f)));
        } else {
            this.actionModeViews.add(actionMode.addItemWithWidth(23, R.drawable.group_edit, AndroidUtilities.m10dp(54.0f)));
            this.actionModeViews.add(actionMode.addItemWithWidth(19, R.drawable.ic_ab_reply, AndroidUtilities.m10dp(54.0f)));
            this.actionModeViews.add(actionMode.addItemWithWidth(22, R.drawable.ic_ab_fave, AndroidUtilities.m10dp(54.0f)));
        ...
        if (this.currentEncryptedChat != null) {
            ...
            if (this.currentUser == null || this.currentUser.f177id == 777000 || this.currentUser.f177id == 429000 || this.currentUser.f177id == 4244000 || !MessagesController.isSupportId(this.currentUser.f177id)) {
        ...
        this.chatListView = new RecyclerListView(context) {
            ...
            public boolean drawChild(Canvas canvas, View child, long drawingTime) {
                ...
                if (child instanceof ChatMessageCell) {
                    ...
                    GroupedMessages group = cell.getCurrentMessagesGroup();
                    if (position != null) {
                        if (position.f55pw != position.spanSize && position.spanSize == ChatActivity.id_chat_compose_panel && position.siblingHeights == null && group.hasSibling) {
        ...
        this.chatLayoutManager.setSpanSizeLookup(new C195810());
        this.chatListView.setLayoutManager(this.chatLayoutManager);
        this.chatListView.addItemDecoration(new C195911());
        ...
        this.chatListView.setOnScrollListener(new C196012());
        ...
        this.mentiondownButton.setOnClickListener(new C094413());
        ...
        if (!this.isBroadcast) {
                    ...
                    if (object instanceof BotInlineResult) {
                        ...
                        if (inlineResult.document != null) {
                            ...
                            if (inlineResult.document.thumb != null) {
                                f2 = (float) inlineResult.document.thumb.f110w;
                            } else {
                                f2 = 100.0f;
                            }
                            size.width = f2;
                            ...
                            if (inlineResult.document.thumb != null) {
                                f = (float) inlineResult.document.thumb.f109h;
                            }
                            size2.height = f;
                            ...
                            if (photoSize != null) {
                                this.size.width = (float) photoSize.f110w;
                                this.size.height = (float) photoSize.f109h;
                            }
                        }
                    }
                    return this.size;
            ...
            this.mentionGridLayoutManager.setSpanSizeLookup(new C196118());
            this.mentionListView.addItemDecoration(new C196219());
            ...
            chatActivityAdapter = new MentionsAdapter(context, false, this.dialog_id, new C196320());
            ...
            this.mentionListView.setOnScrollListener(new C196421());
        }
        ...
        this.chatActivityEnterView.setDelegate(new C196522());
        ...
        StickerPreviewViewerDelegate c196624 = new C196624();
        final StickerPreviewViewerDelegate stickerPreviewViewerDelegate = c196624;
        ...
        this.stickersListView.setOnTouchListener(new ChatActivity$$Lambda$20(this, c196624));
    ...
    final /* synthetic */ void lambda$createView$10$ChatActivity(View v) {
        Bundle args = new Bundle();
        args.putInt("user_id", this.currentUser.f177id);
        args.putBoolean("addContact", true);
    ...
    final /* synthetic */ void lambda$null$11$ChatActivity(DialogInterface dialogInterface, int i) {
        if (this.currentUser != null) {
            MessagesController.getInstance(this.currentAccount).blockUser(this.currentUser.f177id);
        }
    ...
    final /* synthetic */ void lambda$createView$17$ChatActivity(View view, int position) {
        if (!this.mentionsAdapter.isBannedInline()) {
            ...
            if (object instanceof User) {
                ...
                spannableString.setSpan(new URLSpanUserMention(TtmlNode.ANONYMOUS_REGION_ID + user.f177id, 1), 0, spannableString.length(), 33);
    ...
    final /* synthetic */ void lambda$createView$34$ChatActivity(View view) {
        if (getParentActivity() != null) {
            ...
            if (this.currentUser == null || !this.userBlocked) {
                ...
                this.botUser = null;
                MessagesController.getInstance(this.currentAccount).unblockUser(this.currentUser.f177id);
    ...
    private TextureView createTextureView(boolean add) {
        ...
        if (this.roundVideoContainer == null) {
            if (VERSION.SDK_INT >= 21) {
                ...
                this.roundVideoContainer.setOutlineProvider(new C095430());
    ...
    private void sendBotInlineResult(BotInlineResult result) {
        ...
        params.put(TtmlNode.ATTR_ID, result.f76id);
    ...
    public void processInlineBotContextPM(TL_inlineBotSwitchPM object) {
        if (object != null) {
            ...
            if (user != null) {
                this.chatActivityEnterView.setFieldText(TtmlNode.ANONYMOUS_REGION_ID);
                if (this.dialog_id == ((long) user.f177id)) {
    ...
    private void createChatAttachView() {
        if (getParentActivity() != null && this.chatAttachAlert == null) {
            ...
            this.chatAttachAlert.setDelegate(new C196732());
        }
    }
    ...
    public void shareMyContact(MessageObject messageObject) {
        ...
        if (this.currentUser == null) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureShareMyContactInfoUser", R.string.AreYouSureShareMyContactInfoUser, C0195PhoneFormat.getInstance().format("+" + UserConfig.getInstance(this.currentAccount).getCurrentUser().phone), ContactsController.formatName(this.currentUser.first_name, this.currentUser.last_name))));
        }
    ...
    private void hideVoiceHint() {
        ...
        animatorSet.playTogether(animatorArr);
        this.voiceHintAnimation.addListener(new C095734());
    ...
    private void showVoiceHint(boolean hide, boolean video) {
        if (getParentActivity() != null && this.fragmentView != null) {
            if (!hide || this.voiceHintTextView != null) {
                ...
                animatorSet.playTogether(animatorArr);
                this.voiceHintAnimation.addListener(new C095835());
                this.voiceHintAnimation.setDuration(300);
                this.voiceHintAnimation.start();
            }
        }
        ...
        if (getParentActivity() != null && this.currentChat != null && this.currentChat.banned_rights != null && this.fragmentView != null) {
            if (this.mediaBanTooltip == null || this.mediaBanTooltip.getVisibility() != 0) {
                ...
                if (index != -1) {
                    ...
                    AnimatorSet.addListener(new C096036());
                    AnimatorSet.setDuration(300);
                    AnimatorSet.start();
                }
            }
            ...
            if (getParentActivity() != null && this.fragmentView != null && this.gifHintTextView == null) {
                if (this.allowContextBotPanelSecond) {
                    ...
                    if (index != -1) {
                        ...
                        AnimatorSet.addListener(new C096237());
                        AnimatorSet.setDuration(300);
                        AnimatorSet.start();
                    }
    ...
    private void checkContextBotPanel() {
        ...
        if (this.allowContextBotPanel || this.allowContextBotPanelSecond) {
            if (this.mentionContainer.getVisibility() == 4 || this.mentionContainer.getTag() != null) {
                ...
                this.mentionListAnimation.addListener(new C096439());
            ...
            animatorSet.playTogether(animatorArr);
            this.mentionListAnimation.addListener(new C096338());
            this.mentionListAnimation.setDuration(200);
            this.mentionListAnimation.start();
        }
    }
        ...
        if (this.floatingDateView.getTag() != null && !this.currentFloatingDateOnScreen) {
            if (!this.scrollingFloatingDate || this.currentFloatingTopIsNotMessage) {
                ...
                if (animated) {
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.floatingDateAnimation.addListener(new C096540());
    ...
    private void processSelectedAttach(int which) {
        ...
        if (which == 0) {
            ...
            if (VERSION.SDK_INT < 23 || getParentActivity().checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0) {
                ...
                fragment.setDelegate(new C196941());
            ...
            if (VERSION.SDK_INT < 23 || getParentActivity().checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0) {
                ...
                fragment3.setDelegate(new C197042());
    ...
    private int getScrollOffsetForMessage(MessageObject object) {
        ...
        if (groupedMessages != null) {
            ...
            if (currentPosition.siblingHeights != null) {
                ...
                itemHeight = currentPosition.f54ph;
            }
        ...
        if (this.pagedownButton != null) {
            ...
            if (this.pagedownButton.getTag() != null) {
                ...
                if (animated) {
                    ...
                    this.pagedownButtonAnimation.setDuration(200);
                    this.pagedownButtonAnimation.addListener(new C096643());
                    this.pagedownButtonAnimation.start();
                    return;
                }
                this.pagedownButton.setVisibility(4);
            ...
            if (!show) {
                ...
                if (this.mentiondownButton.getTag() != null) {
                    ...
                    if (animated) {
                        ...
                        this.mentiondownButtonAnimation.addListener(new C096744());
    ...
    public void onRequestPermissionsResultFragment(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 17 && this.chatAttachAlert != null) {
            ...
            if (grantResults.length <= 0 || grantResults[0] != 0) {
                ...
                VoIPHelper.startCall(this.currentUser, getParentActivity(), MessagesController.getInstance(this.currentAccount).getUserFull(this.currentUser.f177id));
            }
        }
    }
    ...
    private void updateTitle() {
        if (this.avatarContainer != null) {
            if (this.currentChat != null) {
                ...
                } else if (MessagesController.isSupportId(this.currentUser.f177id) || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f177id)) != null || (ContactsController.getInstance(this.currentAccount).contactsDict.size() == 0 && ContactsController.getInstance(this.currentAccount).isLoadingContacts())) {
                    this.avatarContainer.setTitle(UserObject.getUserName(this.currentUser));
                } else if (TextUtils.isEmpty(this.currentUser.phone)) {
                    this.avatarContainer.setTitle(UserObject.getUserName(this.currentUser));
                } else {
                    this.avatarContainer.setTitle(C0195PhoneFormat.getInstance().format("+" + this.currentUser.phone));
                }
            }
        }
    }
    ...
    private void checkAndUpdateAvatar() {
        if (this.currentUser != null) {
            User user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.currentUser.f177id));
            if (user != null) {
            ...
            Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.currentChat.f78id));
            if (chat != null) {
        ...
        if (uri != null) {
            ...
            if (extractUriFrom.contains("com.google.android.apps.photos.contentprovider")) {
                try {
                    ...
                    if (index != -1) {
                        uri = Uri.parse(URLDecoder.decode(firstExtraction.substring(0, index), C0016C.UTF8_NAME));
                    }
                } catch (Throwable e) {
                    FileLog.m14e(e);
                }
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        ...
        if (id == NotificationCenter.messagesDidLoaded) {
                ...
                if (index != -1) {
                    ...
                    while (a < messArr.size()) {
                        ...
                        if (this.currentUser != null) {
                            ...
                            if ((this.currentUser.bot && obj.isOut()) || this.currentUser.f177id == currentUserId) {
                                obj.setIsRead();
                            }
                        }
            ...
            if (!((updateMask & 1) == 0 && (updateMask & 16) == 0)) {
                if (this.currentChat != null) {
                    chat = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.currentChat.f78id));
                    if (chat != null) {
                        this.currentChat = chat;
                    }
                } else if (this.currentUser != null) {
                    user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.currentUser.f177id));
                    if (user != null) {
                        this.currentUser = user;
                    }
                }
            ...
            if (((Long) args[0]).longValue() == this.dialog_id) {
                    ...
                    for (a = 0; a < arr.size(); a++) {
                        ...
                        if (this.currentChat != null) {
                            if (((messageObject2.messageOwner.action instanceof TL_messageActionChatDeleteUser) && messageObject2.messageOwner.action.user_id == currentUserId) || ((messageObject2.messageOwner.action instanceof TL_messageActionChatAddUser) && messageObject2.messageOwner.action.users.contains(Integer.valueOf(currentUserId)))) {
                                Chat newChat = MessagesController.getInstance(this.currentAccount).getChat(Integer.valueOf(this.currentChat.f78id));
                                if (newChat != null) {
                ...
                if (this.forwardEndReached[0]) {
                    ...
                    for (a = 0; a < arr.size(); a++) {
                        ...
                        if (this.currentUser != null && ((this.currentUser.bot && obj.isOut()) || this.currentUser.f177id == currentUserId)) {
                            obj.setIsRead();
                        }
                        ...
                        if (obj.type >= 0 && this.messagesDict[0].indexOfKey(obj.getId()) < 0) {
                            if (a == 0 && obj.messageOwner.f104id < 0 && obj.type == 5) {
                                this.animatingMessageObjects.add(obj);
                            }
                            if (obj.hasValidGroupId()) {
                            ...
                            if (placeToPaste == -1) {
                                if (obj.messageOwner.f104id < 0 || this.messages.isEmpty()) {
                                    placeToPaste = 0;
                                } else {
                                    ...
                                    while (b < size) {
                                        ...
                                        if (lastMessage.type < 0 || lastMessage.messageOwner.date <= 0 || ((lastMessage.messageOwner.f104id <= 0 || obj.messageOwner.f104id <= 0 || lastMessage.messageOwner.f104id >= obj.messageOwner.f104id) && lastMessage.messageOwner.date >= obj.messageOwner.date)) {
                                            b++;
                                        } else {
                ...
                if (reloadMegagroup) {
                    MessagesController.getInstance(this.currentAccount).loadFullChat(this.currentChat.f78id, 0, true);
                }
            }
                ...
                while (b < this.messages.size()) {
                    ...
                    if (mid2 > 0 && mid2 <= max_id) {
                        if (this.info != null && this.info.pinned_msg_id == mid2) {
                            ...
                            MessagesStorage.getInstance(this.currentAccount).updateChannelPinnedMessage(this.info.f79id, 0);
                            updatePinnedMessageView(true);
                        }
            ...
            if (ChatObject.isChannel(this.currentChat)) {
                if (channelId == 0 && this.mergeDialogId != 0) {
                    loadIndex = 1;
                } else if (channelId == this.currentChat.f78id) {
                    loadIndex = 0;
                } else {
                    return;
                }
            ...
            if (this.currentChat != null && chatFull.f79id == this.currentChat.f78id) {
                if (chatFull instanceof TL_channelFull) {
                    if (this.currentChat.megagroup) {
                        ...
                        if (lastDate == 0 || Math.abs((System.currentTimeMillis() / 1000) - ((long) lastDate)) > 3600) {
                            MessagesController.getInstance(this.currentAccount).loadChannelParticipants(Integer.valueOf(this.currentChat.f78id));
                        }
                    }
            ...
            if (this.currentChat != null && this.currentChat.f78id == chatId) {
            ...
            if (this.currentEncryptedChat != null && chat2.f88id == this.currentEncryptedChat.f88id) {
            ...
            if (this.currentEncryptedChat != null && this.currentEncryptedChat.f88id == encId) {
            ...
            for (int i5 = 0; i5 < mids.size(); i5++) {
                ...
                for (a = 0; a < arr2.size(); a++) {
                    ...
                    if (a == 0) {
                        ...
                        if (channelId != (ChatObject.isChannel(this.currentChat) ? this.currentChat.f78id : 0)) {
                            return;
                        }
                    }
            ...
            message = args[0];
            MessageObject existMessageObject = (MessageObject) this.messagesDict[0].get(message.f104id);
            ...
            for (a = 0; a < arrayList2.size(); a++) {
                ...
                if (did == this.dialog_id || did == this.mergeDialogId) {
                    currentMessage = (MessageObject) this.messagesDict[did == this.dialog_id ? 0 : 1].get(message.f104id);
            ...
            if (this.foundWebPage != null) {
                ...
                for (a = 0; a < hashMap.size(); a++) {
                    ...
                    if (webPage.f183id == this.foundWebPage.f183id) {
            ...
            updated = false;
            int currentChannelId = ChatObject.isChannel(this.currentChat) ? this.currentChat.f78id : 0;
            ...
            Integer uid = args[0];
            if (this.currentUser != null && this.currentUser.f177id == uid.intValue()) {
            ...
            chat = args[0];
            if (this.currentChat != null && chat.f78id == this.currentChat.f78id && this.chatActivityEnterView != null) {
                this.currentChat = chat;
    ...
    public void showAlert(String name, String message) {
        if (this.alertView != null && name != null && message != null) {
            if (this.alertView.getTag() != null) {
                ...
                this.alertViewAnimator.addListener(new C096947());
            ...
            Runnable c097148 = new C097148();
            this.hideAlertViewRunnable = c097148;
            AndroidUtilities.runOnUIThread(c097148, 3000);
        }
    }
    ...
    private void hidePinnedMessageView(boolean animated) {
        if (this.pinnedMessageView.getTag() == null) {
            ...
            if (animated) {
                ...
                this.pinnedMessageViewAnimator.addListener(new C097249());
            ...
            if (this.info == null || this.info.pinned_msg_id == 0 || this.info.pinned_msg_id == preferences.getInt("pin_" + this.dialog_id, 0) || (this.actionBar != null && (this.actionBar.isActionModeShowed() || this.actionBar.isSearchFieldVisible()))) {
                ...
                if (this.pinnedMessageView.getTag() != null) {
                    ...
                    if (animated) {
                        ...
                        animatorSet.playTogether(animatorArr);
                        this.pinnedMessageViewAnimator.setDuration(200);
                        this.pinnedMessageViewAnimator.addListener(new C097350());
                        this.pinnedMessageViewAnimator.start();
                    } else {
                ...
                if (this.loadingPinnedMessage != this.info.pinned_msg_id) {
                    ...
                    DataQuery.getInstance(this.currentAccount).loadPinnedMessage(this.currentChat.f78id, this.info.pinned_msg_id, true);
                }
            }
    ...
    private void updateSpamView() {
        if (this.reportSpamView != null) {
            ...
            SharedPreferences preferences = MessagesController.getNotificationsSettings(this.currentAccount);
            if (this.currentEncryptedChat != null) {
                if (this.currentEncryptedChat.admin_id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ContactsController.getInstance(this.currentAccount).isLoadingContacts() || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f177id)) != null) {
                    show = false;
                } else {
                    show = true;
                }
            ...
            if (show) {
                if (this.reportSpamView.getTag() != null) {
                    ...
                    this.reportSpamViewAnimator.addListener(new C097552());
                ...
                animatorSet.playTogether(animatorArr);
                this.reportSpamViewAnimator.setDuration(200);
                this.reportSpamViewAnimator.addListener(new C097451());
                this.reportSpamViewAnimator.start();
            }
            checkListViewPaddings();
    ...
    private void updateContactStatus() {
        if (this.addContactItem != null) {
            if (this.currentUser == null) {
                ...
                if ((this.currentEncryptedChat != null && !(this.currentEncryptedChat instanceof TL_encryptedChat)) || MessagesController.isSupportId(this.currentUser.f177id) || UserObject.isDeleted(this.currentUser) || ContactsController.getInstance(this.currentAccount).isLoadingContacts() || (!TextUtils.isEmpty(this.currentUser.phone) && ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f177id)) != null && (ContactsController.getInstance(this.currentAccount).contactsDict.size() != 0 || !ContactsController.getInstance(this.currentAccount).isLoadingContacts()))) {
                    this.addContactItem.setVisibility(8);
                } else {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (message != null && message.messageOwner != null && message.messageOwner.media_unread && message.messageOwner.mentioned) {
                    if (!(message.isVoice() || message.isRoundVideo())) {
                        ...
                        MessagesController.getInstance(this.currentAccount).markMentionMessageAsRead(message.getId(), ChatObject.isChannel(this.currentChat) ? this.currentChat.f78id : 0, this.dialog_id);
                        message.setContentIsRead();
                    }
                    if (view instanceof ChatMessageCell) {
    ...
    private boolean fixLayoutInternal() {
        ...
        if (AndroidUtilities.isSmallTablet() && ApplicationLoader.applicationContext.getResources().getConfiguration().orientation == 1) {
            ...
            c0646ActionBar.setBackButtonDrawable(new BackDrawable(z));
            if (!(this.fragmentContextView == null || this.fragmentContextView.getParent() == null)) {
    ...
    private void fixLayout() {
        if (this.avatarContainer != null) {
            this.avatarContainer.getViewTreeObserver().addOnPreDrawListener(new C097653());
        }
    }
    ...
    private void createDeleteMessagesAlert(MessageObject finalSelectedObject, GroupedMessages finalSelectedGroup, int loadParticipant) {
        if (getParentActivity() != null) {
            ...
            if (this.currentChat != null && this.currentChat.megagroup) {
                ...
                if (user == null || user.f177id == UserConfig.getInstance(this.currentAccount).getClientUserId() || loadParticipant == 2) {
                    if (hasOutgoing) {
                ...
                hasOutgoing = false;
                currentDate = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime();
                if ((this.currentUser != null && this.currentUser.f177id != UserConfig.getInstance(this.currentAccount).getClientUserId() && !this.currentUser.bot) || this.currentChat != null) {
                    if (finalSelectedObject == null) {
                        exit = false;
                        for (a = 1; a >= 0; a--) {
                            for (b = 0; b < this.selectedMessagesIds[a].size(); b++) {
    ...
    final /* synthetic */ void lambda$createDeleteMessagesAlert$66$ChatActivity(MessageObject finalSelectedObject, GroupedMessages finalSelectedGroup, boolean[] deleteForAll, User userFinal, boolean[] checks, DialogInterface dialogInterface, int i) {
        ...
        if (userFinal != null) {
            if (checks[0]) {
                MessagesController.getInstance(this.currentAccount).deleteUserFromChat(this.currentChat.f78id, userFinal, this.info);
            }
            if (checks[1]) {
        ...
        if (!this.actionBar.isActionModeShowed()) {
            ...
            if (message != null) {
                ...
                if (single && (message.messageOwner.action instanceof TL_messageActionPinMessage)) {
                    scrollToMessageId(message.messageOwner.reply_to_msg_id, message.messageOwner.f104id, true, 0, false);
                    return;
                }
                int a;
                GroupedMessages groupedMessages;
                    ...
                    if (!(!message.canEditMessage(this.currentChat) || this.chatActivityEnterView.hasAudioToSend() || message.getDialogId() == this.mergeDialogId)) {
                        ...
                        if (single && type >= 2 && type != 20 && !message.needDrawBluredPreview() && !message.isLiveLocation()) {
                            ...
                            for (a = 0; a < this.actionModeViews.size(); a++) {
                                ...
                                view.setPivotY((float) (C0646ActionBar.getCurrentActionBarHeight() / 2));
                            ...
                            if (type >= 0 || (type == -1 && single && ((message.isSending() || message.isEditing()) && this.currentEncryptedChat == null))) {
                                ...
                                if (type == -1) {
                                    ...
                                    if (type == 3) {
                                        ...
                                        if (!(user == null || user.f177id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(user.f177id)) != null)) {
    ...
    private void startEditingMessageObject(MessageObject messageObject) {
        if (messageObject != null && getParentActivity() != null) {
            ...
            req.f150id = messageObject.getId();
        ...
        if (this.selectedObject != null && getParentActivity() != null) {
            ...
            switch (option) {
                ...
                case 22:
                    ...
                    req.f117id = this.selectedObject.getId();
                    req.channel = MessagesController.getInputChannel(this.currentChat);
