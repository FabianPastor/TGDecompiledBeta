...
import org.telegram.p005ui.Components.ChatItemAnimator;
...
public class ChatActivity extends BaseFragment implements NotificationCenterDelegate, DialogsActivityDelegate, LocationActivityDelegate {
    private static final boolean DEBUG_LIST_INVALIDATION = false;
    ...
    private PhotoViewerProvider botContextProvider = new C13212();
    ...
    private ChatItemAnimator itemAnimator;
    ...
    OnItemClickListenerExtended onItemClickListener = new C13124();
    OnItemLongClickListenerExtended onItemLongClickListener = new C13093();
    ...
    private PhotoViewerProvider photoViewerProvider = new C13201();
    ...
    class C056914 implements OnClickListener {
        C056914() {
        }
    ...
    class C057931 extends ViewOutlineProvider {
        C057931() {
        }
    ...
    class C058336 extends AnimatorListenerAdapter {
        C058336() {
        }
    ...
    class C058437 extends AnimatorListenerAdapter {
        C058437() {
        }
    ...
    class C058638 extends AnimatorListenerAdapter {

        /* renamed from: org.telegram.ui.ChatActivity$38$1 */
        class C05851 extends AnimatorListenerAdapter {
            C05851() {
            }
        ...
        final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$38() {
            if (ChatActivity.this.mediaBanTooltip != null) {
                ...
                AnimatorSet.addListener(new C05851());
    ...
    class C058839 extends AnimatorListenerAdapter {

        /* renamed from: org.telegram.ui.ChatActivity$39$1 */
        class C05871 extends AnimatorListenerAdapter {
            C05871() {
            }
        ...
        final /* synthetic */ void lambda$onAnimationEnd$0$ChatActivity$39() {
            if (ChatActivity.this.gifHintTextView != null) {
                ...
                AnimatorSet.playTogether(animatorArr);
                AnimatorSet.addListener(new C05871());
                AnimatorSet.setDuration(300);
                AnimatorSet.start();
            }
        }
    ...
    class C058940 extends AnimatorListenerAdapter {
        C058940() {
        }
    ...
    class C059041 extends AnimatorListenerAdapter {
        C059041() {
        }
    ...
    class C059142 extends AnimatorListenerAdapter {
        C059142() {
        }
    ...
    class C059245 extends AnimatorListenerAdapter {
        C059245() {
        }
    ...
    class C059346 extends AnimatorListenerAdapter {
        C059346() {
        }
    ...
    class C059549 extends AnimatorListenerAdapter {
        C059549() {
        }
    ...
    class C059750 implements Runnable {

        /* renamed from: org.telegram.ui.ChatActivity$50$1 */
        class C05961 extends AnimatorListenerAdapter {
            C05961() {
            }
        ...
        public void run() {
            if (ChatActivity.this.hideAlertViewRunnable == this && ChatActivity.this.alertView.getTag() == null) {
                ...
                ChatActivity.this.alertViewAnimator.addListener(new C05961());
    ...
    class C059851 extends AnimatorListenerAdapter {
        C059851() {
        }
    ...
    class C059952 extends AnimatorListenerAdapter {
        C059952() {
        }
    ...
    class C060053 extends AnimatorListenerAdapter {
        C060053() {
        }
    ...
    class C060154 extends AnimatorListenerAdapter {
        C060154() {
        }
    ...
    class C060255 implements OnPreDrawListener {
        C060255() {
        }
    ...
    class C129910 extends SpanSizeLookup {
        C129910() {
        }
    ...
    class C130011 extends ItemDecoration {
        C130011() {
        }
        ...
        public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
            ...
            if (!(dy == 0 || !ChatActivity.this.scrollingFloatingDate || ChatActivity.this.currentFloatingTopIsNotMessage)) {
                ...
                if (ChatActivity.this.floatingDateView.getTag() == null) {
                    ...
                    ChatActivity.this.floatingDateAnimation.addListener(new C05681());
    ...
    class C130219 extends SpanSizeLookup {
        C130219() {
        }
    ...
    class C130320 extends ItemDecoration {
        C130320() {
        }
    ...
    class C130421 implements MentionsAdapterDelegate {

        /* renamed from: org.telegram.ui.ChatActivity$21$1 */
        class C05711 extends AnimatorListenerAdapter {
            C05711() {
            }
        ...
        class C05722 extends AnimatorListenerAdapter {
            C05722() {
            }
        ...
        public void needChangePanelVisibility(boolean show) {
            ...
            if (show) {
                ...
                if (ChatActivity.this.allowStickersPanel && (!ChatActivity.this.mentionsAdapter.isBotContext() || ChatActivity.this.allowContextBotPanel || ChatActivity.this.allowContextBotPanelSecond)) {
                    ...
                    ChatActivity.this.mentionListAnimation.addListener(new C05711());
            ...
            if (ChatActivity.this.allowStickersPanel) {
                ...
                ChatActivity.this.mentionListAnimation.addListener(new C05722());
                ChatActivity.this.mentionListAnimation.setDuration(200);
                ChatActivity.this.mentionListAnimation.start();
                return;
            }
    ...
    class C130522 extends OnScrollListener {
        C130522() {
        }
    ...
    class C130623 implements ChatActivityEnterViewDelegate {
        C130623() {
        }
        ...
        public void onSetTranslationY(int translationY) {
            if (ChatActivity.this.chatListView != null) {
                ChatActivity.this.chatListView.setTranslationY((float) translationY);
            }
            if (ChatActivity.this.progressView != null) {
                ChatActivity.this.progressView.setTranslationY((float) translationY);
            }
            if (ChatActivity.this.mentionContainer != null) {
                ChatActivity.this.mentionContainer.setTranslationY((float) translationY);
            }
            if (ChatActivity.this.pagedownButton != null) {
                ChatActivity.this.pagedownButton.setTranslationY((float) translationY);
            }
            if (ChatActivity.this.mentiondownButton != null) {
                ChatActivity.this.mentiondownButton.setTranslationY(ChatActivity.this.pagedownButton.getVisibility() != 0 ? (float) translationY : (float) (translationY - AndroidUtilities.m9dp(72.0f)));
            }
        }
    }

    /* renamed from: org.telegram.ui.ChatActivity$25 */
    class C130725 implements StickerPreviewViewerDelegate {
        C130725() {
        }
    ...
    class C130834 implements ChatAttachViewDelegate {
        C130834() {
        }
    ...
    class C13093 implements OnItemLongClickListenerExtended {
        C13093() {
        }
    ...
    class C131043 implements PhotoAlbumPickerActivityDelegate {
        C131043() {
        }
    ...
    class C131144 implements DocumentSelectActivityDelegate {
        C131144() {
        }
    ...
    class C13124 implements OnItemClickListenerExtended {
        C13124() {
        }
    ...
    class C13135 extends ActionBarMenuOnItemClick {
        C13135() {
        }
        ...
        public void onItemClick(int id) {
            ...
            if (id == -1) {
                ...
                if (ChatActivity.this.currentUser != null && ChatActivity.this.getParentActivity() != null) {
                    ...
                    args = new Bundle();
                    args.putInt("user_id", ChatActivity.this.currentUser.f176id);
                ...
                try {
                    DataQuery.getInstance(ChatActivity.this.currentAccount).installShortcut((long) ChatActivity.this.currentUser.f176id);
                } catch (Throwable e) {
                    FileLog.m13e(e);
                }
            } else if (id == 21) {
                ...
                if (ChatActivity.this.currentUser != null && ChatActivity.this.getParentActivity() != null) {
                    VoIPHelper.startCall(ChatActivity.this.currentUser, ChatActivity.this.getParentActivity(), MessagesController.getInstance(ChatActivity.this.currentAccount).getUserFull(ChatActivity.this.currentUser.f176id));
                }
            } else if (id == 50) {
                if (ChatActivity.this.chatActivityEnterView != null) {
    ...
    class C13146 extends ActionBarMenuItemSearchListener {
        boolean searchWas;
    ...
    public class ChatActivityAdapter extends Adapter {
        ...
        class C13161 implements ChatMessageCellDelegate {
            C13161() {
            }
            ...
            public void didPressedUserAvatar(ChatMessageCell cell, User user) {
                ...
                if (ChatActivity.this.actionBar.isActionModeShowed()) {
                    ChatActivity.this.processRowSelect(cell, true);
                } else if (user != null && user.f176id != UserConfig.getInstance(ChatActivity.this.currentAccount).getClientUserId()) {
                    Bundle args = new Bundle();
                    args.putInt("user_id", user.f176id);
                    ProfileActivity fragment = new ProfileActivity(args);
                    if (ChatActivity.this.currentUser == null || ChatActivity.this.currentUser.f176id != user.f176id) {
                        z = false;
                    }
        ...
        class C13172 implements ChatActionCellDelegate {
            C13172() {
            }
            ...
            public void needOpenUserProfile(int uid) {
                ...
                if (uid < 0) {
                    ...
                    if (ChatActivity.this.currentEncryptedChat != null && uid == ChatActivity.this.currentUser.f176id) {
                        args.putLong("dialog_id", ChatActivity.this.dialog_id);
                    }
                    ProfileActivity fragment = new ProfileActivity(args);
                    if (ChatActivity.this.currentUser == null || ChatActivity.this.currentUser.f176id != uid) {
                        z = false;
                    }
                    fragment.setPlayProfileAnimation(z);
                    ChatActivity.this.presentFragment(fragment);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == 0) {
                ...
                chatMessageCell.setDelegate(new C13161());
                if (ChatActivity.this.currentEncryptedChat == null) {
                    chatMessageCell.setAllowAssistant(true);
                }
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C13172());
            } else if (viewType == 2) {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (position == this.botInfoRow) {
                ...
                if (ChatActivity.this.botInfo.size() != 0) {
                    str = ((BotInfo) ChatActivity.this.botInfo.get(ChatActivity.this.currentUser.f176id)).description;
                } else {
                    str = null;
                }
                            ...
                            if (index != -1) {
                                ...
                                messageCell.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                                    public boolean onPreDraw() {
                                        ...
                                        r8[3] = ObjectAnimator.ofFloat(cameraContainer, "translationX", new float[]{((float) position[0]) - rect.f242x});
                                        r8[4] = ObjectAnimator.ofFloat(cameraContainer, "translationY", new float[]{((float) position[1]) - rect.f243y});
                                        ...
                                        animatorSet.addListener(new AnimatorListenerAdapter() {
                                            ...
                                            class C06031 extends AnimatorListenerAdapter {
                                                C06031() {
                                                }
                                            ...
                                            public void onAnimationEnd(Animator animation) {
                                                ...
                                                animatorSet.setInterpolator(new DecelerateInterpolator());
                                                animatorSet.addListener(new C06031());
                                                animatorSet.start();
                                            }
                                        });
                                        animatorSet.start();
    ...
    class C13201 extends EmptyPhotoViewerProvider {
        C13201() {
        }
    ...
    class C13212 extends EmptyPhotoViewerProvider {
        C13212() {
        }
    ...
    public boolean onFragmentCreate() {
        ...
        if (this.currentChat != null) {
            ...
            MessagesController.getInstance(this.currentAccount).loadChatInfo(this.currentChat.f78id, countDownLatch2, true);
            ...
            MessagesController.getInstance(this.currentAccount).loadUserInfo(this.currentUser, null, true);
        }
        ...
        if (this.currentUser != null) {
            this.userBlocked = MessagesController.getInstance(this.currentAccount).blockedUsers.indexOfKey(this.currentUser.f176id) >= 0;
        }
    ...
    public void onFragmentDestroy() {
        ...
        if (this.currentUser != null) {
            MessagesController.getInstance(this.currentAccount).cancelLoadFullUser(this.currentUser.f176id);
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C13135());
        ...
        if (this.currentEncryptedChat == null && !this.isBroadcast) {
            this.searchItem = menu.addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C13146());
        ...
        if (this.currentUser != null) {
            ...
            TL_userFull userFull = MessagesController.getInstance(this.currentAccount).getUserFull(this.currentUser.f176id);
        ...
        if (this.currentEncryptedChat != null) {
            ...
            if (this.currentUser == null || this.currentUser.f176id == 777000 || this.currentUser.f176id == 429000 || this.currentUser.f176id == 4244000 || !MessagesController.isSupportId(this.currentUser.f176id)) {
        ...
        this.chatListView = new RecyclerListView(context) {
            ...
            private void drawReplyButton(Canvas canvas) {
                if (this.slidingView != null) {
                    ...
                    if (Theme.isCurrentThemeDefault() || Theme.hasThemeKey(Theme.key_chat_shareBackground)) {
            ...
            public boolean drawChild(Canvas canvas, View child, long drawingTime) {
                ...
                if (clipLeft != 0) {
                    canvas.save();
                    canvas.clipRect(((float) clipLeft) + child.getTranslationX(), ((float) child.getTop()) + child.getTranslationY(), ((float) child.getRight()) + child.getTranslationX(), ((float) child.getBottom()) + child.getTranslationY());
                ...
                if (num == count - 1) {
                    ...
                    if (size > 0) {
                        for (a = 0; a < size; a++) {
                            ...
                            canvas.save();
                            canvas.translate(((float) cell.getLeft()) + cell.getTranslationX(), ((float) cell.getTop()) + cell.getTranslationY());
                            cell.setTimeAlpha(cell.getAlpha());
                            cell.drawTimeLayout(canvas);
                            cell.setTimeAlpha(1.0f);
                            canvas.restore();
                        }
                    ...
                    if (size > 0) {
                        for (a = 0; a < size; a++) {
                            ...
                            canvas.save();
                            canvas.translate(((float) cell.getLeft()) + cell.getTranslationX(), ((float) cell.getTop()) + cell.getTranslationY());
                            cell.setNamesAlpha(cell.getAlpha());
                            cell.drawNamesLayout(canvas);
                            cell.setNamesAlpha(1.0f);
                            canvas.restore();
                        }
                ...
                if (child instanceof ChatMessageCell) {
                    ...
                    if (position != null) {
                        if (position.last || (position.minX == (byte) 0 && position.minY == (byte) 0)) {
                            if (num == count - 1) {
                                canvas.save();
                                canvas.translate(((float) chatMessageCell.getLeft()) + chatMessageCell.getTranslationX(), ((float) chatMessageCell.getTop()) + chatMessageCell.getTranslationY());
                                if (position.last) {
                                    chatMessageCell.setTimeAlpha(chatMessageCell.getAlpha());
                                    chatMessageCell.drawTimeLayout(canvas);
                                    chatMessageCell.setTimeAlpha(1.0f);
                                }
                                if (position.minX == (byte) 0 && position.minY == (byte) 0) {
                                    chatMessageCell.setNamesAlpha(chatMessageCell.getAlpha());
                                    chatMessageCell.drawNamesLayout(canvas);
                                    chatMessageCell.setNamesAlpha(1.0f);
                                }
                                canvas.restore();
                            } else {
                                if (position.last) {
                        ...
                        if (num == count - 1) {
                            ...
                            if (chatMessageCell.hasCaptionLayout() && (position.flags & 8) != 0) {
                                chatMessageCell.setCaptionAlpha(chatMessageCell.getAlpha());
                                chatMessageCell.drawCaptionLayout(canvas, (position.flags & 1) == 0);
                                chatMessageCell.setCaptionAlpha(1.0f);
                            }
                            canvas.restore();
                    ...
                    if (ChatActivity.this.roundVideoContainer != null && message.isRoundVideo() && MediaController.getInstance().isPlayingMessage(message)) {
                        ...
                        float newY = (((((float) ChatActivity.this.fragmentView.getPaddingTop()) + chatMessageCell.getY()) + ((float) imageReceiver.getImageY())) - ((float) (ChatActivity.this.chatActivityEnterView.isTopViewVisible() ? AndroidUtilities.m9dp(48.0f) : 0))) + ((float) (ChatActivity.this.inPreviewMode ? AndroidUtilities.statusBarHeight : 0));
                    ...
                    if (imageReceiver != null) {
                        ...
                        float ty = chatMessageCell.getTranslationY();
                        int y = (child.getTop() + chatMessageCell.getLayoutHeight()) + Math.round(ty);
        ...
        this.chatLayoutManager.setSpanSizeLookup(new C129910());
        this.chatListView.setLayoutManager(this.chatLayoutManager);
        this.chatListView.addItemDecoration(new C130011());
        ...
        this.chatListView.setOnScrollListener(new C130112());
        ...
        this.mentiondownButton.setOnClickListener(new C056914());
        ...
        if (!this.isBroadcast) {
                    ...
                    if (object instanceof BotInlineResult) {
                        ...
                        if (inlineResult.document != null) {
                            ...
                            if (inlineResult.document.thumb != null) {
                                f2 = (float) inlineResult.document.thumb.f108w;
                            } else {
                                f2 = 100.0f;
                            }
                            size.width = f2;
                            ...
                            if (inlineResult.document.thumb != null) {
                                f = (float) inlineResult.document.thumb.f107h;
                            }
                            size2.height = f;
                            ...
                            if (photoSize != null) {
                                this.size.width = (float) photoSize.f108w;
                                this.size.height = (float) photoSize.f107h;
                            }
                        }
                    }
                    return this.size;
            ...
            this.mentionGridLayoutManager.setSpanSizeLookup(new C130219());
            this.mentionListView.addItemDecoration(new C130320());
            ...
            chatActivityAdapter = new MentionsAdapter(context, false, this.dialog_id, new C130421());
            ...
            this.mentionListView.setOnScrollListener(new C130522());
        }
        ...
        this.chatActivityEnterView.setDelegate(new C130623());
        ...
        StickerPreviewViewerDelegate c130725 = new C130725();
        final StickerPreviewViewerDelegate stickerPreviewViewerDelegate = c130725;
        ...
        this.stickersListView.setOnTouchListener(new ChatActivity$$Lambda$20(this, c130725));
    ...
    final /* synthetic */ void lambda$null$11$ChatActivity(DialogInterface dialogInterface, int i) {
        if (this.currentUser != null) {
            MessagesController.getInstance(this.currentAccount).blockUser(this.currentUser.f176id);
        }
    ...
    final /* synthetic */ void lambda$createView$17$ChatActivity(View view, int position) {
        if (!this.mentionsAdapter.isBannedInline()) {
            ...
            if (object instanceof User) {
                ...
                spannableString.setSpan(new URLSpanUserMention(TtmlNode.ANONYMOUS_REGION_ID + user.f176id, 1), 0, spannableString.length(), 33);
    ...
    final /* synthetic */ void lambda$createView$34$ChatActivity(View view) {
        if (getParentActivity() != null) {
            ...
            if (this.currentUser == null || !this.userBlocked) {
                ...
                this.botUser = null;
                MessagesController.getInstance(this.currentAccount).unblockUser(this.currentUser.f176id);
    ...
    private TextureView createTextureView(boolean add) {
        ...
        if (this.roundVideoContainer == null) {
            if (VERSION.SDK_INT >= 21) {
                ...
                this.roundVideoContainer.setOutlineProvider(new C057931());
    ...
    public void processInlineBotContextPM(TL_inlineBotSwitchPM object) {
        if (object != null) {
            ...
            if (user != null) {
                this.chatActivityEnterView.setFieldText(TtmlNode.ANONYMOUS_REGION_ID);
                if (this.dialog_id == ((long) user.f176id)) {
    ...
    private void createChatAttachView() {
        if (getParentActivity() != null && this.chatAttachAlert == null) {
            ...
            this.chatAttachAlert.setDelegate(new C130834());
        }
    }
    ...
    public void shareMyContact(MessageObject messageObject) {
        ...
        if (this.currentUser == null) {
            ...
            builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureShareMyContactInfoUser", R.string.AreYouSureShareMyContactInfoUser, C0194PhoneFormat.getInstance().format("+" + UserConfig.getInstance(this.currentAccount).getCurrentUser().phone), ContactsController.formatName(this.currentUser.first_name, this.currentUser.last_name))));
        }
    ...
    private void hideVoiceHint() {
        ...
        animatorSet.playTogether(animatorArr);
        this.voiceHintAnimation.addListener(new C058336());
    ...
    private void showVoiceHint(boolean hide, boolean video) {
        if (getParentActivity() != null && this.fragmentView != null) {
            if (!hide || this.voiceHintTextView != null) {
                ...
                animatorSet.playTogether(animatorArr);
                this.voiceHintAnimation.addListener(new C058437());
                this.voiceHintAnimation.setDuration(300);
                this.voiceHintAnimation.start();
            }
        }
        ...
        if (getParentActivity() != null && this.currentChat != null && this.currentChat.banned_rights != null && this.fragmentView != null) {
            if (this.mediaBanTooltip == null || this.mediaBanTooltip.getVisibility() != 0) {
                ...
                if (index != -1) {
                    ...
                    AnimatorSet.addListener(new C058638());
                    AnimatorSet.setDuration(300);
                    AnimatorSet.start();
                }
            }
            ...
            if (getParentActivity() != null && this.fragmentView != null && this.gifHintTextView == null) {
                if (this.allowContextBotPanelSecond) {
                    ...
                    if (index != -1) {
                        ...
                        AnimatorSet.addListener(new C058839());
                        AnimatorSet.setDuration(300);
                        AnimatorSet.start();
                    }
    ...
    private void checkContextBotPanel() {
        ...
        if (this.allowContextBotPanel || this.allowContextBotPanelSecond) {
            if (this.mentionContainer.getVisibility() == 4 || this.mentionContainer.getTag() != null) {
                ...
                this.mentionListAnimation.addListener(new C059041());
            ...
            animatorSet.playTogether(animatorArr);
            this.mentionListAnimation.addListener(new C058940());
            this.mentionListAnimation.setDuration(200);
            this.mentionListAnimation.start();
        }
    }
        ...
        if (this.floatingDateView.getTag() != null && !this.currentFloatingDateOnScreen) {
            if (!this.scrollingFloatingDate || this.currentFloatingTopIsNotMessage) {
                ...
                if (animated) {
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.floatingDateAnimation.addListener(new C059142());
    ...
    private void processSelectedAttach(int which) {
        ...
        if (which == 0) {
            ...
            if (VERSION.SDK_INT < 23 || getParentActivity().checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0) {
                ...
                fragment.setDelegate(new C131043());
                presentFragment(fragment);
                return;
            }
            ...
            if (VERSION.SDK_INT < 23 || getParentActivity().checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0) {
                ...
                fragment3.setDelegate(new C131144());
    ...
    public void updateTextureViewPosition(boolean updateScroll) {
            ...
            for (int a = 0; a < count; a++) {
                ...
                if (view instanceof ChatMessageCell) {
                    ...
                    if (this.roundVideoContainer != null && messageObject.isRoundVideo() && MediaController.getInstance().isPlayingMessage(messageObject)) {
                        ...
                        this.roundVideoContainer.setTranslationY(((float) (this.inPreviewMode ? AndroidUtilities.statusBarHeight : 0)) + (((((float) this.fragmentView.getPaddingTop()) + messageCell.getY()) + ((float) imageReceiver.getImageY())) - ((float) additionalTop)));
                        this.fragmentView.invalidate();
                        this.roundVideoContainer.invalidate();
                        foundTextureViewMessage = true;
                        if (updateScroll && this.roundVideoContainer != null) {
        ...
        if (this.chatListView != null) {
            ...
            for (a = 0; a < count; a++) {
                ...
                if (view instanceof ChatMessageCell) {
                    int viewTop;
                    ChatMessageCell messageCell = (ChatMessageCell) view;
                    int top = messageCell.getTop() + Math.round(view.getTranslationY());
                    int bottom = messageCell.getBottom();
                    if (top >= 0) {
                        viewTop = 0;
                    } else {
        ...
        if (this.pagedownButton != null) {
            ...
            if (this.pagedownButton.getTag() != null) {
                ...
                if (animated) {
                    ...
                    this.pagedownButtonAnimation.setDuration(200);
                    this.pagedownButtonAnimation.addListener(new C059245());
                    this.pagedownButtonAnimation.start();
                    return;
                }
                this.pagedownButton.setVisibility(4);
            ...
            if (!show) {
                ...
                if (this.mentiondownButton.getTag() != null) {
                    ...
                    if (animated) {
                        ...
                        this.mentiondownButtonAnimation.addListener(new C059346());
    ...
    public void onRequestPermissionsResultFragment(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 17 && this.chatAttachAlert != null) {
            ...
            if (grantResults.length <= 0 || grantResults[0] != 0) {
                ...
                VoIPHelper.startCall(this.currentUser, getParentActivity(), MessagesController.getInstance(this.currentAccount).getUserFull(this.currentUser.f176id));
            }
        }
    }
    ...
    private void updateTitle() {
        if (this.avatarContainer != null) {
            if (this.currentChat != null) {
                ...
                } else if (MessagesController.isSupportId(this.currentUser.f176id) || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f176id)) != null || (ContactsController.getInstance(this.currentAccount).contactsDict.size() == 0 && ContactsController.getInstance(this.currentAccount).isLoadingContacts())) {
                    this.avatarContainer.setTitle(UserObject.getUserName(this.currentUser));
                } else if (TextUtils.isEmpty(this.currentUser.phone)) {
                    this.avatarContainer.setTitle(UserObject.getUserName(this.currentUser));
                } else {
                    this.avatarContainer.setTitle(C0194PhoneFormat.getInstance().format("+" + this.currentUser.phone));
                }
            }
        }
    }
    ...
    private void checkAndUpdateAvatar() {
        if (this.currentUser != null) {
            User user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.currentUser.f176id));
            if (user != null) {
        ...
        if (id == NotificationCenter.messagesDidLoad) {
                ...
                if (index != -1) {
                    ...
                    while (a < messArr.size()) {
                        ...
                        if (this.currentUser != null) {
                            ...
                            if ((this.currentUser.bot && obj.isOut()) || this.currentUser.f176id == currentUserId) {
                                obj.setIsRead();
                            }
                        }
            ...
            if (!((updateMask & 1) == 0 && (updateMask & 16) == 0)) {
                if (this.currentChat != null) {
                    ...
                    user = MessagesController.getInstance(this.currentAccount).getUser(Integer.valueOf(this.currentUser.f176id));
                    if (user != null) {
                        this.currentUser = user;
                    }
                }
            ...
            if (((Long) args[0]).longValue() == this.dialog_id) {
                ...
                if (this.forwardEndReached[0]) {
                    ...
                    for (a = 0; a < arr.size(); a++) {
                        ...
                        if (this.currentUser != null && ((this.currentUser.bot && obj.isOut()) || this.currentUser.f176id == currentUserId)) {
                            obj.setIsRead();
                        }
                        ...
                        if (obj.type >= 0 && this.messagesDict[0].indexOfKey(obj.getId()) < 0) {
                            ...
                            if (this.chatAdapter != null) {
                                this.chatAdapter.notifyItemInserted(placeToPaste);
                                ViewHolder prevHolder = this.chatListView.findViewHolderForAdapterPosition(placeToPaste + 1);
                                if (prevHolder != null && (prevHolder.itemView instanceof ChatMessageCell) && ((ChatMessageCell) prevHolder.itemView).getCurrentMessagesGroup() == null) {
                                    this.chatAdapter.onBindViewHolder(prevHolder, prevHolder.getAdapterPosition());
                                }
                            }
                    ...
                    if (newGroups != null) {
                        for (a = 0; a < newGroups.size(); a++) {
                            ...
                            FileLog.m10d("ChatActivity group count " + oldCount + " -> " + newCount);
                ...
                while (b < this.messages.size()) {
                    ...
                    if (mid2 > 0 && mid2 <= max_id) {
                        if (this.chatInfo != null && this.chatInfo.pinned_msg_id == mid2) {
                            ...
                            MessagesStorage.getInstance(this.currentAccount).updateChatPinnedMessage(this.chatInfo.f79id, 0);
                            updatePinnedMessageView(true);
                        } else if (this.userInfo != null && this.userInfo.pinned_msg_id == mid2) {
                            this.pinnedMessageObject = null;
                            this.userInfo.pinned_msg_id = 0;
                            MessagesStorage.getInstance(this.currentAccount).updateUserPinnedMessage(this.chatInfo.f79id, 0);
                            updatePinnedMessageView(true);
                        }
            ...
            if (this.foundWebPage != null) {
                ...
                for (a = 0; a < hashMap.size(); a++) {
                    ...
                    if (webPage.f182id == this.foundWebPage.f182id) {
            ...
            Integer uid = args[0];
            if (this.currentUser != null && this.currentUser.f176id == uid.intValue()) {
    ...
    private void updateBottomOverlay() {
        if (this.bottomOverlayChatText != null) {
            ...
            } else if (MessagesController.getInstance(this.currentAccount).isJoiningChannel(this.currentChat.f78id)) {
    ...
    public void showAlert(String name, String message) {
        if (this.alertView != null && name != null && message != null) {
            if (this.alertView.getTag() != null) {
                ...
                this.alertViewAnimator.addListener(new C059549());
            ...
            Runnable c059750 = new C059750();
            this.hideAlertViewRunnable = c059750;
            AndroidUtilities.runOnUIThread(c059750, 3000);
        }
    }
    ...
    private void hidePinnedMessageView(boolean animated) {
        if (this.pinnedMessageView.getTag() == null) {
            ...
            if (animated) {
                ...
                this.pinnedMessageViewAnimator.addListener(new C059851());
            ...
            if ((this.chatInfo == null && this.userInfo == null) || pinned_msg_id == 0 || pinned_msg_id == preferences.getInt("pin_" + this.dialog_id, 0) || (this.actionBar != null && (this.actionBar.isActionModeShowed() || this.actionBar.isSearchFieldVisible()))) {
                ...
                if (this.pinnedMessageView.getTag() != null) {
                    ...
                    if (animated) {
                        ...
                        animatorSet.playTogether(animatorArr);
                        this.pinnedMessageViewAnimator.setDuration(200);
                        this.pinnedMessageViewAnimator.addListener(new C059952());
                        this.pinnedMessageViewAnimator.start();
                    } else {
                ...
                if (this.loadingPinnedMessage != pinned_msg_id) {
                    ...
                    DataQuery.getInstance(this.currentAccount).loadPinnedMessage(this.dialog_id, ChatObject.isChannel(this.currentChat) ? this.currentChat.f78id : 0, pinned_msg_id, true);
                }
            }
    ...
    private void updateSpamView() {
        if (this.reportSpamView != null) {
            ...
            SharedPreferences preferences = MessagesController.getNotificationsSettings(this.currentAccount);
            if (this.currentEncryptedChat != null) {
                if (this.currentEncryptedChat.admin_id == UserConfig.getInstance(this.currentAccount).getClientUserId() || ContactsController.getInstance(this.currentAccount).isLoadingContacts() || ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f176id)) != null) {
                    show = false;
                } else {
                    show = true;
                }
            ...
            if (show) {
                if (this.reportSpamView.getTag() != null) {
                    ...
                    this.reportSpamViewAnimator.addListener(new C060154());
                ...
                animatorSet.playTogether(animatorArr);
                this.reportSpamViewAnimator.setDuration(200);
                this.reportSpamViewAnimator.addListener(new C060053());
                this.reportSpamViewAnimator.start();
            }
            checkListViewPaddings();
    ...
    private void updateContactStatus() {
        if (this.addContactItem != null) {
            if (this.currentUser == null) {
                ...
                if ((this.currentEncryptedChat != null && !(this.currentEncryptedChat instanceof TL_encryptedChat)) || MessagesController.isSupportId(this.currentUser.f176id) || UserObject.isDeleted(this.currentUser) || ContactsController.getInstance(this.currentAccount).isLoadingContacts() || (!TextUtils.isEmpty(this.currentUser.phone) && ContactsController.getInstance(this.currentAccount).contactsDict.get(Integer.valueOf(this.currentUser.f176id)) != null && (ContactsController.getInstance(this.currentAccount).contactsDict.size() != 0 || !ContactsController.getInstance(this.currentAccount).isLoadingContacts()))) {
                    this.addContactItem.setVisibility(8);
                } else {
    ...
    private boolean fixLayoutInternal() {
        ...
        if (AndroidUtilities.isSmallTablet() && ApplicationLoader.applicationContext.getResources().getConfiguration().orientation == 1) {
            ...
            c0403ActionBar.setBackButtonDrawable(new BackDrawable(z));
            if (!(this.fragmentContextView == null || this.fragmentContextView.getParent() == null)) {
    ...
    private void fixLayout() {
        if (this.avatarContainer != null) {
            this.avatarContainer.getViewTreeObserver().addOnPreDrawListener(new C060255());
        }
    }
    ...
    private void createDeleteMessagesAlert(MessageObject finalSelectedObject, GroupedMessages finalSelectedGroup, int loadParticipant) {
        if (getParentActivity() != null) {
            ...
            if (this.currentChat != null && this.currentChat.megagroup) {
                ...
                if (user == null || user.f176id == UserConfig.getInstance(this.currentAccount).getClientUserId() || loadParticipant == 2) {
                    if (hasOutgoing) {
                ...
                hasOutgoing = false;
                currentDate = ConnectionsManager.getInstance(this.currentAccount).getCurrentTime();
                if ((this.currentUser != null && this.currentUser.f176id != UserConfig.getInstance(this.currentAccount).getClientUserId() && !this.currentUser.bot) || this.currentChat != null) {
                    if (finalSelectedObject == null) {
                        exit = false;
                        for (a = 1; a >= 0; a--) {
                            for (b = 0; b < this.selectedMessagesIds[a].size(); b++) {
    ...
    final /* synthetic */ void lambda$createDeleteMessagesAlert$66$ChatActivity(MessageObject finalSelectedObject, GroupedMessages finalSelectedGroup, boolean[] deleteForAll, User userFinal, boolean[] checks, DialogInterface dialogInterface, int i) {
        ...
        if (userFinal != null) {
            if (checks[0]) {
                MessagesController.getInstance(this.currentAccount).deleteUserFromChat(this.currentChat.f78id, userFinal, this.chatInfo);
            }
            if (checks[1]) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:374:? A:{SYNTHETIC, RETURN} */
                    ...
                    if (!(!message.canEditMessage(this.currentChat) || this.chatActivityEnterView.hasAudioToSend() || message.getDialogId() == this.mergeDialogId)) {
                        ...
                        if (single && type >= 2 && type != 20 && !message.needDrawBluredPreview() && !message.isLiveLocation()) {
                            ...
                            for (a = 0; a < this.actionModeViews.size(); a++) {
                                ...
                                view.setPivotY((float) (C0403ActionBar.getCurrentActionBarHeight() / 2));
    ...
    private void startEditingMessageObject(MessageObject messageObject) {
        if (messageObject != null && getParentActivity() != null) {
            ...
            req.f148id = messageObject.getId();
        ...
        if (this.selectedObject != null && getParentActivity() != null) {
            ...
            switch (option) {
                ...
                case 22:
                    ...
                    req.f115id = this.selectedObject.getId();
                    req.channel = MessagesController.getInputChannel(this.currentChat);
