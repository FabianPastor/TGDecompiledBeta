...
import org.telegram.p005ui.Components.SizeNotifierFrameLayout.SizeNotifierFrameLayoutDelegate;
...
public class EditTextEmoji extends FrameLayout implements NotificationCenterDelegate, SizeNotifierFrameLayoutDelegate {
    ...
    class CLASSNAME implements Listener {
        ...
        public void onEmojiSelected(String symbol) {
            ...
            try {
                ...
                CharSequence localCharSequence = Emoji.replaceEmoji(symbol, EditTextEmoji.this.editText.getPaint().getFontMetricsInt(), AndroidUtilities.m9dp(20.0f), false);
        ...
        public void onClearEmojiRecent() {
            if (EditTextEmoji.this.parentFragment != null && EditTextEmoji.this.parentActivity != null) {
                ...
                builder.setMessage(LocaleController.getString("ClearRecentEmoji", CLASSNAMER.string.ClearRecentEmoji));
                builder.setPositiveButton(LocaleController.getString("ClearButton", CLASSNAMER.string.ClearButton).toUpperCase(), new EditTextEmoji$3$$Lambda$0(this));
    ...
    public EditTextEmoji(Activity context, SizeNotifierFrameLayout parent, BaseFragment fragment) {
        ...
        this.editText.setCursorSize(AndroidUtilities.m9dp(20.0f));
        ...
        this.emojiButton.setImageResource(CLASSNAMER.drawable.ic_msg_panel_smiles);
        this.emojiButton.setPadding(0, 0, 0, AndroidUtilities.m9dp(7.0f));
        ...
        if (show == 1) {
            ...
            if (this.keyboardHeight <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.keyboardHeight = AndroidUtilities.m9dp(150.0f);
                } else {
            ...
            if (this.keyboardHeightLand <= 0) {
                if (AndroidUtilities.isTablet()) {
                    this.keyboardHeightLand = AndroidUtilities.m9dp(150.0f);
                } else {
            ...
            if (this.sizeNotifierLayout != null) {
                ...
                this.emojiButton.setImageResource(CLASSNAMER.drawable.ic_msg_panel_kb);
                onWindowSizeChanged();
                return;
            }
            return;
    ...
    public void onSizeChanged(int height, boolean isWidthGreater) {
        if (height > AndroidUtilities.m9dp(50.0f) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow && !AndroidUtilities.isTablet()) {
            if (isWidthGreater) {
