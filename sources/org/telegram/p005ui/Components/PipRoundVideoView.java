...
public class PipRoundVideoView implements NotificationCenterDelegate {
    ...
    class C12463 extends ViewOutlineProvider {
        C12463() {
        }
    ...
    class C12475 extends AnimatorListenerAdapter {
        C12475() {
        }
    ...
    class C12497 extends AnimatorListenerAdapter {
        C12497() {
        }
    ...
    public void show(Activity activity, Runnable closeRunnable) {
        if (activity != null) {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.aspectRatioFrameLayout.setOutlineProvider(new C12463());
            ...
            try {
                ...
                this.windowLayoutParams.x = PipRoundVideoView.getSideCoord(true, sidex, px, this.videoWidth);
                this.windowLayoutParams.y = PipRoundVideoView.getSideCoord(false, sidey, py, this.videoHeight);
    ...
    public void showTemporary(boolean show) {
        ...
        this.hideShowAnimation.addListener(new C12475());
    ...
    private void animateToBoundsMaybe() {
        int startX = PipRoundVideoView.getSideCoord(true, 0, 0.0f, this.videoWidth);
        int endX = PipRoundVideoView.getSideCoord(true, 1, 0.0f, this.videoWidth);
        int startY = PipRoundVideoView.getSideCoord(false, 0, 0.0f, this.videoHeight);
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C12497());
            }
