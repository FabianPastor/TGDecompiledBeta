...
public class TermsOfServiceView extends FrameLayout {
    ...
    class C13141 implements OnClickListener {
        ...
        class C13131 implements DialogInterface.OnClickListener {

            /* renamed from: org.telegram.ui.Components.TermsOfServiceView$1$1$1 */
            class C13111 implements DialogInterface.OnClickListener {
                C13111() {
                }
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setTitle(LocaleController.getString("AppName", R.string.AppName));
                builder.setPositiveButton(LocaleController.getString("Deactivate", R.string.Deactivate), new C13111());
        ...
        public void onClick(View view) {
            ...
            builder.setPositiveButton(LocaleController.getString("DeclineDeactivate", R.string.DeclineDeactivate), new C13131());
    ...
    class C13162 implements OnClickListener {
        ...
        class C13151 implements DialogInterface.OnClickListener {
            C13151() {
            }
        ...
        public void onClick(View view) {
            if (TermsOfServiceView.this.currentTos.min_age_confirm != 0) {
                ...
                builder.setPositiveButton(LocaleController.getString("Agree", R.string.Agree), new C13151());
                builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    class C13173 implements RequestDelegate {
        C13173() {
        }
    ...
    public TermsOfServiceView(Context context) {
        ...
        declineTextView.setOnClickListener(new C13141());
        ...
        acceptTextView.setOnClickListener(new C13162());
    }

    private void accept() {
        this.delegate.onAcceptTerms(this.currentAccount);
        TL_help_acceptTermsOfService req = new TL_help_acceptTermsOfService();
        req.f134id = this.currentTos.f135id;
        ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C13173());
    }
