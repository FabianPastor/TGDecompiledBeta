...
import org.telegram.p005ui.Cells.JoinSheetUserCell;
...
public class JoinGroupAlert extends BottomSheet {
    ...
    class C11432 implements OnClickListener {
        C11432() {
        }
    ...
    public JoinGroupAlert(Context context, ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C11411());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C11432());
    }
}
