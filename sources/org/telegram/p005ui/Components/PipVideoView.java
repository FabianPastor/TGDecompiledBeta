...
/* renamed from: org.telegram.ui.Components.PipVideoView */
public class PipVideoView {
    ...
    class C15092 extends AnimatorListenerAdapter {
        C15092() {
        }
    ...
    /* renamed from: org.telegram.ui.Components.PipVideoView$MiniControlsView */
    private class MiniControlsView extends FrameLayout {
        private float bufferedPosition;
        private AnimatorSet currentAnimation;
        private Runnable hideRunnable = new C15101();
        ...
        private Runnable progressRunnable = new C15112();
        ...
        class C15112 implements Runnable {
            C15112() {
            }
        ...
        class C15156 extends AnimatorListenerAdapter {
            C15156() {
            }
        ...
        class C15167 extends AnimatorListenerAdapter {
            C15167() {
            }
        ...
        public MiniControlsView(Context context, boolean fullControls) {
            ...
            this.inlineButton.setImageResource(C0541R.drawable.ic_outinline);
        ...
        private void updatePlayButton() {
            if (PipVideoView.this.photoViewer != null) {
                ...
                if (videoPlayer != null) {
                    ...
                    if (videoPlayer.isPlaying()) {
                        this.playButton.setImageResource(C0541R.drawable.ic_pauseinline);
                        AndroidUtilities.runOnUIThread(this.progressRunnable, 500);
                    } else if (this.isCompleted) {
                        this.playButton.setImageResource(C0541R.drawable.ic_againinline);
                    } else {
                        this.playButton.setImageResource(C0541R.drawable.ic_playinline);
                    }
                }
            }
        }
            ...
            if (this.isVisible != value) {
                ...
                if (this.isVisible) {
                    if (animated) {
                        ...
                        this.currentAnimation.addListener(new C15156());
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.addListener(new C15167());
                    this.currentAnimation.start();
                } else {
                    setAlpha(0.0f);
                }
    ...
    public TextureView show(Activity activity, PhotoViewer viewer, EmbedBottomSheet sheet, View controls, float aspectRatio, int rotation, WebView webview) {
        ...
        try {
            ...
            this.windowLayoutParams.x = PipVideoView.getSideCoord(true, sidex, px, this.videoWidth);
            this.windowLayoutParams.y = PipVideoView.getSideCoord(false, sidey, py, this.videoHeight);
    ...
    private void animateToBoundsMaybe() {
        int startX = PipVideoView.getSideCoord(true, 0, 0.0f, this.videoWidth);
        int endX = PipVideoView.getSideCoord(true, 1, 0.0f, this.videoWidth);
        int startY = PipVideoView.getSideCoord(false, 0, 0.0f, this.videoHeight);
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C15092());
            }
