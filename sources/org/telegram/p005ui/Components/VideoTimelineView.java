...
public class VideoTimelineView extends View {
    ...
    class C16151 extends AsyncTask<Integer, Integer, Bitmap> {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int endX = ((int) (((float) width) * this.progressRight)) + AndroidUtilities.m10dp(16.0f);
        canvas.save();
        canvas.clipRect(AndroidUtilities.m10dp(16.0f), 0, AndroidUtilities.m10dp(20.0f) + width, getMeasuredHeight());
        if (this.frames.isEmpty() && this.currentTask == null) {
            ...
            for (int a = 0; a < this.frames.size(); a++) {
                ...
                if (bitmap != null) {
                    ...
                    int y = AndroidUtilities.m10dp(2.0f);
                    if (this.isRoundFrames) {
        ...
        int top = AndroidUtilities.m10dp(2.0f);
        canvas.drawRect((float) AndroidUtilities.m10dp(16.0f), (float) top, (float) startX, (float) (getMeasuredHeight() - top), this.paint2);
        canvas.drawRect((float) (AndroidUtilities.m10dp(4.0f) + endX), (float) top, (float) ((AndroidUtilities.m10dp(16.0f) + width) + AndroidUtilities.m10dp(4.0f)), (float) (getMeasuredHeight() - top), this.paint2);
        canvas.drawRect((float) startX, 0.0f, (float) (AndroidUtilities.m10dp(2.0f) + startX), (float) getMeasuredHeight(), this.paint);
        canvas.drawRect((float) (AndroidUtilities.m10dp(2.0f) + endX), 0.0f, (float) (AndroidUtilities.m10dp(4.0f) + endX), (float) getMeasuredHeight(), this.paint);
        canvas.drawRect((float) (AndroidUtilities.m10dp(2.0f) + startX), 0.0f, (float) (AndroidUtilities.m10dp(4.0f) + endX), (float) top, this.paint);
        canvas.drawRect((float) (AndroidUtilities.m10dp(2.0f) + startX), (float) (getMeasuredHeight() - top), (float) (AndroidUtilities.m10dp(4.0f) + endX), (float) getMeasuredHeight(), this.paint);
        canvas.restore();
        canvas.drawCircle((float) startX, (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.m10dp(7.0f), this.paint);
        canvas.drawCircle((float) (AndroidUtilities.m10dp(4.0f) + endX), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.m10dp(7.0f), this.paint);
    }
}
