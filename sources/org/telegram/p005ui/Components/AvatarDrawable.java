...
public class AvatarDrawable extends Drawable {
    ...
    public AvatarDrawable(User user, boolean profile) {
        ...
        if (user != null) {
            setInfo(user.f228id, user.first_name, user.last_name, false, null);
        }
    }
    ...
    public AvatarDrawable(Chat chat, boolean profile) {
        ...
        this.isProfile = profile;
        if (chat != null) {
            setInfo(chat.f113id, chat.title, null, chat.f113id < 0, null);
        }
    }
    ...
    public static int getNameColorForId(int id) {
        return Theme.getColor(Theme.keys_avatar_nameInMessage[AvatarDrawable.getColorIndex(id)]);
    }
    ...
    public void setInfo(int id, String firstName, String lastName, boolean isBroadcast, String custom) {
        if (this.isProfile) {
            this.color = AvatarDrawable.getProfileColorForId(id);
        } else {
            this.color = AvatarDrawable.getColorForId(id);
        }
