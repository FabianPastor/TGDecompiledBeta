...
public class AnimatedFileDrawable extends BitmapDrawable implements Animatable {
    ...
    private Runnable loadFrameRunnable = new C06123();
    ...
    private Runnable uiRunnable = new C06112();
    private Runnable uiRunnableNoFrame = new C06101();
    ...
    public AnimatedFileDrawable(File file, boolean createDecoder) {
        this.path = file;
        if (createDecoder) {
            this.nativePtr = AnimatedFileDrawable.createDecoder(file.getAbsolutePath(), this.metaData);
