...
public class InstantCameraView extends FrameLayout implements NotificationCenterDelegate {
    ...
    class C112311 extends TimerTask {
        ...
        public void run() {
            AndroidUtilities.runOnUIThread(new C11221());
        }
    }
    ...
    class C11262 implements OnTouchListener {

        /* renamed from: org.telegram.ui.Components.InstantCameraView$2$1 */
        class C11251 extends AnimatorListenerAdapter {
            C11251() {
            }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == 0 && InstantCameraView.this.baseFragment != null) {
                if (InstantCameraView.this.videoPlayer != null) {
                    ...
                    InstantCameraView.this.muteAnimation.addListener(new C11251());
    ...
    class C11295 extends ViewOutlineProvider {
        C11295() {
        }
    ...
    class C11327 implements OnClickListener {
        ...
        class C11311 extends AnimatorListenerAdapter {
            C11311() {
            }
        ...
        public void onClick(View v) {
            if (InstantCameraView.this.cameraReady && InstantCameraView.this.cameraSession != null && InstantCameraView.this.cameraSession.isInitied() && InstantCameraView.this.cameraThread != null) {
                ...
                animator.addListener(new C11311());
                animator.start();
            }
        }
    }
    ...
    class C11338 implements SurfaceTextureListener {
        C11338() {
        }
    ...
    class C11349 extends AnimatorListenerAdapter {
        C11349() {
        }
    ...
    private class AudioBufferInfo {
        ...
        /* synthetic */ AudioBufferInfo(InstantCameraView x0, C11241 x1) {
            this();
        }
    }
     ...
     */
        ...
        private VideoRecorder() {
            ...
            this.recorderRunnable = new C11371();
        }

        /* synthetic */ VideoRecorder(InstantCameraView x0, C11241 x1) {
            this();
        }
     ...
     */
        ...
        private void handleStopRecording(final int send) {
            ...
            if (send != 0) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    class C11391 implements VideoPlayerDelegate {
                        C11391() {
                        }
                    ...
                    public void run() {
                        ...
                        InstantCameraView.this.videoEditedInfo.f60iv = InstantCameraView.this.f254iv;
                        ...
                        if (send == 1) {
                            ...
                            InstantCameraView.this.videoPlayer.setDelegate(new C11391());
        ...
        private void prepareEncoder() {
            try {
                ...
                AndroidUtilities.runOnUIThread(new C11403());
                if (this.eglDisplay != EGL14.EGL_NO_DISPLAY) {
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        class C11351 implements OnFrameAvailableListener {
            C11351() {
            }
        ...
        class C11362 implements OnFrameAvailableListener {
            C11362() {
            }
                ...
                if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, configs, 1, configsCount)) {
                    ...
                    if (this.eglContext == null) {
                        ...
                        if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                            ...
                            this.cameraSurface.setOnFrameAvailableListener(new C11351());
            ...
            switch (inputMessage.what) {
                ...
                case 2:
                    if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                        ...
                        GLES20.glTexParameteri(36197, 10243, 33071);
                        this.cameraSurface = new SurfaceTexture(InstantCameraView.this.cameraTexture[0]);
                        this.cameraSurface.setOnFrameAvailableListener(new C11362());
                        InstantCameraView.this.createCamera(this.cameraSurface);
                        return;
                    } else if (BuildVars.LOGS_ENABLED) {
    ...
    public InstantCameraView(Context context, ChatActivity parentFragment) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.cameraContainer.setOutlineProvider(new C11295());
        ...
        this.switchCameraButton.setOnClickListener(new C11327());
    ...
    public void showCamera() {
        if (this.textureView == null) {
            ...
            if (initCamera()) {
                ...
                this.textureView.setSurfaceTextureListener(new C11338());
    ...
    public void startAnimation(boolean open) {
        ...
        if (!open) {
            this.animatorSet.addListener(new C11349());
        }
    ...
    public void send(int state) {
        if (this.textureView != null) {
            ...
            if (state == 4) {
                ...
                this.videoEditedInfo.f60iv = this.f254iv;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public void run() {
                if (InstantCameraView.this.cameraThread != null) {
                    ...
                    InstantCameraView.this.cameraThread.setCurrentSession(InstantCameraView.this.cameraSession);
                    CameraController.getInstance().openRound(InstantCameraView.this.cameraSession, surfaceTexture, new C11191(), new C11202());
                }
            }
        });
    }
    ...
    private void startProgressTimer() {
        ...
        this.progressTimer.schedule(new C112311(), 0, 17);
    }
