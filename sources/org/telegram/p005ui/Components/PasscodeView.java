...
public class PasscodeView extends FrameLayout {
    ...
    private Runnable checkRunnable = new C11869();
    ...
    class C117510 implements Runnable {
        C117510() {
        }
    ...
    class C117611 implements OnDismissListener {
        C117611() {
        }
    ...
    class C117713 implements OnTouchListener {
        C117713() {
        }
    ...
    class C11781 implements OnEditorActionListener {
        C11781() {
        }
    ...
    class C11792 implements TextWatcher {
        C11792() {
        }
    ...
    class C11803 implements Callback {
        C11803() {
        }
    ...
    class C11814 implements OnClickListener {
        C11814() {
        }
    ...
    class C11825 implements OnLongClickListener {
        C11825() {
        }
    ...
    class C11847 extends AnimatorListenerAdapter {
        C11847() {
        }
    ...
    class C11869 implements Runnable {
        C11869() {
        }
    ...
    private class AnimatingTextView extends FrameLayout {
        ...
        class C11892 extends AnimatorListenerAdapter {
            C11892() {
            }
        ...
        class C11903 extends AnimatorListenerAdapter {
            C11903() {
            }
        ...
        class C11914 extends AnimatorListenerAdapter {
            C11914() {
            }
        ...
        public void appendCharacter(String c) {
            if (this.stringBuilder.length() != 4) {
                ...
                this.dotRunnable = new Runnable() {
                    ...
                    class C11871 extends AnimatorListenerAdapter {
                        C11871() {
                        }
                    ...
                    public void run() {
                        if (AnimatingTextView.this.dotRunnable == this) {
                            ...
                            AnimatingTextView.this.currentAnimation.addListener(new C11871());
                ...
                this.currentAnimation.addListener(new C11892());
        ...
        public void eraseLastCharacter() {
            if (this.stringBuilder.length() != 0) {
                ...
                this.currentAnimation.setDuration(150);
                this.currentAnimation.playTogether(animators);
                this.currentAnimation.addListener(new C11903());
                this.currentAnimation.start();
            }
        }
        ...
        private void eraseAllCharacters(boolean animated) {
            if (this.stringBuilder.length() != 0) {
                ...
                if (animated) {
                    ...
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.playTogether(animators);
                    this.currentAnimation.addListener(new C11914());
                    this.currentAnimation.start();
                    return;
                }
                for (a = 0; a < 4; a++) {
    ...
    class C119212 extends AuthenticationCallback {
        C119212() {
        }
    ...
    public PasscodeView(Context context) {
        ...
        this.passwordEditText.setOnEditorActionListener(new C11781());
        this.passwordEditText.addTextChangedListener(new C11792());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C11803());
        ...
        this.checkImage.setOnClickListener(new C11814());
        ...
        for (a = 0; a < 11; a++) {
            ...
            if (a == 10) {
                frameLayout.setOnLongClickListener(new C11825());
            }
            frameLayout.setOnClickListener(new C11836());
    ...
    private void processDone(boolean fingerprint) {
        ...
        AnimatorSet.addListener(new C11847());
        AnimatorSet.start();
    ...
    public void onResume() {
        ...
        if (this.retryTextView.getVisibility() != 0) {
            if (SharedConfig.passcodeType == 1) {
                ...
                AndroidUtilities.runOnUIThread(new C117510(), 200);
            }
            checkFingerprint();
        }
    }
        ...
        if (VERSION.SDK_INT >= 23 && parentActivity != null && SharedConfig.useFingerprint && !ApplicationLoader.mainInterfacePaused) {
            ...
            try {
                ...
                if (fingerprintManager.isHardwareDetected() && fingerprintManager.hasEnrolledFingerprints()) {
                    ...
                    builder.setOnDismissListener(new C117611());
                    if (this.fingerprintDialog != null) {
                        if (this.fingerprintDialog.isShowing()) {
                            this.fingerprintDialog.dismiss();
                        }
                    ...
                    fingerprintManager.authenticate(null, 0, this.cancellationSignal, new C119212(), null);
                }
            } catch (Throwable e2) {
                FileLog.m14e(e2);
            } catch (Throwable th) {
    ...
    public void onShow() {
        ...
        if (getVisibility() != 0) {
            ...
            setOnTouchListener(new C117713());
        }
    }
