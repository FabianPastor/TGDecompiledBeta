...
public class ContextProgressView extends View {
    ...
    public ContextProgressView(Context context, int colorType) {
        ...
        this.innerPaint.setStrokeWidth((float) AndroidUtilities.m10dp(2.0f));
    ...
    protected void onDraw(Canvas canvas) {
        if (getVisibility() == 0) {
            ...
            int x = (getMeasuredWidth() / 2) - AndroidUtilities.m10dp(9.0f);
            int y = (getMeasuredHeight() / 2) - AndroidUtilities.m10dp(9.0f);
            this.cicleRect.set((float) x, (float) y, (float) (AndroidUtilities.m10dp(18.0f) + x), (float) (AndroidUtilities.m10dp(18.0f) + y));
            canvas.drawCircle((float) (getMeasuredWidth() / 2), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.m10dp(9.0f), this.innerPaint);
