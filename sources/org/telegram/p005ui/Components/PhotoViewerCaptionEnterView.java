...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenterDelegate, SizeNotifierFrameLayoutPhotoDelegate {
    ...
    class C123710 implements Runnable {
        C123710() {
        }
    ...
    class C12393 implements ActionMode.Callback {
        C12393() {
        }
    ...
    class C12404 implements ActionMode.Callback {
        C12404() {
        }
    ...
    class C12415 implements OnKeyListener {
        C12415() {
        }
    ...
    class C12426 implements OnClickListener {
        C12426() {
        }
    ...
    class C12437 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (!PhotoViewerCaptionEnterView.this.innerTextChange && this.processChange) {
                ...
                Emoji.replaceEmoji(editable, PhotoViewerCaptionEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m10dp(20.0f), false);
    ...
    class C12448 implements OnClickListener {
        C12448() {
        }
    ...
    class C20529 implements Listener {
        C20529() {
        }
        ...
        public void onEmojiSelected(String symbol) {
            if (PhotoViewerCaptionEnterView.this.messageEditText.length() + symbol.length() <= PhotoViewerCaptionEnterView.this.captionMaxLength) {
                ...
                try {
                    ...
                    CharSequence localCharSequence = Emoji.replaceEmoji(symbol, PhotoViewerCaptionEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.m10dp(20.0f), false);
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, View window) {
        ...
        this.emojiButton.setOnClickListener(new C12381());
        ...
        if (VERSION.SDK_INT >= 23 && this.windowView != null) {
            this.messageEditText.setCustomSelectionActionModeCallback(new C12393());
            this.messageEditText.setCustomInsertionActionModeCallback(new C12404());
        }
        this.messageEditText.setHint(LocaleController.getString("AddCaption", R.string.AddCaption));
        this.messageEditText.setImeOptions(C0016C.ENCODING_PCM_MU_LAW);
        ...
        this.messageEditText.setCursorSize(AndroidUtilities.m10dp(20.0f));
        ...
        this.messageEditText.setOnKeyListener(new C12415());
        this.messageEditText.setOnClickListener(new C12426());
        this.messageEditText.addTextChangedListener(new C12437());
        ...
        doneButton.setOnClickListener(new C12448());
    }
    ...
    private void createEmojiView() {
        if (this.emojiView == null) {
            ...
            this.emojiView.setListener(new C20529());
        ...
        if (this.messageEditText != null) {
            if (focus) {
                if (!this.messageEditText.isFocused()) {
                    this.messageEditText.postDelayed(new C123710(), 600);
                }
    ...
    public void onSizeChanged(int height, boolean isWidthGreater) {
        if (height > AndroidUtilities.m10dp(50.0f) && this.keyboardVisible && !AndroidUtilities.isInMultiwindow && !this.forceFloatingEmoji) {
            if (isWidthGreater) {
