...
public class GroupCreateSpan extends View {
    ...
    public GroupCreateSpan(Context context, User user, Contact contact) {
        ...
        this.deleteDrawable = getResources().getDrawable(C0541R.drawable.delete);
        ...
        this.nameLayout = new StaticLayout(TextUtils.ellipsize(firstName.replace(10, ' '), textPaint, (float) maxNameWidth, TruncateAt.END), textPaint, 1000, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
