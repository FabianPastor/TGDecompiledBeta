    ...
    public void addRect(float left, float top, float right, float bottom, Direction dir) {
        ...
        if (left > lineLeft || right > lineLeft) {
            ...
            if (this.useRoundRect) {
                ...
                this.rect.set(left - ((float) AndroidUtilities.m9dp(4.0f)), y, ((float) AndroidUtilities.m9dp(4.0f)) + right, y2);
                super.addRoundRect(this.rect, (float) AndroidUtilities.m9dp(4.0f), (float) AndroidUtilities.m9dp(4.0f), dir);
                return;
            }
