...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C19943 extends OnScrollListener {
        C19943() {
        }
    ...
    class C19954 implements OnItemClickListener {
        C19954() {
        }
            ...
            if (view instanceof CheckBoxCell) {
                ...
                if (AdminLogFilterAlert.this.selectedAdmins == null) {
                    ...
                    for (a = 0; a < AdminLogFilterAlert.this.currentAdmins.size(); a++) {
                        ...
                        AdminLogFilterAlert.this.selectedAdmins.put(user.f177id, user);
                    }
                }
                isChecked = checkBoxUserCell.isChecked();
                user = checkBoxUserCell.getCurrentUser();
                if (isChecked) {
                    AdminLogFilterAlert.this.selectedAdmins.remove(user.f177id);
                } else {
                    AdminLogFilterAlert.this.selectedAdmins.put(user.f177id, user);
                }
    ...
    public AdminLogFilterAlert(Context context, TL_channelAdminLogEventsFilter filter, SparseArray<User> admins, boolean megagroup) {
        ...
        this.listView.setOnScrollListener(new C19943());
        this.listView.setOnItemClickListener(new C19954());
        ...
        this.saveButton.setOnClickListener(new C09845());
