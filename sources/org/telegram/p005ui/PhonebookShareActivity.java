...
public class PhonebookShareActivity extends BaseFragment {
    ...
    class C15497 implements OnClickListener {

        /* renamed from: org.telegram.ui.PhonebookShareActivity$7$1 */
        class C15481 implements DialogInterface.OnClickListener {
            C15481() {
            }
        ...
        public void onClick(View v) {
            if (!PhonebookShareActivity.this.isImport) {
                ...
                builder2.setItems(new CharSequence[]{LocaleController.getString("CreateNewContact", R.string.CreateNewContact), LocaleController.getString("AddToExistingContact", R.string.AddToExistingContact)}, new C15481());
                builder2.show();
            }
        }
    }
    ...
    class C15508 implements OnPreDrawListener {
        C15508() {
        }
    ...
    class C22111 extends ActionBarMenuOnItemClick {
        C22111() {
        }
    ...
    class C22124 implements OnItemClickListener {
        C22124() {
        }
    ...
    class C22135 implements OnItemLongClickListener {
        C22135() {
        }
    ...
    class C22146 extends OnScrollListener {
        C22146() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C22111());
        ...
        LayoutManager c22153 = new LinearLayoutManager(context, 1, false) {
            public boolean supportsPredictiveItemAnimations() {
                return false;
            }
        };
        this.layoutManager = c22153;
        recyclerListView.setLayoutManager(c22153);
        ...
        this.listView.setOnItemClickListener(new C22124());
        this.listView.setOnItemLongClickListener(new C22135());
        ...
        needLayout();
        this.listView.setOnScrollListener(new C22146());
        ...
        this.bottomLayout.setOnClickListener(new C15497());
    ...
    private void needLayout() {
        ...
        int newTop = i + C0646ActionBar.getCurrentActionBarHeight();
        ...
        if (this.avatarImage != null) {
            ...
            float avatarY = ((((float) i2) + ((((float) C0646ActionBar.getCurrentActionBarHeight()) / 2.0f) * (1.0f + diff))) - (21.0f * AndroidUtilities.density)) + ((27.0f * AndroidUtilities.density) * diff);
    ...
    private void fixLayout() {
        if (this.fragmentView != null) {
            this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C15508());
        }
    }
