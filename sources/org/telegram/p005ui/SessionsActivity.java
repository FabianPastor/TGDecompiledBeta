...
public class SessionsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C22882 implements OnItemClickListener {
        ...
        class C17081 implements OnClickListener {
            ...
            class C17091 implements RequestDelegate {
                C17091() {
                }
            ...
            class C17102 implements RequestDelegate {
                C17102() {
                }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (SessionsActivity.this.currentType == 0) {
                    ConnectionsManager.getInstance(SessionsActivity.this.currentAccount).sendRequest(new TL_auth_resetAuthorizations(), new C17091());
                    return;
                }
                ConnectionsManager.getInstance(SessionsActivity.this.currentAccount).sendRequest(new TL_account_resetWebAuthorizations(), new C17102());
            }
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == SessionsActivity.this.terminateAllSessionsRow) {
                if (SessionsActivity.this.getParentActivity() != null) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C17081());
    ...
    class C22893 implements RequestDelegate {
        C22893() {
        }
    ...
    class C22904 implements RequestDelegate {
        C22904() {
        }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 3:
                    ...
                    if (layoutParams != null) {
                        ...
                        int currentActionBarHeight = (AndroidUtilities.displaySize.y - C0646ActionBar.getCurrentActionBarHeight()) - AndroidUtilities.m10dp(128.0f);
    ...
    public View createView(Context context) {
        ...
        this.emptyLayout.setLayoutParams(new AbsListView.LayoutParams(-1, AndroidUtilities.displaySize.y - C0646ActionBar.getCurrentActionBarHeight()));
        ...
        this.listView.setOnItemClickListener(new C22882());
    ...
    private void loadSessions(boolean silent) {
        if (!this.loading) {
            ...
            if (this.currentType == 0) {
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getAuthorizations(), new C22893()), this.classGuid);
                return;
            }
            ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(new TL_account_getWebAuthorizations(), new C22904()), this.classGuid);
        }
    }
