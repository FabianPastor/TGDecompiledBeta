...
public class ChangePhoneActivity extends BaseFragment {
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        public boolean onBackPressed(boolean force) {
            ...
            builder.setNegativeButton(LocaleController.getString("Stop", CLASSNAMER.string.Stop), new ChangePhoneActivity$LoginActivitySmsView$$Lambda$5(this));
    ...
    public View createView(Context context) {
        ...
        ScrollView scrollView = new ScrollView(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ChangePhoneActivity.this.scrollHeight = MeasureSpec.getSize(heightMeasureSpec) - AndroidUtilities.m9dp(30.0f);
                super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            }
        };
