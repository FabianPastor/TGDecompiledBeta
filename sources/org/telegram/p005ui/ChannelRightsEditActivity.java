...
/* renamed from: org.telegram.ui.ChannelRightsEditActivity */
public class ChannelRightsEditActivity extends BaseFragment {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == ChannelRightsEditActivity.this.cantEditInfoRow) {
                        privacyCell.setText(LocaleController.getString("EditAdminCantEdit", CLASSNAMER.string.EditAdminCantEdit));
                        return;
                    }
                    return;
                case 2:
                    ...
                    if (position == ChannelRightsEditActivity.this.removeAdminRow) {
                        ...
                        if (ChannelRightsEditActivity.this.currentType == 0) {
                            actionCell.setText(LocaleController.getString("EditAdminRemoveAdmin", CLASSNAMER.string.EditAdminRemoveAdmin), false);
                            return;
                        } else if (ChannelRightsEditActivity.this.currentType == 1) {
                            actionCell.setText(LocaleController.getString("UserRestrictionsBlock", CLASSNAMER.string.UserRestrictionsBlock), false);
                            return;
                        } else {
                            return;
                        }
                        ...
                        if (ChannelRightsEditActivity.this.bannedRights.until_date == 0 || Math.abs(((long) ChannelRightsEditActivity.this.bannedRights.until_date) - (System.currentTimeMillis() / 1000)) > NUM) {
                            value = LocaleController.getString("UserRestrictionsUntilForever", CLASSNAMER.string.UserRestrictionsUntilForever);
                        } else {
                            value = LocaleController.formatDateForBan((long) ChannelRightsEditActivity.this.bannedRights.until_date);
                        }
                        actionCell.setTextAndValue(LocaleController.getString("UserRestrictionsUntil", CLASSNAMER.string.UserRestrictionsUntil), value, false);
                        return;
                    } else {
                        return;
                    }
                case 3:
                    ...
                    if (ChannelRightsEditActivity.this.currentType == 0) {
                        headerCell.setText(LocaleController.getString("EditAdminWhatCanDo", CLASSNAMER.string.EditAdminWhatCanDo));
                        return;
                    } else if (ChannelRightsEditActivity.this.currentType == 1) {
                        headerCell.setText(LocaleController.getString("UserRestrictionsCanDo", CLASSNAMER.string.UserRestrictionsCanDo));
                        return;
                    } else {
                        return;
                    }
                case 4:
                    ...
                    if (position == ChannelRightsEditActivity.this.changeInfoRow) {
                        if (ChannelRightsEditActivity.this.isMegagroup) {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminChangeGroupInfo", CLASSNAMER.string.EditAdminChangeGroupInfo), ChannelRightsEditActivity.this.adminRights.change_info, true);
                        } else {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminChangeChannelInfo", CLASSNAMER.string.EditAdminChangeChannelInfo), ChannelRightsEditActivity.this.adminRights.change_info, true);
                        }
                    } else if (position == ChannelRightsEditActivity.this.postMessagesRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("EditAdminPostMessages", CLASSNAMER.string.EditAdminPostMessages), ChannelRightsEditActivity.this.adminRights.post_messages, true);
                    } else if (position == ChannelRightsEditActivity.this.editMesagesRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("EditAdminEditMessages", CLASSNAMER.string.EditAdminEditMessages), ChannelRightsEditActivity.this.adminRights.edit_messages, true);
                    } else if (position == ChannelRightsEditActivity.this.deleteMessagesRow) {
                        if (ChannelRightsEditActivity.this.isMegagroup) {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminGroupDeleteMessages", CLASSNAMER.string.EditAdminGroupDeleteMessages), ChannelRightsEditActivity.this.adminRights.delete_messages, true);
                        } else {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminDeleteMessages", CLASSNAMER.string.EditAdminDeleteMessages), ChannelRightsEditActivity.this.adminRights.delete_messages, true);
                        }
                    } else if (position == ChannelRightsEditActivity.this.addAdminsRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("EditAdminAddAdmins", CLASSNAMER.string.EditAdminAddAdmins), ChannelRightsEditActivity.this.adminRights.add_admins, false);
                    } else if (position == ChannelRightsEditActivity.this.banUsersRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("EditAdminBanUsers", CLASSNAMER.string.EditAdminBanUsers), ChannelRightsEditActivity.this.adminRights.ban_users, true);
                    } else if (position == ChannelRightsEditActivity.this.addUsersRow) {
                        if (ChannelRightsEditActivity.this.isDemocracy) {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminAddUsersViaLink", CLASSNAMER.string.EditAdminAddUsersViaLink), ChannelRightsEditActivity.this.adminRights.invite_users, true);
                        } else {
                            checkCell.setTextAndCheck(LocaleController.getString("EditAdminAddUsers", CLASSNAMER.string.EditAdminAddUsers), ChannelRightsEditActivity.this.adminRights.invite_users, true);
                        }
                    } else if (position == ChannelRightsEditActivity.this.pinMessagesRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("EditAdminPinMessages", CLASSNAMER.string.EditAdminPinMessages), ChannelRightsEditActivity.this.adminRights.pin_messages, true);
                    } else if (position == ChannelRightsEditActivity.this.viewMessagesRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UserRestrictionsRead", CLASSNAMER.string.UserRestrictionsRead), !ChannelRightsEditActivity.this.bannedRights.view_messages, true);
                    } else if (position == ChannelRightsEditActivity.this.sendMessagesRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UserRestrictionsSend", CLASSNAMER.string.UserRestrictionsSend), !ChannelRightsEditActivity.this.bannedRights.send_messages, true);
                    } else if (position == ChannelRightsEditActivity.this.sendMediaRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UserRestrictionsSendMedia", CLASSNAMER.string.UserRestrictionsSendMedia), !ChannelRightsEditActivity.this.bannedRights.send_media, true);
                    } else if (position == ChannelRightsEditActivity.this.sendStickersRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UserRestrictionsSendStickers", CLASSNAMER.string.UserRestrictionsSendStickers), !ChannelRightsEditActivity.this.bannedRights.send_stickers, true);
                    } else if (position == ChannelRightsEditActivity.this.embedLinksRow) {
                        checkCell.setTextAndCheck(LocaleController.getString("UserRestrictionsEmbedLinks", CLASSNAMER.string.UserRestrictionsEmbedLinks), !ChannelRightsEditActivity.this.bannedRights.embed_links, true);
                    }
                ...
                case 5:
                    ...
                    if (position == ChannelRightsEditActivity.this.rightsShadowRow) {
                        shadowCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, ChannelRightsEditActivity.this.removeAdminRow == -1 ? CLASSNAMER.drawable.greydivider_bottom : CLASSNAMER.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                    } else if (position == ChannelRightsEditActivity.this.removeAdminShadowRow) {
                        shadowCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) CLASSNAMER.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        return;
                    } else {
                        shadowCell.setBackgroundDrawable(Theme.getThemedDrawable(this.mContext, (int) CLASSNAMER.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        return;
                    }
                default:
                    return;
    ...
    public View createView(Context context) {
        ...
        if (this.currentType == 0) {
            this.actionBar.setTitle(LocaleController.getString("EditAdmin", CLASSNAMER.string.EditAdmin));
        } else {
            this.actionBar.setTitle(LocaleController.getString("UserRestrictions", CLASSNAMER.string.UserRestrictions));
        }
        ...
        this.listView.setOnItemClickListener(new ChannelRightsEditActivity$$Lambda$0(this));
        return this.fragmentView;
    }

    final /* synthetic */ void lambda$createView$6$ChannelRightsEditActivity(View view, int position) {
        if (!this.canEdit) {
            return;
        }
        if (position == 0) {
            ...
            if (this.currentType == 0) {
                MessagesController.getInstance(this.currentAccount).setUserAdminRole(this.chatId, this.currentUser, new TL_channelAdminRights(), this.isMegagroup, getFragmentForAlert(0));
                ...
                MessagesController.getInstance(this.currentAccount).setUserBannedRole(this.chatId, this.currentUser, this.bannedRights, this.isMegagroup, getFragmentForAlert(0));
            }
            ...
            if (getParentActivity() != null) {
                ...
                try {
                    DatePickerDialog dialog = new DatePickerDialog(getParentActivity(), new ChannelRightsEditActivity$$Lambda$2(this), calendar.get(1), calendar.get(2), calendar.get(5));
                    ...
                    dialog.setButton(-1, LocaleController.getString("Set", CLASSNAMER.string.Set), dialog);
                    dialog.setButton(-3, LocaleController.getString("UserRestrictionsUntilForever", CLASSNAMER.string.UserRestrictionsUntilForever), new ChannelRightsEditActivity$$Lambda$3(this));
                    dialog.setButton(-2, LocaleController.getString("Cancel", CLASSNAMER.string.Cancel), ChannelRightsEditActivity$$Lambda$4.$instance);
                    if (VERSION.SDK_INT >= 21) {
                        dialog.setOnShowListener(new ChannelRightsEditActivity$$Lambda$5(datePicker));
                    }
                    showDialog(dialog);
                } catch (Throwable e) {
                    FileLog.m13e(e);
            ...
            if (checkCell.isEnabled()) {
                ...
                if (position == this.changeInfoRow) {
                    ...
                    TL_channelAdminRights tL_channelAdminRights = this.adminRights;
                    TL_channelAdminRights tL_channelAdminRights2 = this.adminRights;
                    z = !this.adminRights.invite_users;
                    ...
                    if (position == this.viewMessagesRow) {
                        this.bannedRights.view_messages = !this.bannedRights.view_messages;
                    } else if (position == this.sendMessagesRow) {
                        ...
                        tL_channelBannedRights = this.bannedRights;
                        tL_channelBannedRights2 = this.bannedRights;
                        TL_channelBannedRights tL_channelBannedRights3 = this.bannedRights;
                        TL_channelBannedRights tL_channelBannedRights4 = this.bannedRights;
                        z = !this.bannedRights.send_stickers;
                        tL_channelBannedRights4.send_inline = z;
                        tL_channelBannedRights3.send_gifs = z;
                        tL_channelBannedRights2.send_games = z;
                        tL_channelBannedRights.send_stickers = z;
                    ...
                    if (disabled) {
                        ...
                        if ((this.bannedRights.view_messages || this.bannedRights.send_messages || this.bannedRights.send_media) && !this.bannedRights.send_stickers) {
                            TL_channelBannedRights tL_channelBannedRights5 = this.bannedRights;
                            tL_channelBannedRights = this.bannedRights;
                            tL_channelBannedRights2 = this.bannedRights;
                            this.bannedRights.send_inline = true;
                        ...
                        if ((this.bannedRights.view_messages || this.bannedRights.send_messages || this.bannedRights.send_media) && !this.bannedRights.embed_links) {
                            this.bannedRights.embed_links = true;
                    ...
                    if (!(this.bannedRights.send_messages && this.bannedRights.embed_links && this.bannedRights.send_inline && this.bannedRights.send_media) && this.bannedRights.view_messages) {
                        this.bannedRights.view_messages = false;
                        holder = this.listView.findViewHolderForAdapterPosition(this.viewMessagesRow);
                        if (holder != null) {
                            ((TextCheckCell2) holder.itemView).setChecked(true);
                        }
                    }
                    if (!(this.bannedRights.embed_links && this.bannedRights.send_inline && this.bannedRights.send_media) && this.bannedRights.send_messages) {
                    ...
                    if (!(this.bannedRights.send_inline && this.bannedRights.embed_links) && this.bannedRights.send_media) {
                        this.bannedRights.send_media = false;
                        holder = this.listView.findViewHolderForAdapterPosition(this.sendMediaRow);
                        if (holder != null) {
                            ((TextCheckCell2) holder.itemView).setChecked(true);
                        }
    ...
    final /* synthetic */ void lambda$null$2$ChannelRightsEditActivity(DatePicker view1, int year1, int month, int dayOfMonth1) {
        Calendar calendar1 = Calendar.getInstance();
        calendar1.clear();
        calendar1.set(year1, month, dayOfMonth1);
        try {
            TimePickerDialog dialog13 = new TimePickerDialog(getParentActivity(), new ChannelRightsEditActivity$$Lambda$6(this, (int) (calendar1.getTime().getTime() / 1000)), 0, 0, true);
            dialog13.setButton(-1, LocaleController.getString("Set", CLASSNAMER.string.Set), dialog13);
            dialog13.setButton(-2, LocaleController.getString("Cancel", CLASSNAMER.string.Cancel), ChannelRightsEditActivity$$Lambda$7.$instance);
            showDialog(dialog13);
        } catch (Throwable e) {
            FileLog.m13e(e);
        }
    ...
    final /* synthetic */ void lambda$null$0$ChannelRightsEditActivity(int time, TimePicker view11, int hourOfDay, int minute) {
        this.bannedRights.until_date = ((hourOfDay * 3600) + time) + (minute * 60);
        this.listViewAdapter.notifyItemChanged(this.untilDateRow);
    }

    static final /* synthetic */ void lambda$null$1$ChannelRightsEditActivity(DialogInterface dialog131, int which) {
    }

    final /* synthetic */ void lambda$null$3$ChannelRightsEditActivity(DialogInterface dialog14, int which) {
        this.bannedRights.until_date = 0;
        this.listViewAdapter.notifyItemChanged(this.untilDateRow);
    }

    static final /* synthetic */ void lambda$null$4$ChannelRightsEditActivity(DialogInterface dialog1, int which) {
    }

    static final /* synthetic */ void lambda$null$5$ChannelRightsEditActivity(DatePicker datePicker, DialogInterface dialog12) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate cellDelegate = new ChannelRightsEditActivity$$Lambda$1(this);
        ...
        themeDescriptionArr[11] = new ThemeDescription(this.listView, ThemeDescription.FLAG_CHECKTAG, new Class[]{TextSettingsCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteRedText5);
        ...
        themeDescriptionArr[17] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell2.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switch2Track);
        themeDescriptionArr[18] = new ThemeDescription(this.listView, 0, new Class[]{TextCheckCell2.class}, new String[]{"checkBox"}, null, null, null, Theme.key_switch2TrackChecked);
        ...
        themeDescriptionArr[20] = new ThemeDescription(this.listView, 0, new Class[]{HeaderCell.class}, new String[]{"textView"}, null, null, null, Theme.key_windowBackgroundWhiteBlueHeader);
        themeDescriptionArr[21] = new ThemeDescription(this.listView, 0, new Class[]{UserCell.class}, new String[]{"nameTextView"}, null, null, null, Theme.key_windowBackgroundWhiteBlackText);
        themeDescriptionArr[22] = new ThemeDescription(this.listView, 0, new Class[]{UserCell.class}, new String[]{"statusColor"}, null, null, cellDelegate, Theme.key_windowBackgroundWhiteGrayText);
        themeDescriptionArr[23] = new ThemeDescription(this.listView, 0, new Class[]{UserCell.class}, new String[]{"statusOnlineColor"}, null, null, cellDelegate, Theme.key_windowBackgroundWhiteBlueText);
        themeDescriptionArr[24] = new ThemeDescription(this.listView, 0, new Class[]{UserCell.class}, null, new Drawable[]{Theme.avatar_broadcastDrawable, Theme.avatar_savedDrawable}, null, Theme.key_avatar_text);
    ...
    final /* synthetic */ void lambda$getThemeDescriptions$7$ChannelRightsEditActivity() {
