...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, ImageUpdaterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (this.currentStep == 0) {
            ...
            this.radioButtonCell1.setTextAndValue(LocaleController.getString("ChannelPublic", CLASSNAMER.string.ChannelPublic), LocaleController.getString("ChannelPublicInfo", CLASSNAMER.string.ChannelPublicInfo), false, !this.isPrivate);
            ...
            this.radioButtonCell2.setTextAndValue(LocaleController.getString("ChannelPrivate", CLASSNAMER.string.ChannelPrivate), LocaleController.getString("ChannelPrivateInfo", CLASSNAMER.string.ChannelPrivateInfo), false, this.isPrivate);
            ...
            this.descriptionTextView.setImeOptions(6);
            this.descriptionTextView.setHint(LocaleController.getString("ChannelUsernamePlaceholder", CLASSNAMER.string.ChannelUsernamePlaceholder));
            this.descriptionTextView.setCursorColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.descriptionTextView.setCursorSize(AndroidUtilities.m9dp(20.0f));
            this.descriptionTextView.setCursorWidth(1.5f);
            ...
            this.typeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, (int) CLASSNAMER.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            ...
            this.adminedInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(context, (int) CLASSNAMER.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
    ...
    private void updatePrivatePublic() {
        ...
        if (this.sectionCell != null) {
            if (this.isPrivate || this.canCreatePublic) {
                ...
                this.typeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(this.typeInfoCell.getContext(), (int) CLASSNAMER.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                if (this.loadingAdminedChannels) {
                    ...
                    this.typeInfoCell.setBackgroundDrawable(Theme.getThemedDrawable(this.typeInfoCell.getContext(), (int) CLASSNAMER.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    this.loadingAdminedCell.setVisibility(8);
    ...
    final /* synthetic */ void lambda$didUploadPhoto$11$ChannelCreateActivity(InputFile file, PhotoSize smallSize, PhotoSize bigSize) {
        if (file != null) {
    ...
    final /* synthetic */ void lambda$null$15$ChannelCreateActivity(View view) {
        ...
        builder.setPositiveButton(LocaleController.getString("RevokeButton", CLASSNAMER.string.RevokeButton), new ChannelCreateActivity$$Lambda$16(this, channel));
