...
public class C0195PhoneFormat {
    private static volatile C0195PhoneFormat Instance = null;
    ...
    public static C0195PhoneFormat getInstance() {
        Throwable th;
        C0195PhoneFormat localInstance = Instance;
        if (localInstance == null) {
            synchronized (C0195PhoneFormat.class) {
                try {
                    localInstance = Instance;
                    if (localInstance == null) {
                        C0195PhoneFormat localInstance2 = new C0195PhoneFormat();
                        try {
    ...
    public static String stripExceptNumbers(String str) {
        return C0195PhoneFormat.stripExceptNumbers(str, false);
    }

    public C0195PhoneFormat() {
        init(null);
    }

    public C0195PhoneFormat(String countryCode) {
        init(countryCode);
    }
    ...
    public String format(String orig) {
        ...
        try {
            String str = C0195PhoneFormat.strip(orig);
            String rest;
    ...
    public boolean isPhoneNumberValid(String phoneNumber) {
        ...
        String str = C0195PhoneFormat.strip(phoneNumber);
        String rest;
        CallingCodeInfo info;
        if (str.startsWith("+")) {
            rest = str.substring(1);
