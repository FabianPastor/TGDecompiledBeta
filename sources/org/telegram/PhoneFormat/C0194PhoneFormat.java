...
public class C0194PhoneFormat {
    private static volatile C0194PhoneFormat Instance = null;
    ...
    public static C0194PhoneFormat getInstance() {
        Throwable th;
        C0194PhoneFormat localInstance = Instance;
        if (localInstance == null) {
            synchronized (C0194PhoneFormat.class) {
                try {
                    localInstance = Instance;
                    if (localInstance == null) {
                        C0194PhoneFormat localInstance2 = new C0194PhoneFormat();
                        try {
    ...
    public static String stripExceptNumbers(String str) {
        return C0194PhoneFormat.stripExceptNumbers(str, false);
    }

    public C0194PhoneFormat() {
        init(null);
    }

    public C0194PhoneFormat(String countryCode) {
        init(countryCode);
    }
    ...
    public String format(String orig) {
        ...
        try {
            String str = C0194PhoneFormat.strip(orig);
            String rest;
    ...
    public boolean isPhoneNumberValid(String phoneNumber) {
        ...
        String str = C0194PhoneFormat.strip(phoneNumber);
        String rest;
        CallingCodeInfo info;
        if (str.startsWith("+")) {
            rest = str.substring(1);
