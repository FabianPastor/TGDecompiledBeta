...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda208 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda208(MessagesController messagesController, boolean z, int i, int i2, boolean z2, boolean z3, int i3, long j, int i4, ArrayList arrayList, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12) {
