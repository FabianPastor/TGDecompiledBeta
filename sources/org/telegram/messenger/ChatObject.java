...
public class ChatObject {
    ...
    public static class Call {
        ...
        private Runnable typingUpdateRunnable = new ChatObject$Call$$ExternalSyntheticLambda5(this);
        ...
        public /* synthetic */ void m607lambda$new$0$orgtelegrammessengerChatObject$Call() {
        ...
        public void loadMembers(boolean fromBegin) {
            ...
            if (!this.membersLoadEndReached && this.sortedParticipants.size() <= 5000) {
                ...
                req.offset = str;
                req.limit = 20;
                this.currentAccount.getConnectionsManager().sendRequest(req, new ChatObject$Call$$ExternalSyntheticLambda4(this, fromBegin, req));
            }
        }

        /* renamed from: lambda$loadMembers$2$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m604lambda$loadMembers$2$orgtelegrammessengerChatObject$Call(boolean fromBegin, TLRPC.TL_phone_getGroupParticipants req, TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new ChatObject$Call$$ExternalSyntheticLambda10(this, fromBegin, response, req));
        }

        /* renamed from: lambda$loadMembers$1$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m603lambda$loadMembers$1$orgtelegrammessengerChatObject$Call(boolean fromBegin, TLObject response, TLRPC.TL_phone_getGroupParticipants req) {
        ...
        /* renamed from: lambda$setTitle$3$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m610lambda$setTitle$3$orgtelegrammessengerChatObject$Call(TLObject response, TLRPC.TL_error error) {
            if (response != null) {
        ...
        private void loadUnknownParticipants(ArrayList<Long> participantsToLoad, boolean isIds, OnParticipantsLoad onLoad) {
            ...
            if (participantsToLoad.isEmpty() == 0) {
                ...
                req.offset = "";
                req.limit = 100;
                this.currentAccount.getConnectionsManager().sendRequest(req, new ChatObject$Call$$ExternalSyntheticLambda3(this, guid, onLoad, participantsToLoad, set));
            }
        }

        /* renamed from: lambda$loadUnknownParticipants$5$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m606xe351e81a(int guid, OnParticipantsLoad onLoad, ArrayList participantsToLoad, HashSet set, TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new ChatObject$Call$$ExternalSyntheticLambda7(this, guid, response, onLoad, participantsToLoad, set));
        }

        /* renamed from: lambda$loadUnknownParticipants$4$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m605x8CLASSNAMEvar_b(int guid, TLObject response, OnParticipantsLoad onLoad, ArrayList participantsToLoad, HashSet set) {
        ...
        private void processUpdatesQueue() {
            Collections.sort(this.updatesQueue, ChatObject$Call$$ExternalSyntheticLambda12.INSTANCE);
        ...
        public void checkQueue() {
            ...
            if (!this.updatesQueue.isEmpty()) {
                ChatObject$Call$$ExternalSyntheticLambda6 chatObject$Call$$ExternalSyntheticLambda6 = new ChatObject$Call$$ExternalSyntheticLambda6(this);
                this.checkQueueRunnable = chatObject$Call$$ExternalSyntheticLambda6;
                AndroidUtilities.runOnUIThread(chatObject$Call$$ExternalSyntheticLambda6, 1000);
            }
        }
        ...
        public /* synthetic */ void m609lambda$reloadGroupCall$8$orgtelegrammessengerChatObject$Call(TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new ChatObject$Call$$ExternalSyntheticLambda9(this, response));
        }

        /* renamed from: lambda$reloadGroupCall$7$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m608lambda$reloadGroupCall$7$orgtelegrammessengerChatObject$Call(TLObject response) {
        ...
        private void loadGroupCall() {
            if (!this.loadingGroupCall && SystemClock.elapsedRealtime() - this.lastGroupCallReloadTime >= 30000) {
                ...
                req.offset = "";
                req.limit = 1;
                this.currentAccount.getConnectionsManager().sendRequest(req, new ChatObject$Call$$ExternalSyntheticLambda13(this));
            }
        }

        /* renamed from: lambda$loadGroupCall$10$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m601lambda$loadGroupCall$10$orgtelegrammessengerChatObject$Call(TLObject response, TLRPC.TL_error error) {
            AndroidUtilities.runOnUIThread(new ChatObject$Call$$ExternalSyntheticLambda8(this, response));
        }

        /* renamed from: lambda$loadGroupCall$9$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m602lambda$loadGroupCall$9$orgtelegrammessengerChatObject$Call(TLObject response) {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:112:0x0325  */
        /* JADX WARNING: Removed duplicated region for block: B:113:0x032e  */
        /* JADX WARNING: Removed duplicated region for block: B:130:0x0384  */
        ...
        /* JADX WARNING: Removed duplicated region for block: B:79:0x0249  */
        ...
        public void processParticipantsUpdate(org.telegram.tgnet.TLRPC.TL_updateGroupCallParticipants r33, boolean r34) {
            ...
            L_0x0078:
                ...
                org.telegram.messenger.ChatObject$Call$$ExternalSyntheticLambda6 r2 = new org.telegram.messenger.ChatObject$Call$$ExternalSyntheticLambda6
                r2.<init>(r0)
        ...
        public static boolean videoIsActive(TLRPC.TL_groupCallParticipant participant, boolean presentation, Call call2) {
            ...
            if (!participant.self) {
                ...
                if ((videoParticipant == null || videoParticipant.participant != participant) && call2.participants.get(MessageObject.getPeerId(participant.peer)) == null) {
                    return false;
                }
                if (presentation) {
        ...
        public void sortParticipants() {
            ...
            Comparator<TLRPC.TL_groupCallParticipant> comparator2 = new ChatObject$Call$$ExternalSyntheticLambda11(this, selfId, isAdmin);
            ...
            if (this.sortedParticipants.size() > 5000) {
                if (ChatObject.canManageCalls(chat)) {
                    ...
                    if (lastParticipant.raise_hand_rating != 0) {
                        ChatObject$Call$$ExternalSyntheticLambda11 chatObject$Call$$ExternalSyntheticLambda11 = comparator2;
                    }
                } else {
                    hasAnyVideo = hasAnyVideo2;
                }
            ...
            for (int i4 = 0; i4 < this.sortedParticipants.size(); i4++) {
                ...
                if (!this.canStreamVideo || participant2.videoIndex == 0) {
                    ...
                    VideoParticipant videoParticipant2 = this.videoParticipantsCache.get(participant2.videoEndpoint);
                    if (videoParticipant2 == null) {
                        videoParticipant2 = new VideoParticipant(participant2, false, true);
                        this.videoParticipantsCache.put(participant2.videoEndpoint, videoParticipant2);
                        z2 = true;
                    } else {
                        videoParticipant2.participant = participant2;
                    ...
                    VideoParticipant videoParticipant3 = this.videoParticipantsCache.get(presentation ? participant2.presentationEndpoint : participant2.videoEndpoint);
                    if (videoParticipant3 == null) {
                        videoParticipant3 = new VideoParticipant(participant2, presentation, false);
                        this.videoParticipantsCache.put(presentation ? participant2.presentationEndpoint : participant2.videoEndpoint, videoParticipant3);
                    } else {
                        videoParticipant3.participant = participant2;
                        videoParticipant3.presentation = presentation;
                        videoParticipant3.hasSame = false;
                    }
        ...
        /* renamed from: lambda$sortParticipants$11$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ int m611xad1CLASSNAME(long selfId, boolean isAdmin, TLRPC.TL_groupCallParticipant o1, TLRPC.TL_groupCallParticipant o2) {
        ...
        /* renamed from: lambda$toggleRecord$12$org-telegram-messenger-ChatObject$Call  reason: not valid java name */
        public /* synthetic */ void m612lambda$toggleRecord$12$orgtelegrammessengerChatObject$Call(TLObject response, TLRPC.TL_error error) {
            if (response != null) {
                this.currentAccount.getMessagesController().processUpdates((TLRPC.Updates) response, false);
            }
        }
    ...
    public static class VideoParticipant {
        ...
        public void setAspectRatio(float aspectRatio2, Call call) {
