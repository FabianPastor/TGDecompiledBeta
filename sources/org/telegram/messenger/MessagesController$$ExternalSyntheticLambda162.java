...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda162 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda162(MessagesController messagesController, TLRPC$TL_messages_sponsoredMessages tLRPC$TL_messages_sponsoredMessages) {
        this.f$0 = messagesController;
        this.f$1 = tLRPC$TL_messages_sponsoredMessages;
    }

    public final void run() {
        this.f$0.lambda$getSponsoredMessages$317(this.f$1);
    }
}
