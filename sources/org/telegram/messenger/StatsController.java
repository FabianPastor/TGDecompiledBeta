...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C05291();
    ...
    private Runnable saveRunnable = new C05302();
    ...
    static class C05291 extends ThreadLocal<Long> {
        C05291() {
        }
