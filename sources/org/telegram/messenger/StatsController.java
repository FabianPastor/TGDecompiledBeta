...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C05691();
    ...
    private Runnable saveRunnable = new C05702();
    ...
    static class C05691 extends ThreadLocal<Long> {
        C05691() {
        }
