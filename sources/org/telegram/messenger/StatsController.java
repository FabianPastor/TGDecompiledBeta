...
public class StatsController extends BaseController {
    ...
    private StatsController(int r15) {
        ...
        L_0x007a:
            ...
            r6 = 1
            r7 = 0
            java.io.RandomAccessFile r8 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x012b }
            java.io.File r9 = new java.io.File     // Catch:{ Exception -> 0x012b }
            java.lang.String r10 = "stats2.dat"
            r9.<init>(r1, r10)     // Catch:{ Exception -> 0x012b }
            java.lang.String r1 = "rw"
            r8.<init>(r9, r1)     // Catch:{ Exception -> 0x012b }
            r14.statsFile = r8     // Catch:{ Exception -> 0x012b }
            long r8 = r8.length()     // Catch:{ Exception -> 0x012b }
        ...
        L_0x009d:
            ...
            java.io.RandomAccessFile r11 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r11.readFully(r12, r7, r2)     // Catch:{ Exception -> 0x012b }
            long[][] r11 = r14.sentBytes     // Catch:{ Exception -> 0x012b }
            r11 = r11[r1]     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            long r12 = r14.bytesToLong(r12)     // Catch:{ Exception -> 0x012b }
            r11[r9] = r12     // Catch:{ Exception -> 0x012b }
            java.io.RandomAccessFile r11 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r11.readFully(r12, r7, r2)     // Catch:{ Exception -> 0x012b }
            long[][] r11 = r14.receivedBytes     // Catch:{ Exception -> 0x012b }
            r11 = r11[r1]     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            long r12 = r14.bytesToLong(r12)     // Catch:{ Exception -> 0x012b }
            r11[r9] = r12     // Catch:{ Exception -> 0x012b }
            java.io.RandomAccessFile r11 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r11.readFully(r12, r7, r10)     // Catch:{ Exception -> 0x012b }
            int[][] r11 = r14.sentItems     // Catch:{ Exception -> 0x012b }
            r11 = r11[r1]     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            int r12 = r14.bytesToInt(r12)     // Catch:{ Exception -> 0x012b }
            r11[r9] = r12     // Catch:{ Exception -> 0x012b }
            java.io.RandomAccessFile r11 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r12 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r11.readFully(r12, r7, r10)     // Catch:{ Exception -> 0x012b }
            int[][] r10 = r14.receivedItems     // Catch:{ Exception -> 0x012b }
            r10 = r10[r1]     // Catch:{ Exception -> 0x012b }
            byte[] r11 = r14.buffer     // Catch:{ Exception -> 0x012b }
            int r11 = r14.bytesToInt(r11)     // Catch:{ Exception -> 0x012b }
            r10[r9] = r11     // Catch:{ Exception -> 0x012b }
            int r9 = r9 + 1
            goto L_0x009d
        L_0x00ef:
            java.io.RandomAccessFile r9 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r11 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r9.readFully(r11, r7, r10)     // Catch:{ Exception -> 0x012b }
            int[] r9 = r14.callsTotalTime     // Catch:{ Exception -> 0x012b }
            byte[] r10 = r14.buffer     // Catch:{ Exception -> 0x012b }
            int r10 = r14.bytesToInt(r10)     // Catch:{ Exception -> 0x012b }
            r9[r1] = r10     // Catch:{ Exception -> 0x012b }
            java.io.RandomAccessFile r9 = r14.statsFile     // Catch:{ Exception -> 0x012b }
            byte[] r10 = r14.buffer     // Catch:{ Exception -> 0x012b }
            r9.readFully(r10, r7, r2)     // Catch:{ Exception -> 0x012b }
            long[] r9 = r14.resetStatsDate     // Catch:{ Exception -> 0x012b }
            byte[] r10 = r14.buffer     // Catch:{ Exception -> 0x012b }
            long r10 = r14.bytesToLong(r10)     // Catch:{ Exception -> 0x012b }
            r9[r1] = r10     // Catch:{ Exception -> 0x012b }
            long[] r9 = r14.resetStatsDate     // Catch:{ Exception -> 0x012b }
            r10 = r9[r1]     // Catch:{ Exception -> 0x012b }
            int r12 = (r10 > r4 ? 1 : (r10 == r4 ? 0 : -1))
            if (r12 != 0) goto L_0x0120
            long r10 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x012b }
            r9[r1] = r10     // Catch:{ Exception -> 0x012b }
            r8 = 1
        L_0x0120:
            int r1 = r1 + 1
        ...
        L_0x0124:
            ...
            r14.saveStats()     // Catch:{ Exception -> 0x012b }
        L_0x0129:
            r1 = 0
            goto L_0x012c
        L_0x012b:
