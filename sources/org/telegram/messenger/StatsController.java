...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C05261();
    ...
    private Runnable saveRunnable = new C05272();
    ...
    static class C05261 extends ThreadLocal<Long> {
        C05261() {
        }
