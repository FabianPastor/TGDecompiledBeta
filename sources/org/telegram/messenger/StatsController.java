...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C02741();
    ...
    private Runnable saveRunnable = new C02752();
    ...
    static class C02741 extends ThreadLocal<Long> {
        C02741() {
        }
