...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C03701();
    ...
    private Runnable saveRunnable = new C03712();
    ...
    static class C03701 extends ThreadLocal<Long> {
        C03701() {
        }
