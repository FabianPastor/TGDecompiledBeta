...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C05641();
    ...
    private Runnable saveRunnable = new C05652();
    ...
    static class C05641 extends ThreadLocal<Long> {
        C05641() {
        }
