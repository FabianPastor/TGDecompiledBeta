...
public class StatsController {
    ...
    private static final ThreadLocal<Long> lastStatsSaveTime = new C05181();
    ...
    private Runnable saveRunnable = new C05192();
    ...
    static class C05181 extends ThreadLocal<Long> {
        C05181() {
        }
