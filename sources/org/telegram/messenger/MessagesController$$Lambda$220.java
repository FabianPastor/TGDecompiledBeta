...
final /* synthetic */ class MessagesController$$Lambda$220 implements Runnable {
    ...
    MessagesController$$Lambda$220(MessagesController messagesController, messages_Messages messages_messages, boolean z, boolean z2, int i, int i2, long j, int i3, ArrayList arrayList, int i4, int i5, int i6, boolean z3, int i7, int i8, int i9, int i10, ArrayList arrayList2, HashMap hashMap) {
