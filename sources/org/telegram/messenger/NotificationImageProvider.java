...
public class NotificationImageProvider extends ContentProvider implements NotificationCenter.NotificationCenterDelegate {
    ...
    public android.os.ParcelFileDescriptor openFile(android.net.Uri r19, java.lang.String r20) throws java.io.FileNotFoundException {
        ...
        L_0x00cd:
            ...
            monitor-enter(r14)
            java.util.HashSet<java.lang.String> r0 = r1.waitingForFiles     // Catch:{ all -> 0x00e7 }
            r0.add(r6)     // Catch:{ all -> 0x00e7 }
            java.lang.Object r0 = r1.sync     // Catch:{ InterruptedException -> 0x00e0 }
            r15 = r11
            r10 = 1000(0x3e8, double:4.94E-321)
            r0.wait(r10)     // Catch:{ InterruptedException -> 0x00de }
            goto L_0x00e2
        L_0x00de:
            r0 = move-exception
            goto L_0x00e2
        L_0x00e0:
            ...
            r15 = r11
        L_0x00e2:
            monitor-exit(r14)     // Catch:{ all -> 0x00eb }
            r11 = r15
            r10 = 268435456(0x10000000, float:2.5243549E-29)
            goto L_0x0074
        L_0x00e7:
