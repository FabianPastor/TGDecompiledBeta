...
public final /* synthetic */ class FileRefController$$ExternalSyntheticLambda33 implements Runnable {
    ...
    public /* synthetic */ FileRefController$$ExternalSyntheticLambda33(FileRefController fileRefController, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
        this.f$0 = fileRefController;
        this.f$1 = tL_messages_stickerSet;
    }

    public final void run() {
        this.f$0.m1837xadfCLASSNAMEf(this.f$1);
    }
}
