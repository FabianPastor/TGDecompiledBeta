...
public class EncryptedFileInputStream extends FileInputStream {
    ...
    public int read(byte[] b, int off, int len) throws IOException {
        ...
        if (i2 == 1) {
            ...
            Utilities.aesCtrDecryptionByteArray(b, this.key, this.iv, off, (long) i, this.fileOffset);
        }
        this.fileOffset += i;
        return result;
    }
    ...
    public static void decryptBytesWithKeyFile(byte[] bytes, int offset, int length, File keyFile) throws Exception {
        ...
        randomAccessFile.close();
        Utilities.aesCtrDecryptionByteArray(bytes, key2, iv2, offset, (long) length, 0);
    }
}
