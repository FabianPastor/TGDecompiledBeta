...
public final class ExtendedDefaultDataSourceFactory implements DataSource.Factory {
    ...
    public ExtendedDefaultDataSource mo797createDataSource() {
        return new ExtendedDefaultDataSource(this.context, this.listener, this.baseDataSourceFactory.mo797createDataSource());
    }
}
