...
public class SharedConfig {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:65:0x037f, code lost:
        return;
     */
    ...
    public static void loadConfig() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = configLoaded     // Catch:{ all -> 0x0380 }
            if (r1 != 0) goto L_0x037e
            android.content.Context r1 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch:{ all -> 0x0380 }
        ...
        L_0x000d:
            ...
            r3 = 0
            android.content.SharedPreferences r1 = r1.getSharedPreferences(r2, r3)     // Catch:{ all -> 0x0380 }
            android.content.SharedPreferences unused = org.telegram.messenger.SharedConfig.BackgroundActivityPrefs.prefs = r1     // Catch:{ all -> 0x0380 }
            android.content.Context r1 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "userconfing"
            android.content.SharedPreferences r1 = r1.getSharedPreferences(r2, r3)     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "saveIncomingPhotos"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0380 }
            saveIncomingPhotos = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "passcodeHash1"
            java.lang.String r4 = ""
            java.lang.String r2 = r1.getString(r2, r4)     // Catch:{ all -> 0x0380 }
            passcodeHash = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "appLocked"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0380 }
            appLocked = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "passcodeType"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0380 }
            passcodeType = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "passcodeRetryInMs"
            r4 = 0
            long r6 = r1.getLong(r2, r4)     // Catch:{ all -> 0x0380 }
            passcodeRetryInMs = r6     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "lastUptimeMillis"
            long r4 = r1.getLong(r2, r4)     // Catch:{ all -> 0x0380 }
            lastUptimeMillis = r4     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "badPasscodeTries"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0380 }
            badPasscodeTries = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "autoLockIn"
            r4 = 3600(0xe10, float:5.045E-42)
            int r2 = r1.getInt(r2, r4)     // Catch:{ all -> 0x0380 }
            autoLockIn = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "lastPauseTime"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0380 }
            lastPauseTime = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "useFingerprint"
            r4 = 1
            boolean r2 = r1.getBoolean(r2, r4)     // Catch:{ all -> 0x0380 }
            useFingerprint = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "lastUpdateVersion2"
            java.lang.String r5 = "3.5"
            java.lang.String r2 = r1.getString(r2, r5)     // Catch:{ all -> 0x0380 }
            lastUpdateVersion = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "allowScreenCapture"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0380 }
            allowScreenCapture = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "lastLocalId"
            r5 = -210000(0xfffffffffffccbb0, float:NaN)
            int r2 = r1.getInt(r2, r5)     // Catch:{ all -> 0x0380 }
            lastLocalId = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "pushString2"
            java.lang.String r5 = ""
            java.lang.String r2 = r1.getString(r2, r5)     // Catch:{ all -> 0x0380 }
            pushString = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "pushStatSent"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0380 }
            pushStatSent = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "passportConfigJson"
            java.lang.String r5 = ""
            java.lang.String r2 = r1.getString(r2, r5)     // Catch:{ all -> 0x0380 }
            passportConfigJson = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "passportConfigHash"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0380 }
            passportConfigHash = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "storageCacheDir"
            r5 = 0
            java.lang.String r2 = r1.getString(r2, r5)     // Catch:{ all -> 0x0380 }
            storageCacheDir = r2     // Catch:{ all -> 0x0380 }
            java.lang.String r2 = "pushAuthKey"
            java.lang.String r2 = r1.getString(r2, r5)     // Catch:{ all -> 0x0380 }
            boolean r6 = android.text.TextUtils.isEmpty(r2)     // Catch:{ all -> 0x0380 }
            if (r6 != 0) goto L_0x00d4
            byte[] r6 = android.util.Base64.decode(r2, r3)     // Catch:{ all -> 0x0380 }
            pushAuthKey = r6     // Catch:{ all -> 0x0380 }
        L_0x00d4:
            java.lang.String r6 = passcodeHash     // Catch:{ all -> 0x0380 }
            int r6 = r6.length()     // Catch:{ all -> 0x0380 }
            if (r6 <= 0) goto L_0x00ed
            int r6 = lastPauseTime     // Catch:{ all -> 0x0380 }
            if (r6 != 0) goto L_0x00ed
            long r6 = android.os.SystemClock.elapsedRealtime()     // Catch:{ all -> 0x0380 }
            r8 = 1000(0x3e8, double:4.94E-321)
            long r6 = r6 / r8
            r8 = 600(0x258, double:2.964E-321)
            long r6 = r6 - r8
            int r7 = (int) r6     // Catch:{ all -> 0x0380 }
            lastPauseTime = r7     // Catch:{ all -> 0x0380 }
        L_0x00ed:
            java.lang.String r6 = "passcodeSalt"
            java.lang.String r7 = ""
            java.lang.String r6 = r1.getString(r6, r7)     // Catch:{ all -> 0x0380 }
            int r7 = r6.length()     // Catch:{ all -> 0x0380 }
            if (r7 <= 0) goto L_0x0102
            byte[] r7 = android.util.Base64.decode(r6, r3)     // Catch:{ all -> 0x0380 }
            passcodeSalt = r7     // Catch:{ all -> 0x0380 }
            goto L_0x0106
        L_0x0102:
            byte[] r7 = new byte[r3]     // Catch:{ all -> 0x0380 }
            passcodeSalt = r7     // Catch:{ all -> 0x0380 }
        L_0x0106:
            java.lang.String r7 = "appUpdateCheckTime"
            long r8 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0380 }
            long r7 = r1.getLong(r7, r8)     // Catch:{ all -> 0x0380 }
            lastUpdateCheckTime = r7     // Catch:{ all -> 0x0380 }
        ...
        L_0x0187:
            r7 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r7)     // Catch:{ all -> 0x0380 }
        L_0x018b:
            android.content.Context r7 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch:{ all -> 0x0380 }
            java.lang.String r8 = "mainconfig"
            android.content.SharedPreferences r7 = r7.getSharedPreferences(r8, r3)     // Catch:{ all -> 0x0380 }
            r1 = r7
            java.lang.String r7 = "save_gallery"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            saveToGallery = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "autoplay_gif"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            autoplayGifs = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "autoplay_video"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            autoplayVideo = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "mapPreviewType"
            r8 = 2
            int r7 = r1.getInt(r7, r8)     // Catch:{ all -> 0x0380 }
            mapPreviewType = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "raise_to_speak"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            raiseToSpeak = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "custom_tabs"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            customTabs = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "direct_share"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            directShare = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "shuffleMusic"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            shuffleMusic = r7     // Catch:{ all -> 0x0380 }
        ...
        L_0x01e1:
            r7 = 0
        L_0x01e2:
            playOrderReversed = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "inappCamera"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            inappCamera = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "cameraCache"
            boolean r7 = r1.contains(r7)     // Catch:{ all -> 0x0380 }
            hasCameraCache = r7     // Catch:{ all -> 0x0380 }
            roundCamera16to9 = r4     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "repeatMode"
            int r7 = r1.getInt(r7, r3)     // Catch:{ all -> 0x0380 }
            repeatMode = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "fons_size"
            boolean r9 = org.telegram.messenger.AndroidUtilities.isTablet()     // Catch:{ all -> 0x0380 }
        ...
        L_0x0209:
            r9 = 16
        L_0x020b:
            int r7 = r1.getInt(r7, r9)     // Catch:{ all -> 0x0380 }
            fontSize = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "bubbleRadius"
            r9 = 17
            int r7 = r1.getInt(r7, r9)     // Catch:{ all -> 0x0380 }
            bubbleRadius = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "iv_font_size"
            int r9 = fontSize     // Catch:{ all -> 0x0380 }
            int r7 = r1.getInt(r7, r9)     // Catch:{ all -> 0x0380 }
            ivFontSize = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "allowBigEmoji"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            allowBigEmoji = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "useSystemEmoji"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            useSystemEmoji = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "streamMedia"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            streamMedia = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "saveStreamMedia"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            saveStreamMedia = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "smoothKeyboard2"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            smoothKeyboard = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "pauseMusicOnRecord"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            pauseMusicOnRecord = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "chatBlur"
            boolean r7 = r1.getBoolean(r7, r4)     // Catch:{ all -> 0x0380 }
            chatBlur = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "streamAllVideo"
            boolean r9 = org.telegram.messenger.BuildVars.DEBUG_VERSION     // Catch:{ all -> 0x0380 }
            boolean r7 = r1.getBoolean(r7, r9)     // Catch:{ all -> 0x0380 }
            streamAllVideo = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "streamMkv"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            streamMkv = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "suggestStickers"
            int r7 = r1.getInt(r7, r3)     // Catch:{ all -> 0x0380 }
            suggestStickers = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "sortContactsByName"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            sortContactsByName = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "sortFilesByName"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            sortFilesByName = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "noSoundHintShowed"
            boolean r7 = r1.getBoolean(r7, r3)     // Catch:{ all -> 0x0380 }
            noSoundHintShowed = r7     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "directShareHash2"
            java.lang.String r5 = r1.getString(r7, r5)     // Catch:{ all -> 0x0380 }
            directShareHash = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "useThreeLinesLayout"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            useThreeLinesLayout = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "archiveHidden"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            archiveHidden = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "distanceSystemType"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            distanceSystemType = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "devicePerformanceClass"
            r7 = -1
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            devicePerformanceClass = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "loopStickers"
            boolean r5 = r1.getBoolean(r5, r4)     // Catch:{ all -> 0x0380 }
            loopStickers = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "keep_media"
            int r5 = r1.getInt(r5, r8)     // Catch:{ all -> 0x0380 }
            keepMedia = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "noStatusBar"
            boolean r5 = r1.getBoolean(r5, r4)     // Catch:{ all -> 0x0380 }
            noStatusBar = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "forceRtmpStream"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            forceRtmpStream = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "lastKeepMediaCheckTime"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            lastKeepMediaCheckTime = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "lastLogsCheckTime"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            lastLogsCheckTime = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "searchMessagesAsListHintShows"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            searchMessagesAsListHintShows = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "searchMessagesAsListUsed"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            searchMessagesAsListUsed = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "stickersReorderingHintUsed"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            stickersReorderingHintUsed = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "textSelectionHintShows"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            textSelectionHintShows = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "scheduledOrNoSoundHintShows"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            scheduledOrNoSoundHintShows = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "forwardingOptionsHintShown"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            forwardingOptionsHintShown = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "lockRecordAudioVideoHint"
            int r5 = r1.getInt(r5, r3)     // Catch:{ all -> 0x0380 }
            lockRecordAudioVideoHint = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "disableVoiceAudioEffects"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            disableVoiceAudioEffects = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "noiseSupression"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            noiseSupression = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "ChatSwipeAction"
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            chatSwipeAction = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "messageSeenCount"
            r7 = 3
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            messageSeenHintCount = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "emojiInteractionsHintCount"
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            emojiInteractionsHintCount = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "dayNightThemeSwitchHintCount"
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            dayNightThemeSwitchHintCount = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "mediaColumnsCount"
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            mediaColumnsCount = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "fastScrollHintCount"
            int r5 = r1.getInt(r5, r7)     // Catch:{ all -> 0x0380 }
            fastScrollHintCount = r5     // Catch:{ all -> 0x0380 }
            java.lang.String r5 = "dontAskManageStorage"
            boolean r5 = r1.getBoolean(r5, r3)     // Catch:{ all -> 0x0380 }
            dontAskManageStorage = r5     // Catch:{ all -> 0x0380 }
            android.content.Context r5 = org.telegram.messenger.ApplicationLoader.applicationContext     // Catch:{ all -> 0x0380 }
            java.lang.String r7 = "Notifications"
            android.content.SharedPreferences r3 = r5.getSharedPreferences(r7, r3)     // Catch:{ all -> 0x0380 }
            r1 = r3
            java.lang.String r3 = "AllAccounts"
            boolean r3 = r1.getBoolean(r3, r4)     // Catch:{ all -> 0x0380 }
            showNotificationsForAllAccounts = r3     // Catch:{ all -> 0x0380 }
            configLoaded = r4     // Catch:{ all -> 0x0380 }
            monitor-exit(r0)     // Catch:{ all -> 0x0380 }
            return
        L_0x037e:
            monitor-exit(r0)     // Catch:{ all -> 0x0380 }
            return
        ...
        if (devicePerformanceClass == -1) {
            ...
            for (int i = 0; i < cpuCount; i++) {
                try {
                    ...
                    if (line != null) {
                        totalCpuFreq += Utilities.parseInt(line).intValue() / 1000;
                        freqResolved++;
                    }
                    reader.close();
                } catch (Throwable th) {
