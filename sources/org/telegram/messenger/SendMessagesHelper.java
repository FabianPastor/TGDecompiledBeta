...
public class SendMessagesHelper implements NotificationCenterDelegate {
    ...
    private LocationProvider locationProvider = new LocationProvider(new C05381());
    ...
    class C05381 implements LocationProviderDelegate {
        C05381() {
        }
    ...
    public static class LocationProvider {
        ...
        public void start() {
            ...
            this.locationQueryCancelRunnable = new C05671();
    ...
    public SendMessagesHelper(int instance) {
        ...
        AndroidUtilities.runOnUIThread(new C05482());
    }
    ...
    public int editMessage(MessageObject messageObject, String message, boolean searchLinks, final BaseFragment fragment, ArrayList<MessageEntity> entities, final Runnable callback) {
        ...
        return ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
            ...
            public void run(TLObject response, final TL_error error) {
                AndroidUtilities.runOnUIThread(new C05581());
                if (error == null) {
...
*/
                                ...
                                if (null == null) {
                                    ...
                                    MessagesStorage.getInstance(SendMessagesHelper.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            AndroidUtilities.runOnUIThread(new C05231());
                                        }
                                    });
                                }
                            }
            ...
            if (paths == null || originalPaths == null || paths.size() == originalPaths.size()) {
                ...
                new Thread(new Runnable() {
                    ...
                    class C05361 implements Runnable {
                        ...
                        public void run() {
                            try {
                                Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString("UnsupportedAttachment", C0493R.string.UnsupportedAttachment), 0).show();
                            } catch (Throwable e) {
                                FileLog.m3e(e);
                            }
                        }
    ...
    public static void prepareSendingText(final String text, final long dialog_id) {
        ...
        MessagesStorage.getInstance(currentAccount).getStorageQueue().postRunnable(new Runnable() {
            ...
            public void run() {
                Utilities.stageQueue.postRunnable(new C05401());
            }
        });
    }
        ...
        if (!media.isEmpty()) {
            ...
            mediaSendQueue.postRunnable(new Runnable() {
                ...
                class C05422 implements Runnable {
                    ...
                    C05422(TL_document tL_document, String str, SendingMediaInfo sendingMediaInfo, HashMap hashMap) {
                ...
                class C05433 implements Runnable {
                    final /* synthetic */ SendingMediaInfo val$info;
                    final /* synthetic */ boolean val$needDownloadHttpFinal;
                    final /* synthetic */ HashMap val$params;
                    final /* synthetic */ TL_photo val$photoFinal;

                    C05433(TL_photo tL_photo, boolean z, SendingMediaInfo sendingMediaInfo, HashMap hashMap) {
                ...
                class C05444 implements Runnable {
                    ...
                    C05444(Bitmap bitmap, String str, TL_document tL_document, VideoEditedInfo videoEditedInfo, String str2, SendingMediaInfo sendingMediaInfo, HashMap hashMap) {
                ...
                class C05455 implements Runnable {
                    final /* synthetic */ SendingMediaInfo val$info;
                    final /* synthetic */ HashMap val$params;
                    final /* synthetic */ TL_photo val$photoFinal;

                    C05455(TL_photo tL_photo, SendingMediaInfo sendingMediaInfo, HashMap hashMap) {
                        this.val$photoFinal = tL_photo;
                        this.val$info = sendingMediaInfo;
                        this.val$params = hashMap;
                    }
                ...
                class C05466 implements Runnable {
