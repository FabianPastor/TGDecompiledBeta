...
public class SendMessagesHelper implements NotificationCenterDelegate {
            ...
            public void onLocationChanged(Location location) {
                if (location != null && LocationProvider.this.locationQueryCancelRunnable != null) {
                    if (BuildVars.LOGS_ENABLED) {
                        FileLog.m10d("found location " + location);
                    }
                    ...
                    if (file != null && media != null) {
                        ...
                        if (message.type == 4) {
                            ...
                            if (index >= 0) {
                                ...
                                if (inputEncryptedFile.var_id == 1) {
                        ...
                        if (decryptedMessage != null) {
                            ...
                            decryptedMessage.media.var_iv = (byte[]) args[4];
                            if (message.type == 4) {
    ...
    final /* synthetic */ void lambda$null$1$SendMessagesHelper(TL_photo photo, MessageObject messageObject, File cacheFile, DelayedMessage message, String path) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m11e("can't load image " + path + " to file " + cacheFile.toString());
        }
        message.markAsError();
    }
    ...
    public void processForwardFromMyName(MessageObject messageObject, long did) {
        if (messageObject != null) {
            ...
            if (messageObject.messageOwner.media == null || (messageObject.messageOwner.media instanceof TL_messageMediaEmpty) || (messageObject.messageOwner.media instanceof TL_messageMediaWebPage) || (messageObject.messageOwner.media instanceof TL_messageMediaGame) || (messageObject.messageOwner.media instanceof TL_messageMediaInvoice)) {
                ...
                user.var_id = messageObject.messageOwner.media.user_id;
    ...
    public void sendScreenshotMessage(User user, int messageId, Message resendMessage) {
        if (user != null && messageId != 0 && user.var_id != UserConfig.getInstance(this.currentAccount).getClientUserId()) {
            Message message;
            TLObject req = new TL_messages_sendScreenshotNotification();
            req.peer = new TL_inputPeerUser();
            req.peer.access_hash = user.access_hash;
            req.peer.user_id = user.var_id;
            if (resendMessage != null) {
                ...
                message.dialog_id = (long) user.var_id;
                message.unread = true;
                message.out = true;
                ...
                message.to_id.user_id = user.var_id;
        ...
        if (document != null) {
            if (((int) peer) == 0) {
                if (MessagesController.getInstance(this.currentAccount).getEncryptedChat(Integer.valueOf((int) (peer >> 32))) != null) {
                    ...
                    newDocument.var_id = document.var_id;
                    ...
                    if (document.thumb instanceof TL_photoSize) {
                        ...
                        if (file.exists()) {
                            try {
                                ...
                                newDocument.thumb.var_w = document.thumb.var_w;
                                newDocument.thumb.var_h = document.thumb.var_h;
                ...
                if (msgObj.getId() > 0 && !msgObj.needDrawBluredPreview()) {
                    if (canSendStickers || !(msgObj.isSticker() || msgObj.isGif() || msgObj.isGame())) {
                        if (canSendMedia || !((msgObj.messageOwner.media instanceof TL_messageMediaPhoto) || (msgObj.messageOwner.media instanceof TL_messageMediaDocument))) {
                            ...
                            if (BuildVars.LOGS_ENABLED) {
                                FileLog.m10d("forward message user_id = " + inputPeer.user_id + " chat_id = " + inputPeer.chat_id + " channel_id = " + inputPeer.channel_id + " access_hash = " + inputPeer.access_hash);
                            }
        ...
        if (error == null) {
            ...
            while (a1 < updates.updates.size()) {
                ...
                if (update instanceof TL_updateMessageID) {
                    ...
                    newMessagesByIds.put(updateMessageID.var_id, updateMessageID.random_id);
            ...
            while (a1 < updates.updates.size()) {
                ...
                if ((update instanceof TL_updateNewMessage) || (update instanceof TL_updateNewChannelMessage)) {
                    ...
                    long random_id = newMessagesByIds.get(message.var_id);
                    if (random_id != 0) {
    ...
    final /* synthetic */ void lambda$null$5$SendMessagesHelper(Message newMsgObj1, long peer, int oldId, Message message) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(oldId), Integer.valueOf(message.var_id), message, Long.valueOf(peer), Long.valueOf(0));
    ...
    final /* synthetic */ void lambda$null$8$SendMessagesHelper(Message newMsgObj1) {
        ...
        NotificationCenter.getInstance(this.currentAccount).postNotificationName(NotificationCenter.messageSendError, Integer.valueOf(newMsgObj1.var_id));
        processSentMessage(newMsgObj1.var_id);
        removeFromSendingMessages(newMsgObj1.var_id);
    }
            ...
            if ((type >= 1 && type <= 3) || (type >= 5 && type <= 8)) {
                ...
                if (type == 2) {
                    ...
                    if (photo.access_hash == 0) {
                        ...
                        media.var_id = new TL_inputPhoto();
                        media.var_id.var_id = photo.var_id;
                        media.var_id.access_hash = photo.access_hash;
                        media.var_id.file_reference = photo.file_reference;
                        if (media.var_id.file_reference == null) {
                            media.var_id.file_reference = new byte[0];
                        }
                        inputMedia = media;
                    }
                    ...
                    if (document.access_hash == 0) {
                        ...
                        media.var_id = new TL_inputDocument();
                        media.var_id.var_id = document.var_id;
                        media.var_id.access_hash = document.access_hash;
                        media.var_id.file_reference = document.file_reference;
                        if (media.var_id.file_reference == null) {
                            media.var_id.file_reference = new byte[0];
                        }
                        inputMedia = media;
                ...
                request.var_id = messageObject.getId();
    ...
    private void sendMessage(String message, String caption, MessageMedia location, TL_photo photo, VideoEditedInfo videoEditedInfo, User user, TL_document document, TL_game game, TL_messageMediaPoll poll, long peer, String path, MessageObject reply_to_msg, WebPage webPage, boolean searchLinks, MessageObject retryMessageObject, ArrayList<MessageEntity> entities, ReplyMarkup replyMarkup, HashMap<String, String> params, int ttl, Object parentObject) {
        ...
        if ((user == null || user.phone != null) && peer != 0) {
                    ...
                    if (retryMessageObject.isForwarded()) {
                        ...
                        if (retryMessageObject.type == 0) {
                            ...
                            try {
                                ...
                                user2.var_id = newMsg.media.user_id;
                                type = 6;
                                user = user2;
                            } catch (Exception e2) {
                                e = e2;
            ...
            if (message != null) {
                ...
                newMsg.media.user_id = user.var_id;
                                ...
                                if (attribute instanceof TL_documentAttributeSticker) {
                                    ...
                                    if (attribute.stickerset != null) {
                                        ...
                                        if (attribute.stickerset instanceof TL_inputStickerSetShortName) {
                                            ...
                                            name = DataQuery.getInstance(this.currentAccount).getStickerSetName(attribute.stickerset.var_id);
                                        }
            ...
            try {
                ...
                if (groupId == 0) {
                    ...
                    if (delayedMessage == null) {
                        delayedMessage2 = new DelayedMessage(peer);
                        delayedMessage2.initForGroup(groupId);
                    ...
                    if (isFinalGroupMedia) {
                        delayedMessage2.finalGroupMessage = newMsg.var_id;
                    }
                    delayedMessage = delayedMessage2;
                }
                try {
                    if (BuildVars.LOGS_ENABLED && sendToPeer != null) {
                        FileLog.m10d("send message user_id = " + sendToPeer.user_id + " chat_id = " + sendToPeer.chat_id + " channel_id = " + sendToPeer.channel_id + " access_hash = " + sendToPeer.access_hash);
                    }
                    boolean performMediaUpload = false;
                    ...
                    if (type == 0 || !(type != 9 || message == null || encryptedChat == null)) {
                        if (encryptedChat != null) {
                            TL_decryptedMessage reqSend2;
                            if (AndroidUtilities.getPeerLayerVersion(encryptedChat.layer) >= 73) {
                                reqSend2 = new TL_decryptedMessage();
                            } else {
                                reqSend2 = new TL_decryptedMessage_layer45();
                            }
                            reqSend2.ttl = newMsg.ttl;
                            if (!(entities == null || entities.isEmpty())) {
                                reqSend2.entities = entities;
                                reqSend2.flags |= 128;
                            }
                            if (newMsg.reply_to_random_id != 0) {
                                reqSend2.reply_to_random_id = newMsg.reply_to_random_id;
                                reqSend2.flags |= 8;
                            }
                            if (params != null) {
                                if (params.get("bot_name") != null) {
                                    reqSend2.via_bot_name = (String) params.get("bot_name");
                                    reqSend2.flags |= 2048;
                                }
                            }
                            ...
                            if (webPage == null || webPage.url == null) {
                                reqSend2.media = new TL_decryptedMessageMediaEmpty();
                            } else {
                                reqSend2.media = new TL_decryptedMessageMediaWebPage();
                                reqSend2.media.url = webPage.url;
                                reqSend2.flags |= 512;
                            }
                            SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend2, newMsgObj.messageOwner, encryptedChat, null, null, newMsgObj);
                            if (retryMessageObject == null) {
                                DataQuery.getInstance(this.currentAccount).cleanDraft(peer, false);
                            }
                            delayedMessage2 = delayedMessage;
                        } else if (sendToPeers != null) {
                            TL_messages_sendBroadcast reqSend3 = new TL_messages_sendBroadcast();
                            random_ids = new ArrayList();
                            for (a = 0; a < sendToPeers.size(); a++) {
                                random_ids.add(Long.valueOf(Utilities.random.nextLong()));
                            }
                            reqSend3.message = message;
                            reqSend3.contacts = sendToPeers;
                            reqSend3.media = new TL_inputMediaEmpty();
                            reqSend3.random_id = random_ids;
                            performSendMessageRequest(reqSend3, newMsgObj, null, null, parentObject);
                            delayedMessage2 = delayedMessage;
                        } else {
                            TL_messages_sendMessage reqSend4 = new TL_messages_sendMessage();
                            reqSend4.message = message;
                            reqSend4.clear_draft = retryMessageObject == null;
                            ...
                            if (newMsg.reply_to_msg_id != 0) {
                                reqSend4.flags |= 1;
                                reqSend4.reply_to_msg_id = newMsg.reply_to_msg_id;
                            }
                            if (!searchLinks) {
                                reqSend4.no_webpage = true;
                            }
                            if (!(entities == null || entities.isEmpty())) {
                                reqSend4.entities = entities;
                                reqSend4.flags |= 8;
                            }
                            performSendMessageRequest(reqSend4, newMsgObj, null, null, parentObject);
                            if (retryMessageObject == null) {
                                DataQuery.getInstance(this.currentAccount).cleanDraft(peer, false);
                            }
                            delayedMessage2 = delayedMessage;
                        ...
                        if (type == 4) {
                            ...
                            reqSend.random_id.add(Long.valueOf(newMsg.random_id));
                            if (retryMessageObject.getId() >= 0) {
                                reqSend.var_id.add(Integer.valueOf(retryMessageObject.getId()));
                            } else if (retryMessageObject.messageOwner.fwd_msg_id != 0) {
                                reqSend.var_id.add(Integer.valueOf(retryMessageObject.messageOwner.fwd_msg_id));
                            } else if (retryMessageObject.messageOwner.fwd_from != null) {
                                reqSend.var_id.add(Integer.valueOf(retryMessageObject.messageOwner.fwd_from.channel_post));
                            }
                        ...
                        if (type == 9) {
                            ...
                            reqSend.var_id = (String) params.get(TtmlNode.ATTR_ID);
                            if (retryMessageObject == null) {
                        ...
                        if (type == 1) {
                            ...
                            uploadedDocument = new TL_inputMediaUploadedDocument();
                            uploadedDocument.mime_type = document2.mime_type;
                            uploadedDocument.attributes = document2.attributes;
                            ...
                            if (document2.access_hash == 0) {
                                ...
                                media = new TL_inputMediaDocument();
                                media.var_id = new TL_inputDocument();
                                media.var_id.var_id = document2.var_id;
                                media.var_id.access_hash = document2.access_hash;
                                media.var_id.file_reference = document2.file_reference;
                                if (media.var_id.file_reference == null) {
                                    media.var_id.file_reference = new byte[0];
                                }
                                inputMedia = media;
                            ...
                            if (type == 7 || type == 9) {
                                ...
                                if (!(http || uploadedMedia == null)) {
                                    ...
                                    delayedMessage2.location = document2.thumb.location;
                                    delayedMessage2.parentObject = parentObject;
                                    delayedMessage2.inputUploadMedia = uploadedMedia;
                                    delayedMessage2.performMediaUpload = performMediaUpload;
                                }
                            } else if (type == 8) {
                                uploadedDocument = new TL_inputMediaUploadedDocument();
                        ...
                        if (sendToPeers != null) {
                            ...
                            if (delayedMessage2.sendRequest != null) {
                                request = (TL_messages_sendMultiMedia) delayedMessage2.sendRequest;
                            } else {
                            ...
                            delayedMessage2.parentObjects.add(parentObject);
                            delayedMessage2.locations.add(delayedMessage2.location);
                        ...
                        if (groupId != 0) {
                            ...
                            performSendMessageRequest(reqSend, newMsgObj, null, delayedMessage2, parentObject);
                        } else if (type == 2) {
                            if (performMediaUpload) {
                                performSendDelayedMessage(delayedMessage2);
                            } else {
                                performSendMessageRequest(reqSend, newMsgObj, originalPath, null, true, delayedMessage2, parentObject);
                            }
                        } else if (type == 3) {
                            if (performMediaUpload) {
                                performSendDelayedMessage(delayedMessage2);
                            ...
                            if (!performMediaUpload || delayedMessage2 == null) {
                                performSendMessageRequest(reqSend, newMsgObj, originalPath, delayedMessage2, parentObject);
                            } else {
                                performSendDelayedMessage(delayedMessage2);
                            }
                        ...
                        if (AndroidUtilities.getPeerLayerVersion(encryptedChat.layer) >= 73) {
                            reqSend5 = new TL_decryptedMessage();
                            if (groupId != 0) {
                                reqSend5.grouped_id = groupId;
                                reqSend5.flags |= 131072;
                            }
                        } else {
                            reqSend5 = new TL_decryptedMessage_layer45();
                        }
                        reqSend5.ttl = newMsg.ttl;
                        if (!(entities == null || entities.isEmpty())) {
                            reqSend5.entities = entities;
                            reqSend5.flags |= 128;
                        }
                        if (newMsg.reply_to_random_id != 0) {
                            reqSend5.reply_to_random_id = newMsg.reply_to_random_id;
                            reqSend5.flags |= 8;
                        }
                        reqSend5.flags |= 512;
                        if (params != null) {
                            if (params.get("bot_name") != null) {
                                reqSend5.via_bot_name = (String) params.get("bot_name");
                                reqSend5.flags |= 2048;
                            }
                        }
                        reqSend5.random_id = newMsg.random_id;
                        reqSend5.message = TtmlNode.ANONYMOUS_REGION_ID;
                        if (type == 1) {
                            if (location instanceof TL_messageMediaVenue) {
                                reqSend5.media = new TL_decryptedMessageMediaVenue();
                                reqSend5.media.address = location.address;
                                reqSend5.media.title = location.title;
                                reqSend5.media.provider = location.provider;
                                reqSend5.media.venue_id = location.venue_id;
                            } else {
                                reqSend5.media = new TL_decryptedMessageMediaGeoPoint();
                            }
                            reqSend5.media.lat = location.geo.lat;
                            reqSend5.media._long = location.geo._long;
                            SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend5, newMsgObj.messageOwner, encryptedChat, null, null, newMsgObj);
                            delayedMessage2 = delayedMessage;
                        } else {
                            if (type == 2 || (type == 9 && photo != null)) {
                                ...
                                reqSend5.media = new TL_decryptedMessageMediaPhoto();
                                reqSend5.media.caption = caption;
                                if (small.bytes != null) {
                                    ((TL_decryptedMessageMediaPhoto) reqSend5.media).thumb = small.bytes;
                                } else {
                                    ((TL_decryptedMessageMediaPhoto) reqSend5.media).thumb = new byte[0];
                                }
                                reqSend5.media.thumb_h = small.var_h;
                                reqSend5.media.thumb_w = small.var_w;
                                reqSend5.media.var_w = big.var_w;
                                reqSend5.media.var_h = big.var_h;
                                reqSend5.media.size = big.size;
                                if (big.location.key == null || groupId != 0) {
                                    if (delayedMessage == null) {
                                        ...
                                        delayedMessage2.type = 0;
                                        delayedMessage2.originalPath = originalPath;
                                        delayedMessage2.sendEncryptedRequest = reqSend5;
                                        delayedMessage2.obj = newMsgObj;
                                        delayedMessage2.parentObject = parentObject;
                                    ...
                                    encryptedFile.var_id = big.location.volume_id;
                                    encryptedFile.access_hash = big.location.secret;
                                    reqSend5.media.key = big.location.key;
                                    reqSend5.media.var_iv = big.location.var_iv;
                                    SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend5, newMsgObj.messageOwner, encryptedChat, encryptedFile, null, newMsgObj);
                                }
                            } else if (type == 3) {
                                ...
                                if (MessageObject.isNewGifDocument(document2) || MessageObject.isRoundVideoDocument(document2)) {
                                    reqSend5.media = new TL_decryptedMessageMediaDocument();
                                    reqSend5.media.attributes = document2.attributes;
                                    if (document2.thumb == null || document2.thumb.bytes == null) {
                                        ((TL_decryptedMessageMediaDocument) reqSend5.media).thumb = new byte[0];
                                    } else {
                                        ((TL_decryptedMessageMediaDocument) reqSend5.media).thumb = document2.thumb.bytes;
                                    }
                                } else {
                                    reqSend5.media = new TL_decryptedMessageMediaVideo();
                                    if (document2.thumb == null || document2.thumb.bytes == null) {
                                        ((TL_decryptedMessageMediaVideo) reqSend5.media).thumb = new byte[0];
                                    } else {
                                        ((TL_decryptedMessageMediaVideo) reqSend5.media).thumb = document2.thumb.bytes;
                                    }
                                }
                                reqSend5.media.caption = caption;
                                reqSend5.media.mime_type = MimeTypes.VIDEO_MP4;
                                reqSend5.media.size = document2.size;
                                for (a = 0; a < document2.attributes.size(); a++) {
                                    attribute = (DocumentAttribute) document2.attributes.get(a);
                                    if (attribute instanceof TL_documentAttributeVideo) {
                                        reqSend5.media.var_w = attribute.var_w;
                                        reqSend5.media.var_h = attribute.var_h;
                                        reqSend5.media.duration = attribute.duration;
                                        break;
                                    }
                                }
                                reqSend5.media.thumb_h = document2.thumb.var_h;
                                reqSend5.media.thumb_w = document2.thumb.var_w;
                                if (document2.key == null || groupId != 0) {
                                    ...
                                    encryptedFile = new TL_inputEncryptedFile();
                                    encryptedFile.var_id = document2.var_id;
                                    encryptedFile.access_hash = document2.access_hash;
                                    reqSend5.media.key = document2.key;
                                    reqSend5.media.var_iv = document2.var_iv;
                                    SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend5, newMsgObj.messageOwner, encryptedChat, encryptedFile, null, newMsgObj);
                                    delayedMessage2 = delayedMessage;
                                }
                            } else if (type == 6) {
                                reqSend5.media = new TL_decryptedMessageMediaContact();
                                reqSend5.media.phone_number = user.phone;
                                reqSend5.media.first_name = user.first_name;
                                reqSend5.media.last_name = user.last_name;
                                reqSend5.media.user_id = user.var_id;
                                SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend5, newMsgObj.messageOwner, encryptedChat, null, null, newMsgObj);
                                delayedMessage2 = delayedMessage;
                            } else if (type == 7 || (type == 9 && document2 != null)) {
                                if (MessageObject.isStickerDocument(document2)) {
                                    reqSend5.media = new TL_decryptedMessageMediaExternalDocument();
                                    reqSend5.media.var_id = document2.var_id;
                                    reqSend5.media.date = document2.date;
                                    reqSend5.media.access_hash = document2.access_hash;
                                    reqSend5.media.mime_type = document2.mime_type;
                                    reqSend5.media.size = document2.size;
                                    reqSend5.media.dc_id = document2.dc_id;
                                    reqSend5.media.attributes = document2.attributes;
                                    if (document2.thumb == null) {
                                        ((TL_decryptedMessageMediaExternalDocument) reqSend5.media).thumb = new TL_photoSizeEmpty();
                                        ((TL_decryptedMessageMediaExternalDocument) reqSend5.media).thumb.type = "s";
                                    } else {
                                        ((TL_decryptedMessageMediaExternalDocument) reqSend5.media).thumb = document2.thumb;
                                    }
                                    SecretChatHelper.getInstance(this.currentAccount).performSendEncryptedRequest(reqSend5, newMsgObj.messageOwner, encryptedChat, null, null, newMsgObj);
                                    delayedMessage2 = delayedMessage;
                                } else {
                                    ...
                                    if (document2.thumb == null || document2.thumb.bytes == null) {
                                        ((TL_decryptedMessageMediaDocument) reqSend5.media).thumb = new byte[0];
                                        reqSend5.media.thumb_h = 0;
                                        reqSend5.media.thumb_w = 0;
                                    } else {
                                        ((TL_decryptedMessageMediaDocument) reqSend5.media).thumb = document2.thumb.bytes;
                                        reqSend5.media.thumb_h = document2.thumb.var_h;
                                        reqSend5.media.thumb_w = document2.thumb.var_w;
                        ...
                        if (groupId != 0) {
                            ...
                            if (delayedMessage2.sendEncryptedRequest != null) {
                                request2 = (TL_messages_sendEncryptedMultiMedia) delayedMessage2.sendEncryptedRequest;
                            } else {
                            ...
                            delayedMessage2.originalPaths.add(originalPath);
                            delayedMessage2.performMediaUpload = true;
                            request2.messages.add(reqSend5);
                            encryptedFile = new TL_inputEncryptedFile();
                            encryptedFile.var_id = type == 3 ? 1 : 0;
            ...
            if (message.videoEditedInfo == null || !message.videoEditedInfo.needConvert()) {
                if (message.videoEditedInfo != null) {
                    if (message.videoEditedInfo.file != null) {
                        ...
                        decryptedMessage.media.var_iv = message.videoEditedInfo.var_iv;
                ...
                if (message.sendRequest != null) {
                    ...
                    if (media.file == null) {
                        ...
                        if (location == null) {
                            location = FileLoader.getDirectory(4) + "/" + document.var_id + ".mp4";
                        }
                        putToDelayedMessages(location, message);
                ...
                if (messageObject.getDocument() != null) {
                    if (message.videoEditedInfo != null) {
                        ...
                        if (documentLocation == null) {
                            documentLocation = FileLoader.getDirectory(4) + "/" + document.var_id + ".mp4";
                        }
                        if (message.sendRequest != null) {
    ...
    final /* synthetic */ void lambda$null$19$SendMessagesHelper(TLObject response, InputMedia inputMedia, DelayedMessage message) {
        ...
        if (response != null) {
            ...
            if ((inputMedia instanceof TL_inputMediaUploadedPhoto) && (messageMedia instanceof TL_messageMediaPhoto)) {
                ...
                inputMediaPhoto.var_id = new TL_inputPhoto();
                inputMediaPhoto.var_id.var_id = messageMedia.photo.var_id;
                inputMediaPhoto.var_id.access_hash = messageMedia.photo.access_hash;
                inputMediaPhoto.var_id.file_reference = messageMedia.photo.file_reference;
                ...
                inputMediaDocument.var_id = new TL_inputDocument();
                inputMediaDocument.var_id.var_id = messageMedia.document.var_id;
                inputMediaDocument.var_id.access_hash = messageMedia.document.access_hash;
                inputMediaDocument.var_id.file_reference = messageMedia.document.file_reference;
    ...
    protected void putToSendingMessages(Message message) {
        this.sendingMessages.put(message.var_id, message);
    }
    ...
    final /* synthetic */ void lambda$null$28$SendMessagesHelper(TL_error error, ArrayList parentObjects, TL_messages_sendMultiMedia req, ArrayList msgObjs, ArrayList originalPaths, DelayedMessage delayedMessage, TLObject response) {
        ...
        if (error == null) {
            ...
            while (a < updatesArr.size()) {
                ...
                if (update instanceof TL_updateMessageID) {
                    TL_updateMessageID updateMessageID = (TL_updateMessageID) update;
                    newIds.put(updateMessageID.random_id, Integer.valueOf(updateMessageID.var_id));
                    updatesArr.remove(a);
                    a--;
            ...
            for (i = 0; i < msgObjs.size(); i++) {
                ...
                sentMessages.add(message);
                newMsgObj.var_id = message.var_id;
    ...
    final /* synthetic */ void lambda$performSendMessageRequest$40$SendMessagesHelper(final TLObject req, Object parentObject, MessageObject msgObj, String originalPath, DelayedMessage parentMessage, boolean check, DelayedMessage delayedMessage, Message newMsgObj, TLObject response, TL_error error) {
        if (error != null && (((req instanceof TL_messages_sendMedia) || (req instanceof TL_messages_editMessage)) && FileRefController.isFileRefError(error.text))) {
            if (parentObject != null) {
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        SendMessagesHelper.this.removeFromSendingMessages(message.var_id);
    ...
    final /* synthetic */ void lambda$null$37$SendMessagesHelper(boolean isBroadcast, ArrayList sentMessages, Message newMsgObj, int oldId) {
        ...
        Object[] objArr = new Object[5];
        objArr[0] = Integer.valueOf(oldId);
        objArr[1] = Integer.valueOf(isBroadcast ? oldId : newMsgObj.var_id);
        objArr[2] = newMsgObj;
        objArr[3] = Long.valueOf(newMsgObj.dialog_id);
        objArr[4] = Long.valueOf(0);
        ...
        if (sentMessage != null) {
            ...
            if ((sentMessage.media instanceof TL_messageMediaPhoto) && sentMessage.media.photo != null && (newMsg.media instanceof TL_messageMediaPhoto) && newMsg.media.photo != null) {
                if (sentMessage.media.ttl_seconds == 0) {
                    MessagesStorage.getInstance(this.currentAccount).putSentFile(originalPath, sentMessage.media.photo, 0, "sent_" + sentMessage.to_id.channel_id + "_" + sentMessage.var_id);
                }
                    ...
                    for (a = 0; a < sentMessage.media.photo.sizes.size(); a++) {
                        ...
                        if (!(size == null || size.location == null || (size instanceof TL_photoSizeEmpty) || size.type == null)) {
                            ...
                            while (b < newMsg.media.photo.sizes.size()) {
                                ...
                                if (size2 == null || size2.location == null || size2.type == null || !((size2.location.volume_id == -2147483648L && size.type.equals(size2.type)) || (size.var_w == size2.var_w && size.var_h == size2.var_h))) {
                                    b++;
                                } else {
                                    ...
                                    if (!fileName.equals(fileName2)) {
                                        ...
                                        if (sentMessage.media.ttl_seconds != 0 || (sentMessage.media.photo.sizes.size() != 1 && size.var_w <= 90 && size.var_h <= 90)) {
                ...
                newMsg.media.photo.var_id = sentMessage.media.photo.var_id;
                ...
                if (MessageObject.isVideoMessage(sentMessage)) {
                    if (sentMessage.media.ttl_seconds == 0) {
                        MessagesStorage.getInstance(this.currentAccount).putSentFile(originalPath, sentMessage.media.document, 2, "sent_" + sentMessage.to_id.channel_id + "_" + sentMessage.var_id);
                    }
                    sentMessage.attachPath = newMsg.attachPath;
                    ...
                    MessagesStorage.getInstance(this.currentAccount).putSentFile(originalPath, sentMessage.media.document, 1, "sent_" + sentMessage.to_id.channel_id + "_" + sentMessage.var_id);
                }
                ...
                newMsg.media.document.var_id = sentMessage.media.document.var_id;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:178:0x040a  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:124:0x02dc  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:201:0x047b  */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x02e7  */
    /* JADX WARNING: Removed duplicated region for block: B:169:0x03bc A:{SYNTHETIC, Splitter: B:169:0x03bc} */
    /* JADX WARNING: Removed duplicated region for block: B:163:0x03ae A:{SYNTHETIC, Splitter: B:163:0x03ae} */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x00c6  */
    /* JADX WARNING: Removed duplicated region for block: B:60:0x0116  */
    /* JADX WARNING: Removed duplicated region for block: B:177:0x0407  */
    /* JADX WARNING: Removed duplicated region for block: B:68:0x0130  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:124:0x02dc  */
    /* JADX WARNING: Removed duplicated region for block: B:127:0x02e7  */
    /* JADX WARNING: Missing block: B:139:0x0347, code:
            if (r30.equals("flac") != false) goto L_0x0349;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            sentData = MessagesStorage.getInstance(currentAccount).getSentFile(originalPath, isEncrypted ? 1 : 4);
                            if (sentData != null) {
                            }
                            if (isEncrypted) {
                            }
                            sentData = MessagesStorage.getInstance(currentAccount).getSentFile(path + file.length(), isEncrypted ? 1 : 4);
                            if (sentData != null) {
                            }
                            ensureMediaThumbExists(currentAccount, document, path, null, 0);
                            if (document == null) {
                            }
                            if (caption == null) {
                            }
                ...
                if (document == null) {
                    ...
                    if (document.mime_type.equals("image/webp") && allowSticker && editingMessageObject == null) {
                        ...
                        if (bmOptions.outWidth != 0 && bmOptions.outHeight != 0 && bmOptions.outWidth <= 800 && bmOptions.outHeight <= 800) {
                            ...
                            attributeImageSize.var_w = bmOptions.outWidth;
                            attributeImageSize.var_h = bmOptions.outHeight;
        ...
        for (int a = 0; a < size; a++) {
            ...
            if (!isEncrypted) {
                ...
                if (sentData != null) {
                    document = sentData[0];
                    parentObject = sentData[1];
                    ensureMediaThumbExists(currentAccount, document, originalPath, null, 0);
                }
            }
            if (document == null) {
    ...
    static final /* synthetic */ void lambda$null$47$SendMessagesHelper() {
        try {
            Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString("UnsupportedAttachment", CLASSNAMER.string.UnsupportedAttachment), 0).show();
        } catch (Throwable e) {
            FileLog.m13e(e);
        }
    }
    ...
    static final /* synthetic */ void lambda$prepareSendingBotContextResult$50$SendMessagesHelper(BotInlineResult result, long dialog_id, int currentAccount, HashMap params, MessageObject reply_to_msg) {
                ...
                switch (obj) {
                    ...
                    case 5:
                        ...
                        switch (obj) {
                            ...
                            case 4:
                                ...
                                attributeVideo.var_w = wh[0];
                                attributeVideo.var_h = wh[1];
                            ...
                            case 5:
                                ...
                                TL_documentAttributeImageSize attributeImageSize = new TL_documentAttributeImageSize();
                                wh = MessageObject.getInlineResultWidthAndHeight(result);
                                attributeImageSize.var_w = wh[0];
                                attributeImageSize.var_h = wh[1];
                                document.attributes.add(attributeImageSize);
                        ...
                        if (document.thumb == null) {
                            ...
                            wh = MessageObject.getInlineResultWidthAndHeight(result);
                            document.thumb.var_w = wh[0];
                            document.thumb.var_h = wh[1];
                    ...
                    case 6:
                        ...
                        if (photo == null) {
                            ...
                            wh = MessageObject.getInlineResultWidthAndHeight(result);
                            photoSize.var_w = wh[0];
                            photoSize.var_h = wh[1];
                            photoSize.size = 1;
    ...
    public static void ensureMediaThumbExists(int currentAccount, TLObject object, String path, Uri uri, long startTime) {
        if (object instanceof TL_photo) {
            ...
            boolean smallExists = smallFile.exists();
            ...
            TL_document document = (TL_document) object;
            if (MessageObject.isVideoDocument(document) && !(document.thumb instanceof TL_photoSizeEmpty) && !FileLoader.getPathToAttach(document.thumb, true).exists()) {
                Bitmap thumb = createVideoThumbnail(path, startTime, false);
                if (thumb == null) {
                    thumb = ThumbnailUtils.createVideoThumbnail(path, 1);
                }
                document.thumb = ImageLoader.scaleAndSaveImage(document.thumb, thumb, 90.0f, 90.0f, 55, false);
            }
        }
    }
    ...
    /* JADX WARNING: Missing block: B:274:0x095a, code:
            if (r105.endsWith(".webp") != false) goto L_0x095c;
     */
    /* JADX WARNING: Missing block: B:347:0x0b37, code:
            if (r113.size() == 1) goto L_0x0b39;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static final /* synthetic */ void lambda$prepareSendingMedia$60$SendMessagesHelper(ArrayList media, long dialog_id, int currentAccount, boolean forceDocument, boolean groupPhotos, MessageObject editingMessageObject, MessageObject reply_to_msg, InputContentInfoCompat inputContent) {
                ...
                if (info.searchImage == null && !info.isVideo) {
                    ...
                    if (!(ImageLoader.shouldSendImageAsDocument(info.path, info.uri) || (tempPath == null && info.uri != null && (MediaController.isGif(info.uri) || MediaController.isWebp(info.uri))))) {
                        ...
                        if (!isEncrypted && info.ttl == 0) {
                            sentData = MessagesStorage.getInstance(currentAccount).getSentFile(originalPath, !isEncrypted ? 0 : 3);
                            if (sentData != null) {
                                photo = sentData[0];
                                parentObject = sentData[1];
                            }
                            ...
                            ensureMediaThumbExists(currentAccount, photo, info.path, info.uri, 0);
                        }
                        MediaSendPrepareWorker mediaSendPrepareWorker = new MediaSendPrepareWorker();
                        workers.put(info, mediaSendPrepareWorker);
                        if (photo != null) {
                            mediaSendPrepareWorker.parentObject = parentObject;
            ...
            if (info.searchImage != null) {
                if (info.searchImage.type == 1) {
                    ...
                    if (document == null) {
                        ...
                        if (document.thumb == null) {
                            document.thumb = new TL_photoSize();
                            document.thumb.var_w = info.searchImage.width;
                            document.thumb.var_h = info.searchImage.height;
                            document.thumb.size = 0;
                            document.thumb.location = new TL_fileLocationUnavailable();
                            document.thumb.type = "x";
                        }
                    ...
                    if (photo == null) {
                        ...
                        if (photo == null) {
                            ...
                            if (photo == null) {
                                ...
                                photo.file_reference = new byte[0];
                                TL_photoSize photoSize = new TL_photoSize();
                                photoSize.var_w = info.searchImage.width;
                                photoSize.var_h = info.searchImage.height;
                                photoSize.size = 0;
                                photoSize.location = new TL_fileLocationUnavailable();
                                photoSize.type = "x";
                                photo.sizes.add(photoSize);
                ...
                if (forceDocument || (videoEditedInfo == null && !info.path.endsWith("mp4"))) {
                    ...
                    parentObject = null;
                    if (!isEncrypted && info.ttl == 0) {
                        sentData = MessagesStorage.getInstance(currentAccount).getSentFile(originalPath, !isEncrypted ? 2 : 5);
                        if (sentData != null) {
                            document = sentData[0];
                            parentObject = sentData[1];
                            ensureMediaThumbExists(currentAccount, document, info.path, null, startTime);
                        }
                    }
                    if (document == null) {
                        TL_documentAttributeVideo attributeVideo;
                        thumb = createVideoThumbnail(info.path, startTime, false);
                        if (thumb == null) {
                        ...
                        if (videoEditedInfo == null || !videoEditedInfo.needConvert()) {
                            ...
                            if (videoEditedInfo.muted) {
                                ...
                                videoEditedInfo.originalWidth = attributeVideo.var_w;
                                videoEditedInfo.originalHeight = attributeVideo.var_h;
                                attributeVideo.var_w = videoEditedInfo.resultWidth;
                                attributeVideo.var_h = videoEditedInfo.resultHeight;
                            } else {
                                ...
                                if (videoEditedInfo.rotationValue == 90 || videoEditedInfo.rotationValue == 270) {
                                    attributeVideo.var_w = videoEditedInfo.resultHeight;
                                    attributeVideo.var_h = videoEditedInfo.resultWidth;
                                } else {
                                    attributeVideo.var_w = videoEditedInfo.resultWidth;
                                    attributeVideo.var_h = videoEditedInfo.resultHeight;
                                }
                ...
                if (forceDocument || ImageLoader.shouldSendImageAsDocument(info.path, info.uri)) {
                    ...
                    if (tempPath != null) {
                        ...
                        extension = TtmlNode.ANONYMOUS_REGION_ID;
                    }
                } else {
                    if (tempPath != null) {
                        if (!tempPath.endsWith(".gif")) {
                ...
                if (isDocument) {
                    ...
                    if (photo != null) {
                        ...
                        if (currentPhotoObject != null) {
                            ...
                            int photoHeight = photoWidth + AndroidUtilities.m9dp(100.0f);
                            ...
                            float scale = ((float) currentPhotoObject.var_w) / ((float) photoWidth);
                            int w = (int) (((float) currentPhotoObject.var_w) / scale);
                            int h = (int) (((float) currentPhotoObject.var_h) / scale);
                            if (w == 0) {
                            ...
                            if (h > photoHeight) {
                                ...
                                float hScale = ((float) currentPhotoObject.var_h) / ((float) h);
                                if (((float) currentPhotoObject.var_w) / hScale < ((float) photoWidth)) {
                                    w = (int) (((float) currentPhotoObject.var_w) / hScale);
                                }
                            }
                            keyFinal[0] = String.format(Locale.US, "%d_%d@%d_%d", new Object[]{Long.valueOf(currentPhotoObject.location.volume_id), Integer.valueOf(currentPhotoObject.location.local_id), Integer.valueOf((int) (((float) w) / AndroidUtilities.density)), Integer.valueOf((int) (((float) h) / AndroidUtilities.density))});
                            Options opts = new Options();
                            opts.inJustDecodeBounds = true;
                            File file2 = FileLoader.getPathToAttach(currentPhotoObject);
                            ...
                            if (VERSION.SDK_INT >= 21) {
                                ...
                                bitmapFinal[0] = BitmapFactory.decodeStream(fileInputStream, null, opts);
                                fileInputStream.close();
                            }
                        }
                        if (groupPhotos) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m10d("total send time = " + (System.currentTimeMillis() - beginTime));
        }
    }
    ...
    private static void fillVideoAttribute(String videoPath, TL_documentAttributeVideo attributeVideo, VideoEditedInfo videoEditedInfo) {
        ...
        try {
            ...
            try {
                ...
                if (width != null) {
                    attributeVideo.var_w = Integer.parseInt(width);
                }
                String height = mediaMetadataRetriever2.extractMetadata(19);
                if (height != null) {
                    attributeVideo.var_h = Integer.parseInt(height);
                }
                ...
                if (VERSION.SDK_INT >= 17) {
                    ...
                    if (rotation != null) {
                        ...
                        if (videoEditedInfo != null) {
                            ...
                            int temp = attributeVideo.var_w;
                            attributeVideo.var_w = attributeVideo.var_h;
                            attributeVideo.var_h = temp;
                        }
                    }
                }
                infoObtained = true;
        ...
        if (infoObtained) {
            try {
                ...
                if (mp != null) {
                    ...
                    attributeVideo.var_w = mp.getVideoWidth();
                    attributeVideo.var_h = mp.getVideoHeight();
                    mp.release();
                }
            } catch (Throwable e2222) {
                FileLog.m13e(e2222);
    ...
    private static Bitmap createVideoThumbnail(String filePath, long time, boolean quality) {
        Bitmap bitmap = null;
        ...
        float size = quality ? (float) Math.min(180, Math.min(AndroidUtilities.displaySize.x, AndroidUtilities.displaySize.y) / 4) : 90.0f;
        if (((float) max) > size) {
    ...
    static final /* synthetic */ void lambda$prepareSendingVideo$62$SendMessagesHelper(VideoEditedInfo info, String videoPath, long dialog_id, long duration, int ttl, int currentAccount, int height, int width, long estimatedSize, CharSequence caption, MessageObject editingMessageObject, MessageObject reply_to_msg, ArrayList entities) {
        ...
        if (!isEncrypted && ttl == 0) {
            ...
            if (sentData != null) {
                document = sentData[0];
                parentObject = sentData[1];
                ensureMediaThumbExists(currentAccount, document, videoPath, null, startTime);
            }
        }
        if (document == null) {
            TL_documentAttributeVideo attributeVideo;
            thumb = createVideoThumbnail(videoPath, startTime, false);
            Bitmap qualityThumb = isRound ? createVideoThumbnail(videoPath, startTime, true) : null;
            if (thumb == null) {
            ...
            if (videoEditedInfo == null || !videoEditedInfo.needConvert()) {
                ...
                if (videoEditedInfo.muted) {
                    ...
                    if (videoEditedInfo.rotationValue == 90 || videoEditedInfo.rotationValue == 270) {
                        attributeVideo.var_w = height;
                        attributeVideo.var_h = width;
                    } else {
                        attributeVideo.var_w = width;
                        attributeVideo.var_h = height;
                    }
                }
