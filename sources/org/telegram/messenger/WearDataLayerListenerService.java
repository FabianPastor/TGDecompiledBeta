    ...
    public void onChannelOpened(Channel ch) {
        ...
        if (apiClient.blockingConnect().isSuccess()) {
            ...
            try {
                ...
                NotificationCenterDelegate c18201;
                    ...
                    if (UserConfig.getInstance(this.currentAccount).isClientActivated()) {
                        ...
                        if (user.photo != null) {
                            ...
                            if (!photo.exists()) {
                                ...
                                c18201 = new NotificationCenterDelegate() {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        JSONObject jSONObject = new JSONObject(new String(messageEvent.getData(), C0539C.UTF8_NAME));
