...
public class WearDataLayerListenerService extends WearableListenerService {
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:93:0x0242 */
    /* JADX WARNING: Missing exception handler attribute for start block: B:98:0x0247 */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:42:0x014e A[Catch:{ Exception -> 0x024a }] */
    /* JADX WARNING: Removed duplicated region for block: B:43:0x0154 A[Catch:{ Exception -> 0x024a }] */
    ...
    public void onChannelOpened(com.google.android.gms.wearable.Channel r12) {
        ...
        L_0x0040:
            ...
            boolean r2 = r2.equals(r1)     // Catch:{ Exception -> 0x024a }
            r3 = 2
            r4 = 1
            r5 = 0
            if (r2 == 0) goto L_0x0100
            java.io.DataOutputStream r1 = new java.io.DataOutputStream     // Catch:{ Exception -> 0x024a }
            java.io.BufferedOutputStream r2 = new java.io.BufferedOutputStream     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.common.api.PendingResult r6 = r12.getOutputStream(r0)     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.common.api.Result r6 = r6.await()     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.wearable.Channel$GetOutputStreamResult r6 = (com.google.android.gms.wearable.Channel.GetOutputStreamResult) r6     // Catch:{ Exception -> 0x024a }
            java.io.OutputStream r6 = r6.getOutputStream()     // Catch:{ Exception -> 0x024a }
            r2.<init>(r6)     // Catch:{ Exception -> 0x024a }
            r1.<init>(r2)     // Catch:{ Exception -> 0x024a }
            int r2 = r11.currentAccount     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.UserConfig r2 = org.telegram.messenger.UserConfig.getInstance(r2)     // Catch:{ Exception -> 0x024a }
            boolean r2 = r2.isClientActivated()     // Catch:{ Exception -> 0x024a }
            if (r2 == 0) goto L_0x00f5
            int r2 = r11.currentAccount     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.UserConfig r2 = org.telegram.messenger.UserConfig.getInstance(r2)     // Catch:{ Exception -> 0x024a }
            org.telegram.tgnet.TLRPC$User r2 = r2.getCurrentUser()     // Catch:{ Exception -> 0x024a }
            int r6 = r2.id     // Catch:{ Exception -> 0x024a }
            r1.writeInt(r6)     // Catch:{ Exception -> 0x024a }
            java.lang.String r6 = r2.first_name     // Catch:{ Exception -> 0x024a }
            r1.writeUTF(r6)     // Catch:{ Exception -> 0x024a }
            java.lang.String r6 = r2.last_name     // Catch:{ Exception -> 0x024a }
            r1.writeUTF(r6)     // Catch:{ Exception -> 0x024a }
            java.lang.String r6 = r2.phone     // Catch:{ Exception -> 0x024a }
            r1.writeUTF(r6)     // Catch:{ Exception -> 0x024a }
            org.telegram.tgnet.TLRPC$UserProfilePhoto r6 = r2.photo     // Catch:{ Exception -> 0x024a }
            if (r6 == 0) goto L_0x00f1
            org.telegram.tgnet.TLRPC$FileLocation r6 = r6.photo_small     // Catch:{ Exception -> 0x024a }
            java.io.File r4 = org.telegram.messenger.FileLoader.getPathToAttach(r6, r4)     // Catch:{ Exception -> 0x024a }
            java.util.concurrent.CyclicBarrier r6 = new java.util.concurrent.CyclicBarrier     // Catch:{ Exception -> 0x024a }
            r6.<init>(r3)     // Catch:{ Exception -> 0x024a }
            boolean r3 = r4.exists()     // Catch:{ Exception -> 0x024a }
            if (r3 != 0) goto L_0x00be
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$8U0-_yHRCazmJqUiYuBHLzQc1Zw r3 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$8U0-_yHRCazmJqUiYuBHLzQc1Zw     // Catch:{ Exception -> 0x024a }
            r3.<init>(r4, r6)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$ydGZBP8a_DgE_oUlcF-P734PK4E r7 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$ydGZBP8a_DgE_oUlcF-P734PK4E     // Catch:{ Exception -> 0x024a }
            r7.<init>(r3, r2)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.AndroidUtilities.runOnUIThread(r7)     // Catch:{ Exception -> 0x024a }
            r7 = 10
        ...
        L_0x00b6:
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$-E3pdqIpzem9HMQdYOOW1Pr-JLY r2 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$-E3pdqIpzem9HMQdYOOW1Pr-JLY     // Catch:{ Exception -> 0x024a }
            r2.<init>(r3)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.AndroidUtilities.runOnUIThread(r2)     // Catch:{ Exception -> 0x024a }
        L_0x00be:
            boolean r2 = r4.exists()     // Catch:{ Exception -> 0x024a }
            if (r2 == 0) goto L_0x00ed
            long r2 = r4.length()     // Catch:{ Exception -> 0x024a }
            r6 = 52428800(0x3200000, double:2.5903269E-316)
            int r8 = (r2 > r6 ? 1 : (r2 == r6 ? 0 : -1))
            if (r8 > 0) goto L_0x00ed
            long r2 = r4.length()     // Catch:{ Exception -> 0x024a }
            int r3 = (int) r2     // Catch:{ Exception -> 0x024a }
            byte[] r2 = new byte[r3]     // Catch:{ Exception -> 0x024a }
            java.io.FileInputStream r5 = new java.io.FileInputStream     // Catch:{ Exception -> 0x024a }
            r5.<init>(r4)     // Catch:{ Exception -> 0x024a }
            java.io.DataInputStream r4 = new java.io.DataInputStream     // Catch:{ Exception -> 0x024a }
            r4.<init>(r5)     // Catch:{ Exception -> 0x024a }
            r4.readFully(r2)     // Catch:{ Exception -> 0x024a }
            r5.close()     // Catch:{ Exception -> 0x024a }
            r1.writeInt(r3)     // Catch:{ Exception -> 0x024a }
            r1.write(r2)     // Catch:{ Exception -> 0x024a }
            goto L_0x00f8
        L_0x00ed:
            r1.writeInt(r5)     // Catch:{ Exception -> 0x024a }
            goto L_0x00f8
        L_0x00f1:
            r1.writeInt(r5)     // Catch:{ Exception -> 0x024a }
            goto L_0x00f8
        L_0x00f5:
            r1.writeInt(r5)     // Catch:{ Exception -> 0x024a }
        L_0x00f8:
            r1.flush()     // Catch:{ Exception -> 0x024a }
            r1.close()     // Catch:{ Exception -> 0x024a }
            goto L_0x0254
        L_0x0100:
            ...
            int r1 = r11.currentAccount     // Catch:{ Exception -> 0x024a }
            org.telegram.tgnet.ConnectionsManager r1 = org.telegram.tgnet.ConnectionsManager.getInstance(r1)     // Catch:{ Exception -> 0x024a }
            r1.setAppPaused(r5, r5)     // Catch:{ Exception -> 0x024a }
            java.lang.String[] r1 = new java.lang.String[r4]     // Catch:{ Exception -> 0x024a }
            r1[r5] = r6     // Catch:{ Exception -> 0x024a }
            java.util.concurrent.CyclicBarrier r2 = new java.util.concurrent.CyclicBarrier     // Catch:{ Exception -> 0x024a }
            r2.<init>(r3)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$TyUn_inIn_bL15Zp21g9ds7kIqo r3 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$TyUn_inIn_bL15Zp21g9ds7kIqo     // Catch:{ Exception -> 0x024a }
            r3.<init>(r1, r2)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$1H-JF3ZpPL0EQHpem6g8cKThkx0 r6 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$1H-JF3ZpPL0EQHpem6g8cKThkx0     // Catch:{ Exception -> 0x024a }
            r6.<init>(r3)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.AndroidUtilities.runOnUIThread(r6)     // Catch:{ Exception -> 0x024a }
            r6 = 30
        ...
        L_0x012f:
            org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$--vZ1ZRAnaS9dH9su4DFTPSXoSU r2 = new org.telegram.messenger.-$$Lambda$WearDataLayerListenerService$--vZ1ZRAnaS9dH9su4DFTPSXoSU     // Catch:{ Exception -> 0x024a }
            r2.<init>(r3)     // Catch:{ Exception -> 0x024a }
            org.telegram.messenger.AndroidUtilities.runOnUIThread(r2)     // Catch:{ Exception -> 0x024a }
            java.io.DataOutputStream r2 = new java.io.DataOutputStream     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.common.api.PendingResult r3 = r12.getOutputStream(r0)     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.common.api.Result r3 = r3.await()     // Catch:{ Exception -> 0x024a }
            com.google.android.gms.wearable.Channel$GetOutputStreamResult r3 = (com.google.android.gms.wearable.Channel.GetOutputStreamResult) r3     // Catch:{ Exception -> 0x024a }
            java.io.OutputStream r3 = r3.getOutputStream()     // Catch:{ Exception -> 0x024a }
            r2.<init>(r3)     // Catch:{ Exception -> 0x024a }
            r3 = r1[r5]     // Catch:{ Exception -> 0x024a }
            if (r3 == 0) goto L_0x0154
            r1 = r1[r5]     // Catch:{ Exception -> 0x024a }
            r2.writeUTF(r1)     // Catch:{ Exception -> 0x024a }
            goto L_0x0159
        L_0x0154:
            java.lang.String r1 = ""
            r2.writeUTF(r1)     // Catch:{ Exception -> 0x024a }
        L_0x0159:
            r2.flush()     // Catch:{ Exception -> 0x024a }
            r2.close()     // Catch:{ Exception -> 0x024a }
            int r1 = r11.currentAccount     // Catch:{ Exception -> 0x024a }
            org.telegram.tgnet.ConnectionsManager r1 = org.telegram.tgnet.ConnectionsManager.getInstance(r1)     // Catch:{ Exception -> 0x024a }
            r1.setAppPaused(r4, r5)     // Catch:{ Exception -> 0x024a }
            goto L_0x0254
        L_0x016a:
            java.lang.String r2 = "/getChatPhoto"
            boolean r1 = r2.equals(r1)     // Catch:{ Exception -> 0x024a }
            if (r1 == 0) goto L_0x0254
            java.io.DataInputStream r1 = new java.io.DataInputStream     // Catch:{ Exception -> 0x0248 }
            com.google.android.gms.common.api.PendingResult r2 = r12.getInputStream(r0)     // Catch:{ Exception -> 0x0248 }
            com.google.android.gms.common.api.Result r2 = r2.await()     // Catch:{ Exception -> 0x0248 }
            com.google.android.gms.wearable.Channel$GetInputStreamResult r2 = (com.google.android.gms.wearable.Channel.GetInputStreamResult) r2     // Catch:{ Exception -> 0x0248 }
            java.io.InputStream r2 = r2.getInputStream()     // Catch:{ Exception -> 0x0248 }
            r1.<init>(r2)     // Catch:{ Exception -> 0x0248 }
            java.io.DataOutputStream r2 = new java.io.DataOutputStream     // Catch:{ all -> 0x0243 }
            com.google.android.gms.common.api.PendingResult r3 = r12.getOutputStream(r0)     // Catch:{ all -> 0x0243 }
            com.google.android.gms.common.api.Result r3 = r3.await()     // Catch:{ all -> 0x0243 }
            com.google.android.gms.wearable.Channel$GetOutputStreamResult r3 = (com.google.android.gms.wearable.Channel.GetOutputStreamResult) r3     // Catch:{ all -> 0x0243 }
            java.io.OutputStream r3 = r3.getOutputStream()     // Catch:{ all -> 0x0243 }
            r2.<init>(r3)     // Catch:{ all -> 0x0243 }
        ...
        L_0x0234:
            ...
            r1.close()     // Catch:{ Exception -> 0x0248 }
            goto L_0x0254
        L_0x023e:
            r3 = move-exception
