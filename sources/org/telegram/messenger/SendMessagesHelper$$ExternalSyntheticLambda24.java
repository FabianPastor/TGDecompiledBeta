...
public final /* synthetic */ class SendMessagesHelper$$ExternalSyntheticLambda24 implements Runnable {
    ...
    public /* synthetic */ SendMessagesHelper$$ExternalSyntheticLambda24(SendMessagesHelper sendMessagesHelper, String str, boolean z, TLObject tLObject, MessageObject messageObject, TLRPC.KeyboardButton keyboardButton, ChatActivity chatActivity, TwoStepVerificationActivity twoStepVerificationActivity, TLObject[] tLObjectArr, TLRPC.TL_error tL_error, TLRPC.InputCheckPasswordSRP inputCheckPasswordSRP, boolean z2) {
    ...
    public final void run() {
        this.f$0.m483lambda$sendCallback$29$orgtelegrammessengerSendMessagesHelper(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11);
    }
}
