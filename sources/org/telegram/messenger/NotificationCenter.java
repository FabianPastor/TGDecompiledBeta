...
public class NotificationCenter {
    ...
    static {
        ...
        int i44 = i43 + 1;
        totalEvents = i44;
        twoStepPasswordChanged = i43;
        int i45 = i44 + 1;
        totalEvents = i45;
        didSetOrRemoveTwoStepPassword = i44;
        int i46 = i45 + 1;
        totalEvents = i46;
        didRemoveTwoStepPassword = i45;
        int i47 = i46 + 1;
        totalEvents = i47;
        replyMessagesDidLoad = i46;
        int i48 = i47 + 1;
        totalEvents = i48;
        didLoadPinnedMessages = i47;
        int i49 = i48 + 1;
        totalEvents = i49;
        newSessionReceived = i48;
        totalEvents = i49 + 1;
        didReceivedWebpages = i49;
        int i50 = totalEvents;
        totalEvents = i50 + 1;
        didReceivedWebpagesInUpdates = i50;
        int i51 = totalEvents;
        totalEvents = i51 + 1;
        stickersDidLoad = i51;
        int i52 = totalEvents;
        totalEvents = i52 + 1;
        diceStickersDidLoad = i52;
        int i53 = totalEvents;
        totalEvents = i53 + 1;
        featuredStickersDidLoad = i53;
        int i54 = totalEvents;
        totalEvents = i54 + 1;
        groupStickersDidLoad = i54;
        int i55 = totalEvents;
        totalEvents = i55 + 1;
        messagesReadContent = i55;
        int i56 = totalEvents;
        totalEvents = i56 + 1;
        botInfoDidLoad = i56;
        int i57 = totalEvents;
        ...
        int i58 = totalEvents;
        totalEvents = i58 + 1;
        pinnedInfoDidLoad = i58;
        int i59 = totalEvents;
        totalEvents = i59 + 1;
        botKeyboardDidLoad = i59;
        int i60 = totalEvents;
        totalEvents = i60 + 1;
        chatSearchResultsAvailable = i60;
        int i61 = totalEvents;
        totalEvents = i61 + 1;
        chatSearchResultsLoading = i61;
        int i62 = totalEvents;
        totalEvents = i62 + 1;
        musicDidLoad = i62;
        int i63 = totalEvents;
        totalEvents = i63 + 1;
        moreMusicDidLoad = i63;
        int i64 = totalEvents;
        totalEvents = i64 + 1;
        needShowAlert = i64;
        int i65 = totalEvents;
        totalEvents = i65 + 1;
        needShowPlayServicesAlert = i65;
        int i66 = totalEvents;
        totalEvents = i66 + 1;
        didUpdateMessagesViews = i66;
        int i67 = totalEvents;
        totalEvents = i67 + 1;
        needReloadRecentDialogsSearch = i67;
        int i68 = totalEvents;
        totalEvents = i68 + 1;
        peerSettingsDidLoad = i68;
        int i69 = totalEvents;
        totalEvents = i69 + 1;
        wasUnableToFindCurrentLocation = i69;
        int i70 = totalEvents;
        totalEvents = i70 + 1;
        reloadHints = i70;
        int i71 = totalEvents;
        totalEvents = i71 + 1;
        reloadInlineHints = i71;
        int i72 = totalEvents;
        totalEvents = i72 + 1;
        newDraftReceived = i72;
        int i73 = totalEvents;
        totalEvents = i73 + 1;
        recentDocumentsDidLoad = i73;
        int i74 = totalEvents;
        totalEvents = i74 + 1;
        needAddArchivedStickers = i74;
        int i75 = totalEvents;
        totalEvents = i75 + 1;
        archivedStickersCountDidLoad = i75;
        int i76 = totalEvents;
        totalEvents = i76 + 1;
        paymentFinished = i76;
        int i77 = totalEvents;
        totalEvents = i77 + 1;
        channelRightsUpdated = i77;
        int i78 = totalEvents;
        totalEvents = i78 + 1;
        openArticle = i78;
        int i79 = totalEvents;
        totalEvents = i79 + 1;
        updateMentionsCount = i79;
        int i80 = totalEvents;
        totalEvents = i80 + 1;
        didUpdatePollResults = i80;
        int i81 = totalEvents;
        totalEvents = i81 + 1;
        chatOnlineCountDidLoad = i81;
        int i82 = totalEvents;
        totalEvents = i82 + 1;
        videoLoadingStateChanged = i82;
        int i83 = totalEvents;
        totalEvents = i83 + 1;
        newPeopleNearbyAvailable = i83;
        int i84 = totalEvents;
        totalEvents = i84 + 1;
        stopAllHeavyOperations = i84;
        int i85 = totalEvents;
        totalEvents = i85 + 1;
        startAllHeavyOperations = i85;
        int i86 = totalEvents;
        totalEvents = i86 + 1;
        sendingMessagesChanged = i86;
        int i87 = totalEvents;
        totalEvents = i87 + 1;
        didUpdateReactions = i87;
        int i88 = totalEvents;
        totalEvents = i88 + 1;
        didVerifyMessagesStickers = i88;
        int i89 = totalEvents;
        totalEvents = i89 + 1;
        scheduledMessagesUpdated = i89;
        int i90 = totalEvents;
        totalEvents = i90 + 1;
        newSuggestionsAvailable = i90;
        int i91 = totalEvents;
        totalEvents = i91 + 1;
        didLoadChatInviter = i91;
        int i92 = totalEvents;
        totalEvents = i92 + 1;
        didLoadChatAdmins = i92;
        int i93 = totalEvents;
        totalEvents = i93 + 1;
        historyImportProgressChanged = i93;
        int i94 = totalEvents;
        totalEvents = i94 + 1;
        stickersImportProgressChanged = i94;
        int i95 = totalEvents;
        totalEvents = i95 + 1;
        stickersImportComplete = i95;
        int i96 = totalEvents;
        totalEvents = i96 + 1;
        dialogDeleted = i96;
        int i97 = totalEvents;
        totalEvents = i97 + 1;
        walletPendingTransactionsChanged = i97;
        int i98 = totalEvents;
        totalEvents = i98 + 1;
        walletSyncProgressChanged = i98;
        int i99 = totalEvents;
        totalEvents = i99 + 1;
        httpFileDidLoad = i99;
        int i100 = totalEvents;
        totalEvents = i100 + 1;
        httpFileDidFailedLoad = i100;
        int i101 = totalEvents;
        totalEvents = i101 + 1;
        didUpdateConnectionState = i101;
        int i102 = totalEvents;
        totalEvents = i102 + 1;
        fileUploaded = i102;
        int i103 = totalEvents;
        totalEvents = i103 + 1;
        fileUploadFailed = i103;
        int i104 = totalEvents;
        totalEvents = i104 + 1;
        fileUploadProgressChanged = i104;
        int i105 = totalEvents;
        totalEvents = i105 + 1;
        fileLoadProgressChanged = i105;
        ...
        totalEvents = i108 + 1;
        filePreparingStarted = i108;
        int i109 = totalEvents;
        totalEvents = i109 + 1;
        fileNewChunkAvailable = i109;
        int i110 = totalEvents;
        totalEvents = i110 + 1;
        filePreparingFailed = i110;
        int i111 = totalEvents;
        totalEvents = i111 + 1;
        dialogsUnreadCounterChanged = i111;
        int i112 = totalEvents;
        totalEvents = i112 + 1;
        messagePlayingProgressDidChanged = i112;
        int i113 = totalEvents;
        totalEvents = i113 + 1;
        messagePlayingDidReset = i113;
        int i114 = totalEvents;
        totalEvents = i114 + 1;
        messagePlayingPlayStateChanged = i114;
        int i115 = totalEvents;
        totalEvents = i115 + 1;
        messagePlayingDidStart = i115;
        int i116 = totalEvents;
        totalEvents = i116 + 1;
        messagePlayingDidSeek = i116;
        int i117 = totalEvents;
        totalEvents = i117 + 1;
        messagePlayingGoingToStop = i117;
        int i118 = totalEvents;
        totalEvents = i118 + 1;
        recordProgressChanged = i118;
        int i119 = totalEvents;
        totalEvents = i119 + 1;
        recordStarted = i119;
        int i120 = totalEvents;
        totalEvents = i120 + 1;
        recordStartError = i120;
        ...
        totalEvents = i125 + 1;
        audioRecordTooShort = i125;
        int i126 = totalEvents;
        totalEvents = i126 + 1;
        audioRouteChanged = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        didStartedCall = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        groupCallUpdated = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        groupCallSpeakingUsersUpdated = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        groupCallScreencastStateChanged = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        activeGroupCallsUpdated = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        applyGroupCallVisibleParticipants = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        groupCallTypingsUpdated = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        didEndCall = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        closeInCallActivity = i135;
        int i136 = totalEvents;
        totalEvents = i136 + 1;
        groupCallVisibilityChanged = i136;
        ...
        totalEvents = i139 + 1;
        needDeleteDialog = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        newEmojiSuggestionsAvailable = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        themeUploadedToServer = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        themeUploadError = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        dialogFiltersUpdated = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        filterSettingsUpdated = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        suggestedFiltersLoaded = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        pushMessagesUpdated = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        stopEncodingService = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        wallpapersDidLoad = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        wallpapersNeedReload = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        didReceiveSmsCode = i150;
        ...
        totalEvents = i153 + 1;
        invalidateMotionBackground = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        closeOtherAppActivities = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        cameraInitied = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        didReplacedPhotoInMemCache = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        didSetNewTheme = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        themeListUpdated = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        didApplyNewTheme = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        themeAccentListUpdated = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        needCheckSystemBarColors = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        needShareTheme = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        needSetDayNightTheme = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        goingToPreviewTheme = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        locationPermissionGranted = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        reloadInterface = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        suggestedLangpack = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        didSetNewWallpapper = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        proxySettingsChanged = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        proxyCheckDone = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        liveLocationsChanged = i171;
        int i172 = totalEvents;
        totalEvents = i172 + 1;
        newLocationAvailable = i172;
        int i173 = totalEvents;
        totalEvents = i173 + 1;
        liveLocationsCacheChanged = i173;
        int i174 = totalEvents;
        totalEvents = i174 + 1;
        notificationsCountUpdated = i174;
        int i175 = totalEvents;
        totalEvents = i175 + 1;
        playerDidStartPlaying = i175;
        int i176 = totalEvents;
        totalEvents = i176 + 1;
        closeSearchByActiveAction = i176;
        int i177 = totalEvents;
        totalEvents = i177 + 1;
        messagePlayingSpeedChanged = i177;
        int i178 = totalEvents;
        totalEvents = i178 + 1;
        screenStateChanged = i178;
        int i179 = totalEvents;
        totalEvents = i179 + 1;
        didClearDatabase = i179;
        int i180 = totalEvents;
        totalEvents = i180 + 1;
        voipServiceCreated = i180;
        int i181 = totalEvents;
        totalEvents = i181 + 1;
        webRtcMicAmplitudeEvent = i181;
        int i182 = totalEvents;
        totalEvents = i182 + 1;
        webRtcSpeakerAmplitudeEvent = i182;
    ...
    public int setAnimationInProgress(int i, int[] iArr, boolean z) {
        ...
        if (this.checkForExpiredNotifications == null) {
            $$Lambda$NotificationCenter$qfLoSVnI6RSAMmhz7SoulpZLung r6 = new Runnable() {
                public final void run() {
                    NotificationCenter.this.checkForExpiredNotifications();
                }
            };
            this.checkForExpiredNotifications = r6;
            AndroidUtilities.runOnUIThread(r6, 1017);
        }
        ...
        if (!this.allowedNotifications.isEmpty()) {
            ...
            if (j != Long.MAX_VALUE) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public final void run() {
                        NotificationCenter.this.lambda$checkForExpiredNotifications$0$NotificationCenter();
                    }
                }, Math.max(17, 1017 - (elapsedRealtime - j)));
            }
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: lambda$checkForExpiredNotifications$0 */
    public /* synthetic */ void lambda$checkForExpiredNotifications$0$NotificationCenter() {
        this.checkForExpiredNotifications = new Runnable() {
            public final void run() {
                NotificationCenter.this.checkForExpiredNotifications();
            }
        };
