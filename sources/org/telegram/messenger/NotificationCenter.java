...
public class NotificationCenter {
    ...
    static {
        ...
        int i102 = i101 + 1;
        totalEvents = i102;
        walletPendingTransactionsChanged = i101;
        int i103 = i102 + 1;
        totalEvents = i103;
        walletSyncProgressChanged = i102;
        int i104 = i103 + 1;
        totalEvents = i104;
        httpFileDidLoad = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        httpFileDidFailedLoad = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        didUpdateConnectionState = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        fileUploaded = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        fileUploadFailed = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        fileUploadProgressChanged = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        fileLoadProgressChanged = i109;
        int i111 = i110 + 1;
        totalEvents = i111;
        fileLoaded = i110;
        int i112 = i111 + 1;
        ...
        int i113 = i112 + 1;
        totalEvents = i113;
        filePreparingStarted = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        fileNewChunkAvailable = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        filePreparingFailed = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        dialogsUnreadCounterChanged = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        messagePlayingProgressDidChanged = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        messagePlayingDidReset = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        messagePlayingPlayStateChanged = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        messagePlayingDidStart = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        messagePlayingDidSeek = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        messagePlayingGoingToStop = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        recordProgressChanged = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        recordStarted = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        recordStartError = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        recordStopped = i125;
        int i127 = i126 + 1;
        ...
        int i130 = i129 + 1;
        totalEvents = i130;
        audioRecordTooShort = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        audioRouteChanged = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        didStartedCall = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        groupCallUpdated = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        groupCallSpeakingUsersUpdated = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        groupCallScreencastStateChanged = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        activeGroupCallsUpdated = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        applyGroupCallVisibleParticipants = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        groupCallTypingsUpdated = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        didEndCall = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        closeInCallActivity = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        groupCallVisibilityChanged = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        appDidLogout = i141;
        int i143 = i142 + 1;
        ...
        int i144 = i143 + 1;
        totalEvents = i144;
        needDeleteDialog = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        newEmojiSuggestionsAvailable = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        themeUploadedToServer = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        themeUploadError = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        dialogFiltersUpdated = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        filterSettingsUpdated = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        suggestedFiltersLoaded = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        pushMessagesUpdated = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        stopEncodingService = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        wallpapersDidLoad = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        wallpapersNeedReload = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        didReceiveSmsCode = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        didReceiveCall = i155;
        int i157 = i156 + 1;
        ...
        int i158 = i157 + 1;
        totalEvents = i158;
        invalidateMotionBackground = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        closeOtherAppActivities = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        cameraInitied = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        didReplacedPhotoInMemCache = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        didSetNewTheme = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        themeListUpdated = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        didApplyNewTheme = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        themeAccentListUpdated = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        needCheckSystemBarColors = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        needShareTheme = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        needSetDayNightTheme = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        goingToPreviewTheme = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        locationPermissionGranted = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        reloadInterface = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        suggestedLangpack = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        didSetNewWallpapper = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        proxySettingsChanged = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        proxyCheckDone = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        liveLocationsChanged = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        newLocationAvailable = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        liveLocationsCacheChanged = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        notificationsCountUpdated = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        playerDidStartPlaying = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        closeSearchByActiveAction = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        messagePlayingSpeedChanged = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        screenStateChanged = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        didClearDatabase = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        voipServiceCreated = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        webRtcMicAmplitudeEvent = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        webRtcSpeakerAmplitudeEvent = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        showBulletin = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        appUpdateAvailable = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        onDatabaseMigration = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        onEmojiInteractionsReceived = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        emojiPreviewThemesChanged = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        reactionsDidLoad = i192;
        totalEvents = i193 + 1;
        chatAvailableReactionsUpdated = i193;
    }
