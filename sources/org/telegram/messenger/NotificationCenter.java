...
public class NotificationCenter {
    ...
    static {
        ...
        totalEvents = i126 + 1;
        groupCallScreencastStateChanged = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        activeGroupCallsUpdated = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        applyGroupCallVisibleParticipants = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        groupCallTypingsUpdated = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        didEndCall = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        closeInCallActivity = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        groupCallVisibilityChanged = i132;
        ...
        totalEvents = i135 + 1;
        needDeleteDialog = i135;
        int i136 = totalEvents;
        totalEvents = i136 + 1;
        newEmojiSuggestionsAvailable = i136;
        int i137 = totalEvents;
        totalEvents = i137 + 1;
        themeUploadedToServer = i137;
        int i138 = totalEvents;
        totalEvents = i138 + 1;
        themeUploadError = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        dialogFiltersUpdated = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        filterSettingsUpdated = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        suggestedFiltersLoaded = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        pushMessagesUpdated = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        stopEncodingService = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        wallpapersDidLoad = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        wallpapersNeedReload = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        didReceiveSmsCode = i146;
        ...
        totalEvents = i149 + 1;
        closeOtherAppActivities = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        cameraInitied = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        didReplacedPhotoInMemCache = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        didSetNewTheme = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        themeListUpdated = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        didApplyNewTheme = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        themeAccentListUpdated = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        needCheckSystemBarColors = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        needShareTheme = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        needSetDayNightTheme = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        goingToPreviewTheme = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        locationPermissionGranted = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        reloadInterface = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        suggestedLangpack = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        didSetNewWallpapper = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        proxySettingsChanged = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        proxyCheckDone = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        liveLocationsChanged = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        newLocationAvailable = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        liveLocationsCacheChanged = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        notificationsCountUpdated = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        playerDidStartPlaying = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        closeSearchByActiveAction = i171;
        int i172 = totalEvents;
        totalEvents = i172 + 1;
        messagePlayingSpeedChanged = i172;
        int i173 = totalEvents;
        totalEvents = i173 + 1;
        screenStateChanged = i173;
        int i174 = totalEvents;
        totalEvents = i174 + 1;
        didClearDatabase = i174;
        int i175 = totalEvents;
        totalEvents = i175 + 1;
        voipServiceCreated = i175;
        int i176 = totalEvents;
        totalEvents = i176 + 1;
        webRtcMicAmplitudeEvent = i176;
        int i177 = totalEvents;
        totalEvents = i177 + 1;
        webRtcSpeakerAmplitudeEvent = i177;
        int i178 = totalEvents;
        totalEvents = i178 + 1;
        showBulletin = i178;
        int i179 = totalEvents;
        totalEvents = i179 + 1;
        appUpdateAvailable = i179;
    }
