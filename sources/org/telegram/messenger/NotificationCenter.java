...
public class NotificationCenter {
    ...
    static {
        ...
        int i56 = totalEvents;
        totalEvents = i56 + 1;
        pinnedInfoDidLoad = i56;
        int i57 = totalEvents;
        totalEvents = i57 + 1;
        botKeyboardDidLoad = i57;
        int i58 = totalEvents;
        totalEvents = i58 + 1;
        chatSearchResultsAvailable = i58;
        int i59 = totalEvents;
        totalEvents = i59 + 1;
        chatSearchResultsLoading = i59;
        int i60 = totalEvents;
        totalEvents = i60 + 1;
        musicDidLoad = i60;
        int i61 = totalEvents;
        totalEvents = i61 + 1;
        moreMusicDidLoad = i61;
        int i62 = totalEvents;
        totalEvents = i62 + 1;
        needShowAlert = i62;
        int i63 = totalEvents;
        totalEvents = i63 + 1;
        needShowPlayServicesAlert = i63;
        int i64 = totalEvents;
        totalEvents = i64 + 1;
        didUpdateMessagesViews = i64;
        int i65 = totalEvents;
        totalEvents = i65 + 1;
        needReloadRecentDialogsSearch = i65;
        int i66 = totalEvents;
        totalEvents = i66 + 1;
        peerSettingsDidLoad = i66;
        int i67 = totalEvents;
        totalEvents = i67 + 1;
        wasUnableToFindCurrentLocation = i67;
        int i68 = totalEvents;
        totalEvents = i68 + 1;
        reloadHints = i68;
        int i69 = totalEvents;
        totalEvents = i69 + 1;
        reloadInlineHints = i69;
        int i70 = totalEvents;
        totalEvents = i70 + 1;
        newDraftReceived = i70;
        int i71 = totalEvents;
        totalEvents = i71 + 1;
        recentDocumentsDidLoad = i71;
        int i72 = totalEvents;
        totalEvents = i72 + 1;
        needAddArchivedStickers = i72;
        int i73 = totalEvents;
        totalEvents = i73 + 1;
        archivedStickersCountDidLoad = i73;
        int i74 = totalEvents;
        totalEvents = i74 + 1;
        paymentFinished = i74;
        int i75 = totalEvents;
        totalEvents = i75 + 1;
        channelRightsUpdated = i75;
        int i76 = totalEvents;
        totalEvents = i76 + 1;
        openArticle = i76;
        int i77 = totalEvents;
        ...
        int i78 = totalEvents;
        totalEvents = i78 + 1;
        didUpdatePollResults = i78;
        int i79 = totalEvents;
        totalEvents = i79 + 1;
        chatOnlineCountDidLoad = i79;
        int i80 = totalEvents;
        totalEvents = i80 + 1;
        videoLoadingStateChanged = i80;
        int i81 = totalEvents;
        totalEvents = i81 + 1;
        newPeopleNearbyAvailable = i81;
        int i82 = totalEvents;
        totalEvents = i82 + 1;
        stopAllHeavyOperations = i82;
        int i83 = totalEvents;
        totalEvents = i83 + 1;
        startAllHeavyOperations = i83;
        int i84 = totalEvents;
        totalEvents = i84 + 1;
        sendingMessagesChanged = i84;
        int i85 = totalEvents;
        totalEvents = i85 + 1;
        didUpdateReactions = i85;
        int i86 = totalEvents;
        totalEvents = i86 + 1;
        didVerifyMessagesStickers = i86;
        int i87 = totalEvents;
        totalEvents = i87 + 1;
        scheduledMessagesUpdated = i87;
        int i88 = totalEvents;
        totalEvents = i88 + 1;
        newSuggestionsAvailable = i88;
        int i89 = totalEvents;
        totalEvents = i89 + 1;
        walletPendingTransactionsChanged = i89;
        int i90 = totalEvents;
        totalEvents = i90 + 1;
        walletSyncProgressChanged = i90;
        int i91 = totalEvents;
        totalEvents = i91 + 1;
        httpFileDidLoad = i91;
        int i92 = totalEvents;
        totalEvents = i92 + 1;
        httpFileDidFailedLoad = i92;
        int i93 = totalEvents;
        totalEvents = i93 + 1;
        didUpdateConnectionState = i93;
        int i94 = totalEvents;
        totalEvents = i94 + 1;
        FileDidUpload = i94;
        int i95 = totalEvents;
        totalEvents = i95 + 1;
        FileDidFailUpload = i95;
        int i96 = totalEvents;
        totalEvents = i96 + 1;
        FileUploadProgressChanged = i96;
        int i97 = totalEvents;
        totalEvents = i97 + 1;
        FileLoadProgressChanged = i97;
        int i98 = totalEvents;
        totalEvents = i98 + 1;
        fileDidLoad = i98;
        int i99 = totalEvents;
        totalEvents = i99 + 1;
        fileDidFailToLoad = i99;
        int i100 = totalEvents;
        totalEvents = i100 + 1;
        filePreparingStarted = i100;
        int i101 = totalEvents;
        totalEvents = i101 + 1;
        fileNewChunkAvailable = i101;
        int i102 = totalEvents;
        totalEvents = i102 + 1;
        filePreparingFailed = i102;
        int i103 = totalEvents;
        totalEvents = i103 + 1;
        dialogsUnreadCounterChanged = i103;
        int i104 = totalEvents;
        totalEvents = i104 + 1;
        messagePlayingProgressDidChanged = i104;
        int i105 = totalEvents;
        totalEvents = i105 + 1;
        messagePlayingDidReset = i105;
        int i106 = totalEvents;
        totalEvents = i106 + 1;
        messagePlayingPlayStateChanged = i106;
        int i107 = totalEvents;
        totalEvents = i107 + 1;
        messagePlayingDidStart = i107;
        int i108 = totalEvents;
        totalEvents = i108 + 1;
        messagePlayingDidSeek = i108;
        int i109 = totalEvents;
        totalEvents = i109 + 1;
        messagePlayingGoingToStop = i109;
        int i110 = totalEvents;
        totalEvents = i110 + 1;
        recordProgressChanged = i110;
        int i111 = totalEvents;
        totalEvents = i111 + 1;
        recordStarted = i111;
        int i112 = totalEvents;
        totalEvents = i112 + 1;
        recordStartError = i112;
        ...
        totalEvents = i117 + 1;
        audioRecordTooShort = i117;
        int i118 = totalEvents;
        totalEvents = i118 + 1;
        audioRouteChanged = i118;
        ...
        totalEvents = i124 + 1;
        needDeleteDialog = i124;
        int i125 = totalEvents;
        totalEvents = i125 + 1;
        newEmojiSuggestionsAvailable = i125;
        int i126 = totalEvents;
        totalEvents = i126 + 1;
        themeUploadedToServer = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        themeUploadError = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        dialogFiltersUpdated = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        filterSettingsUpdated = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        suggestedFiltersLoaded = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        pushMessagesUpdated = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        stopEncodingService = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        wallpapersDidLoad = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        wallpapersNeedReload = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        didReceiveSmsCode = i135;
        ...
        totalEvents = i138 + 1;
        closeOtherAppActivities = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        cameraInitied = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        didReplacedPhotoInMemCache = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        didSetNewTheme = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        themeListUpdated = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        didApplyNewTheme = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        themeAccentListUpdated = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        needCheckSystemBarColors = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        needShareTheme = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        needSetDayNightTheme = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        goingToPreviewTheme = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        locationPermissionGranted = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        reloadInterface = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        suggestedLangpack = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        didSetNewWallpapper = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        proxySettingsChanged = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        proxyCheckDone = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        liveLocationsChanged = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        newLocationAvailable = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        liveLocationsCacheChanged = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        notificationsCountUpdated = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        playerDidStartPlaying = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        closeSearchByActiveAction = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        messagePlayingSpeedChanged = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        screenStateChanged = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        voipServiceCreated = i163;
    }
