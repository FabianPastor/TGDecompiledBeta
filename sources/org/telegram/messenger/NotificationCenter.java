...
public class NotificationCenter {
    ...
    static {
        ...
        int i59 = i58 + 1;
        totalEvents = i59;
        needShowPlayServicesAlert = i58;
        int i60 = i59 + 1;
        totalEvents = i60;
        didUpdateMessagesViews = i59;
        int i61 = i60 + 1;
        totalEvents = i61;
        needReloadRecentDialogsSearch = i60;
        int i62 = i61 + 1;
        totalEvents = i62;
        peerSettingsDidLoad = i61;
        int i63 = i62 + 1;
        totalEvents = i63;
        ...
        int i67 = i66 + 1;
        totalEvents = i67;
        recentDocumentsDidLoad = i66;
        int i68 = i67 + 1;
        totalEvents = i68;
        needAddArchivedStickers = i67;
        int i69 = i68 + 1;
        totalEvents = i69;
        archivedStickersCountDidLoad = i68;
        int i70 = i69 + 1;
        totalEvents = i70;
        paymentFinished = i69;
        int i71 = i70 + 1;
        totalEvents = i71;
        channelRightsUpdated = i70;
        int i72 = i71 + 1;
        totalEvents = i72;
        openArticle = i71;
        int i73 = i72 + 1;
        totalEvents = i73;
        updateMentionsCount = i72;
        int i74 = i73 + 1;
        totalEvents = i74;
        didUpdatePollResults = i73;
        int i75 = i74 + 1;
        totalEvents = i75;
        chatOnlineCountDidLoad = i74;
        int i76 = i75 + 1;
        totalEvents = i76;
        videoLoadingStateChanged = i75;
        int i77 = i76 + 1;
        totalEvents = i77;
        newPeopleNearbyAvailable = i76;
        int i78 = i77 + 1;
        totalEvents = i78;
        stopAllHeavyOperations = i77;
        int i79 = i78 + 1;
        totalEvents = i79;
        startAllHeavyOperations = i78;
        int i80 = i79 + 1;
        totalEvents = i80;
        sendingMessagesChanged = i79;
        int i81 = i80 + 1;
        totalEvents = i81;
        didUpdateReactions = i80;
        int i82 = i81 + 1;
        totalEvents = i82;
        didVerifyMessagesStickers = i81;
        int i83 = i82 + 1;
        totalEvents = i83;
        scheduledMessagesUpdated = i82;
        int i84 = i83 + 1;
        totalEvents = i84;
        newSuggestionsAvailable = i83;
        int i85 = i84 + 1;
        totalEvents = i85;
        walletPendingTransactionsChanged = i84;
        int i86 = i85 + 1;
        totalEvents = i86;
        walletSyncProgressChanged = i85;
        int i87 = i86 + 1;
        totalEvents = i87;
        httpFileDidLoad = i86;
        int i88 = i87 + 1;
        totalEvents = i88;
        httpFileDidFailedLoad = i87;
        int i89 = i88 + 1;
        totalEvents = i89;
        didUpdateConnectionState = i88;
        int i90 = i89 + 1;
        totalEvents = i90;
        FileDidUpload = i89;
        int i91 = i90 + 1;
        totalEvents = i91;
        FileDidFailUpload = i90;
        int i92 = i91 + 1;
        totalEvents = i92;
        FileUploadProgressChanged = i91;
        int i93 = i92 + 1;
        totalEvents = i93;
        FileLoadProgressChanged = i92;
        int i94 = i93 + 1;
        totalEvents = i94;
        fileDidLoad = i93;
        int i95 = i94 + 1;
        totalEvents = i95;
        fileDidFailToLoad = i94;
        int i96 = i95 + 1;
        totalEvents = i96;
        filePreparingStarted = i95;
        int i97 = i96 + 1;
        totalEvents = i97;
        fileNewChunkAvailable = i96;
        int i98 = i97 + 1;
        totalEvents = i98;
        filePreparingFailed = i97;
        int i99 = i98 + 1;
        totalEvents = i99;
        dialogsUnreadCounterChanged = i98;
        int i100 = i99 + 1;
        totalEvents = i100;
        messagePlayingProgressDidChanged = i99;
        int i101 = i100 + 1;
        totalEvents = i101;
        messagePlayingDidReset = i100;
        int i102 = i101 + 1;
        totalEvents = i102;
        messagePlayingPlayStateChanged = i101;
        int i103 = i102 + 1;
        totalEvents = i103;
        messagePlayingDidStart = i102;
        int i104 = i103 + 1;
        totalEvents = i104;
        messagePlayingDidSeek = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        messagePlayingGoingToStop = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        recordProgressChanged = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        recordStarted = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        recordStartError = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        recordStopped = i108;
        int i110 = i109 + 1;
        ...
        int i113 = i112 + 1;
        totalEvents = i113;
        audioRecordTooShort = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        audioRouteChanged = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        didStartedCall = i114;
        int i116 = i115 + 1;
        ...
        int i120 = i119 + 1;
        totalEvents = i120;
        needDeleteDialog = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        newEmojiSuggestionsAvailable = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        themeUploadedToServer = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        themeUploadError = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        dialogFiltersUpdated = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        filterSettingsUpdated = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        suggestedFiltersLoaded = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        pushMessagesUpdated = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        stopEncodingService = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        wallpapersDidLoad = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        wallpapersNeedReload = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        didReceiveSmsCode = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        didReceiveCall = i131;
        int i133 = i132 + 1;
        ...
        int i134 = i133 + 1;
        totalEvents = i134;
        closeOtherAppActivities = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        cameraInitied = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        didReplacedPhotoInMemCache = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        didSetNewTheme = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        themeListUpdated = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        didApplyNewTheme = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        themeAccentListUpdated = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        needCheckSystemBarColors = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        needShareTheme = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        needSetDayNightTheme = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        goingToPreviewTheme = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        locationPermissionGranted = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        reloadInterface = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        suggestedLangpack = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        didSetNewWallpapper = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        proxySettingsChanged = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        proxyCheckDone = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        liveLocationsChanged = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        newLocationAvailable = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        liveLocationsCacheChanged = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        notificationsCountUpdated = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        playerDidStartPlaying = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        closeSearchByActiveAction = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        messagePlayingSpeedChanged = i156;
        totalEvents = i157 + 1;
        screenStateChanged = i157;
    }
