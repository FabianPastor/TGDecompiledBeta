...
public class NotificationCenter {
    ...
    static {
        ...
        int i103 = i102 + 1;
        totalEvents = i103;
        didGenerateFingerprintKeyPair = i102;
        int i104 = i103 + 1;
        totalEvents = i104;
        walletPendingTransactionsChanged = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        walletSyncProgressChanged = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        httpFileDidLoad = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        httpFileDidFailedLoad = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        didUpdateConnectionState = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        fileUploaded = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        fileUploadFailed = i109;
        int i111 = i110 + 1;
        totalEvents = i111;
        fileUploadProgressChanged = i110;
        int i112 = i111 + 1;
        totalEvents = i112;
        fileLoadProgressChanged = i111;
        int i113 = i112 + 1;
        totalEvents = i113;
        fileLoaded = i112;
        int i114 = i113 + 1;
        ...
        int i115 = i114 + 1;
        totalEvents = i115;
        filePreparingStarted = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        fileNewChunkAvailable = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        filePreparingFailed = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        dialogsUnreadCounterChanged = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        messagePlayingProgressDidChanged = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        messagePlayingDidReset = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        messagePlayingPlayStateChanged = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        messagePlayingDidStart = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        messagePlayingDidSeek = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        messagePlayingGoingToStop = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        recordProgressChanged = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        recordStarted = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        recordStartError = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        recordStopped = i127;
        int i129 = i128 + 1;
        ...
        int i132 = i131 + 1;
        totalEvents = i132;
        audioRecordTooShort = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        audioRouteChanged = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        didStartedCall = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        groupCallUpdated = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        groupCallSpeakingUsersUpdated = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        groupCallScreencastStateChanged = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        activeGroupCallsUpdated = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        applyGroupCallVisibleParticipants = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        groupCallTypingsUpdated = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        didEndCall = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        closeInCallActivity = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        groupCallVisibilityChanged = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        appDidLogout = i143;
        int i145 = i144 + 1;
        ...
        int i146 = i145 + 1;
        totalEvents = i146;
        needDeleteDialog = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        newEmojiSuggestionsAvailable = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        themeUploadedToServer = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        themeUploadError = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        dialogFiltersUpdated = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        filterSettingsUpdated = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        suggestedFiltersLoaded = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        pushMessagesUpdated = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        stopEncodingService = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        wallpapersDidLoad = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        wallpapersNeedReload = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        didReceiveSmsCode = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        didReceiveCall = i157;
        int i159 = i158 + 1;
        ...
        int i160 = i159 + 1;
        totalEvents = i160;
        invalidateMotionBackground = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        closeOtherAppActivities = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        cameraInitied = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        didReplacedPhotoInMemCache = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        didSetNewTheme = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        themeListUpdated = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        didApplyNewTheme = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        themeAccentListUpdated = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        needCheckSystemBarColors = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        needShareTheme = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        needSetDayNightTheme = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        goingToPreviewTheme = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        locationPermissionGranted = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        locationPermissionDenied = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        ...
        int i195 = i194 + 1;
        totalEvents = i195;
        emojiPreviewThemesChanged = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        reactionsDidLoad = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        chatAvailableReactionsUpdated = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        dialogsUnreadReactionsCounterChanged = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        onDatabaseOpened = i198;
        totalEvents = i199 + 1;
        onDownloadingFilesChanged = i199;
    }
