...
public class NotificationCenter {
    ...
    static {
        ...
        int i91 = i90 + 1;
        totalEvents = i91;
        sendingMessagesChanged = i90;
        int i92 = i91 + 1;
        totalEvents = i92;
        didUpdateReactions = i91;
        int i93 = i92 + 1;
        totalEvents = i93;
        didVerifyMessagesStickers = i92;
        int i94 = i93 + 1;
        totalEvents = i94;
        scheduledMessagesUpdated = i93;
        int i95 = i94 + 1;
        totalEvents = i95;
        newSuggestionsAvailable = i94;
        int i96 = i95 + 1;
        totalEvents = i96;
        didLoadChatInviter = i95;
        int i97 = i96 + 1;
        totalEvents = i97;
        didLoadChatAdmins = i96;
        int i98 = i97 + 1;
        totalEvents = i98;
        historyImportProgressChanged = i97;
        int i99 = i98 + 1;
        totalEvents = i99;
        stickersImportProgressChanged = i98;
        int i100 = i99 + 1;
        totalEvents = i100;
        stickersImportComplete = i99;
        int i101 = i100 + 1;
        totalEvents = i101;
        dialogDeleted = i100;
        int i102 = i101 + 1;
        totalEvents = i102;
        didGenerateFingerprintKeyPair = i101;
        int i103 = i102 + 1;
        totalEvents = i103;
        walletPendingTransactionsChanged = i102;
        int i104 = i103 + 1;
        totalEvents = i104;
        walletSyncProgressChanged = i103;
        int i105 = i104 + 1;
        totalEvents = i105;
        httpFileDidLoad = i104;
        int i106 = i105 + 1;
        totalEvents = i106;
        httpFileDidFailedLoad = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        didUpdateConnectionState = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        fileUploaded = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        fileUploadFailed = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        fileUploadProgressChanged = i109;
        int i111 = i110 + 1;
        totalEvents = i111;
        fileLoadProgressChanged = i110;
        int i112 = i111 + 1;
        totalEvents = i112;
        fileLoaded = i111;
        int i113 = i112 + 1;
        ...
        int i114 = i113 + 1;
        totalEvents = i114;
        filePreparingStarted = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        fileNewChunkAvailable = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        filePreparingFailed = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        dialogsUnreadCounterChanged = i116;
        int i118 = i117 + 1;
        totalEvents = i118;
        messagePlayingProgressDidChanged = i117;
        int i119 = i118 + 1;
        totalEvents = i119;
        messagePlayingDidReset = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        messagePlayingPlayStateChanged = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        messagePlayingDidStart = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        messagePlayingDidSeek = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        messagePlayingGoingToStop = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        recordProgressChanged = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        recordStarted = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        recordStartError = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        recordStopped = i126;
        int i128 = i127 + 1;
        ...
        int i131 = i130 + 1;
        totalEvents = i131;
        audioRecordTooShort = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        audioRouteChanged = i131;
        int i133 = i132 + 1;
        totalEvents = i133;
        didStartedCall = i132;
        int i134 = i133 + 1;
        totalEvents = i134;
        groupCallUpdated = i133;
        int i135 = i134 + 1;
        totalEvents = i135;
        groupCallSpeakingUsersUpdated = i134;
        int i136 = i135 + 1;
        totalEvents = i136;
        groupCallScreencastStateChanged = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        activeGroupCallsUpdated = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        applyGroupCallVisibleParticipants = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        groupCallTypingsUpdated = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        didEndCall = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        closeInCallActivity = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        groupCallVisibilityChanged = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        appDidLogout = i142;
        int i144 = i143 + 1;
        ...
        int i145 = i144 + 1;
        totalEvents = i145;
        needDeleteDialog = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        newEmojiSuggestionsAvailable = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        themeUploadedToServer = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        themeUploadError = i147;
        int i149 = i148 + 1;
        totalEvents = i149;
        dialogFiltersUpdated = i148;
        int i150 = i149 + 1;
        totalEvents = i150;
        filterSettingsUpdated = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        suggestedFiltersLoaded = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        pushMessagesUpdated = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        stopEncodingService = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        wallpapersDidLoad = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        wallpapersNeedReload = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        didReceiveSmsCode = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        didReceiveCall = i156;
        int i158 = i157 + 1;
        ...
        int i159 = i158 + 1;
        totalEvents = i159;
        invalidateMotionBackground = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        closeOtherAppActivities = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        cameraInitied = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        didReplacedPhotoInMemCache = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        didSetNewTheme = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        themeListUpdated = i163;
        int i165 = i164 + 1;
        totalEvents = i165;
        didApplyNewTheme = i164;
        int i166 = i165 + 1;
        totalEvents = i166;
        themeAccentListUpdated = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        needCheckSystemBarColors = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        needShareTheme = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        needSetDayNightTheme = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        goingToPreviewTheme = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        locationPermissionGranted = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        locationPermissionDenied = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        reloadInterface = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        suggestedLangpack = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        didSetNewWallpapper = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        proxySettingsChanged = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        proxyCheckDone = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        liveLocationsChanged = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        newLocationAvailable = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        liveLocationsCacheChanged = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        notificationsCountUpdated = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        playerDidStartPlaying = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        closeSearchByActiveAction = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        messagePlayingSpeedChanged = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        screenStateChanged = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        didClearDatabase = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        voipServiceCreated = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        webRtcMicAmplitudeEvent = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        webRtcSpeakerAmplitudeEvent = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        showBulletin = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        appUpdateAvailable = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        onDatabaseMigration = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        onEmojiInteractionsReceived = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        emojiPreviewThemesChanged = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        reactionsDidLoad = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        chatAvailableReactionsUpdated = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        dialogsUnreadReactionsCounterChanged = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        onDatabaseOpened = i197;
        totalEvents = i198 + 1;
        onDownloadingFilesChanged = i198;
    }
