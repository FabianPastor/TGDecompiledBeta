...
public class NotificationCenter {
    ...
    static {
        ...
        totalEvents = i126 + 1;
        applyGroupCallVisibleParticipants = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        groupCallTypingsUpdated = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        didEndCall = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        closeInCallActivity = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        groupCallVisibilityChanged = i130;
        ...
        totalEvents = i133 + 1;
        needDeleteDialog = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        newEmojiSuggestionsAvailable = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        themeUploadedToServer = i135;
        int i136 = totalEvents;
        totalEvents = i136 + 1;
        themeUploadError = i136;
        int i137 = totalEvents;
        totalEvents = i137 + 1;
        dialogFiltersUpdated = i137;
        int i138 = totalEvents;
        totalEvents = i138 + 1;
        filterSettingsUpdated = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        suggestedFiltersLoaded = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        pushMessagesUpdated = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        stopEncodingService = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        wallpapersDidLoad = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        wallpapersNeedReload = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        didReceiveSmsCode = i144;
        ...
        totalEvents = i147 + 1;
        closeOtherAppActivities = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        cameraInitied = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        didReplacedPhotoInMemCache = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        didSetNewTheme = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        themeListUpdated = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        didApplyNewTheme = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        themeAccentListUpdated = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        needCheckSystemBarColors = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        needShareTheme = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        needSetDayNightTheme = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        goingToPreviewTheme = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        locationPermissionGranted = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        reloadInterface = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        suggestedLangpack = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        didSetNewWallpapper = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        proxySettingsChanged = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        proxyCheckDone = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        liveLocationsChanged = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        newLocationAvailable = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        liveLocationsCacheChanged = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        notificationsCountUpdated = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        playerDidStartPlaying = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        closeSearchByActiveAction = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        messagePlayingSpeedChanged = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        screenStateChanged = i171;
        int i172 = totalEvents;
        totalEvents = i172 + 1;
        didClearDatabase = i172;
        int i173 = totalEvents;
        totalEvents = i173 + 1;
        voipServiceCreated = i173;
        int i174 = totalEvents;
        totalEvents = i174 + 1;
        webRtcMicAmplitudeEvent = i174;
