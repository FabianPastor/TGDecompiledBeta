...
public class NotificationCenter {
    ...
    static {
        ...
        int i92 = totalEvents;
        totalEvents = i92 + 1;
        historyImportProgressChanged = i92;
        int i93 = totalEvents;
        totalEvents = i93 + 1;
        stickersImportProgressChanged = i93;
        int i94 = totalEvents;
        totalEvents = i94 + 1;
        stickersImportComplete = i94;
        int i95 = totalEvents;
        totalEvents = i95 + 1;
        dialogDeleted = i95;
        int i96 = totalEvents;
        totalEvents = i96 + 1;
        walletPendingTransactionsChanged = i96;
        int i97 = totalEvents;
        totalEvents = i97 + 1;
        walletSyncProgressChanged = i97;
        int i98 = totalEvents;
        totalEvents = i98 + 1;
        httpFileDidLoad = i98;
        int i99 = totalEvents;
        totalEvents = i99 + 1;
        httpFileDidFailedLoad = i99;
        int i100 = totalEvents;
        totalEvents = i100 + 1;
        didUpdateConnectionState = i100;
        int i101 = totalEvents;
        totalEvents = i101 + 1;
        FileDidUpload = i101;
        int i102 = totalEvents;
        totalEvents = i102 + 1;
        FileDidFailUpload = i102;
        int i103 = totalEvents;
        totalEvents = i103 + 1;
        FileUploadProgressChanged = i103;
        int i104 = totalEvents;
        totalEvents = i104 + 1;
        fileLoadProgressChanged = i104;
        int i105 = totalEvents;
        totalEvents = i105 + 1;
        fileDidLoad = i105;
        int i106 = totalEvents;
        totalEvents = i106 + 1;
        fileDidFailToLoad = i106;
        int i107 = totalEvents;
        totalEvents = i107 + 1;
        filePreparingStarted = i107;
        int i108 = totalEvents;
        totalEvents = i108 + 1;
        fileNewChunkAvailable = i108;
        int i109 = totalEvents;
        totalEvents = i109 + 1;
        filePreparingFailed = i109;
        int i110 = totalEvents;
        totalEvents = i110 + 1;
        dialogsUnreadCounterChanged = i110;
        int i111 = totalEvents;
        totalEvents = i111 + 1;
        messagePlayingProgressDidChanged = i111;
        int i112 = totalEvents;
        totalEvents = i112 + 1;
        messagePlayingDidReset = i112;
        int i113 = totalEvents;
        totalEvents = i113 + 1;
        messagePlayingPlayStateChanged = i113;
        int i114 = totalEvents;
        totalEvents = i114 + 1;
        messagePlayingDidStart = i114;
        int i115 = totalEvents;
        totalEvents = i115 + 1;
        messagePlayingDidSeek = i115;
        int i116 = totalEvents;
        totalEvents = i116 + 1;
        messagePlayingGoingToStop = i116;
        int i117 = totalEvents;
        totalEvents = i117 + 1;
        recordProgressChanged = i117;
        int i118 = totalEvents;
        totalEvents = i118 + 1;
        recordStarted = i118;
        int i119 = totalEvents;
        totalEvents = i119 + 1;
        recordStartError = i119;
        ...
        totalEvents = i124 + 1;
        audioRecordTooShort = i124;
        int i125 = totalEvents;
        totalEvents = i125 + 1;
        audioRouteChanged = i125;
        int i126 = totalEvents;
        totalEvents = i126 + 1;
        didStartedCall = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        groupCallUpdated = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        groupCallSpeakingUsersUpdated = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        groupCallScreencastStateChanged = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        activeGroupCallsUpdated = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        applyGroupCallVisibleParticipants = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        groupCallTypingsUpdated = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        didEndCall = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        closeInCallActivity = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        groupCallVisibilityChanged = i135;
        ...
        totalEvents = i138 + 1;
        needDeleteDialog = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        newEmojiSuggestionsAvailable = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        themeUploadedToServer = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        themeUploadError = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        dialogFiltersUpdated = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        filterSettingsUpdated = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        suggestedFiltersLoaded = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        pushMessagesUpdated = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        stopEncodingService = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        wallpapersDidLoad = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        wallpapersNeedReload = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        didReceiveSmsCode = i149;
        ...
        totalEvents = i152 + 1;
        closeOtherAppActivities = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        cameraInitied = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        didReplacedPhotoInMemCache = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        didSetNewTheme = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        themeListUpdated = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        didApplyNewTheme = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        themeAccentListUpdated = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        needCheckSystemBarColors = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        needShareTheme = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        needSetDayNightTheme = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        goingToPreviewTheme = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        locationPermissionGranted = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        reloadInterface = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        suggestedLangpack = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        didSetNewWallpapper = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        proxySettingsChanged = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        proxyCheckDone = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        liveLocationsChanged = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        newLocationAvailable = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        liveLocationsCacheChanged = i171;
        int i172 = totalEvents;
        totalEvents = i172 + 1;
        notificationsCountUpdated = i172;
        int i173 = totalEvents;
        totalEvents = i173 + 1;
        playerDidStartPlaying = i173;
        int i174 = totalEvents;
        totalEvents = i174 + 1;
        closeSearchByActiveAction = i174;
        int i175 = totalEvents;
        totalEvents = i175 + 1;
        messagePlayingSpeedChanged = i175;
        int i176 = totalEvents;
        totalEvents = i176 + 1;
        screenStateChanged = i176;
        int i177 = totalEvents;
        totalEvents = i177 + 1;
        didClearDatabase = i177;
        int i178 = totalEvents;
        totalEvents = i178 + 1;
        voipServiceCreated = i178;
        int i179 = totalEvents;
        totalEvents = i179 + 1;
        webRtcMicAmplitudeEvent = i179;
        int i180 = totalEvents;
        totalEvents = i180 + 1;
        webRtcSpeakerAmplitudeEvent = i180;
        int i181 = totalEvents;
        totalEvents = i181 + 1;
        showBulletin = i181;
        int i182 = totalEvents;
        totalEvents = i182 + 1;
        appUpdateAvailable = i182;
    }
