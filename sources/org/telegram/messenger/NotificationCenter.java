...
public class NotificationCenter {
    ...
    static {
        ...
        int i94 = totalEvents;
        totalEvents = i94 + 1;
        walletPendingTransactionsChanged = i94;
        int i95 = totalEvents;
        totalEvents = i95 + 1;
        walletSyncProgressChanged = i95;
        int i96 = totalEvents;
        totalEvents = i96 + 1;
        httpFileDidLoad = i96;
        int i97 = totalEvents;
        totalEvents = i97 + 1;
        httpFileDidFailedLoad = i97;
        int i98 = totalEvents;
        totalEvents = i98 + 1;
        didUpdateConnectionState = i98;
        int i99 = totalEvents;
        totalEvents = i99 + 1;
        FileDidUpload = i99;
        int i100 = totalEvents;
        totalEvents = i100 + 1;
        FileDidFailUpload = i100;
        int i101 = totalEvents;
        totalEvents = i101 + 1;
        FileUploadProgressChanged = i101;
        int i102 = totalEvents;
        totalEvents = i102 + 1;
        fileLoadProgressChanged = i102;
        int i103 = totalEvents;
        totalEvents = i103 + 1;
        fileDidLoad = i103;
        int i104 = totalEvents;
        totalEvents = i104 + 1;
        fileDidFailToLoad = i104;
        int i105 = totalEvents;
        totalEvents = i105 + 1;
        filePreparingStarted = i105;
        int i106 = totalEvents;
        totalEvents = i106 + 1;
        fileNewChunkAvailable = i106;
        int i107 = totalEvents;
        totalEvents = i107 + 1;
        filePreparingFailed = i107;
        int i108 = totalEvents;
        totalEvents = i108 + 1;
        dialogsUnreadCounterChanged = i108;
        int i109 = totalEvents;
        totalEvents = i109 + 1;
        messagePlayingProgressDidChanged = i109;
        int i110 = totalEvents;
        totalEvents = i110 + 1;
        messagePlayingDidReset = i110;
        int i111 = totalEvents;
        totalEvents = i111 + 1;
        messagePlayingPlayStateChanged = i111;
        int i112 = totalEvents;
        totalEvents = i112 + 1;
        messagePlayingDidStart = i112;
        int i113 = totalEvents;
        totalEvents = i113 + 1;
        messagePlayingDidSeek = i113;
        int i114 = totalEvents;
        totalEvents = i114 + 1;
        messagePlayingGoingToStop = i114;
        int i115 = totalEvents;
        totalEvents = i115 + 1;
        recordProgressChanged = i115;
        int i116 = totalEvents;
        totalEvents = i116 + 1;
        recordStarted = i116;
        int i117 = totalEvents;
        totalEvents = i117 + 1;
        recordStartError = i117;
        ...
        totalEvents = i122 + 1;
        audioRecordTooShort = i122;
        int i123 = totalEvents;
        totalEvents = i123 + 1;
        audioRouteChanged = i123;
        int i124 = totalEvents;
        totalEvents = i124 + 1;
        didStartedCall = i124;
        int i125 = totalEvents;
        totalEvents = i125 + 1;
        groupCallUpdated = i125;
        int i126 = totalEvents;
        totalEvents = i126 + 1;
        groupCallSpeakingUsersUpdated = i126;
        int i127 = totalEvents;
        totalEvents = i127 + 1;
        groupCallScreencastStateChanged = i127;
        int i128 = totalEvents;
        totalEvents = i128 + 1;
        activeGroupCallsUpdated = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        applyGroupCallVisibleParticipants = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        groupCallTypingsUpdated = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        didEndCall = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        closeInCallActivity = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        groupCallVisibilityChanged = i133;
        ...
        totalEvents = i136 + 1;
        needDeleteDialog = i136;
        int i137 = totalEvents;
        totalEvents = i137 + 1;
        newEmojiSuggestionsAvailable = i137;
        int i138 = totalEvents;
        totalEvents = i138 + 1;
        themeUploadedToServer = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        themeUploadError = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        dialogFiltersUpdated = i140;
        int i141 = totalEvents;
        totalEvents = i141 + 1;
        filterSettingsUpdated = i141;
        int i142 = totalEvents;
        totalEvents = i142 + 1;
        suggestedFiltersLoaded = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        pushMessagesUpdated = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        stopEncodingService = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        wallpapersDidLoad = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        wallpapersNeedReload = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        didReceiveSmsCode = i147;
        ...
        totalEvents = i150 + 1;
        closeOtherAppActivities = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        cameraInitied = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        didReplacedPhotoInMemCache = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        didSetNewTheme = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        themeListUpdated = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        didApplyNewTheme = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        themeAccentListUpdated = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        needCheckSystemBarColors = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        needShareTheme = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        needSetDayNightTheme = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        goingToPreviewTheme = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        locationPermissionGranted = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        reloadInterface = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        suggestedLangpack = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        didSetNewWallpapper = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        proxySettingsChanged = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        proxyCheckDone = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        liveLocationsChanged = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        newLocationAvailable = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        liveLocationsCacheChanged = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        notificationsCountUpdated = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        playerDidStartPlaying = i171;
        int i172 = totalEvents;
        totalEvents = i172 + 1;
        closeSearchByActiveAction = i172;
        int i173 = totalEvents;
        totalEvents = i173 + 1;
        messagePlayingSpeedChanged = i173;
        int i174 = totalEvents;
        totalEvents = i174 + 1;
        screenStateChanged = i174;
        int i175 = totalEvents;
        totalEvents = i175 + 1;
        didClearDatabase = i175;
        int i176 = totalEvents;
        totalEvents = i176 + 1;
        voipServiceCreated = i176;
        int i177 = totalEvents;
        totalEvents = i177 + 1;
        webRtcMicAmplitudeEvent = i177;
        int i178 = totalEvents;
        totalEvents = i178 + 1;
        webRtcSpeakerAmplitudeEvent = i178;
        int i179 = totalEvents;
        totalEvents = i179 + 1;
        showBulletin = i179;
        int i180 = totalEvents;
        totalEvents = i180 + 1;
        appUpdateAvailable = i180;
    }
