...
public class NotificationCenter {
    ...
    static {
        ...
        int i171 = i170 + 1;
        totalEvents = i171;
        locationPermissionDenied = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        reloadInterface = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        suggestedLangpack = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        didSetNewWallpapper = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        proxySettingsChanged = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        proxyCheckDone = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        liveLocationsChanged = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        newLocationAvailable = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        liveLocationsCacheChanged = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        notificationsCountUpdated = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        playerDidStartPlaying = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        closeSearchByActiveAction = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        messagePlayingSpeedChanged = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        screenStateChanged = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        didClearDatabase = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        voipServiceCreated = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        webRtcMicAmplitudeEvent = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        webRtcSpeakerAmplitudeEvent = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        showBulletin = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        appUpdateAvailable = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        onDatabaseMigration = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        onEmojiInteractionsReceived = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        emojiPreviewThemesChanged = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        reactionsDidLoad = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
