...
public class NotificationCenter {
    ...
    static {
        ...
        int i174 = i173 + 1;
        totalEvents = i174;
        locationPermissionDenied = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        reloadInterface = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        suggestedLangpack = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        didSetNewWallpapper = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        proxySettingsChanged = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        proxyCheckDone = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        liveLocationsChanged = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        newLocationAvailable = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        liveLocationsCacheChanged = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        notificationsCountUpdated = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        playerDidStartPlaying = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        closeSearchByActiveAction = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        messagePlayingSpeedChanged = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        screenStateChanged = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        didClearDatabase = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        voipServiceCreated = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        webRtcMicAmplitudeEvent = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        webRtcSpeakerAmplitudeEvent = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        showBulletin = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        appUpdateAvailable = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        onDatabaseMigration = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        onEmojiInteractionsReceived = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        emojiPreviewThemesChanged = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        reactionsDidLoad = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        attachMenuBotsDidLoad = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        chatAvailableReactionsUpdated = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        dialogsUnreadReactionsCounterChanged = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        onDatabaseOpened = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        onDownloadingFilesChanged = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        onActivityResultReceived = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        onRequestPermissionResultReceived = i203;
        totalEvents = i204 + 1;
        onUserRingtonesUpdated = i204;
    }
