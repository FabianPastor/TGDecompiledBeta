...
public class NotificationCenter {
    ...
    static {
        ...
        int i91 = totalEvents;
        totalEvents = i91 + 1;
        walletPendingTransactionsChanged = i91;
        int i92 = totalEvents;
        totalEvents = i92 + 1;
        walletSyncProgressChanged = i92;
        int i93 = totalEvents;
        totalEvents = i93 + 1;
        httpFileDidLoad = i93;
        int i94 = totalEvents;
        totalEvents = i94 + 1;
        httpFileDidFailedLoad = i94;
        int i95 = totalEvents;
        totalEvents = i95 + 1;
        didUpdateConnectionState = i95;
        int i96 = totalEvents;
        totalEvents = i96 + 1;
        FileDidUpload = i96;
        int i97 = totalEvents;
        totalEvents = i97 + 1;
        FileDidFailUpload = i97;
        int i98 = totalEvents;
        totalEvents = i98 + 1;
        FileUploadProgressChanged = i98;
        int i99 = totalEvents;
        totalEvents = i99 + 1;
        FileLoadProgressChanged = i99;
        int i100 = totalEvents;
        totalEvents = i100 + 1;
        fileDidLoad = i100;
        int i101 = totalEvents;
        totalEvents = i101 + 1;
        fileDidFailToLoad = i101;
        int i102 = totalEvents;
        totalEvents = i102 + 1;
        filePreparingStarted = i102;
        int i103 = totalEvents;
        totalEvents = i103 + 1;
        fileNewChunkAvailable = i103;
        int i104 = totalEvents;
        totalEvents = i104 + 1;
        filePreparingFailed = i104;
        int i105 = totalEvents;
        totalEvents = i105 + 1;
        dialogsUnreadCounterChanged = i105;
        int i106 = totalEvents;
        totalEvents = i106 + 1;
        messagePlayingProgressDidChanged = i106;
        int i107 = totalEvents;
        totalEvents = i107 + 1;
        messagePlayingDidReset = i107;
        int i108 = totalEvents;
        totalEvents = i108 + 1;
        messagePlayingPlayStateChanged = i108;
        int i109 = totalEvents;
        totalEvents = i109 + 1;
        messagePlayingDidStart = i109;
        int i110 = totalEvents;
        totalEvents = i110 + 1;
        messagePlayingDidSeek = i110;
        int i111 = totalEvents;
        totalEvents = i111 + 1;
        messagePlayingGoingToStop = i111;
        int i112 = totalEvents;
        totalEvents = i112 + 1;
        recordProgressChanged = i112;
        int i113 = totalEvents;
        totalEvents = i113 + 1;
        recordStarted = i113;
        int i114 = totalEvents;
        totalEvents = i114 + 1;
        recordStartError = i114;
        ...
        totalEvents = i119 + 1;
        audioRecordTooShort = i119;
        int i120 = totalEvents;
        totalEvents = i120 + 1;
        audioRouteChanged = i120;
        int i121 = totalEvents;
        totalEvents = i121 + 1;
        didStartedCall = i121;
        int i122 = totalEvents;
        totalEvents = i122 + 1;
        groupCallUpdated = i122;
        int i123 = totalEvents;
        totalEvents = i123 + 1;
        groupCallTypingsUpdated = i123;
        int i124 = totalEvents;
        totalEvents = i124 + 1;
        didEndCall = i124;
        int i125 = totalEvents;
        totalEvents = i125 + 1;
        closeInCallActivity = i125;
        int i126 = totalEvents;
        totalEvents = i126 + 1;
        groupCallVisibilityChanged = i126;
        ...
        totalEvents = i129 + 1;
        needDeleteDialog = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        newEmojiSuggestionsAvailable = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        themeUploadedToServer = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        themeUploadError = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        dialogFiltersUpdated = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        filterSettingsUpdated = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        suggestedFiltersLoaded = i135;
        int i136 = totalEvents;
        totalEvents = i136 + 1;
        pushMessagesUpdated = i136;
        int i137 = totalEvents;
        totalEvents = i137 + 1;
        stopEncodingService = i137;
        int i138 = totalEvents;
        totalEvents = i138 + 1;
        wallpapersDidLoad = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        wallpapersNeedReload = i139;
        int i140 = totalEvents;
        totalEvents = i140 + 1;
        didReceiveSmsCode = i140;
        ...
        totalEvents = i143 + 1;
        closeOtherAppActivities = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        cameraInitied = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        didReplacedPhotoInMemCache = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        didSetNewTheme = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        themeListUpdated = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        didApplyNewTheme = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        themeAccentListUpdated = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        needCheckSystemBarColors = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        needShareTheme = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        needSetDayNightTheme = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        goingToPreviewTheme = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        locationPermissionGranted = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        reloadInterface = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        suggestedLangpack = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        didSetNewWallpapper = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        proxySettingsChanged = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        proxyCheckDone = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        liveLocationsChanged = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        newLocationAvailable = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        liveLocationsCacheChanged = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        notificationsCountUpdated = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        playerDidStartPlaying = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        closeSearchByActiveAction = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        messagePlayingSpeedChanged = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        screenStateChanged = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        didDatabaseCleared = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        voipServiceCreated = i169;
        int i170 = totalEvents;
        totalEvents = i170 + 1;
        webRtcMicAmplitudeEvent = i170;
        int i171 = totalEvents;
        totalEvents = i171 + 1;
        webRtcSpeakerAmplitudeEvent = i171;
    }
