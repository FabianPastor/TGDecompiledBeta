...
public class NotificationCenter {
    ...
    public static final int webRtcAmplitudeEvent;
    ...
    static {
        ...
        totalEvents = i128 + 1;
        needDeleteDialog = i128;
        int i129 = totalEvents;
        totalEvents = i129 + 1;
        newEmojiSuggestionsAvailable = i129;
        int i130 = totalEvents;
        totalEvents = i130 + 1;
        themeUploadedToServer = i130;
        int i131 = totalEvents;
        totalEvents = i131 + 1;
        themeUploadError = i131;
        int i132 = totalEvents;
        totalEvents = i132 + 1;
        dialogFiltersUpdated = i132;
        int i133 = totalEvents;
        totalEvents = i133 + 1;
        filterSettingsUpdated = i133;
        int i134 = totalEvents;
        totalEvents = i134 + 1;
        suggestedFiltersLoaded = i134;
        int i135 = totalEvents;
        totalEvents = i135 + 1;
        pushMessagesUpdated = i135;
        int i136 = totalEvents;
        totalEvents = i136 + 1;
        stopEncodingService = i136;
        int i137 = totalEvents;
        totalEvents = i137 + 1;
        wallpapersDidLoad = i137;
        int i138 = totalEvents;
        totalEvents = i138 + 1;
        wallpapersNeedReload = i138;
        int i139 = totalEvents;
        totalEvents = i139 + 1;
        didReceiveSmsCode = i139;
        ...
        totalEvents = i142 + 1;
        closeOtherAppActivities = i142;
        int i143 = totalEvents;
        totalEvents = i143 + 1;
        cameraInitied = i143;
        int i144 = totalEvents;
        totalEvents = i144 + 1;
        didReplacedPhotoInMemCache = i144;
        int i145 = totalEvents;
        totalEvents = i145 + 1;
        didSetNewTheme = i145;
        int i146 = totalEvents;
        totalEvents = i146 + 1;
        themeListUpdated = i146;
        int i147 = totalEvents;
        totalEvents = i147 + 1;
        didApplyNewTheme = i147;
        int i148 = totalEvents;
        totalEvents = i148 + 1;
        themeAccentListUpdated = i148;
        int i149 = totalEvents;
        totalEvents = i149 + 1;
        needCheckSystemBarColors = i149;
        int i150 = totalEvents;
        totalEvents = i150 + 1;
        needShareTheme = i150;
        int i151 = totalEvents;
        totalEvents = i151 + 1;
        needSetDayNightTheme = i151;
        int i152 = totalEvents;
        totalEvents = i152 + 1;
        goingToPreviewTheme = i152;
        int i153 = totalEvents;
        totalEvents = i153 + 1;
        locationPermissionGranted = i153;
        int i154 = totalEvents;
        totalEvents = i154 + 1;
        reloadInterface = i154;
        int i155 = totalEvents;
        totalEvents = i155 + 1;
        suggestedLangpack = i155;
        int i156 = totalEvents;
        totalEvents = i156 + 1;
        didSetNewWallpapper = i156;
        int i157 = totalEvents;
        totalEvents = i157 + 1;
        proxySettingsChanged = i157;
        int i158 = totalEvents;
        totalEvents = i158 + 1;
        proxyCheckDone = i158;
        int i159 = totalEvents;
        totalEvents = i159 + 1;
        liveLocationsChanged = i159;
        int i160 = totalEvents;
        totalEvents = i160 + 1;
        newLocationAvailable = i160;
        int i161 = totalEvents;
        totalEvents = i161 + 1;
        liveLocationsCacheChanged = i161;
        int i162 = totalEvents;
        totalEvents = i162 + 1;
        notificationsCountUpdated = i162;
        int i163 = totalEvents;
        totalEvents = i163 + 1;
        playerDidStartPlaying = i163;
        int i164 = totalEvents;
        totalEvents = i164 + 1;
        closeSearchByActiveAction = i164;
        int i165 = totalEvents;
        totalEvents = i165 + 1;
        messagePlayingSpeedChanged = i165;
        int i166 = totalEvents;
        totalEvents = i166 + 1;
        screenStateChanged = i166;
        int i167 = totalEvents;
        totalEvents = i167 + 1;
        didDatabaseCleared = i167;
        int i168 = totalEvents;
        totalEvents = i168 + 1;
        voipServiceCreated = i168;
        int i169 = totalEvents;
        totalEvents = i169 + 1;
        webRtcAmplitudeEvent = i169;
    }
