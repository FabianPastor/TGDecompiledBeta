...
public class NotificationCenter {
    ...
    static {
        ...
        int i106 = i105 + 1;
        totalEvents = i106;
        animatedEmojiDocumentLoaded = i105;
        int i107 = i106 + 1;
        totalEvents = i107;
        didGenerateFingerprintKeyPair = i106;
        int i108 = i107 + 1;
        totalEvents = i108;
        walletPendingTransactionsChanged = i107;
        int i109 = i108 + 1;
        totalEvents = i109;
        walletSyncProgressChanged = i108;
        int i110 = i109 + 1;
        totalEvents = i110;
        httpFileDidLoad = i109;
        int i111 = i110 + 1;
        totalEvents = i111;
        httpFileDidFailedLoad = i110;
        int i112 = i111 + 1;
        totalEvents = i112;
        didUpdateConnectionState = i111;
        int i113 = i112 + 1;
        totalEvents = i113;
        fileUploaded = i112;
        int i114 = i113 + 1;
        totalEvents = i114;
        fileUploadFailed = i113;
        int i115 = i114 + 1;
        totalEvents = i115;
        fileUploadProgressChanged = i114;
        int i116 = i115 + 1;
        totalEvents = i116;
        fileLoadProgressChanged = i115;
        int i117 = i116 + 1;
        totalEvents = i117;
        fileLoaded = i116;
        int i118 = i117 + 1;
        ...
        int i119 = i118 + 1;
        totalEvents = i119;
        filePreparingStarted = i118;
        int i120 = i119 + 1;
        totalEvents = i120;
        fileNewChunkAvailable = i119;
        int i121 = i120 + 1;
        totalEvents = i121;
        filePreparingFailed = i120;
        int i122 = i121 + 1;
        totalEvents = i122;
        dialogsUnreadCounterChanged = i121;
        int i123 = i122 + 1;
        totalEvents = i123;
        messagePlayingProgressDidChanged = i122;
        int i124 = i123 + 1;
        totalEvents = i124;
        messagePlayingDidReset = i123;
        int i125 = i124 + 1;
        totalEvents = i125;
        messagePlayingPlayStateChanged = i124;
        int i126 = i125 + 1;
        totalEvents = i126;
        messagePlayingDidStart = i125;
        int i127 = i126 + 1;
        totalEvents = i127;
        messagePlayingDidSeek = i126;
        int i128 = i127 + 1;
        totalEvents = i128;
        messagePlayingGoingToStop = i127;
        int i129 = i128 + 1;
        totalEvents = i129;
        recordProgressChanged = i128;
        int i130 = i129 + 1;
        totalEvents = i130;
        recordStarted = i129;
        int i131 = i130 + 1;
        totalEvents = i131;
        recordStartError = i130;
        int i132 = i131 + 1;
        totalEvents = i132;
        recordStopped = i131;
        int i133 = i132 + 1;
        ...
        int i136 = i135 + 1;
        totalEvents = i136;
        audioRecordTooShort = i135;
        int i137 = i136 + 1;
        totalEvents = i137;
        audioRouteChanged = i136;
        int i138 = i137 + 1;
        totalEvents = i138;
        didStartedCall = i137;
        int i139 = i138 + 1;
        totalEvents = i139;
        groupCallUpdated = i138;
        int i140 = i139 + 1;
        totalEvents = i140;
        groupCallSpeakingUsersUpdated = i139;
        int i141 = i140 + 1;
        totalEvents = i141;
        groupCallScreencastStateChanged = i140;
        int i142 = i141 + 1;
        totalEvents = i142;
        activeGroupCallsUpdated = i141;
        int i143 = i142 + 1;
        totalEvents = i143;
        applyGroupCallVisibleParticipants = i142;
        int i144 = i143 + 1;
        totalEvents = i144;
        groupCallTypingsUpdated = i143;
        int i145 = i144 + 1;
        totalEvents = i145;
        didEndCall = i144;
        int i146 = i145 + 1;
        totalEvents = i146;
        closeInCallActivity = i145;
        int i147 = i146 + 1;
        totalEvents = i147;
        groupCallVisibilityChanged = i146;
        int i148 = i147 + 1;
        totalEvents = i148;
        appDidLogout = i147;
        int i149 = i148 + 1;
        ...
        int i150 = i149 + 1;
        totalEvents = i150;
        needDeleteDialog = i149;
        int i151 = i150 + 1;
        totalEvents = i151;
        newEmojiSuggestionsAvailable = i150;
        int i152 = i151 + 1;
        totalEvents = i152;
        themeUploadedToServer = i151;
        int i153 = i152 + 1;
        totalEvents = i153;
        themeUploadError = i152;
        int i154 = i153 + 1;
        totalEvents = i154;
        dialogFiltersUpdated = i153;
        int i155 = i154 + 1;
        totalEvents = i155;
        filterSettingsUpdated = i154;
        int i156 = i155 + 1;
        totalEvents = i156;
        suggestedFiltersLoaded = i155;
        int i157 = i156 + 1;
        totalEvents = i157;
        updateBotMenuButton = i156;
        int i158 = i157 + 1;
        totalEvents = i158;
        didUpdatePremiumGiftStickers = i157;
        int i159 = i158 + 1;
        totalEvents = i159;
        pushMessagesUpdated = i158;
        int i160 = i159 + 1;
        totalEvents = i160;
        stopEncodingService = i159;
        int i161 = i160 + 1;
        totalEvents = i161;
        wallpapersDidLoad = i160;
        int i162 = i161 + 1;
        totalEvents = i162;
        wallpapersNeedReload = i161;
        int i163 = i162 + 1;
        totalEvents = i163;
        didReceiveSmsCode = i162;
        int i164 = i163 + 1;
        totalEvents = i164;
        didReceiveCall = i163;
        int i165 = i164 + 1;
        ...
        int i166 = i165 + 1;
        totalEvents = i166;
        invalidateMotionBackground = i165;
        int i167 = i166 + 1;
        totalEvents = i167;
        closeOtherAppActivities = i166;
        int i168 = i167 + 1;
        totalEvents = i168;
        cameraInitied = i167;
        int i169 = i168 + 1;
        totalEvents = i169;
        didReplacedPhotoInMemCache = i168;
        int i170 = i169 + 1;
        totalEvents = i170;
        didSetNewTheme = i169;
        int i171 = i170 + 1;
        totalEvents = i171;
        themeListUpdated = i170;
        int i172 = i171 + 1;
        totalEvents = i172;
        didApplyNewTheme = i171;
        int i173 = i172 + 1;
        totalEvents = i173;
        themeAccentListUpdated = i172;
        int i174 = i173 + 1;
        totalEvents = i174;
        needCheckSystemBarColors = i173;
        int i175 = i174 + 1;
        totalEvents = i175;
        needShareTheme = i174;
        int i176 = i175 + 1;
        totalEvents = i176;
        needSetDayNightTheme = i175;
        int i177 = i176 + 1;
        totalEvents = i177;
        goingToPreviewTheme = i176;
        int i178 = i177 + 1;
        totalEvents = i178;
        locationPermissionGranted = i177;
        int i179 = i178 + 1;
        totalEvents = i179;
        locationPermissionDenied = i178;
        int i180 = i179 + 1;
        totalEvents = i180;
        reloadInterface = i179;
        int i181 = i180 + 1;
        totalEvents = i181;
        suggestedLangpack = i180;
        int i182 = i181 + 1;
        totalEvents = i182;
        didSetNewWallpapper = i181;
        int i183 = i182 + 1;
        totalEvents = i183;
        proxySettingsChanged = i182;
        int i184 = i183 + 1;
        totalEvents = i184;
        proxyCheckDone = i183;
        int i185 = i184 + 1;
        totalEvents = i185;
        liveLocationsChanged = i184;
        int i186 = i185 + 1;
        totalEvents = i186;
        newLocationAvailable = i185;
        int i187 = i186 + 1;
        totalEvents = i187;
        liveLocationsCacheChanged = i186;
        int i188 = i187 + 1;
        totalEvents = i188;
        notificationsCountUpdated = i187;
        int i189 = i188 + 1;
        totalEvents = i189;
        playerDidStartPlaying = i188;
        int i190 = i189 + 1;
        totalEvents = i190;
        closeSearchByActiveAction = i189;
        int i191 = i190 + 1;
        totalEvents = i191;
        messagePlayingSpeedChanged = i190;
        int i192 = i191 + 1;
        totalEvents = i192;
        screenStateChanged = i191;
        int i193 = i192 + 1;
        totalEvents = i193;
        didClearDatabase = i192;
        int i194 = i193 + 1;
        totalEvents = i194;
        voipServiceCreated = i193;
        int i195 = i194 + 1;
        totalEvents = i195;
        webRtcMicAmplitudeEvent = i194;
        int i196 = i195 + 1;
        totalEvents = i196;
        webRtcSpeakerAmplitudeEvent = i195;
        int i197 = i196 + 1;
        totalEvents = i197;
        showBulletin = i196;
        int i198 = i197 + 1;
        totalEvents = i198;
        appUpdateAvailable = i197;
        int i199 = i198 + 1;
        totalEvents = i199;
        onDatabaseMigration = i198;
        int i200 = i199 + 1;
        totalEvents = i200;
        onEmojiInteractionsReceived = i199;
        int i201 = i200 + 1;
        totalEvents = i201;
        emojiPreviewThemesChanged = i200;
        int i202 = i201 + 1;
        totalEvents = i202;
        reactionsDidLoad = i201;
        int i203 = i202 + 1;
        totalEvents = i203;
        attachMenuBotsDidLoad = i202;
        int i204 = i203 + 1;
        totalEvents = i204;
        chatAvailableReactionsUpdated = i203;
        int i205 = i204 + 1;
        totalEvents = i205;
        dialogsUnreadReactionsCounterChanged = i204;
        int i206 = i205 + 1;
        totalEvents = i206;
        onDatabaseOpened = i205;
        int i207 = i206 + 1;
        totalEvents = i207;
        onDownloadingFilesChanged = i206;
        int i208 = i207 + 1;
        totalEvents = i208;
        onActivityResultReceived = i207;
        int i209 = i208 + 1;
        totalEvents = i209;
        onRequestPermissionResultReceived = i208;
        int i210 = i209 + 1;
        totalEvents = i210;
        onUserRingtonesUpdated = i209;
        int i211 = i210 + 1;
        totalEvents = i211;
        currentUserPremiumStatusChanged = i210;
        int i212 = i211 + 1;
        totalEvents = i212;
        premiumPromoUpdated = i211;
        int i213 = i212 + 1;
        totalEvents = i213;
        premiumStatusChangedGlobal = i212;
        int i214 = i213 + 1;
        totalEvents = i214;
        currentUserShowLimitReachedDialog = i213;
        int i215 = i214 + 1;
        totalEvents = i215;
        billingProductDetailsUpdated = i214;
        totalEvents = i215 + 1;
        premiumStickersPreviewLoaded = i215;
    }
