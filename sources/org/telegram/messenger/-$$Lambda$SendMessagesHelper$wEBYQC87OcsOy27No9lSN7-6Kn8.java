...
public final /* synthetic */ class -$$Lambda$SendMessagesHelper$wEBYQCLASSNAMEOcsOy27No9lSN7-6Kn8 implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$SendMessagesHelper$wEBYQCLASSNAMEOcsOy27No9lSN7-6Kn8(Bitmap bitmap, String str, MessageObject messageObject, AccountInstance accountInstance, VideoEditedInfo videoEditedInfo, TL_document tL_document, String str2, HashMap hashMap, String str3, long j, MessageObject messageObject2, String str4, ArrayList arrayList, boolean z, int i, int i2) {
        this.f$0 = bitmap;
        this.f$1 = str;
    ...
    public final void run() {
        ...
        SendMessagesHelper.lambda$null$63(bitmap2, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12, this.f$13, this.f$14, this.f$15);
    }
}
