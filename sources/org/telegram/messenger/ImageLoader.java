...
public class ImageLoader {
    ...
    private class CacheImage {
        ...
        /* synthetic */ CacheImage(ImageLoader x0, C04241 x1) {
            this();
        }
    ...
    private class ThumbGenerateInfo {
        ...
        /* synthetic */ ThumbGenerateInfo(ImageLoader x0, C04241 x1) {
            this();
        }
    }
    ...
    public ImageLoader() {
        ...
        BroadcastReceiver receiver = new C04233();
    ...
    public BitmapDrawable getImageFromMemory(TLObject fileLocation, String httpUrl, String filter) {
        ...
        if (httpUrl != null) {
            ...
            if (location2.version == 0) {
                ...
                key = location2.dc_id + "_" + location2.f84id + "_" + location2.version;
            }
        } else if (fileLocation instanceof SecureDocument) {
            SecureDocument location3 = (SecureDocument) fileLocation;
            key = location3.secureFile.dc_id + "_" + location3.secureFile.f200id;
        ...
        if (imageReceiver != null) {
            ...
            if (httpLocation != null) {
                ...
                if (imageLocation instanceof FileLocation) {
                    ...
                    key = document2.secureFile.dc_id + "_" + document2.secureFile.f200id;
                    url = key + "." + ext;
                    if (null != null) {
                        thumbUrl = null + "." + ext;
                    }
                    ...
                    if (document3.f84id != 0 && document3.dc_id != 0) {
                        if (document3.version == 0) {
                            ...
                            key = document3.dc_id + "_" + document3.f84id + "_" + document3.version;
                        }
    ...
    private static PhotoSize scaleAndSaveImageInternal(Bitmap bitmap, int w, int h, float photoW, float photoH, float scaleFactor, int quality, boolean cache, boolean scaleAnyway) throws Exception {
        ...
        size.f110w = scaledBitmap.getWidth();
        size.f109h = scaledBitmap.getHeight();
        if (size.f110w <= 100 && size.f109h <= 100) {
            size.type = "s";
        } else if (size.f110w <= 320 && size.f109h <= 320) {
            size.type = "m";
        } else if (size.f110w <= 800 && size.f109h <= 800) {
            size.type = "x";
        } else if (size.f110w > 1280 || size.f109h > 1280) {
            size.type = "w";
        } else {
            size.type = "y";
        }
    ...
    public static void saveMessageThumbs(Message message) {
        ...
        if (photoSize != null && photoSize.bytes != null && photoSize.bytes.length != 0) {
            ...
            newPhotoSize.f110w = photoSize.f110w;
            newPhotoSize.f109h = photoSize.f109h;
