...
public class ImageLoader {
    ...
    class C02363 extends BroadcastReceiver {
...
*/
            ...
            if (progress == 1.0f || this.lastProgressTime == 0 || this.lastProgressTime < currentTime - 500) {
                ...
                Utilities.stageQueue.postRunnable(new Runnable() {
                    ...
                    public void run() {
                        ...
                        AndroidUtilities.runOnUIThread(new C02471());
                    }
                });
            }
        }
    ...
    private class HttpImageTask extends AsyncTask<Void, Void, Boolean> {
        ...
        class C02512 implements RequestDelegate {
            C02512() {
            }
        ...
        class C02544 implements Runnable {
            C02544() {
            }
        ...
        class C02555 implements Runnable {
            C02555() {
            }
        ...
        class C02576 implements Runnable {
                    ...
                    if (this.cacheImage.httpUrl.startsWith("https://static-maps") || this.cacheImage.httpUrl.startsWith("https://maps.googleapis")) {
                        ...
                        if (provider == 3 || provider == 4) {
                            ...
                            if (webFile != null) {
                                ...
                                req.offset = 0;
                                req.limit = 0;
                                ConnectionsManager.getInstance(this.cacheImage.currentAccount).sendRequest(req, new C02512());
                            }
                        }
                    }
        ...
        protected void onPostExecute(final Boolean result) {
            ...
            ImageLoader.this.imageLoadQueue.postRunnable(new C02544());
        }

        protected void onCancelled() {
            ImageLoader.this.imageLoadQueue.postRunnable(new C02555());
            Utilities.stageQueue.postRunnable(new C02576());
        }
    }
    ...
    public ImageLoader() {
        ...
        BroadcastReceiver receiver = new C02363();
    ...
    public void checkMediaPaths() {
        this.cacheOutQueue.postRunnable(new C02384());
    }
...
*/
    ...
    private static PhotoSize scaleAndSaveImageInternal(Bitmap bitmap, int w, int h, float photoW, float photoH, float scaleFactor, int quality, boolean cache, boolean scaleAnyway) throws Exception {
        ...
        size.f27w = scaledBitmap.getWidth();
        size.f26h = scaledBitmap.getHeight();
        if (size.f27w <= 100 && size.f26h <= 100) {
            size.type = "s";
        } else if (size.f27w <= 320 && size.f26h <= 320) {
            size.type = "m";
        } else if (size.f27w <= 800 && size.f26h <= 800) {
            size.type = "x";
        } else if (size.f27w > 1280 || size.f26h > 1280) {
            size.type = "w";
        } else {
            size.type = "y";
        }
    ...
    public static void saveMessageThumbs(Message message) {
        ...
        if (photoSize != null && photoSize.bytes != null && photoSize.bytes.length != 0) {
            ...
            newPhotoSize.w = photoSize.f27w;
            newPhotoSize.h = photoSize.f26h;
