...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda115 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda115(MessagesController messagesController, MessagesStorage.BooleanCallback booleanCallback, Context context, AlertDialog alertDialog, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_channels_convertToGigagroup tLRPC$TL_channels_convertToGigagroup) {
    ...
    public final void run() {
        this.f$0.lambda$convertToGigaGroup$210(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
