...
public final /* synthetic */ class -$$Lambda$SendMessagesHelper$nc6Scafqy8vNHePpYzkI8smc2ws implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$SendMessagesHelper$nc6Scafqy8vNHePpYzkI8smc2ws(Bitmap[] bitmapArr, String[] strArr, MessageObject messageObject, AccountInstance accountInstance, TL_photo tL_photo, HashMap hashMap, String str, long j, MessageObject messageObject2, SendingMediaInfo sendingMediaInfo, boolean z, int i) {
        this.f$0 = bitmapArr;
        this.f$1 = strArr;
