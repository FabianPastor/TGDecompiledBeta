...
public class RingtoneDataStore {
    ...
    public void m1134lambda$new$0$orgtelegrammessengerringtoneRingtoneDataStore() {
        ...
        req.hash = queryHash;
        if (needReload) {
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RingtoneDataStore$$ExternalSyntheticLambda4(this));
            return;
        }
        if (!this.loaded) {
            loadFromPrefs(true);
    ...
    public /* synthetic */ void m1133x9e2ce1f4(TLObject response, TLRPC.TL_error error) {
        AndroidUtilities.runOnUIThread(new RingtoneDataStore$$ExternalSyntheticLambda2(this, response));
    }

    /* renamed from: lambda$loadUserRingtones$1$org-telegram-messenger-ringtone-RingtoneDataStore  reason: not valid java name */
    public /* synthetic */ void m1132x5aa1CLASSNAME(TLObject response) {
        if (response != null) {
    ...
    public /* synthetic */ void m1131x5CLASSNAME(java.util.ArrayList r6) {
        /*
            r5 = this;
            r0 = 0
        L_0x0001:
        ...
        L_0x0023:
            ...
            org.telegram.tgnet.TLRPC$Document r2 = r1.document
            java.io.File r3 = org.telegram.messenger.FileLoader.getPathToAttach(r2)
            if (r3 == 0) goto L_0x0035
            boolean r4 = r3.exists()
            if (r4 != 0) goto L_0x003d
        L_0x0035:
            org.telegram.messenger.ringtone.RingtoneDataStore$$ExternalSyntheticLambda3 r4 = new org.telegram.messenger.ringtone.RingtoneDataStore$$ExternalSyntheticLambda3
            r4.<init>(r5, r2)
        ...
        L_0x0040:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ringtone.RingtoneDataStore.m1131x5CLASSNAME(java.util.ArrayList):void");
    }

    /* renamed from: lambda$checkRingtoneSoundsLoaded$3$org-telegram-messenger-ringtone-RingtoneDataStore  reason: not valid java name */
    public /* synthetic */ void m1130xCLASSNAMEeb48(TLRPC.Document document) {
