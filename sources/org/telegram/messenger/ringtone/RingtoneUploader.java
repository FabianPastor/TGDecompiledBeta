...
public class RingtoneUploader implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void m1136x23b86CLASSNAME(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m1135x320eCLASSNAME(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m1137lambda$error$2$orgtelegrammessengerringtoneRingtoneUploader(TLRPC.TL_error error) {
