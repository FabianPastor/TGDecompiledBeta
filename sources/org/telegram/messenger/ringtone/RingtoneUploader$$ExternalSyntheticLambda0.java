...
public final /* synthetic */ class RingtoneUploader$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public /* synthetic */ RingtoneUploader$$ExternalSyntheticLambda0(RingtoneUploader ringtoneUploader, TLObject tLObject, TLRPC.TL_error tL_error) {
    ...
    public final void run() {
        this.f$0.m1135x320eCLASSNAME(this.f$1, this.f$2);
    }
}
