                ...
                if (sourceFile.exists()) {
                    ...
                    if (!(context == null || type == 0)) {
                        try {
                            ...
                            try {
                                progressDialog2.setMessage(LocaleController.getString("Loading", C0493R.string.Loading));
