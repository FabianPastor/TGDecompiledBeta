...
public final /* synthetic */ class -$$Lambda$ImageLoader$2$-V5jPiyC2kg0zX7Y5l0pTebxVX4 implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$ImageLoader$2$-V5jPiyC2kg0zX7Y5l0pTebxVX4(int i, String str, InputFile inputFile, InputEncryptedFile inputEncryptedFile, byte[] bArr, byte[] bArr2, long j) {
        this.f$0 = i;
        this.f$1 = str;
        this.f$2 = inputFile;
