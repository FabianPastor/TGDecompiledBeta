...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda285 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda285(MessagesController messagesController, long j, TLRPC$TL_messages_getMessagesViews tLRPC$TL_messages_getMessagesViews) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$updateTimerProc$117(this.f$1, this.f$2, tLObject, tLRPC$TL_error);
    }
}
