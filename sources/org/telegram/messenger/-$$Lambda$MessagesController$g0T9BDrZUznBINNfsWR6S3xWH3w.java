...
public final /* synthetic */ class -$$Lambda$MessagesController$g0T9BDrZUznBINNfsWR6S3xWH3w implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$MessagesController$g0T9BDrZUznBINNfsWR6S3xWH3w(MessagesController messagesController, int i, ArrayList arrayList, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, LongSparseArray longSparseArray3, boolean z, ArrayList arrayList2, ArrayList arrayList3, SparseArray sparseArray) {
    ...
    public final void run() {
        this.f$0.lambda$processUpdateArray$252$MessagesController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9);
    }
}
