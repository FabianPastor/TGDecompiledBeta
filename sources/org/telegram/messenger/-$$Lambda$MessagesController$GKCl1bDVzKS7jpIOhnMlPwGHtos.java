...
public final /* synthetic */ class -$$Lambda$MessagesController$GKCl1bDVzKS7jpIOhnMlPwGHtos implements Runnable {
    ...
    public final void run() {
        this.f$0.lambda$null$270$MessagesController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7);
    }
}
