...
public class UserConfig extends BaseController {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:19:0x013d A[SYNTHETIC, Splitter:B:19:0x013d] */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x019c A[Catch:{ Exception -> 0x0168 }] */
    /* JADX WARNING: Removed duplicated region for block: B:49:0x020a A[Catch:{ Exception -> 0x0168 }] */
    ...
    public void loadConfig() {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r11.configLoaded     // Catch:{ all -> 0x0212 }
            if (r1 == 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0212 }
            return
        L_0x0009:
            android.content.SharedPreferences r1 = r11.getPreferences()     // Catch:{ all -> 0x0212 }
            int r2 = r11.currentAccount     // Catch:{ all -> 0x0212 }
            r3 = 0
            if (r2 != 0) goto L_0x001a
            java.lang.String r2 = "selectedAccount"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            selectedAccount = r2     // Catch:{ all -> 0x0212 }
        L_0x001a:
            java.lang.String r2 = "registeredForPush"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.registeredForPush = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "lastSendMessageId"
            r4 = -210000(0xfffffffffffccbb0, float:NaN)
            int r2 = r1.getInt(r2, r4)     // Catch:{ all -> 0x0212 }
            r11.lastSendMessageId = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "contactsSavedCount"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.contactsSavedCount = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "lastBroadcastId"
            r4 = -1
            int r2 = r1.getInt(r2, r4)     // Catch:{ all -> 0x0212 }
            r11.lastBroadcastId = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "lastContactsSyncTime"
            long r5 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0212 }
            r7 = 1000(0x3e8, double:4.94E-321)
            long r5 = r5 / r7
            int r6 = (int) r5     // Catch:{ all -> 0x0212 }
            r5 = 82800(0x14370, float:1.16028E-40)
            int r6 = r6 - r5
            int r2 = r1.getInt(r2, r6)     // Catch:{ all -> 0x0212 }
            r11.lastContactsSyncTime = r2     // Catch:{ all -> 0x0212 }
            ...
            int r6 = r6 - r5
            int r2 = r1.getInt(r2, r6)     // Catch:{ all -> 0x0212 }
            r11.lastHintsSyncTime = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "draftsLoaded"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.draftsLoaded = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "unreadDialogsLoaded"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.unreadDialogsLoaded = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "contactsReimported"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.contactsReimported = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "ratingLoadTime"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.ratingLoadTime = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "botRatingLoadTime"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.botRatingLoadTime = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "loginTime"
            int r5 = r11.currentAccount     // Catch:{ all -> 0x0212 }
            int r2 = r1.getInt(r2, r5)     // Catch:{ all -> 0x0212 }
            r11.loginTime = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "syncContacts"
            r5 = 1
            boolean r2 = r1.getBoolean(r2, r5)     // Catch:{ all -> 0x0212 }
            r11.syncContacts = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "suggestContacts"
            boolean r2 = r1.getBoolean(r2, r5)     // Catch:{ all -> 0x0212 }
            r11.suggestContacts = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "hasSecureData"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.hasSecureData = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "notificationsSettingsLoaded3"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.notificationsSettingsLoaded = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "notificationsSignUpSettingsLoaded"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.notificationsSignUpSettingsLoaded = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "autoDownloadConfigLoadTime"
            r6 = 0
            long r8 = r1.getLong(r2, r6)     // Catch:{ all -> 0x0212 }
            r11.autoDownloadConfigLoadTime = r8     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "2dialogsLoadOffsetId"
            boolean r2 = r1.contains(r2)     // Catch:{ all -> 0x0212 }
        ...
        L_0x00df:
            r2 = 1
        L_0x00e0:
            r11.hasValidDialogLoadIds = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "tonEncryptedData"
            r8 = 0
            java.lang.String r2 = r1.getString(r2, r8)     // Catch:{ all -> 0x0212 }
            r11.tonEncryptedData = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "tonPublicKey"
            java.lang.String r2 = r1.getString(r2, r8)     // Catch:{ all -> 0x0212 }
            r11.tonPublicKey = r2     // Catch:{ all -> 0x0212 }
            ...
            int r10 = r11.currentAccount     // Catch:{ all -> 0x0212 }
            r9.append(r10)     // Catch:{ all -> 0x0212 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = r1.getString(r2, r9)     // Catch:{ all -> 0x0212 }
            r11.tonKeyName = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "tonCreationFinished"
            boolean r2 = r1.getBoolean(r2, r5)     // Catch:{ all -> 0x0212 }
            r11.tonCreationFinished = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "sharingMyLocationUntil"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.sharingMyLocationUntil = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "lastMyLocationShareTime"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.lastMyLocationShareTime = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "filtersLoaded"
            boolean r2 = r1.getBoolean(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.filtersLoaded = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "tonPasscodeSalt"
            java.lang.String r2 = r1.getString(r2, r8)     // Catch:{ all -> 0x0212 }
            if (r2 == 0) goto L_0x016c
            byte[] r2 = android.util.Base64.decode(r2, r3)     // Catch:{ Exception -> 0x0168 }
            r11.tonPasscodeSalt = r2     // Catch:{ Exception -> 0x0168 }
            java.lang.String r2 = "tonPasscodeType"
            int r2 = r1.getInt(r2, r4)     // Catch:{ Exception -> 0x0168 }
            r11.tonPasscodeType = r2     // Catch:{ Exception -> 0x0168 }
            java.lang.String r2 = "tonPasscodeRetryInMs"
            long r9 = r1.getLong(r2, r6)     // Catch:{ Exception -> 0x0168 }
            r11.tonPasscodeRetryInMs = r9     // Catch:{ Exception -> 0x0168 }
            java.lang.String r2 = "tonLastUptimeMillis"
            long r9 = r1.getLong(r2, r6)     // Catch:{ Exception -> 0x0168 }
            r11.tonLastUptimeMillis = r9     // Catch:{ Exception -> 0x0168 }
            java.lang.String r2 = "tonBadPasscodeTries"
            int r2 = r1.getInt(r2, r3)     // Catch:{ Exception -> 0x0168 }
            r11.tonBadPasscodeTries = r2     // Catch:{ Exception -> 0x0168 }
            goto L_0x016c
        L_0x0168:
            r2 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r2)     // Catch:{ all -> 0x0212 }
        L_0x016c:
            java.lang.String r2 = "terms"
            java.lang.String r2 = r1.getString(r2, r8)     // Catch:{ Exception -> 0x018e }
            if (r2 == 0) goto L_0x0192
            byte[] r2 = android.util.Base64.decode(r2, r3)     // Catch:{ Exception -> 0x018e }
            if (r2 == 0) goto L_0x0192
            org.telegram.tgnet.SerializedData r9 = new org.telegram.tgnet.SerializedData     // Catch:{ Exception -> 0x018e }
            r9.<init>((byte[]) r2)     // Catch:{ Exception -> 0x018e }
            int r2 = r9.readInt32(r3)     // Catch:{ Exception -> 0x018e }
            org.telegram.tgnet.TLRPC$TL_help_termsOfService r2 = org.telegram.tgnet.TLRPC$TL_help_termsOfService.TLdeserialize(r9, r2, r3)     // Catch:{ Exception -> 0x018e }
            r11.unacceptedTermsOfService = r2     // Catch:{ Exception -> 0x018e }
        ...
        L_0x0192:
            ...
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetId = r2     // Catch:{ all -> 0x0212 }
            if (r2 == r4) goto L_0x01c4
            java.lang.String r2 = "6migrateOffsetDate"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetDate = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "6migrateOffsetUserId"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetUserId = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "6migrateOffsetChatId"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetChatId = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "6migrateOffsetChannelId"
            int r2 = r1.getInt(r2, r3)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetChannelId = r2     // Catch:{ all -> 0x0212 }
            java.lang.String r2 = "6migrateOffsetAccess"
            long r6 = r1.getLong(r2, r6)     // Catch:{ all -> 0x0212 }
            r11.migrateOffsetAccess = r6     // Catch:{ all -> 0x0212 }
        L_0x01c4:
            java.lang.String r2 = "tmpPassword"
            java.lang.String r2 = r1.getString(r2, r8)     // Catch:{ all -> 0x0212 }
            if (r2 == 0) goto L_0x01e5
            byte[] r2 = android.util.Base64.decode(r2, r3)     // Catch:{ all -> 0x0212 }
            if (r2 == 0) goto L_0x01e5
            org.telegram.tgnet.SerializedData r4 = new org.telegram.tgnet.SerializedData     // Catch:{ all -> 0x0212 }
            r4.<init>((byte[]) r2)     // Catch:{ all -> 0x0212 }
            int r2 = r4.readInt32(r3)     // Catch:{ all -> 0x0212 }
            org.telegram.tgnet.TLRPC$TL_account_tmpPassword r2 = org.telegram.tgnet.TLRPC$TL_account_tmpPassword.TLdeserialize(r4, r2, r3)     // Catch:{ all -> 0x0212 }
            r11.tmpPassword = r2     // Catch:{ all -> 0x0212 }
            r4.cleanup()     // Catch:{ all -> 0x0212 }
        L_0x01e5:
            java.lang.String r2 = "user"
            java.lang.String r1 = r1.getString(r2, r8)     // Catch:{ all -> 0x0212 }
            if (r1 == 0) goto L_0x0206
            byte[] r1 = android.util.Base64.decode(r1, r3)     // Catch:{ all -> 0x0212 }
            if (r1 == 0) goto L_0x0206
            org.telegram.tgnet.SerializedData r2 = new org.telegram.tgnet.SerializedData     // Catch:{ all -> 0x0212 }
            r2.<init>((byte[]) r1)     // Catch:{ all -> 0x0212 }
            int r1 = r2.readInt32(r3)     // Catch:{ all -> 0x0212 }
            org.telegram.tgnet.TLRPC$User r1 = org.telegram.tgnet.TLRPC$User.TLdeserialize(r2, r1, r3)     // Catch:{ all -> 0x0212 }
            r11.currentUser = r1     // Catch:{ all -> 0x0212 }
            r2.cleanup()     // Catch:{ all -> 0x0212 }
        L_0x0206:
            org.telegram.tgnet.TLRPC$User r1 = r11.currentUser     // Catch:{ all -> 0x0212 }
            if (r1 == 0) goto L_0x020e
            int r1 = r1.id     // Catch:{ all -> 0x0212 }
            r11.clientUserId = r1     // Catch:{ all -> 0x0212 }
        L_0x020e:
            r11.configLoaded = r5     // Catch:{ all -> 0x0212 }
            monitor-exit(r0)     // Catch:{ all -> 0x0212 }
            return
        L_0x0212:
            r1 = move-exception
