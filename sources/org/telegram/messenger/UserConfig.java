...
public class UserConfig extends BaseController {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:27:0x014f A:{Catch:{ Exception -> 0x0168 }} */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x0170 A:{Catch:{ Exception -> 0x0143 }} */
    /* JADX WARNING: Removed duplicated region for block: B:59:0x01fd A:{Catch:{ Exception -> 0x0143 }} */
    /* JADX WARNING: Removed duplicated region for block: B:62:0x022d A:{Catch:{ Exception -> 0x0143 }} */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x024e A:{Catch:{ Exception -> 0x0143 }} */
    /* JADX WARNING: Removed duplicated region for block: B:72:0x026a A:{Catch:{ Exception -> 0x0143 }} */
    public void loadConfig() {
        /*
        r13 = this;
        r0 = r13.sync;
        monitor-enter(r0);
        r1 = r13.configLoaded;	 Catch:{ all -> 0x0274 }
        if (r1 == 0) goto L_0x0009;
    L_0x0007:
        monitor-exit(r0);	 Catch:{ all -> 0x0274 }
        return;
    L_0x0009:
        r1 = r13.getPreferences();	 Catch:{ all -> 0x0274 }
        r2 = r13.currentAccount;	 Catch:{ all -> 0x0274 }
        r3 = 0;
        if (r2 != 0) goto L_0x001a;
    L_0x0012:
        r2 = "selectedAccount";
        r2 = r1.getInt(r2, r3);	 Catch:{ all -> 0x0274 }
        selectedAccount = r2;	 Catch:{ all -> 0x0274 }
    L_0x001a:
        r2 = "registeredForPush";
        r2 = r1.getBoolean(r2, r3);	 Catch:{ all -> 0x0274 }
        r13.registeredForPush = r2;	 Catch:{ all -> 0x0274 }
        r2 = "lastSendMessageId";
        r4 = -210000; // 0xfffffffffffccbb0 float:NaN double:NaN;
        r2 = r1.getInt(r2, r4);	 Catch:{ all -> 0x0274 }
        ...
        r5 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x0274 }
        r7 = 1000; // 0x3e8 float:1.401E-42 double:4.94E-321;
        r5 = r5 / r7;
        r6 = (int) r5;	 Catch:{ all -> 0x0274 }
        r5 = 82800; // 0x14370 float:1.16028E-40 double:4.09086E-319;
        r6 = r6 - r5;
        r2 = r1.getInt(r2, r6);	 Catch:{ all -> 0x0274 }
        ...
        r2 = "loginTime";
        r5 = r13.currentAccount;	 Catch:{ all -> 0x0274 }
        r2 = r1.getInt(r2, r5);	 Catch:{ all -> 0x0274 }
        r13.loginTime = r2;	 Catch:{ all -> 0x0274 }
        r2 = "syncContacts";
        r5 = 1;
        r2 = r1.getBoolean(r2, r5);	 Catch:{ all -> 0x0274 }
    ...
    L_0x00dd:
        ...
        r2 = "tonEncryptedData";
        r8 = 0;
        r2 = r1.getString(r2, r8);	 Catch:{ all -> 0x0274 }
        r13.tonEncryptedData = r2;	 Catch:{ all -> 0x0274 }
        r2 = "tonPublicKey";
        r2 = r1.getString(r2, r8);	 Catch:{ all -> 0x0274 }
        r13.tonPublicKey = r2;	 Catch:{ all -> 0x0274 }
        r2 = "tonKeyName";
        r9 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0274 }
        r9.<init>();	 Catch:{ all -> 0x0274 }
        r10 = "walletKey";
        r9.append(r10);	 Catch:{ all -> 0x0274 }
        r10 = r13.currentAccount;	 Catch:{ all -> 0x0274 }
        r9.append(r10);	 Catch:{ all -> 0x0274 }
        r9 = r9.toString();	 Catch:{ all -> 0x0274 }
        r2 = r1.getString(r2, r9);	 Catch:{ all -> 0x0274 }
    ...
    L_0x0143:
        r2 = move-exception;
        org.telegram.messenger.FileLog.e(r2);	 Catch:{ all -> 0x0274 }
    L_0x0147:
        r2 = "terms";
        r2 = r1.getString(r2, r8);	 Catch:{ Exception -> 0x0168 }
        if (r2 == 0) goto L_0x016c;
    L_0x014f:
        r2 = android.util.Base64.decode(r2, r3);	 Catch:{ Exception -> 0x0168 }
        if (r2 == 0) goto L_0x016c;
    L_0x0155:
        r9 = new org.telegram.tgnet.SerializedData;	 Catch:{ Exception -> 0x0168 }
        r9.<init>(r2);	 Catch:{ Exception -> 0x0168 }
        r2 = r9.readInt32(r3);	 Catch:{ Exception -> 0x0168 }
        r2 = org.telegram.tgnet.TLRPC.TL_help_termsOfService.TLdeserialize(r9, r2, r3);	 Catch:{ Exception -> 0x0168 }
    ...
    L_0x0170:
        ...
        r9 = java.lang.System.currentTimeMillis();	 Catch:{ all -> 0x0274 }
        r9 = r1.getLong(r2, r9);	 Catch:{ all -> 0x0274 }
        r13.lastUpdateCheckTime = r9;	 Catch:{ all -> 0x0274 }
        r2 = "appUpdate";
        r2 = r1.getString(r2, r8);	 Catch:{ Exception -> 0x01ed }
        if (r2 == 0) goto L_0x01b4;
    L_0x0184:
        r9 = "appUpdateBuild";
        r10 = org.telegram.messenger.BuildVars.BUILD_VERSION;	 Catch:{ Exception -> 0x01ed }
        r9 = r1.getInt(r9, r10);	 Catch:{ Exception -> 0x01ed }
        r13.pendingAppUpdateBuildVersion = r9;	 Catch:{ Exception -> 0x01ed }
        r9 = "appUpdateTime";
        r10 = java.lang.System.currentTimeMillis();	 Catch:{ Exception -> 0x01ed }
        r9 = r1.getLong(r9, r10);	 Catch:{ Exception -> 0x01ed }
        r13.pendingAppUpdateInstallTime = r9;	 Catch:{ Exception -> 0x01ed }
        r2 = android.util.Base64.decode(r2, r3);	 Catch:{ Exception -> 0x01ed }
        if (r2 == 0) goto L_0x01b4;
    L_0x01a0:
        r9 = new org.telegram.tgnet.SerializedData;	 Catch:{ Exception -> 0x01ed }
        r9.<init>(r2);	 Catch:{ Exception -> 0x01ed }
        r2 = r9.readInt32(r3);	 Catch:{ Exception -> 0x01ed }
        r2 = org.telegram.tgnet.TLRPC.help_AppUpdate.TLdeserialize(r9, r2, r3);	 Catch:{ Exception -> 0x01ed }
        r2 = (org.telegram.tgnet.TLRPC.TL_help_appUpdate) r2;	 Catch:{ Exception -> 0x01ed }
        r13.pendingAppUpdate = r2;	 Catch:{ Exception -> 0x01ed }
        r9.cleanup();	 Catch:{ Exception -> 0x01ed }
    L_0x01b4:
        r2 = r13.pendingAppUpdate;	 Catch:{ Exception -> 0x01ed }
        if (r2 == 0) goto L_0x01f1;
    L_0x01b8:
        r2 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Exception -> 0x01d1 }
        r2 = r2.getPackageManager();	 Catch:{ Exception -> 0x01d1 }
        r9 = org.telegram.messenger.ApplicationLoader.applicationContext;	 Catch:{ Exception -> 0x01d1 }
        r9 = r9.getPackageName();	 Catch:{ Exception -> 0x01d1 }
        r2 = r2.getPackageInfo(r9, r3);	 Catch:{ Exception -> 0x01d1 }
        r9 = r2.lastUpdateTime;	 Catch:{ Exception -> 0x01d1 }
        r11 = r2.firstInstallTime;	 Catch:{ Exception -> 0x01d1 }
        r9 = java.lang.Math.max(r9, r11);	 Catch:{ Exception -> 0x01d1 }
        goto L_0x01d6;
    L_0x01d1:
        r2 = move-exception;
        org.telegram.messenger.FileLog.e(r2);	 Catch:{ Exception -> 0x01ed }
        r9 = r6;
    L_0x01d6:
        r2 = r13.pendingAppUpdateBuildVersion;	 Catch:{ Exception -> 0x01ed }
        r11 = org.telegram.messenger.BuildVars.BUILD_VERSION;	 Catch:{ Exception -> 0x01ed }
        if (r2 != r11) goto L_0x01e2;
    L_0x01dc:
        r11 = r13.pendingAppUpdateInstallTime;	 Catch:{ Exception -> 0x01ed }
        r2 = (r11 > r9 ? 1 : (r11 == r9 ? 0 : -1));
        if (r2 >= 0) goto L_0x01f1;
    L_0x01e2:
        r13.pendingAppUpdate = r8;	 Catch:{ Exception -> 0x01ed }
        r2 = new org.telegram.messenger.-$$Lambda$UserConfig$HoXioNChxQlw-svExyMbii8fWo0;	 Catch:{ Exception -> 0x01ed }
        r2.<init>(r13);	 Catch:{ Exception -> 0x01ed }
    ...
    L_0x01f1:
        ...
        r2 = r13.migrateOffsetId;	 Catch:{ all -> 0x0274 }
    ...
    L_0x01fd:
        ...
        r6 = r1.getLong(r2, r6);	 Catch:{ all -> 0x0274 }
    ...
    L_0x022d:
        r2 = android.util.Base64.decode(r2, r3);	 Catch:{ all -> 0x0274 }
        if (r2 == 0) goto L_0x0245;
    L_0x0233:
        r4 = new org.telegram.tgnet.SerializedData;	 Catch:{ all -> 0x0274 }
        r4.<init>(r2);	 Catch:{ all -> 0x0274 }
        r2 = r4.readInt32(r3);	 Catch:{ all -> 0x0274 }
        r2 = org.telegram.tgnet.TLRPC.TL_account_tmpPassword.TLdeserialize(r4, r2, r3);	 Catch:{ all -> 0x0274 }
        r13.tmpPassword = r2;	 Catch:{ all -> 0x0274 }
        r4.cleanup();	 Catch:{ all -> 0x0274 }
    L_0x0245:
        r2 = "user";
        r1 = r1.getString(r2, r8);	 Catch:{ all -> 0x0274 }
        if (r1 == 0) goto L_0x0266;
    L_0x024e:
        r1 = android.util.Base64.decode(r1, r3);	 Catch:{ all -> 0x0274 }
        if (r1 == 0) goto L_0x0266;
    L_0x0254:
        r2 = new org.telegram.tgnet.SerializedData;	 Catch:{ all -> 0x0274 }
        r2.<init>(r1);	 Catch:{ all -> 0x0274 }
        r1 = r2.readInt32(r3);	 Catch:{ all -> 0x0274 }
        r1 = org.telegram.tgnet.TLRPC.User.TLdeserialize(r2, r1, r3);	 Catch:{ all -> 0x0274 }
        r13.currentUser = r1;	 Catch:{ all -> 0x0274 }
        r2.cleanup();	 Catch:{ all -> 0x0274 }
    L_0x0266:
        r1 = r13.currentUser;	 Catch:{ all -> 0x0274 }
        if (r1 == 0) goto L_0x0270;
    L_0x026a:
        r1 = r13.currentUser;	 Catch:{ all -> 0x0274 }
        r1 = r1.id;	 Catch:{ all -> 0x0274 }
