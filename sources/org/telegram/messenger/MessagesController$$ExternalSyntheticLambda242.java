...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda242 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda242(MessagesController messagesController, TLRPC.TL_inputChatPhoto tL_inputChatPhoto, TLRPC.FileLocation fileLocation, TLRPC.FileLocation fileLocation2, String str, Runnable runnable) {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m125x5914854c(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, tLObject, tL_error);
    }
}
