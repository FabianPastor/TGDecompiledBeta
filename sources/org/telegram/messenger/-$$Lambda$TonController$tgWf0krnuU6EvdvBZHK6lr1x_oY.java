...
public final /* synthetic */ class -$$Lambda$TonController$tgWf0krnuU6EvdvBZHK6lr1x_oY implements BytesCallback {
    ...
    public /* synthetic */ -$$Lambda$TonController$tgWf0krnuU6EvdvBZHK6lr1x_oY(TonController tonController, ErrorCallback errorCallback, boolean z, String[] strArr, WordsCallback wordsCallback) {
    ...
    public final void run(byte[] bArr) {
        this.f$0.lambda$createWallet$11$TonController(this.f$1, this.f$2, this.f$3, this.f$4, bArr);
    }
}
