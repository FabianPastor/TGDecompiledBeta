...
class FeedRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory, NotificationCenter.NotificationCenterDelegate {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        if (messageObject.photoThumbs == null || messageObject.photoThumbs.isEmpty()) {
            ...
            File f = FileLoader.getInstance(UserConfig.selectedAccount).getPathToAttach(FileLoader.getClosestPhotoSizeWithSize(messageObject.photoThumbs, AndroidUtilities.getPhotoSize()));
            if (f.exists()) {
                rv.setViewVisibility(NUM, 0);
    ...
    public /* synthetic */ void m1802xab71b43d() {
