...
public class MessagesController implements NotificationCenterDelegate {
    ...
    private final Comparator<TL_dialog> dialogComparator = new C03212();
    ...
    private Runnable themeCheckRunnable = new C03161();
    private final Comparator<Update> updatesComparator = new C03273();
    ...
    class C03212 implements Comparator<TL_dialog> {
        C03212() {
        }
    ...
    class C03273 implements Comparator<Update> {
        C03273() {
        }
    ...
    class C03304 implements Runnable {
        C03304() {
        }
    ...
    class C03507 implements Runnable {
        C03507() {
        }
    ...
    class C18106 implements RequestDelegate {
    ...
    public MessagesController(int num) {
        ...
        AndroidUtilities.runOnUIThread(new C03304());
        addSupportUser();
    ...
    public void didReceivedNotification(int id, int account, Object... args) {
        ...
        if (id == NotificationCenter.FileDidUpload) {
            ...
            if (this.uploadingAvatar != null && this.uploadingAvatar.equals(location)) {
                ...
                req.file = file;
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new C18106());
            }
    ...
    public void cleanup() {
        ...
        Utilities.stageQueue.postRunnable(new C03507());
        ...
        Utilities.stageQueue.postRunnable(new C03598());
                ...
                ConnectionsManager.getInstance(this.currentAccount).bindRequestToGuid(ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                    ...
                    public void run(final TLObject response, TL_error error) {
                        if (error == null) {
                            ...
                            AndroidUtilities.runOnUIThread(new C03142());
                        }
                    }
                }), classGuid);
            }
    ...
    private boolean checkDeletingTask(boolean runnable) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            public void run() {
                ...
                Utilities.stageQueue.postRunnable(new C03191());
            }
        });
        return true;
    }
            ...
            public void run() {
                ...
                if (messages != null) {
                    ...
                    if (!MessagesController.this.checkDeletingTask(false)) {
                        MessagesController.this.currentDeleteTaskRunnable = new C03201();
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                ...
                public void run(TLObject response, final TL_error error) {
                    if (error == null) {
                        ...
                        AndroidUtilities.runOnUIThread(new C03221(), 1000);
                        return;
                    }
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
        ...
        if (user != null && rights != null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                ...
                public void run(TLObject response, final TL_error error) {
                    if (error == null) {
                        MessagesController.this.processUpdates((Updates) response, false);
                        AndroidUtilities.runOnUIThread(new C03241(), 1000);
                        return;
                    }
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
    ...
    public void loadMessages(long dialog_id, int count, int max_id, int offset_date, boolean fromCache, int midDate, int classGuid, int load_type, int last_message_id, boolean isChannel, int loadIndex, int first_unread, int unread_count, int last_date, boolean queryFromServer, int mentionsCount) {
        ...
        if ((load_type == 3 || load_type == 2) && last_message_id == 0) {
            loadMessages(dialog_id, 1, 0, 0, false, 0, classGuid, 0, 0, isChannel, -1, 0, 0, 0, false, 0);
        }
    ...
    private void migrateDialogs(final int offset, int offsetDate, int offsetUser, int offsetChat, int offsetChannel, long accessPeer) {
        if (!this.migratingDialogs && offset != -1) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                ...
                /* renamed from: org.telegram.messenger.MessagesController$67$2 */
                ...
                public void run(TLObject response, TL_error error) {
                    if (error == null) {
                        ...
                        MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                            ...
                            /* renamed from: org.telegram.messenger.MessagesController$67$1$1 */
                    ...
                    AndroidUtilities.runOnUIThread(new C03432());
                }
            });
        }
    }
    ...
    public void convertToMegaGroup(final Context context, int chat_id) {
        ...
        final int reqId = ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
            ...
            /* renamed from: org.telegram.messenger.MessagesController$88$2 */
        ...
        if (user != null) {
            if (chat_id > 0) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(request, new RequestDelegate() {
                    ...
                    /* renamed from: org.telegram.messenger.MessagesController$99$3 */
                    ...
                    public void run(TLObject response, final TL_error error) {
                        if (isChannel && (inputUser instanceof TL_inputUserSelf)) {
                            AndroidUtilities.runOnUIThread(new C03651());
                        }
                        if (error != null) {
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                        ...
                        if (isChannel) {
                            ...
                            AndroidUtilities.runOnUIThread(new C03673(), 1000);
                        }
                        if (isChannel && (inputUser instanceof TL_inputUserSelf)) {
        ...
        if (user != null) {
            ...
            if (chat_id > 0) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(request, new RequestDelegate() {
                    ...
                    /* renamed from: org.telegram.messenger.MessagesController$100$2 */
                    ...
                    public void run(TLObject response, TL_error error) {
                        ...
                        if (error == null) {
                            MessagesController.this.processUpdates((Updates) response, false);
                            if (isChannel && !(inputUser instanceof TL_inputUserSelf)) {
                                AndroidUtilities.runOnUIThread(new C02772(), 1000);
                            }
                        }
                    }
                }, 64);
            ...
            if (!UserConfig.getInstance(this.currentAccount).registeredForPush || !regid.equals(SharedConfig.pushString)) {
                ...
                ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                    ...
                    public void run(TLObject response, TL_error error) {
                        ...
                        AndroidUtilities.runOnUIThread(new C02781());
                    }
                });
            }
        }
                                ...
                                public void run(TLObject response, TL_error error) {
                                    if (error == null) {
                                        ...
                                        MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                            ...
                                            /* renamed from: org.telegram.messenger.MessagesController$114$2$2 */
                                                    ...
                                                    if ((res instanceof TL_updates_channelDifference) || (res instanceof TL_updates_channelDifferenceEmpty)) {
                                                        if (!res.new_messages.isEmpty()) {
                                                            ...
                                                            MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                                                ...
                                                                /* renamed from: org.telegram.messenger.MessagesController$114$2$2$2$1 */
                                            ...
                                            public void run() {
                                                ...
                                                Utilities.stageQueue.postRunnable(new C02842());
                                            }
                                        });
                                        return;
                                    }
                ...
                public void run(TLObject response, TL_error error) {
                    if (error == null) {
                        ...
                        MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                            ...
                            /* renamed from: org.telegram.messenger.MessagesController$115$3$2 */
                                ...
                                public void run() {
                                    ...
                                    if (!(res.new_messages.isEmpty() && res.new_encrypted_messages.isEmpty())) {
                                        ...
                                        MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                            ...
                                            /* renamed from: org.telegram.messenger.MessagesController$115$3$2$2$1 */
                            ...
                            public void run() {
                                ...
                                Utilities.stageQueue.postRunnable(new C02932());
                            }
                        });
                        return;
                    }
                ...
                public void run(TLObject response, TL_error error) {
                    if (response != null) {
                        ...
                        MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                            ...
                            /* renamed from: org.telegram.messenger.MessagesController$117$1$1 */
                            ...
                            public void run() {
                                AndroidUtilities.runOnUIThread(new C02951());
                            }
                        });
                    }
                }
        ...
        if (chat != null && ChatObject.isChannel(chat_id, this.currentAccount)) {
            if ((!chat.left && !chat.kicked) || ignoreLeft) {
                ...
                MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                    ...
                    /* renamed from: org.telegram.messenger.MessagesController$118$1 */
                            ...
                            if (res != null && (res.participant instanceof TL_channelParticipantSelf) && res.participant.inviter_id != UserConfig.getInstance(MessagesController.this.currentAccount).getClientUserId()) {
                                if (!chat.megagroup || !MessagesStorage.getInstance(MessagesController.this.currentAccount).isMigratedChat(chat.id)) {
                                    ...
                                    MessagesStorage.getInstance(MessagesController.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                        ...
                                        /* renamed from: org.telegram.messenger.MessagesController$120$1$2$1 */
            ...
            if (missingData) {
                ...
                if (!messageObject.isOut()) {
                    ...
                    MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                        ...
                        /* renamed from: org.telegram.messenger.MessagesController$123$1 */
    ...
    public boolean processUpdateArray(ArrayList<Update> updates, ArrayList<User> usersArr, ArrayList<Chat> chatsArr, boolean fromGetDifference) {
        ...
        if (pushMessages != null) {
            ...
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                ...
                public void run() {
                    AndroidUtilities.runOnUIThread(new C03041());
                }
            });
        }
        if (messagesArr != null) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            /* renamed from: org.telegram.messenger.MessagesController$131$3 */
            class C18083 implements RequestDelegate {
                C18083() {
                }
                            ...
                            if (call instanceof TL_phoneCallRequested) {
                                if (call.date + (MessagesController.this.callRingTimeout / 1000) >= ConnectionsManager.getInstance(MessagesController.this.currentAccount).getCurrentTime()) {
                                    ...
                                    if (svc == null && VoIPService.callIShouldHavePutIntoIntent == null && tm.getCallState() == 0) {
                                        ...
                                        ConnectionsManager.getInstance(MessagesController.this.currentAccount).sendRequest(req, new C18083());
                                    }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    public void run() {
                        if (progressDialog[0] != null) {
                            ...
                            progressDialog[0].setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C03101());
