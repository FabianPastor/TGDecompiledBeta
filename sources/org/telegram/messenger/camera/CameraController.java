...
public class CameraController implements MediaRecorder.OnInfoListener {
    ...
    public /* synthetic */ void m2401x6e3d3dee(boolean withDelay, Runnable onInitRunnable) {
        String str;
        ...
        try {
            if (cameraController.cameraInfos == null) {
                ...
                String cache = preferences.getString(str3, (String) null);
                                ...
                                try {
                                    ...
                                    if (size.width == 1280) {
                                        try {
                                            ...
                                            e = e;
                                            FileLog.e((Throwable) e, !str.equals(e.getMessage()));
    ...
    public /* synthetic */ void m2398xc0dd5851() {
    ...
    public /* synthetic */ void m2400x34729c0f(boolean withDelay, Exception e, Runnable onInitRunnable) {
        this.onFinishCameraInitRunnables.clear();
        this.loadingCameras = false;
    ...
    public /* synthetic */ void m2399xfaa7fa30(Runnable onInitRunnable) {
    ...
    public /* synthetic */ void m2402lambda$open$10$orgtelegrammessengercameraCameraController(CameraSession session, Runnable prestartCallback, SurfaceTexture texture, Runnable callback) {
        Camera camera = session.cameraInfo.camera;
        if (camera == null) {
            try {
                CameraInfo cameraInfo = session.cameraInfo;
    ...
    public /* synthetic */ void m2404x55var_fb8(Camera camera, CameraSession session, CameraView cameraView, File path, Runnable onVideoStartRecord) {
        if (camera != null) {
            try {
                Camera.Parameters params = camera.getParameters();
    ...
    public /* synthetic */ void m2403x1c2acdd9(CameraView cameraView, File path, Runnable onVideoStartRecord) {
    ...
    public /* synthetic */ void m2405x8fCLASSNAME(Camera camera, CameraSession session, boolean mirror, File path, CameraInfo info, VideoTakeCallback callback, Runnable onVideoStartRecord) {
        int bitrate;
        if (camera != null) {
            try {
                Camera.Parameters params = camera.getParameters();
    ...
    public /* synthetic */ void m2397x1d61ce23(File cacheFile, Bitmap bitmapFinal, long durationFinal) {
    ...
    public /* synthetic */ void m2406x9d3b7c3c(CameraSession session, boolean abandon) {
