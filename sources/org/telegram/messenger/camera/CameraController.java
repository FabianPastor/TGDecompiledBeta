...
public class CameraController implements MediaRecorder.OnInfoListener {
    ...
    public /* synthetic */ void m1115x6e3d3dee(boolean withDelay, Runnable onInitRunnable) {
        String cache;
    ...
    public /* synthetic */ void m1112xc0dd5851() {
    ...
    public /* synthetic */ void m1114x34729c0f(boolean withDelay, Exception e, Runnable onInitRunnable) {
        this.onFinishCameraInitRunnables.clear();
        this.loadingCameras = false;
    ...
    public /* synthetic */ void m1113xfaa7fa30(Runnable onInitRunnable) {
    ...
    public /* synthetic */ void m1116lambda$open$10$orgtelegrammessengercameraCameraController(CameraSession session, Runnable prestartCallback, SurfaceTexture texture, Runnable callback) {
        Camera camera = session.cameraInfo.camera;
        if (camera == null) {
            try {
                CameraInfo cameraInfo = session.cameraInfo;
    ...
    public /* synthetic */ void m1118x55var_fb8(Camera camera, CameraSession session, CameraView cameraView, File path, Runnable onVideoStartRecord) {
        if (camera != null) {
            try {
                Camera.Parameters params = camera.getParameters();
    ...
    public /* synthetic */ void m1117x1c2acdd9(CameraView cameraView, File path, Runnable onVideoStartRecord) {
    ...
    public /* synthetic */ void m1119x8fCLASSNAME(Camera camera, CameraSession session, boolean mirror, File path, CameraInfo info, VideoTakeCallback callback, Runnable onVideoStartRecord) {
        int bitrate;
        if (camera != null) {
            try {
                Camera.Parameters params = camera.getParameters();
    ...
    public /* synthetic */ void m1111x1d61ce23(File cacheFile, Bitmap bitmapFinal, long durationFinal) {
    ...
    public /* synthetic */ void m1120x9d3b7c3c(CameraSession session, boolean abandon) {
