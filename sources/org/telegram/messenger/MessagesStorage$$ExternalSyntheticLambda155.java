...
public final /* synthetic */ class MessagesStorage$$ExternalSyntheticLambda155 implements Runnable {
    ...
    public /* synthetic */ MessagesStorage$$ExternalSyntheticLambda155(MessagesStorage messagesStorage, LongSparseIntArray longSparseIntArray, LongSparseIntArray longSparseIntArray2, SparseIntArray sparseIntArray) {
    ...
    public final void run() {
        this.f$0.lambda$markMessagesAsRead$167(this.f$1, this.f$2, this.f$3);
    }
}
