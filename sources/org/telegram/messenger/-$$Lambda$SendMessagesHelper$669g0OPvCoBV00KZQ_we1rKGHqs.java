...
public final /* synthetic */ class -$$Lambda$SendMessagesHelper$669g0OPvCoBV00KZQ_we1rKGHqs implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$SendMessagesHelper$669g0OPvCoBV00KZQ_we1rKGHqs(Bitmap bitmap, String str, MessageObject messageObject, AccountInstance accountInstance, VideoEditedInfo videoEditedInfo, TL_document tL_document, String str2, HashMap hashMap, String str3, long j, MessageObject messageObject2, SendingMediaInfo sendingMediaInfo) {
        this.f$0 = bitmap;
        this.f$1 = str;
    ...
    public final void run() {
        SendMessagesHelper.lambda$null$58(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11);
    }
}
