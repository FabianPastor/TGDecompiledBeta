...
public class NotificationBadge {
    ...
    private static boolean initBadger() {
        ...
        ResolveInfo resolveInfo = context.getPackageManager().resolveActivity(intent, C0559C.DEFAULT_BUFFER_SEGMENT_SIZE);
        if (resolveInfo != null) {
        ...
        List<ResolveInfo> resolveInfos = context.getPackageManager().queryIntentActivities(intent, C0559C.DEFAULT_BUFFER_SEGMENT_SIZE);
