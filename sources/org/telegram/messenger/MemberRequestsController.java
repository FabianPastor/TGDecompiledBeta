...
public class MemberRequestsController extends BaseController {
    ...
    public /* synthetic */ void m2126x928219c8(long chatId, RequestDelegate onComplete, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m2125x92var_fc7(TLRPC.TL_error error, TLObject response, long chatId, RequestDelegate onComplete) {
        if (error == null) {
