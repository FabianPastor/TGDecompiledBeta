...
public final /* synthetic */ class SendMessagesHelper$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ SendMessagesHelper$$ExternalSyntheticLambda1(ArrayList arrayList, long j, boolean z, boolean z2, AccountInstance accountInstance, MessageObject messageObject, MessageObject messageObject2, MessageObject messageObject3, boolean z3, int i, InputContentInfoCompat inputContentInfoCompat) {
        this.f$0 = arrayList;
        this.f$1 = j;
        this.f$2 = z;
        this.f$3 = z2;
