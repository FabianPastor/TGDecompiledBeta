...
public class MrzRecognizer {
    ...
    private static org.telegram.messenger.MrzRecognizer.Result recognizeBarcode(android.graphics.Bitmap r13) {
        ...
        L_0x019f:
            ...
            java.lang.String r5 = r4.rawValue     // Catch:{ Exception -> 0x024e }
            byte[] r5 = android.util.Base64.decode(r5, r7)     // Catch:{ Exception -> 0x024e }
            java.lang.String r6 = new java.lang.String     // Catch:{ Exception -> 0x024e }
            java.lang.String r10 = "windows-1251"
            r6.<init>(r5, r10)     // Catch:{ Exception -> 0x024e }
            java.lang.String r10 = "\\|"
            java.lang.String[] r6 = r6.split(r10)     // Catch:{ Exception -> 0x024e }
            int r10 = r6.length     // Catch:{ Exception -> 0x024e }
            r11 = 10
            if (r10 < r11) goto L_0x024d
            org.telegram.messenger.MrzRecognizer$Result r10 = new org.telegram.messenger.MrzRecognizer$Result     // Catch:{ Exception -> 0x024e }
            r10.<init>()     // Catch:{ Exception -> 0x024e }
            r10.type = r9     // Catch:{ Exception -> 0x024e }
            java.lang.String r11 = "RU"
            r10.issuingCountry = r11     // Catch:{ Exception -> 0x024e }
            r10.nationality = r11     // Catch:{ Exception -> 0x024e }
            r11 = r6[r7]     // Catch:{ Exception -> 0x024e }
            r10.number = r11     // Catch:{ Exception -> 0x024e }
            r11 = r6[r8]     // Catch:{ Exception -> 0x024e }
            java.lang.String r11 = r11.substring(r7, r9)     // Catch:{ Exception -> 0x024e }
            int r11 = java.lang.Integer.parseInt(r11)     // Catch:{ Exception -> 0x024e }
            r10.expiryYear = r11     // Catch:{ Exception -> 0x024e }
            r11 = r6[r8]     // Catch:{ Exception -> 0x024e }
            r12 = 6
            java.lang.String r11 = r11.substring(r9, r12)     // Catch:{ Exception -> 0x024e }
            int r11 = java.lang.Integer.parseInt(r11)     // Catch:{ Exception -> 0x024e }
            r10.expiryMonth = r11     // Catch:{ Exception -> 0x024e }
            r8 = r6[r8]     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = r8.substring(r12)     // Catch:{ Exception -> 0x024e }
            int r8 = java.lang.Integer.parseInt(r8)     // Catch:{ Exception -> 0x024e }
            r10.expiryDay = r8     // Catch:{ Exception -> 0x024e }
            r8 = 3
            r8 = r6[r8]     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = cyrillicToLatin(r8)     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = capitalize(r8)     // Catch:{ Exception -> 0x024e }
            r10.lastName = r8     // Catch:{ Exception -> 0x024e }
            r8 = r6[r9]     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = cyrillicToLatin(r8)     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = capitalize(r8)     // Catch:{ Exception -> 0x024e }
            r10.firstName = r8     // Catch:{ Exception -> 0x024e }
            r8 = 5
            r8 = r6[r8]     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = cyrillicToLatin(r8)     // Catch:{ Exception -> 0x024e }
            java.lang.String r8 = capitalize(r8)     // Catch:{ Exception -> 0x024e }
            r10.middleName = r8     // Catch:{ Exception -> 0x024e }
            r8 = r6[r12]     // Catch:{ Exception -> 0x024e }
            java.lang.String r7 = r8.substring(r7, r9)     // Catch:{ Exception -> 0x024e }
            int r7 = java.lang.Integer.parseInt(r7)     // Catch:{ Exception -> 0x024e }
            r10.birthYear = r7     // Catch:{ Exception -> 0x024e }
            r7 = r6[r12]     // Catch:{ Exception -> 0x024e }
            java.lang.String r7 = r7.substring(r9, r12)     // Catch:{ Exception -> 0x024e }
            int r7 = java.lang.Integer.parseInt(r7)     // Catch:{ Exception -> 0x024e }
            r10.birthMonth = r7     // Catch:{ Exception -> 0x024e }
            r7 = r6[r12]     // Catch:{ Exception -> 0x024e }
            java.lang.String r7 = r7.substring(r12)     // Catch:{ Exception -> 0x024e }
            int r7 = java.lang.Integer.parseInt(r7)     // Catch:{ Exception -> 0x024e }
            r10.birthDay = r7     // Catch:{ Exception -> 0x024e }
            return r10
        L_0x024d:
            goto L_0x024f
        L_0x024e:
