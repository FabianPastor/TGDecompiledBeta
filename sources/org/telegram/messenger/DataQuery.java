...
public class DataQuery {
    ...
    public void addRecentSticker(final int type, Document document, int date, boolean remove) {
        ...
        if (type == 2) {
            if (remove) {
                Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString("RemovedFromFavorites", C0493R.string.RemovedFromFavorites), 0).show();
            } else {
                Toast.makeText(ApplicationLoader.applicationContext, LocaleController.getString("AddedToFavorites", C0493R.string.AddedToFavorites), 0).show();
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        try {
                            if (error == null) {
                                if (stickerSet.masks) {
                                    Toast.makeText(context, LocaleController.getString("MasksRemoved", C0493R.string.MasksRemoved), 0).show();
                                } else {
                                    Toast.makeText(context, LocaleController.getString("StickersRemoved", C0493R.string.StickersRemoved), 0).show();
                                }
                                DataQuery.this.loadStickers(type, false, true);
                            }
                            Toast.makeText(context, LocaleController.getString("ErrorOccurred", C0493R.string.ErrorOccurred), 0).show();
                            DataQuery.this.loadStickers(type, false, true);
                        } catch (Throwable e) {
                            FileLog.m3e(e);
                        }
            ...
            Utilities.globalQueue.postRunnable(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        arrayList.add(new Builder(ApplicationLoader.applicationContext, "compose").setShortLabel(LocaleController.getString("NewConversationShortcut", C0493R.string.NewConversationShortcut)).setLongLabel(LocaleController.getString("NewConversationShortcut", C0493R.string.NewConversationShortcut)).setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.shortcut_compose)).setIntent(intent).build());
                        ...
                        for (a = 0; a < hintsFinal.size(); a++) {
                            ...
                            if (user != null || chat != null) {
                                ...
                                if (bitmap != null) {
                                    ...
                                    builder.setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.shortcut_user));
                                }
            ...
            if (user != null || chat != null) {
                ...
                if (selfUser || photo != null) {
                    ...
                    if (selfUser || bitmap != null) {
                        ...
                        Drawable drawable = ApplicationLoader.applicationContext.getResources().getDrawable(C0493R.drawable.book_logo);
                ...
                if (VERSION.SDK_INT >= 26) {
                    ...
                    if (bitmap != null) {
                        ...
                        if (user.bot) {
                            pinShortcutInfo.setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.book_bot));
                        } else {
                            pinShortcutInfo.setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.book_user));
                        }
                    } else if (chat != null) {
                        if (!ChatObject.isChannel(chat) || chat.megagroup) {
                            pinShortcutInfo.setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.book_group));
                        } else {
                            pinShortcutInfo.setIcon(Icon.createWithResource(ApplicationLoader.applicationContext, C0493R.drawable.book_channel));
                        }
                    }
                ...
                if (bitmap != null) {
                    ...
                    if (user.bot) {
                        addIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(ApplicationLoader.applicationContext, C0493R.drawable.book_bot));
                    } else {
                        addIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(ApplicationLoader.applicationContext, C0493R.drawable.book_user));
                    }
                } else if (chat != null) {
                    if (!ChatObject.isChannel(chat) || chat.megagroup) {
                        addIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(ApplicationLoader.applicationContext, C0493R.drawable.book_group));
                    } else {
                        addIntent.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", ShortcutIconResource.fromContext(ApplicationLoader.applicationContext, C0493R.drawable.book_channel));
                    }
                }
