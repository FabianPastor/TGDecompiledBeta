...
public final /* synthetic */ class ImageLoader$CacheOutTask$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ ImageLoader$CacheOutTask$$ExternalSyntheticLambda2(ImageLoader.CacheOutTask cacheOutTask, RLottieDrawable rLottieDrawable, Canvas canvas, boolean z, int i, int i2, Bitmap bitmap) {
    ...
    public final void run() {
        this.f$0.lambda$loadLastFrame$0(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
