...
public class ImageReceiver implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void setForUserOrChat(TLObject object, Drawable avatarDrawable, Object parentObject) {
        ...
        if (strippedBitmap != null) {
            ...
            setImage(ImageLocation.getForUserOrChat(object, 1), "50_50", ImageLocation.getForUserOrChat(object, 2), "50_50_b", avatarDrawable, parentObject, 0);
        } else {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:125:0x01d3 A[RETURN] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:135:0x01e6  */
    /* JADX WARNING: Removed duplicated region for block: B:136:0x01ec  */
    /* JADX WARNING: Removed duplicated region for block: B:143:0x0209  */
    /* JADX WARNING: Removed duplicated region for block: B:159:0x02c0  */
    /* JADX WARNING: Removed duplicated region for block: B:162:0x030d  */
    /* JADX WARNING: Removed duplicated region for block: B:165:0x031e  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:183:0x034c  */
    /* JADX WARNING: Removed duplicated region for block: B:185:0x0352  */
    ...
    public void setImage(org.telegram.messenger.ImageLocation r20, java.lang.String r21, org.telegram.messenger.ImageLocation r22, java.lang.String r23, org.telegram.messenger.ImageLocation r24, java.lang.String r25, android.graphics.drawable.Drawable r26, int r27, java.lang.String r28, java.lang.Object r29, int r30) {
        ...
        L_0x0073:
            ...
            android.graphics.Paint r14 = r0.roundPaint
            r14.setShader(r13)
            r0.staticThumbDrawable = r7
            r0.currentAlpha = r10
            r0.previousAlpha = r10
            r0.currentSize = r12
    ...
    public void setImageBitmap(Drawable bitmap) {
        ...
        if (bitmap instanceof AnimatedFileDrawable) {
            ...
            if (this.attachedToWindow) {
                fileDrawable.addParent(this.parentView);
            }
    ...
    public void onDetachedFromWindow() {
        ...
        if (animatedFileDrawable != null) {
            animatedFileDrawable.removeParent(this.parentView);
        }
    }
    ...
    public boolean onAttachedToWindow() {
        ...
        AnimatedFileDrawable animatedFileDrawable = getAnimation();
        if (!(animatedFileDrawable == null || (view = this.parentView) == null)) {
            animatedFileDrawable.addParent(view);
        }
    ...
    public boolean setImageBitmapByKey(Drawable drawable, String key, int type, boolean memCache, int guid) {
        ...
        if (type == 0) {
            ...
            if (!this.isVisible || (((memCache || this.forcePreview) && !this.forceCrossfade) || this.crossfadeDuration == 0)) {
                ...
                if ((drawable4 instanceof AnimatedFileDrawable) && ((AnimatedFileDrawable) drawable4).hasBitmap()) {
                    ...
                    allowCorssfade = (drawable5 instanceof LoadingStickerDrawable) || (drawable5 instanceof SvgHelper.SvgDrawable) || (drawable5 instanceof Emoji.EmojiDrawable);
                }
                if (allowCorssfade && !((drawable3 = this.currentThumbDrawable) == null && this.staticThumbDrawable == null && !this.forceCrossfade)) {
            ...
            if (this.currentImageDrawable == null) {
                if ((memCache || this.forcePreview) && !this.forceCrossfade) {
                    ...
                    if ((drawable6 == null && this.staticThumbDrawable == null) || this.currentAlpha == 1.0f || this.forceCrossfade) {
            ...
            if (!this.forcePreview) {
                ...
                if ((drawable7 != null && !(drawable7 instanceof AnimatedFileDrawable)) || ((drawable2 = this.currentMediaDrawable) != null && !(drawable2 instanceof AnimatedFileDrawable))) {
                    return false;
                }
            }
        ...
        if (imageReceiverDelegate != null) {
            ...
            imageReceiverDelegate.didSetImage(this, (drawable8 == null && this.currentThumbDrawable == null && this.staticThumbDrawable == null && this.currentMediaDrawable == null) ? false : true, drawable8 == null && this.currentMediaDrawable == null, memCache);
        }
        if (drawable instanceof AnimatedFileDrawable) {
    ...
    private void recycleBitmap(String newKey, int type) {
        ...
        if (image instanceof AnimatedFileDrawable) {
            ((AnimatedFileDrawable) image).removeParent(this.parentView);
        }
