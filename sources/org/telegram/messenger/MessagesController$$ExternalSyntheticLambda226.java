...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda226 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda226(MessagesController messagesController, TLRPC.TL_theme tL_theme, Theme.ThemeInfo themeInfo, TLRPC.TL_inputThemeSettings tL_inputThemeSettings, Theme.ThemeAccent themeAccent) {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m195xb04732dc(this.f$1, this.f$2, this.f$3, this.f$4, tLObject, tL_error);
    }
}
