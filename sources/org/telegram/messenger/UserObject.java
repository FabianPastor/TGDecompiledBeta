...
public class UserObject {
    ...
    public static String getUserName(User user) {
        if (user == null || isDeleted(user)) {
            return LocaleController.getString("HiddenName", C0501R.string.HiddenName);
        }
    ...
    public static String getFirstName(User user) {
        ...
        return TextUtils.isEmpty(name) ? LocaleController.getString("HiddenName", C0501R.string.HiddenName) : name;
    }
}
