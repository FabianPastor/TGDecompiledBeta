...
public class UserObject {
    ...
    public static String getUserName(User user) {
        if (user == null || isDeleted(user)) {
            return LocaleController.getString("HiddenName", CLASSNAMER.string.HiddenName);
        }
    ...
    public static String getFirstName(User user, boolean allowShort) {
        ...
        return TextUtils.isEmpty(name) ? LocaleController.getString("HiddenName", CLASSNAMER.string.HiddenName) : name;
    }
}
