...
public class DispatchQueuePool {
    ...
    public /* synthetic */ void m1799lambda$execute$1$orgtelegrammessengerDispatchQueuePool(Runnable runnable, DispatchQueue queue) {
        runnable.run();
    ...
    public /* synthetic */ void m1798lambda$execute$0$orgtelegrammessengerDispatchQueuePool(DispatchQueue queue) {
        this.totalTasksCount--;
