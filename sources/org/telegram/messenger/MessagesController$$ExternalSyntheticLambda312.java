...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda312 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda312(MessagesController messagesController, Context context, AlertDialog alertDialog, MessagesStorage.BooleanCallback booleanCallback, BaseFragment baseFragment, TLRPC$TL_channels_convertToGigagroup tLRPC$TL_channels_convertToGigagroup) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$convertToGigaGroup$222(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, tLObject, tLRPC$TL_error);
    }
}
