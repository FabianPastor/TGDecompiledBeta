...
public final /* synthetic */ class FileLoadOperation$$ExternalSyntheticLambda14 implements RequestDelegate {
    ...
    public /* synthetic */ FileLoadOperation$$ExternalSyntheticLambda14(FileLoadOperation fileLoadOperation, FileLoadOperation.RequestInfo requestInfo) {
        this.f$0 = fileLoadOperation;
        this.f$1 = requestInfo;
    }

    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$startDownloadRequest$13(this.f$1, tLObject, tLRPC$TL_error);
    }
}
