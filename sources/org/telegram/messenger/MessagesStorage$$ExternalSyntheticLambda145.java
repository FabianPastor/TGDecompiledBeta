...
public final /* synthetic */ class MessagesStorage$$ExternalSyntheticLambda145 implements Runnable {
    ...
    public /* synthetic */ MessagesStorage$$ExternalSyntheticLambda145(MessagesStorage messagesStorage, LongSparseIntArray longSparseIntArray, LongSparseIntArray longSparseIntArray2, SparseIntArray sparseIntArray) {
    ...
    public final void run() {
        this.f$0.lambda$markMessagesAsRead$157(this.f$1, this.f$2, this.f$3);
    }
}
