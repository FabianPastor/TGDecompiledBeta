...
public final /* synthetic */ class FileLoader$$ExternalSyntheticLambda3 implements Runnable {
    ...
    public /* synthetic */ FileLoader$$ExternalSyntheticLambda3(FileLoader fileLoader, TLRPC$Document tLRPC$Document, SecureDocument secureDocument, WebFile webFile, TLRPC$TL_fileLocationToBeDeprecated tLRPC$TL_fileLocationToBeDeprecated, ImageLocation imageLocation, Object obj, String str, int i, int i2, int i3) {
        this.f$0 = fileLoader;
    ...
    public final void run() {
        this.f$0.lambda$loadFile$8(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10);
    }
}
