...
public final /* synthetic */ class -$$Lambda$MessagesController$SAsPbHJfghvx0KNTlzJK_bZrkCk implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$MessagesController$SAsPbHJfghvx0KNTlzJK_bZrkCk(MessagesController messagesController, int i, messages_Dialogs messages_dialogs, ArrayList arrayList, boolean z, int i2, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, SparseArray sparseArray, int i3, boolean z2, int i4, ArrayList arrayList2) {
    ...
    public final void run() {
        this.f$0.lambda$null$130$MessagesController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12);
    }
}
