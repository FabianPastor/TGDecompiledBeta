...
public abstract class Timeline {
    public static final Timeline EMPTY = new C19741();
    ...
    static class C19741 extends Timeline {
        C19741() {
        }
    ...
    public final Pair<Integer, Long> getPeriodPosition(Window window, Period period, int windowIndex, long windowPositionUs, long defaultPositionProjectionUs) {
        ...
        while (periodDurationUs != C0555C.TIME_UNSET && periodPositionUs >= periodDurationUs && periodIndex < window.lastPeriodIndex) {
