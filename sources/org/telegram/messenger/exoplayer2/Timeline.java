...
public abstract class Timeline {
    public static final Timeline EMPTY = new C06261();

    /* renamed from: org.telegram.messenger.exoplayer2.Timeline$1 */
    static class C06261 extends Timeline {
        C06261() {
        }
    ...
    public static final class Period {
        ...
        public long getDurationMs() {
            return C0621C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInWindowMs() {
            return C0621C.usToMs(this.positionInWindowUs);
        }
        ...
        public long getAdDurationUs(int adGroupIndex, int adIndexInAdGroup) {
            AdGroup adGroup = this.adPlaybackState.adGroups[adGroupIndex];
            return adGroup.count != -1 ? adGroup.durationsUs[adIndexInAdGroup] : C0621C.TIME_UNSET;
        }
    ...
    public static final class Window {
        ...
        public long getDefaultPositionMs() {
            return C0621C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C0621C.usToMs(this.positionInFirstPeriodUs);
        }
    ...
    public final Pair<Integer, Long> getPeriodPosition(Window window, Period period, int windowIndex, long windowPositionUs, long defaultPositionProjectionUs) {
        ...
        if (windowPositionUs == C0621C.TIME_UNSET) {
        ...
        while (periodDurationUs != C0621C.TIME_UNSET && periodPositionUs >= periodDurationUs && periodIndex < window.lastPeriodIndex) {
