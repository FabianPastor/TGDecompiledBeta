...
public abstract class Timeline {
    public static final Timeline EMPTY = new C19951();
    ...
    public static final class Period {
        ...
        public long getDurationMs() {
            return C0559C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInWindowMs() {
            return C0559C.usToMs(this.positionInWindowUs);
        }
        ...
        public long getAdDurationUs(int adGroupIndex, int adIndexInAdGroup) {
            AdGroup adGroup = this.adPlaybackState.adGroups[adGroupIndex];
            return adGroup.count != -1 ? adGroup.durationsUs[adIndexInAdGroup] : C0559C.TIME_UNSET;
        }
    ...
    public static final class Window {
        ...
        public long getDefaultPositionMs() {
            return C0559C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C0559C.usToMs(this.positionInFirstPeriodUs);
        }
    ...
    static class C19951 extends Timeline {
        C19951() {
        }
    ...
    public final Pair<Integer, Long> getPeriodPosition(Window window, Period period, int windowIndex, long windowPositionUs, long defaultPositionProjectionUs) {
        ...
        if (windowPositionUs == C0559C.TIME_UNSET) {
        ...
        while (periodDurationUs != C0559C.TIME_UNSET && periodPositionUs >= periodDurationUs && periodIndex < window.lastPeriodIndex) {
