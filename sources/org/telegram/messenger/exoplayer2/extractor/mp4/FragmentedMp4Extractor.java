...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C06431();
    ...
    static class C06431 implements ExtractorsFactory {
        C06431() {
        }
    ...
    public FragmentedMp4Extractor(int flags, TimestampAdjuster timestampAdjuster, Track sideloadedTrack, DrmInitData sideloadedDrmInitData, List<Format> closedCaptionFormats, TrackOutput additionalEmsgTrackOutput) {
        ...
        this.segmentIndexEarliestPresentationTimeUs = C0605C.TIME_UNSET;
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray atom) {
        if (this.emsgTrackOutputs.length != 0) {
            ...
            atom.readNullTerminatedString();
            long presentationTimeDeltaUs = Util.scaleLargeTimestamp(atom.readUnsignedInt(), C0605C.MICROS_PER_SECOND, atom.readUnsignedInt());
            for (TrackOutput emsgTrackOutput : this.emsgTrackOutputs) {
                atom.setPosition(12);
                emsgTrackOutput.sampleData(atom, sampleSize);
            }
            if (this.segmentIndexEarliestPresentationTimeUs != C0605C.TIME_UNSET) {
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray atom, long inputPosition) throws ParserException {
        ...
        long earliestPresentationTimeUs = Util.scaleLargeTimestamp(earliestPresentationTime, C0605C.MICROS_PER_SECOND, timescale);
        atom.skipBytes(2);
        ...
        for (int i = 0; i < referenceCount; i++) {
            ...
            timeUs = Util.scaleLargeTimestamp(time, C0605C.MICROS_PER_SECOND, timescale);
