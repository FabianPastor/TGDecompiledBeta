...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public static final ExtractorsFactory FACTORY = new C20041();
    ...
    static class C20041 implements ExtractorsFactory {
        C20041() {
        }
    ...
    public SeekPoints getSeekPoints(long timeUs) {
        ...
        long firstTimeUs;
        long firstOffset;
        long secondTimeUs = C0559C.TIME_UNSET;
        long secondOffset = -1;
        ...
        for (int i = 0; i < this.tracks.length; i++) {
            if (i != this.firstVideoTrackIndex) {
                ...
                if (secondTimeUs != C0559C.TIME_UNSET) {
    ...
    private void processMoovAtom(ContainerAtom moov) throws ParserException {
        ...
        long durationUs = C0559C.TIME_UNSET;
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            if (atom.type == Atom.TYPE_trak) {
                Track track = AtomParsers.parseTrak(atom, moov.getLeafAtomOfType(Atom.TYPE_mvhd), C0559C.TIME_UNSET, null, (this.flags & 1) != 0, this.isQuickTime);
                if (track != null) {
                    ...
                    if (trackSampleTable.sampleCount != 0) {
                        ...
                        durationUs = Math.max(durationUs, track.durationUs != C0559C.TIME_UNSET ? track.durationUs : trackSampleTable.durationUs);
