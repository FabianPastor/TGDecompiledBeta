...
public final class FlvExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C20001();
    ...
    private long mediaTagTimestampOffsetUs = C0559C.TIME_UNSET;
    ...
    static class C20001 implements ExtractorsFactory {
        C20001() {
        }
    ...
    public void seek(long position, long timeUs) {
        this.state = 1;
        this.mediaTagTimestampOffsetUs = C0559C.TIME_UNSET;
    ...
    private void ensureReadyForMediaOutput() {
        if (!this.outputSeekMap) {
            this.extractorOutput.seekMap(new Unseekable(C0559C.TIME_UNSET));
            this.outputSeekMap = true;
        }
        if (this.mediaTagTimestampOffsetUs == C0559C.TIME_UNSET) {
            this.mediaTagTimestampOffsetUs = this.metadataReader.getDurationUs() == C0559C.TIME_UNSET ? -this.tagTimestampUs : 0;
        }
    }
}
