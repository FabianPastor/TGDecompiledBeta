...
public final class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C19801();
...
*/
    ...
    static class C19801 implements ExtractorsFactory {
        C19801() {
        }
    ...
    void endMasterElement(int id) throws ParserException {
        switch (id) {
            ...
            case 357149030:
                ...
                if (this.durationTimecode != C0555C.TIME_UNSET) {
        ...
        switch (id) {
            ...
            case ID_SIMPLE_BLOCK /*163*/:
                if (this.blockState == 0) {
                    ...
                    this.blockDurationUs = C0555C.TIME_UNSET;
                    this.blockState = 1;
                    this.scratch.reset();
                }
    ...
    private SeekMap buildSeekMap() {
        if (this.segmentContentPosition == -1 || this.durationUs == C0555C.TIME_UNSET || this.cueTimesUs == null || this.cueTimesUs.size() == 0 || this.cueClusterPositions == null || this.cueClusterPositions.size() != this.cueTimesUs.size()) {
