...
public final class Mp3Extractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C19781();
    ...
    static class C19781 implements ExtractorsFactory {
        C19781() {
        }
    ...
    public Mp3Extractor(int flags, long forcedFirstSampleTimestampUs) {
        ...
        this.basisTimeUs = C0554C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C0554C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C0554C.TIME_UNSET) {
