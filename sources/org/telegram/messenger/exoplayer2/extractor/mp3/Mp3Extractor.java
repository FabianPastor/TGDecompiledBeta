...
public final class Mp3Extractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C18511();
    ...
    static class C18511 implements ExtractorsFactory {
        C18511() {
        }
    ...
    public Mp3Extractor(int flags, long forcedFirstSampleTimestampUs) {
        ...
        this.basisTimeUs = C0546C.TIME_UNSET;
    }
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C0546C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C0546C.TIME_UNSET) {
        ...
        this.trackOutput.sampleMetadata(this.basisTimeUs + ((this.samplesRead * C0546C.MICROS_PER_SECOND) / ((long) this.synchronizedHeader.sampleRate)), 1, this.synchronizedHeader.frameSize, 0, null);
