...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Creator<DrmInitData> CREATOR = new C06471();
    ...
    static class C06471 implements Creator<DrmInitData> {
        C06471() {
        }
    ...
    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new C06481();
        ...
        static class C06481 implements Creator<SchemeData> {
            C06481() {
            }
        ...
        public boolean matches(UUID schemeUuid) {
            return C0621C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C0621C.UUID_NIL.equals(first.uuid)) {
            return C0621C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
