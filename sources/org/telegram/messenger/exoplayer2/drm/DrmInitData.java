...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Creator<DrmInitData> CREATOR = new C05841();
    ...
    static class C05841 implements Creator<DrmInitData> {
        C05841() {
        }
    ...
    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new C05851();
        ...
        static class C05851 implements Creator<SchemeData> {
            C05851() {
            }
        ...
        public boolean matches(UUID schemeUuid) {
            return C0559C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C0559C.UUID_NIL.equals(first.uuid)) {
            return C0559C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
