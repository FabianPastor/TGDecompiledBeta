...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Creator<DrmInitData> CREATOR = new C06311();
    ...
    static class C06311 implements Creator<DrmInitData> {
        C06311() {
        }
    ...
    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new C06321();
        ...
        static class C06321 implements Creator<SchemeData> {
            C06321() {
            }
        ...
        public boolean matches(UUID schemeUuid) {
            return C0605C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C0605C.UUID_NIL.equals(first.uuid)) {
            return C0605C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
