...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Creator<DrmInitData> CREATOR = new C06411();
    ...
    static class C06411 implements Creator<DrmInitData> {
        C06411() {
        }
    ...
    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new C06421();
        ...
        static class C06421 implements Creator<SchemeData> {
            C06421() {
            }
        ...
        public boolean matches(UUID schemeUuid) {
            return C0615C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C0615C.UUID_NIL.equals(first.uuid)) {
            return C0615C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
