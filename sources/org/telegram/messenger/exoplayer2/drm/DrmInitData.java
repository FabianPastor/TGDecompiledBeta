...
public final class DrmInitData implements Parcelable, Comparator<SchemeData> {
    public static final Creator<DrmInitData> CREATOR = new C06421();
    ...
    static class C06421 implements Creator<DrmInitData> {
        C06421() {
        }
    ...
    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new C06431();
        ...
        static class C06431 implements Creator<SchemeData> {
            C06431() {
            }
        ...
        public boolean matches(UUID schemeUuid) {
            return C0616C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C0616C.UUID_NIL.equals(first.uuid)) {
            return C0616C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
