...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    protected final void maybeInitCodec() throws ExoPlaybackException {
        if (this.codec == null && this.format != null) {
            ...
            if (shouldInitCodec(this.codecInfo)) {
                ...
                this.codecHotswapDeadlineMs = getState() == 2 ? SystemClock.elapsedRealtime() + 1000 : C0559C.TIME_UNSET;
                resetInputBuffer();
                resetOutputBuffer();
    ...
    protected void releaseCodec() {
        this.codecHotswapDeadlineMs = C0559C.TIME_UNSET;
        resetInputBuffer();
        resetOutputBuffer();
    ...
    public boolean isReady() {
        if (this.format == null || this.waitingForKeys || (!isSourceReady() && !hasOutputBuffer() && (this.codecHotswapDeadlineMs == C0559C.TIME_UNSET || SystemClock.elapsedRealtime() >= this.codecHotswapDeadlineMs))) {
            return false;
        }
        return true;
    }
