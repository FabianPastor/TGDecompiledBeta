...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    public boolean isReady() {
        if (this.format == null || this.waitingForKeys || (!isSourceReady() && !hasOutputBuffer() && (this.codecHotswapDeadlineMs == C0555C.TIME_UNSET || SystemClock.elapsedRealtime() >= this.codecHotswapDeadlineMs))) {
            return false;
        }
        return true;
    }
