...
public final class SpliceScheduleCommand extends SpliceCommand {
    public static final Creator<SpliceScheduleCommand> CREATOR = new C06041();
    public final List<Event> events;

    /* renamed from: org.telegram.messenger.exoplayer2.metadata.scte35.SpliceScheduleCommand$1 */
    static class C06041 implements Creator<SpliceScheduleCommand> {
        C06041() {
        }
    ...
    public static final class Event {
        ...
        private static Event parseFromSection(ParsableByteArray sectionData) {
            ...
            long utcSpliceTime = C0554C.TIME_UNSET;
            ...
            long breakDurationUs = C0554C.TIME_UNSET;
