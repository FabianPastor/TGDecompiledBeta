...
public final class Id3Decoder implements MetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = new C06781();
    ...
    static class C06781 implements FramePredicate {
        C06781() {
        }
    ...
    private static String getCharsetName(int encodingByte) {
        switch (encodingByte) {
            case 0:
                return "ISO-8859-1";
            case 1:
                return C0616C.UTF16_NAME;
            case 2:
                return "UTF-16BE";
            case 3:
                return C0616C.UTF8_NAME;
            default:
                return "ISO-8859-1";
        }
    }
