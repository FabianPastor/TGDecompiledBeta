...
public final class PlayerEmsgHandler implements Callback {
    ...
    private long lastLoadedChunkEndTimeBeforeRefreshUs = C0554C.TIME_UNSET;
    private long lastLoadedChunkEndTimeUs = C0554C.TIME_UNSET;
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private void parsePlayerEmsgEvent(long eventTimeUs, EventMessage eventMessage) {
            ...
            if (manifestPublishTimeMsInEmsg != C0554C.TIME_UNSET) {
    ...
    boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        if (this.lastLoadedChunkEndTimeUs == C0554C.TIME_UNSET || this.lastLoadedChunkEndTimeUs >= chunk.startTimeUs) {
    ...
    void onChunkLoadCompleted(Chunk chunk) {
        if (this.lastLoadedChunkEndTimeUs != C0554C.TIME_UNSET || chunk.endTimeUs > this.lastLoadedChunkEndTimeUs) {
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        if (this.lastLoadedChunkEndTimeBeforeRefreshUs == C0554C.TIME_UNSET || this.lastLoadedChunkEndTimeBeforeRefreshUs != this.lastLoadedChunkEndTimeUs) {
