...
public final class PlayerEmsgHandler implements Callback {
    ...
    boolean maybeRefreshManifestOnLoadingError(Chunk chunk) {
        ...
        if (this.lastLoadedChunkEndTimeUs == C0555C.TIME_UNSET || this.lastLoadedChunkEndTimeUs >= chunk.startTimeUs) {
    ...
    void onChunkLoadCompleted(Chunk chunk) {
        if (this.lastLoadedChunkEndTimeUs != C0555C.TIME_UNSET || chunk.endTimeUs > this.lastLoadedChunkEndTimeUs) {
    ...
    private void maybeNotifyDashManifestRefreshNeeded() {
        if (this.lastLoadedChunkEndTimeBeforeRefreshUs == C0555C.TIME_UNSET || this.lastLoadedChunkEndTimeBeforeRefreshUs != this.lastLoadedChunkEndTimeUs) {
