...
final class EventSampleStream implements SampleStream {
    ...
    private long pendingSeekPositionUs = C0600C.TIME_UNSET;
    ...
    void updateEventStream(EventStream eventStream, boolean eventStreamUpdatable) {
        long lastReadPositionUs = this.currentIndex == 0 ? C0600C.TIME_UNSET : this.eventTimesUs[this.currentIndex - 1];
        this.eventStreamUpdatable = eventStreamUpdatable;
        this.eventStream = eventStream;
        this.eventTimesUs = eventStream.presentationTimesUs;
        if (this.pendingSeekPositionUs != C0600C.TIME_UNSET) {
            seekToUs(this.pendingSeekPositionUs);
        } else if (lastReadPositionUs != C0600C.TIME_UNSET) {
