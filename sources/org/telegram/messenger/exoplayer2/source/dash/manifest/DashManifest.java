...
public class DashManifest implements FilterableManifest<DashManifest, RepresentationKey> {
    ...
    public final long getPeriodDurationMs(int index) {
        ...
        if (this.durationMs == C0615C.TIME_UNSET) {
    ...
    public final long getPeriodDurationUs(int index) {
        return C0615C.msToUs(getPeriodDurationMs(index));
    }
    ...
    public final DashManifest copy(List<RepresentationKey> streamKeys) {
        ...
        return new DashManifest(this.availabilityStartTimeMs, this.durationMs != C0615C.TIME_UNSET ? this.durationMs - shiftMs : C0615C.TIME_UNSET, this.minBufferTimeMs, this.dynamic, this.minUpdatePeriodMs, this.timeShiftBufferDepthMs, this.suggestedPresentationDelayMs, this.publishTimeMs, this.utcTiming, this.location, copyPeriods);
    }
