...
public class DashManifest {
    ...
    public final long getPeriodDurationMs(int index) {
        ...
        if (this.durationMs == C0542C.TIME_UNSET) {
    ...
    public final DashManifest copy(List<RepresentationKey> representationKeys) {
        ...
        return new DashManifest(this.availabilityStartTimeMs, this.durationMs != C0542C.TIME_UNSET ? this.durationMs - shiftMs : C0542C.TIME_UNSET, this.minBufferTimeMs, this.dynamic, this.minUpdatePeriodMs, this.timeShiftBufferDepthMs, this.suggestedPresentationDelayMs, this.publishTimeMs, this.utcTiming, this.location, copyPeriods);
    }
