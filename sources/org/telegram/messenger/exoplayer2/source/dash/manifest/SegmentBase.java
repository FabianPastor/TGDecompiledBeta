...
public abstract class SegmentBase {
    ...
    public static abstract class MultiSegmentBase extends SegmentBase {
        ...
        public int getSegmentNum(long timeUs, long periodDurationUs) {
            ...
            if (this.segmentTimeline == null) {
                int segmentNum = this.startNumber + ((int) (timeUs / ((this.duration * C0546C.MICROS_PER_SECOND) / this.timescale)));
        ...
        public final long getSegmentDurationUs(int sequenceNumber, long periodDurationUs) {
            if (this.segmentTimeline != null) {
                return (((SegmentTimelineElement) this.segmentTimeline.get(sequenceNumber - this.startNumber)).duration * C0546C.MICROS_PER_SECOND) / this.timescale;
            }
            int segmentCount = getSegmentCount(periodDurationUs);
            return (segmentCount == -1 || sequenceNumber != (getFirstSegmentNum() + segmentCount) - 1) ? (this.duration * C0546C.MICROS_PER_SECOND) / this.timescale : periodDurationUs - getSegmentTimeUs(sequenceNumber);
        }
        ...
        public final long getSegmentTimeUs(int sequenceNumber) {
            ...
            return Util.scaleLargeTimestamp(unscaledSegmentTime, C0546C.MICROS_PER_SECOND, this.timescale);
        }
    ...
    public static class SegmentTemplate extends MultiSegmentBase {
        ...
        public int getSegmentCount(long periodDurationUs) {
            ...
            if (periodDurationUs != C0546C.TIME_UNSET) {
                return (int) Util.ceilDivide(periodDurationUs, (this.duration * C0546C.MICROS_PER_SECOND) / this.timescale);
            }
            return -1;
        }
    }
    ...
    public long getPresentationTimeOffsetUs() {
        return Util.scaleLargeTimestamp(this.presentationTimeOffset, C0546C.MICROS_PER_SECOND, this.timescale);
    }
}
