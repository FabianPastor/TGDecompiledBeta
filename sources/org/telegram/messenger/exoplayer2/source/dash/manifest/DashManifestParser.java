...
public class DashManifestParser extends DefaultHandler implements Parser<DashManifest> {
    ...
    protected DashManifest parseMediaPresentationDescription(XmlPullParser xpp, String baseUrl) throws XmlPullParserException, IOException {
        long availabilityStartTime = parseDateTime(xpp, "availabilityStartTime", C0555C.TIME_UNSET);
        long durationMs = parseDuration(xpp, "mediaPresentationDuration", C0555C.TIME_UNSET);
        long minBufferTimeMs = parseDuration(xpp, "minBufferTime", C0555C.TIME_UNSET);
        String typeString = xpp.getAttributeValue(null, "type");
        boolean dynamic = typeString != null && "dynamic".equals(typeString);
        long minUpdateTimeMs = dynamic ? parseDuration(xpp, "minimumUpdatePeriod", C0555C.TIME_UNSET) : C0555C.TIME_UNSET;
        long timeShiftBufferDepthMs = dynamic ? parseDuration(xpp, "timeShiftBufferDepth", C0555C.TIME_UNSET) : C0555C.TIME_UNSET;
        long suggestedPresentationDelayMs = dynamic ? parseDuration(xpp, "suggestedPresentationDelay", C0555C.TIME_UNSET) : C0555C.TIME_UNSET;
        long publishTimeMs = parseDateTime(xpp, "publishTime", C0555C.TIME_UNSET);
                        ...
                        if (XmlPullParserUtil.isStartTag(xpp, "Period") && !seenEarlyAccessPeriod) {
                            ...
                            if (period.startMs != C0555C.TIME_UNSET) {
                                ...
                                if (periodDurationMs == C0555C.TIME_UNSET) {
                                    nextPeriodStartMs = C0555C.TIME_UNSET;
                                } else {
        ...
        if (durationMs == C0555C.TIME_UNSET) {
            if (nextPeriodStartMs != C0555C.TIME_UNSET) {
    ...
    protected Pair<Period, Long> parsePeriod(XmlPullParser xpp, String baseUrl, long defaultStartMs) throws XmlPullParserException, IOException {
        ...
        long durationMs = parseDuration(xpp, "duration", C0555C.TIME_UNSET);
    ...
    protected Pair<String, SchemeData> parseContentProtection(XmlPullParser xpp) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xpp, "widevine:license")) {
                ...
                } else if (C0555C.PLAYREADY_UUID.equals(uuid) && XmlPullParserUtil.isStartTag(xpp, "mspr:pro") && xpp.next() == 4) {
    ...
    protected SegmentList parseSegmentList(XmlPullParser xpp, SegmentList parent) throws XmlPullParserException, IOException {
        long timescale = parseLong(xpp, "timescale", parent != null ? parent.timescale : 1);
        long presentationTimeOffset = parseLong(xpp, "presentationTimeOffset", parent != null ? parent.presentationTimeOffset : 0);
        long duration = parseLong(xpp, "duration", parent != null ? parent.duration : C0555C.TIME_UNSET);
    ...
    protected EventMessage parseEvent(XmlPullParser xpp, String schemeIdUri, String value, long timescale, ByteArrayOutputStream scratchOutputStream) throws IOException, XmlPullParserException {
        ...
        long duration = parseLong(xpp, "duration", C0555C.TIME_UNSET);
