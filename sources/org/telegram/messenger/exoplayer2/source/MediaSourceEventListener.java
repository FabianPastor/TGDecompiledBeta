...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void loadStarted(DataSpec dataSpec, int dataType, long elapsedRealtimeMs) {
            loadStarted(dataSpec, dataType, -1, null, 0, null, C0559C.TIME_UNSET, C0559C.TIME_UNSET, elapsedRealtimeMs);
        }
        ...
        public void loadCompleted(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCompleted(dataSpec, dataType, -1, null, 0, null, C0559C.TIME_UNSET, C0559C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadCanceled(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCanceled(dataSpec, dataType, -1, null, 0, null, C0559C.TIME_UNSET, C0559C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadError(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded, IOException error, boolean wasCanceled) {
            loadError(dataSpec, dataType, -1, null, 0, null, C0559C.TIME_UNSET, C0559C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded, error, wasCanceled);
        }
        ...
        public void downstreamFormatChanged(int trackType, Format trackFormat, int trackSelectionReason, Object trackSelectionData, long mediaTimeUs) {
            downstreamFormatChanged(new MediaLoadData(1, trackType, trackFormat, trackSelectionReason, trackSelectionData, adjustMediaTime(mediaTimeUs), C0559C.TIME_UNSET));
        }
        ...
        private long adjustMediaTime(long mediaTimeUs) {
            long mediaTimeMs = C0559C.usToMs(mediaTimeUs);
            if (mediaTimeMs == C0559C.TIME_UNSET) {
