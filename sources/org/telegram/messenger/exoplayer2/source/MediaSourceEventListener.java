...
public interface MediaSourceEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void loadStarted(DataSpec dataSpec, int dataType, long elapsedRealtimeMs) {
            loadStarted(dataSpec, dataType, -1, null, 0, null, C0600C.TIME_UNSET, C0600C.TIME_UNSET, elapsedRealtimeMs);
        }
        ...
        public void loadCompleted(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCompleted(dataSpec, dataType, -1, null, 0, null, C0600C.TIME_UNSET, C0600C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadCanceled(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded) {
            loadCanceled(dataSpec, dataType, -1, null, 0, null, C0600C.TIME_UNSET, C0600C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded);
        }
        ...
        public void loadError(DataSpec dataSpec, int dataType, long elapsedRealtimeMs, long loadDurationMs, long bytesLoaded, IOException error, boolean wasCanceled) {
            loadError(dataSpec, dataType, -1, null, 0, null, C0600C.TIME_UNSET, C0600C.TIME_UNSET, elapsedRealtimeMs, loadDurationMs, bytesLoaded, error, wasCanceled);
        }
        ...
        private long adjustMediaTime(long mediaTimeUs) {
            long mediaTimeMs = C0600C.usToMs(mediaTimeUs);
            if (mediaTimeMs == C0600C.TIME_UNSET) {
