...
public final class ClippingMediaPeriod implements MediaPeriod, Callback {
    ...
    public ClippingMediaPeriod(MediaPeriod mediaPeriod, boolean enableInitialDiscontinuity) {
        ...
        this.pendingInitialDiscontinuityPositionUs = enableInitialDiscontinuity ? 0 : C0605C.TIME_UNSET;
        this.startUs = C0605C.TIME_UNSET;
        this.endUs = C0605C.TIME_UNSET;
    }
    ...
    public long selectTracks(TrackSelection[] selections, boolean[] mayRetainStreamFlags, SampleStream[] streams, boolean[] streamResetFlags, long positionUs) {
        ...
        long j = (isPendingInitialDiscontinuity() && positionUs == 0 && shouldKeepInitialDiscontinuity(this.startUs, selections)) ? enablePositionUs : C0605C.TIME_UNSET;
    ...
    public long readDiscontinuity() {
        ...
        if (isPendingInitialDiscontinuity()) {
            ...
            this.pendingInitialDiscontinuityPositionUs = C0605C.TIME_UNSET;
            long childDiscontinuityUs = readDiscontinuity();
            return childDiscontinuityUs != C0605C.TIME_UNSET ? childDiscontinuityUs : initialDiscontinuityUs;
        } else {
            long discontinuityUs = this.mediaPeriod.readDiscontinuity();
            if (discontinuityUs == C0605C.TIME_UNSET) {
    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        boolean z = (this.startUs == C0605C.TIME_UNSET || this.endUs == C0605C.TIME_UNSET) ? false : true;
        Assertions.checkState(z);
    ...
    boolean isPendingInitialDiscontinuity() {
        return this.pendingInitialDiscontinuityPositionUs != C0605C.TIME_UNSET;
    }
