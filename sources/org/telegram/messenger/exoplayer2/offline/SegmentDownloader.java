    ...
    public final synchronized void download(ProgressListener listener) throws IOException, InterruptedException {
        ...
        try {
            ...
            for (int i = 0; i < segments.size(); i++) {
                CacheUtil.cache(((Segment) segments.get(i)).dataSpec, this.cache, this.dataSource, buffer, this.priorityTaskManager, C0546C.PRIORITY_DOWNLOAD, cachingCounters, true);
