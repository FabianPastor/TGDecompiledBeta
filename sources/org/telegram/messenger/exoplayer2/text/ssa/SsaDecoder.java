...
public final class SsaDecoder extends SimpleSubtitleDecoder {
    ...
    public static long parseTimecodeUs(String timeString) {
        ...
        if (matcher.matches()) {
            return (((((Long.parseLong(matcher.group(1)) * 60) * 60) * C0600C.MICROS_PER_SECOND) + ((Long.parseLong(matcher.group(2)) * 60) * C0600C.MICROS_PER_SECOND)) + (Long.parseLong(matcher.group(3)) * C0600C.MICROS_PER_SECOND)) + (Long.parseLong(matcher.group(4)) * 10000);
        }
