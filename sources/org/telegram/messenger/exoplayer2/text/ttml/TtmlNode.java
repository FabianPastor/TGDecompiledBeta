...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String text) {
        return new TtmlNode(null, TtmlRenderUtil.applyTextElementSpacePolicy(text), C0554C.TIME_UNSET, C0554C.TIME_UNSET, null, null, ANONYMOUS_REGION_ID);
    }
    ...
    public boolean isActive(long timeUs) {
        return (this.startTimeUs == C0554C.TIME_UNSET && this.endTimeUs == C0554C.TIME_UNSET) || ((this.startTimeUs <= timeUs && this.endTimeUs == C0554C.TIME_UNSET) || ((this.startTimeUs == C0554C.TIME_UNSET && timeUs < this.endTimeUs) || (this.startTimeUs <= timeUs && timeUs < this.endTimeUs)));
    }
    ...
    private void getEventTimes(TreeSet<Long> out, boolean descendsPNode) {
        ...
        if (descendsPNode || isPNode) {
            if (this.startTimeUs != C0554C.TIME_UNSET) {
                out.add(Long.valueOf(this.startTimeUs));
            }
            if (this.endTimeUs != C0554C.TIME_UNSET) {
