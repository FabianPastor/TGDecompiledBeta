...
public final class TimestampAdjuster {
    ...
    private volatile long lastSampleTimestamp = C0605C.TIME_UNSET;
    ...
    public synchronized void setFirstSampleTimestampUs(long firstSampleTimestampUs) {
        Assertions.checkState(this.lastSampleTimestamp == C0605C.TIME_UNSET);
    ...
    public long getLastAdjustedTimestampUs() {
        if (this.lastSampleTimestamp != C0605C.TIME_UNSET) {
            return this.lastSampleTimestamp;
        }
        return this.firstSampleTimestampUs != Long.MAX_VALUE ? this.firstSampleTimestampUs : C0605C.TIME_UNSET;
    }
    ...
    public long getTimestampOffsetUs() {
        ...
        return this.lastSampleTimestamp != C0605C.TIME_UNSET ? this.timestampOffsetUs : C0605C.TIME_UNSET;
    }

    public void reset() {
        this.lastSampleTimestamp = C0605C.TIME_UNSET;
    }

    public long adjustTsTimestamp(long pts) {
        if (pts == C0605C.TIME_UNSET) {
    ...
    public synchronized void waitUntilInitialized() throws InterruptedException {
        while (this.lastSampleTimestamp == C0605C.TIME_UNSET) {
            wait();
        }
    }

    public static long ptsToUs(long pts) {
        return (C0605C.MICROS_PER_SECOND * pts) / 90000;
    }

    public static long usToPts(long us) {
        return (90000 * us) / C0605C.MICROS_PER_SECOND;
    }
}
