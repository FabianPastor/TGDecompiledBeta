...
public class SlidingPercentile {
    private static final Comparator<Sample> INDEX_COMPARATOR = new C06221();
    private static final int MAX_RECYCLED_SAMPLES = 5;
    private static final int SORT_ORDER_BY_INDEX = 1;
    private static final int SORT_ORDER_BY_VALUE = 0;
    private static final int SORT_ORDER_NONE = -1;
    private static final Comparator<Sample> VALUE_COMPARATOR = new C06232();
    ...
    static class C06221 implements Comparator<Sample> {
        C06221() {
        }
    ...
    static class C06232 implements Comparator<Sample> {
        C06232() {
        }
