...
public final /* synthetic */ class ImageLoader$3$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ ImageLoader$3$$ExternalSyntheticLambda2(int i, String str, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputEncryptedFile tLRPC$InputEncryptedFile, byte[] bArr, byte[] bArr2, long j) {
        this.f$0 = i;
        this.f$1 = str;
