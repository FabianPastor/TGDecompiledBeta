...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda35 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda35(MessagesController messagesController, MessagesStorage.LongCallback longCallback, Context context, AlertDialog alertDialog, TLRPC.TL_error tL_error, BaseFragment baseFragment, TLRPC.TL_messages_migrateChat tL_messages_migrateChat) {
    ...
    public final void run() {
        this.f$0.m165x3713CLASSNAMEf(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
