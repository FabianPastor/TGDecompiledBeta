...
public class Browser {
    ...
    static class C19691 implements ServiceConnectionCallback {
        C19691() {
        }
    ...
    public static void bindCustomTabsService(Activity activity) {
        ...
        if (customTabsClient == null) {
            ...
            try {
                ...
                customTabsServiceConnection = new ServiceConnection(new C19691());
                            ...
                            public void run() {
                                if (progressDialog[0] != null) {
                                    try {
                                        ...
                                        progressDialog[0].setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C05351());
