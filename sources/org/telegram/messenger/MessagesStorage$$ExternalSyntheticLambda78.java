...
public final /* synthetic */ class MessagesStorage$$ExternalSyntheticLambda78 implements Runnable {
    ...
    public /* synthetic */ MessagesStorage$$ExternalSyntheticLambda78(MessagesStorage messagesStorage, TLRPC.TL_messages_messages tL_messages_messages, int i, long j, long j2, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, boolean z, boolean z2, int i11, int i12, boolean z3, int i13, boolean z4) {
        this.f$0 = messagesStorage;
        this.f$1 = tL_messages_messages;
        this.f$2 = i;
        this.f$3 = j;
        this.f$4 = j2;
        this.f$5 = i2;
    ...
    public final void run() {
        ...
        messagesStorage2.m899xbc3e4208(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12, this.f$13, this.f$14, this.f$15, this.f$16, this.f$17, this.f$18, this.f$19, this.f$20);
    }
}
