...
public final /* synthetic */ class SendMessagesHelper$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ SendMessagesHelper$$ExternalSyntheticLambda4(Bitmap bitmap, String str, MessageObject messageObject, AccountInstance accountInstance, VideoEditedInfo videoEditedInfo, TLRPC$TL_document tLRPC$TL_document, String str2, HashMap hashMap, String str3, long j, MessageObject messageObject2, MessageObject messageObject3, String str4, ArrayList arrayList, boolean z, int i, int i2) {
        this.f$0 = bitmap;
        this.f$1 = str;
