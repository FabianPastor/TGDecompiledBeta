...
public final /* synthetic */ class -$$Lambda$MessagesController$x85q2w9-luD1YVlpfesIxu10Yns implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$MessagesController$x85q2w9-luD1YVlpfesIxu10Yns(MessagesController messagesController, messages_Messages messages_messages, long j, boolean z, boolean z2, int i, int i2, boolean z3, int i3, int i4, int i5, int i6, int i7, boolean z4, int i8, int i9, int i10, int i11, boolean z5) {
