...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda47 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda47(MessagesController messagesController, int i, TLRPC$TL_messages_getPeerDialogs tLRPC$TL_messages_getPeerDialogs, TLRPC$TL_error tLRPC$TL_error) {
    ...
    public final void run() {
        this.f$0.lambda$loadMessagesInternal$143(this.f$1, this.f$2, this.f$3);
    }
}
