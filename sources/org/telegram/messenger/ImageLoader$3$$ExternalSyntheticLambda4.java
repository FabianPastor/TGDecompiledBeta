...
public final /* synthetic */ class ImageLoader$3$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ ImageLoader$3$$ExternalSyntheticLambda4(ImageLoader.AnonymousClass3 r1, int i, String str, TLRPC$InputFile tLRPC$InputFile, TLRPC$InputEncryptedFile tLRPC$InputEncryptedFile, byte[] bArr, byte[] bArr2, long j) {
        this.f$0 = r1;
        this.f$1 = i;
        this.f$2 = str;
