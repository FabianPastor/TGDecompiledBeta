...
public final /* synthetic */ class -$$Lambda$TonController$yUECOT-FM_Kv3rLiI_KH71P7BiE implements TonLibCallback {
    ...
    public /* synthetic */ -$$Lambda$TonController$yUECOT-FM_Kv3rLiI_KH71P7BiE(TonController tonController, String str, String str2, long j, String str3, Runnable runnable, Runnable runnable2, ErrorCallback errorCallback, DangerousCallback dangerousCallback, InputKey inputKey) {
    ...
    public final void run(Object obj) {
        this.f$0.lambda$null$41$TonController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, obj);
    }
}
