...
public final /* synthetic */ class ImageLoader$CacheOutTask$$ExternalSyntheticLambda3 implements Runnable {
    ...
    public /* synthetic */ ImageLoader$CacheOutTask$$ExternalSyntheticLambda3(ImageLoader.CacheOutTask cacheOutTask, RLottieDrawable rLottieDrawable, Canvas canvas, Bitmap bitmap) {
    ...
    public final void run() {
        this.f$0.lambda$loadFirstFrame$1(this.f$1, this.f$2, this.f$3);
    }
}
