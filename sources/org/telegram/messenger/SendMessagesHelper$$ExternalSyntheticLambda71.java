...
public final /* synthetic */ class SendMessagesHelper$$ExternalSyntheticLambda71 implements Runnable {
    ...
    public /* synthetic */ SendMessagesHelper$$ExternalSyntheticLambda71(Bitmap[] bitmapArr, String[] strArr, MessageObject messageObject, AccountInstance accountInstance, TLRPC.TL_photo tL_photo, HashMap hashMap, String str, long j, MessageObject messageObject2, MessageObject messageObject3, SendMessagesHelper.SendingMediaInfo sendingMediaInfo, boolean z, int i) {
        this.f$0 = bitmapArr;
        this.f$1 = strArr;
    ...
    public final void run() {
        SendMessagesHelper.lambda$prepareSendingMedia$88(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12);
    }
}
