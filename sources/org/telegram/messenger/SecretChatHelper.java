...
public class SecretChatHelper extends BaseController {
    ...
    public /* synthetic */ void m2372xc3b53c7c(ArrayList pendingEncMessagesToDeleteCopy) {
    ...
    public /* synthetic */ void m2373xe82e9eba(TLRPC.Dialog dialog, long dialog_id) {
    ...
    public /* synthetic */ void m2374x74cec9bb(TLRPC.EncryptedChat exist, TLRPC.EncryptedChat newChat) {
        if (exist != null) {
            getMessagesController().putEncryptedChat(newChat, false);
        }
    ...
    public /* synthetic */ void m2375x16ef4bc(long dialog_id) {
    ...
    private void updateMediaPaths(MessageObject newMsgObj, TLRPC.EncryptedFile file, TLRPC.DecryptedMessage decryptedMessage, String originalPath) {
        ...
        if ((newMsg.media instanceof TLRPC.TL_messageMediaPhoto) && newMsg.media.photo != null) {
            ...
            new File(FileLoader.getDirectory(4), fileName + ".jpg").renameTo(getFileLoader().getPathToAttach(size));
            ...
            if (newMsg.attachPath != null && newMsg.attachPath.startsWith(FileLoader.getDirectory(4).getAbsolutePath()) && new File(newMsg.attachPath).renameTo(getFileLoader().getPathToAttach(newMsg.media.document))) {
    ...
    public /* synthetic */ void m2366x85cvar_a(org.telegram.tgnet.TLRPC.EncryptedChat r28, org.telegram.tgnet.TLRPC.DecryptedMessage r29, org.telegram.tgnet.TLRPC.Message r30, org.telegram.tgnet.TLRPC.InputEncryptedFile r31, org.telegram.messenger.MessageObject r32, java.lang.String r33) {
        /*
            r27 = this;
            r8 = r28
            r9 = r29
        ...
        L_0x027c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.SecretChatHelper.m2366x85cvar_a(org.telegram.tgnet.TLRPC$EncryptedChat, org.telegram.tgnet.TLRPC$DecryptedMessage, org.telegram.tgnet.TLRPC$Message, org.telegram.tgnet.TLRPC$InputEncryptedFile, org.telegram.messenger.MessageObject, java.lang.String):void");
    }

    /* renamed from: lambda$performSendEncryptedRequest$7$org-telegram-messenger-SecretChatHelper  reason: not valid java name */
    public /* synthetic */ void m2365xvar_ed719(TLRPC.DecryptedMessage req, TLRPC.EncryptedChat chat, TLRPC.Message newMsgObj, MessageObject newMsg, String originalPath, TLObject response, TLRPC.TL_error error) {
        int existFlags;
        ...
        if (error == null && (decryptedMessage.action instanceof TLRPC.TL_decryptedMessageActionNotifyLayer)) {
            ...
            if (currentChat.key_hash.length == 16) {
                try {
                    byte[] sha256 = Utilities.computeSHA256(encryptedChat.auth_key, 0, (long) encryptedChat.auth_key.length);
    ...
    public /* synthetic */ void m2363xdfee8117(TLRPC.Message newMsgObj, TLRPC.messages_SentEncryptedMessage res, int existFlags, String attachPath) {
    ...
    public /* synthetic */ void m2362x534e5616(TLRPC.Message newMsgObj, int existFlags, String attachPath) {
    ...
    public /* synthetic */ void m2364x6c8eaCLASSNAME(TLRPC.Message newMsgObj) {
    ...
    private void applyPeerLayer(TLRPC.EncryptedChat chat, int newPeerLayer) {
        ...
        if (newPeerLayer > currentPeerLayer) {
            if (chat.key_hash.length == 16) {
                try {
                    byte[] sha256 = Utilities.computeSHA256(chat.auth_key, 0, (long) chat.auth_key.length);
                    byte[] key_hash = new byte[36];
    ...
    public /* synthetic */ void m2359lambda$applyPeerLayer$9$orgtelegrammessengerSecretChatHelper(TLRPC.EncryptedChat chat) {
        ...
        if (tLObject != null) {
            ...
            if (tLObject instanceof TLRPC.TL_decryptedMessage) {
                ...
                if (decryptedMessage.media == null || (decryptedMessage.media instanceof TLRPC.TL_decryptedMessageMediaEmpty)) {
                    ...
                    if (decryptedMessage.media instanceof TLRPC.TL_decryptedMessageMediaContact) {
                        ...
                        big.type = "x";
                        big.size = (int) encryptedFile.size;
            ...
            if (tLObject instanceof TLRPC.TL_decryptedMessageService) {
                ...
                if ((serviceMessage.action instanceof TLRPC.TL_decryptedMessageActionSetMessageTTL) || (serviceMessage.action instanceof TLRPC.TL_decryptedMessageActionScreenshotMessages)) {
                    ...
                    BigInteger g_a2 = g_a.modPow(new BigInteger(i, salt), p);
                    byte[] authKey = g_a2.toByteArray();
    ...
    public /* synthetic */ void m2371x53e0a31b(long did) {
    ...
    public /* synthetic */ void m2370xCLASSNAMEa(long did) {
    ...
    public /* synthetic */ void m2369x3aa04d19(long did) {
    ...
    public /* synthetic */ void m2377lambda$resendMessages$15$orgtelegrammessengerSecretChatHelper(int startSeq, TLRPC.EncryptedChat encryptedChat, int endSeq) {
        long dialog_id;
    ...
    public /* synthetic */ void m2376lambda$resendMessages$14$orgtelegrammessengerSecretChatHelper(ArrayList messages) {
    ...
    public /* synthetic */ void m2361lambda$decryptMessage$17$orgtelegrammessengerSecretChatHelper(TLRPC.TL_encryptedChatDiscarded newChat) {
        getMessagesController().putEncryptedChat(newChat, false);
        getMessagesStorage().updateEncryptedChat(newChat);
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    public /* synthetic */ void m2367x790a9119(TLRPC.EncryptedChat encryptedChat) {
    ...
    public /* synthetic */ void m2368x5aabc1a(TLRPC.TL_encryptedChatDiscarded newChat) {
        getMessagesController().putEncryptedChat(newChat, false);
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    public /* synthetic */ void m2360xbee5b370(long newTaskId, TLObject response, TLRPC.TL_error error) {
        if (newTaskId != 0) {
    ...
    public /* synthetic */ void m2358xb735687(TLRPC.EncryptedChat encryptedChat, TLObject response, TLRPC.TL_error error) {
        TLRPC.EncryptedChat encryptedChat2 = encryptedChat;
    ...
    public /* synthetic */ void m2357x7ed32b86(TLRPC.EncryptedChat encryptedChat, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m2356xvar_(TLRPC.EncryptedChat newChat) {
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    ...
    public /* synthetic */ void m2383x98b25de3(Context context, AlertDialog progressDialog, TLRPC.User user, TLObject response, TLRPC.TL_error error) {
        byte[] g_a;
    ...
    public /* synthetic */ void m2381xvar_e80cc(Context context, AlertDialog progressDialog, byte[] salt, TLRPC.User user, TLObject response1, TLRPC.TL_error error1) {
        if (error1 == null) {
    ...
    public /* synthetic */ void m2379xdd0e2aca(Context context, AlertDialog progressDialog, TLObject response1, byte[] salt, TLRPC.User user) {
        this.startingSecretChat = false;
        if (!((Activity) context).isFinishing()) {
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m2378x506dffc9() {
    ...
    public /* synthetic */ void m2380x69ae55cb(Context context, AlertDialog progressDialog) {
        if (!((Activity) context).isFinishing()) {
            this.startingSecretChat = false;
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m2382x82eeabcd(Context context, AlertDialog progressDialog) {
        this.startingSecretChat = false;
        if (!((Activity) context).isFinishing()) {
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m2384x255288e4(int reqId, DialogInterface dialog) {
