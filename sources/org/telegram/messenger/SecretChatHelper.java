...
public class SecretChatHelper {
    ...
    class C05298 implements Comparator<TL_decryptedMessageHolder> {
        C05298() {
        }
    ...
    protected void performSendEncryptedRequest(DecryptedMessage req, Message newMsgObj, EncryptedChat chat, InputEncryptedFile encryptedFile, String originalPath, MessageObject newMsg) {
        if (req != null && chat.auth_key != null && !(chat instanceof TL_encryptedChatRequested) && !(chat instanceof TL_encryptedChatWaiting)) {
            ...
            Utilities.stageQueue.postRunnable(new Runnable() {
                ...
                class C05201 implements RequestDelegate {
                        ...
                        if (error == null) {
                            ...
                            MessagesStorage.getInstance(SecretChatHelper.this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    AndroidUtilities.runOnUIThread(new C05171());
                                }
                            });
                            return;
                        }
                ...
                public void run() {
                    try {
                        ...
                        ConnectionsManager.getInstance(SecretChatHelper.this.currentAccount).sendRequest(reqToSend, new C05201(), 64);
                    } catch (Throwable e) {
                        FileLog.m3e(e);
                    }
                }
                ...
                if ((serviceMessage.action instanceof TL_decryptedMessageActionSetMessageTTL) || (serviceMessage.action instanceof TL_decryptedMessageActionScreenshotMessages)) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            MessagesStorage.getInstance(SecretChatHelper.this.currentAccount).getStorageQueue().postRunnable(new C05241());
    ...
    private void resendMessages(final int startSeq, final int endSeq, final EncryptedChat encryptedChat) {
        if (encryptedChat != null && endSeq - startSeq >= 0) {
            MessagesStorage.getInstance(this.currentAccount).getStorageQueue().postRunnable(new Runnable() {
                ...
                class C05261 implements Comparator<Message> {
                    C05261() {
                    }
                ...
                public void run() {
                    try {
                        ...
                        if (!exists) {
                            ...
                            Collections.sort(messages, new C05261());
    ...
    public void checkSecretHoles(EncryptedChat chat, ArrayList<Message> messages) {
        ...
        if (holes != null) {
            Collections.sort(holes, new C05298());
    ...
    public void acceptSecretChat(final EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(encryptedChat.id) == null) {
            ...
            ConnectionsManager.getInstance(this.currentAccount).sendRequest(req, new RequestDelegate() {
                ...
                class C05071 implements RequestDelegate {
                    C05071() {
                    }
                ...
                public void run(TLObject response, TL_error error) {
                    if (error == null) {
                        ...
                        if (Utilities.isGoodGaAndGb(g_a, p)) {
                            ...
                            ConnectionsManager.getInstance(SecretChatHelper.this.currentAccount).sendRequest(req2, new C05071());
                            return;
                        }
                        SecretChatHelper.this.acceptingChats.remove(encryptedChat.id);
                        SecretChatHelper.this.declineSecretChat(encryptedChat.id);
                            ...
                            class C05112 implements Runnable {
                                ...
                                public void run() {
                                    if (!((Activity) context).isFinishing()) {
                                        ...
                                        builder.setMessage(LocaleController.getString("CreateEncryptedChatError", C0505R.string.CreateEncryptedChatError));
                                ...
                                if (error == null) {
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Utilities.stageQueue.postRunnable(new C05091());
                                        }
                                    });
                                    return;
                                }
                                SecretChatHelper.this.delayedEncryptedChatUpdates.clear();
                                AndroidUtilities.runOnUIThread(new C05112());
                            }
                        }, 2);
                        return;
                    }
                    SecretChatHelper.this.delayedEncryptedChatUpdates.clear();
                    AndroidUtilities.runOnUIThread(new C05133());
                }
            }, 2);
