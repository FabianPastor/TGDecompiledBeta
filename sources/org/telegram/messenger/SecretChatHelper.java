...
public class SecretChatHelper extends BaseController {
    ...
    public /* synthetic */ void m1086xc3b53c7c(ArrayList pendingEncMessagesToDeleteCopy) {
    ...
    public /* synthetic */ void m1087xe82e9eba(TLRPC.Dialog dialog, long dialog_id) {
    ...
    public /* synthetic */ void m1088x74cec9bb(TLRPC.EncryptedChat exist, TLRPC.EncryptedChat newChat) {
        if (exist != null) {
            getMessagesController().putEncryptedChat(newChat, false);
        }
    ...
    public /* synthetic */ void m1089x16ef4bc(long dialog_id) {
    ...
    public /* synthetic */ void m1080x85cvar_a(org.telegram.tgnet.TLRPC.EncryptedChat r28, org.telegram.tgnet.TLRPC.DecryptedMessage r29, org.telegram.tgnet.TLRPC.Message r30, org.telegram.tgnet.TLRPC.InputEncryptedFile r31, org.telegram.messenger.MessageObject r32, java.lang.String r33) {
        /*
            r27 = this;
            r8 = r28
            r9 = r29
        ...
        L_0x027c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.SecretChatHelper.m1080x85cvar_a(org.telegram.tgnet.TLRPC$EncryptedChat, org.telegram.tgnet.TLRPC$DecryptedMessage, org.telegram.tgnet.TLRPC$Message, org.telegram.tgnet.TLRPC$InputEncryptedFile, org.telegram.messenger.MessageObject, java.lang.String):void");
    }

    /* renamed from: lambda$performSendEncryptedRequest$7$org-telegram-messenger-SecretChatHelper  reason: not valid java name */
    public /* synthetic */ void m1079xvar_ed719(TLRPC.DecryptedMessage req, TLRPC.EncryptedChat chat, TLRPC.Message newMsgObj, MessageObject newMsg, String originalPath, TLObject response, TLRPC.TL_error error) {
        int existFlags;
    ...
    public /* synthetic */ void m1077xdfee8117(TLRPC.Message newMsgObj, TLRPC.messages_SentEncryptedMessage res, int existFlags, String attachPath) {
    ...
    public /* synthetic */ void m1076x534e5616(TLRPC.Message newMsgObj, int existFlags, String attachPath) {
    ...
    public /* synthetic */ void m1078x6c8eaCLASSNAME(TLRPC.Message newMsgObj) {
    ...
    public /* synthetic */ void m1073lambda$applyPeerLayer$9$orgtelegrammessengerSecretChatHelper(TLRPC.EncryptedChat chat) {
    ...
    public /* synthetic */ void m1085x53e0a31b(long did) {
    ...
    public /* synthetic */ void m1084xCLASSNAMEa(long did) {
    ...
    public /* synthetic */ void m1083x3aa04d19(long did) {
    ...
    public /* synthetic */ void m1091lambda$resendMessages$15$orgtelegrammessengerSecretChatHelper(int startSeq, TLRPC.EncryptedChat encryptedChat, int endSeq) {
        long dialog_id;
    ...
    public /* synthetic */ void m1090lambda$resendMessages$14$orgtelegrammessengerSecretChatHelper(ArrayList messages) {
    ...
    public /* synthetic */ void m1075lambda$decryptMessage$17$orgtelegrammessengerSecretChatHelper(TLRPC.TL_encryptedChatDiscarded newChat) {
        getMessagesController().putEncryptedChat(newChat, false);
        getMessagesStorage().updateEncryptedChat(newChat);
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    public /* synthetic */ void m1081x790a9119(TLRPC.EncryptedChat encryptedChat) {
    ...
    public /* synthetic */ void m1082x5aabc1a(TLRPC.TL_encryptedChatDiscarded newChat) {
        getMessagesController().putEncryptedChat(newChat, false);
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    }
    ...
    public /* synthetic */ void m1074xbee5b370(long newTaskId, TLObject response, TLRPC.TL_error error) {
        if (newTaskId != 0) {
    ...
    public /* synthetic */ void m1072xb735687(TLRPC.EncryptedChat encryptedChat, TLObject response, TLRPC.TL_error error) {
        TLRPC.EncryptedChat encryptedChat2 = encryptedChat;
    ...
    public /* synthetic */ void m1071x7ed32b86(TLRPC.EncryptedChat encryptedChat, TLObject response1, TLRPC.TL_error error1) {
    ...
    public /* synthetic */ void m1070xvar_(TLRPC.EncryptedChat newChat) {
        getNotificationCenter().postNotificationName(NotificationCenter.encryptedChatUpdated, newChat);
    ...
    public /* synthetic */ void m1097x98b25de3(Context context, AlertDialog progressDialog, TLRPC.User user, TLObject response, TLRPC.TL_error error) {
        byte[] g_a;
    ...
    public /* synthetic */ void m1095xvar_e80cc(Context context, AlertDialog progressDialog, byte[] salt, TLRPC.User user, TLObject response1, TLRPC.TL_error error1) {
        if (error1 == null) {
    ...
    public /* synthetic */ void m1093xdd0e2aca(Context context, AlertDialog progressDialog, TLObject response1, byte[] salt, TLRPC.User user) {
        this.startingSecretChat = false;
        if (!((Activity) context).isFinishing()) {
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m1092x506dffc9() {
    ...
    public /* synthetic */ void m1094x69ae55cb(Context context, AlertDialog progressDialog) {
        if (!((Activity) context).isFinishing()) {
            this.startingSecretChat = false;
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m1096x82eeabcd(Context context, AlertDialog progressDialog) {
        this.startingSecretChat = false;
        if (!((Activity) context).isFinishing()) {
            try {
                progressDialog.dismiss();
    ...
    public /* synthetic */ void m1098x255288e4(int reqId, DialogInterface dialog) {
