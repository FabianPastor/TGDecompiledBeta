...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda16 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda16(MessagesController messagesController, MessagesStorage.BooleanCallback booleanCallback, Context context, AlertDialog alertDialog, TLRPC.TL_error tL_error, BaseFragment baseFragment, TLRPC.TL_channels_convertToGigagroup tL_channels_convertToGigagroup) {
    ...
    public final void run() {
        this.f$0.m154x79a1122a(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
