...
public class FileLoadOperation {
    ...
    public /* synthetic */ void m619lambda$getCurrentFile$1$orgtelegrammessengerFileLoadOperation(File[] result, CountDownLatch countDownLatch) {
        if (this.state == 3) {
    ...
    public /* synthetic */ void m620xcb1e2f1b(int[] result, int offset, int length, CountDownLatch countDownLatch) {
    ...
    public /* synthetic */ void m623xc3d0b3c8(FileLoadOperationStream operation) {
        ArrayList<FileLoadOperationStream> arrayList = this.streamListeners;
        if (arrayList != null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:200:0x05e1 A[SYNTHETIC, Splitter:B:200:0x05e1] */
    /* JADX WARNING: Removed duplicated region for block: B:210:0x0603  */
    /* JADX WARNING: Removed duplicated region for block: B:230:0x0674  */
    /* JADX WARNING: Removed duplicated region for block: B:233:0x067e  */
    /* JADX WARNING: Removed duplicated region for block: B:246:0x06d8  */
    /* JADX WARNING: Removed duplicated region for block: B:253:0x0700  */
    /* JADX WARNING: Removed duplicated region for block: B:259:0x072c  */
    /* JADX WARNING: Removed duplicated region for block: B:264:0x076b  */
    /* JADX WARNING: Removed duplicated region for block: B:288:0x07d0 A[Catch:{ Exception -> 0x07d5 }] */
    /* JADX WARNING: Removed duplicated region for block: B:293:0x07dd  */
    /* JADX WARNING: Removed duplicated region for block: B:295:0x07e3  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean start(org.telegram.messenger.FileLoadOperationStream r32, int r33, boolean r34) {
        ...
        L_0x0410:
            ...
            r0.<init>(r8, r13)
            r13 = r0
            java.io.RandomAccessFile r0 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x048a }
            r0.<init>(r13, r12)     // Catch:{ Exception -> 0x048a }
            r14 = r0
            long r19 = r13.length()     // Catch:{ Exception -> 0x048a }
            byte[] r0 = new byte[r10]     // Catch:{ Exception -> 0x048a }
            r7.encryptKey = r0     // Catch:{ Exception -> 0x048a }
            r8 = 16
            byte[] r10 = new byte[r8]     // Catch:{ Exception -> 0x048a }
            r7.encryptIv = r10     // Catch:{ Exception -> 0x048a }
            ...
            r10 = 32
            r15 = 0
            r14.read(r0, r15, r10)     // Catch:{ Exception -> 0x048a }
            byte[] r0 = r7.encryptIv     // Catch:{ Exception -> 0x048a }
            r14.read(r0, r15, r8)     // Catch:{ Exception -> 0x048a }
            goto L_0x047a
        L_0x0461:
            java.security.SecureRandom r0 = org.telegram.messenger.Utilities.random     // Catch:{ Exception -> 0x048a }
            byte[] r10 = r7.encryptKey     // Catch:{ Exception -> 0x048a }
            r0.nextBytes(r10)     // Catch:{ Exception -> 0x048a }
            java.security.SecureRandom r0 = org.telegram.messenger.Utilities.random     // Catch:{ Exception -> 0x048a }
            byte[] r10 = r7.encryptIv     // Catch:{ Exception -> 0x048a }
            r0.nextBytes(r10)     // Catch:{ Exception -> 0x048a }
            byte[] r0 = r7.encryptKey     // Catch:{ Exception -> 0x048a }
            r14.write(r0)     // Catch:{ Exception -> 0x048a }
            byte[] r0 = r7.encryptIv     // Catch:{ Exception -> 0x048a }
            r14.write(r0)     // Catch:{ Exception -> 0x048a }
            r9 = 1
        L_0x047a:
            java.nio.channels.FileChannel r0 = r14.getChannel()     // Catch:{ Exception -> 0x0482 }
            r0.close()     // Catch:{ Exception -> 0x0482 }
            goto L_0x0486
        L_0x0482:
            r0 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r0)     // Catch:{ Exception -> 0x048a }
        L_0x0486:
            r14.close()     // Catch:{ Exception -> 0x048a }
            goto L_0x048e
        L_0x048a:
            r0 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r0)
        L_0x048e:
            ...
            r16 = 0
            java.io.RandomAccessFile r0 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x05c8 }
            java.io.File r8 = r7.cacheFilePreload     // Catch:{ Exception -> 0x05c8 }
            r0.<init>(r8, r12)     // Catch:{ Exception -> 0x05c8 }
            r7.preloadStream = r0     // Catch:{ Exception -> 0x05c8 }
            long r19 = r0.length()     // Catch:{ Exception -> 0x05c8 }
            r0 = 0
            r8 = 1
            r7.preloadStreamFileOffset = r8     // Catch:{ Exception -> 0x05c8 }
            long r13 = (long) r0     // Catch:{ Exception -> 0x05c8 }
            long r13 = r19 - r13
            r26 = 1
            int r8 = (r13 > r26 ? 1 : (r13 == r26 ? 0 : -1))
            if (r8 <= 0) goto L_0x05b6
            java.io.RandomAccessFile r8 = r7.preloadStream     // Catch:{ Exception -> 0x05c8 }
            byte r8 = r8.readByte()     // Catch:{ Exception -> 0x05c8 }
        ...
        L_0x04cc:
            r13 = 0
            r10[r13] = r8     // Catch:{ Exception -> 0x05c8 }
            int r0 = r0 + 1
        L_0x04d1:
            long r13 = (long) r0     // Catch:{ Exception -> 0x05c8 }
            ...
            goto L_0x05bd
        L_0x04e8:
            java.io.RandomAccessFile r13 = r7.preloadStream     // Catch:{ Exception -> 0x05c8 }
            int r13 = r13.readInt()     // Catch:{ Exception -> 0x05c8 }
            int r0 = r0 + 4
            r14 = r9
            long r8 = (long) r0
            long r8 = r19 - r8
            ...
            if (r26 < 0) goto L_0x05a7
            if (r13 < 0) goto L_0x05a7
            int r8 = r7.totalBytesCount     // Catch:{ Exception -> 0x059f }
            if (r13 <= r8) goto L_0x0508
            r26 = r4
            r28 = r5
            r27 = r10
            goto L_0x05bd
        L_0x0508:
            java.io.RandomAccessFile r8 = r7.preloadStream     // Catch:{ Exception -> 0x059f }
            int r8 = r8.readInt()     // Catch:{ Exception -> 0x059f }
            int r0 = r0 + 4
            r26 = r4
            r9 = r5
            long r4 = (long) r0
            ...
            if (r29 < 0) goto L_0x05bd
            int r4 = r7.currentDownloadChunkSize     // Catch:{ Exception -> 0x05c6 }
            if (r8 <= r4) goto L_0x0525
            goto L_0x05bd
        L_0x0525:
            org.telegram.messenger.FileLoadOperation$PreloadRange r4 = new org.telegram.messenger.FileLoadOperation$PreloadRange     // Catch:{ Exception -> 0x05c6 }
            r4.<init>(r0, r8)     // Catch:{ Exception -> 0x05c6 }
            int r0 = r0 + r8
            java.io.RandomAccessFile r5 = r7.preloadStream     // Catch:{ Exception -> 0x05c6 }
            long r9 = (long) r0     // Catch:{ Exception -> 0x05c6 }
            r5.seek(r9)     // Catch:{ Exception -> 0x05c6 }
            long r9 = (long) r0     // Catch:{ Exception -> 0x05c6 }
            long r9 = r19 - r9
            r29 = 12
        ...
        L_0x053c:
            java.io.RandomAccessFile r5 = r7.preloadStream     // Catch:{ Exception -> 0x05c6 }
            int r5 = r5.readInt()     // Catch:{ Exception -> 0x05c6 }
            r7.foundMoovSize = r5     // Catch:{ Exception -> 0x05c6 }
            if (r5 == 0) goto L_0x0557
            int r9 = r7.nextPreloadDownloadOffset     // Catch:{ Exception -> 0x05c6 }
            int r10 = r7.totalBytesCount     // Catch:{ Exception -> 0x05c6 }
            r29 = 2
            int r10 = r10 / 2
        ...
        L_0x0552:
            r9 = 1
        L_0x0553:
            r7.moovFound = r9     // Catch:{ Exception -> 0x05c6 }
            r7.preloadNotRequestedBytesCount = r5     // Catch:{ Exception -> 0x05c6 }
        L_0x0557:
            java.io.RandomAccessFile r5 = r7.preloadStream     // Catch:{ Exception -> 0x05c6 }
            int r5 = r5.readInt()     // Catch:{ Exception -> 0x05c6 }
            r7.nextPreloadDownloadOffset = r5     // Catch:{ Exception -> 0x05c6 }
            java.io.RandomAccessFile r5 = r7.preloadStream     // Catch:{ Exception -> 0x05c6 }
            int r5 = r5.readInt()     // Catch:{ Exception -> 0x05c6 }
            r7.nextAtomOffset = r5     // Catch:{ Exception -> 0x05c6 }
            int r0 = r0 + 12
            android.util.SparseArray<org.telegram.messenger.FileLoadOperation$PreloadRange> r5 = r7.preloadedBytesRanges     // Catch:{ Exception -> 0x05c6 }
            if (r5 != 0) goto L_0x0574
            android.util.SparseArray r5 = new android.util.SparseArray     // Catch:{ Exception -> 0x05c6 }
            r5.<init>()     // Catch:{ Exception -> 0x05c6 }
            r7.preloadedBytesRanges = r5     // Catch:{ Exception -> 0x05c6 }
        L_0x0574:
            android.util.SparseIntArray r5 = r7.requestedPreloadedBytesRanges     // Catch:{ Exception -> 0x05c6 }
            if (r5 != 0) goto L_0x057f
            android.util.SparseIntArray r5 = new android.util.SparseIntArray     // Catch:{ Exception -> 0x05c6 }
            r5.<init>()     // Catch:{ Exception -> 0x05c6 }
            r7.requestedPreloadedBytesRanges = r5     // Catch:{ Exception -> 0x05c6 }
        L_0x057f:
            android.util.SparseArray<org.telegram.messenger.FileLoadOperation$PreloadRange> r5 = r7.preloadedBytesRanges     // Catch:{ Exception -> 0x05c6 }
            r5.put(r13, r4)     // Catch:{ Exception -> 0x05c6 }
            android.util.SparseIntArray r5 = r7.requestedPreloadedBytesRanges     // Catch:{ Exception -> 0x05c6 }
            r9 = 1
            r5.put(r13, r9)     // Catch:{ Exception -> 0x05c6 }
            int r5 = r7.totalPreloadedBytes     // Catch:{ Exception -> 0x05c6 }
            int r5 = r5 + r8
            r7.totalPreloadedBytes = r5     // Catch:{ Exception -> 0x05c6 }
            int r5 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x05c6 }
            int r9 = r8 + 20
            int r5 = r5 + r9
            r7.preloadStreamFileOffset = r5     // Catch:{ Exception -> 0x05c6 }
            r9 = r14
            r4 = r26
            r10 = r27
            r5 = r28
        ...
        L_0x05b6:
            ...
            r27 = r10
        L_0x05bd:
            java.io.RandomAccessFile r4 = r7.preloadStream     // Catch:{ Exception -> 0x05c6 }
            int r5 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x05c6 }
            long r8 = (long) r5     // Catch:{ Exception -> 0x05c6 }
            r4.seek(r8)     // Catch:{ Exception -> 0x05c6 }
            goto L_0x05d3
        L_0x05c6:
            r0 = move-exception
            goto L_0x05d0
        ...
        L_0x05d3:
            ...
            java.io.RandomAccessFile r0 = r7.preloadStream     // Catch:{ Exception -> 0x05f5 }
            if (r0 == 0) goto L_0x05f4
            java.nio.channels.FileChannel r0 = r0.getChannel()     // Catch:{ Exception -> 0x05e9 }
            r0.close()     // Catch:{ Exception -> 0x05e9 }
            goto L_0x05ed
        L_0x05e9:
            r0 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r0)     // Catch:{ Exception -> 0x05f5 }
        L_0x05ed:
            java.io.RandomAccessFile r0 = r7.preloadStream     // Catch:{ Exception -> 0x05f5 }
            r0.close()     // Catch:{ Exception -> 0x05f5 }
            r7.preloadStream = r15     // Catch:{ Exception -> 0x05f5 }
        L_0x05f4:
            goto L_0x0601
        L_0x05f5:
            r0 = move-exception
        ...
        L_0x0601:
            ...
            java.io.RandomAccessFile r0 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x066d }
            java.io.File r4 = r7.cacheFileParts     // Catch:{ Exception -> 0x066d }
            r0.<init>(r4, r12)     // Catch:{ Exception -> 0x066d }
            r7.filePartsStream = r0     // Catch:{ Exception -> 0x066d }
            long r4 = r0.length()     // Catch:{ Exception -> 0x066d }
            r8 = 8
            long r8 = r4 % r8
            r19 = 4
            ...
            long r4 = r4 - r19
            java.io.RandomAccessFile r0 = r7.filePartsStream     // Catch:{ Exception -> 0x066d }
            int r0 = r0.readInt()     // Catch:{ Exception -> 0x066d }
            long r8 = (long) r0     // Catch:{ Exception -> 0x066d }
            r19 = 2
            long r19 = r4 / r19
        ...
        L_0x0635:
            ...
            java.io.RandomAccessFile r9 = r7.filePartsStream     // Catch:{ Exception -> 0x066d }
            int r9 = r9.readInt()     // Catch:{ Exception -> 0x066d }
            java.io.RandomAccessFile r10 = r7.filePartsStream     // Catch:{ Exception -> 0x066d }
            int r10 = r10.readInt()     // Catch:{ Exception -> 0x066d }
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r13 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x066d }
            org.telegram.messenger.FileLoadOperation$Range r15 = new org.telegram.messenger.FileLoadOperation$Range     // Catch:{ Exception -> 0x066d }
            r19 = r1
            r1 = 0
            r15.<init>(r9, r10)     // Catch:{ Exception -> 0x0662 }
            r13.add(r15)     // Catch:{ Exception -> 0x0662 }
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r1 = r7.notRequestedBytesRanges     // Catch:{ Exception -> 0x0662 }
            org.telegram.messenger.FileLoadOperation$Range r13 = new org.telegram.messenger.FileLoadOperation$Range     // Catch:{ Exception -> 0x0662 }
            r15 = 0
            r13.<init>(r9, r10)     // Catch:{ Exception -> 0x0662 }
            r1.add(r13)     // Catch:{ Exception -> 0x0662 }
            int r8 = r8 + 1
            r1 = r19
            r15 = 0
            goto L_0x0635
        ...
        L_0x0769:
            ...
            r0.<init>(r1, r2)
            r7.cacheIvTemp = r0
            java.io.RandomAccessFile r0 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x07a8 }
            java.io.File r1 = r7.cacheIvTemp     // Catch:{ Exception -> 0x07a8 }
            r0.<init>(r1, r12)     // Catch:{ Exception -> 0x07a8 }
            r7.fiv = r0     // Catch:{ Exception -> 0x07a8 }
            int r0 = r7.downloadedBytes     // Catch:{ Exception -> 0x07a8 }
            if (r0 == 0) goto L_0x07a7
            if (r14 != 0) goto L_0x07a7
            java.io.File r0 = r7.cacheIvTemp     // Catch:{ Exception -> 0x07a8 }
            ...
            java.io.RandomAccessFile r4 = r7.fiv     // Catch:{ Exception -> 0x07a8 }
            byte[] r5 = r7.iv     // Catch:{ Exception -> 0x07a8 }
            r8 = 32
            r9 = 0
            r4.read(r5, r9, r8)     // Catch:{ Exception -> 0x07a8 }
            goto L_0x07a7
        L_0x07a2:
            r4 = 0
            r7.downloadedBytes = r4     // Catch:{ Exception -> 0x07a8 }
            r7.requestedBytesCount = r4     // Catch:{ Exception -> 0x07a8 }
        L_0x07a7:
            goto L_0x07b1
        L_0x07a8:
            r0 = move-exception
        ...
        L_0x07c0:
            r31.updateProgress()
            java.io.RandomAccessFile r0 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x07d5 }
            java.io.File r1 = r7.cacheFileTemp     // Catch:{ Exception -> 0x07d5 }
            r0.<init>(r1, r12)     // Catch:{ Exception -> 0x07d5 }
            r7.fileOutputStream = r0     // Catch:{ Exception -> 0x07d5 }
            int r1 = r7.downloadedBytes     // Catch:{ Exception -> 0x07d5 }
            if (r1 == 0) goto L_0x07d4
            long r4 = (long) r1     // Catch:{ Exception -> 0x07d5 }
            r0.seek(r4)     // Catch:{ Exception -> 0x07d5 }
        L_0x07d4:
            goto L_0x07d9
        L_0x07d5:
            r0 = move-exception
        ...
        L_0x07f4:
            ...
            r7.started = r1
            r4 = 0
            r7.onFinishLoadingFile(r4)     // Catch:{ Exception -> 0x0803 }
            r5 = 1
            goto L_0x080a
        L_0x0803:
            r0 = move-exception
    ...
    public /* synthetic */ void m626lambda$start$4$orgtelegrammessengerFileLoadOperation(boolean steamPriority, int streamOffset, FileLoadOperationStream stream, boolean alreadyStarted) {
    ...
    public /* synthetic */ void m627lambda$start$5$orgtelegrammessengerFileLoadOperation(boolean[] preloaded) {
        int i = this.totalBytesCount;
    ...
    public /* synthetic */ void m625xCLASSNAMEa74(boolean value) {
    ...
    public /* synthetic */ void m618lambda$cancel$7$orgtelegrammessengerFileLoadOperation(boolean deleteFiles) {
    ...
    public /* synthetic */ void m622x905dc9cf(boolean increment) {
        try {
    ...
    public /* synthetic */ void m624x6ac3var_(TLObject response, TLRPC.TL_error error) {
        if (error != null) {
            onFail(false, 0);
            return;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:179:0x0497, code lost:
        r7.delayedRequestInfos.remove(r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:180:0x04a1, code lost:
        if (processRequestResult(r2, (org.telegram.tgnet.TLRPC.TL_error) null) != false) goto L_0x04e1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:182:0x04a7, code lost:
        if (org.telegram.messenger.FileLoadOperation.RequestInfo.access$400(r2) == null) goto L_0x04b8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:183:0x04a9, code lost:
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:185:0x04bc, code lost:
        if (org.telegram.messenger.FileLoadOperation.RequestInfo.access$500(r2) == null) goto L_0x04cd;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:186:0x04be, code lost:
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:188:0x04d1, code lost:
        if (org.telegram.messenger.FileLoadOperation.RequestInfo.access$600(r2) == null) goto L_0x04e1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:189:0x04d3, code lost:
     ...
     */
    /* JADX WARNING: Removed duplicated region for block: B:74:0x01db A[Catch:{ Exception -> 0x04f2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:75:0x01e9 A[Catch:{ Exception -> 0x04f2 }] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean processRequestResult(org.telegram.messenger.FileLoadOperation.RequestInfo r29, org.telegram.tgnet.TLRPC.TL_error r30) {
        ...
        L_0x0032:
            ...
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r12 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            if (r12 != 0) goto L_0x0055
            int r12 = r7.downloadedBytes     // Catch:{ Exception -> 0x04f2 }
            int r13 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            if (r12 == r13) goto L_0x0055
            r28.delayRequestInfo(r29)     // Catch:{ Exception -> 0x04f2 }
            return r10
        L_0x0055:
            org.telegram.tgnet.TLRPC$TL_upload_file r12 = r29.response     // Catch:{ Exception -> 0x04f2 }
            if (r12 == 0) goto L_0x0062
            org.telegram.tgnet.TLRPC$TL_upload_file r12 = r29.response     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.NativeByteBuffer r12 = r12.bytes     // Catch:{ Exception -> 0x04f2 }
            goto L_0x007d
        L_0x0062:
            org.telegram.tgnet.TLRPC$TL_upload_webFile r12 = r29.responseWeb     // Catch:{ Exception -> 0x04f2 }
            if (r12 == 0) goto L_0x006f
            org.telegram.tgnet.TLRPC$TL_upload_webFile r12 = r29.responseWeb     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.NativeByteBuffer r12 = r12.bytes     // Catch:{ Exception -> 0x04f2 }
            goto L_0x007d
        L_0x006f:
            org.telegram.tgnet.TLRPC$TL_upload_cdnFile r12 = r29.responseCdn     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x007d:
            ...
            int r13 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            if (r13 != 0) goto L_0x0087
            goto L_0x04ec
        L_0x0087:
            int r13 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            boolean r14 = r7.isCdn     // Catch:{ Exception -> 0x04f2 }
            r5 = 131072(0x20000, float:1.83671E-40)
            if (r14 == 0) goto L_0x00ad
            int r14 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r14 = r14 / r5
            int r15 = r14 * r5
            android.util.SparseArray<org.telegram.tgnet.TLRPC$TL_fileHash> r5 = r7.cdnHashes     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x00a3
            java.lang.Object r5 = r5.get(r15)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$TL_fileHash r5 = (org.telegram.tgnet.TLRPC.TL_fileHash) r5     // Catch:{ Exception -> 0x04f2 }
            goto L_0x00a4
        L_0x00a3:
            r5 = 0
        L_0x00a4:
            ...
            r28.delayRequestInfo(r29)     // Catch:{ Exception -> 0x04f2 }
            r7.requestFileOffsets(r15)     // Catch:{ Exception -> 0x04f2 }
            return r9
        L_0x00ad:
            org.telegram.tgnet.TLRPC$TL_upload_cdnFile r5 = r29.responseCdn     // Catch:{ Exception -> 0x04f2 }
            r14 = 13
            r15 = 14
            r18 = 15
            r19 = 12
            if (r5 == 0) goto L_0x00ed
            int r5 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r5 = r5 / 16
            byte[] r9 = r7.cdnIv     // Catch:{ Exception -> 0x04f2 }
            r10 = r5 & 255(0xff, float:3.57E-43)
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r9[r18] = r10     // Catch:{ Exception -> 0x04f2 }
            int r10 = r5 >> 8
            r10 = r10 & 255(0xff, float:3.57E-43)
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r9[r15] = r10     // Catch:{ Exception -> 0x04f2 }
            int r10 = r5 >> 16
            r10 = r10 & 255(0xff, float:3.57E-43)
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r9[r14] = r10     // Catch:{ Exception -> 0x04f2 }
            int r10 = r5 >> 24
            r10 = r10 & 255(0xff, float:3.57E-43)
            byte r10 = (byte) r10     // Catch:{ Exception -> 0x04f2 }
            r9[r19] = r10     // Catch:{ Exception -> 0x04f2 }
            java.nio.ByteBuffer r9 = r12.buffer     // Catch:{ Exception -> 0x04f2 }
            byte[] r10 = r7.cdnKey     // Catch:{ Exception -> 0x04f2 }
            byte[] r14 = r7.cdnIv     // Catch:{ Exception -> 0x04f2 }
            int r15 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            r20 = r5
            r5 = 0
            org.telegram.messenger.Utilities.aesCtrDecryption(r9, r10, r14, r5, r15)     // Catch:{ Exception -> 0x04f2 }
        L_0x00ed:
            boolean r5 = r7.isPreloadVideoOperation     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x01f6
            java.io.RandomAccessFile r0 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            int r2 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            r0.writeInt(r2)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r0 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            r0.writeInt(r13)     // Catch:{ Exception -> 0x04f2 }
            int r0 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x04f2 }
            int r0 = r0 + 8
            r7.preloadStreamFileOffset = r0     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r0 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            java.nio.channels.FileChannel r0 = r0.getChannel()     // Catch:{ Exception -> 0x04f2 }
            java.nio.ByteBuffer r2 = r12.buffer     // Catch:{ Exception -> 0x04f2 }
            r0.write(r2)     // Catch:{ Exception -> 0x04f2 }
            boolean r2 = org.telegram.messenger.BuildVars.DEBUG_VERSION     // Catch:{ Exception -> 0x04f2 }
            if (r2 == 0) goto L_0x013d
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x04f2 }
            r2.<init>()     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r3 = "save preload file part "
            r2.append(r3)     // Catch:{ Exception -> 0x04f2 }
            java.io.File r3 = r7.cacheFilePreload     // Catch:{ Exception -> 0x04f2 }
            r2.append(r3)     // Catch:{ Exception -> 0x04f2 }
            r2.append(r1)     // Catch:{ Exception -> 0x04f2 }
            int r1 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            r2.append(r1)     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r1 = " size "
            r2.append(r1)     // Catch:{ Exception -> 0x04f2 }
            r2.append(r13)     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r1 = r2.toString()     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLog.d(r1)     // Catch:{ Exception -> 0x04f2 }
        L_0x013d:
            android.util.SparseArray<org.telegram.messenger.FileLoadOperation$PreloadRange> r1 = r7.preloadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            if (r1 != 0) goto L_0x0148
            android.util.SparseArray r1 = new android.util.SparseArray     // Catch:{ Exception -> 0x04f2 }
            r1.<init>()     // Catch:{ Exception -> 0x04f2 }
            r7.preloadedBytesRanges = r1     // Catch:{ Exception -> 0x04f2 }
        L_0x0148:
            android.util.SparseArray<org.telegram.messenger.FileLoadOperation$PreloadRange> r1 = r7.preloadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            int r2 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLoadOperation$PreloadRange r3 = new org.telegram.messenger.FileLoadOperation$PreloadRange     // Catch:{ Exception -> 0x04f2 }
            int r4 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x04f2 }
            r5 = 0
            r3.<init>(r4, r13)     // Catch:{ Exception -> 0x04f2 }
            r1.put(r2, r3)     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.totalPreloadedBytes     // Catch:{ Exception -> 0x04f2 }
            int r1 = r1 + r13
            r7.totalPreloadedBytes = r1     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x04f2 }
            int r1 = r1 + r13
            r7.preloadStreamFileOffset = r1     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.moovFound     // Catch:{ Exception -> 0x04f2 }
            if (r1 != 0) goto L_0x01a4
            int r1 = r7.nextAtomOffset     // Catch:{ Exception -> 0x04f2 }
            int r2 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.findNextPreloadDownloadOffset(r1, r2, r12)     // Catch:{ Exception -> 0x04f2 }
            if (r1 >= 0) goto L_0x019a
            int r1 = r1 * -1
            int r2 = r7.nextPreloadDownloadOffset     // Catch:{ Exception -> 0x04f2 }
            int r3 = r7.currentDownloadChunkSize     // Catch:{ Exception -> 0x04f2 }
            int r2 = r2 + r3
            r7.nextPreloadDownloadOffset = r2     // Catch:{ Exception -> 0x04f2 }
            int r3 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
            r4 = 2
            int r3 = r3 / r4
            if (r2 >= r3) goto L_0x018d
            r2 = 1048576(0x100000, float:1.469368E-39)
            int r2 = r2 + r1
            r7.foundMoovSize = r2     // Catch:{ Exception -> 0x04f2 }
            r7.preloadNotRequestedBytesCount = r2     // Catch:{ Exception -> 0x04f2 }
            r2 = 1
            r7.moovFound = r2     // Catch:{ Exception -> 0x04f2 }
            goto L_0x0196
        L_0x018d:
        ...
        L_0x0196:
            ...
            goto L_0x01a2
        L_0x019a:
            int r2 = r7.currentDownloadChunkSize     // Catch:{ Exception -> 0x04f2 }
            int r3 = r1 / r2
            int r3 = r3 * r2
            r7.nextPreloadDownloadOffset = r3     // Catch:{ Exception -> 0x04f2 }
        L_0x01a2:
            r7.nextAtomOffset = r1     // Catch:{ Exception -> 0x04f2 }
        L_0x01a4:
            java.io.RandomAccessFile r1 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            int r2 = r7.foundMoovSize     // Catch:{ Exception -> 0x04f2 }
            r1.writeInt(r2)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r1 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            int r2 = r7.nextPreloadDownloadOffset     // Catch:{ Exception -> 0x04f2 }
            r1.writeInt(r2)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r1 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            int r2 = r7.nextAtomOffset     // Catch:{ Exception -> 0x04f2 }
            r1.writeInt(r2)     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.preloadStreamFileOffset     // Catch:{ Exception -> 0x04f2 }
            int r1 = r1 + 12
            r7.preloadStreamFileOffset = r1     // Catch:{ Exception -> 0x04f2 }
            int r1 = r7.nextPreloadDownloadOffset     // Catch:{ Exception -> 0x04f2 }
            if (r1 == 0) goto L_0x01d8
            int r2 = r7.moovFound     // Catch:{ Exception -> 0x04f2 }
            if (r2 == 0) goto L_0x01cb
            int r2 = r7.foundMoovSize     // Catch:{ Exception -> 0x04f2 }
            if (r2 < 0) goto L_0x01d8
        L_0x01cb:
            int r2 = r7.totalPreloadedBytes     // Catch:{ Exception -> 0x04f2 }
            r3 = 2097152(0x200000, float:2.938736E-39)
            if (r2 > r3) goto L_0x01d8
            int r2 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x01d9:
            ...
            java.io.RandomAccessFile r2 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            r3 = 0
            r2.seek(r3)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r2 = r7.preloadStream     // Catch:{ Exception -> 0x04f2 }
            r3 = 1
            r2.write(r3)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x01f4
        L_0x01e9:
            int r2 = r7.moovFound     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x01f4:
            goto L_0x0476
        L_0x01f6:
            int r5 = r7.downloadedBytes     // Catch:{ Exception -> 0x04f2 }
            int r5 = r5 + r13
            r7.downloadedBytes = r5     // Catch:{ Exception -> 0x04f2 }
            int r9 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x0204:
            ...
            goto L_0x0219
        L_0x0206:
            int r10 = r7.currentDownloadChunkSize     // Catch:{ Exception -> 0x04f2 }
            if (r13 != r10) goto L_0x0217
            if (r9 == r5) goto L_0x0210
            int r10 = r5 % r10
        ...
        L_0x0218:
            r9 = r5
        L_0x0219:
            byte[] r5 = r7.key     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x0246
            java.nio.ByteBuffer r5 = r12.buffer     // Catch:{ Exception -> 0x04f2 }
            byte[] r10 = r7.key     // Catch:{ Exception -> 0x04f2 }
            byte[] r14 = r7.iv     // Catch:{ Exception -> 0x04f2 }
            r23 = 0
            r24 = 1
            r25 = 0
            int r26 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            r20 = r5
            r21 = r10
            r22 = r14
            org.telegram.messenger.Utilities.aesIgeEncryption(r20, r21, r22, r23, r24, r25, r26)     // Catch:{ Exception -> 0x04f2 }
            if (r9 == 0) goto L_0x0246
            int r5 = r7.bytesCountPadding     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x0246
            int r5 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            int r10 = r7.bytesCountPadding     // Catch:{ Exception -> 0x04f2 }
            int r5 = r5 - r10
            r12.limit(r5)     // Catch:{ Exception -> 0x04f2 }
        L_0x0246:
            boolean r5 = r7.encryptFile     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x0280
            int r5 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r5 = r5 / 16
            byte[] r10 = r7.encryptIv     // Catch:{ Exception -> 0x04f2 }
            r14 = r5 & 255(0xff, float:3.57E-43)
            byte r14 = (byte) r14     // Catch:{ Exception -> 0x04f2 }
            r10[r18] = r14     // Catch:{ Exception -> 0x04f2 }
            int r14 = r5 >> 8
            r14 = r14 & 255(0xff, float:3.57E-43)
            byte r14 = (byte) r14     // Catch:{ Exception -> 0x04f2 }
            r15 = 14
            r10[r15] = r14     // Catch:{ Exception -> 0x04f2 }
            int r14 = r5 >> 16
            r14 = r14 & 255(0xff, float:3.57E-43)
            byte r14 = (byte) r14     // Catch:{ Exception -> 0x04f2 }
            r15 = 13
            ...
            r14 = r14 & 255(0xff, float:3.57E-43)
            byte r14 = (byte) r14     // Catch:{ Exception -> 0x04f2 }
            r10[r19] = r14     // Catch:{ Exception -> 0x04f2 }
            java.nio.ByteBuffer r10 = r12.buffer     // Catch:{ Exception -> 0x04f2 }
            byte[] r14 = r7.encryptKey     // Catch:{ Exception -> 0x04f2 }
            byte[] r15 = r7.encryptIv     // Catch:{ Exception -> 0x04f2 }
            r16 = r5
            int r5 = r12.limit()     // Catch:{ Exception -> 0x04f2 }
            r11 = 0
            org.telegram.messenger.Utilities.aesCtrDecryption(r10, r14, r15, r11, r5)     // Catch:{ Exception -> 0x04f2 }
        L_0x0280:
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r5 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x02b3
            java.io.RandomAccessFile r5 = r7.fileOutputStream     // Catch:{ Exception -> 0x04f2 }
            int r10 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            long r10 = (long) r10     // Catch:{ Exception -> 0x04f2 }
            r5.seek(r10)     // Catch:{ Exception -> 0x04f2 }
            boolean r5 = org.telegram.messenger.BuildVars.DEBUG_VERSION     // Catch:{ Exception -> 0x04f2 }
            if (r5 == 0) goto L_0x02b3
            ...
            r5.append(r10)     // Catch:{ Exception -> 0x04f2 }
            java.io.File r10 = r7.cacheFileFinal     // Catch:{ Exception -> 0x04f2 }
            r5.append(r10)     // Catch:{ Exception -> 0x04f2 }
            r5.append(r1)     // Catch:{ Exception -> 0x04f2 }
            int r1 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            r5.append(r1)     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r1 = r5.toString()     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLog.d(r1)     // Catch:{ Exception -> 0x04f2 }
        L_0x02b3:
            java.io.RandomAccessFile r1 = r7.fileOutputStream     // Catch:{ Exception -> 0x04f2 }
            java.nio.channels.FileChannel r1 = r1.getChannel()     // Catch:{ Exception -> 0x04f2 }
            r10 = r1
            java.nio.ByteBuffer r1 = r12.buffer     // Catch:{ Exception -> 0x04f2 }
            r10.write(r1)     // Catch:{ Exception -> 0x04f2 }
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r1 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            int r5 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r11 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            int r11 = r11 + r13
            r14 = 1
            r7.addPart(r1, r5, r11, r14)     // Catch:{ Exception -> 0x04f2 }
            boolean r1 = r7.isCdn     // Catch:{ Exception -> 0x04f2 }
            if (r1 == 0) goto L_0x0447
            int r1 = r29.offset     // Catch:{ Exception -> 0x04f2 }
            r5 = 131072(0x20000, float:1.83671E-40)
            int r1 = r1 / r5
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r5 = r7.notCheckedCdnRanges     // Catch:{ Exception -> 0x04f2 }
            int r5 = r5.size()     // Catch:{ Exception -> 0x04f2 }
            r11 = 1
            r14 = 0
        L_0x02e1:
            if (r14 >= r5) goto L_0x0300
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r15 = r7.notCheckedCdnRanges     // Catch:{ Exception -> 0x04f2 }
            java.lang.Object r15 = r15.get(r14)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLoadOperation$Range r15 = (org.telegram.messenger.FileLoadOperation.Range) r15     // Catch:{ Exception -> 0x04f2 }
            r16 = r5
            int r5 = r15.start     // Catch:{ Exception -> 0x04f2 }
            if (r5 > r1) goto L_0x02fb
            int r5 = r15.end     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x0302:
            ...
            r5 = 131072(0x20000, float:1.83671E-40)
            int r14 = r1 * r5
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r15 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            int r15 = r7.getDownloadedLengthFromOffsetInternal(r15, r14, r5)     // Catch:{ Exception -> 0x04f2 }
            if (r15 == 0) goto L_0x0439
            if (r15 == r5) goto L_0x0328
            int r5 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
            if (r5 <= 0) goto L_0x031d
            r26 = r10
            int r10 = r5 - r14
            if (r15 == r10) goto L_0x032a
            goto L_0x031f
        L_0x031d:
            r26 = r10
        L_0x031f:
        ...
        L_0x032a:
            android.util.SparseArray<org.telegram.tgnet.TLRPC$TL_fileHash> r5 = r7.cdnHashes     // Catch:{ Exception -> 0x04f2 }
            java.lang.Object r5 = r5.get(r14)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$TL_fileHash r5 = (org.telegram.tgnet.TLRPC.TL_fileHash) r5     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r10 = r7.fileReadStream     // Catch:{ Exception -> 0x04f2 }
            if (r10 != 0) goto L_0x034d
            r10 = 131072(0x20000, float:1.83671E-40)
            byte[] r10 = new byte[r10]     // Catch:{ Exception -> 0x04f2 }
            r7.cdnCheckBytes = r10     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r10 = new java.io.RandomAccessFile     // Catch:{ Exception -> 0x04f2 }
            r17 = r9
            java.io.File r9 = r7.cacheFileTemp     // Catch:{ Exception -> 0x04f2 }
            r27 = r11
            java.lang.String r11 = "r"
            r10.<init>(r9, r11)     // Catch:{ Exception -> 0x04f2 }
            r7.fileReadStream = r10     // Catch:{ Exception -> 0x04f2 }
            goto L_0x0351
        L_0x034d:
            r17 = r9
            r27 = r11
        L_0x0351:
            java.io.RandomAccessFile r9 = r7.fileReadStream     // Catch:{ Exception -> 0x04f2 }
            long r10 = (long) r14     // Catch:{ Exception -> 0x04f2 }
            r9.seek(r10)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r9 = r7.fileReadStream     // Catch:{ Exception -> 0x04f2 }
            byte[] r10 = r7.cdnCheckBytes     // Catch:{ Exception -> 0x04f2 }
            r11 = 0
            r9.readFully(r10, r11, r15)     // Catch:{ Exception -> 0x04f2 }
            boolean r9 = r7.encryptFile     // Catch:{ Exception -> 0x04f2 }
            if (r9 == 0) goto L_0x039a
            int r9 = r14 / 16
            byte[] r10 = r7.encryptIv     // Catch:{ Exception -> 0x04f2 }
            r11 = r9 & 255(0xff, float:3.57E-43)
            byte r11 = (byte) r11     // Catch:{ Exception -> 0x04f2 }
            r10[r18] = r11     // Catch:{ Exception -> 0x04f2 }
            int r11 = r9 >> 8
            ...
            r11 = r11 & 255(0xff, float:3.57E-43)
            byte r11 = (byte) r11     // Catch:{ Exception -> 0x04f2 }
            r10[r19] = r11     // Catch:{ Exception -> 0x04f2 }
            byte[] r11 = r7.cdnCheckBytes     // Catch:{ Exception -> 0x04f2 }
            r18 = r9
            byte[] r9 = r7.encryptKey     // Catch:{ Exception -> 0x04f2 }
            r23 = 0
            r25 = 0
            r20 = r11
            r21 = r9
            r22 = r10
            r24 = r15
            org.telegram.messenger.Utilities.aesCtrDecryptionByteArray(r20, r21, r22, r23, r24, r25)     // Catch:{ Exception -> 0x04f2 }
        L_0x039a:
            byte[] r9 = r7.cdnCheckBytes     // Catch:{ Exception -> 0x04f2 }
            r10 = 0
            byte[] r9 = org.telegram.messenger.Utilities.computeSHA256(r9, r10, r15)     // Catch:{ Exception -> 0x04f2 }
            byte[] r10 = r5.hash     // Catch:{ Exception -> 0x04f2 }
            boolean r10 = java.util.Arrays.equals(r9, r10)     // Catch:{ Exception -> 0x04f2 }
            if (r10 != 0) goto L_0x042a
            boolean r10 = org.telegram.messenger.BuildVars.LOGS_ENABLED     // Catch:{ Exception -> 0x04f2 }
            if (r10 == 0) goto L_0x041f
            org.telegram.tgnet.TLRPC$InputFileLocation r10 = r7.location     // Catch:{ Exception -> 0x04f2 }
            if (r10 == 0) goto L_0x03fb
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x04f2 }
            r10.<init>()     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r11 = "invalid cdn hash "
            r10.append(r11)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r11 = r7.location     // Catch:{ Exception -> 0x04f2 }
            r10.append(r11)     // Catch:{ Exception -> 0x04f2 }
            r10.append(r6)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r6 = r7.location     // Catch:{ Exception -> 0x04f2 }
            r11 = r5
            long r5 = r6.id     // Catch:{ Exception -> 0x04f2 }
            r10.append(r5)     // Catch:{ Exception -> 0x04f2 }
            r10.append(r4)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r4 = r7.location     // Catch:{ Exception -> 0x04f2 }
            int r4 = r4.local_id     // Catch:{ Exception -> 0x04f2 }
            r10.append(r4)     // Catch:{ Exception -> 0x04f2 }
            r10.append(r3)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r3 = r7.location     // Catch:{ Exception -> 0x04f2 }
            long r3 = r3.access_hash     // Catch:{ Exception -> 0x04f2 }
            r10.append(r3)     // Catch:{ Exception -> 0x04f2 }
            r10.append(r2)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r2 = r7.location     // Catch:{ Exception -> 0x04f2 }
            long r2 = r2.volume_id     // Catch:{ Exception -> 0x04f2 }
            r10.append(r2)     // Catch:{ Exception -> 0x04f2 }
            r10.append(r0)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$InputFileLocation r0 = r7.location     // Catch:{ Exception -> 0x04f2 }
            long r2 = r0.secret     // Catch:{ Exception -> 0x04f2 }
            r10.append(r2)     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r0 = r10.toString()     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLog.e((java.lang.String) r0)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x0420
        L_0x03fb:
            r11 = r5
            org.telegram.tgnet.TLRPC$InputWebFileLocation r0 = r7.webLocation     // Catch:{ Exception -> 0x04f2 }
            ...
            org.telegram.tgnet.TLRPC$InputWebFileLocation r2 = r7.webLocation     // Catch:{ Exception -> 0x04f2 }
            r0.append(r2)     // Catch:{ Exception -> 0x04f2 }
            r0.append(r6)     // Catch:{ Exception -> 0x04f2 }
            java.lang.String r2 = r7.fileName     // Catch:{ Exception -> 0x04f2 }
            r0.append(r2)     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x0420:
            r2 = 0
            r7.onFail(r2, r2)     // Catch:{ Exception -> 0x04f2 }
            java.io.File r0 = r7.cacheFileTemp     // Catch:{ Exception -> 0x04f2 }
            r0.delete()     // Catch:{ Exception -> 0x04f2 }
            return r2
        L_0x042a:
            r11 = r5
            android.util.SparseArray<org.telegram.tgnet.TLRPC$TL_fileHash> r0 = r7.cdnHashes     // Catch:{ Exception -> 0x04f2 }
            r0.remove(r14)     // Catch:{ Exception -> 0x04f2 }
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r0 = r7.notCheckedCdnRanges     // Catch:{ Exception -> 0x04f2 }
            int r2 = r1 + 1
            r3 = 0
            r7.addPart(r0, r1, r2, r3)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x044b
        L_0x0439:
            r17 = r9
            r26 = r10
        ...
        L_0x0447:
            ...
            r26 = r10
        L_0x044b:
            java.io.RandomAccessFile r0 = r7.fiv     // Catch:{ Exception -> 0x04f2 }
            if (r0 == 0) goto L_0x045b
            r1 = 0
            r0.seek(r1)     // Catch:{ Exception -> 0x04f2 }
            java.io.RandomAccessFile r0 = r7.fiv     // Catch:{ Exception -> 0x04f2 }
            byte[] r1 = r7.iv     // Catch:{ Exception -> 0x04f2 }
            r0.write(r1)     // Catch:{ Exception -> 0x04f2 }
        L_0x045b:
            int r0 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
            if (r0 <= 0) goto L_0x0474
            int r0 = r7.state     // Catch:{ Exception -> 0x04f2 }
            r1 = 1
            if (r0 != r1) goto L_0x0474
            r28.copyNotLoadedRanges()     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLoadOperation$FileLoadOperationDelegate r1 = r7.delegate     // Catch:{ Exception -> 0x04f2 }
            int r0 = r7.downloadedBytes     // Catch:{ Exception -> 0x04f2 }
            long r3 = (long) r0     // Catch:{ Exception -> 0x04f2 }
            int r0 = r7.totalBytesCount     // Catch:{ Exception -> 0x04f2 }
            long r5 = (long) r0     // Catch:{ Exception -> 0x04f2 }
            r2 = r28
            r1.didChangedLoadProgress(r2, r3, r5)     // Catch:{ Exception -> 0x04f2 }
        L_0x0474:
            r1 = r17
        L_0x0476:
            r0 = 0
        L_0x0477:
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$RequestInfo> r2 = r7.delayedRequestInfos     // Catch:{ Exception -> 0x04f2 }
            int r2 = r2.size()     // Catch:{ Exception -> 0x04f2 }
            if (r0 >= r2) goto L_0x04e1
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$RequestInfo> r2 = r7.delayedRequestInfos     // Catch:{ Exception -> 0x04f2 }
            java.lang.Object r2 = r2.get(r0)     // Catch:{ Exception -> 0x04f2 }
            org.telegram.messenger.FileLoadOperation$RequestInfo r2 = (org.telegram.messenger.FileLoadOperation.RequestInfo) r2     // Catch:{ Exception -> 0x04f2 }
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$Range> r3 = r7.notLoadedBytesRanges     // Catch:{ Exception -> 0x04f2 }
            if (r3 != 0) goto L_0x0497
            int r3 = r7.downloadedBytes     // Catch:{ Exception -> 0x04f2 }
            int r4 = r2.offset     // Catch:{ Exception -> 0x04f2 }
            if (r3 != r4) goto L_0x0494
            goto L_0x0497
        L_0x0494:
            int r0 = r0 + 1
            goto L_0x0477
        L_0x0497:
            java.util.ArrayList<org.telegram.messenger.FileLoadOperation$RequestInfo> r3 = r7.delayedRequestInfos     // Catch:{ Exception -> 0x04f2 }
            r3.remove(r0)     // Catch:{ Exception -> 0x04f2 }
            r3 = 0
            boolean r3 = r7.processRequestResult(r2, r3)     // Catch:{ Exception -> 0x04f2 }
            if (r3 != 0) goto L_0x04e1
            org.telegram.tgnet.TLRPC$TL_upload_file r3 = r2.response     // Catch:{ Exception -> 0x04f2 }
            if (r3 == 0) goto L_0x04b8
            org.telegram.tgnet.TLRPC$TL_upload_file r3 = r2.response     // Catch:{ Exception -> 0x04f2 }
            r4 = 0
            r3.disableFree = r4     // Catch:{ Exception -> 0x04f2 }
            org.telegram.tgnet.TLRPC$TL_upload_file r3 = r2.response     // Catch:{ Exception -> 0x04f2 }
            r3.freeResources()     // Catch:{ Exception -> 0x04f2 }
            goto L_0x04e1
        L_0x04b8:
            org.telegram.tgnet.TLRPC$TL_upload_webFile r3 = r2.responseWeb     // Catch:{ Exception -> 0x04f2 }
            ...
            goto L_0x04e1
        L_0x04cd:
            org.telegram.tgnet.TLRPC$TL_upload_cdnFile r3 = r2.responseCdn     // Catch:{ Exception -> 0x04f2 }
            if (r3 == 0) goto L_0x04e1
            org.telegram.tgnet.TLRPC$TL_upload_cdnFile r3 = r2.responseCdn     // Catch:{ Exception -> 0x04f2 }
            r4 = 0
            r3.disableFree = r4     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x04e1:
            ...
            r0 = 1
            r7.onFinishLoadingFile(r0)     // Catch:{ Exception -> 0x04f2 }
            goto L_0x04fa
        L_0x04e8:
            r28.startDownloadRequest()     // Catch:{ Exception -> 0x04f2 }
            goto L_0x04fa
        L_0x04ec:
            r0 = 1
            r7.onFinishLoadingFile(r0)     // Catch:{ Exception -> 0x04f2 }
        ...
        L_0x04fd:
            ...
            r3 = r0
            r3.useDelimiter(r1)
            int r0 = r3.nextInt()     // Catch:{ Exception -> 0x0521 }
            java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x0521 }
            goto L_0x0524
        L_0x0521:
            r0 = move-exception
            r1 = 0
        ...
        L_0x053c:
            ...
            r0 = 1
            r7.onFinishLoadingFile(r0)     // Catch:{ Exception -> 0x0554 }
            r1 = 0
            goto L_0x05f6
        L_0x0554:
            r0 = move-exception
    ...
    public /* synthetic */ void m621lambda$onFail$10$orgtelegrammessengerFileLoadOperation(int reason) {
    ...
    public void startDownloadRequest() {
        ...
        L_0x01e0:
            ...
            org.telegram.tgnet.NativeByteBuffer r0 = new org.telegram.tgnet.NativeByteBuffer     // Catch:{ Exception -> 0x024e }
            int r11 = r10.length     // Catch:{ Exception -> 0x024e }
            r0.<init>((int) r11)     // Catch:{ Exception -> 0x024e }
            java.io.RandomAccessFile r11 = r1.preloadStream     // Catch:{ Exception -> 0x024e }
            int r12 = r10.fileOffset     // Catch:{ Exception -> 0x024e }
            long r12 = (long) r12     // Catch:{ Exception -> 0x024e }
            r11.seek(r12)     // Catch:{ Exception -> 0x024e }
            java.io.RandomAccessFile r11 = r1.preloadStream     // Catch:{ Exception -> 0x024e }
            java.nio.channels.FileChannel r11 = r11.getChannel()     // Catch:{ Exception -> 0x024e }
            java.nio.ByteBuffer r12 = r0.buffer     // Catch:{ Exception -> 0x024e }
            r11.read(r12)     // Catch:{ Exception -> 0x024e }
            java.nio.ByteBuffer r11 = r0.buffer     // Catch:{ Exception -> 0x024e }
            r11.position(r5)     // Catch:{ Exception -> 0x024e }
            org.telegram.tgnet.TLRPC$TL_upload_file r11 = r15.response     // Catch:{ Exception -> 0x024e }
            r11.bytes = r0     // Catch:{ Exception -> 0x024e }
            org.telegram.messenger.DispatchQueue r11 = org.telegram.messenger.Utilities.stageQueue     // Catch:{ Exception -> 0x024e }
            org.telegram.messenger.FileLoadOperation$$ExternalSyntheticLambda7 r12 = new org.telegram.messenger.FileLoadOperation$$ExternalSyntheticLambda7     // Catch:{ Exception -> 0x024e }
            r12.<init>(r1, r15)     // Catch:{ Exception -> 0x024e }
            r11.postRunnable(r12)     // Catch:{ Exception -> 0x024e }
            goto L_0x02ac
        L_0x024e:
            r0 = move-exception
        L_0x024f:
    ...
    public /* synthetic */ void m628xe3dafa6a(RequestInfo requestInfo) {
    ...
    public /* synthetic */ void m630xf2a564a8(RequestInfo requestInfo, TLObject request, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m629xeb402var_(RequestInfo requestInfo, TLObject response1, TLRPC.TL_error error1) {
