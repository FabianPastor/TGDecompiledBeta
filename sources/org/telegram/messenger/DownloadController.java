...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:34:0x02fc  */
    ...
    public /* synthetic */ void m61lambda$new$0$orgtelegrammessengerDownloadController() {
    ...
    public /* synthetic */ void m58xc6var_CLASSNAME(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m57xe1b1dda6(TLObject response) {
        Preset preset;
    ...
    public /* synthetic */ void m67x71var_eb7(MessageObject parentObject) {
        boolean contains = false;
        int i = 0;
        while (true) {
            if (i >= this.recentDownloadingFiles.size()) {
                break;
            } else if (this.recentDownloadingFiles.get(i).getDocument().id == parentObject.getDocument().id) {
                contains = true;
                break;
            } else {
                i++;
        ...
        if (!contains) {
            ...
            while (true) {
                if (i2 >= this.downloadingFiles.size()) {
                    break;
                } else if (this.downloadingFiles.get(i2).getDocument().id == parentObject.getDocument().id) {
                    contains = true;
                    break;
                } else {
                    i2++;
    ...
    public /* synthetic */ void m66x8cb4eff6(MessageObject parentObject) {
        try {
    ...
    public /* synthetic */ void m63x872e680d(MessageObject parentObject) {
    ...
    public /* synthetic */ void m62xa1ecvar_c(MessageObject parentObject) {
        try {
    ...
    public /* synthetic */ void m64x867eb33(MessageObject parentObject, int reason) {
        boolean removed = false;
        int i = 0;
        while (true) {
            if (i >= this.downloadingFiles.size()) {
    ...
    public /* synthetic */ void m65xeda959f4(MessageObject parentObject) {
        try {
            SQLitePreparedStatement state = getMessagesStorage().getDatabase().executeFast("DELETE FROM downloading_documents WHERE hash = ? AND id = ?");
    ...
    public /* synthetic */ void m60x5c0evar_() {
    ...
    public /* synthetic */ void m59x207var_(ArrayList downloadingMessages, ArrayList recentlyDownloadedMessages) {
    ...
    public /* synthetic */ void m55x5e3299d() {
        try {
    ...
    public /* synthetic */ void m56x7bb1CLASSNAMEf(ArrayList messageObjects) {
        try {
            SQLitePreparedStatement state = getMessagesStorage().getDatabase().executeFast("DELETE FROM downloading_documents WHERE hash = ? AND id = ?");
            for (int i = 0; i < messageObjects.size(); i++) {
                state.requery();
                ...
                state.step();
                try {
                    FileLoader.getPathToMessage(((MessageObject) messageObjects.get(i)).messageOwner).delete();
                } catch (Exception e) {
                    FileLog.e((Throwable) e);
                }
            }
