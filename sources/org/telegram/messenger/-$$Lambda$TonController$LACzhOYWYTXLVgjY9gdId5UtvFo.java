...
public final /* synthetic */ class -$$Lambda$TonController$LACzhOYWYTXLVgjY9gdId5UtvFo implements Runnable {
    ...
    public /* synthetic */ -$$Lambda$TonController$LACzhOYWYTXLVgjY9gdId5UtvFo(TonController tonController, InputKey inputKey, String str, Cipher cipher, Runnable runnable, ErrorCallback errorCallback, String str2, String str3, long j, String str4, Runnable runnable2, Runnable runnable3, DangerousCallback dangerousCallback) {
    ...
    public final void run() {
        this.f$0.lambda$sendGrams$34$TonController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, this.f$11, this.f$12);
    }
}
