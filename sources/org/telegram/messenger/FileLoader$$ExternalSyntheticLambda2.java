...
public final /* synthetic */ class FileLoader$$ExternalSyntheticLambda2 implements Runnable {
    ...
    public /* synthetic */ FileLoader$$ExternalSyntheticLambda2(FileLoader fileLoader, FileLoadOperation[] fileLoadOperationArr, TLRPC.Document document, ImageLocation imageLocation, Object obj, FileLoadOperationStream fileLoadOperationStream, int i, boolean z, CountDownLatch countDownLatch) {
        this.f$0 = fileLoader;
    ...
    public final void run() {
        this.f$0.m636lambda$loadStreamFile$9$orgtelegrammessengerFileLoader(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
