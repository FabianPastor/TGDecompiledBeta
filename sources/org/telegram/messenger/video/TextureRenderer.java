...
public class TextureRenderer {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:120:0x0206 A[SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:60:0x0166 A[ADDED_TO_REGION, Catch:{ all -> 0x0216 }] */
    ...
    public void surfaceCreated() {
        ...
        L_0x0126:
            ...
            r0 = 0
        L_0x0130:
            int[] r14 = r1.paintTexture     // Catch:{ all -> 0x0216 }
            int r14 = r14.length     // Catch:{ all -> 0x0216 }
            if (r0 >= r14) goto L_0x021a
            r14 = 270(0x10e, float:3.78E-43)
            r15 = 90
            if (r0 != 0) goto L_0x015d
            java.lang.String r2 = r1.imagePath     // Catch:{ all -> 0x0216 }
            if (r2 == 0) goto L_0x015d
            androidx.exifinterface.media.ExifInterface r10 = new androidx.exifinterface.media.ExifInterface     // Catch:{ all -> 0x015f }
            r10.<init>((java.lang.String) r2)     // Catch:{ all -> 0x015f }
            java.lang.String r8 = "Orientation"
            int r8 = r10.getAttributeInt(r8, r3)     // Catch:{ all -> 0x015f }
        ...
        L_0x015a:
            ...
            goto L_0x0160
        L_0x015d:
            java.lang.String r2 = r1.paintPath     // Catch:{ all -> 0x0216 }
        L_0x015f:
            r8 = 0
        L_0x0160:
            android.graphics.Bitmap r2 = android.graphics.BitmapFactory.decodeFile(r2)     // Catch:{ all -> 0x0216 }
            if (r2 == 0) goto L_0x0206
            if (r0 != 0) goto L_0x01e8
            java.lang.String r10 = r1.imagePath     // Catch:{ all -> 0x0216 }
            if (r10 == 0) goto L_0x01e8
            int r10 = r1.transformedWidth     // Catch:{ all -> 0x0216 }
            int r11 = r1.transformedHeight     // Catch:{ all -> 0x0216 }
            android.graphics.Bitmap$Config r3 = android.graphics.Bitmap.Config.ARGB_8888     // Catch:{ all -> 0x0216 }
            android.graphics.Bitmap r3 = android.graphics.Bitmap.createBitmap(r10, r11, r3)     // Catch:{ all -> 0x0216 }
            r3.eraseColor(r4)     // Catch:{ all -> 0x0216 }
            android.graphics.Canvas r10 = new android.graphics.Canvas     // Catch:{ all -> 0x0216 }
            r10.<init>(r3)     // Catch:{ all -> 0x0216 }
            if (r8 == r15) goto L_0x019a
            if (r8 != r14) goto L_0x0183
            goto L_0x019a
        L_0x0183:
            int r11 = r2.getWidth()     // Catch:{ all -> 0x0216 }
            float r11 = (float) r11     // Catch:{ all -> 0x0216 }
            int r14 = r1.transformedWidth     // Catch:{ all -> 0x0216 }
            float r14 = (float) r14     // Catch:{ all -> 0x0216 }
            float r11 = r11 / r14
            int r14 = r2.getHeight()     // Catch:{ all -> 0x0216 }
            float r14 = (float) r14     // Catch:{ all -> 0x0216 }
            int r15 = r1.transformedHeight     // Catch:{ all -> 0x0216 }
            float r15 = (float) r15     // Catch:{ all -> 0x0216 }
            float r14 = r14 / r15
            float r11 = java.lang.Math.max(r11, r14)     // Catch:{ all -> 0x0216 }
            goto L_0x01b0
        L_0x019a:
            int r11 = r2.getHeight()     // Catch:{ all -> 0x0216 }
            float r11 = (float) r11     // Catch:{ all -> 0x0216 }
            int r14 = r1.transformedWidth     // Catch:{ all -> 0x0216 }
            float r14 = (float) r14     // Catch:{ all -> 0x0216 }
            float r11 = r11 / r14
            int r14 = r2.getWidth()     // Catch:{ all -> 0x0216 }
            float r14 = (float) r14     // Catch:{ all -> 0x0216 }
            int r15 = r1.transformedHeight     // Catch:{ all -> 0x0216 }
            float r15 = (float) r15     // Catch:{ all -> 0x0216 }
            float r14 = r14 / r15
            float r11 = java.lang.Math.max(r11, r14)     // Catch:{ all -> 0x0216 }
        L_0x01b0:
            android.graphics.Matrix r14 = new android.graphics.Matrix     // Catch:{ all -> 0x0216 }
            r14.<init>()     // Catch:{ all -> 0x0216 }
            int r15 = r2.getWidth()     // Catch:{ all -> 0x0216 }
            int r15 = -r15
            r4 = 2
            int r15 = r15 / r4
            float r15 = (float) r15     // Catch:{ all -> 0x0216 }
            int r9 = r2.getHeight()     // Catch:{ all -> 0x0216 }
            int r9 = -r9
            int r9 = r9 / r4
            float r9 = (float) r9     // Catch:{ all -> 0x0216 }
            r14.postTranslate(r15, r9)     // Catch:{ all -> 0x0216 }
            float r9 = r12 / r11
            r14.postScale(r9, r9)     // Catch:{ all -> 0x0216 }
            float r8 = (float) r8     // Catch:{ all -> 0x0216 }
            r14.postRotate(r8)     // Catch:{ all -> 0x0216 }
            int r8 = r3.getWidth()     // Catch:{ all -> 0x0216 }
            int r8 = r8 / r4
            float r8 = (float) r8     // Catch:{ all -> 0x0216 }
            int r9 = r3.getHeight()     // Catch:{ all -> 0x0216 }
            int r9 = r9 / r4
            float r9 = (float) r9     // Catch:{ all -> 0x0216 }
            r14.postTranslate(r8, r9)     // Catch:{ all -> 0x0216 }
            android.graphics.Paint r8 = new android.graphics.Paint     // Catch:{ all -> 0x0216 }
            r8.<init>(r4)     // Catch:{ all -> 0x0216 }
            r10.drawBitmap(r2, r14, r8)     // Catch:{ all -> 0x0216 }
            r2 = r3
        L_0x01e8:
            int[] r3 = r1.paintTexture     // Catch:{ all -> 0x0216 }
            r3 = r3[r0]     // Catch:{ all -> 0x0216 }
            android.opengl.GLES20.glBindTexture(r13, r3)     // Catch:{ all -> 0x0216 }
            android.opengl.GLES20.glTexParameteri(r13, r5, r6)     // Catch:{ all -> 0x0216 }
            android.opengl.GLES20.glTexParameteri(r13, r7, r6)     // Catch:{ all -> 0x0216 }
            r3 = 10242(0x2802, float:1.4352E-41)
            r4 = 33071(0x812f, float:4.6342E-41)
            android.opengl.GLES20.glTexParameteri(r13, r3, r4)     // Catch:{ all -> 0x0216 }
            r3 = 10243(0x2803, float:1.4354E-41)
            android.opengl.GLES20.glTexParameteri(r13, r3, r4)     // Catch:{ all -> 0x0216 }
            r3 = 0
            android.opengl.GLUtils.texImage2D(r13, r3, r2, r3)     // Catch:{ all -> 0x0216 }
        L_0x0206:
            int r0 = r0 + 1
            r2 = 0
            r3 = 1
        ...
        L_0x0252:
            ...
            r17 = r5
            r20 = r4
            long r4 = org.telegram.ui.Components.RLottieDrawable.create(r17, r18, r19, r20, r21, r22, r23)     // Catch:{ all -> 0x03fa }
