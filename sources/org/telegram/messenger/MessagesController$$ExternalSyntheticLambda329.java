...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda329 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda329(MessagesController messagesController, TLRPC$TL_theme tLRPC$TL_theme, Theme.ThemeInfo themeInfo, TLRPC$TL_inputThemeSettings tLRPC$TL_inputThemeSettings, Theme.ThemeAccent themeAccent) {
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$didReceivedNotification$33(this.f$1, this.f$2, this.f$3, this.f$4, tLObject, tLRPC$TL_error);
    }
}
