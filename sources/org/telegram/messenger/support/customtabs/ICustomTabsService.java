        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 2:
                    ...
                    boolean _arg21 = warmup(data.readLong());
                    reply.writeNoException();
                    reply.writeInt(_arg21);
                    return true;
                case 3:
                    data.enforceInterface("android.support.customtabs.ICustomTabsService");
                    boolean _arg13 = newSession(ICustomTabsCallback.Stub.asInterface(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    boolean _arg212 = updateVisuals(_arg02, _arg122);
                    reply.writeNoException();
                ...
                case 7:
                    ...
                    boolean _arg213 = requestPostMessageChannel(_arg03, _arg112);
                    reply.writeNoException();
                    reply.writeInt(_arg213);
                    return true;
                case 8:
                    data.enforceInterface("android.support.customtabs.ICustomTabsService");
                    ...
                    int _result = postMessage(_arg04, _arg1, _arg22);
                    reply.writeNoException();
