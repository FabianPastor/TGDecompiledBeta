...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C13642();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C13631();
    ...
    class C13631 implements MainThreadCallback<T> {
        C13631() {
        }
    ...
    class C13642 implements BackgroundCallback<T> {
