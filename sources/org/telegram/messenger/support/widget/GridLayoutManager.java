...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    protected void calculateItemBorders(int i) {
    ...
    protected int getSpanSize(Recycler recycler, State state, int i) {
        if (state.isPreLayout() == null) {
        ...
        for (i2 = 0; i2 < i6; i2++) {
            ...
            if (r6.mOrientationHelper.getDecoratedMeasurement(view) != i7) {
                ...
                if (r6.mOrientation == 1) {
                    i5 = LayoutManager.getChildMeasureSpec(i3, NUM, modeInOther, layoutParams.width, false);
                    i3 = MeasureSpec.makeMeasureSpec(i7 - i4, NUM);
                    modeInOther = i5;
                } else {
                    modeInOther = MeasureSpec.makeMeasureSpec(i7 - modeInOther, NUM);
                    i3 = LayoutManager.getChildMeasureSpec(i3, NUM, i4, layoutParams.height, false);
                }
    ...
    protected void assignSpans(Recycler recycler, State state, int i, int i2, boolean z) {
        i2 = -1;
        int i3 = 0;
        if (z) {
            z = true;
                            ...
                            if (i4 > i6) {
                                ...
                                if (obj != null) {
                                    if (childAt.hasFocusable()) {
                                        ...
                                        view4 = childAt;
                                        i9 = Math.min(i13, i3) - Math.max(i12, i2);
