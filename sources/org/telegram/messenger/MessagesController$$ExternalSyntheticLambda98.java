...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda98 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda98(MessagesController messagesController, TLRPC.WallPaper wallPaper, TLRPC.TL_wallPaperSettings tL_wallPaperSettings, Theme.OverrideWallpaperInfo overrideWallpaperInfo, File file) {
    ...
    public final void run() {
        this.f$0.m196xcb05CLASSNAMEb(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
