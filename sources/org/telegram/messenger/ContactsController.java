...
public class ContactsController extends BaseController {
    ...
    public /* synthetic */ void m30lambda$new$0$orgtelegrammessengerContactsController() {
        try {
    ...
    public /* synthetic */ void m12lambda$cleanup$1$orgtelegrammessengerContactsController() {
    ...
    public /* synthetic */ void m11x699e1var_(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m10x845cb097(TLRPC.TL_help_inviteText res) {
    ...
    public /* synthetic */ void m9lambda$checkContacts$4$orgtelegrammessengerContactsController() {
    ...
    public /* synthetic */ void m18xCLASSNAMEfbf() {
        if (BuildVars.LOGS_ENABLED) {
    ...
    public /* synthetic */ void m55xe9e28340(HashMap contacts2, boolean first, boolean schedule, boolean cancel) {
        if (BuildVars.LOGS_ENABLED) {
    ...
    public /* synthetic */ void m14x3b83ab48(Runnable runnable, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
            this.contactsBookSPhones.clear();
            this.contactsBook.clear();
            this.completedRequestsCount = 0;
    ...
    public /* synthetic */ void m13x56423CLASSNAME(Runnable runnable) {
        AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
        try {
            Account[] accounts = am.getAccountsByType("org.telegram.messenger");
            this.systemAccount = null;
    ...
    public /* synthetic */ void m52lambda$readContacts$10$orgtelegrammessengerContactsController() {
    ...
    private java.util.HashMap<java.lang.String, org.telegram.messenger.ContactsController.Contact> readContactsFromPhoneBook() {
        ...
        L_0x0209:
            ...
            r5 = 2131627501(0x7f0e0ded, float:1.8882268E38)
            java.lang.String r1 = org.telegram.messenger.LocaleController.getString(r1, r5)     // Catch:{ all -> 0x0382 }
            r0.add(r1)     // Catch:{ all -> 0x0382 }
        L_0x0217:
    ...
    public /* synthetic */ void m29x39var_a07(SparseArray contactHashMap) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ void m43x3cf1c3d6(java.util.HashMap r35, boolean r36, boolean r37, boolean r38, boolean r39, boolean r40, boolean r41) {
        /*
            r34 = this;
            r13 = r34
            r14 = r35
        ...
        L_0x0733:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ContactsController.m43x3cf1c3d6(java.util.HashMap, boolean, boolean, boolean, boolean, boolean, boolean):void");
    }

    /* renamed from: lambda$performSyncPhoneBook$12$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m31xavar_cf5(HashMap contactHashMap) {
    ...
    public /* synthetic */ void m32x94c3ebb6(int checkType, HashMap contactHashMap, boolean first, boolean schedule) {
    ...
    public /* synthetic */ void m34x5var_CLASSNAME(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
    ...
    public /* synthetic */ void m33x7a055a77(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m41x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
    ...
    public /* synthetic */ void m38xvar_CLASSNAMEc(HashMap contactsMapToSave, SparseArray contactIdToKey, boolean[] hasErrors, HashMap contactsMap, TLRPC.TL_contacts_importContacts req, int count, HashMap contactsBookShort, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m37xf0b157b(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal, boolean[] hasErrors) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m35x448837f9(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m41x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
        getNotificationCenter().postNotificationName(NotificationCenter.contactsImported, new Object[0]);
    }

    /* renamed from: lambda$performSyncPhoneBook$17$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m36x29c9a6ba() {
    ...
    public /* synthetic */ void m40x8d2d7793(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m39xa7eCLASSNAMEd2(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m41x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
        updateUnregisteredContacts();
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
        getNotificationCenter().postNotificationName(NotificationCenter.contactsImported, new Object[0]);
    ...
    public /* synthetic */ void m42x57b05515(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m20lambda$loadContacts$27$orgtelegrammessengerContactsController(long hash, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m19lambda$loadContacts$26$orgtelegrammessengerContactsController() {
        synchronized (this.loadContactsSync) {
            this.loadingContacts = false;
        }
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
    ...
    public /* synthetic */ void m51x3bbda006(ArrayList usersArr, int from, ArrayList contactsArr) {
    ...
    public /* synthetic */ void m50x567CLASSNAME(int from, ArrayList contactsArr, LongSparseArray usersDict, ArrayList usersArr, boolean isEmpty) {
    ...
    public /* synthetic */ void m45x5e12a568() {
    ...
    public /* synthetic */ void m46x43541429() {
        this.doneLoadingContacts = true;
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
    }
    ...
    public /* synthetic */ void m47xa6b7e502(ArrayList contactsArr, ConcurrentHashMap contactsDictionary, HashMap sectionsDict, HashMap sectionsDictMutual, ArrayList sortedSectionsArray, ArrayList sortedSectionsArrayMutual, int from, boolean isEmpty) {
    ...
    public /* synthetic */ void m49x713aCLASSNAME(HashMap contactsByPhonesDictFinal, HashMap contactsByPhonesShortDictFinal) {
    ...
    public /* synthetic */ void m48x8bvar_c3(HashMap contactsByPhonesDictFinal, HashMap contactsByPhonesShortDictFinal) {
    ...
    public void m41x726ee654(HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal, ArrayList<String> phoneBookSectionsArrayFinal, HashMap<String, Contact> phoneBookByShortPhonesFinal) {
    ...
    public /* synthetic */ void m28xcadb3f5a(ArrayList contactsCopy, HashMap phoneBookByShortPhonesFinal, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal) {
    ...
    public /* synthetic */ void m27xe599d099(ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookSectionsDictFinal) {
    ...
    public /* synthetic */ int m8x277ef5f(TLRPC.TL_contact tl_contact, TLRPC.TL_contact tl_contact2) {
    ...
    public void m44x8296d0df(ArrayList<TLRPC.TL_contact> contactsArray) {
        Cursor cursor = null;
        try {
            if (hasContactsPermission()) {
    ...
    public /* synthetic */ void m5x52aad668(Long uid) {
    ...
    public /* synthetic */ void m6x37eCLASSNAME() {
        loadContacts(false, 0);
    }

    /* renamed from: lambda$applyContactsUpdates$48$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m7x1d2db3ea(ArrayList newContacts, ArrayList contactsToDelete) {
    ...
    public /* synthetic */ void m4lambda$addContact$52$orgtelegrammessengerContactsController(TLRPC.User user, TLObject response, TLRPC.TL_error error) {
        int index;
        if (error == null) {
    ...
    public /* synthetic */ void m2lambda$addContact$50$orgtelegrammessengerContactsController(TLRPC.User u) {
    ...
    public /* synthetic */ void m3lambda$addContact$51$orgtelegrammessengerContactsController(TLRPC.Updates res) {
        for (int a = 0; a < res.users.size(); a++) {
            TLRPC.User u = res.users.get(a);
    ...
    public /* synthetic */ void m17x6de2e0d4(ArrayList uids, ArrayList users, boolean showBulletin, String userName, TLObject response, TLRPC.TL_error error) {
        int index;
        if (error == null) {
    ...
    public /* synthetic */ void m15xa3600352(ArrayList users) {
    ...
    public /* synthetic */ void m16x88a17213(ArrayList users, boolean showBulletin, String userName) {
    ...
    public /* synthetic */ void m54xfCLASSNAMEe105(SharedPreferences.Editor editor, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m53x16d87244(SharedPreferences.Editor editor, TLObject response) {
    ...
    public /* synthetic */ void m22x4746ce08(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m21x62055var_(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public /* synthetic */ void m24xe027CLASSNAMEf(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m23xfae6529e(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public /* synthetic */ void m26xaaaa9ee1(int num, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m25xCLASSNAME(TLRPC.TL_error error, TLObject response, int num) {
        if (error == null) {
