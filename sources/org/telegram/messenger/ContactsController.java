...
public class ContactsController extends BaseController {
    ...
    public /* synthetic */ void m39lambda$new$0$orgtelegrammessengerContactsController() {
        try {
    ...
    public /* synthetic */ void m21lambda$cleanup$1$orgtelegrammessengerContactsController() {
    ...
    public /* synthetic */ void m20x699e1var_(TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m19x845cb097(TLRPC.TL_help_inviteText res) {
    ...
    public /* synthetic */ void m18lambda$checkContacts$4$orgtelegrammessengerContactsController() {
    ...
    public /* synthetic */ void m27xCLASSNAMEfbf() {
        if (BuildVars.LOGS_ENABLED) {
    ...
    public /* synthetic */ void m64xe9e28340(HashMap contacts2, boolean first, boolean schedule, boolean cancel) {
        if (BuildVars.LOGS_ENABLED) {
    ...
    public /* synthetic */ void m23x3b83ab48(Runnable runnable, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
            this.contactsBookSPhones.clear();
            this.contactsBook.clear();
            this.completedRequestsCount = 0;
    ...
    public /* synthetic */ void m22x56423CLASSNAME(Runnable runnable) {
        AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
        try {
            Account[] accounts = am.getAccountsByType("org.telegram.messenger");
            this.systemAccount = null;
    ...
    public /* synthetic */ void m61lambda$readContacts$10$orgtelegrammessengerContactsController() {
    ...
    private java.util.HashMap<java.lang.String, org.telegram.messenger.ContactsController.Contact> readContactsFromPhoneBook() {
        ...
        L_0x01b2:
            r26 = r0
            r0 = 2131627146(0x7f0e0c8a, float:1.8881548E38)
        ...
        L_0x01c0:
            ...
            r5 = 2131627144(0x7f0e0CLASSNAME, float:1.8881544E38)
        ...
        L_0x01d4:
            ...
            java.util.ArrayList<java.lang.String> r0 = r13.phoneTypes     // Catch:{ all -> 0x0382 }
            r1 = 2131627146(0x7f0e0c8a, float:1.8881548E38)
        ...
        L_0x01e4:
            ...
            r5 = 2131627154(0x7f0e0CLASSNAME, float:1.8881564E38)
            java.lang.String r1 = org.telegram.messenger.LocaleController.getString(r1, r5)     // Catch:{ all -> 0x0382 }
            r0.add(r1)     // Catch:{ all -> 0x0382 }
            goto L_0x0217
        L_0x01f6:
            ...
            r5 = 2131627145(0x7f0e0CLASSNAME, float:1.8881546E38)
            java.lang.String r1 = org.telegram.messenger.LocaleController.getString(r1, r5)     // Catch:{ all -> 0x0382 }
            r0.add(r1)     // Catch:{ all -> 0x0382 }
            goto L_0x0217
        L_0x0209:
            ...
            r5 = 2131627153(0x7f0e0CLASSNAME, float:1.8881562E38)
            java.lang.String r1 = org.telegram.messenger.LocaleController.getString(r1, r5)     // Catch:{ all -> 0x0382 }
            r0.add(r1)     // Catch:{ all -> 0x0382 }
        L_0x0217:
    ...
    public /* synthetic */ void m38x39var_a07(SparseArray contactHashMap) {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public /* synthetic */ void m52x3cf1c3d6(java.util.HashMap r35, boolean r36, boolean r37, boolean r38, boolean r39, boolean r40, boolean r41) {
        /*
            r34 = this;
            r13 = r34
            r14 = r35
        ...
        L_0x0733:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.ContactsController.m52x3cf1c3d6(java.util.HashMap, boolean, boolean, boolean, boolean, boolean, boolean):void");
    }

    /* renamed from: lambda$performSyncPhoneBook$12$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m40xavar_cf5(HashMap contactHashMap) {
    ...
    public /* synthetic */ void m41x94c3ebb6(int checkType, HashMap contactHashMap, boolean first, boolean schedule) {
    ...
    public /* synthetic */ void m43x5var_CLASSNAME(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
    ...
    public /* synthetic */ void m42x7a055a77(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m50x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
    ...
    public /* synthetic */ void m47xvar_CLASSNAMEc(HashMap contactsMapToSave, SparseArray contactIdToKey, boolean[] hasErrors, HashMap contactsMap, TLRPC.TL_contacts_importContacts req, int count, HashMap contactsBookShort, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m46xf0b157b(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal, boolean[] hasErrors) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m44x448837f9(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m50x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
        getNotificationCenter().postNotificationName(NotificationCenter.contactsImported, new Object[0]);
    }

    /* renamed from: lambda$performSyncPhoneBook$17$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m45x29c9a6ba() {
    ...
    public /* synthetic */ void m49x8d2d7793(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m48xa7eCLASSNAMEd2(HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        m50x726ee654(phoneBookSectionsDictFinal, phoneBookSectionsArrayFinal, phoneBookByShortPhonesFinal);
        updateUnregisteredContacts();
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
        getNotificationCenter().postNotificationName(NotificationCenter.contactsImported, new Object[0]);
    ...
    public /* synthetic */ void m51x57b05515(HashMap contactsBookShort, HashMap contactsMap, boolean first, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookByShortPhonesFinal) {
        this.contactsBookSPhones = contactsBookShort;
        this.contactsBook = contactsMap;
        this.contactsSyncInProgress = false;
        this.contactsBookLoaded = true;
    ...
    public /* synthetic */ void m29lambda$loadContacts$27$orgtelegrammessengerContactsController(long hash, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m28lambda$loadContacts$26$orgtelegrammessengerContactsController() {
        synchronized (this.loadContactsSync) {
            this.loadingContacts = false;
        }
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
    ...
    public /* synthetic */ void m60x3bbda006(ArrayList usersArr, int from, ArrayList contactsArr) {
    ...
    public /* synthetic */ void m59x567CLASSNAME(int from, ArrayList contactsArr, LongSparseArray usersDict, ArrayList usersArr, boolean isEmpty) {
    ...
    public /* synthetic */ void m54x5e12a568() {
    ...
    public /* synthetic */ void m55x43541429() {
        this.doneLoadingContacts = true;
        getNotificationCenter().postNotificationName(NotificationCenter.contactsDidLoad, new Object[0]);
    }
    ...
    public /* synthetic */ void m56xa6b7e502(ArrayList contactsArr, ConcurrentHashMap contactsDictionary, HashMap sectionsDict, HashMap sectionsDictMutual, ArrayList sortedSectionsArray, ArrayList sortedSectionsArrayMutual, int from, boolean isEmpty) {
    ...
    public /* synthetic */ void m58x713aCLASSNAME(HashMap contactsByPhonesDictFinal, HashMap contactsByPhonesShortDictFinal) {
    ...
    public /* synthetic */ void m57x8bvar_c3(HashMap contactsByPhonesDictFinal, HashMap contactsByPhonesShortDictFinal) {
    ...
    public void m50x726ee654(HashMap<String, ArrayList<Object>> phoneBookSectionsDictFinal, ArrayList<String> phoneBookSectionsArrayFinal, HashMap<String, Contact> phoneBookByShortPhonesFinal) {
    ...
    public /* synthetic */ void m37xcadb3f5a(ArrayList contactsCopy, HashMap phoneBookByShortPhonesFinal, HashMap phoneBookSectionsDictFinal, ArrayList phoneBookSectionsArrayFinal) {
    ...
    public /* synthetic */ void m36xe599d099(ArrayList phoneBookSectionsArrayFinal, HashMap phoneBookSectionsDictFinal) {
    ...
    public /* synthetic */ int m17x277ef5f(TLRPC.TL_contact tl_contact, TLRPC.TL_contact tl_contact2) {
    ...
    public void m53x8296d0df(ArrayList<TLRPC.TL_contact> contactsArray) {
        Cursor cursor = null;
        try {
            if (hasContactsPermission()) {
    ...
    public /* synthetic */ void m14x52aad668(Long uid) {
    ...
    public /* synthetic */ void m15x37eCLASSNAME() {
        loadContacts(false, 0);
    }

    /* renamed from: lambda$applyContactsUpdates$48$org-telegram-messenger-ContactsController  reason: not valid java name */
    public /* synthetic */ void m16x1d2db3ea(ArrayList newContacts, ArrayList contactsToDelete) {
    ...
    public /* synthetic */ void m13lambda$addContact$52$orgtelegrammessengerContactsController(TLRPC.User user, TLObject response, TLRPC.TL_error error) {
        int index;
        if (error == null) {
    ...
    public /* synthetic */ void m11lambda$addContact$50$orgtelegrammessengerContactsController(TLRPC.User u) {
    ...
    public /* synthetic */ void m12lambda$addContact$51$orgtelegrammessengerContactsController(TLRPC.Updates res) {
        for (int a = 0; a < res.users.size(); a++) {
            TLRPC.User u = res.users.get(a);
    ...
    public /* synthetic */ void m26x6de2e0d4(ArrayList uids, ArrayList users, boolean showBulletin, String userName, TLObject response, TLRPC.TL_error error) {
        int index;
        if (error == null) {
    ...
    public /* synthetic */ void m24xa3600352(ArrayList users) {
    ...
    public /* synthetic */ void m25x88a17213(ArrayList users, boolean showBulletin, String userName) {
    ...
    public /* synthetic */ void m63xfCLASSNAMEe105(SharedPreferences.Editor editor, TLObject response, TLRPC.TL_error error) {
        if (error == null) {
    ...
    public /* synthetic */ void m62x16d87244(SharedPreferences.Editor editor, TLObject response) {
    ...
    public /* synthetic */ void m31x4746ce08(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m30x62055var_(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public /* synthetic */ void m33xe027CLASSNAMEf(TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m32xfae6529e(TLRPC.TL_error error, TLObject response) {
        if (error == null) {
    ...
    public /* synthetic */ void m35xaaaa9ee1(int num, TLObject response, TLRPC.TL_error error) {
    ...
    public /* synthetic */ void m34xCLASSNAME(TLRPC.TL_error error, TLObject response, int num) {
        if (error == null) {
