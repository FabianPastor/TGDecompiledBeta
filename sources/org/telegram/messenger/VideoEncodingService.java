    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (this.path == null) {
            ...
            if (this.builder == null) {
                ...
                if (isGif) {
                    this.builder.setTicker(LocaleController.getString("SendingGif", C0500R.string.SendingGif));
                    this.builder.setContentText(LocaleController.getString("SendingGif", C0500R.string.SendingGif));
                } else {
                    this.builder.setTicker(LocaleController.getString("SendingVideo", C0500R.string.SendingVideo));
                    this.builder.setContentText(LocaleController.getString("SendingVideo", C0500R.string.SendingVideo));
                }
            }
