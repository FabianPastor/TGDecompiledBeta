...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda154 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda154(MessagesController messagesController, TLRPC$TL_messages_sponsoredMessages tLRPC$TL_messages_sponsoredMessages) {
        this.f$0 = messagesController;
        this.f$1 = tLRPC$TL_messages_sponsoredMessages;
    }

    public final void run() {
        this.f$0.lambda$getSponsoredMessages$311(this.f$1);
    }
}
