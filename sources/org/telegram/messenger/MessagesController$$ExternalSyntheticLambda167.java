...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda167 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda167(MessagesController messagesController, TLRPC$TL_messages_messageViews tLRPC$TL_messages_messageViews, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, LongSparseArray longSparseArray3) {
    ...
    public final void run() {
        this.f$0.lambda$updateTimerProc$120(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
