...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda252 implements RequestDelegate {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda252(MessagesController messagesController, TLRPC.TL_theme tL_theme, Theme.ThemeInfo themeInfo, TLRPC.TL_inputThemeSettings tL_inputThemeSettings, Theme.ThemeAccent themeAccent) {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m203xde2de137(this.f$1, this.f$2, this.f$3, this.f$4, tLObject, tL_error);
    }
}
