...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda122 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda122(MessagesController messagesController, MessagesStorage.LongCallback longCallback, Context context, AlertDialog alertDialog, TLRPC$TL_error tLRPC$TL_error, BaseFragment baseFragment, TLRPC$TL_messages_migrateChat tLRPC$TL_messages_migrateChat) {
    ...
    public final void run() {
        this.f$0.lambda$convertToMegaGroup$210(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
