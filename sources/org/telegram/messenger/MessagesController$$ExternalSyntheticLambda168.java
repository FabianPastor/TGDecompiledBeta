...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda168 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda168(MessagesController messagesController, TLRPC$TL_messages_sponsoredMessages tLRPC$TL_messages_sponsoredMessages) {
        this.f$0 = messagesController;
        this.f$1 = tLRPC$TL_messages_sponsoredMessages;
    }

    public final void run() {
        this.f$0.lambda$getSponsoredMessages$327(this.f$1);
    }
}
