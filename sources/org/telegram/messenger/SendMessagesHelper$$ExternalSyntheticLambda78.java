...
public final /* synthetic */ class SendMessagesHelper$$ExternalSyntheticLambda78 implements RequestDelegate {
    ...
    public /* synthetic */ SendMessagesHelper$$ExternalSyntheticLambda78(SendMessagesHelper sendMessagesHelper, long j, int i, boolean z, boolean z2, LongSparseArray longSparseArray, ArrayList arrayList, ArrayList arrayList2, MessageObject messageObject, TLRPC.Peer peer, TLRPC.TL_messages_forwardMessages tL_messages_forwardMessages) {
    ...
    public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
        this.f$0.m471lambda$sendMessage$14$orgtelegrammessengerSendMessagesHelper(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8, this.f$9, this.f$10, tLObject, tL_error);
    }
}
