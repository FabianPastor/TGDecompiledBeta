...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda164 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda164(MessagesController messagesController, TLRPC$TL_help_termsOfServiceUpdate tLRPC$TL_help_termsOfServiceUpdate) {
        this.f$0 = messagesController;
        this.f$1 = tLRPC$TL_help_termsOfServiceUpdate;
    }

    public final void run() {
        this.f$0.lambda$checkTosUpdate$127(this.f$1);
    }
}
