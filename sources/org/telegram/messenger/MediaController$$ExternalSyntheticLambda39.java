...
public final /* synthetic */ class MediaController$$ExternalSyntheticLambda39 implements Runnable {
    ...
    public /* synthetic */ MediaController$$ExternalSyntheticLambda39(int i, File file, String str, AlertDialog alertDialog, boolean[] zArr, String str2, Runnable runnable, boolean[] zArr2) {
        this.f$0 = i;
        this.f$1 = file;
        this.f$2 = str;
