...
public class NativeLoader {
    ...
    private static boolean loadFromZip(Context context, File destDir, File destLocalFile, String folder) {
        ...
        try {
            ...
            ZipEntry entry = zipFile.getEntry("lib/" + folder + "/" + "libtmessages.40.so");
            if (entry != null) {
            ...
            throw new Exception("Unable to find file in apk:lib/" + folder + "/" + "tmessages.40");
        } catch (Exception e5) {
    ...
    public static synchronized void initNativeLibs(android.content.Context r8) {
        ...
        L_0x00a9:
            ...
            java.lang.String r6 = "libtmessages.40loc.so"
