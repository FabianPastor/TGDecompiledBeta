...
public class NativeLoader {
    ...
    private static boolean loadFromZip(android.content.Context r5, java.io.File r6, java.io.File r7, java.lang.String r8) {
        ...
        L_0x0017:
            r6 = 0
            java.util.zip.ZipFile r2 = new java.util.zip.ZipFile     // Catch:{ Exception -> 0x00af, all -> 0x00ac }
            android.content.pm.ApplicationInfo r5 = r5.getApplicationInfo()     // Catch:{ Exception -> 0x00af, all -> 0x00ac }
            java.lang.String r5 = r5.sourceDir     // Catch:{ Exception -> 0x00af, all -> 0x00ac }
            ...
            java.util.zip.ZipEntry r5 = r2.getEntry(r5)     // Catch:{ Exception -> 0x00aa }
            if (r5 == 0) goto L_0x008a
            java.io.InputStream r6 = r2.getInputStream(r5)     // Catch:{ Exception -> 0x00aa }
            java.io.FileOutputStream r5 = new java.io.FileOutputStream     // Catch:{ Exception -> 0x00aa }
            r5.<init>(r7)     // Catch:{ Exception -> 0x00aa }
            r8 = 4096(0x1000, float:5.74E-42)
            byte[] r8 = new byte[r8]     // Catch:{ Exception -> 0x00aa }
        L_0x004f:
            int r0 = r6.read(r8)     // Catch:{ Exception -> 0x00aa }
        ...
        L_0x0073:
            r7 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r7)     // Catch:{ Exception -> 0x00aa }
        L_0x0077:
        ...
        L_0x0089:
            return r5
        L_0x008a:
            java.lang.Exception r5 = new java.lang.Exception     // Catch:{ Exception -> 0x00aa }
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00aa }
            ...
            r7.append(r8)     // Catch:{ Exception -> 0x00aa }
            java.lang.String r7 = r7.toString()     // Catch:{ Exception -> 0x00aa }
            r5.<init>(r7)     // Catch:{ Exception -> 0x00aa }
        ...
        L_0x00af:
            ...
            r2 = r6
        L_0x00b1:
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r5)     // Catch:{ all -> 0x00c9 }
    ...
    public static synchronized void initNativeLibs(android.content.Context r7) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = nativeLoaded     // Catch:{ all -> 0x0116 }
        ...
        L_0x0020:
            ...
            boolean r2 = r2.equalsIgnoreCase(r3)     // Catch:{ Exception -> 0x0095 }
        ...
        L_0x0078:
            java.lang.String r2 = "armeabi"
            boolean r3 = org.telegram.messenger.BuildVars.LOGS_ENABLED     // Catch:{ Exception -> 0x0095 }
            ...
            java.lang.String r4 = android.os.Build.CPU_ABI     // Catch:{ Exception -> 0x0095 }
            r3.append(r4)     // Catch:{ Exception -> 0x0095 }
            java.lang.String r3 = r3.toString()     // Catch:{ Exception -> 0x0095 }
            org.telegram.messenger.FileLog.e((java.lang.String) r3)     // Catch:{ Exception -> 0x0095 }
            goto L_0x009b
        L_0x0095:
            r2 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r2)     // Catch:{ all -> 0x001d }
        ...
        L_0x00ae:
            ...
            boolean r5 = org.telegram.messenger.BuildVars.LOGS_ENABLED     // Catch:{ Error -> 0x00dd }
            if (r5 == 0) goto L_0x00d2
            java.lang.String r5 = "Load local lib"
            org.telegram.messenger.FileLog.d(r5)     // Catch:{ Error -> 0x00dd }
        L_0x00d2:
            java.lang.String r5 = r4.getAbsolutePath()     // Catch:{ Error -> 0x00dd }
        ...
        L_0x0110:
            r7 = move-exception
            org.telegram.messenger.FileLog.e((java.lang.Throwable) r7)     // Catch:{ all -> 0x0116 }
        L_0x0114:
            monitor-exit(r0)
            return
        L_0x0116:
