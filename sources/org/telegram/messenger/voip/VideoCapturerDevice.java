...
public class VideoCapturerDevice {
    ...
    public /* synthetic */ void m492lambda$new$0$orgtelegrammessengervoipVideoCapturerDevice(boolean r3) {
        /*
            r2 = this;
        ...
        L_0x000d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.messenger.voip.VideoCapturerDevice.m492lambda$new$0$orgtelegrammessengervoipVideoCapturerDevice(boolean):void");
    }
    ...
    public /* synthetic */ void m491lambda$init$5$orgtelegrammessengervoipVideoCapturerDevice(long ptr, String deviceName) {
        if (eglBase != null) {
            this.nativePtr = ptr;
    ...
    public /* synthetic */ void m488lambda$init$2$orgtelegrammessengervoipVideoCapturerDevice(Point size) {
    ...
    public /* synthetic */ void m489lambda$init$3$orgtelegrammessengervoipVideoCapturerDevice() {
        if (this.videoCapturerSurfaceTextureHelper != null) {
    ...
    public /* synthetic */ void m490lambda$init$4$orgtelegrammessengervoipVideoCapturerDevice(String cameraName) {
    ...
    public /* synthetic */ void m496x7b06e05b(long ptr, int state) {
    ...
    public /* synthetic */ void m495x7b7d465a(int state) {
    ...
    public /* synthetic */ void m494x8c9ffc3c() {
        int a = 0;
        while (true) {
            VideoCapturerDevice[] videoCapturerDeviceArr = instance;
    ...
    public /* synthetic */ void m493x8d16623b() {
