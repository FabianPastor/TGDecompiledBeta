...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0d0a26 float:1.8747384E38 double:1.053131061E-314;
        ...
        r3[r2] = r4;
        r2 = NUM; // 0x7f0d0a28 float:1.8747388E38 double:1.053131062E-314;
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0d0a33 float:1.874741E38 double:1.0531310675E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0d04c5 float:1.8744591E38 double:1.053130381E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0d0a2c float:1.8747396E38 double:1.053131064E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r10 = NUM; // 0x7f0d0a24 float:1.874738E38 double:1.05313106E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x026c:
        ...
        r7 = NUM; // 0x7f0d0a34 float:1.8747413E38 double:1.053131068E-314;
        ...
        goto L_0x02ce;
    L_0x0290:
        r1 = NUM; // 0x7f0d0a33 float:1.874741E38 double:1.0531310675E-314;
    ...
    L_0x02a2:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0d0a25 float:1.8747382E38 double:1.0531310606E-314;
    ...
    L_0x02ce:
        ...
        r3 = NUM; // 0x7f0d0a24 float:1.874738E38 double:1.05313106E-314;
        r7 = "VoipAnswerCall";
