...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0e0bc3 float:1.8881145E38 double:1.0531636443E-314;
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0e0bd0 float:1.888117E38 double:1.0531636507E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0e0574 float:1.8877869E38 double:1.0531628463E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0e0bc9 float:1.8881157E38 double:1.053163647E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r10 = NUM; // 0x7f0e0bc1 float:1.888114E38 double:1.0531636433E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x026b:
        ...
        r7 = NUM; // 0x7f0e0bd1 float:1.8881173E38 double:1.053163651E-314;
        ...
        goto L_0x02cd;
    L_0x028f:
        r1 = NUM; // 0x7f0e0bd0 float:1.888117E38 double:1.0531636507E-314;
    ...
    L_0x02a1:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0e0bc2 float:1.8881143E38 double:1.053163644E-314;
    ...
    L_0x02cd:
        ...
        r3 = NUM; // 0x7f0e0bc1 float:1.888114E38 double:1.0531636433E-314;
        r7 = "VoipAnswerCall";
