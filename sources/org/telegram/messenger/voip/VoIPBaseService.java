...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r5 = 0;
        r3[r5] = r4;
        r4 = NUM; // 0x7f0d0a1c float:1.8747364E38 double:1.053131056E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = NUM; // 0x7f0d0a1d float:1.8747366E38 double:1.0531310567E-314;
    ...
    L_0x0085:
        ...
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = NUM; // 0x7f0CLASSNAMEa float:1.8609212E38 double:1.0530974034E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0d0a28 float:1.8747388E38 double:1.053131062E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0d04c0 float:1.8744581E38 double:1.0531303783E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0d0a21 float:1.8747374E38 double:1.0531310587E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r14 = NUM; // 0x7var_ float:1.7945115E38 double:1.052935634E-314;
        ...
        r10 = NUM; // 0x7f0d0a19 float:1.8747358E38 double:1.0531310547E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x01d6:
        ...
        r12 = NUM; // 0x7var_ float:1.7945113E38 double:1.0529356335E-314;
    ...
    L_0x026c:
        ...
        r7 = NUM; // 0x7f0d0a29 float:1.874739E38 double:1.0531310626E-314;
    ...
    L_0x02a2:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0d0a1a float:1.874736E38 double:1.053131055E-314;
    ...
    L_0x02ce:
        ...
        r3 = NUM; // 0x7f0d0a19 float:1.8747358E38 double:1.0531310547E-314;
        r7 = "VoipAnswerCall";
