...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0e0bf3 float:1.8881242E38 double:1.053163668E-314;
        r5 = "VoipAudioRoutingBluetooth";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = 0;
        r3[r5] = r4;
        r4 = NUM; // 0x7f0e0bf4 float:1.8881244E38 double:1.0531636685E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = NUM; // 0x7f0e0bf5 float:1.8881246E38 double:1.053163669E-314;
    ...
    L_0x0085:
        ...
        r5 = NUM; // 0x7f0d000e float:1.8742143E38 double:1.0531297845E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spConnectingId = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = NUM; // 0x7f0d0011 float:1.874215E38 double:1.053129786E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spRingbackID = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = NUM; // 0x7f0d0010 float:1.8742147E38 double:1.0531297854E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spFailedID = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = NUM; // 0x7f0d000f float:1.8742145E38 double:1.053129785E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
        r6.spEndId = r1;	 Catch:{ Exception -> 0x0105 }
        r1 = r6.soundPool;	 Catch:{ Exception -> 0x0105 }
        r5 = NUM; // 0x7f0d000d float:1.8742141E38 double:1.053129784E-314;
        r1 = r1.load(r6, r5, r4);	 Catch:{ Exception -> 0x0105 }
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0e0CLASSNAME float:1.8881268E38 double:1.0531636744E-314;
        ...
        r8 = NUM; // 0x7var_c float:1.7945673E38 double:1.05293577E-314;
        r5 = r5.setSmallIcon(r8);
        r5 = r5.setSubText(r2);
        r8 = 0;
        r9 = android.app.PendingIntent.getActivity(r0, r8, r4, r8);
        r5 = r5.setContentIntent(r9);
        r9 = "content://org.telegram.messenger.beta.call_sound_provider/start_ringing";
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0e057f float:1.8877891E38 double:1.053162852E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0e0bf9 float:1.8881254E38 double:1.053163671E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r14 = NUM; // 0x7var_ float:1.7945113E38 double:1.0529356335E-314;
        ...
        r10 = NUM; // 0x7f0e0bf1 float:1.8881238E38 double:1.053163667E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x01d6:
        ...
        r12 = NUM; // 0x7var_ float:1.7945111E38 double:1.052935633E-314;
    ...
    L_0x0244:
        r13 = NUM; // 0x7f0b0001 float:1.8476271E38 double:1.05306502E-314;
        goto L_0x024a;
    L_0x0248:
        r13 = NUM; // 0x7f0b0000 float:1.847627E38 double:1.0530650194E-314;
    L_0x024a:
        r10.<init>(r12, r13);
        r12 = NUM; // 0x7var_ float:1.8077762E38 double:1.052967946E-314;
        r10.setTextViewText(r12, r1);
        r1 = android.text.TextUtils.isEmpty(r18);
        r12 = NUM; // 0x7var_bb float:1.807788E38 double:1.0529679745E-314;
        r13 = NUM; // 0x7var_ab float:1.8077848E38 double:1.0529679666E-314;
    ...
    L_0x026b:
        ...
        r7 = NUM; // 0x7f0e0CLASSNAME float:1.888127E38 double:1.053163675E-314;
        ...
        goto L_0x02cd;
    L_0x028f:
        r1 = NUM; // 0x7f0e0CLASSNAME float:1.8881268E38 double:1.0531636744E-314;
    ...
    L_0x02a1:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0e0bf2 float:1.888124E38 double:1.0531636675E-314;
    ...
    L_0x02cd:
        ...
        r3 = NUM; // 0x7f0e0bf1 float:1.8881238E38 double:1.053163667E-314;
        r7 = "VoipAnswerCall";
        ...
        r10.setTextViewText(r2, r3);
        r2 = NUM; // 0x7var_ float:1.8077803E38 double:1.0529679557E-314;
