...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0d0ae0 float:1.8747761E38 double:1.053131153E-314;
        r5 = "VoipAudioRoutingBluetooth";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = 0;
        r3[r5] = r4;
        r4 = NUM; // 0x7f0d0ae1 float:1.8747763E38 double:1.0531311535E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = NUM; // 0x7f0d0ae2 float:1.8747765E38 double:1.053131154E-314;
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0d0aed float:1.8747788E38 double:1.0531311594E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0d0520 float:1.8744776E38 double:1.053130426E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0d0ae6 float:1.8747774E38 double:1.053131156E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r10 = NUM; // 0x7f0d0ade float:1.8747757E38 double:1.053131152E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x026b:
        ...
        r7 = NUM; // 0x7f0d0aee float:1.874779E38 double:1.05313116E-314;
        ...
        goto L_0x02cd;
    L_0x028f:
        r1 = NUM; // 0x7f0d0aed float:1.8747788E38 double:1.0531311594E-314;
    ...
    L_0x02a1:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0d0adf float:1.874776E38 double:1.0531311525E-314;
    ...
    L_0x02cd:
        ...
        r3 = NUM; // 0x7f0d0ade float:1.8747757E38 double:1.053131152E-314;
        r7 = "VoipAnswerCall";
