...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0e0bda float:1.8881191E38 double:1.0531636556E-314;
        r5 = "VoipAudioRoutingBluetooth";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = 0;
        r3[r5] = r4;
        r4 = NUM; // 0x7f0e0bdb float:1.8881193E38 double:1.053163656E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = NUM; // 0x7f0e0bdc float:1.8881195E38 double:1.0531636566E-314;
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0e0be7 float:1.8881218E38 double:1.053163662E-314;
        ...
        r8 = NUM; // 0x7var_d float:1.7945675E38 double:1.0529357703E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0e0578 float:1.8877877E38 double:1.0531628483E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0e0be0 float:1.8881203E38 double:1.0531636586E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r14 = NUM; // 0x7var_ float:1.7945111E38 double:1.052935633E-314;
        ...
        r10 = NUM; // 0x7f0e0bd8 float:1.8881187E38 double:1.0531636546E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x01d6:
        ...
        r12 = NUM; // 0x7var_ float:1.794511E38 double:1.0529356325E-314;
    ...
    L_0x026b:
        ...
        r7 = NUM; // 0x7f0e0be8 float:1.888122E38 double:1.0531636625E-314;
        ...
        goto L_0x02cd;
    L_0x028f:
        r1 = NUM; // 0x7f0e0be7 float:1.8881218E38 double:1.053163662E-314;
    ...
    L_0x02a1:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0e0bd9 float:1.888119E38 double:1.053163655E-314;
    ...
    L_0x02cd:
        ...
        r3 = NUM; // 0x7f0e0bd8 float:1.8881187E38 double:1.0531636546E-314;
        r7 = "VoipAnswerCall";
