...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener, NotificationCenterDelegate {
    ...
    L_0x000e:
        ...
        r4 = NUM; // 0x7f0d0ab6 float:1.8747676E38 double:1.0531311323E-314;
        r5 = "VoipAudioRoutingBluetooth";
        r4 = org.telegram.messenger.LocaleController.getString(r5, r4);
        r5 = 0;
        r3[r5] = r4;
        r4 = NUM; // 0x7f0d0ab7 float:1.8747678E38 double:1.053131133E-314;
        r6 = "VoipAudioRoutingEarpiece";
        r4 = org.telegram.messenger.LocaleController.getString(r6, r4);
        r3[r2] = r4;
        r2 = NUM; // 0x7f0d0ab8 float:1.874768E38 double:1.0531311333E-314;
    ...
    public void showIncomingNotification(java.lang.String r17, java.lang.CharSequence r18, org.telegram.tgnet.TLObject r19, java.util.List<org.telegram.tgnet.TLRPC.User> r20, int r21, java.lang.Class<? extends android.app.Activity> r22) {
        ...
        r5.<init>(r0);
        r6 = NUM; // 0x7f0d0ac3 float:1.8747703E38 double:1.0531311387E-314;
        ...
        r8 = NUM; // 0x7var_c0 float:1.7945487E38 double:1.0529357244E-314;
    ...
    L_0x00dc:
        ...
        r11.append(r15);
        r11 = r11.toString();
        r12 = NUM; // 0x7f0d0517 float:1.8744758E38 double:1.0531304213E-314;
        r14 = "IncomingCalls";
    ...
    L_0x0130:
        ...
        r10 = "call_id";
        r6.putExtra(r10, r8);
        r8 = NUM; // 0x7f0d0abc float:1.8747688E38 double:1.053131135E-314;
        r9 = "VoipDeclineCall";
    ...
    L_0x017f:
        ...
        r10 = NUM; // 0x7f0d0ab4 float:1.8747672E38 double:1.0531311313E-314;
        r14 = "VoipAnswerCall";
    ...
    L_0x026b:
        ...
        r7 = NUM; // 0x7f0d0ac4 float:1.8747705E38 double:1.053131139E-314;
        ...
        goto L_0x02cd;
    L_0x028f:
        r1 = NUM; // 0x7f0d0ac3 float:1.8747703E38 double:1.0531311387E-314;
    ...
    L_0x02a1:
        ...
        r1 = org.telegram.messenger.UserConfig.getInstance(r1);
        r1 = r1.getCurrentUser();
        r14 = NUM; // 0x7f0d0ab5 float:1.8747674E38 double:1.053131132E-314;
    ...
    L_0x02cd:
        ...
        r3 = NUM; // 0x7f0d0ab4 float:1.8747672E38 double:1.0531311313E-314;
        r7 = "VoipAnswerCall";
