...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda27 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda27(MessagesController messagesController, MessagesStorage.LongCallback longCallback, Context context, AlertDialog alertDialog, TLRPC.TL_error tL_error, BaseFragment baseFragment, TLRPC.TL_messages_migrateChat tL_messages_migrateChat) {
    ...
    public final void run() {
        this.f$0.m162x874var_c(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
