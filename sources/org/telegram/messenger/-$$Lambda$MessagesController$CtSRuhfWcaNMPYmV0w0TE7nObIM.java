...
public final /* synthetic */ class -$$Lambda$MessagesController$CtSRuhfWcaNMPYmV0w0TE7nObIM implements Runnable {
    ...
    public final void run() {
        this.f$0.lambda$processUpdateArray$271$MessagesController(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7);
    }
}
