...
public class LocaleController {
    ...
    L_0x0073:
        nameDisplayOrder = r3;
        r3 = NUM; // 0x7f0d0b68 float:1.8748037E38 double:1.05313122E-314;
        r5 = "formatterMonth";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd MMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterDayMonth = r3;
        r3 = NUM; // 0x7f0d0b6e float:1.874805E38 double:1.053131223E-314;
        r5 = "formatterYear";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYear = r3;
        r3 = NUM; // 0x7f0d0b6f float:1.8748051E38 double:1.0531312237E-314;
        r5 = "formatterYearMax";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYearMax = r3;
        r3 = NUM; // 0x7f0d0b49 float:1.8747974E38 double:1.053131205E-314;
        r5 = "chatDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatDate = r3;
        r3 = NUM; // 0x7f0d0b4a float:1.8747976E38 double:1.0531312054E-314;
        r5 = "chatFullDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatFullDate = r3;
        r3 = NUM; // 0x7f0d0b6d float:1.8748047E38 double:1.0531312227E-314;
        r5 = "formatterWeek";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "EEE";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterWeek = r3;
        r3 = NUM; // 0x7f0d0b61 float:1.8748023E38 double:1.053131217E-314;
    ...
    L_0x0109:
        r2 = NUM; // 0x7f0d0b67 float:1.8748035E38 double:1.0531312197E-314;
        r3 = "formatterDay24H";
        goto L_0x0114;
    L_0x010f:
        r2 = NUM; // 0x7f0d0b66 float:1.8748033E38 double:1.053131219E-314;
        r3 = "formatterDay12H";
    L_0x0114:
    ...
    L_0x012b:
        r1 = NUM; // 0x7f0d0b6c float:1.8748045E38 double:1.053131222E-314;
        r2 = "formatterStats24H";
        goto L_0x0136;
    L_0x0131:
        r1 = NUM; // 0x7f0d0b6b float:1.8748043E38 double:1.0531312217E-314;
    ...
    L_0x014f:
        r1 = NUM; // 0x7f0d0b63 float:1.8748027E38 double:1.0531312177E-314;
    ...
    L_0x016e:
        r1 = NUM; // 0x7f0d0b65 float:1.8748031E38 double:1.0531312187E-314;
        r2 = "formatterBannedUntilThisYear24H";
        goto L_0x0179;
    L_0x0174:
        r1 = NUM; // 0x7f0d0b64 float:1.874803E38 double:1.053131218E-314;
