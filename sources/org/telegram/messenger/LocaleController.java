...
public class LocaleController {
    ...
    private class TimeZoneChangedReceiver extends BroadcastReceiver {
        ...
        public /* synthetic */ void m721xb3806a48() {
    ...
    public LocaleController() {
        ...
        AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda6(this));
    }

    /* renamed from: lambda$new$0$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m82lambda$new$0$orgtelegrammessengerLocaleController() {
    ...
    public /* synthetic */ void m83lambda$new$1$orgtelegrammessengerLocaleController() {
    ...
    public void applyLanguage(LocaleInfo localeInfo, boolean override, boolean init, boolean fromFile, boolean force, int currentAccount) {
        ...
        if (localeInfo2 != null) {
            ...
            if ((localeInfo.isRemote() || localeInfo.isUnofficial()) && (z || !pathToFile.exists() || (hasBase && !pathToBaseFile.exists()))) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.d("reload locale because one of file doesn't exist" + pathToFile + " " + pathToBaseFile);
                }
                if (init) {
                    AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda9(this, localeInfo2, i));
                } else {
            ...
            try {
                ...
                if (this.reloadLastFile) {
                    if (init) {
                        AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda8(this, i, z));
                    } else {
    ...
    public /* synthetic */ void m70lambda$applyLanguage$2$orgtelegrammessengerLocaleController(LocaleInfo localeInfo, int currentAccount) {
    ...
    public /* synthetic */ void m71lambda$applyLanguage$3$orgtelegrammessengerLocaleController(int currentAccount, boolean force) {
    ...
    public static String formatPluralString(String key, int plural) {
        ...
        String param = key + "_" + getInstance().stringForQuantity(getInstance().currentPluralRules.quantityForNumber(plural));
        return formatString(param, key + "_other", ApplicationLoader.applicationContext.getResources().getIdentifier(param, "string", ApplicationLoader.applicationContext.getPackageName()), Integer.valueOf(plural));
    }
    ...
    public void recreateFormatters() {
        ...
        L_0x0076:
            nameDisplayOrder = r7
            r7 = 2131628807(0x7f0e1307, float:1.8884917E38)
            ...
            r7 = 2131628813(0x7f0e130d, float:1.888493E38)
            java.lang.String r8 = "formatterYear"
            java.lang.String r7 = r9.getStringInternal(r8, r7)
            java.lang.String r8 = "dd.MM.yy"
            org.telegram.messenger.time.FastDateFormat r7 = r9.createFormatter(r0, r7, r8)
            r9.formatterYear = r7
            r7 = 2131628814(0x7f0e130e, float:1.8884931E38)
        ...
        L_0x0157:
            ...
            r2 = 2131628810(0x7f0e130a, float:1.8884923E38)
        ...
        L_0x01bc:
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 4
            r4 = 2131627449(0x7f0e0db9, float:1.8882163E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 13
            r4 = 2131627935(0x7f0e0f9f, float:1.8883148E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 14
            r4 = 2131627936(0x7f0e0fa0, float:1.888315E38)
    ...
    public void saveRemoteLocaleStringsForCurrentLocale(TLRPC.TL_langPackDifference difference, int currentAccount) {
        if (this.currentLocaleInfo != null) {
            ...
            if (langCode.equals(this.currentLocaleInfo.shortName) || langCode.equals(this.currentLocaleInfo.baseLangCode)) {
                m79x1var_b3(this.currentLocaleInfo, difference, currentAccount);
            }
        }
    }

    /* renamed from: saveRemoteLocaleStrings */
    public void m79x1var_b3(LocaleInfo localeInfo, TLRPC.TL_langPackDifference difference, int currentAccount) {
        int type;
        File finalFile;
        ...
        if (tL_langPackDifference != null && !tL_langPackDifference.strings.isEmpty() && localeInfo2 != null && !localeInfo.isLocal()) {
            ...
            if (type != -1) {
                ...
                try {
                    ...
                    AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda7(this, type, localeInfo, difference, valuesToSet));
                } catch (Exception e) {
                }
            }
        }
    ...
    /* renamed from: lambda$saveRemoteLocaleStrings$4$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m84x7dCLASSNAME(int type, LocaleInfo localeInfo, TLRPC.TL_langPackDifference difference, HashMap valuesToSet) {
        String[] args;
        Locale newLocale;
        if (type == 0) {
    ...
    public void loadRemoteLanguages(int currentAccount) {
        if (!this.loadingRemoteLanguages) {
            ...
            ConnectionsManager.getInstance(currentAccount).sendRequest(new TLRPC.TL_langpack_getLanguages(), new LocaleController$$ExternalSyntheticLambda1(this, currentAccount), 8);
        }
    }

    /* renamed from: lambda$loadRemoteLanguages$6$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m81x35812ed3(int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda14(this, response, currentAccount));
        }
    }

    /* renamed from: lambda$loadRemoteLanguages$5$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m80xa8e103d2(TLObject response, int currentAccount) {
    ...
    /* renamed from: lambda$applyRemoteLanguage$8$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m78x926058b2(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda12(this, localeInfo, response, currentAccount));
        }
    }

    /* renamed from: lambda$applyRemoteLanguage$10$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m72xfe8var_e3(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda13(this, localeInfo, response, currentAccount));
        }
    }

    /* renamed from: lambda$applyRemoteLanguage$12$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m74x17cfa6e5(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda10(this, localeInfo, response, currentAccount));
        }
    }

    /* renamed from: lambda$applyRemoteLanguage$14$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m76x310ffce7(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
