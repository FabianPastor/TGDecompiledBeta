...
public class LocaleController {
    ...
    private class TimeZoneChangedReceiver extends BroadcastReceiver {
        ...
        public /* synthetic */ void m646xb3806a48() {
    ...
    public void recreateFormatters() {
        ...
        L_0x0076:
            nameDisplayOrder = r7
            r7 = 2131629125(0x7f0e1445, float:1.8885562E38)
            ...
            r7 = 2131629115(0x7f0e143b, float:1.8885542E38)
        ...
        L_0x0157:
            ...
            r2 = 2131629128(0x7f0e1448, float:1.8885568E38)
            java.lang.String r4 = "formatterStats24H"
            goto L_0x016c
        L_0x0167:
            r2 = 2131629127(0x7f0e1447, float:1.8885566E38)
        ...
        L_0x017b:
            ...
            goto L_0x0190
        L_0x018b:
            r2 = 2131629117(0x7f0e143d, float:1.8885546E38)
        ...
        L_0x01bc:
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 3
            r4 = 2131627693(0x7f0e0ead, float:1.8882658E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 5
            r4 = 2131627692(0x7f0e0eac, float:1.8882656E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 8
            r4 = 2131628201(0x7f0e10a9, float:1.8883688E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 9
            r4 = 2131628206(0x7f0e10ae, float:1.8883698E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 10
            r4 = 2131628204(0x7f0e10ac, float:1.8883694E38)
            ...
            org.telegram.messenger.time.FastDateFormat[] r2 = r9.formatterScheduleSend
            r3 = 14
            r4 = 2131628217(0x7f0e10b9, float:1.888372E38)
    ...
    public void saveRemoteLocaleStringsForCurrentLocale(TLRPC.TL_langPackDifference difference, int currentAccount) {
        if (this.currentLocaleInfo != null) {
            ...
            if (langCode.equals(this.currentLocaleInfo.shortName) || langCode.equals(this.currentLocaleInfo.baseLangCode)) {
                m78x926058b2(this.currentLocaleInfo, difference, currentAccount);
            }
        }
    }

    /* renamed from: saveRemoteLocaleStrings */
    public void m78x926058b2(LocaleInfo localeInfo, TLRPC.TL_langPackDifference difference, int currentAccount) {
        int type;
        File finalFile;
    ...
    public /* synthetic */ void m84xa697d88(int type, LocaleInfo localeInfo, TLRPC.TL_langPackDifference difference, HashMap valuesToSet) {
        String[] args;
        Locale newLocale;
        if (type == 0) {
    ...
    public void loadRemoteLanguages(int currentAccount) {
        if (!this.loadingRemoteLanguages) {
            ...
            ConnectionsManager.getInstance(currentAccount).sendRequest(new TLRPC.TL_langpack_getLanguages(), new LocaleController$$ExternalSyntheticLambda2(this, currentAccount), 8);
        }
    }

    /* renamed from: lambda$loadRemoteLanguages$7$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m81xCLASSNAMEd4(int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
            AndroidUtilities.runOnUIThread(new LocaleController$$ExternalSyntheticLambda15(this, response, currentAccount));
        }
    }

    /* renamed from: lambda$loadRemoteLanguages$6$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m80x35812ed3(TLObject response, int currentAccount) {
        ...
        if (localeInfo.isRemote() || localeInfo.isUnofficial()) {
            if (localeInfo.hasBaseLang() && (langCode == null || langCode.equals(localeInfo.baseLangCode))) {
                if (localeInfo.baseVersion == 0 || force) {
                    ...
                    ConnectionsManager.getInstance(currentAccount).sendRequest(req, new LocaleController$$ExternalSyntheticLambda3(this, localeInfo, currentAccount), 8);
                    ...
                    req2.lang_pack = "";
                    ConnectionsManager.getInstance(currentAccount).sendRequest(req2, new LocaleController$$ExternalSyntheticLambda6(this, localeInfo, currentAccount), 8);
                }
            }
            ...
            if (localeInfo.version == 0 || force) {
                ...
                ConnectionsManager.getInstance(currentAccount).sendRequest(req3, new LocaleController$$ExternalSyntheticLambda5(this, localeInfo, currentAccount), 8);
                return;
            }
            ...
            req4.lang_pack = "";
            ConnectionsManager.getInstance(currentAccount).sendRequest(req4, new LocaleController$$ExternalSyntheticLambda4(this, localeInfo, currentAccount), 8);
        }
    }

    /* renamed from: lambda$applyRemoteLanguage$9$org-telegram-messenger-LocaleController  reason: not valid java name */
    public /* synthetic */ void m79x1var_b3(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m73x8b2f7be4(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m75xa46fd1e6(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
    ...
    public /* synthetic */ void m77xbdb027e8(LocaleInfo localeInfo, int currentAccount, TLObject response, TLRPC.TL_error error) {
        if (response != null) {
