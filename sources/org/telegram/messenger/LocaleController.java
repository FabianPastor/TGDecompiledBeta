...
public class LocaleController {
    ...
    L_0x0076:
        nameDisplayOrder = r7;
        r7 = NUM; // 0x7f0e0ce2 float:1.8881727E38 double:1.053163786E-314;
        r8 = "formatterMonth";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "dd MMM";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.formatterDayMonth = r7;
        r7 = NUM; // 0x7f0e0ce8 float:1.8881739E38 double:1.053163789E-314;
        r8 = "formatterYear";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "dd.MM.yy";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.formatterYear = r7;
        r7 = NUM; // 0x7f0e0ce9 float:1.888174E38 double:1.0531637895E-314;
        r8 = "formatterYearMax";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "dd.MM.yyyy";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.formatterYearMax = r7;
        r7 = NUM; // 0x7f0e0cc2 float:1.8881662E38 double:1.0531637702E-314;
        r8 = "chatDate";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "d MMMM";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.chatDate = r7;
        r7 = NUM; // 0x7f0e0cc3 float:1.8881664E38 double:1.0531637707E-314;
        r8 = "chatFullDate";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "d MMMM yyyy";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.chatFullDate = r7;
        r7 = NUM; // 0x7f0e0ce7 float:1.8881737E38 double:1.0531637885E-314;
        r8 = "formatterWeek";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "EEE";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.formatterWeek = r7;
        r7 = NUM; // 0x7f0e0cda float:1.888171E38 double:1.053163782E-314;
        r8 = "formatDateSchedule";
        r7 = r9.getStringInternal(r8, r7);
        r8 = "MMM d";
        r7 = r9.createFormatter(r0, r7, r8);
        r9.formatterScheduleDay = r7;
        r7 = NUM; // 0x7f0e0cdb float:1.8881712E38 double:1.0531637826E-314;
    ...
    L_0x011d:
        r2 = NUM; // 0x7f0e0ce1 float:1.8881725E38 double:1.0531637856E-314;
        r4 = "formatterDay24H";
        goto L_0x0128;
    L_0x0123:
        r2 = NUM; // 0x7f0e0ce0 float:1.8881723E38 double:1.053163785E-314;
        r4 = "formatterDay12H";
    L_0x0128:
    ...
    L_0x013f:
        r1 = NUM; // 0x7f0e0ce6 float:1.8881735E38 double:1.053163788E-314;
        r2 = "formatterStats24H";
        goto L_0x014a;
    L_0x0145:
        r1 = NUM; // 0x7f0e0ce5 float:1.8881733E38 double:1.0531637875E-314;
    ...
    L_0x0163:
        r1 = NUM; // 0x7f0e0cdd float:1.8881717E38 double:1.0531637836E-314;
        r2 = "formatterBannedUntil24H";
        goto L_0x016e;
    L_0x0169:
        r1 = NUM; // 0x7f0e0cdc float:1.8881715E38 double:1.053163783E-314;
    ...
    L_0x0182:
        r1 = NUM; // 0x7f0e0cdf float:1.888172E38 double:1.0531637846E-314;
        r2 = "formatterBannedUntilThisYear24H";
        goto L_0x018d;
    L_0x0188:
        r1 = NUM; // 0x7f0e0cde float:1.8881719E38 double:1.053163784E-314;
    ...
    L_0x019a:
        ...
        r2 = NUM; // 0x7f0e09fd float:1.8880224E38 double:1.05316342E-314;
        r4 = "SendTodayAt";
        r2 = r9.getStringInternal(r4, r2);
        ...
        r1[r3] = r2;
        r1 = r9.formatterScheduleSend;
        r2 = NUM; // 0x7f0e09e7 float:1.888018E38 double:1.053163409E-314;
        r3 = "SendDayAt";
        ...
        r1 = r9.formatterScheduleSend;
        r2 = 3;
        r3 = NUM; // 0x7f0e094c float:1.8879865E38 double:1.0531633325E-314;
        r4 = "RemindTodayAt";
        ...
        r1 = r9.formatterScheduleSend;
        r2 = 4;
        r3 = NUM; // 0x7f0e094a float:1.887986E38 double:1.0531633315E-314;
        r4 = "RemindDayAt";
        r3 = r9.getStringInternal(r4, r3);
        ...
        r1 = r9.formatterScheduleSend;
        r2 = 5;
        r3 = NUM; // 0x7f0e094b float:1.8879863E38 double:1.053163332E-314;
        r4 = "RemindDayYearAt";
        r3 = r9.getStringInternal(r4, r3);
    ...
    public static String formatDistance(float f) {
            ...
            if (i == 0) {
                try {
                    ...
                    if (telephonyManager != null) {
                        boolean z;
                        String toUpperCase = telephonyManager.getSimCountryIso().toUpperCase();
                        if (!("US".equals(toUpperCase) || "GB".equals(toUpperCase) || "MM".equals(toUpperCase))) {
                            if (!"LR".equals(toUpperCase)) {
                                z = false;
                    ...
                    useImperialSystemType = Boolean.valueOf(false);
                    FileLog.e(e);
                }
            } else {
        ...
        if (useImperialSystemType.booleanValue()) {
            ...
            if (f < 1000.0f) {
                objArr = new Object[1];
                objArr[0] = String.format(str2, new Object[]{Integer.valueOf((int) Math.max(1.0f, f))});
                return formatString("FootsAway", NUM, objArr);
            }
            if (f % 5280.0f == 0.0f) {
                format = String.format(str2, new Object[]{Integer.valueOf((int) (f / 5280.0f))});
            } else {
                format = String.format(str, new Object[]{Float.valueOf(f / 5280.0f)});
            }
            return formatString("MilesAway", NUM, format);
        } else if (f < 1000.0f) {
            objArr = new Object[1];
            objArr[0] = String.format(str2, new Object[]{Integer.valueOf((int) Math.max(1.0f, f))});
            return formatString("MetersAway2", NUM, objArr);
        } else {
            if (f % 1000.0f == 0.0f) {
                format = String.format(str2, new Object[]{Integer.valueOf((int) (f / 1000.0f))});
            } else {
                format = String.format(str, new Object[]{Float.valueOf(f / 1000.0f)});
            }
            return formatString("KMetersAway2", NUM, format);
        }
    }
}
