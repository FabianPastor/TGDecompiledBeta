...
public class LocaleController {
    ...
    L_0x0073:
        nameDisplayOrder = r3;
        r3 = NUM; // 0x7f0d0b3b float:1.8747946E38 double:1.053131198E-314;
        r5 = "formatterMonth";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd MMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterDayMonth = r3;
        r3 = NUM; // 0x7f0d0b41 float:1.8747958E38 double:1.053131201E-314;
        r5 = "formatterYear";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYear = r3;
        r3 = NUM; // 0x7f0d0b42 float:1.874796E38 double:1.0531312014E-314;
        r5 = "formatterYearMax";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "dd.MM.yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.formatterYearMax = r3;
        r3 = NUM; // 0x7f0d0b1c float:1.8747883E38 double:1.0531311827E-314;
        r5 = "chatDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatDate = r3;
        r3 = NUM; // 0x7f0d0b1d float:1.8747885E38 double:1.053131183E-314;
        r5 = "chatFullDate";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "d MMMM yyyy";
        r3 = r7.createFormatter(r0, r3, r5);
        r7.chatFullDate = r3;
        r3 = NUM; // 0x7f0d0b40 float:1.8747956E38 double:1.0531312005E-314;
        r5 = "formatterWeek";
        r3 = r7.getStringInternal(r5, r3);
        r5 = "EEE";
        r3 = r7.createFormatter(r0, r3, r5);
    ...
    L_0x0109:
        r2 = NUM; // 0x7f0d0b3a float:1.8747944E38 double:1.0531311975E-314;
        r3 = "formatterDay24H";
        goto L_0x0114;
    L_0x010f:
        r2 = NUM; // 0x7f0d0b39 float:1.8747942E38 double:1.053131197E-314;
        r3 = "formatterDay12H";
    L_0x0114:
    ...
    L_0x012b:
        r1 = NUM; // 0x7f0d0b3f float:1.8747954E38 double:1.0531312E-314;
        r2 = "formatterStats24H";
        goto L_0x0136;
    L_0x0131:
        r1 = NUM; // 0x7f0d0b3e float:1.8747952E38 double:1.0531311995E-314;
    ...
    L_0x014f:
        r1 = NUM; // 0x7f0d0b36 float:1.8747936E38 double:1.0531311955E-314;
        r2 = "formatterBannedUntil24H";
        goto L_0x015a;
    L_0x0155:
        r1 = NUM; // 0x7f0d0b35 float:1.8747934E38 double:1.053131195E-314;
    ...
    L_0x016e:
        r1 = NUM; // 0x7f0d0b38 float:1.874794E38 double:1.0531311965E-314;
        r2 = "formatterBannedUntilThisYear24H";
        goto L_0x0179;
    L_0x0174:
        r1 = NUM; // 0x7f0d0b37 float:1.8747938E38 double:1.053131196E-314;
