...
public final /* synthetic */ class MessagesController$$ExternalSyntheticLambda34 implements Runnable {
    ...
    public /* synthetic */ MessagesController$$ExternalSyntheticLambda34(MessagesController messagesController, MessagesStorage.BooleanCallback booleanCallback, Context context, AlertDialog alertDialog, TLRPC.TL_error tL_error, BaseFragment baseFragment, TLRPC.TL_channels_convertToGigagroup tL_channels_convertToGigagroup) {
    ...
    public final void run() {
        this.f$0.m162xvar_d001f(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6);
    }
}
