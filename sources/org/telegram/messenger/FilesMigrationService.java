...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        new Thread() {
            ...
            public /* synthetic */ void m606lambda$run$0$orgtelegrammessengerFilesMigrationService$1() {
    ...
    public /* synthetic */ void m604x55fd53fa(File target, Path path) {
    ...
    public /* synthetic */ void m605x13efee05(int currentCount) {
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public /* synthetic */ void m607xavar_eacf(View view) {
            migrateOldFolder();
        }
