...
public class FilesMigrationService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        new Thread() {
            ...
            public /* synthetic */ void m1876lambda$run$0$orgtelegrammessengerFilesMigrationService$1() {
    ...
    public /* synthetic */ void m1874x55fd53fa(File target, Path path) {
    ...
    public /* synthetic */ void m1875x13efee05(int currentCount) {
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public FilesMigrationBottomSheet(BaseFragment fragment2) {
            ...
            buttonTextView.setBackground(Theme.AdaptiveRipple.filledRect("featuredStickers_addButton", 6.0f));
        ...
        public /* synthetic */ void m1877xavar_eacf(View view) {
            migrateOldFolder();
        }
