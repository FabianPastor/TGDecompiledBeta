...
public class FilesMigrationService extends Service {
    private static boolean hasOldFolder;
    long lastUpdateTime;
    ...
    public static void checkBottomSheet(DialogsActivity dialogsActivity) {
        ArrayList<File> rootDirs;
        ...
        if (hasOldFolder) {
            FilesMigrationBottomSheet filesMigrationBottomSheet = new FilesMigrationBottomSheet(dialogsActivity);
            dialogsActivity.filesMigrationBottomSheet = filesMigrationBottomSheet;
    ...
    public static class FilesMigrationBottomSheet extends BottomSheet {
        ...
        public FilesMigrationBottomSheet(DialogsActivity dialogsActivity) {
        ...
        public void dismiss() {
            super.dismiss();
            this.fragment.filesMigrationBottomSheet = null;
        }
    }
}
