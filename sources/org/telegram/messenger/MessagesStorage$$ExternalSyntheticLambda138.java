...
public final /* synthetic */ class MessagesStorage$$ExternalSyntheticLambda138 implements Runnable {
    ...
    public /* synthetic */ MessagesStorage$$ExternalSyntheticLambda138(MessagesStorage messagesStorage, int i, ArrayList arrayList, int i2, LongSparseArray longSparseArray, LongSparseArray longSparseArray2, ArrayList arrayList2, ArrayList arrayList3, CountDownLatch countDownLatch) {
    ...
    public final void run() {
        this.f$0.m969x19ba8078(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, this.f$6, this.f$7, this.f$8);
    }
}
