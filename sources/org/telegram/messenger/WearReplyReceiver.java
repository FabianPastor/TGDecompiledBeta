...
public class WearReplyReceiver extends BroadcastReceiver {
    ...
    public /* synthetic */ void m1107lambda$onReceive$1$orgtelegrammessengerWearReplyReceiver(AccountInstance accountInstance, long dialogId, CharSequence text, int maxId) {
    ...
    public /* synthetic */ void m1106lambda$onReceive$0$orgtelegrammessengerWearReplyReceiver(AccountInstance accountInstance, TLRPC.User user1, CharSequence text, long dialogId, int maxId) {
    ...
    public /* synthetic */ void m1109lambda$onReceive$3$orgtelegrammessengerWearReplyReceiver(AccountInstance accountInstance, long dialogId, CharSequence text, int maxId) {
    ...
    public /* synthetic */ void m1108lambda$onReceive$2$orgtelegrammessengerWearReplyReceiver(AccountInstance accountInstance, TLRPC.Chat chat1, CharSequence text, long dialogId, int maxId) {
