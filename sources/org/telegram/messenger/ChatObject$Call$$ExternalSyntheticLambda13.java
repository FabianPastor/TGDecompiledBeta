...
public final /* synthetic */ class ChatObject$Call$$ExternalSyntheticLambda13 implements RequestDelegate {
    ...
    public /* synthetic */ ChatObject$Call$$ExternalSyntheticLambda13(ChatObject.Call call, boolean z, TLRPC$TL_phone_getGroupParticipants tLRPC$TL_phone_getGroupParticipants) {
        this.f$0 = call;
        this.f$1 = z;
    ...
    public final void run(TLObject tLObject, TLRPC$TL_error tLRPC$TL_error) {
        this.f$0.lambda$loadMembers$2(this.f$1, this.f$2, tLObject, tLRPC$TL_error);
    }
}
