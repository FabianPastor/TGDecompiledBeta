...
public class ConnectionsManager extends BaseController {
    ...
    public ConnectionsManager(int i) {
        ...
        init(BuildVars.BUILD_VERSION, 138, BuildVars.APP_ID, str7, str9, str8, str, str6, file2, FileLog.getNetworkLogPath(), getRegId(), AndroidUtilities.getCertificateSHA256Fingerprint(), (TimeZone.getDefault().getRawOffset() + TimeZone.getDefault().getDSTSavings()) / 1000, getUserConfig().getClientUserId(), isPushConnectionEnabled);
    }
