    ...
    if (paramAlbumEntry != null)
    {
      ...
      if ((paramAlbumEntry.coverPhoto != null) && (paramAlbumEntry.coverPhoto.path != null))
      {
        ...
        if (paramAlbumEntry.coverPhoto.isVideo) {
          localAlbumView.imageView.setImage("vthumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130837858));
        }
      }
      for (;;)
      {
        ...
        return;
        localAlbumView.imageView.setImage("thumb://" + paramAlbumEntry.coverPhoto.imageId + ":" + paramAlbumEntry.coverPhoto.path, null, getContext().getResources().getDrawable(2130837858));
        continue;
        localAlbumView.imageView.setImageResource(2130837858);
      }
    }
