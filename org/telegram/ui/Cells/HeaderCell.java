  ...
  extends FrameLayout
{
  ...
  public HeaderCell(Context paramContext)
  {
    ...
    for (int j = i;; j = 3)
    {
      addView(paramContext, LayoutHelper.createFrame(-1, -1.0F, j | 0x30, 17.0F, 15.0F, 17.0F, 0.0F));
      return;
      j = 3;
      break;
    }
  ...
  {
    super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(paramInt1), NUM), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(38.0F), NUM));
  }
