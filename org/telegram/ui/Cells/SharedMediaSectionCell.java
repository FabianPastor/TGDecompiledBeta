  ...
  extends FrameLayout
{
  ...
  public SharedMediaSectionCell(Context paramContext)
  {
    ...
    for (int j = i;; j = 3)
    {
      addView(paramContext, LayoutHelper.createFrame(-1, -1.0F, j | 0x30, 13.0F, 0.0F, 13.0F, 0.0F));
      return;
      j = 3;
      break;
    }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/ui/Cells/SharedMediaSectionCell.class
