  ...
  extends FrameLayout
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.valueTextView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1 - AndroidUtilities.dp(24.0F), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), NUM));
    this.textView.measure(View.MeasureSpec.makeMeasureSpec(paramInt1 - AndroidUtilities.dp(95.0F), Integer.MIN_VALUE), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(20.0F), NUM));
