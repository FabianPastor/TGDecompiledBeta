  ...
  extends AlertDialog.Builder
{
  ...
  public StickersArchiveAlert(Context paramContext, BaseFragment paramBaseFragment, ArrayList<TLRPC.StickerSetCovered> paramArrayList)
  {
    ...
    if (localStickerSetCovered.set.masks)
    {
      ...
      paramArrayList.setText(LocaleController.getString("ArchivedMasksAlertInfo", NUM));
    }
    for (;;)
    {
      ...
      setNegativeButton(LocaleController.getString("Close", NUM), new DialogInterface.OnClickListener()
      {
      ...
      break;
      label309:
      paramArrayList.setText(LocaleController.getString("ArchivedStickersAlertInfo", NUM));
    }
  }
    ...
    extends RecyclerListView.SelectionAdapter
  {
    ...
    {
      ArchivedStickerSetCell localArchivedStickerSetCell = (ArchivedStickerSetCell)paramViewHolder.itemView;
      paramViewHolder = (TLRPC.StickerSetCovered)StickersArchiveAlert.this.stickerSets.get(paramInt);
