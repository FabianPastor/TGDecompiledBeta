  ...
  extends FrameLayout
{
  ...
  public WebFrameLayout(Context paramContext, BottomSheet paramBottomSheet, String paramString1, String paramString2, String paramString3, String paramString4, int paramInt1, int paramInt2)
  {
    ...
    if ((paramString2 != null) && (paramString2.length() > 0))
    {
      ...
      if ((this.webView.getSettings().getUserAgentString() == null) || (Build.VERSION.SDK_INT >= 21))
      {
    ...
    for (paramInt1 = 22;; paramInt1 = 0)
    {
      ...
      paramString1.setText(LocaleController.getString("Close", NUM).toUpperCase());
      ...
      paramString2.setPadding(AndroidUtilities.dp(18.0F), 0, AndroidUtilities.dp(18.0F), 0);
      paramString2.setText(LocaleController.getString("Copy", NUM).toUpperCase());
      ...
      paramString2.setOnClickListener(new View.OnClickListener()
      {
        public void onClick(View paramAnonymousView)
        {
          try
          {
            ...
            Toast.makeText(WebFrameLayout.this.getContext(), LocaleController.getString("LinkCopied", NUM), 0).show();
            if (WebFrameLayout.this.dialog != null) {
              WebFrameLayout.this.dialog.dismiss();
            }
            return;
      ...
      paramContext.setText(LocaleController.getString("OpenInBrowser", NUM).toUpperCase());
      ...
      paramBottomSheet.setDelegate(new BottomSheet.BottomSheetDelegate()
      {
        public void onOpenAnimationEnd()
        {
          ...
          try
          {
            ...
            i = m;
            Matcher localMatcher = AndroidUtilities.youtubeIdRegex.matcher(WebFrameLayout.this.openUrl);
            str = null;
            i = m;
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    {
      super.onMeasure(paramInt1, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(paramInt2 + 84) + i + 1, NUM));
      return;
    }
  }
}
