  ...
  extends HorizontalScrollView
{
  ...
  public View getTab(int paramInt)
  {
    ...
    for (View localView = null;; localView = this.tabsContainer.getChildAt(paramInt)) {
      return localView;
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if ((this.currentPositionOffset > 0.0F) && (this.currentPosition < this.tabCount - 1))
    {
      ...
      float f4 = localView.getRight();
      f1 = this.currentPositionOffset * f3 + (1.0F - this.currentPositionOffset) * f1;
