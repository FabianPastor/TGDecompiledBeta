...
public class BuildVars {
    ...
    public static int BUILD_VERSION = 871;
    public static String BUILD_VERSION_STRING = "3.14";
    ...
    public static String YOUTUBE_API_KEY = "AIzaSyA-t0jLPjUt2FxrA8VPK2EiYHcYcboIR6k";
}
