  ...
  implements Serializable, DatePrinter
{
  ...
  public StringBuffer format(Object paramObject, StringBuffer paramStringBuffer, FieldPosition paramFieldPosition)
  {
    if ((paramObject instanceof Date)) {
      paramObject = format((Date)paramObject, paramStringBuffer);
    }
    for (;;)
    {
      return (StringBuffer)paramObject;
      if ((paramObject instanceof Calendar))
      {
        paramObject = format((Calendar)paramObject, paramStringBuffer);
      }
      else
      {
        ...
        paramObject = format(((Long)paramObject).longValue(), paramStringBuffer);
      }
    }
  ...
  protected List<Rule> parsePattern()
  {
    ...
    String[] arrayOfString1 = ((DateFormatSymbols)localObject).getEras();
    String[] arrayOfString2 = ((DateFormatSymbols)localObject).getMonths();
    String[] arrayOfString3 = ((DateFormatSymbols)localObject).getShortMonths();
    String[] arrayOfString4 = ((DateFormatSymbols)localObject).getWeekdays();
    String[] arrayOfString5 = ((DateFormatSymbols)localObject).getShortWeekdays();
    ...
    case 'G': 
      localObject = new TextField(0, arrayOfString1);
    }
    for (;;)
    {
      ...
      else
      {
        ...
        localObject = selectNumberRule(1, j);
        continue;
        if (m >= 4)
        {
          localObject = new TextField(2, arrayOfString2);
        }
        else if (m == 3)
        {
          localObject = new TextField(2, arrayOfString3);
        }
        else if (m == 2)
        {
        ...
        else
        {
          ...
          continue;
          localObject = new TwelveHourField(selectNumberRule(10, m));
          continue;
          ...
          continue;
          if (m < 4) {}
          for (localObject = arrayOfString5;; localObject = arrayOfString4)
          {
          ...
          continue;
          localObject = new TwentyFourHourField(selectNumberRule(11, m));
          continue;
  ...
  protected NumberRule selectNumberRule(int paramInt1, int paramInt2)
  {
    ...
    {
    default: 
      localObject = new PaddedNumberField(paramInt1, paramInt2);
    }
    for (;;)
    {
      return (NumberRule)localObject;
      localObject = new UnpaddedNumberField(paramInt1);
      continue;
      localObject = new TwoDigitNumberField(paramInt1);
    }
  }
    ...
    implements FastDatePrinter.NumberRule
  {
    ...
    public final void appendTo(StringBuffer paramStringBuffer, int paramInt)
    {
      ...
      for (;;)
      {
        return;
        if (paramInt < 1000) {}
        for (i = 3;; i = Integer.toString(paramInt).length())
        {
          int j = this.mSize;
          for (;;)
          {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      for (;;)
      {
        ...
        if ((paramObject instanceof TimeZoneDisplayKey))
        {
          ...
          if ((!this.mTimeZone.equals(((TimeZoneDisplayKey)paramObject).mTimeZone)) || (this.mStyle != ((TimeZoneDisplayKey)paramObject).mStyle) || (!this.mLocale.equals(((TimeZoneDisplayKey)paramObject).mLocale))) {
            bool = false;
          }
        }
        else
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/time/FastDatePrinter.class
