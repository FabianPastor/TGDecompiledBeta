...
public abstract class Representation
{
  ...
  public static Representation newInstance(String paramString1, long paramLong, Format paramFormat, String paramString2, SegmentBase paramSegmentBase, List<Descriptor> paramList, String paramString3)
  {
    ...
    for (paramString1 = new SingleSegmentRepresentation(paramString1, paramLong, paramFormat, paramString2, (SegmentBase.SingleSegmentBase)paramSegmentBase, paramList, paramString3, -1L);; paramString1 = new MultiSegmentRepresentation(paramString1, paramLong, paramFormat, paramString2, (SegmentBase.MultiSegmentBase)paramSegmentBase, paramList))
    {
      return paramString1;
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/source/dash/manifest/Representation.class
