  ...
  extends TagPayloadReader
{
  ...
  private static Object readAmfData(ParsableByteArray paramParsableByteArray, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      paramParsableByteArray = readAmfDouble(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfBoolean(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfString(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfObject(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfEcmaArray(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfStrictArray(paramParsableByteArray);
      continue;
      paramParsableByteArray = readAmfDate(paramParsableByteArray);
    }
  }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/extractor/flv/ScriptTagPayloadReader.class
