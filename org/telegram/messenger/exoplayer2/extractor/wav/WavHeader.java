...
final class WavHeader {
    ...
    public long getPosition(long timeUs) {
        return Math.min((((((long) this.averageBytesPerSecond) * timeUs) / C.MICROS_PER_SECOND) / ((long) this.blockAlignment)) * ((long) this.blockAlignment), this.dataSize - ((long) this.blockAlignment)) + this.dataStartPosition;
    }
