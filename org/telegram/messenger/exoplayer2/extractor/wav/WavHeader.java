  ...
  implements SeekMap
{
  ...
  public SeekMap.SeekPoints getSeekPoints(long paramLong)
  {
    ...
    Object localObject = new SeekPoint(l3, l2);
    if ((l3 >= paramLong) || (l1 == this.dataSize - this.blockAlignment)) {}
    for (localObject = new SeekMap.SeekPoints((SeekPoint)localObject);; localObject = new SeekMap.SeekPoints((SeekPoint)localObject, new SeekPoint(getTimeUs(paramLong), paramLong)))
    {
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/extractor/wav/WavHeader.class
