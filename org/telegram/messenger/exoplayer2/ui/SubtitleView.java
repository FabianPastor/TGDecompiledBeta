  ...
  implements TextRenderer.Output
{
  ...
  public void dispatchDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      while (j < i)
      {
        ((SubtitlePainter)this.painters.get(j)).draw((Cue)this.cues.get(j), this.applyEmbeddedStyles, this.applyEmbeddedFontSizes, this.style, f, this.bottomPaddingFraction, paramCanvas, k, m, n, i1);
        j += 1;
      }
    }
    label183:
  ...
  {
    if (this.applyEmbeddedFontSizes == paramBoolean) {
      return;
    }
    this.applyEmbeddedFontSizes = paramBoolean;
    invalidate();
  }
  
  public void setApplyEmbeddedStyles(boolean paramBoolean)
  {
    if ((this.applyEmbeddedStyles == paramBoolean) && (this.applyEmbeddedFontSizes == paramBoolean)) {
      return;
    }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/ui/SubtitleView.class
