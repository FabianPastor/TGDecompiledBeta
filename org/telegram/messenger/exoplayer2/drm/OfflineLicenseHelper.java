...
public final class OfflineLicenseHelper<T extends ExoMediaCrypto>
{
  ...
  {
    paramDrmInitData = openBlockingKeyRequest(paramInt, paramArrayOfByte, paramDrmInitData);
    DrmSession.DrmSessionException localDrmSessionException = paramDrmInitData.getError();
    paramArrayOfByte = paramDrmInitData.getOfflineLicenseKeySetId();
    this.drmSessionManager.releaseSession(paramDrmInitData);
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/drm/OfflineLicenseHelper.class
