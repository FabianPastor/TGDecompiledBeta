...
public final class Id3Decoder implements MetadataDecoder<List<Id3Frame>> {
    ...
    public List<Id3Frame> decode(byte[] data, int size) throws MetadataDecoderException {
        ...
        while (id3Size > 0) {
            ...
            if (frameId0 == 84 && frameId1 == 88 && frameId2 == 88 && frameId3 == 88) {
                ...
                frame = decodeTextInformationFrame(id3Data, frameSize, String.format(Locale.US, "%c%c%c%c", new Object[]{Integer.valueOf(frameId0), Integer.valueOf(frameId1), Integer.valueOf(frameId2), Integer.valueOf(frameId3)}));
            } else {
                frame = decodeBinaryFrame(id3Data, frameSize, String.format(Locale.US, "%c%c%c%c", new Object[]{Integer.valueOf(frameId0), Integer.valueOf(frameId1), Integer.valueOf(frameId2), Integer.valueOf(frameId3)}));
            }
            id3Frames.add(frame);
    ...
    private static int decodeId3Header(ParsableByteArray id3Buffer) throws MetadataDecoderException {
        ...
        throw new MetadataDecoderException(String.format(Locale.US, "Unexpected ID3 file identifier, expected \"ID3\", actual \"%c%c%c\".", new Object[]{Integer.valueOf(id1), Integer.valueOf(id2), Integer.valueOf(id3)}));
    }
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray id3Data, int frameSize) throws UnsupportedEncodingException {
        int encoding = id3Data.readUnsignedByte();
        String charset = getCharsetName(encoding);
        byte[] data = new byte[(frameSize - 1)];
        id3Data.readBytes(data, 0, frameSize - 1);
