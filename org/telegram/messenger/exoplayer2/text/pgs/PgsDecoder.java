  ...
  extends SimpleSubtitleDecoder
{
  ...
  private static final class CueBuilder
  {
    ...
    private void parsePaletteSection(ParsableByteArray paramParsableByteArray, int paramInt)
    {
      ...
      for (;;)
      {
        ...
        for (paramInt = 0; paramInt < i; paramInt++)
        {
          ...
          int i2 = (int)(k + 1.402D * (m - 128));
          m = (int)(k - 0.34414D * (n - 128) - 0.71414D * (m - 128));
          n = (int)(k + 1.772D * (n - 128));
          this.colors[j] = (i1 << 24 | Util.constrainValue(i2, 0, 255) << 16 | Util.constrainValue(m, 0, 255) << 8 | Util.constrainValue(n, 0, 255));
        }
        this.colorsSet = true;
      }
    }
    ...
    public Cue build()
    {
      ...
      for (Object localObject = null;; localObject = new Cue(Bitmap.createBitmap((int[])localObject, this.bitmapWidth, this.bitmapHeight, Bitmap.Config.ARGB_8888), this.bitmapX / this.planeWidth, 0, this.bitmapY / this.planeHeight, 0, this.bitmapWidth / this.planeWidth, this.bitmapHeight / this.planeHeight))
      {
        return (Cue)localObject;
        this.bitmapData.setPosition(0);
        localObject = new int[this.bitmapWidth * this.bitmapHeight];
        int i = 0;
        while (i < localObject.length)
        {
          ...
          else
          {
            ...
            if (k != 0)
            {
              ...
              {
                Arrays.fill((int[])localObject, i, i + j, k);
                i += j;
                break;
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/text/pgs/PgsDecoder.class
