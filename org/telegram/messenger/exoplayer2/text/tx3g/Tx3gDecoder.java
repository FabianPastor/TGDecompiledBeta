  ...
  extends SimpleSubtitleDecoder
{
    ...
    throws SubtitleDecoderException
  {
    ...
    for (;;)
    {
      ...
      if (paramParsableByteArray.bytesLeft() >= 2)
      {
        ...
        if ((j == 65279) || (j == 65534))
        {
          paramParsableByteArray = paramParsableByteArray.readString(i, Charset.forName("UTF-16"));
          continue;
        }
      }
      paramParsableByteArray = paramParsableByteArray.readString(i, Charset.forName("UTF-8"));
    }
  }
    ...
    throws SubtitleDecoderException
  {
    ...
    float f1;
    for (paramArrayOfByte = Tx3gSubtitle.EMPTY;; paramArrayOfByte = new Tx3gSubtitle(new Cue(paramArrayOfByte, null, f1, 0, 0, Float.MIN_VALUE, Integer.MIN_VALUE, Float.MIN_VALUE)))
    {
      ...
      f1 = this.defaultVerticalPlacement;
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/text/tx3g/Tx3gDecoder.class
