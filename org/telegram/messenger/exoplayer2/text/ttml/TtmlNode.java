...
final class TtmlNode
{
  ...
  private void traverseForText(long paramLong, boolean paramBoolean, String paramString, Map<String, SpannableStringBuilder> paramMap)
  {
    ...
    Object localObject1 = this.regionId;
    Object localObject2 = localObject1;
    if ("".equals(localObject1)) {
      localObject2 = paramString;
    }
    if ((this.isTextNode) && (paramBoolean)) {
      getRegionOutput((String)localObject2, paramMap).append(this.text);
    }
    for (;;)
    {
      return;
      ...
      {
        getRegionOutput((String)localObject2, paramMap).append('\n');
      }
      else if ((!"metadata".equals(this.tag)) && (isActive(paramLong)))
      {
        boolean bool1 = "p".equals(this.tag);
        ...
        while (paramString.hasNext())
        {
          ...
          this.nodeStartsByRegion.put(((Map.Entry)localObject1).getKey(), Integer.valueOf(((SpannableStringBuilder)((Map.Entry)localObject1).getValue()).length()));
        }
        int i = 0;
        if (i < getChildCount())
        {
          ...
          for (boolean bool2 = true;; bool2 = false)
          {
            paramString.traverseForText(paramLong, bool2, (String)localObject2, paramMap);
            i++;
            break;
          }
        }
        if (bool1) {
          TtmlRenderUtil.endParagraph(getRegionOutput((String)localObject2, paramMap));
        }
        paramMap = paramMap.entrySet().iterator();
        while (paramMap.hasNext())
        {
          paramString = (Map.Entry)paramMap.next();
          this.nodeEndsByRegion.put(paramString.getKey(), Integer.valueOf(((SpannableStringBuilder)paramString.getValue()).length()));
        }
      }
    }
  }
  ...
  public List<Cue> getCues(long paramLong, Map<String, TtmlStyle> paramMap, Map<String, TtmlRegion> paramMap1)
  {
    ...
    {
      Map.Entry localEntry = (Map.Entry)localIterator.next();
      localObject = (TtmlRegion)paramMap1.get(localEntry.getKey());
      paramMap.add(new Cue(cleanUpText((SpannableStringBuilder)localEntry.getValue()), null, ((TtmlRegion)localObject).line, ((TtmlRegion)localObject).lineType, ((TtmlRegion)localObject).lineAnchor, ((TtmlRegion)localObject).position, Integer.MIN_VALUE, ((TtmlRegion)localObject).width));
    }
    return paramMap;
  }
  ...
  {
    if (((this.startTimeUs == -9223372036854775807L) && (this.endTimeUs == -9223372036854775807L)) || ((this.startTimeUs <= paramLong) && (this.endTimeUs == -9223372036854775807L)) || ((this.startTimeUs == -9223372036854775807L) && (paramLong < this.endTimeUs)) || ((this.startTimeUs <= paramLong) && (paramLong < this.endTimeUs))) {}
    for (boolean bool = true;; bool = false) {
      return bool;
    }
  }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/text/ttml/TtmlNode.class
