...
public final class WebvttCue extends Cue {
    ...
    public static class Builder {
        ...
        public WebvttCue build() {
            if (this.position != Cue.DIMEN_UNSET && this.positionAnchor == Integer.MIN_VALUE) {
    ...
    public WebvttCue(long startTime, long endTime, CharSequence text) {
        this(startTime, endTime, text, null, Cue.DIMEN_UNSET, Integer.MIN_VALUE, Integer.MIN_VALUE, Cue.DIMEN_UNSET, Integer.MIN_VALUE, Cue.DIMEN_UNSET);
    }
