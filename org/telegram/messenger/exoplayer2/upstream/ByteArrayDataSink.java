  ...
  implements DataSink
{
  ...
  {
    if (this.stream == null) {}
    for (byte[] arrayOfByte = null;; arrayOfByte = this.stream.toByteArray()) {
      return arrayOfByte;
    }
  }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/exoplayer2/upstream/ByteArrayDataSink.class
