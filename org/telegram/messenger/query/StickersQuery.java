...
public class StickersQuery
{
  ...
  private static HashMap<Long, TLRPC.TL_messages_stickerSet> groupStickerSets;
  ...
  private static HashMap<String, TLRPC.TL_messages_stickerSet> stickerSetsByName;
  ...
  static
  {
    ...
    recentStickers = new ArrayList[] { new ArrayList(), new ArrayList(), new ArrayList() };
    loadingRecentStickers = new boolean[3];
    recentStickersLoaded = new boolean[3];
    ...
    if (recentGifs.size() > MessagesController.getInstance().maxRecentGifsCount)
    {
      ...
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          try
          {
            MessagesStorage.getInstance().getDatabase().executeFast("DELETE FROM web_recent_v3 WHERE id = '" + this.val$old.id + "' AND type = 2").stepThis().dispose();
            return;
          }
  ...
  public static void addRecentSticker(int paramInt1, TLRPC.Document paramDocument, int paramInt2, boolean paramBoolean)
  {
    int j = 0;
    int i = 0;
    ...
    if (paramInt1 == 2) {
      if (paramBoolean)
      {
        ...
        i = MessagesController.getInstance().maxFaveStickersCount;
        label207:
        if ((recentStickers[paramInt1].size() > i) || (paramBoolean)) {
          if (!paramBoolean) {
            break label344;
          }
        }
    ...
    label344:
    for (final Object localObject = paramDocument;; localObject = (TLRPC.Document)recentStickers[paramInt1].remove(recentStickers[paramInt1].size() - 1))
    {
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          ...
          for (;;)
          {
            try
            {
              MessagesStorage.getInstance().getDatabase().executeFast("DELETE FROM web_recent_v3 WHERE id = '" + localObject.id + "' AND type = " + i).stepThis().dispose();
              return;
            }
            catch (Exception localException)
            {
      ...
      if (paramInt1 == 2) {
        NotificationCenter.getInstance().postNotificationName(NotificationCenter.recentDocumentsDidLoaded, new Object[] { Boolean.valueOf(false), Integer.valueOf(paramInt1) });
      }
      return;
  ...
  {
    boolean bool = false;
    if ((stickersLoaded[0] == 0) || (stickerSets[0].size() >= 5) || (!recentStickers[2].isEmpty())) {
      bool = true;
    }
    return bool;
  }
  ...
  public static TLRPC.TL_messages_stickerSet getGroupStickerSetById(TLRPC.StickerSet paramStickerSet)
  {
    TLRPC.TL_messages_stickerSet localTL_messages_stickerSet2 = (TLRPC.TL_messages_stickerSet)stickerSetsById.get(Long.valueOf(paramStickerSet.id));
    ...
    {
      localTL_messages_stickerSet2 = (TLRPC.TL_messages_stickerSet)groupStickerSets.get(Long.valueOf(paramStickerSet.id));
  ...
  public static boolean isStickerInFavorites(TLRPC.Document paramDocument)
  {
    int i = 0;
    while (i < recentStickers[2].size())
    {
      TLRPC.Document localDocument = (TLRPC.Document)recentStickers[2].get(i);
  ...
  public static void loadArchivedStickersCount(int paramInt, boolean paramBoolean)
  {
    ...
    for (paramBoolean = bool;; paramBoolean = false)
    {
      ...
      ConnectionsManager.getInstance().sendRequest(localTL_messages_getArchivedStickers, new RequestDelegate()
      {
          ...
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              if (paramAnonymousTL_error == null)
              {
                ...
                StickersQuery.archivedStickersCount[StickersQuery.22.this.val$type] = localTL_messages_archivedStickers.count;
                ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).edit().putInt("archivedStickersCount" + StickersQuery.22.this.val$type, localTL_messages_archivedStickers.count).commit();
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.archivedStickersCountDidLoaded, new Object[] { Integer.valueOf(StickersQuery.22.this.val$type) });
              }
            }
          });
        }
    ...
    if (paramBoolean1)
    {
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        ...
        public void run()
        {
          ...
          //   332: astore 8
          //   334: aload 9
          //   336: invokestatic 87	org/telegram/messenger/query/StickersQuery:access$900	(Ljava/util/ArrayList;)I
          //   339: istore_3
          //   340: iload_2
          //   341: istore 4
          //   343: iload_3
          ...
          //   375: iload 4
          //   377: iload 5
          //   379: invokestatic 94	org/telegram/messenger/query/StickersQuery:access$1000	(Ljava/util/ArrayList;Ljava/util/ArrayList;ZII)V
          //   382: return
          //   383: astore 9
          //   385: aload 10
          //   387: astore 7
          ...
          //   391: astore 8
          //   393: aload 9
          //   395: invokestatic 100	org/telegram/messenger/FileLog:e	(Ljava/lang/Throwable;)V
          //   398: iload_1
          //   399: istore 4
          //   401: iload 6
          //   403: istore 5
          ...
          //   411: ifnull -41 -> 370
          //   414: aload 7
          //   416: invokevirtual 90	org/telegram/SQLite/SQLiteCursor:dispose	()V
          //   419: iload_1
          //   420: istore 4
          //   422: iload 6
          //   424: istore 5
          ...
          //   441: ifnull +8 -> 449
          //   444: aload 7
          //   446: invokevirtual 90	org/telegram/SQLite/SQLiteCursor:dispose	()V
          //   449: aload 9
          //   451: athrow
          //   452: astore 9
          //   454: goto -15 -> 439
          ...
          //   22	442	5	n	int
          //   27	396	6	i1	int
          //   59	386	7	localObject1	Object
          //   32	404	8	localObject2	Object
          //   457	10	8	localThrowable1	Throwable
          //   1	360	9	localObject3	Object
          //   383	11	9	localThrowable2	Throwable
          //   433	17	9	localObject4	Object
          //   452	8	9	localObject5	Object
          //   468	1	9	localObject6	Object
          //   35	351	10	localObject7	Object
          //   42	420	11	localObject8	Object
          ...
          //   154	172	452	finally
          //   179	184	452	finally
          //   140	147	457	java/lang/Throwable
          //   154	172	457	java/lang/Throwable
          //   179	184	457	java/lang/Throwable
        }
      });
      return;
    }
        ...
        public void run(final TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              StickersQuery.processLoadedFeaturedStickers(null, null, false, (int)(System.currentTimeMillis() / 1000L), StickersQuery.15.this.val$req.hash);
            }
          });
        }
      });
  ...
  private static void loadGroupStickerSet(TLRPC.StickerSet paramStickerSet, boolean paramBoolean)
  {
    if (paramBoolean)
    {
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        public void run()
        {
          try
          {
            SQLiteCursor localSQLiteCursor = MessagesStorage.getInstance().getDatabase().queryFinalized("SELECT document FROM web_recent_v3 WHERE id = 's_" + this.val$stickerSet.id + "'", new Object[0]);
            ...
            for (;;)
            {
              ...
              if ((localTL_messages_stickerSet == null) || (localTL_messages_stickerSet.set == null) || (localTL_messages_stickerSet.set.hash != this.val$stickerSet.hash)) {
                StickersQuery.loadGroupStickerSet(this.val$stickerSet, false);
              }
              if ((localTL_messages_stickerSet != null) && (localTL_messages_stickerSet.set != null)) {
                AndroidUtilities.runOnUIThread(new Runnable()
                {
                  public void run()
                  {
                    StickersQuery.groupStickerSets.put(Long.valueOf(localTL_messages_stickerSet.set.id), localTL_messages_stickerSet);
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.groupStickersDidLoaded, new Object[] { Long.valueOf(localTL_messages_stickerSet.set.id) });
                  }
                });
              }
              return;
        ...
        if (paramAnonymousTLObject != null)
        {
          ...
          MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
          {
            public void run()
            {
              try
              {
                SQLitePreparedStatement localSQLitePreparedStatement = MessagesStorage.getInstance().getDatabase().executeFast("REPLACE INTO web_recent_v3 VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
          ...
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              StickersQuery.groupStickerSets.put(Long.valueOf(paramAnonymousTLObject.set.id), paramAnonymousTLObject);
              NotificationCenter.getInstance().postNotificationName(NotificationCenter.groupStickersDidLoaded, new Object[] { Long.valueOf(paramAnonymousTLObject.set.id) });
            }
          });
        }
      }
  ...
  public static void loadRecents(final int paramInt, final boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    boolean bool = true;
    if (paramBoolean1)
    {
        ...
        public void run()
        {
          for (;;)
          {
            ...
            try
            {
              ...
              {
                i = 2;
                SQLiteCursor localSQLiteCursor = MessagesStorage.getInstance().getDatabase().queryFinalized("SELECT document FROM web_recent_v3 WHERE type = " + i + " ORDER BY date DESC", new Object[0]);
            ...
            if (paramInt == 1)
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  if (StickersQuery.8.this.val$gif)
                  {
                    StickersQuery.access$202(localArrayList);
                    StickersQuery.access$302(false);
                    StickersQuery.access$402(true);
                  }
                  for (;;)
                  {
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.recentDocumentsDidLoaded, new Object[] { Boolean.valueOf(StickersQuery.8.this.val$gif), Integer.valueOf(StickersQuery.8.this.val$type) });
                    StickersQuery.loadRecents(StickersQuery.8.this.val$type, StickersQuery.8.this.val$gif, false, false);
                    return;
                    StickersQuery.recentStickers[StickersQuery.8.this.val$type] = localArrayList;
                    StickersQuery.loadingRecentStickers[StickersQuery.8.this.val$type] = 0;
                    StickersQuery.recentStickersLoaded[StickersQuery.8.this.val$type] = 1;
                  }
                }
              });
            }
    ...
    label76:
    Object localObject = ApplicationLoader.applicationContext.getSharedPreferences("emoji", 0);
    if (!paramBoolean3)
    {
      long l;
      if (paramBoolean1) {
      ...
      while (Math.abs(System.currentTimeMillis() - l) < 3600000L) {
        ...
        {
          loadingRecentStickers[paramInt] = false;
          return;
        }
      }
    }
    ...
    if (paramInt == 2)
    {
      ...
      ((TLRPC.TL_messages_getFavedStickers)localObject).hash = calcDocumentsHash(recentStickers[paramInt]);
      ConnectionsManager.getInstance().sendRequest((TLObject)localObject, new RequestDelegate()
      {
        public void run(TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
    ...
    if (paramBoolean1)
    {
      MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
      {
        ...
        public void run()
        {
          ...
          //   53: aload_0
          //   54: getfield 17	org/telegram/messenger/query/StickersQuery$23:val$type	I
          //   57: iconst_1
          //   58: iadd
          ...
          //   231: astore 8
          //   233: aload 9
          //   235: invokestatic 96	org/telegram/messenger/query/StickersQuery:access$2100	(Ljava/util/ArrayList;)I
          //   238: istore_3
          //   239: iload_2
          //   240: istore 4
          //   242: iload_3
          ...
          //   267: istore 4
          //   269: aload_0
          //   270: getfield 17	org/telegram/messenger/query/StickersQuery$23:val$type	I
          //   273: aload 8
          //   275: iconst_1
          //   276: iload 4
          //   278: iload 5
          //   280: invokestatic 103	org/telegram/messenger/query/StickersQuery:access$2200	(ILjava/util/ArrayList;ZII)V
          //   283: return
          //   284: astore 9
          //   286: aload 10
          //   288: astore 7
          ...
          //   292: astore 8
          //   294: aload 9
          //   296: invokestatic 109	org/telegram/messenger/FileLog:e	(Ljava/lang/Throwable;)V
          //   299: iload_1
          //   300: istore 4
          //   302: iload 6
          //   304: istore 5
          ...
          //   312: ifnull -43 -> 269
          //   315: aload 7
          //   317: invokevirtual 99	org/telegram/SQLite/SQLiteCursor:dispose	()V
          //   320: iload_1
          //   321: istore 4
          //   323: iload 6
          //   325: istore 5
          ...
          //   342: ifnull +8 -> 350
          //   345: aload 7
          //   347: invokevirtual 99	org/telegram/SQLite/SQLiteCursor:dispose	()V
          //   350: aload 9
          //   352: athrow
          //   353: astore 9
          //   355: goto -15 -> 340
          ...
          //   13	352	5	n	int
          //   18	306	6	i1	int
          //   72	274	7	localObject1	Object
          //   23	314	8	localObject2	Object
          //   358	10	8	localThrowable1	Throwable
          //   1	259	9	localObject3	Object
          //   284	11	9	localThrowable2	Throwable
          //   334	17	9	localObject4	Object
          //   353	8	9	localObject5	Object
          //   369	1	9	localObject6	Object
          //   26	261	10	localObject7	Object
          //   33	330	11	localObject8	Object
          ...
          //   167	185	353	finally
          //   192	197	353	finally
          //   153	160	358	java/lang/Throwable
          //   167	185	358	java/lang/Throwable
          //   192	197	358	java/lang/Throwable
        }
      });
      return;
    }
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              public void run()
              {
                if ((paramAnonymousTLObject instanceof TLRPC.TL_messages_allStickers))
                {
                  ...
                  {
                    StickersQuery.processLoadedStickers(StickersQuery.24.this.val$type, localArrayList, false, (int)(System.currentTimeMillis() / 1000L), localTL_messages_allStickers.hash);
                    return;
                  }
                      ...
                      public void run(final TLObject paramAnonymous3TLObject, TLRPC.TL_error paramAnonymous3TL_error)
                      {
                        AndroidUtilities.runOnUIThread(new Runnable()
                        {
                          public void run()
                          {
                            ...
                            StickersQuery.24.1.1.this.val$newStickerArray.set(StickersQuery.24.1.1.this.val$index, localTL_messages_stickerSet);
                            StickersQuery.24.1.1.this.val$newStickerSets.put(Long.valueOf(StickersQuery.24.1.1.this.val$stickerSet.id), localTL_messages_stickerSet);
                            if (StickersQuery.24.1.1.this.val$newStickerSets.size() == StickersQuery.24.1.1.this.val$res.sets.size())
                            {
                              int i = 0;
                              while (i < StickersQuery.24.1.1.this.val$newStickerArray.size())
                              {
                                if (StickersQuery.24.1.1.this.val$newStickerArray.get(i) == null) {
                                  StickersQuery.24.1.1.this.val$newStickerArray.remove(i);
                                }
                                i += 1;
                              }
                              StickersQuery.processLoadedStickers(StickersQuery.24.this.val$type, StickersQuery.24.1.1.this.val$newStickerArray, false, (int)(System.currentTimeMillis() / 1000L), StickersQuery.24.1.1.this.val$res.hash);
                            }
                          }
                        });
                      }
                ...
                StickersQuery.processLoadedStickers(StickersQuery.24.this.val$type, null, false, (int)(System.currentTimeMillis() / 1000L), StickersQuery.24.this.val$hash);
              }
            });
          }
        });
  ...
  public static void markFaturedStickersByIdAsRead(long paramLong)
  {
    ...
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        ...
        StickersQuery.access$1302(StickersQuery.calcFeaturedStickersHash(StickersQuery.featuredStickerSets));
        NotificationCenter.getInstance().postNotificationName(NotificationCenter.featuredStickersDidLoaded, new Object[0]);
  ...
  private static void processLoadedFeaturedStickers(final ArrayList<TLRPC.StickerSetCovered> paramArrayList, final ArrayList<Long> paramArrayList1, boolean paramBoolean, final int paramInt1, final int paramInt2)
  {
    AndroidUtilities.runOnUIThread(new Runnable()
    {
      public void run()
      {
        StickersQuery.access$1102(false);
        StickersQuery.access$1202(true);
      }
    });
      ...
      public void run()
      {
        ...
        if (((this.val$cache) && ((paramArrayList == null) || (Math.abs(System.currentTimeMillis() / 1000L - paramInt1) >= 3600L))) || ((!this.val$cache) && (paramArrayList == null) && (paramInt2 == 0)))
        {
          localObject = new Runnable()
          {
            public void run()
            {
              if ((StickersQuery.17.this.val$res != null) && (StickersQuery.17.this.val$hash != 0)) {
                StickersQuery.access$1302(StickersQuery.17.this.val$hash);
              }
          ...
          if (paramArrayList != null) {
            try
            {
              ...
              AndroidUtilities.runOnUIThread(new Runnable()
              {
                public void run()
                {
                  StickersQuery.access$1502(StickersQuery.17.this.val$unreadStickers);
                  StickersQuery.access$1602(localHashMap);
                  StickersQuery.access$1702(localObject);
                  StickersQuery.access$1302(StickersQuery.17.this.val$hash);
                  StickersQuery.access$1802(StickersQuery.17.this.val$date);
                  NotificationCenter.getInstance().postNotificationName(NotificationCenter.featuredStickersDidLoaded, new Object[0]);
                }
              });
              return;
        ...
        public void run()
        {
          ...
          if (this.val$gif)
          {
            ...
            if (paramArrayList != null)
            {
              ...
              StickersQuery.access$202(paramArrayList);
            }
          }
          for (;;)
          {
      ...
      public void run()
      {
        ...
        if (((this.val$cache) && ((paramArrayList == null) || (Math.abs(System.currentTimeMillis() / 1000L - paramInt2) >= 3600L))) || ((!this.val$cache) && (paramArrayList == null) && (paramInt3 == 0)))
        {
          localObject1 = new Runnable()
          {
            public void run()
            {
              if ((StickersQuery.27.this.val$res != null) && (StickersQuery.27.this.val$hash != 0)) {
                StickersQuery.loadHash[StickersQuery.27.this.val$type] = StickersQuery.27.this.val$hash;
              }
              StickersQuery.loadStickers(StickersQuery.27.this.val$type, false, false);
            }
          };
          if ((paramArrayList == null) && (!this.val$cache)) {}
        ...
        for (;;)
        {
          if (k < localTL_stickerPack.documents.size())
          {
            ...
            AndroidUtilities.runOnUIThread(new Runnable()
            {
              ...
              {
                int i = 0;
                while (i < StickersQuery.stickerSets[StickersQuery.27.this.val$type].size())
                {
                  TLRPC.StickerSet localStickerSet = ((TLRPC.TL_messages_stickerSet)StickersQuery.stickerSets[StickersQuery.27.this.val$type].get(i)).set;
                ...
                StickersQuery.stickerSets[StickersQuery.27.this.val$type] = localArrayList;
                StickersQuery.loadHash[StickersQuery.27.this.val$type] = StickersQuery.27.this.val$hash;
                StickersQuery.loadDate[StickersQuery.27.this.val$type] = StickersQuery.27.this.val$date;
                if (StickersQuery.27.this.val$type == 0)
                {
                  StickersQuery.access$3102(localHashMap5);
                  StickersQuery.access$3202(localHashMap3);
                }
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.stickersDidLoaded, new Object[] { Integer.valueOf(StickersQuery.27.this.val$type) });
              }
            });
            return;
            if (this.val$cache) {
  ...
  public static void putGroupStickerSet(TLRPC.TL_messages_stickerSet paramTL_messages_stickerSet)
  {
    groupStickerSets.put(Long.valueOf(paramTL_messages_stickerSet.set.id), paramTL_messages_stickerSet);
  }
  ...
  public static void removeRecentGif(TLRPC.Document paramDocument)
  {
    ...
    MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable()
    {
      public void run()
      {
        try
        {
          MessagesStorage.getInstance().getDatabase().executeFast("DELETE FROM web_recent_v3 WHERE id = '" + this.val$document.id + "' AND type = 2").stepThis().dispose();
          return;
        }
        catch (Exception localException)
        {
        ...
        public void run(final TLObject paramAnonymousTLObject, TLRPC.TL_error paramAnonymousTL_error)
        {
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              ...
              {
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.needReloadArchivedStickers, new Object[] { Integer.valueOf(StickersQuery.28.this.val$type) });
                if ((StickersQuery.28.this.val$hide != 1) && (StickersQuery.28.this.val$baseFragment != null) && (StickersQuery.28.this.val$baseFragment.getParentActivity() != null))
                {
                  localActivity = StickersQuery.28.this.val$baseFragment.getParentActivity();
                  if (!StickersQuery.28.this.val$showSettings) {
                    break label135;
                  }
                }
              }
              label135:
              for (Object localObject = StickersQuery.28.this.val$baseFragment;; localObject = null)
              {
                ...
                StickersQuery.28.this.val$baseFragment.showDialog(((StickersArchiveAlert)localObject).create());
                return;
              }
            }
          });
          AndroidUtilities.runOnUIThread(new Runnable()
          {
            public void run()
            {
              StickersQuery.loadStickers(StickersQuery.28.this.val$type, false, false);
            }
          }, 1000L);
        }
      });
        ...
        AndroidUtilities.runOnUIThread(new Runnable()
        {
          public void run()
          {
            try
            {
              if (paramAnonymousTL_error == null)
              {
                if (StickersQuery.29.this.val$stickerSet.masks) {
                  Toast.makeText(StickersQuery.29.this.val$context, LocaleController.getString("MasksRemoved", NUM), 0).show();
                }
                for (;;)
                {
                  StickersQuery.loadStickers(StickersQuery.29.this.val$type, false, true);
                  return;
                  Toast.makeText(StickersQuery.29.this.val$context, LocaleController.getString("StickersRemoved", NUM), 0).show();
                }
              }
            }
            catch (Exception localException)
            {
              for (;;)
              {
                FileLog.e(localException);
                continue;
                Toast.makeText(StickersQuery.29.this.val$context, LocaleController.getString("ErrorOccurred", NUM), 0).show();
              }
            }
          }
        });
