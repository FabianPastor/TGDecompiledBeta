    ...
    private static void processLoadedMedia(messages_Messages res, long uid, int count, int max_id, int type, boolean fromCache, int classGuid, boolean isChannel, boolean topReached) {
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                ...
                MessagesController.getInstance().putUsers(org_telegram_tgnet_TLRPC_messages_Messages.users, z);
                MessagesController.getInstance().putChats(org_telegram_tgnet_TLRPC_messages_Messages.chats, z);
                ...
                try {
                    ...
                    if (!(z && i == 0)) {
                        ...
                        if (i != 0) {
                            ...
                            MessagesStorage.getInstance().closeHolesInMedia(j, minId, ConnectionsManager.DEFAULT_DATACENTER_ID, i2);
                        }
                    }
