...
public class ID3v2TagBody
{
  ...
  {
    int i = paramID3v2FrameHeader.getBodySize();
    ...
    for (;;)
    {
      ...
      {
        i = paramID3v2FrameHeader.getDataLengthIndicator();
        localObject2 = new InflaterInputStream((InputStream)localObject1);
      }
      return new ID3v2FrameBody((InputStream)localObject2, paramID3v2FrameHeader.getHeaderSize(), i, this.tagHeader, paramID3v2FrameHeader);
    }
  }
