    ...
    throws IOException, ID3v2Exception
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localID3v2FrameHeader = new org/telegram/messenger/audioinfo/mp3/ID3v2FrameHeader;
          localID3v2FrameHeader.<init>(localID3v2TagBody);
      ...
      if ((this.cover == null) || (this.coverPictureType != 3))
      {
        ...
        if ((this.cover == null) || (paramID3v2FrameBody.type == 3) || (paramID3v2FrameBody.type == 0))
        {
          ...
          for (;;)
          {
            try
            {
              localObject2 = paramID3v2FrameBody.imageData;
              ...
              if ((((BitmapFactory.Options)localObject1).outWidth > 800) || (((BitmapFactory.Options)localObject1).outHeight > 800))
              {
                i = Math.max(((BitmapFactory.Options)localObject1).outWidth, ((BitmapFactory.Options)localObject1).outHeight);
                if (i > 800)
                {
              ...
              this.cover = BitmapFactory.decodeByteArray((byte[])localObject2, 0, localObject2.length, (BitmapFactory.Options)localObject1);
              if (this.cover != null)
              {
            ...
            this.coverPictureType = ((byte)paramID3v2FrameBody.type);
            break;
            this.smallCover = this.cover;
          }
          ...
          if ((this.comment == null) || (paramID3v2FrameBody.description == null) || ("".equals(paramID3v2FrameBody.description)))
          {
            ...
            if (((String)localObject2).length() > 0)
            {
              ...
              for (paramID3v2FrameBody = null;; paramID3v2FrameBody = ID3v1Genre.getGenre(Integer.parseInt((String)localObject2)))
              {
                try
                {
                  ...
                  if (i > 1)
                  {
                    ID3v1Genre localID3v1Genre = ID3v1Genre.getGenre(Integer.parseInt(((String)localObject2).substring(1, i)));
                      ...
                      else
                      {
                        ...
                        if (paramID3v2FrameBody.length() > 0)
                        {
                          ...
                          else
                          {
                            ...
                            continue;
                            String str = parseTextFrame(paramID3v2FrameBody);
                            if (str.length() > 0)
                            {
                              try
                              {
                                this.year = Short.valueOf(str).shortValue();
                              }
                              catch (NumberFormatException paramID3v2FrameBody) {}
                              if (LOGGER.isLoggable(this.debugLevel))
                              {
                                LOGGER.log(this.debugLevel, "Could not parse year: " + str);
                                continue;
                                if (this.lyrics == null) {
