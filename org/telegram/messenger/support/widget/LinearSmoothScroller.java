  ...
  extends RecyclerView.SmoothScroller
{
  ...
  public int calculateDxToMakeVisible(View paramView, int paramInt)
  {
    ...
    for (paramInt = 0;; paramInt = calculateDtToFit(localLayoutManager.getDecoratedLeft(paramView) - localLayoutParams.leftMargin, localLayoutManager.getDecoratedRight(paramView) + localLayoutParams.rightMargin, localLayoutManager.getPaddingLeft(), localLayoutManager.getWidth() - localLayoutManager.getPaddingRight(), paramInt))
    {
      return paramInt;
  ...
  public int calculateDyToMakeVisible(View paramView, int paramInt)
  {
    ...
    RecyclerView.LayoutParams localLayoutParams;
    for (paramInt = 0;; paramInt = calculateDtToFit(localLayoutManager.getDecoratedTop(paramView) - localLayoutParams.topMargin, localLayoutManager.getDecoratedBottom(paramView) + localLayoutParams.bottomMargin, localLayoutManager.getPaddingTop(), localLayoutManager.getHeight() - localLayoutManager.getPaddingBottom(), paramInt))
    {
      return paramInt;
      localLayoutParams = (RecyclerView.LayoutParams)paramView.getLayoutParams();
    }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/support/widget/LinearSmoothScroller.class
