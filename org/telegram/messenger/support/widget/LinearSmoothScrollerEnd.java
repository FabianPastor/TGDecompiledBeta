  ...
  extends RecyclerView.SmoothScroller
{
  ...
  public int calculateDxToMakeVisible(View paramView)
  {
    ...
    for (;;)
    {
      ...
      int j = localLayoutManager.getDecoratedRight(paramView) + localLayoutParams.rightMargin;
      int k = localLayoutManager.getPaddingLeft();
      int m = localLayoutManager.getWidth() - localLayoutManager.getPaddingRight();
      if ((i > k) && (j < m))
      {
        i = 0;
      }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/support/widget/LinearSmoothScrollerEnd.class
