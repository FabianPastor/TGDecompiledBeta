...
class ViewInfoStore
{
  ...
  private RecyclerView.ItemAnimator.ItemHolderInfo popFromLayoutStep(RecyclerView.ViewHolder paramViewHolder, int paramInt)
  {
    ...
    do
    {
      do
      {
        return (RecyclerView.ItemAnimator.ItemHolderInfo)localObject2;
  ...
  {
    for (int i = this.mOldChangedHolders.size() - 1;; i--) {
      if (i >= 0)
      {
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/org/telegram/messenger/support/widget/ViewInfoStore.class
