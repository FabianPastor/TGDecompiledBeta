...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        if (!applicationInited) {
            ...
            ConnectionsManager.getInstance().init(BuildVars.BUILD_VERSION, 71, BuildVars.APP_ID, deviceModel, systemVersion, appVersion, langCode, systemLangCode, configPath, FileLog.getNetworkLogPath(), UserConfig.getClientUserId(), enablePushConnection);
