...
public class zzc
{
  ...
  static String zza(KeyPair paramKeyPair, String... paramVarArgs)
  {
    ...
    //   46: invokestatic 108	com/google/android/gms/iid/InstanceID:zzu	([B)Ljava/lang/String;
    //   49: astore_0
    //   50: aload_0
    //   51: areturn
    //   52: astore_0
    ...
    throws IOException
  {
    ...
    paramBundle.putString("app_ver", Integer.toString(InstanceID.zzdg(this.zzahn)));
    paramBundle.putString("app_ver_name", InstanceID.zzdh(this.zzahn));
    paramBundle.putString("cliv", "iid-9683000");
    paramBundle.putString("appid", InstanceID.zza(paramKeyPair));
    String str = InstanceID.zzu(paramKeyPair.getPublic().getEncoded());
  ...
  protected void zzb(Intent paramIntent, String paramString)
  {
    ...
    if (bool)
    {
      ...
      paramString.setPackage(this.zzahn.getPackageName());
      paramString.putExtra("GSF", paramIntent);
      this.zzahn.startService(paramString);
      return;
    }
    paramIntent.putExtra("google.messenger", this.aeX);
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/google/android/gms/iid/zzc.class
