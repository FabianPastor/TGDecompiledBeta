...
public interface zzbkt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbkt {
        ...
        private static class zza implements zzbkt {
        ...
        public static zzbkt zzfu(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbkt)) ? new zza(iBinder) : (zzbkt) queryLocalInterface;
        }
