...
final class zzcef {
    ...
    @WorkerThread
    zzcef(zzcgk com_google_android_gms_internal_zzcgk, String str) {
    ...
    public final void setAppVersion(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzaeI, str) ? 1 : 0) | this.zzboN;
        this.zzaeI = str;
    }
    ...
    public final void zzdG(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzaKE, str) ? 1 : 0) | this.zzboN;
        this.zzaKE = str;
    }
    ...
    public final void zzdH(String str) {
        ...
        this.zzboN = (!zzcjk.zzR(this.zzXB, str) ? 1 : 0) | this.zzboN;
        this.zzXB = str;
    }
    ...
    public final void zzdI(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzbov, str) ? 1 : 0) | this.zzboN;
        this.zzbov = str;
    }
    ...
    public final void zzdJ(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzbow, str) ? 1 : 0) | this.zzboN;
        this.zzbow = str;
    }
    ...
    public final void zzdK(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzboB, str) ? 1 : 0) | this.zzboN;
        this.zzboB = str;
    }
    ...
    public final void zzdL(String str) {
        this.zzboe.zzwE().zzjC();
        this.zzboN = (!zzcjk.zzR(this.zzboM, str) ? 1 : 0) | this.zzboN;
        this.zzboM = str;
    }
    ...
    public final void zzwV() {
        ...
        long j = this.zzbox + 1;
        if (j > 2147483647L) {
            this.zzboe.zzwF().zzyz().zzj("Bundle index overflow. appId", zzcfk.zzdZ(this.mAppId));
            j = 0;
        }
        this.zzboN = true;
        this.zzbox = j;
