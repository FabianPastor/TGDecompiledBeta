...
public final class zzctt extends zzz<zzctr> implements zzctj {
    ...
    public zzctt(Context context, Looper looper, boolean z, zzq com_google_android_gms_common_internal_zzq, Bundle bundle, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public zzctt(Context context, Looper looper, boolean z, zzq com_google_android_gms_common_internal_zzq, zzctk com_google_android_gms_internal_zzctk, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
    ...
    public static Bundle zza(zzq com_google_android_gms_common_internal_zzq) {
        zzctk zzrt = com_google_android_gms_common_internal_zzq.zzrt();
    ...
    public final void zza(zzal com_google_android_gms_common_internal_zzal, boolean z) {
        try {
            ((zzctr) zzrf()).zza(com_google_android_gms_common_internal_zzal, this.zzaHn.intValue(), z);
        } catch (RemoteException e) {
            Log.w("SignInClientImpl", "Remote service probably died when saveDefaultAccount is called");
        }
    }

    public final void zza(zzctp com_google_android_gms_internal_zzctp) {
        zzbo.zzb((Object) com_google_android_gms_internal_zzctp, (Object) "Expecting a valid ISignInCallbacks");
        try {
            ...
            ((zzctr) zzrf()).zza(new zzctu(new zzbp(zzrl, this.zzaHn.intValue(), googleSignInAccount)), com_google_android_gms_internal_zzctp);
        } catch (Throwable e) {
            Log.w("SignInClientImpl", "Remote service probably died when signIn is called");
            try {
                com_google_android_gms_internal_zzctp.zzb(new zzctw(8));
