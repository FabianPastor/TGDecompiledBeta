...
final class zzbbj implements zzbdo {
    ...
    private final Map<zzc<?>, zzbcw> zzaCo;
    ...
    private zzbbj(Context context, zzbco com_google_android_gms_internal_zzbco, Lock lock, Looper looper, com.google.android.gms.common.zze com_google_android_gms_common_zze, Map<zzc<?>, zze> map, Map<zzc<?>, zze> map2, zzq com_google_android_gms_common_internal_zzq, zza<? extends zzctj, zzctk> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzctj__com_google_android_gms_internal_zzctk, zze com_google_android_gms_common_api_Api_zze, ArrayList<zzbbh> arrayList, ArrayList<zzbbh> arrayList2, Map<Api<?>, Boolean> map3, Map<Api<?>, Boolean> map4) {
        this.mContext = context;
        this.zzaCl = com_google_android_gms_internal_zzbco;
        this.zzaCv = lock;
        this.zzrO = looper;
        this.zzaCq = com_google_android_gms_common_api_Api_zze;
        this.zzaCm = new zzbcw(context, this.zzaCl, lock, looper, com_google_android_gms_common_zze, map2, null, map4, null, arrayList2, new zzbbl());
        this.zzaCn = new zzbcw(context, this.zzaCl, lock, looper, com_google_android_gms_common_zze, map, com_google_android_gms_common_internal_zzq, map3, com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzctj__com_google_android_gms_internal_zzctk, arrayList, new zzbbm());
    ...
    public static zzbbj zza(Context context, zzbco com_google_android_gms_internal_zzbco, Lock lock, Looper looper, com.google.android.gms.common.zze com_google_android_gms_common_zze, Map<zzc<?>, zze> map, zzq com_google_android_gms_common_internal_zzq, Map<Api<?>, Boolean> map2, zza<? extends zzctj, zzctk> com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzctj__com_google_android_gms_internal_zzctk, ArrayList<zzbbh> arrayList) {
        ...
        while (i < size) {
            ...
            if (arrayMap3.containsKey(com_google_android_gms_internal_zzbbh.zzayW)) {
                arrayList2.add(com_google_android_gms_internal_zzbbh);
            } else if (arrayMap4.containsKey(com_google_android_gms_internal_zzbbh.zzayW)) {
                arrayList3.add(com_google_android_gms_internal_zzbbh);
            } else {
                throw new IllegalStateException("Each ClientCallbacks must have a corresponding API in the isOptionalMap");
            }
        }
        return new zzbbj(context, com_google_android_gms_internal_zzbco, lock, looper, com_google_android_gms_common_zze, arrayMap, arrayMap2, com_google_android_gms_common_internal_zzq, com_google_android_gms_common_api_Api_zza__extends_com_google_android_gms_internal_zzctj__com_google_android_gms_internal_zzctk, com_google_android_gms_common_api_Api_zze, arrayList2, arrayList3, arrayMap3, arrayMap4);
    }
    ...
    private final boolean zzf(zzbax<? extends Result, ? extends zzb> com_google_android_gms_internal_zzbax__extends_com_google_android_gms_common_api_Result___extends_com_google_android_gms_common_api_Api_zzb) {
        zzc zzpd = com_google_android_gms_internal_zzbax__extends_com_google_android_gms_common_api_Result___extends_com_google_android_gms_common_api_Api_zzb.zzpd();
        zzbo.zzb(this.zzaCo.containsKey(zzpd), (Object) "GoogleApiClient is not configured to use the API required for this call.");
        return ((zzbcw) this.zzaCo.get(zzpd)).equals(this.zzaCn);
    }
    ...
    public final ConnectionResult getConnectionResult(@NonNull Api<?> api) {
        return ((zzbcw) this.zzaCo.get(api.zzpd())).equals(this.zzaCn) ? zzpH() ? new ConnectionResult(4, zzpI()) : this.zzaCn.getConnectionResult(api) : this.zzaCm.getConnectionResult(api);
    }
    ...
    public final boolean zza(zzbeh com_google_android_gms_internal_zzbeh) {
        ...
        try {
            if ((isConnecting() || isConnected()) && !this.zzaCn.isConnected()) {
                this.zzaCp.add(com_google_android_gms_internal_zzbeh);
                if (this.zzaCw == 0) {
                    this.zzaCw = 1;
                }
                this.zzaCt = null;
