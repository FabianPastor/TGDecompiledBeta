...
public interface zzbkw extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzbkw {
        ...
        private static class zza implements zzbkw {
            ...
            public void zza(Status status, zzu com_google_android_gms_wallet_zzu, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.wallet.internal.IWalletServiceCallbacks");
                    if (status != null) {
                    ...
                    if (com_google_android_gms_wallet_zzu != null) {
                        obtain.writeInt(1);
                        com_google_android_gms_wallet_zzu.writeToParcel(obtain, 0);
                    } else {
                        obtain.writeInt(0);
                    }
                    if (bundle != null) {
        ...
        public static zzbkw zzfx(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzbkw)) ? new zza(iBinder) : (zzbkw) queryLocalInterface;
        }
    ...
    void zza(Status status, zzu com_google_android_gms_wallet_zzu, Bundle bundle) throws RemoteException;
