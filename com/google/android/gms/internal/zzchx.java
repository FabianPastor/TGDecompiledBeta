...
@TargetApi(14)
@MainThread
final class zzchx implements ActivityLifecycleCallbacks {
    private /* synthetic */ zzchk zzbtt;

    private zzchx(zzchk com_google_android_gms_internal_zzchk) {
            ...
            if (intent != null) {
                ...
                if (data != null && data.isHierarchical()) {
                    if (bundle == null) {
                        ...
                        this.zzbtt.zzwB();
                        String str = zzcjk.zzl(intent) ? "gs" : "auto";
                        if (zzq != null) {
    ...
    public final void onActivityResumed(Activity activity) {
        ...
        zzciz zzwD = this.zzbtt.zzwD();
        zzwD.zzwE().zzj(new zzcjc(zzwD, zzwD.zzkq().elapsedRealtime()));
    }
