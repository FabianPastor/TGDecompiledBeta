...
public interface zzaqq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzaqq {
        ...
        private static class zza implements zzaqq {
            ...
            public void zza(zzaqp com_google_android_gms_internal_zzaqp, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.identity.intents.internal.IAddressService");
                    obtain.writeStrongBinder(com_google_android_gms_internal_zzaqp != null ? com_google_android_gms_internal_zzaqp.asBinder() : null);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 2:
                    ...
                    zza(com.google.android.gms.internal.zzaqp.zza.zzcX(parcel.readStrongBinder()), parcel.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(parcel) : null, parcel.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(parcel) : null);
    ...
    void zza(zzaqp com_google_android_gms_internal_zzaqp, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException;
}
