...
public final class ade {
    ...
    public static void zza(ada com_google_android_gms_internal_ada, ada com_google_android_gms_internal_ada2) {
        if (com_google_android_gms_internal_ada.zzcrZ != null) {
            com_google_android_gms_internal_ada2.zzcrZ = (adc) com_google_android_gms_internal_ada.zzcrZ.clone();
        }
    }
