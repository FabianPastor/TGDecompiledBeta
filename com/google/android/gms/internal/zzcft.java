...
class zzcft extends BroadcastReceiver {
    private static String zzaiq = zzcft.class.getName();
    private boolean mRegistered;
    private boolean zzair;
    private final zzcgk zzboe;

    zzcft(zzcgk com_google_android_gms_internal_zzcgk) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if ("android.net.conn.CONNECTIVITY_CHANGE".equals(action)) {
            ...
            if (this.zzair != zzlQ) {
                this.zzair = zzlQ;
                this.zzboe.zzwE().zzj(new zzcfu(this, zzlQ));
                return;
            }
            return;
        }
