...
public abstract interface zzbjo
  extends IInterface
{
  public abstract void zzTS()
    throws RemoteException;
  
  public abstract Barcode[] zza(IObjectWrapper paramIObjectWrapper, zzbka paramzzbka)
    throws RemoteException;
  
  public abstract Barcode[] zzb(IObjectWrapper paramIObjectWrapper, zzbka paramzzbka)
    throws RemoteException;
  ...
  public static abstract class zza
    ...
    implements zzbjo
  {
    public static zzbjo zzfn(IBinder paramIBinder)
    {
      ...
      if ((localIInterface != null) && ((localIInterface instanceof zzbjo))) {
        return (zzbjo)localIInterface;
      }
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        paramParcel1 = zza(localIObjectWrapper1, (zzbka)localObject);
      ...
      case 2: 
        ...
        localObject = localIObjectWrapper1;
        if (paramParcel1.readInt() != 0) {
          localObject = (zzbka)zzbka.CREATOR.createFromParcel(paramParcel1);
        }
        paramParcel1 = zzb(localIObjectWrapper2, (zzbka)localObject);
        paramParcel2.writeNoException();
        paramParcel2.writeTypedArray(paramParcel1, 1);
        return true;
      }
      ...
      implements zzbjo
    {
      ...
      /* Error */
      public Barcode[] zza(IObjectWrapper paramIObjectWrapper, zzbka paramzzbka)
        throws RemoteException
      {
        // Byte code:
        ...
        //   46: aload_0
        //   47: getfield 18	com/google/android/gms/internal/zzbjo$zza$zza:zzrk	Landroid/os/IBinder;
        //   50: iconst_1
        //   51: aload_3
        //   52: aload 4
        //   54: iconst_0
        ...
        //   66: aload 4
        //   68: getstatic 73	com/google/android/gms/vision/barcode/Barcode:CREATOR	Landroid/os/Parcelable$Creator;
        //   71: invokevirtual 77	android/os/Parcel:createTypedArray	(Landroid/os/Parcelable$Creator;)[Ljava/lang/Object;
        //   74: checkcast 79	[Lcom/google/android/gms/vision/barcode/Barcode;
        //   77: astore_1
        //   78: aload 4
      ...
      /* Error */
      public Barcode[] zzb(IObjectWrapper paramIObjectWrapper, zzbka paramzzbka)
        throws RemoteException
      {
        // Byte code:
        //   0: invokestatic 30	android/os/Parcel:obtain	()Landroid/os/Parcel;
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/google/android/gms/internal/zzbjo.class
