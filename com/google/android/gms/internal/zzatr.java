...
public class zzatr implements Creator<zzatq> {
    static void zza(zzatq com_google_android_gms_internal_zzatq, Parcel parcel, int i) {
        ...
        zzc.zza(parcel, 3, com_google_android_gms_internal_zzatq.zzbrH, i, false);
        zzc.zza(parcel, 4, com_google_android_gms_internal_zzatq.zzbqW, false);
        zzc.zza(parcel, 5, com_google_android_gms_internal_zzatq.zzbrI);
        zzc.zzJ(parcel, zzaZ);
    }
