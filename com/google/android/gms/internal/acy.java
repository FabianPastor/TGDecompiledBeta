...
public final class acy
{
  ...
  private acy(ByteBuffer paramByteBuffer)
  {
    this.zzcrY = paramByteBuffer;
    this.zzcrY.order(ByteOrder.LITTLE_ENDIAN);
  }
  
  private acy(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    this(ByteBuffer.wrap(paramArrayOfByte, paramInt1, paramInt2));
  }
  
  public static acy zzI(byte[] paramArrayOfByte)
  {
  ...
  public static int zzb(int paramInt, adg paramadg)
  {
  ...
  public static acy zzc(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    return new acy(paramArrayOfByte, 0, paramInt2);
  }
    ...
    throws IOException
  {
    ...
    if (this.zzcrY.remaining() >= i)
    {
      this.zzcrY.put(paramArrayOfByte, 0, i);
      return;
    }
    throw new acz(this.zzcrY.position(), this.zzcrY.limit());
  }
  ...
  public final void zza(int paramInt, adg paramadg)
    throws IOException
  {
    zzt(paramInt, 2);
    zzb(paramadg);
  ...
  public final void zzb(adg paramadg)
    throws IOException
  {
    zzcu(paramadg.zzLS());
    paramadg.zza(this);
    ...
    throws IOException
  {
    ...
    try
    {
      ...
      i = this.zzcrY.position();
      if (this.zzcrY.remaining() < paramInt) {
        throw new acz(paramInt + i, this.zzcrY.limit());
      }
    }
    catch (BufferOverflowException paramString)
    {
      acz localacz = new acz(this.zzcrY.position(), this.zzcrY.limit());
      localacz.initCause(paramString);
      throw localacz;
    }
    this.zzcrY.position(i + paramInt);
    zza(paramString, this.zzcrY);
    int j = this.zzcrY.position();
    this.zzcrY.position(i);
    zzcu(j - i - paramInt);
    this.zzcrY.position(j);
    return;
    label156:
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/google/android/gms/internal/acy.class
