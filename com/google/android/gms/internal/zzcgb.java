...
public final class zzcgb {
    private final zzcgd zzbrL;

    public zzcgb(zzcgd com_google_android_gms_internal_zzcgd) {
        zzbo.zzu(com_google_android_gms_internal_zzcgd);
        this.zzbrL = com_google_android_gms_internal_zzcgd;
    }

    public static boolean zzj(Context context, boolean z) {
        zzbo.zzu(context);
        return zzcjk.zza(context, "com.google.android.gms.measurement.AppMeasurementReceiver", false);
    }

    @MainThread
    public final void onReceive(Context context, Intent intent) {
        zzcgk zzbj = zzcgk.zzbj(context);
        zzcfk zzwF = zzbj.zzwF();
        if (intent == null) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            ...
            zzbj.zzwE().zzj(new zzcgc(this, zzbj, longExtra, zzq, context, zzwF));
        }
    }
}
