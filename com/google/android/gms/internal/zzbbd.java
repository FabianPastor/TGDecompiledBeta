    ...
    public final void setResultCallback(ResultCallback<? super R> resultCallback, long j, TimeUnit timeUnit) {
        ...
        synchronized (this.zzaBW) {
            ...
            if (isCanceled()) {
                ...
                this.zzaCa = resultCallback;
                zzbbf com_google_android_gms_internal_zzbbf = this.zzaBX;
                com_google_android_gms_internal_zzbbf.sendMessageDelayed(com_google_android_gms_internal_zzbbf.obtainMessage(2, this), timeUnit.toMillis(j));
            }
        }
    }
