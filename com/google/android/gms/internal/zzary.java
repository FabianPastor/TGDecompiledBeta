...
public final class zzary {
    ...
    public static void zza(zzaru com_google_android_gms_internal_zzaru, zzaru com_google_android_gms_internal_zzaru2) {
        if (com_google_android_gms_internal_zzaru.btG != null) {
            com_google_android_gms_internal_zzaru2.btG = (zzarw) com_google_android_gms_internal_zzaru.btG.clone();
        }
    }
