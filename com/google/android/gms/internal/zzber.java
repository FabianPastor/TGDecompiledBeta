...
public final class zzber<R extends Result> extends TransformedResult<R> implements ResultCallback<R> {
    ...
    public final <S extends Result> TransformedResult<S> then(@NonNull ResultTransform<? super R, ? extends S> resultTransform) {
        TransformedResult com_google_android_gms_internal_zzber;
        boolean z = true;
        synchronized (this.zzaBW) {
            ...
            com_google_android_gms_internal_zzber = new zzber(this.zzaBY);
            this.zzaFb = com_google_android_gms_internal_zzber;
            zzqJ();
        }
        return com_google_android_gms_internal_zzber;
    }
