...
public class zzath implements Creator<zzatg> {
    static void zza(zzatg com_google_android_gms_internal_zzatg, Parcel parcel, int i) {
        ...
        zzc.zza(parcel, 3, com_google_android_gms_internal_zzatg.zzbqW, false);
        zzc.zza(parcel, 4, com_google_android_gms_internal_zzatg.zzbqX, i, false);
        zzc.zza(parcel, 5, com_google_android_gms_internal_zzatg.zzbqY);
        zzc.zza(parcel, 6, com_google_android_gms_internal_zzatg.zzbqZ);
        zzc.zza(parcel, 7, com_google_android_gms_internal_zzatg.zzbra, false);
        zzc.zza(parcel, 8, com_google_android_gms_internal_zzatg.zzbrb, i, false);
        zzc.zza(parcel, 9, com_google_android_gms_internal_zzatg.zzbrc);
        zzc.zza(parcel, 10, com_google_android_gms_internal_zzatg.zzbrd, i, false);
        zzc.zza(parcel, 11, com_google_android_gms_internal_zzatg.zzbre);
        zzc.zza(parcel, 12, com_google_android_gms_internal_zzatg.zzbrf, i, false);
        zzc.zzJ(parcel, zzaZ);
    }
