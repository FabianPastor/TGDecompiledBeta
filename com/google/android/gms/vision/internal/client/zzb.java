  ...
  implements Parcelable.Creator<FrameMetadataParcel>
{
  static void zza(FrameMetadataParcel paramFrameMetadataParcel, Parcel paramParcel, int paramInt)
  {
    ...
    com.google.android.gms.common.internal.safeparcel.zzb.zza(paramParcel, 5, paramFrameMetadataParcel.aOE);
  ...
  public FrameMetadataParcel[] zzabl(int paramInt)
  {
    return new FrameMetadataParcel[paramInt];
  }
  
  public FrameMetadataParcel zzsv(Parcel paramParcel)
  {
    int i = 0;
