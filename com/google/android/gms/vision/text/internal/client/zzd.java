  ...
  implements Parcelable.Creator<LineBoxParcel>
{
  static void zza(LineBoxParcel paramLineBoxParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 2, paramLineBoxParcel.aOQ, paramInt, false);
    zzb.zza(paramParcel, 3, paramLineBoxParcel.aOR, paramInt, false);
    zzb.zza(paramParcel, 4, paramLineBoxParcel.aOS, paramInt, false);
    zzb.zza(paramParcel, 5, paramLineBoxParcel.aOT, paramInt, false);
    zzb.zza(paramParcel, 6, paramLineBoxParcel.aOU, false);
    zzb.zza(paramParcel, 7, paramLineBoxParcel.aOV);
    zzb.zza(paramParcel, 8, paramLineBoxParcel.aOK, false);
    zzb.zzc(paramParcel, 9, paramLineBoxParcel.aOW);
    zzb.zza(paramParcel, 10, paramLineBoxParcel.aOX);
    zzb.zzc(paramParcel, 11, paramLineBoxParcel.aOY);
    zzb.zzc(paramParcel, 12, paramLineBoxParcel.aOZ);
    zzb.zzaj(paramParcel, i);
  }
  
  public LineBoxParcel[] zzabo(int paramInt)
  {
    return new LineBoxParcel[paramInt];
  }
  
  public LineBoxParcel zzsx(Parcel paramParcel)
  {
