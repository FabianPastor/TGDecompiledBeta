  ...
  implements Parcelable.Creator<BoundingBoxParcel>
{
  static void zza(BoundingBoxParcel paramBoundingBoxParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 6, paramBoundingBoxParcel.aLE);
    zzb.zzaj(paramParcel, paramInt);
  }
  
  public BoundingBoxParcel[] zzabx(int paramInt)
  {
    return new BoundingBoxParcel[paramInt];
  }
  
  public BoundingBoxParcel zztg(Parcel paramParcel)
  {
    int i = 0;
    ...
    {
      int i2 = com.google.android.gms.common.internal.safeparcel.zza.zzcp(paramParcel);
      switch (com.google.android.gms.common.internal.safeparcel.zza.zzgv(i2))
      {
      default: 
