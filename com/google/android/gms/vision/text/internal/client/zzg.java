  ...
  extends zza<zzb>
{
  ...
  public zzg(Context paramContext, TextRecognizerOptions paramTextRecognizerOptions)
  {
    ...
    this.aOO = paramTextRecognizerOptions;
    zzcls();
  }
  ...
  public LineBoxParcel[] zza(Bitmap paramBitmap, FrameMetadataParcel paramFrameMetadataParcel, RecognitionOptions paramRecognitionOptions)
  {
    ...
    try
    {
      ...
      paramBitmap = ((zzb)zzcls()).zza(paramBitmap, paramFrameMetadataParcel, paramRecognitionOptions);
      return paramBitmap;
    }
  ...
  protected zzb zzd(zztl paramzztl, Context paramContext)
    throws RemoteException, zztl.zza
  {
    return zzc.zza.zzlj(paramzztl.zzjd("com.google.android.gms.vision.text.ChimeraNativeTextRecognizerCreator")).zza(zze.zzac(paramContext), this.aOO);
  }
}
