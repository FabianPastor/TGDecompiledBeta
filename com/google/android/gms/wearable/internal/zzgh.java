...
public class zzgh
{
  ...
  public static zzgh zzbz(Context paramContext)
  {
    zzbo.zzu(paramContext);
    try
    {
      if (zzbTC == null) {
        zzbTC = new zzgh(paramContext);
      }
      return zzbTC;
    }
    finally {}
  ...
  private static boolean zzc(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    if (paramPackageInfo.signatures.length != 1)
    {
      Log.w("WearSignatureVerifier", "Package has more than one signature.");
    ...
    if (paramBoolean) {
      return zza(paramPackageInfo, new byte[][] { zzbTD, zzbTE });
    }
    return zza(paramPackageInfo, new byte[][] { zzbTD });
  }
  
  private static byte[] zzcs(String paramString)
  {
    try
    {
  ...
  private final PackageInfo zzgn(String paramString)
  {
    try
    {
      paramString = zzbha.zzaP(this.mContext).getPackageInfo(paramString, 64);
      return paramString;
    }
  ...
  public final boolean zzgm(String paramString)
  {
    boolean bool1 = false;
    paramString = zzgn(paramString);
    if (paramString == null) {}
    boolean bool2;
    do
    {
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/google/android/gms/wearable/internal/zzgh.class
