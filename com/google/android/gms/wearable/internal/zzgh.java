...
public class zzgh {
    ...
    private static boolean zzc(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return zza(packageInfo, zzbTB, zzbTC);
        }
        return zza(packageInfo, zzbTB);
    }
    ...
    private final PackageInfo zzgn(String str) {
        try {
            return zzbgz.zzaP(this.mContext).getPackageInfo(str, 64);
