...
public class zzhp {
    ...
    private static boolean zzc(PackageInfo packageInfo, boolean z) {
        ...
        if (z) {
            return zza(packageInfo, zzlme, zzlmf);
        }
        return zza(packageInfo, zzlme);
    }
    ...
    private static byte[] zzfx(String str) {
        try {
    ...
    private final PackageInfo zzoa(String str) {
        try {
            return zzbhf.zzdb(this.mContext).getPackageInfo(str, 64);
        } catch (NameNotFoundException e) {
            return null;
        }
    }

    public final boolean zznz(String str) {
        PackageInfo zzoa = zzoa(str);
        if (zzoa == null) {
            return false;
        }
        if (zzp.zzch(this.mContext)) {
            return zzc(zzoa, true);
        }
        boolean zzc = zzc(zzoa, false);
        if (zzc || !zzc(zzoa, true)) {
            return zzc;
        }
