  ...
  implements Parcelable.Creator<UserAttributeParcel>
{
  static void zza(UserAttributeParcel paramUserAttributeParcel, Parcel paramParcel, int paramInt)
  {
    ...
    zzb.zza(paramParcel, 3, paramUserAttributeParcel.asu);
    zzb.zza(paramParcel, 4, paramUserAttributeParcel.asv, false);
    zzb.zza(paramParcel, 5, paramUserAttributeParcel.asw, false);
    zzb.zza(paramParcel, 6, paramUserAttributeParcel.Dr, false);
    zzb.zza(paramParcel, 7, paramUserAttributeParcel.aoA, false);
    zzb.zza(paramParcel, 8, paramUserAttributeParcel.asx, false);
    zzb.zzaj(paramParcel, paramInt);
  }
  
  public UserAttributeParcel zzph(Parcel paramParcel)
  {
  ...
  public UserAttributeParcel[] zzwn(int paramInt)
  {
