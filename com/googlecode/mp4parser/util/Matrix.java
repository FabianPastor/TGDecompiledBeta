...
public class Matrix
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      if (Double.compare(((Matrix)paramObject).b, this.b) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).c, this.c) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).d, this.d) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).tx, this.tx) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).ty, this.ty) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).u, this.u) != 0) {
        return false;
      }
      if (Double.compare(((Matrix)paramObject).v, this.v) != 0) {
        return false;
      }
    } while (Double.compare(((Matrix)paramObject).w, this.w) == 0);
    return false;
  }
