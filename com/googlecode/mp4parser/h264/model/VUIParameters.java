...
public class VUIParameters
{
  ...
  public static class BitstreamRestriction
  {
    ...
    public String toString()
    {
      StringBuilder localStringBuilder = new StringBuilder("BitstreamRestriction{");
      localStringBuilder.append("motion_vectors_over_pic_boundaries_flag=").append(this.motion_vectors_over_pic_boundaries_flag);
      localStringBuilder.append(", max_bytes_per_pic_denom=").append(this.max_bytes_per_pic_denom);
      localStringBuilder.append(", max_bits_per_mb_denom=").append(this.max_bits_per_mb_denom);
      localStringBuilder.append(", log2_max_mv_length_horizontal=").append(this.log2_max_mv_length_horizontal);
      localStringBuilder.append(", log2_max_mv_length_vertical=").append(this.log2_max_mv_length_vertical);
      localStringBuilder.append(", num_reorder_frames=").append(this.num_reorder_frames);
      localStringBuilder.append(", max_dec_frame_buffering=").append(this.max_dec_frame_buffering);
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/googlecode/mp4parser/h264/model/VUIParameters.class
