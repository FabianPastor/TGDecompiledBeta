  ...
  extends AbstractFullBox
{
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (this.extentIndex != ((Extent)paramObject).extentIndex) {
            bool = false;
          } else if (this.extentLength != ((Extent)paramObject).extentLength) {
            bool = false;
          } else if (this.extentOffset != ((Extent)paramObject).extentOffset) {
            bool = false;
          }
        }
      }
  ...
  public class Item
  {
      ...
      do
      {
        for (;;)
        {
          ...
          else
          {
            ...
            else if (this.constructionMethod != ((Item)paramObject).constructionMethod)
            {
              bool = false;
            }
            else if (this.dataReferenceIndex != ((Item)paramObject).dataReferenceIndex)
            {
              bool = false;
            }
            else
    ...
    {
      int i = this.itemId;
      int j = this.constructionMethod;
      int k = this.dataReferenceIndex;
      int m = (int)(this.baseOffset ^ this.baseOffset >>> 32);
      if (this.extents != null) {}
      for (int n = this.extents.hashCode();; n = 0) {
