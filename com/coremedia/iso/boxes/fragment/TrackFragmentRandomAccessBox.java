      ...
      for (;;)
      {
        ...
        else
        {
          ...
          if (this.moofOffset != ((Entry)paramObject).moofOffset) {
            bool = false;
          } else if (this.sampleNumber != ((Entry)paramObject).sampleNumber) {
            bool = false;
          } else if (this.time != ((Entry)paramObject).time) {
            bool = false;
          } else if (this.trafNumber != ((Entry)paramObject).trafNumber) {
            bool = false;
          } else if (this.trunNumber != ((Entry)paramObject).trunNumber) {
            bool = false;
          }
        }
      }
