  ...
  implements FullBox
{
  ...
  {
    Object localObject = getBoxes(AbstractSampleEntry.class).iterator();
    if (((Iterator)localObject).hasNext()) {}
    for (localObject = (AbstractSampleEntry)((Iterator)localObject).next();; localObject = null) {
      return (AbstractSampleEntry)localObject;
    }
  }
...
/* Location:              /home/fabian/Escritorio/Proyectos/Android/Dev/jardecompiler/TMessagesProj-fat-debug.jar!/com/coremedia/iso/boxes/SampleDescriptionBox.class
